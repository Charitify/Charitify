...
const Icon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<svg${add_attribute("id", id, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-15dzgeg"}"${add_attribute("style", styleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}>
    <use${add_attribute("xlink:href", `#ico-${type}`, 0)} class="${"ico-use svelte-15dzgeg"}"></use>
</svg>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <span class="${"nav-actions svelte-1fltwxb"}">
    ...
    ${validate_component(Button, "Button").$$render($$result, { auto: true, size: "small" }, {}, {
		default: () => `
      ${validate_component(Icon, "Icon").$$render($$result, { type: "moon", class: "theme-fill-color" }, {}, {})}
    `
	})}
  </span>
</nav>`;
