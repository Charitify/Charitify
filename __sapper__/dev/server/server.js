...
const css$c = {
	code: "section.svelte-crb7w8.svelte-crb7w8{width:100%;flex-grow:1;display:flex;align-self:stretch;align-items:center}span.svelte-crb7w8.svelte-crb7w8{overflow:hidden;padding:0 8px}span.svelte-crb7w8 h4.svelte-crb7w8,span.svelte-crb7w8 p.svelte-crb7w8{line-height:1.2;max-width:100%;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}",
	map: "{\"version\":3,\"file\":\"AvatarAndName.svelte\",\"sources\":[\"AvatarAndName.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Avatar } from '../components'\\n\\n    export let src = undefined\\n    export let title = undefined\\n    export let subtitle = undefined\\n</script>\\n\\n<section>\\n    <Avatar src={src} alt={title}/>\\n\\n    <span>\\n        <h4>{title}</h4>\\n        <p>{subtitle}</p>\\n    </span>\\n</section>\\n\\n<style>\\n    section {\\n        width: 100%;\\n        flex-grow: 1;\\n        display: flex;\\n        align-self: stretch;\\n        align-items: center;\\n    }\\n\\n    span {\\n        overflow: hidden;\\n        padding: 0 8px;\\n    }\\n\\n    span h6 {\\n        font-weight: normal;\\n    }\\n\\n    span h4,\\n    span p {\\n        line-height: 1.2;\\n        max-width: 100%;\\n        overflow: hidden;\\n        white-space: nowrap;\\n        text-overflow: ellipsis;\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAkBI,OAAO,4BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,CACnB,WAAW,CAAE,MAAM,AACvB,CAAC,AAED,IAAI,4BAAC,CAAC,AACF,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,CAAC,CAAC,GAAG,AAClB,CAAC,AAMD,kBAAI,CAAC,gBAAE,CACP,kBAAI,CAAC,CAAC,cAAC,CAAC,AACJ,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,QAAQ,CAAE,MAAM,CAChB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,QAAQ,AAC3B,CAAC\"}"
};
...
const AvatarAndName = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"svelte-crb7w8"}">
    ${validate_component(Avatar, "Avatar").$$render($$result, { src, alt: title }, {}, {})}

    <span class="${"svelte-crb7w8"}">
        <h4 class="${"svelte-crb7w8"}">${escape(title)}</h4>
        <p class="${"svelte-crb7w8"}">${escape(subtitle)}</p>
    </span>
</section>`;
});
