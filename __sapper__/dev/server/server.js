...
const css$4 = {
	code: ".inp.svelte-shbv4z{width:100%;flex:1 1 0;color:inherit;border-radius:var(--border-radius);min-width:var(--min-interactive-size);min-height:var(--min-interactive-size);border:1px solid rgba(var(--color-black), .2);background-color:rgba(var(--theme-bg-color), .75);box-shadow:inset var(--shadow-primary), var(--shadow-secondary-inset)}.inp.svelte-shbv4z:focus{border-color:rgb(var(--color-success))}.inp.svelte-shbv4z:invalid,.inp.invalid.svelte-shbv4z{border-color:rgb(var(--color-danger))}",
