...
const Progress = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1kjumgy"}"${add_attribute("title", titleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)} role="${"progressbar"}" aria-valuemin="${"0"}" aria-valuemax="${"100"}"${add_attribute("aria-valuenow", val, 0)}${add_attribute("style", `${getBorderRadius(borderRadius)}`, 0)}>
...
const css$b = {
	code: ".card.svelte-19a10oz.svelte-19a10oz{display:flex;flex-direction:column;flex:none;max-width:100%}.images.svelte-19a10oz.svelte-19a10oz{width:100%;height:100px;overflow:hidden;box-shadow:var(--shadow-primary);border-radius:var(--border-radius)}h5.svelte-19a10oz.svelte-19a10oz{height:calc(var(--font-line-height) * 2);overflow:hidden}.ava-section.svelte-19a10oz.svelte-19a10oz{display:flex;align-items:center}.ava-section.svelte-19a10oz span.svelte-19a10oz{overflow:hidden;font-size:.7rem;padding:0 var(--screen-padding)}.ava-section.svelte-19a10oz span p.svelte-19a10oz{font-size:.6rem}.ava-section.svelte-19a10oz span p.svelte-19a10oz,.ava-section.svelte-19a10oz span h3.svelte-19a10oz{max-width:100%;line-height:1.4;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}",
	map: "{\"version\":3,\"file\":\"CharityCard.svelte\",\"sources\":[\"CharityCard.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Picture, Rate, Progress, Avatar } from '../components'\\n    import { Swipe, SwipeItem } from '../plugins'\\n\\n    export let src = undefined\\n    export let title = undefined\\n    export let percent = undefined\\n    export let orgHead = undefined\\n    export let orgHeadSrc = undefined\\n    export let organization = undefined\\n</script>\\n\\n<div class=\\\"card\\\">\\n\\n    <div class=\\\"images\\\">\\n        <Swipe>\\n            <SwipeItem>\\n                <Picture {src} alt={title}/>\\n            </SwipeItem>\\n            <SwipeItem>\\n                <Picture {src} alt={title}/>\\n            </SwipeItem>\\n            <SwipeItem>\\n                <Picture {src} alt={title}/>\\n            </SwipeItem>\\n            <SwipeItem>\\n                <Picture {src} alt={title}/>\\n            </SwipeItem>\\n            <SwipeItem>\\n                <Picture {src} alt={title}/>\\n            </SwipeItem>\\n        </Swipe>\\n    </div>\\n\\n    <Progress value={percent} borderRadius=\\\"0 0\\\"/>\\n\\n    <h5>{title}</h5>\\n\\n    <p class=\\\"text-center\\\" style=\\\"padding-top: 4px\\\">\\n        <Rate size=\\\"small\\\"/>\\n    </p>\\n\\n    <footer class=\\\"ava-section\\\">\\n        <Avatar src={orgHeadSrc} alt=\\\"avatar\\\"/>\\n\\n        <span>\\n            <h3>{orgHead}</h3>\\n            <p>{organization}</p>\\n        </span>\\n    </footer>\\n</div>\\n\\n<style>\\n    .card {\\n        display: flex;\\n        flex-direction: column;\\n        flex: none;\\n        max-width: 100%;\\n    }\\n\\n    .images {\\n        width: 100%;\\n        height: 100px;\\n        overflow: hidden;\\n        box-shadow: var(--shadow-primary);\\n        border-radius: var(--border-radius);\\n    }\\n\\n    h5 {\\n        height: calc(var(--font-line-height) * 2);\\n        overflow: hidden;\\n    }\\n\\n    .ava-section {\\n        display: flex;\\n        align-items: center;\\n    }\\n\\n    .ava-section span {\\n        overflow: hidden;\\n        font-size: .7rem;\\n        padding: 0 var(--screen-padding);\\n    }\\n\\n    .ava-section span p {\\n        font-size: .6rem;\\n    }\\n\\n    .ava-section span p,\\n    .ava-section span h3 {\\n        max-width: 100%;\\n        line-height: 1.4;\\n        overflow: hidden;\\n        white-space: nowrap;\\n        text-overflow: ellipsis;\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAqDI,KAAK,8BAAC,CAAC,AACH,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,IAAI,CAAE,IAAI,CACV,SAAS,CAAE,IAAI,AACnB,CAAC,AAED,OAAO,8BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACjC,aAAa,CAAE,IAAI,eAAe,CAAC,AACvC,CAAC,AAED,EAAE,8BAAC,CAAC,AACA,MAAM,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACzC,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,YAAY,8BAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACvB,CAAC,AAED,2BAAY,CAAC,IAAI,eAAC,CAAC,AACf,QAAQ,CAAE,MAAM,CAChB,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,CAAC,CAAC,IAAI,gBAAgB,CAAC,AACpC,CAAC,AAED,2BAAY,CAAC,IAAI,CAAC,CAAC,eAAC,CAAC,AACjB,SAAS,CAAE,KAAK,AACpB,CAAC,AAED,2BAAY,CAAC,IAAI,CAAC,gBAAC,CACnB,2BAAY,CAAC,IAAI,CAAC,EAAE,eAAC,CAAC,AAClB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,QAAQ,CAAE,MAAM,CAChB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,QAAQ,AAC3B,CAAC\"}"
};
...
const CharityCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"card svelte-19a10oz"}">

    <div class="${"images svelte-19a10oz"}">
    ...
    <h5 class="${"svelte-19a10oz"}">${escape(title)}</h5>

    <p class="${"text-center"}" style="${"padding-top: 4px"}">
        ${validate_component(Rate, "Rate").$$render($$result, { size: "small" }, {}, {})}
    </p>

    <footer class="${"ava-section svelte-19a10oz"}">
        ${validate_component(Avatar, "Avatar").$$render($$result, { src: orgHeadSrc, alt: "avatar" }, {}, {})}

        <span class="${"svelte-19a10oz"}">
            <h3 class="${"svelte-19a10oz"}">${escape(orgHead)}</h3>
            <p class="${"svelte-19a10oz"}">${escape(organization)}</p>
        </span>
    </footer>
</div>`;
});
...
<section class="${"container"}">
    <section class="${"top svelte-p91g5c"}">
        <div class="${"top-pic svelte-p91g5c"}">
            ${validate_component(Swipe, "Swipe").$$render($$result, {}, {}, {
		default: () => `
                ${validate_component(SwipeItem, "SwipeItem").$$render($$result, {}, {}, {
			default: () => `
        ...
        <ul class="${"options svelte-p91g5c"}">
            <li class="${"svelte-p91g5c"}">
    ...
    <section class="${"rate-section svelte-p91g5c"}">
        <div class="${"ava-section svelte-p91g5c"}">
		...
		{}
            ...
            <span class="${"svelte-p91g5c"}">
                <h3 class="${"svelte-p91g5c"}">Tina Kandelaki</h3>
                <p class="${"svelte-p91g5c"}">ORG charity charitify</p>
            </span>
        </div>
    ...
    <h1 class="${"svelte-p91g5c"}">The main title</h1>
...
<div class="${"container"}">
    ...
    <ul class="${"cards svelte-p91g5c"}">
        ${each(cards, card => `<li class="${"svelte-p91g5c"}">
