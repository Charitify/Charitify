...
const css$4 = {
	code: ".inp.svelte-6it5nr{width:100%;flex:1 1 0;color:inherit;border-radius:var(--border-radius);min-width:var(--min-interactive-size);min-height:var(--min-interactive-size);border:2px solid rgba(var(--color-black), .1);background-color:rgba(var(--theme-bg-color), .75);box-shadow:inset var(--shadow-primary), var(--shadow-secondary-inset)}.inp.svelte-6it5nr:focus{border-color:rgb(var(--color-success))}.inp.svelte-6it5nr:invalid,.inp.invalid.svelte-6it5nr{border-color:rgb(var(--color-danger))}",
