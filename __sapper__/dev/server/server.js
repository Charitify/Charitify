...
const Progress = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${escape(null_to_empty(classProp)) + " svelte-eb7mkp"}"${add_attribute("title", titleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)} role="${"progressbar"}" aria-valuemin="${"0"}" aria-valuemax="${"100"}"${add_attribute("aria-valuenow", val, 0)}>
    <div class="${"progress-inner-frame svelte-eb7mkp"}">
        <div class="${"progress-core svelte-eb7mkp"}"${add_attribute("style", `width:${val}%`, 0)}></div>
    </div>
</div>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<ul>
		...
		<li><a rel="${"prefetch"}" href="${"blog"}" class="${["svelte-1uar9t", segment === "blog" ? "selected" : ""].join(" ").trim()}">blog</a></li>
	</ul>
...
<section class="${"container"}">
    <section class="${"top svelte-ycbgek"}">
        <div class="${"top-pic svelte-ycbgek"}">
        ...
        <ul class="${"options svelte-ycbgek"}">
            <li class="${"svelte-ycbgek"}">
    ...
    <section class="${"rate-section svelte-ycbgek"}">
        <div class="${"ava-section svelte-ycbgek"}">
		...
		{}
            ...
            <span class="${"svelte-ycbgek"}">
                <h3 class="${"svelte-ycbgek"}">Tina Kandelaki</h3>
                <p class="${"svelte-ycbgek"}">ORG charity charitify</p>
            </span>
        </div>
    ...
    <h1 class="${"svelte-ycbgek"}">The main title</h1>
...
<h1 class="${"svelte-ycbgek"}">Charitify - is the application for helping those in need.</h1>
