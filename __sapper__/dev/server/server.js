...
<section class="${"top-wrap svelte-omfi2y"}">
    <section class="${"top svelte-omfi2y"}">
        <div class="${"top-pic svelte-omfi2y"}">
        ...
        <ul class="${"options svelte-omfi2y"}">
            <li class="${"svelte-omfi2y"}">
    ...
    <h1 class="${"svelte-omfi2y"}">The main title</h1>
...
<h1 class="${"svelte-omfi2y"}">Charitify - is the application for helping those in need.</h1>
