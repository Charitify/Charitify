...
const css$e = {
	code: ".item.svelte-11epvv9{border-radius:var(--border-radius);box-shadow:inset var(--shadow-primary);background-color:rgba(var(--theme-bg-color))}",
	map: "{\"version\":3,\"file\":\"ListItems.svelte\",\"sources\":[\"ListItems.svelte\"],\"sourcesContent\":[\"<script>\\n    import AvatarAndName from './AvatarAndName.svelte'\\n\\n    export let amount = 1\\n\\n    $: listArr = [...(new Array(Number.isFinite(+amount) ? +amount : 1))]\\n</script>\\n\\n{#each listArr as item}\\n    <section class=\\\"item container\\\">\\n        <br>\\n        <AvatarAndName\\n                src=\\\"https://placeimg.com/300/300/people\\\"\\n                title=\\\"Tina Kandelaki\\\"\\n                subtitle=\\\"ORG charity charitify\\\"\\n        />\\n        <br>\\n    </section>\\n    <br>\\n{/each}\\n\\n<style>\\n    .item {\\n        border-radius: var(--border-radius);\\n        box-shadow: inset var(--shadow-primary);\\n        background-color: rgba(var(--theme-bg-color));\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAsBI,KAAK,eAAC,CAAC,AACH,aAAa,CAAE,IAAI,eAAe,CAAC,CACnC,UAAU,CAAE,KAAK,CAAC,IAAI,gBAAgB,CAAC,CACvC,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,AACjD,CAAC\"}"
};
...
const ListItems = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${each(listArr, item => `<section class="${"item container svelte-11epvv9"}">
        <br>
...
<div class="${"container"}">
    ...
    <div class="${"search svelte-i75ym8"}">
