...
<section class="${"top-wrap svelte-enxug"}">
    <section class="${"top svelte-enxug"}">
        <div class="${"top-pic svelte-enxug"}">
        ...
        <ul class="${"options svelte-enxug"}">
            <li class="${"svelte-enxug"}">
    ...
    <h1 class="${"svelte-enxug"}">The main title</h1>
...
<h1 class="${"svelte-enxug"}">Charitify - is the application for helping those in need.</h1>
