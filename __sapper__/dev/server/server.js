...
const Progress = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1v0u557"}"${add_attribute("title", titleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)} role="${"progressbar"}" aria-valuemin="${"0"}" aria-valuemax="${"100"}"${add_attribute("aria-valuenow", val, 0)}${add_attribute("style", `${getBorderRadius(borderRadius)}`, 0)}>
    <div class="${"progress-inner-frame svelte-1v0u557"}">
        <div class="${"progress-core svelte-1v0u557"}"${add_attribute("style", `width:${val}%;`, 0)}></div>
    </div>
</div>`;
});
...
const css$b = {
	code: ".card.svelte-zfbadj.svelte-zfbadj{display:flex;flex-direction:column;flex:none;max-width:100%}.images.svelte-zfbadj.svelte-zfbadj{width:100%;height:100px;overflow:hidden;box-shadow:var(--shadow-primary);border-radius:var(--border-radius)}h5.svelte-zfbadj.svelte-zfbadj{--card-line-height:1.4;line-height:var(--card-line-height);height:calc(var(--font-size) * (var(--card-line-height) / 1.2) * 2);overflow:hidden}.ava-section.svelte-zfbadj.svelte-zfbadj{display:flex;align-items:center}.ava-section.svelte-zfbadj span.svelte-zfbadj{overflow:hidden;font-size:.7rem;padding:0 var(--screen-padding)}.ava-section.svelte-zfbadj span p.svelte-zfbadj{font-size:.6rem}.ava-section.svelte-zfbadj span p.svelte-zfbadj,.ava-section.svelte-zfbadj span h3.svelte-zfbadj{max-width:100%;line-height:1.4;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}",
...
const CharityCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"card svelte-zfbadj"}">

    <div class="${"images svelte-zfbadj"}">
    ...
    <h5 class="${"svelte-zfbadj"}">${escape(title)}</h5>

    <p class="${"text-center"}" style="${"padding-top: var(--screen-padding)"}">
        ${validate_component(Rate, "Rate").$$render($$result, { size: "small" }, {}, {})}
    </p>

    <footer class="${"ava-section svelte-zfbadj"}">
        ${validate_component(Avatar, "Avatar").$$render($$result, { src: orgHeadSrc, alt: "avatar" }, {}, {})}

        <span class="${"svelte-zfbadj"}">
            <h3 class="${"svelte-zfbadj"}">${escape(orgHead)}</h3>
            <p class="${"svelte-zfbadj"}">${escape(organization)}</p>
        </span>
    </footer>
</div>`;
});
