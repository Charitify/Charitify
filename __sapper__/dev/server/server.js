...
const Swipe = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"swipe-panel svelte-wqpzbz"}">
    <div class="${"swipe-item-wrapper svelte-wqpzbz"}"${add_attribute("this", swipeWrapper, 1)}>
        <div class="${"swipeable-items svelte-wqpzbz"}">
            <div class="${"swipeable-slot-wrapper svelte-wqpzbz"}">
                ${$$slots.default ? $$slots.default({}) : ``}
            </div>
        </div>
    </div>
    <div class="${"swipe-handler svelte-wqpzbz"}"${add_attribute("this", swipeHandler, 1)}></div>
    ${showIndicators
	? `<div class="${"swipe-indicator swipe-indicator-inside svelte-wqpzbz"}">
            ${each(indicators, (x, i) => `<span class="${"dot " + escape(activeIndicator == i ? "is-active" : "") + " svelte-wqpzbz"}"></span>`)}
        </div>`
	: ``}
...
const css$1 = {
	code: ".swipeable-item.svelte-1l8yv16{position:absolute;top:0;bottom:0;left:0;right:0;transition-timing-function:ease-out}",
	map: "{\"version\":3,\"file\":\"SwipeItem.svelte\",\"sources\":[\"SwipeItem.svelte\"],\"sourcesContent\":[\"<script>\\n    export let classes = '';\\n</script>\\n\\n<style>\\n    .swipeable-item {\\n        position: absolute;\\n        top: 0;\\n        bottom: 0;\\n        left: 0;\\n        right: 0;\\n        transition-timing-function: ease-out;\\n    }\\n</style>\\n\\n<div class=\\\"swipeable-item {classes}\\\">\\n    <slot />\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAKI,eAAe,eAAC,CAAC,AACb,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,0BAA0B,CAAE,QAAQ,AACxC,CAAC\"}"
};
...
const SwipeItem = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"swipeable-item " + escape(classes) + " svelte-1l8yv16"}">
    ${$$slots.default ? $$slots.default({}) : ``}
</div>`;
});
