...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    ${each(imagesArr, img => `<li class="${"svelte-113nkvq"}">
...
const CharityCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"images-wrap svelte-do16pj"}">
        ${validate_component(Carousel, "Carousel").$$render($$result, { images: [src, src, src] }, {}, {})}
    </div>
