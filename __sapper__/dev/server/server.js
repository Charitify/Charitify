...
const css$3 = {
	code: ".rate.svelte-1peopo6.svelte-1peopo6{display:flex;margin:calc(var(--screen-padding) * -1 / 3)}li.svelte-1peopo6.svelte-1peopo6{padding:calc(var(--screen-padding) / 3)}.rate.svelte-1peopo6 li.svelte-1peopo6{-webkit-filter:drop-shadow(var(--shadow-primary));filter:drop-shadow(var(--shadow-primary))}",
	map: "{\"version\":3,\"file\":\"Rate.svelte\",\"sources\":[\"Rate.svelte\"],\"sourcesContent\":[\"<script>\\n    import Icon from './Icon.svelte'\\n\\n    export let is = 'danger'\\n    export let size = 'medium' // small|medium|mig\\n</script>\\n\\n<ul class=\\\"rate\\\">\\n    <li>\\n        <Icon {is} {size} type=\\\"heart-filled\\\"/>\\n    </li>\\n    <li>\\n        <Icon {is} {size} type=\\\"heart-filled\\\"/>\\n    </li>\\n    <li>\\n        <Icon {is} {size} type=\\\"heart-filled\\\"/>\\n    </li>\\n    <li>\\n        <Icon {is} {size} type=\\\"heart-filled\\\"/>\\n    </li>\\n    <li>\\n        <Icon {is} {size} type=\\\"heart-filled\\\"/>\\n    </li>\\n</ul>\\n\\n<style>\\n    .rate {\\n        display: flex;\\n        margin: calc(var(--screen-padding) * -1 / 3);\\n    }\\n\\n    li {\\n        padding: calc(var(--screen-padding) / 3);\\n    }\\n\\n    .rate li {\\n        -webkit-filter: drop-shadow(var(--shadow-primary));\\n        filter: drop-shadow(var(--shadow-primary));\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA0BI,KAAK,8BAAC,CAAC,AACH,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,CAAC,CAAC,AAChD,CAAC,AAED,EAAE,8BAAC,CAAC,AACA,OAAO,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,AAC5C,CAAC,AAED,oBAAK,CAAC,EAAE,eAAC,CAAC,AACN,cAAc,CAAE,YAAY,IAAI,gBAAgB,CAAC,CAAC,CAClD,MAAM,CAAE,YAAY,IAAI,gBAAgB,CAAC,CAAC,AAC9C,CAAC\"}"
};
...
const Rate = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"rate svelte-1peopo6"}">
    <li class="${"svelte-1peopo6"}">
...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${add_attribute("id", id, 0)}${add_attribute("href", href, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-o6g7w0"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </a>`
	: `${htmlFor
		? `<label${add_attribute("id", id, 0)} ${disabled ? "disabled" : ""}${add_attribute("for", htmlFor, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-o6g7w0"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </label>`
		: `<button${add_attribute("id", id, 0)}${add_attribute("type", type, 0)} ${disabled ? "disabled" : ""}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-o6g7w0"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`}`}`;
});
...
const css$8 = {
	code: ".divider.svelte-7u2z10{margin:0;border:none}.info.svelte-7u2z10{background-color:rgb(var(--color-info))}.success.svelte-7u2z10{background-color:rgb(var(--color-success))}.warning.svelte-7u2z10{background-color:rgb(var(--color-warning))}.danger.svelte-7u2z10{background-color:rgb(var(--color-danger))}",
	map: "{\"version\":3,\"file\":\"Divider.svelte\",\"sources\":[\"Divider.svelte\"],\"sourcesContent\":[\"<script>\\n    import { toCSSString, classnames } from '../utils'\\n\\n    export let is = 'info'\\n    export let size = 0\\n    export let width = 2\\n\\n    $: classProp = classnames('divider', is, $$props.class)\\n    $: styleProp = toCSSString({ padding: `${size / 2}px 0`, height: `${width}px` })\\n</script>\\n\\n<hr class={classProp} style={styleProp}>\\n\\n<style>\\n    .divider {\\n        margin: 0;\\n        border: none;\\n    }\\n\\n    .info {\\n        background-color: rgb(var(--color-info));\\n    }\\n\\n    .success {\\n        background-color: rgb(var(--color-success));\\n    }\\n\\n    .warning {\\n        background-color: rgb(var(--color-warning));\\n    }\\n\\n    .danger {\\n        background-color: rgb(var(--color-danger));\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAcI,QAAQ,cAAC,CAAC,AACN,MAAM,CAAE,CAAC,CACT,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,KAAK,cAAC,CAAC,AACH,gBAAgB,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,AAC5C,CAAC,AAED,QAAQ,cAAC,CAAC,AACN,gBAAgB,CAAE,IAAI,IAAI,eAAe,CAAC,CAAC,AAC/C,CAAC,AAED,QAAQ,cAAC,CAAC,AACN,gBAAgB,CAAE,IAAI,IAAI,eAAe,CAAC,CAAC,AAC/C,CAAC,AAED,OAAO,cAAC,CAAC,AACL,gBAAgB,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,AAC9C,CAAC\"}"
};
...
const Progress = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1i5c0kx"}"${add_attribute("title", titleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)} role="${"progressbar"}" aria-valuemin="${"0"}" aria-valuemax="${"100"}"${add_attribute("aria-valuenow", val, 0)}>
    <div class="${"progress-inner-frame svelte-1i5c0kx"}">
        <div class="${"progress-core svelte-1i5c0kx"}"${add_attribute("style", `width:${val}%`, 0)}></div>
    </div>
</div>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"theme-bg container svelte-1uar9t"}">
	<ul>
		<li><a href="${"."}" class="${["svelte-1uar9t", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
		<li><a href="${"about"}" class="${["svelte-1uar9t", segment === "about" ? "selected" : ""].join(" ").trim()}">about</a></li>

		
		<li><a rel="${"prefetch"}" href="${"charity"}" class="${["svelte-1uar9t", segment === "charity" ? "selected" : ""].join(" ").trim()}">charity</a></li>
	</ul>

  <span class="${"nav-actions svelte-1uar9t"}">
    <select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-1uar9t"}">
      <option value="${"ua"}">Ua</option>
      <option value="${"ru"}">Ru</option>
      <option value="${"en"}">En</option>
    </select>
...
const css$b = {
	code: "h1.svelte-1fydlyp.svelte-1fydlyp{text-transform:uppercase;text-align:center}.top.svelte-1fydlyp.svelte-1fydlyp{display:flex;margin-bottom:calc(var(--screen-padding) * 1.5);margin-top:var(--screen-padding)}.top-pic.svelte-1fydlyp.svelte-1fydlyp{z-index:0;flex-grow:1;overflow:hidden;margin-bottom:2px;border-radius:var(--border-radius);box-shadow:var(--shadow-primary)}.options.svelte-1fydlyp.svelte-1fydlyp{flex:0;display:flex;flex-direction:column;margin:calc(var(--screen-padding) * -1 / 2) 0;padding:0 0 0 var(--screen-padding)}.options.svelte-1fydlyp li.svelte-1fydlyp{flex:none;margin:calc(var(--screen-padding) / 2) 0}.rate-section.svelte-1fydlyp.svelte-1fydlyp{display:flex;align-items:baseline;justify-content:space-between;padding:calc(var(--screen-padding) * 1.5) 0}.ava-section.svelte-1fydlyp.svelte-1fydlyp{display:flex;align-items:center;justify-content:space-between}.ava-section.svelte-1fydlyp span.svelte-1fydlyp{font-size:.7rem;padding:0 var(--screen-padding)}.ava-section.svelte-1fydlyp span p.svelte-1fydlyp{font-size:.6rem}.ava-section.svelte-1fydlyp span p.svelte-1fydlyp,.ava-section.svelte-1fydlyp span h3.svelte-1fydlyp{max-width:100%;line-height:1.4;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}",
...
<section class="${"container"}">
    <section class="${"top svelte-1fydlyp"}">
        <div class="${"top-pic svelte-1fydlyp"}">
        ...
        <ul class="${"options svelte-1fydlyp"}">
            <li class="${"svelte-1fydlyp"}">
    ...
    <section class="${"rate-section svelte-1fydlyp"}">
        <div class="${"ava-section svelte-1fydlyp"}">
		...
		{}
            ...
            <span class="${"svelte-1fydlyp"}">
                <h3 class="${"svelte-1fydlyp"}">Tina Kandelaki</h3>
                <p class="${"svelte-1fydlyp"}">ORG charity charitify</p>
            </span>
        </div>
    ...
    <h1 class="${"svelte-1fydlyp"}">The main title</h1>
...
<h1 class="${"svelte-1fydlyp"}">Charitify - is the application for helping those in need.</h1>
...
const css$c = {
	code: "section.svelte-k07h5p{flex-grow:1;padding:var(--screen-padding)}h1.svelte-k07h5p{text-align:center}",
	map: "{\"version\":3,\"file\":\"charity.svelte\",\"sources\":[\"charity.svelte\"],\"sourcesContent\":[\"<svelte:head>\\n\\t<title>Charitify - Charity page and donate.</title>\\n</svelte:head>\\n\\n<style>\\n\\tsection {\\n\\t\\tflex-grow: 1;\\n\\t\\tpadding: var(--screen-padding);\\n\\t}\\n\\n\\th1 {\\n\\t\\ttext-align: center;\\n\\t}\\n\\n\\tp {\\n\\t\\ttext-align: justify;\\n\\t}\\n</style>\\n\\n<section>\\n\\t<h1>Charity</h1>\\n</section>\\n\"],\"names\":[],\"mappings\":\"AAKC,OAAO,cAAC,CAAC,AACR,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,gBAAgB,CAAC,AAC/B,CAAC,AAED,EAAE,cAAC,CAAC,AACH,UAAU,CAAE,MAAM,AACnB,CAAC\"}"
};
...
<section class="${"svelte-k07h5p"}">
	<h1 class="${"svelte-k07h5p"}">Charity</h1>
</section>`;
});
...
const css$d = {
	code: "section.svelte-9pd9lc{flex-grow:1;padding:var(--screen-padding)}h1.svelte-9pd9lc{text-align:center}p.svelte-9pd9lc{text-align:justify}footer.svelte-9pd9lc{padding:var(--screen-padding)}",
	map: "{\"version\":3,\"file\":\"about.svelte\",\"sources\":[\"about.svelte\"],\"sourcesContent\":[\"<script>\\n\\tlet currYear = new Date().getFullYear()\\n</script>\\n\\n<svelte:head>\\n\\t<title>Charitify - Charity page and donate.</title>\\n</svelte:head>\\n\\n<style>\\n\\tsection {\\n\\t\\tflex-grow: 1;\\n\\t\\tpadding: var(--screen-padding);\\n\\t}\\n\\n\\th1 {\\n\\t\\ttext-align: center;\\n\\t}\\n\\n\\tp {\\n\\t\\ttext-align: justify;\\n\\t}\\n\\n\\tfooter {\\n\\t\\tpadding: var(--screen-padding);\\n\\t}\\n</style>\\n\\n<section>\\n\\t<br>\\n\\t<br>\\n\\n\\t<h1>About this project</h1>\\n\\n\\t<br>\\n\\t<br>\\n\\n\\t<p>This is the 'about' page. There's not much here. This is the 'about' page. There's not much here.</p>\\n\\n\\t<br>\\n\\n\\t<p>This is the 'about' page. There's not much here. This is the 'about' page. There's not much here.</p>\\n\\n\\t<br>\\n\\t<br>\\n</section>\\n\\n<footer>\\n\\t<p>© 2019 - {currYear}</p>\\n</footer>\\n\"],\"names\":[],\"mappings\":\"AASC,OAAO,cAAC,CAAC,AACR,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,gBAAgB,CAAC,AAC/B,CAAC,AAED,EAAE,cAAC,CAAC,AACH,UAAU,CAAE,MAAM,AACnB,CAAC,AAED,CAAC,cAAC,CAAC,AACF,UAAU,CAAE,OAAO,AACpB,CAAC,AAED,MAAM,cAAC,CAAC,AACP,OAAO,CAAE,IAAI,gBAAgB,CAAC,AAC/B,CAAC\"}"
};
...
<section class="${"svelte-9pd9lc"}">
	<br>
	<br>

	<h1 class="${"svelte-9pd9lc"}">About this project</h1>

	<br>
	<br>

	<p class="${"svelte-9pd9lc"}">This is the &#39;about&#39; page. There&#39;s not much here. This is the &#39;about&#39; page. There&#39;s not much here.</p>
...
<footer class="${"svelte-9pd9lc"}">
	<p class="${"svelte-9pd9lc"}">© 2019 - ${escape(currYear)}</p>
</footer>`;
});
