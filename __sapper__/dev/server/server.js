...
const css$2 = {
	code: "svg.svelte-10eiudw.svelte-10eiudw{display:inherit}.small.svelte-10eiudw.svelte-10eiudw{width:15px;height:15px}.medium.svelte-10eiudw.svelte-10eiudw{width:22px;height:22px}.big.svelte-10eiudw.svelte-10eiudw{width:35px;height:35px}.primary.svelte-10eiudw .svelte-10eiudw{fill:rgb(var(--color-success));stroke:rgb(var(--color-success))}.warning.svelte-10eiudw .svelte-10eiudw{fill:rgb(var(--color-warning));stroke:rgb(var(--color-warning))}.danger.svelte-10eiudw .svelte-10eiudw{fill:rgb(var(--color-danger));stroke:rgb(var(--color-danger))}",
...
const Icon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<svg${add_attribute("id", id, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-10eiudw"}"${add_attribute("style", styleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}>
    <use${add_attribute("xlink:href", `#ico-${type}`, 0)} class="${"ico_use svelte-10eiudw"}"></use>
</svg>`;
});
...
const css$7 = {
	code: ".btn.svelte-1pc762x:not(.auto){width:100%}.btn.svelte-1pc762x{flex:none;color:inherit;max-width:100%;user-select:none;padding:5px 15px;font-weight:bold;text-align:center;align-items:center;display:inline-flex;justify-content:center;border-radius:var(--border-radius);text-shadow:1px 1px rgba(0, 0, 0, .3)}.small.svelte-1pc762x{padding:5px;min-width:calc(var(--min-interactive-size) / 1.5);min-height:calc(var(--min-interactive-size) / 1.5)}.medium.svelte-1pc762x{padding:5px 10px;min-width:var(--min-interactive-size);min-height:var(--min-interactive-size)}.big.svelte-1pc762x{padding:5px 15px;min-width:calc(var(--min-interactive-size) * 1.5);min-height:calc(var(--min-interactive-size) * 1.5)}.btn.svelte-1pc762x:focus{background-color:rgba(0, 0, 0, 0.1)}.btn.svelte-1pc762x:hover{box-shadow:0 2px rgba(0, 0, 0, 0.2);background-color:rgba(0, 0, 0, 0.1)}.btn.svelte-1pc762x:active{transform:translateY(1px);box-shadow:0 1px rgba(0, 0, 0, 0.2);background-color:rgba(0, 0, 0, 0.1)}.btn.success.svelte-1pc762x{color:var(--color-light-font);background-color:rgb(var(--color-success));box-shadow:0 2px rgb(var(--color-success-dark)), var(--secondary-shadow)}.btn.success.svelte-1pc762x:focus{background-color:rgb(var(--color-success), .85)}.btn.success.svelte-1pc762x:hover{transform:translateY(1px);box-shadow:0 2px rgb(var(--color-success-dark)), var(--secondary-shadow)}.btn.success.svelte-1pc762x:active{transform:translateY(2px);box-shadow:0 1px rgb(var(--color-success-dark)), var(--secondary-shadow)}.btn.warning.svelte-1pc762x{color:var(--color-light-font);background-color:rgb(var(--color-warning));box-shadow:0 2px rgb(var(--color-warning-dark)), var(--secondary-shadow)}.btn.warning.svelte-1pc762x:focus{background-color:rgb(var(--color-warning), .85)}.btn.warning.svelte-1pc762x:hover{transform:translateY(1px);box-shadow:0 2px rgb(var(--color-warning-dark)), var(--secondary-shadow)}.btn.warning.svelte-1pc762x:active{transform:translateY(2px);box-shadow:0 1px rgb(var(--color-warning-dark)), var(--secondary-shadow)}.btn.danger.svelte-1pc762x{color:var(--color-light-font);background-color:rgb(var(--color-danger));box-shadow:0 2px rgb(var(--color-danger-dark)), var(--secondary-shadow)}.btn.danger.svelte-1pc762x:focus{background-color:rgb(var(--color-danger), .85)}.btn.danger.svelte-1pc762x:hover{transform:translateY(1px);box-shadow:0 2px rgb(var(--color-danger-dark)), var(--secondary-shadow)}.btn.danger.svelte-1pc762x:active{transform:translateY(2px);box-shadow:0 1px rgb(var(--color-danger-dark)), var(--secondary-shadow)}@media screen and (min-width: 769px){.btn.success.svelte-1pc762x{box-shadow:0 3px rgb(var(--color-success-dark)), var(--secondary-shadow)}.btn.warning.svelte-1pc762x{box-shadow:0 3px rgb(var(--color-warning-dark)), var(--secondary-shadow)}.btn.danger.svelte-1pc762x{box-shadow:0 3px rgb(var(--color-danger-dark)), var(--secondary-shadow)}}",
	map: "{\"version\":3,\"file\":\"Button.svelte\",\"sources\":[\"Button.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames } from '../utils'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let is = undefined\\n    export let id = undefined\\n    export let href = undefined\\n    export let auto = false\\n    export let type = 'button'\\n    export let size = 'medium'\\n    export let title = undefined\\n    export let disabled = false\\n    export let ariaLabel = undefined\\n\\n    let titleProp = title || ariaLabel\\n    let ariaLabelProp = ariaLabel || title\\n\\n    $: classProp = classnames('btn', is, size, $$props.class, { auto, disabled })\\n</script>\\n\\n{#if href}\\n    <a\\n            {id}\\n            {href}\\n            title={titleProp}\\n            class={classProp}\\n            aria-label={ariaLabelProp}\\n            on:click='{e => !disabled && dispatch(\\\"click\\\", e)}'\\n    >\\n        <slot></slot>\\n    </a>\\n{:else}\\n    <button\\n            {id}\\n            {type}\\n            {disabled}\\n            title={titleProp}\\n            class={classProp}\\n            aria-label={ariaLabelProp}\\n            on:click='{e => !disabled && dispatch(\\\"click\\\", e)}'\\n    >\\n        <slot></slot>\\n    </button>\\n{/if}\\n\\n<style>\\n    .btn:not(.auto) {\\n        width: 100%;\\n    }\\n\\n    .btn {\\n        flex: none;\\n        color: inherit;\\n        max-width: 100%;\\n        user-select: none;\\n        padding: 5px 15px;\\n        font-weight: bold;\\n        text-align: center;\\n        align-items: center;\\n        display: inline-flex;\\n        justify-content: center;\\n        border-radius: var(--border-radius);\\n        text-shadow: 1px 1px rgba(0, 0, 0, .3);\\n    }\\n\\n    .small {\\n        padding: 5px;\\n        min-width: calc(var(--min-interactive-size) / 1.5);\\n        min-height: calc(var(--min-interactive-size) / 1.5);\\n    }\\n\\n    .medium {\\n        padding: 5px 10px;\\n        min-width: var(--min-interactive-size);\\n        min-height: var(--min-interactive-size);\\n    }\\n\\n    .big {\\n        padding: 5px 15px;\\n        min-width: calc(var(--min-interactive-size) * 1.5);\\n        min-height: calc(var(--min-interactive-size) * 1.5);\\n    }\\n\\n    .btn:focus {\\n        background-color: rgba(0, 0, 0, 0.1);\\n    }\\n\\n    .btn:hover {\\n        box-shadow: 0 2px rgba(0, 0, 0, 0.2);\\n        background-color: rgba(0, 0, 0, 0.1);\\n    }\\n\\n    .btn:active {\\n        transform: translateY(1px);\\n        box-shadow: 0 1px rgba(0, 0, 0, 0.2);\\n        background-color: rgba(0, 0, 0, 0.1);\\n    }\\n\\n    /* Success */\\n\\n    .btn.success {\\n        color: var(--color-light-font);\\n        background-color: rgb(var(--color-success));\\n        box-shadow: 0 2px rgb(var(--color-success-dark)), var(--secondary-shadow);\\n    }\\n\\n    .btn.success:focus {\\n        background-color: rgb(var(--color-success), .85);\\n    }\\n\\n    .btn.success:hover {\\n        transform: translateY(1px);\\n        box-shadow: 0 2px rgb(var(--color-success-dark)), var(--secondary-shadow);\\n    }\\n\\n    .btn.success:active {\\n        transform: translateY(2px);\\n        box-shadow: 0 1px rgb(var(--color-success-dark)), var(--secondary-shadow);\\n    }\\n\\n    /* Warning */\\n\\n    .btn.warning {\\n        color: var(--color-light-font);\\n        background-color: rgb(var(--color-warning));\\n        box-shadow: 0 2px rgb(var(--color-warning-dark)), var(--secondary-shadow);\\n    }\\n\\n    .btn.warning:focus {\\n        background-color: rgb(var(--color-warning), .85);\\n    }\\n\\n    .btn.warning:hover {\\n        transform: translateY(1px);\\n        box-shadow: 0 2px rgb(var(--color-warning-dark)), var(--secondary-shadow);\\n    }\\n\\n    .btn.warning:active {\\n        transform: translateY(2px);\\n        box-shadow: 0 1px rgb(var(--color-warning-dark)), var(--secondary-shadow);\\n    }\\n\\n    /* Danger */\\n\\n    .btn.danger {\\n        color: var(--color-light-font);\\n        background-color: rgb(var(--color-danger));\\n        box-shadow: 0 2px rgb(var(--color-danger-dark)), var(--secondary-shadow);\\n    }\\n\\n    .btn.danger:focus {\\n        background-color: rgb(var(--color-danger), .85);\\n    }\\n\\n    .btn.danger:hover {\\n        transform: translateY(1px);\\n        box-shadow: 0 2px rgb(var(--color-danger-dark)), var(--secondary-shadow);\\n    }\\n\\n    .btn.danger:active {\\n        transform: translateY(2px);\\n        box-shadow: 0 1px rgb(var(--color-danger-dark)), var(--secondary-shadow);\\n    }\\n\\n\\n    @media screen and (min-width: 769px) {\\n        .btn.success {\\n            box-shadow: 0 3px rgb(var(--color-success-dark)), var(--secondary-shadow);\\n        }\\n\\n        .btn.warning {\\n            box-shadow: 0 3px rgb(var(--color-warning-dark)), var(--secondary-shadow);\\n        }\\n\\n        .btn.danger {\\n            box-shadow: 0 3px rgb(var(--color-danger-dark)), var(--secondary-shadow);\\
B,CAAC,AAC5E,CAAC,AAGD,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAClC,IAAI,QAAQ,eAAC,CAAC,AACV,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,oBAAoB,CAAC,CAAC,CAAC,CAAC,IAAI,kBAAkB,CAAC,AAC7E,CAAC,AAED,IAAI,QAAQ,eAAC,CAAC,AACV,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,oBAAoB,CAAC,CAAC,CAAC,CAAC,IAAI,kBAAkB,CAAC,AAC7E,CAAC,AAED,IAAI,OAAO,eAAC,CAAC,AACT,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,mBAAmB,CAAC,CAAC,CAAC,CAAC,IAAI,kBAAkB,CAAC,AAC5E,CAAC,AACL,CAAC\"}"
};
...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${add_attribute("id", id, 0)}${add_attribute("href", href, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1pc762x"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </a>`
	: `<button${add_attribute("id", id, 0)}${add_attribute("type", type, 0)} ${disabled ? "disabled" : ""}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1pc762x"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`}`;
});
...
const Progress = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${escape(null_to_empty(classProp)) + " svelte-19ij780"}"${add_attribute("title", titleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)} role="${"progressbar"}" aria-valuemin="${"0"}" aria-valuemax="${"100"}"${add_attribute("aria-valuenow", val, 0)}>
    <div class="${"progress-inner-frame svelte-19ij780"}">
        <div class="${"progress-core svelte-19ij780"}"${add_attribute("style", `width:${val}%`, 0)}></div>
    </div>
</div>`;
});
...
const css$a = {
	code: "nav.svelte-1fltwxb{position:sticky;top:0;z-index:1;display:flex;justify-content:space-between;border-bottom:1px solid rgba(var(--color-danger), .1);box-shadow:var(--secondary-shadow)}.selected.svelte-1fltwxb{position:relative;display:inline-block}.selected.svelte-1fltwxb::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(var(--color-danger));display:block;bottom:-1px}a.svelte-1fltwxb{padding:.8em 0.5em}.nav-actions.svelte-1fltwxb{display:flex;align-items:center}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n  import Icon from './Icon.svelte'\\n  import Button from './Button.svelte'\\n\\n  export let segment;\\n\\n  let isDarkTheme = true\\n\\n  function changeTheme() {\\n    isDarkTheme = !isDarkTheme\\n    document.body.classList.remove('theme-dark')\\n    document.body.classList.remove('theme-light')\\n    document.body.classList.add(isDarkTheme ? 'theme-dark' : 'theme-light')\\n  }\\n</script>\\n\\n<nav class=\\\"theme-bg container\\\">\\n\\t<ul>\\n\\t\\t<li><a class:selected='{segment === undefined}' href='.'>home</a></li>\\n\\t\\t<li><a class:selected='{segment === \\\"about\\\"}' href='about'>about</a></li>\\n\\n\\t\\t<!-- for the blog link, we're using rel=prefetch so that Sapper prefetches\\n\\t\\t     the blog data when we hover over the link or tap it on a touchscreen -->\\n\\t\\t<li><a rel=prefetch class:selected='{segment === \\\"blog\\\"}' href='blog'>blog</a></li>\\n\\t</ul>\\n\\n  <span class=\\\"nav-actions\\\">\\n    <Button on:click={changeTheme} auto size=\\\"small\\\">\\n      En\\n    </Button>\\n    <Button on:click={changeTheme} auto size=\\\"small\\\">\\n      <Icon is=\\\"info\\\" type=\\\"moon\\\" class=\\\"theme-fill-color\\\"/>\\n    </Button>\\n  </span>\\n</nav>\\n\\n<style>\\n  nav {\\n    position: sticky;\\n    top: 0;\\n    z-index: 1;\\n    display: flex;\\n    justify-content: space-between;\\n    border-bottom: 1px solid rgba(var(--color-danger), .1);\\n    box-shadow: var(--secondary-shadow);\\n  }\\n\\n  .selected {\\n    position: relative;\\n    display: inline-block;\\n  }\\n\\n  .selected::after {\\n    position: absolute;\\n    content: \\\"\\\";\\n    width: calc(100% - 1em);\\n    height: 2px;\\n    background-color: rgb(var(--color-danger));\\n    display: block;\\n    bottom: -1px;\\n  }\\n\\n  a {\\n    padding: .8em 0.5em;\\n  }\\n\\n  .nav-actions {\\n    display: flex;\\n    align-items: center;\\n  }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAqCE,GAAG,eAAC,CAAC,AACH,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,EAAE,CAAC,CACtD,UAAU,CAAE,IAAI,kBAAkB,CAAC,AACrC,CAAC,AAED,SAAS,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,AACvB,CAAC,AAED,wBAAS,OAAO,AAAC,CAAC,AAChB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CACvB,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,CAC1C,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AACd,CAAC,AAED,CAAC,eAAC,CAAC,AACD,OAAO,CAAE,IAAI,CAAC,KAAK,AACrB,CAAC,AAED,YAAY,eAAC,CAAC,AACZ,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,AACrB,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"theme-bg container svelte-1fltwxb"}">
	<ul>
		<li><a href="${"."}" class="${["svelte-1fltwxb", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
		<li><a href="${"about"}" class="${["svelte-1fltwxb", segment === "about" ? "selected" : ""].join(" ").trim()}">about</a></li>

		
		<li><a rel="${"prefetch"}" href="${"blog"}" class="${["svelte-1fltwxb", segment === "blog" ? "selected" : ""].join(" ").trim()}">blog</a></li>
	</ul>

  <span class="${"nav-actions svelte-1fltwxb"}">
...
const css$b = {
	code: "h1.svelte-1acbdpe.svelte-1acbdpe{text-transform:uppercase;text-align:center}.top.svelte-1acbdpe.svelte-1acbdpe{display:flex;margin-bottom:calc(var(--screen-padding) * 2);margin-top:var(--screen-padding)}.top-pic.svelte-1acbdpe.svelte-1acbdpe{z-index:0;flex-grow:1;overflow:hidden;border-radius:var(--border-radius);box-shadow:var(--primary-shadow)}.options.svelte-1acbdpe.svelte-1acbdpe{flex:0;display:flex;flex-direction:column;margin:calc(var(--screen-padding) * -1) 0;padding:0 0 0 var(--screen-padding)}.options.svelte-1acbdpe li.svelte-1acbdpe{flex:none;margin:var(--screen-padding) 0}.rate-section.svelte-1acbdpe.svelte-1acbdpe{display:flex;align-items:baseline;justify-content:space-between;padding:calc(var(--screen-padding) * 2) 0}.ava-section.svelte-1acbdpe.svelte-1acbdpe{display:flex;align-items:center;justify-content:space-between}.ava-section.svelte-1acbdpe span.svelte-1acbdpe{font-size:.7rem;padding:0 var(--screen-padding)}.ava-section.svelte-1acbdpe span p.svelte-1acbdpe{font-size:.6rem}.ava-section.svelte-1acbdpe span p.svelte-1acbdpe,.ava-section.svelte-1acbdpe span h3.svelte-1acbdpe{max-width:100%;line-height:1.4;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}",
...
<section class="${"container"}">
    <section class="${"top svelte-1acbdpe"}">
        <div class="${"top-pic svelte-1acbdpe"}">
        ...
        <ul class="${"options svelte-1acbdpe"}">
            <li class="${"svelte-1acbdpe"}">
    ...
    <section class="${"rate-section svelte-1acbdpe"}">
        <div class="${"ava-section svelte-1acbdpe"}">
		...
		{}
            ...
            <span class="${"svelte-1acbdpe"}">
                <h3 class="${"svelte-1acbdpe"}">Tina Kandelaki</h3>
                <p class="${"svelte-1acbdpe"}">ORG charity charitify</p>
            </span>
        </div>
    ...
    <h1 class="${"svelte-1acbdpe"}">The main title</h1>
...
<h1 class="${"svelte-1acbdpe"}">Charitify - is the application for helping those in need.</h1>
...
const Icons = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <svg style="${"display: none"}">
        ...
        <symbol id="${"ico-moon"}" preserveAspectRatio="${"xMidYMid meet"}" viewBox="${"0 0 1280.000000 1074.000000"}">
