...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$6, 66, 4, 1582);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$6, 54, 4, 1321);
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$6, 43, 4, 1092);
...
function playClick() {
	try {
		return document.getElementById("button_click_min").play();
	} catch(e) {
		console.error(e);
	}
}
