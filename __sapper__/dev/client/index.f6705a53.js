...
function create_fragment$b(ctx) {
	...
	let span;
	let h31;
	let t6_value = ({ orgHead: /*orgHead*/ ctx[3] }) + "";
	let t6;
	let t7;
	let p1;
	let t8_value = ({ organization: /*organization*/ ctx[5] }) + "";
	let t8;
	let current;
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(h30_nodes, /*title*/ ctx[1]);
			...
			h31 = claim_element(span_nodes, "H3", { class: true });
		...
		h: function hydrate() {
			...
			add_location(div0, file$b, 14, 4, 387);
			add_location(h30, file$b, 34, 4, 927);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding-top", "8px");
			add_location(p0, file$b, 38, 4, 1001);
			attr_dev(h31, "class", "svelte-xaarx7");
			add_location(h31, file$b, 46, 12, 1198);
			attr_dev(p1, "class", "svelte-xaarx7");
			add_location(p1, file$b, 47, 12, 1231);
			attr_dev(span, "class", "svelte-xaarx7");
			add_location(span, file$b, 45, 8, 1179);
			attr_dev(footer, "class", "ava-section svelte-xaarx7");
			add_location(footer, file$b, 42, 4, 1093);
			attr_dev(div1, "class", "card svelte-xaarx7");
			add_location(div1, file$b, 12, 0, 363);
		},
		m: function mount(target, anchor) {
