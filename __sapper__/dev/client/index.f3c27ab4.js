...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 241, 4, 5978);
			add_location(br1, file$2, 242, 4, 5987);
			add_location(br2, file$2, 246, 4, 6061);
			add_location(br3, file$2, 247, 4, 6070);
			add_location(br4, file$2, 251, 4, 6142);
			add_location(br5, file$2, 252, 4, 6151);
			add_location(br6, file$2, 256, 4, 6224);
			add_location(br7, file$2, 257, 4, 6233);
			add_location(br8, file$2, 261, 4, 6304);
			add_location(br9, file$2, 262, 4, 6313);
			add_location(br10, file$2, 266, 4, 6387);
			add_location(br11, file$2, 267, 4, 6396);
			add_location(br12, file$2, 271, 4, 6468);
			add_location(br13, file$2, 272, 4, 6477);
			add_location(br14, file$2, 276, 4, 6553);
			add_location(br15, file$2, 277, 4, 6562);
			add_location(br16, file$2, 281, 4, 6633);
			add_location(br17, file$2, 282, 4, 6642);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h20, file$2, 215, 4, 5757);
			attr_dev(div2, "class", "containe");
			add_location(div2, file$2, 214, 0, 5730);
			add_location(br6, file$2, 225, 0, 5881);
			add_location(br7, file$2, 226, 0, 5886);
			attr_dev(h11, "class", "svelte-1fydlyp");
			add_location(h11, file$2, 287, 0, 6712);
			add_location(br8, file$2, 289, 0, 6780);
			add_location(br9, file$2, 290, 0, 6785);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file$2, 292, 0, 6791);
			add_location(br10, file$2, 294, 0, 6833);
			add_location(br11, file$2, 295, 0, 6838);
			add_location(p2, file$2, 297, 0, 6844);
			add_location(p3, file$2, 298, 0, 6880);
			add_location(p4, file$2, 299, 0, 6924);
			add_location(br12, file$2, 301, 0, 6970);
			add_location(br13, file$2, 302, 0, 6975);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file$2, 304, 0, 6981);
			add_location(span1, file$2, 308, 8, 7055);
			add_location(li5, file$2, 307, 4, 7042);
			add_location(span2, file$2, 315, 8, 7289);
			add_location(li6, file$2, 314, 4, 7276);
			add_location(span3, file$2, 322, 8, 7484);
			add_location(li7, file$2, 321, 4, 7471);
			add_location(ul1, file$2, 306, 0, 7033);
			add_location(br14, file$2, 330, 0, 7702);
			add_location(br15, file$2, 331, 0, 7707);
			add_location(br16, file$2, 335, 8, 7814);
			add_location(br17, file$2, 337, 8, 7843);
			add_location(br18, file$2, 338, 8, 7856);
			add_location(br19, file$2, 340, 8, 7932);
			add_location(br20, file$2, 341, 8, 7945);
			add_location(br21, file$2, 343, 8, 8034);
			add_location(br22, file$2, 344, 8, 8047);
			add_location(br23, file$2, 346, 8, 8153);
			add_location(br24, file$2, 347, 8, 8166);
			add_location(br25, file$2, 351, 8, 8293);
			add_location(br26, file$2, 352, 8, 8306);
			add_location(br27, file$2, 354, 8, 8413);
			add_location(br28, file$2, 355, 8, 8426);
			add_location(br29, file$2, 357, 8, 8532);
			add_location(br30, file$2, 358, 8, 8545);
			add_location(div3, file$2, 334, 4, 7800);
			add_location(br31, file$2, 362, 8, 8580);
			add_location(br32, file$2, 364, 8, 8618);
			add_location(br33, file$2, 365, 8, 8631);
			add_location(br34, file$2, 367, 8, 8716);
			add_location(br35, file$2, 368, 8, 8729);
			add_location(br36, file$2, 370, 8, 8827);
			add_location(br37, file$2, 371, 8, 8840);
			add_location(br38, file$2, 373, 8, 8938);
			add_location(br39, file$2, 374, 8, 8951);
			add_location(br40, file$2, 378, 8, 9087);
			add_location(br41, file$2, 379, 8, 9100);
			add_location(br42, file$2, 381, 8, 9216);
			add_location(br43, file$2, 382, 8, 9229);
			add_location(br44, file$2, 384, 8, 9344);
			add_location(br45, file$2, 385, 8, 9357);
			add_location(div4, file$2, 361, 4, 8566);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 333, 0, 7713);
			add_location(br46, file$2, 389, 0, 9385);
			add_location(br47, file$2, 390, 0, 9390);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file$2, 392, 0, 9396);
			add_location(br48, file$2, 394, 0, 9439);
			add_location(br49, file$2, 395, 0, 9444);
			add_location(br50, file$2, 400, 4, 9509);
			add_location(br51, file$2, 401, 4, 9518);
			add_location(br52, file$2, 405, 4, 9601);
			add_location(br53, file$2, 406, 4, 9610);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 411, 8, 9699);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 412, 8, 9726);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 413, 8, 9753);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 410, 4, 9671);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 416, 4, 9793);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 417, 4, 9851);
			add_location(br54, file$2, 419, 4, 9900);
			add_location(br55, file$2, 420, 4, 9909);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 422, 4, 9919);
			add_location(br56, file$2, 424, 4, 9971);
			add_location(br57, file$2, 425, 4, 9980);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 427, 4, 9990);
			add_location(section4, file$2, 397, 0, 9450);
			add_location(br58, file$2, 430, 0, 10066);
			add_location(br59, file$2, 431, 0, 10071);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file$2, 433, 0, 10077);
			add_location(br60, file$2, 435, 0, 10112);
			add_location(br61, file$2, 436, 0, 10117);
			add_location(br62, file$2, 440, 0, 10189);
			add_location(br63, file$2, 441, 0, 10194);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file$2, 443, 0, 10200);
			add_location(strong, file$2, 446, 4, 10245);
			add_location(p5, file$2, 445, 0, 10237);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 451, 0, 10354);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
