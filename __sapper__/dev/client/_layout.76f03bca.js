...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br1, file, 26, 1, 646);
			add_location(br2, file, 34, 1, 747);
			add_location(br3, file, 35, 1, 753);
			attr_dev(div1, "class", "list-wrap svelte-1vo7cwi");
			add_location(div1, file, 25, 0, 621);
		},
		m: function mount(target, anchor) {
