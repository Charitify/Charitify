import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, c as create_slot, g as get_slot_context, a as get_slot_changes, t as transition_in, b as transition_out, e as element, f as claim_element, h as children, j as detach_dev, k as attr_dev, l as add_location, m as insert_dev, n as group_outros, o as check_outros, p as binding_callbacks, q as noop, r as assign, u as exclude_internal_props, v as svg_element, x as xlink_attr, w as null_to_empty, y as append_dev, z as create_component, A as space, B as claim_component, C as claim_space, D as mount_component, E as destroy_component, F as createEventDispatcher$1, G as empty, H as set_attributes, I as toggle_class, J as listen_dev, K as set_input_value, L as get_spread_update, M as run_all, N as prop_dev, O as onMount$1, P as destroy_each, Q as text, R as claim_text, T as set_data_dev, U as get_spread_object } from './index.44a3e267.js';
import { createEventDispatcher, setContext, onMount, onDestroy, getContext } from 'svelte/types/runtime';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section, file, 70, 0, 1741);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	let { center = [48.3794, 31.1656] } = $$props;
	let { zoom = 5 } = $$props;
	let map;
	let container;
	...
	function onCreateMap() {
		...
		map.on("dragend", () => dispatch("recentre", { center: map.getCenter() }));
		map.on("load", () => dispatch("ready"));
	}
...
function instance$1($$self, $$props, $$invalidate) {
	...
	const writable_props = ["lon", "lat", "label"];
	...
	$$self.$set = $$props => {
		if ("lon" in $$props) $$invalidate(0, lon = $$props.lon);
...
class MapMarker extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { lon: 0, lat: 1, label: 2 });
		...
		if (/*lon*/ ctx[0] === undefined && !("lon" in props)) {
			console.warn("<MapMarker> was created without expected prop 'lon'");
		}
		...
		if (/*label*/ ctx[2] === undefined && !("label" in props)) {
			console.warn("<MapMarker> was created without expected prop 'label'");
		}
	}
