...
const file$8 = "src/layouts/Header.svelte";
...
const file$9 = "src/layouts/Footer.svelte";
...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(p, file$9, 5, 4, 34);
			attr_dev(footer, "class", "svelte-hgsupk");
			add_location(footer, file$9, 4, 0, 21);
		},
		m: function mount(target, anchor) {
...
const file$a = "src/layouts/Comment.svelte";
...
function create_fragment$a(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h4, file$a, 13, 12, 268);
			attr_dev(sub, "class", "svelte-1ix1pjw");
			add_location(sub, file$a, 14, 12, 297);
			attr_dev(span, "class", "svelte-1ix1pjw");
			add_location(span, file$a, 12, 8, 249);
			attr_dev(br, "class", "small");
			add_location(br, file$a, 17, 8, 344);
			attr_dev(pre, "class", "svelte-1ix1pjw");
			add_location(pre, file$a, 19, 8, 372);
			attr_dev(div, "class", "svelte-1ix1pjw");
			add_location(div, file$a, 11, 4, 235);
			attr_dev(section, "class", "svelte-1ix1pjw");
			add_location(section, file$a, 8, 0, 164);
		},
		m: function mount(target, anchor) {
...
class Comment extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$9, create_fragment$a, safe_not_equal, { src: 0, title: 1, subtitle: 2 });
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-17v5gt1");
			add_location(li, file$b, 59, 12, 1873);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(59:8) {#each imagesArr as img}",
		ctx
	});
...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-17v5gt1");
			add_location(ul, file$b, 57, 4, 1823);
			attr_dev(section, "class", "svelte-17v5gt1");
			add_location(section, file$b, 56, 0, 1809);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_fragment$f(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$f, 14, 4, 419);
			attr_dev(h4, "class", "svelte-do16pj");
			add_location(h4, file$f, 20, 4, 546);
			attr_dev(div1, "class", "rate-wrap svelte-do16pj");
			add_location(div1, file$f, 22, 4, 568);
			add_location(footer, file$f, 26, 4, 637);
			attr_dev(section, "class", "card svelte-do16pj");
			add_location(section, file$f, 13, 0, 392);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file$g, 53, 8, 1833);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
...
function create_fragment$g(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h2, file$g, 48, 0, 1702);
			add_location(br, file$g, 50, 0, 1775);
			attr_dev(ul, "class", "cards svelte-1k1p6bw");
			add_location(ul, file$g, 51, 0, 1780);
		},
		m: function mount(target, anchor) {
...
class CharityCards extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$e, create_fragment$g, safe_not_equal, { amount: 1 });
