...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(h30_nodes, /*title*/ ctx[1]);
		...
		h: function hydrate() {
			...
			add_location(h30, file$b, 36, 4, 979);
