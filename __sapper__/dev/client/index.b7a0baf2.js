...
function create_fragment$b(ctx) {
	...
	const block = {
		c: function create() {
			...
			span = element("span");
			h3 = element("h3");
			t5 = text(/*orgHead*/ ctx[3]);
			t6 = space();
			p = element("p");
			t7 = text(/*organization*/ ctx[5]);
			this.h();
		},
		l: function claim(nodes) {
			...
			t5 = claim_text(h3_nodes, /*orgHead*/ ctx[3]);
			h3_nodes.forEach(detach_dev);
			t6 = claim_space(span_nodes);
			p = claim_element(span_nodes, "P", { class: true });
			var p_nodes = children(p);
			t7 = claim_text(p_nodes, /*organization*/ ctx[5]);
		...
		h: function hydrate() {
			...
			add_location(h3, file$b, 42, 12, 1094);
			attr_dev(p, "class", "svelte-19a10oz");
			add_location(p, file$b, 43, 12, 1125);
			attr_dev(span, "class", "svelte-19a10oz");
			add_location(span, file$b, 41, 8, 1075);
			attr_dev(footer, "class", "ava-section svelte-19a10oz");
			add_location(footer, file$b, 38, 4, 989);
		...
		p: function update(ctx, [dirty]) {
			...
			if (!current || dirty & /*orgHead*/ 8) set_data_dev(t5, /*orgHead*/ ctx[3]);
			if (!current || dirty & /*organization*/ 32) set_data_dev(t7, /*organization*/ ctx[5]);
		},
		i: function intro(local) {
			if (current) return;
