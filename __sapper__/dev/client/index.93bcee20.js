...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-core svelte-q4cvvi");
			attr_dev(div0, "style", div0_style_value = `width:${/*val*/ ctx[1]}%`);
			add_location(div0, file$5, 28, 4, 757);
			attr_dev(div1, "id", /*id*/ ctx[0]);
			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-q4cvvi"));
			...
			add_location(div1, file$5, 18, 0, 537);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 16 && div1_class_value !== (div1_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-q4cvvi"))) {
