...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$8, 34, 8, 942);
			attr_dev(div1, "class", "progress-inner-frame svelte-19ij780");
			add_location(div1, file$8, 33, 4, 899);
			...
			add_location(div2, file$8, 23, 0, 679);
		},
		m: function mount(target, anchor) {
...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$9, 15, 6, 341);
			add_location(li0, file$9, 15, 2, 337);
			attr_dev(a1, "href", "about");
			attr_dev(a1, "class", "svelte-8q888w");
			toggle_class(a1, "selected", /*segment*/ ctx[0] === "about");
			add_location(a1, file$9, 16, 6, 414);
			add_location(li1, file$9, 16, 2, 410);
			attr_dev(a2, "rel", "prefetch");
			attr_dev(a2, "href", "blog");
			attr_dev(a2, "class", "svelte-8q888w");
			toggle_class(a2, "selected", /*segment*/ ctx[0] === "blog");
			add_location(a2, file$9, 20, 6, 648);
			add_location(li2, file$9, 20, 2, 644);
			add_location(ul, file$9, 14, 1, 330);
			attr_dev(button, "type", "button");
			add_location(button, file$9, 23, 2, 738);
			attr_dev(nav, "class", "theme-bg svelte-8q888w");
			add_location(nav, file$9, 13, 0, 306);
