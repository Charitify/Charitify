...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 232, 12, 6141);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 247, 4, 6328);
			add_location(br1, file, 248, 4, 6337);
			add_location(br2, file, 252, 4, 6411);
			add_location(br3, file, 253, 4, 6420);
			add_location(br4, file, 257, 4, 6492);
			add_location(br5, file, 258, 4, 6501);
			add_location(br6, file, 262, 4, 6574);
			add_location(br7, file, 263, 4, 6583);
			add_location(br8, file, 267, 4, 6654);
			add_location(br9, file, 268, 4, 6663);
			add_location(br10, file, 272, 4, 6737);
			add_location(br11, file, 273, 4, 6746);
			add_location(br12, file, 277, 4, 6818);
			add_location(br13, file, 278, 4, 6827);
			add_location(br14, file, 282, 4, 6903);
			add_location(br15, file, 283, 4, 6912);
			add_location(br16, file, 287, 4, 6983);
			add_location(br17, file, 288, 4, 6992);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 139, 8, 3440);
			attr_dev(li0, "class", "svelte-1ytg6rp");
			add_location(li0, file, 160, 12, 4268);
			attr_dev(li1, "class", "svelte-1ytg6rp");
			add_location(li1, file, 163, 12, 4388);
			attr_dev(li2, "class", "svelte-1ytg6rp");
			add_location(li2, file, 166, 12, 4509);
			add_location(br0, file, 170, 16, 4652);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 181, 20, 5003);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 182, 20, 5043);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 183, 20, 5084);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 180, 16, 4951);
			attr_dev(li3, "class", "svelte-1ytg6rp");
			add_location(li3, file, 169, 12, 4631);
			attr_dev(li4, "class", "svelte-1ytg6rp");
			add_location(li4, file, 186, 12, 5164);
			attr_dev(ul0, "class", "options svelte-1ytg6rp");
			add_location(ul0, file, 159, 8, 4235);
			attr_dev(section0, "class", "top svelte-1ytg6rp");
			add_location(section0, file, 138, 4, 3410);
			add_location(br1, file, 193, 4, 5344);
			attr_dev(h3, "class", "svelte-1ytg6rp");
			add_location(h3, file, 201, 16, 5577);
			attr_dev(p0, "class", "svelte-1ytg6rp");
			add_location(p0, file, 202, 16, 5617);
			attr_dev(span0, "class", "svelte-1ytg6rp");
			add_location(span0, file, 200, 12, 5554);
			attr_dev(div1, "class", "ava-section svelte-1ytg6rp");
			add_location(div1, file, 197, 8, 5438);
			attr_dev(section1, "class", "rate-section svelte-1ytg6rp");
			add_location(section1, file, 196, 4, 5399);
			add_location(br2, file, 209, 4, 5718);
			attr_dev(h10, "class", "svelte-1ytg6rp");
			add_location(h10, file, 211, 4, 5728);
			add_location(br3, file, 213, 4, 5757);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 215, 4, 5767);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 137, 0, 3378);
			add_location(br4, file, 220, 0, 5923);
			add_location(br5, file, 221, 0, 5928);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 225, 4, 5987);
			add_location(br6, file, 228, 4, 6070);
			attr_dev(ul1, "class", "cards svelte-1ytg6rp");
			add_location(ul1, file, 230, 4, 6080);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 223, 0, 5934);
			add_location(br7, file, 240, 0, 6240);
			add_location(br8, file, 241, 0, 6245);
			attr_dev(h11, "class", "svelte-1ytg6rp");
			add_location(h11, file, 293, 0, 7062);
			add_location(br9, file, 295, 0, 7130);
			add_location(br10, file, 296, 0, 7135);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 298, 0, 7141);
			add_location(br11, file, 300, 0, 7183);
			add_location(br12, file, 301, 0, 7188);
			add_location(p2, file, 303, 0, 7194);
			add_location(p3, file, 304, 0, 7230);
			add_location(p4, file, 305, 0, 7274);
			add_location(br13, file, 307, 0, 7320);
			add_location(br14, file, 308, 0, 7325);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 310, 0, 7331);
			add_location(span1, file, 314, 8, 7405);
			add_location(li5, file, 313, 4, 7392);
			add_location(span2, file, 321, 8, 7639);
			add_location(li6, file, 320, 4, 7626);
			add_location(span3, file, 328, 8, 7834);
			add_location(li7, file, 327, 4, 7821);
			add_location(ul2, file, 312, 0, 7383);
			add_location(br15, file, 336, 0, 8052);
			add_location(br16, file, 337, 0, 8057);
			add_location(br17, file, 341, 8, 8164);
			add_location(br18, file, 343, 8, 8193);
			add_location(br19, file, 344, 8, 8206);
			add_location(br20, file, 346, 8, 8282);
			add_location(br21, file, 347, 8, 8295);
			add_location(br22, file, 349, 8, 8384);
			add_location(br23, file, 350, 8, 8397);
			add_location(br24, file, 352, 8, 8503);
			add_location(br25, file, 353, 8, 8516);
			add_location(br26, file, 357, 8, 8643);
			add_location(br27, file, 358, 8, 8656);
			add_location(br28, file, 360, 8, 8763);
			add_location(br29, file, 361, 8, 8776);
			add_location(br30, file, 363, 8, 8882);
			add_location(br31, file, 364, 8, 8895);
			add_location(div3, file, 340, 4, 8150);
			add_location(br32, file, 368, 8, 8930);
			add_location(br33, file, 370, 8, 8968);
			add_location(br34, file, 371, 8, 8981);
			add_location(br35, file, 373, 8, 9066);
			add_location(br36, file, 374, 8, 9079);
			add_location(br37, file, 376, 8, 9177);
			add_location(br38, file, 377, 8, 9190);
			add_location(br39, file, 379, 8, 9288);
			add_location(br40, file, 380, 8, 9301);
			add_location(br41, file, 384, 8, 9437);
			add_location(br42, file, 385, 8, 9450);
			add_location(br43, file, 387, 8, 9566);
			add_location(br44, file, 388, 8, 9579);
			add_location(br45, file, 390, 8, 9694);
			add_location(br46, file, 391, 8, 9707);
			add_location(div4, file, 367, 4, 8916);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 339, 0, 8063);
			add_location(br47, file, 395, 0, 9735);
			add_location(br48, file, 396, 0, 9740);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 398, 0, 9746);
			add_location(br49, file, 400, 0, 9789);
			add_location(br50, file, 401, 0, 9794);
			add_location(br51, file, 406, 4, 9859);
			add_location(br52, file, 407, 4, 9868);
			add_location(br53, file, 411, 4, 9951);
			add_location(br54, file, 412, 4, 9960);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 417, 8, 10049);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 418, 8, 10076);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 419, 8, 10103);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 416, 4, 10021);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 422, 4, 10143);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 423, 4, 10201);
			add_location(br55, file, 425, 4, 10250);
			add_location(br56, file, 426, 4, 10259);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 428, 4, 10269);
			add_location(br57, file, 430, 4, 10321);
			add_location(br58, file, 431, 4, 10330);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 433, 4, 10340);
			add_location(section4, file, 403, 0, 9800);
			add_location(br59, file, 436, 0, 10416);
			add_location(br60, file, 437, 0, 10421);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 439, 0, 10427);
			add_location(br61, file, 441, 0, 10462);
			add_location(br62, file, 442, 0, 10467);
			add_location(br63, file, 446, 0, 10539);
			add_location(br64, file, 447, 0, 10544);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 449, 0, 10550);
			add_location(strong, file, 452, 4, 10595);
			add_location(p5, file, 451, 0, 10587);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 457, 0, 10704);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
