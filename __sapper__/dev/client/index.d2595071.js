...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 124, 4, 3446);
			add_location(br1, file$2, 125, 4, 3455);
			add_location(br2, file$2, 129, 4, 3529);
			add_location(br3, file$2, 130, 4, 3538);
			add_location(br4, file$2, 134, 4, 3610);
			add_location(br5, file$2, 135, 4, 3619);
			add_location(br6, file$2, 139, 4, 3692);
			add_location(br7, file$2, 140, 4, 3701);
			add_location(br8, file$2, 144, 4, 3772);
			add_location(br9, file$2, 145, 4, 3781);
			add_location(br10, file$2, 149, 4, 3855);
			add_location(br11, file$2, 150, 4, 3864);
			add_location(br12, file$2, 154, 4, 3936);
			add_location(br13, file$2, 155, 4, 3945);
			add_location(br14, file$2, 159, 4, 4021);
			add_location(br15, file$2, 160, 4, 4030);
			add_location(br16, file$2, 164, 4, 4101);
			add_location(br17, file$2, 165, 4, 4110);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section1, file$2, 98, 4, 2789);
			add_location(span0, file$2, 102, 4, 2883);
			add_location(br2, file$2, 110, 4, 3167);
			add_location(br3, file$2, 111, 4, 3176);
			attr_dev(h10, "class", "svelte-g87fnk");
			add_location(h10, file$2, 113, 4, 3186);
			add_location(br4, file$2, 115, 4, 3215);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 117, 4, 3225);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 43, 0, 848);
			attr_dev(h11, "class", "svelte-g87fnk");
			add_location(h11, file$2, 170, 0, 4180);
			add_location(br5, file$2, 172, 0, 4248);
			add_location(br6, file$2, 173, 0, 4253);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 175, 0, 4259);
			add_location(br7, file$2, 177, 0, 4301);
			add_location(br8, file$2, 178, 0, 4306);
			add_location(p1, file$2, 180, 0, 4312);
			add_location(p2, file$2, 181, 0, 4348);
			add_location(p3, file$2, 182, 0, 4392);
			add_location(br9, file$2, 184, 0, 4438);
			add_location(br10, file$2, 185, 0, 4443);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 187, 0, 4449);
			add_location(span1, file$2, 191, 8, 4523);
			add_location(li5, file$2, 190, 4, 4510);
			add_location(span2, file$2, 198, 8, 4757);
			add_location(li6, file$2, 197, 4, 4744);
			add_location(span3, file$2, 205, 8, 4952);
			add_location(li7, file$2, 204, 4, 4939);
			add_location(ul1, file$2, 189, 0, 4501);
			add_location(br11, file$2, 213, 0, 5170);
			add_location(br12, file$2, 214, 0, 5175);
			add_location(br13, file$2, 218, 8, 5282);
			add_location(br14, file$2, 220, 8, 5311);
			add_location(br15, file$2, 221, 8, 5324);
			add_location(br16, file$2, 223, 8, 5400);
			add_location(br17, file$2, 224, 8, 5413);
			add_location(br18, file$2, 226, 8, 5502);
			add_location(br19, file$2, 227, 8, 5515);
			add_location(br20, file$2, 229, 8, 5621);
			add_location(br21, file$2, 230, 8, 5634);
			add_location(br22, file$2, 234, 8, 5761);
			add_location(br23, file$2, 235, 8, 5774);
			add_location(br24, file$2, 237, 8, 5881);
			add_location(br25, file$2, 238, 8, 5894);
			add_location(br26, file$2, 240, 8, 6000);
			add_location(br27, file$2, 241, 8, 6013);
			add_location(div1, file$2, 217, 4, 5268);
			add_location(br28, file$2, 245, 8, 6048);
			add_location(br29, file$2, 247, 8, 6086);
			add_location(br30, file$2, 248, 8, 6099);
			add_location(br31, file$2, 250, 8, 6184);
			add_location(br32, file$2, 251, 8, 6197);
			add_location(br33, file$2, 253, 8, 6295);
			add_location(br34, file$2, 254, 8, 6308);
			add_location(br35, file$2, 256, 8, 6406);
			add_location(br36, file$2, 257, 8, 6419);
			add_location(br37, file$2, 261, 8, 6555);
			add_location(br38, file$2, 262, 8, 6568);
			add_location(br39, file$2, 264, 8, 6684);
			add_location(br40, file$2, 265, 8, 6697);
			add_location(br41, file$2, 267, 8, 6812);
			add_location(br42, file$2, 268, 8, 6825);
			add_location(div2, file$2, 244, 4, 6034);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 216, 0, 5181);
			add_location(br43, file$2, 272, 0, 6853);
			add_location(br44, file$2, 273, 0, 6858);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 275, 0, 6864);
			add_location(br45, file$2, 277, 0, 6907);
			add_location(br46, file$2, 278, 0, 6912);
			add_location(br47, file$2, 283, 4, 6977);
			add_location(br48, file$2, 284, 4, 6986);
			add_location(br49, file$2, 288, 4, 7069);
			add_location(br50, file$2, 289, 4, 7078);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 294, 8, 7167);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 295, 8, 7194);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 296, 8, 7221);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 293, 4, 7139);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 299, 4, 7261);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 300, 4, 7319);
			add_location(br51, file$2, 302, 4, 7368);
			add_location(br52, file$2, 303, 4, 7377);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 305, 4, 7387);
			add_location(br53, file$2, 307, 4, 7439);
			add_location(br54, file$2, 308, 4, 7448);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 310, 4, 7458);
			add_location(section4, file$2, 280, 0, 6918);
			add_location(br55, file$2, 313, 0, 7534);
			add_location(br56, file$2, 314, 0, 7539);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 316, 0, 7545);
			add_location(br57, file$2, 322, 0, 7669);
			add_location(br58, file$2, 323, 0, 7674);
			add_location(br59, file$2, 327, 0, 7746);
			add_location(br60, file$2, 328, 0, 7751);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 330, 0, 7757);
			add_location(strong, file$2, 333, 4, 7802);
			add_location(p4, file$2, 332, 0, 7794);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 338, 0, 7911);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
