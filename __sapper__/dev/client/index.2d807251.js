...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file$g, 50, 4, 1749);
			add_location(br, file$g, 52, 4, 1809);
		},
		m: function mount(target, anchor) {
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file$g, 56, 8, 1873);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(56:4) {#each cards as card}",
		ctx
	});
...
function create_fragment$g(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(ul, file$g, 54, 0, 1820);
		},
		m: function mount(target, anchor) {
