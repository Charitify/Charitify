...
function create_fragment$d(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-yty9nz");
			add_location(h4, file$d, 12, 8, 230);
			attr_dev(sub, "class", "svelte-yty9nz");
			add_location(sub, file$d, 13, 8, 255);
			attr_dev(span, "class", "svelte-yty9nz");
			add_location(span, file$d, 11, 4, 215);
			attr_dev(section, "class", "svelte-yty9nz");
