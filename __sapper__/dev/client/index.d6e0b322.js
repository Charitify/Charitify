...
function create_fragment$f(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$f, 12, 4, 353);
			attr_dev(h4, "class", "svelte-do16pj");
			add_location(h4, file$f, 18, 4, 467);
			attr_dev(div1, "class", "rate-wrap svelte-do16pj");
			add_location(div1, file$f, 20, 4, 489);
			add_location(footer, file$f, 24, 4, 558);
			attr_dev(section, "class", "card svelte-do16pj");
			add_location(section, file$f, 11, 0, 326);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function instance$d($$self, $$props, $$invalidate) {
	...
	const writable_props = ["title", "percent", "orgHead", "orgHeadSrc", "organization"];
	...
	return [title, percent, orgHead, orgHeadSrc, organization];
}
