...
function create_fragment$c(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-1rz2h68");
			add_location(h4, file$c, 12, 8, 230);
			attr_dev(p, "class", "svelte-1rz2h68");
			add_location(p, file$c, 13, 8, 255);
			attr_dev(span, "class", "svelte-1rz2h68");
			add_location(span, file$c, 11, 4, 215);
			attr_dev(section, "class", "svelte-1rz2h68");
