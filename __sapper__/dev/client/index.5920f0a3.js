...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			set_style(h51, "font-size", ".8em");
			add_location(h51, file, 71, 0, 2427);
			add_location(span9, file, 71, 45, 2472);
			add_location(h6, file, 72, 0, 2495);
			add_location(span10, file, 72, 21, 2516);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 74, 0, 2540);
			attr_dev(section, "class", "container");
			add_location(section, file, 78, 0, 2595);
		},
