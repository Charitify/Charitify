...
const file$9 = "src/components/ProgressNext.svelte";
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file$9, 37, 12, 1008);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
		},
...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$9, 35, 4, 936);
			...
			add_location(div1, file$9, 25, 0, 716);
		},
		m: function mount(target, anchor) {
...
class ProgressNext extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$9, create_fragment$9, safe_not_equal, { id: 0, value: 6, title: 7, ariaLabel: 8 });
...
const file$a = "src/components/Nav.svelte";
...
function create_fragment$a(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$a, 20, 6, 447);
			add_location(li0, file$a, 20, 2, 443);
			attr_dev(a1, "href", "about");
			attr_dev(a1, "class", "svelte-1uar9t");
			toggle_class(a1, "selected", /*segment*/ ctx[0] === "about");
			add_location(a1, file$a, 21, 6, 520);
			add_location(li1, file$a, 21, 2, 516);
			attr_dev(a2, "rel", "prefetch");
			attr_dev(a2, "href", "charity");
			attr_dev(a2, "class", "svelte-1uar9t");
			toggle_class(a2, "selected", /*segment*/ ctx[0] === "charity");
			add_location(a2, file$a, 25, 6, 754);
			add_location(li2, file$a, 25, 2, 750);
			add_location(ul, file$a, 19, 1, 436);
			option0.__value = "ua";
			option0.value = option0.__value;
			add_location(option0, file$a, 30, 6, 959);
			option1.__value = "ru";
			option1.value = option1.__value;
			add_location(option1, file$a, 31, 6, 996);
			option2.__value = "en";
			option2.value = option2.__value;
			add_location(option2, file$a, 32, 6, 1033);
			attr_dev(select, "name", "lang");
			attr_dev(select, "id", "lang");
			attr_dev(select, "class", "btn small lang-select svelte-1uar9t");
			add_location(select, file$a, 29, 4, 884);
			attr_dev(span, "class", "nav-actions svelte-1uar9t");
			add_location(span, file$a, 28, 2, 853);
			attr_dev(nav, "class", "theme-bg container svelte-1uar9t");
			add_location(nav, file$a, 18, 0, 402);
		},
		m: function mount(target, anchor) {
