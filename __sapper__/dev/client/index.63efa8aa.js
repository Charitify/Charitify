...
function create_fragment$f(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p, file$f, 9, 4, 114);
			attr_dev(section, "class", "title svelte-24owzm");
...
function create_fragment$g(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file$g, 5, 4, 46);
			attr_dev(li1, "class", "svelte-115iut2");
			add_location(li1, file$g, 8, 4, 142);
			attr_dev(li2, "class", "svelte-115iut2");
			add_location(li2, file$g, 11, 4, 239);
			add_location(br, file$g, 15, 8, 350);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$g, 26, 12, 621);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$g, 27, 12, 653);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$g, 28, 12, 686);
			attr_dev(datalist, "id", "sum-suggestions");
			add_location(datalist, file$g, 25, 8, 577);
			attr_dev(li3, "class", "svelte-115iut2");
			add_location(li3, file$g, 14, 4, 337);
			attr_dev(li4, "class", "svelte-115iut2");
			add_location(li4, file$g, 31, 4, 742);
			attr_dev(ul, "class", "options svelte-115iut2");
			add_location(ul, file$g, 4, 0, 21);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li0);
