...
function create_fragment$e(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-16uyabk");
			add_location(h4, file$d, 12, 8, 230);
			attr_dev(sub, "class", "svelte-16uyabk");
			add_location(sub, file$d, 13, 8, 255);
			attr_dev(span, "class", "svelte-16uyabk");
			add_location(span, file$d, 11, 4, 215);
			attr_dev(section, "class", "svelte-16uyabk");
