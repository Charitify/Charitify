...
import { S as Swipe, B as Button, I as Input, P as Progress, A as Avatar, R as Rate, D as Divider, F as Footer, a as SwipeItem, C as CharityCard, b as Picture } from './index.4ea11a2e.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 238, 12, 6406);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-p91g5c");
			add_location(li, file, 260, 12, 6736);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file, 206, 16, 5837);
			attr_dev(p0, "class", "svelte-p91g5c");
			add_location(p0, file, 207, 16, 5877);
			attr_dev(span, "class", "svelte-p91g5c");
			add_location(span, file, 205, 12, 5814);
			attr_dev(div1, "class", "ava-section svelte-p91g5c");
			add_location(div1, file, 202, 8, 5698);
			attr_dev(section1, "class", "rate-section svelte-p91g5c");
			add_location(section1, file, 201, 4, 5659);
			add_location(br1, file, 214, 4, 5978);
			attr_dev(h1, "class", "svelte-p91g5c");
			add_location(h1, file, 216, 4, 5988);
			add_location(br2, file, 218, 4, 6017);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 220, 4, 6027);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 144, 0, 3692);
			add_location(br3, file, 225, 0, 6183);
			add_location(br4, file, 226, 0, 6188);
			add_location(br5, file, 227, 0, 6193);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 231, 4, 6252);
			add_location(br6, file, 234, 4, 6335);
			attr_dev(ul1, "class", "cards svelte-p91g5c");
			add_location(ul1, file, 236, 4, 6345);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 229, 0, 6199);
			add_location(br7, file, 245, 0, 6504);
			add_location(br8, file, 246, 0, 6509);
			add_location(br9, file, 247, 0, 6514);
			add_location(br10, file, 248, 0, 6519);
			add_location(br11, file, 249, 0, 6524);
			set_style(h21, "text-align", "right");
			add_location(h21, file, 253, 4, 6583);
			add_location(br12, file, 256, 4, 6665);
			attr_dev(ul2, "class", "cards svelte-p91g5c");
			add_location(ul2, file, 258, 4, 6675);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 251, 0, 6530);
			add_location(br13, file, 267, 0, 6834);
			add_location(br14, file, 268, 0, 6839);
			add_location(br15, file, 269, 0, 6844);
			add_location(br16, file, 270, 0, 6849);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
