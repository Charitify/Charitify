...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 227, 12, 6028);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(227:8) {#each cards as card}",
		ctx
	});
...
// (286:4) <Button is="success" type="submit">
function create_default_slot_13(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(286:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (242:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 242, 4, 6215);
			add_location(br1, file, 243, 4, 6224);
			add_location(br2, file, 247, 4, 6298);
			add_location(br3, file, 248, 4, 6307);
			add_location(br4, file, 252, 4, 6379);
			add_location(br5, file, 253, 4, 6388);
			add_location(br6, file, 257, 4, 6461);
			add_location(br7, file, 258, 4, 6470);
			add_location(br8, file, 262, 4, 6541);
			add_location(br9, file, 263, 4, 6550);
			add_location(br10, file, 267, 4, 6624);
			add_location(br11, file, 268, 4, 6633);
			add_location(br12, file, 272, 4, 6705);
			add_location(br13, file, 273, 4, 6714);
			add_location(br14, file, 277, 4, 6790);
			add_location(br15, file, 278, 4, 6799);
			add_location(br16, file, 282, 4, 6870);
			add_location(br17, file, 283, 4, 6879);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(242:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (341:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(341:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (344:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(344:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (347:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(347:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (355:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(355:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (358:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(358:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (368:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(368:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (382:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(382:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (385:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(385:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h20, file, 220, 4, 5874);
			add_location(br6, file, 223, 4, 5957);
			attr_dev(ul1, "class", "cards svelte-1l1j0nq");
			add_location(ul1, file, 225, 4, 5967);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 218, 0, 5821);
			add_location(br7, file, 235, 0, 6127);
			add_location(br8, file, 236, 0, 6132);
			attr_dev(h11, "class", "svelte-1l1j0nq");
			add_location(h11, file, 288, 0, 6949);
			add_location(br9, file, 290, 0, 7017);
			add_location(br10, file, 291, 0, 7022);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 293, 0, 7028);
			add_location(br11, file, 295, 0, 7070);
			add_location(br12, file, 296, 0, 7075);
			add_location(p2, file, 298, 0, 7081);
			add_location(p3, file, 299, 0, 7117);
			add_location(p4, file, 300, 0, 7161);
			add_location(br13, file, 302, 0, 7207);
			add_location(br14, file, 303, 0, 7212);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 305, 0, 7218);
			add_location(span1, file, 309, 8, 7292);
			add_location(li5, file, 308, 4, 7279);
			add_location(span2, file, 316, 8, 7526);
			add_location(li6, file, 315, 4, 7513);
			add_location(span3, file, 323, 8, 7721);
			add_location(li7, file, 322, 4, 7708);
			add_location(ul2, file, 307, 0, 7270);
			add_location(br15, file, 331, 0, 7939);
			add_location(br16, file, 332, 0, 7944);
			add_location(br17, file, 336, 8, 8051);
			add_location(br18, file, 338, 8, 8080);
			add_location(br19, file, 339, 8, 8093);
			add_location(br20, file, 341, 8, 8169);
			add_location(br21, file, 342, 8, 8182);
			add_location(br22, file, 344, 8, 8271);
			add_location(br23, file, 345, 8, 8284);
			add_location(br24, file, 347, 8, 8390);
			add_location(br25, file, 348, 8, 8403);
			add_location(br26, file, 352, 8, 8530);
			add_location(br27, file, 353, 8, 8543);
			add_location(br28, file, 355, 8, 8650);
			add_location(br29, file, 356, 8, 8663);
			add_location(br30, file, 358, 8, 8769);
			add_location(br31, file, 359, 8, 8782);
			add_location(div3, file, 335, 4, 8037);
			add_location(br32, file, 363, 8, 8817);
			add_location(br33, file, 365, 8, 8855);
			add_location(br34, file, 366, 8, 8868);
			add_location(br35, file, 368, 8, 8953);
			add_location(br36, file, 369, 8, 8966);
			add_location(br37, file, 371, 8, 9064);
			add_location(br38, file, 372, 8, 9077);
			add_location(br39, file, 374, 8, 9175);
			add_location(br40, file, 375, 8, 9188);
			add_location(br41, file, 379, 8, 9324);
			add_location(br42, file, 380, 8, 9337);
			add_location(br43, file, 382, 8, 9453);
			add_location(br44, file, 383, 8, 9466);
			add_location(br45, file, 385, 8, 9581);
			add_location(br46, file, 386, 8, 9594);
			add_location(div4, file, 362, 4, 8803);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 334, 0, 7950);
			add_location(br47, file, 390, 0, 9622);
			add_location(br48, file, 391, 0, 9627);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 393, 0, 9633);
			add_location(br49, file, 395, 0, 9676);
			add_location(br50, file, 396, 0, 9681);
			add_location(br51, file, 401, 4, 9746);
			add_location(br52, file, 402, 4, 9755);
			add_location(br53, file, 406, 4, 9838);
			add_location(br54, file, 407, 4, 9847);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 412, 8, 9936);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 413, 8, 9963);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 414, 8, 9990);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 411, 4, 9908);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 417, 4, 10030);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 418, 4, 10088);
			add_location(br55, file, 420, 4, 10137);
			add_location(br56, file, 421, 4, 10146);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 423, 4, 10156);
			add_location(br57, file, 425, 4, 10208);
			add_location(br58, file, 426, 4, 10217);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 428, 4, 10227);
			add_location(section4, file, 398, 0, 9687);
			add_location(br59, file, 431, 0, 10303);
			add_location(br60, file, 432, 0, 10308);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 434, 0, 10314);
			add_location(br61, file, 436, 0, 10349);
			add_location(br62, file, 437, 0, 10354);
			add_location(br63, file, 441, 0, 10426);
			add_location(br64, file, 442, 0, 10431);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 444, 0, 10437);
			add_location(strong, file, 447, 4, 10482);
			add_location(p5, file, 446, 0, 10474);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 452, 0, 10591);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
