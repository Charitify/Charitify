...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-1v2uiex");
			add_location(h4, file$9, 14, 12, 269);
			attr_dev(sub, "class", "svelte-1v2uiex");
			add_location(sub, file$9, 15, 12, 298);
			attr_dev(span, "class", "svelte-1v2uiex");
			add_location(span, file$9, 13, 8, 250);
			attr_dev(pre, "class", "svelte-1v2uiex");
			add_location(pre, file$9, 18, 8, 345);
			attr_dev(div, "class", "svelte-1v2uiex");
			add_location(div, file$9, 12, 4, 236);
			attr_dev(section, "class", "svelte-1v2uiex");
