...
// (33:4) <Button on:click={changeTheme} auto size="small">
function create_default_slot$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(33:4) <Button on:click={changeTheme} auto size=\\\"small\\\">",
		ctx
	});
...
function create_fragment$c(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(a1_nodes, "charity");
		...
		h: function hydrate() {
			...
			attr_dev(a1, "href", "charity");
			attr_dev(a1, "class", "svelte-xs8syd");
			toggle_class(a1, "selected", /*segment*/ ctx[0] === "charity");
			add_location(a1, file$c, 21, 6, 520);
			add_location(li1, file$c, 21, 2, 516);
			attr_dev(a2, "href", "about");
			attr_dev(a2, "class", "svelte-xs8syd");
			toggle_class(a2, "selected", /*segment*/ ctx[0] === "about");
			add_location(a2, file$c, 22, 6, 615);
			add_location(li2, file$c, 22, 2, 611);
			add_location(ul, file$c, 19, 1, 436);
			option0.__value = "ua";
			option0.value = option0.__value;
			add_location(option0, file$c, 27, 6, 801);
			option1.__value = "ru";
			option1.value = option1.__value;
			add_location(option1, file$c, 28, 6, 838);
			option2.__value = "en";
			option2.value = option2.__value;
			add_location(option2, file$c, 29, 6, 875);
			attr_dev(select, "name", "lang");
			attr_dev(select, "id", "lang");
			attr_dev(select, "class", "btn small lang-select svelte-xs8syd");
			add_location(select, file$c, 26, 4, 726);
			attr_dev(span, "class", "nav-actions svelte-xs8syd");
			add_location(span, file$c, 25, 2, 695);
