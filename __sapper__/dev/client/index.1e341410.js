...
import { S as Swipe, B as Button, I as Input, P as Progress, A as Avatar, R as Rate, D as Divider, F as Footer, a as SwipeItem, C as CharityCard, b as Picture } from './index.b6157e08.js';
...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-1i9k0b4");
			add_location(li, file, 238, 12, 6425);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-1i9k0b4");
			add_location(li, file, 260, 12, 6755);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-1i9k0b4");
			add_location(div0, file, 146, 8, 3762);
			attr_dev(li0, "class", "svelte-1i9k0b4");
			add_location(li0, file, 167, 12, 4590);
			attr_dev(li1, "class", "svelte-1i9k0b4");
			add_location(li1, file, 170, 12, 4710);
			attr_dev(li2, "class", "svelte-1i9k0b4");
			add_location(li2, file, 173, 12, 4831);
			add_location(br0, file, 177, 16, 4974);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 188, 20, 5325);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 189, 20, 5365);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 190, 20, 5406);
			attr_dev(datalist, "id", "sum-suggestions");
			add_location(datalist, file, 187, 16, 5273);
			attr_dev(li3, "class", "svelte-1i9k0b4");
			add_location(li3, file, 176, 12, 4953);
			attr_dev(li4, "class", "svelte-1i9k0b4");
			add_location(li4, file, 193, 12, 5486);
			attr_dev(ul0, "class", "options svelte-1i9k0b4");
			add_location(ul0, file, 166, 8, 4557);
			attr_dev(section0, "class", "top svelte-1i9k0b4");
			add_location(section0, file, 145, 4, 3732);
			attr_dev(h3, "class", "svelte-1i9k0b4");
			add_location(h3, file, 206, 16, 5856);
			attr_dev(p0, "class", "svelte-1i9k0b4");
			add_location(p0, file, 207, 16, 5896);
			attr_dev(span, "class", "svelte-1i9k0b4");
			add_location(span, file, 205, 12, 5833);
			attr_dev(div1, "class", "ava-section svelte-1i9k0b4");
			add_location(div1, file, 202, 8, 5717);
			attr_dev(section1, "class", "rate-section svelte-1i9k0b4");
			add_location(section1, file, 201, 4, 5678);
			add_location(br1, file, 214, 4, 5997);
			attr_dev(h1, "class", "svelte-1i9k0b4");
			add_location(h1, file, 216, 4, 6007);
			add_location(br2, file, 218, 4, 6036);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 220, 4, 6046);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 144, 0, 3700);
			add_location(br3, file, 225, 0, 6202);
			add_location(br4, file, 226, 0, 6207);
			add_location(br5, file, 227, 0, 6212);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 231, 4, 6271);
			add_location(br6, file, 234, 4, 6354);
			attr_dev(ul1, "class", "cards svelte-1i9k0b4");
			add_location(ul1, file, 236, 4, 6364);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 229, 0, 6218);
			add_location(br7, file, 245, 0, 6523);
			add_location(br8, file, 246, 0, 6528);
			add_location(br9, file, 247, 0, 6533);
			add_location(br10, file, 248, 0, 6538);
			add_location(br11, file, 249, 0, 6543);
			set_style(h21, "text-align", "right");
			add_location(h21, file, 253, 4, 6602);
			add_location(br12, file, 256, 4, 6684);
			attr_dev(ul2, "class", "cards svelte-1i9k0b4");
			add_location(ul2, file, 258, 4, 6694);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 251, 0, 6549);
			add_location(br13, file, 267, 0, 6853);
			add_location(br14, file, 268, 0, 6858);
			add_location(br15, file, 269, 0, 6863);
			add_location(br16, file, 270, 0, 6868);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
