...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section, file, 70, 0, 1737);
		},
		m: function mount(target, anchor) {
