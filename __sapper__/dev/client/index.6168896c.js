...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 114, 4, 2725);
			add_location(br1, file, 115, 4, 2734);
			add_location(br2, file, 119, 4, 2795);
			add_location(br3, file, 120, 4, 2804);
			add_location(br4, file, 124, 4, 2863);
			add_location(br5, file, 125, 4, 2872);
			add_location(br6, file, 129, 4, 2932);
			add_location(br7, file, 130, 4, 2941);
			add_location(br8, file, 134, 4, 2999);
			add_location(br9, file, 135, 4, 3008);
			add_location(br10, file, 139, 4, 3069);
			add_location(br11, file, 140, 4, 3078);
			add_location(br12, file, 144, 4, 3137);
			add_location(br13, file, 145, 4, 3146);
			add_location(br14, file, 149, 4, 3209);
			add_location(br15, file, 150, 4, 3218);
			add_location(br16, file, 154, 4, 3276);
			add_location(br17, file, 155, 4, 3285);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 50, 8, 764);
			attr_dev(li0, "class", "svelte-1kmv00v");
			add_location(li0, file, 55, 12, 923);
			attr_dev(li1, "class", "svelte-1kmv00v");
			add_location(li1, file, 58, 12, 1043);
			attr_dev(li2, "class", "svelte-1kmv00v");
			add_location(li2, file, 61, 12, 1164);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 75, 20, 1637);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 76, 20, 1677);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 77, 20, 1718);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 74, 16, 1585);
			attr_dev(li3, "class", "svelte-1kmv00v");
			add_location(li3, file, 64, 12, 1286);
			attr_dev(ul0, "class", "options svelte-1kmv00v");
			add_location(ul0, file, 54, 8, 890);
			attr_dev(section0, "class", "top svelte-1kmv00v");
			add_location(section0, file, 49, 4, 734);
			add_location(span0, file, 85, 8, 1846);
			add_location(li4, file, 84, 8, 1833);
			add_location(span1, file, 92, 8, 2088);
			add_location(li5, file, 91, 8, 2075);
			add_location(span2, file, 99, 8, 2291);
			add_location(li6, file, 98, 8, 2278);
			add_location(ul1, file, 83, 4, 1820);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file, 107, 4, 2521);
			attr_dev(section2, "class", "top-wrap svelte-1kmv00v");
			add_location(section2, file, 48, 0, 703);
			attr_dev(span3, "class", "text-success");
			add_location(span3, file, 160, 10, 3365);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 160, 0, 3355);
			add_location(br0, file, 162, 0, 3414);
			add_location(br1, file, 163, 0, 3419);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 165, 0, 3425);
			add_location(br2, file, 167, 0, 3467);
			add_location(br3, file, 168, 0, 3472);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 170, 0, 3478);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 171, 0, 3514);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 172, 0, 3558);
			add_location(br4, file, 174, 0, 3604);
			add_location(br5, file, 175, 0, 3609);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 177, 0, 3615);
			add_location(br6, file, 179, 0, 3667);
			add_location(br7, file, 180, 0, 3672);
			add_location(br8, file, 184, 8, 3779);
			add_location(br9, file, 186, 8, 3808);
			add_location(br10, file, 187, 8, 3821);
			add_location(br11, file, 189, 8, 3897);
			add_location(br12, file, 190, 8, 3910);
			add_location(br13, file, 192, 8, 3999);
			add_location(br14, file, 193, 8, 4012);
			add_location(br15, file, 195, 8, 4118);
			add_location(br16, file, 196, 8, 4131);
			add_location(br17, file, 200, 8, 4258);
			add_location(br18, file, 201, 8, 4271);
			add_location(br19, file, 203, 8, 4378);
			add_location(br20, file, 204, 8, 4391);
			add_location(br21, file, 206, 8, 4497);
			add_location(br22, file, 207, 8, 4510);
			add_location(div1, file, 183, 4, 3765);
			add_location(br23, file, 211, 8, 4545);
			add_location(br24, file, 213, 8, 4583);
			add_location(br25, file, 214, 8, 4596);
			add_location(br26, file, 216, 8, 4681);
			add_location(br27, file, 217, 8, 4694);
			add_location(br28, file, 219, 8, 4792);
			add_location(br29, file, 220, 8, 4805);
			add_location(br30, file, 222, 8, 4903);
			add_location(br31, file, 223, 8, 4916);
			add_location(br32, file, 227, 8, 5052);
			add_location(br33, file, 228, 8, 5065);
			add_location(br34, file, 230, 8, 5181);
			add_location(br35, file, 231, 8, 5194);
			add_location(br36, file, 233, 8, 5309);
			add_location(br37, file, 234, 8, 5322);
			add_location(div2, file, 210, 4, 4531);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 182, 0, 3678);
			add_location(br38, file, 238, 0, 5350);
			add_location(br39, file, 239, 0, 5355);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 241, 0, 5361);
			add_location(br40, file, 243, 0, 5404);
			add_location(br41, file, 244, 0, 5409);
			add_location(br42, file, 249, 4, 5474);
			add_location(br43, file, 250, 4, 5483);
			add_location(br44, file, 254, 4, 5566);
			add_location(br45, file, 255, 4, 5575);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 260, 8, 5664);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 261, 8, 5691);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 262, 8, 5718);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 259, 4, 5636);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 265, 4, 5758);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 266, 4, 5816);
			add_location(br46, file, 268, 4, 5865);
			add_location(br47, file, 269, 4, 5874);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 271, 4, 5884);
			add_location(br48, file, 273, 4, 5936);
			add_location(br49, file, 274, 4, 5945);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 276, 4, 5955);
			add_location(section4, file, 246, 0, 5415);
			add_location(br50, file, 279, 0, 6031);
			add_location(br51, file, 280, 0, 6036);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 282, 0, 6042);
			add_location(br52, file, 288, 0, 6166);
			add_location(br53, file, 289, 0, 6171);
			add_location(br54, file, 293, 0, 6243);
			add_location(br55, file, 294, 0, 6248);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 296, 0, 6254);
			add_location(strong, file, 299, 4, 6299);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 298, 0, 6291);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 304, 0, 6408);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
