...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$6, 68, 4, 1677);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$6, 56, 4, 1416);
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$6, 45, 4, 1187);
