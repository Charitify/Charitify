...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 162, 4, 4187);
			add_location(br1, file$2, 163, 4, 4196);
			add_location(br2, file$2, 167, 4, 4270);
			add_location(br3, file$2, 168, 4, 4279);
			add_location(br4, file$2, 172, 4, 4351);
			add_location(br5, file$2, 173, 4, 4360);
			add_location(br6, file$2, 177, 4, 4433);
			add_location(br7, file$2, 178, 4, 4442);
			add_location(br8, file$2, 182, 4, 4513);
			add_location(br9, file$2, 183, 4, 4522);
			add_location(br10, file$2, 187, 4, 4596);
			add_location(br11, file$2, 188, 4, 4605);
			add_location(br12, file$2, 192, 4, 4677);
			add_location(br13, file$2, 193, 4, 4686);
			add_location(br14, file$2, 197, 4, 4762);
			add_location(br15, file$2, 198, 4, 4771);
			add_location(br16, file$2, 202, 4, 4842);
			add_location(br17, file$2, 203, 4, 4851);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-1thz8mg");
			add_location(div0, file$2, 76, 8, 1670);
			attr_dev(li0, "class", "svelte-1thz8mg");
			add_location(li0, file$2, 97, 12, 2498);
			attr_dev(li1, "class", "svelte-1thz8mg");
			add_location(li1, file$2, 100, 12, 2618);
			attr_dev(li2, "class", "svelte-1thz8mg");
			add_location(li2, file$2, 103, 12, 2739);
			add_location(br0, file$2, 107, 16, 2882);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 118, 20, 3233);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 119, 20, 3273);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 120, 20, 3314);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 117, 16, 3181);
			attr_dev(li3, "class", "svelte-1thz8mg");
			add_location(li3, file$2, 106, 12, 2861);
			attr_dev(li4, "class", "svelte-1thz8mg");
			add_location(li4, file$2, 123, 12, 3394);
			attr_dev(ul0, "class", "options svelte-1thz8mg");
			add_location(ul0, file$2, 96, 8, 2465);
			attr_dev(section0, "class", "top svelte-1thz8mg");
			add_location(section0, file$2, 75, 4, 1640);
			attr_dev(h3, "class", "svelte-1thz8mg");
			add_location(h3, file$2, 136, 16, 3753);
			attr_dev(p0, "class", "svelte-1thz8mg");
			add_location(p0, file$2, 137, 16, 3793);
			attr_dev(span0, "class", "svelte-1thz8mg");
			add_location(span0, file$2, 135, 12, 3730);
			attr_dev(div1, "class", "ava-section svelte-1thz8mg");
			add_location(div1, file$2, 132, 8, 3614);
			attr_dev(section1, "class", "rate-section svelte-1thz8mg");
			add_location(section1, file$2, 131, 4, 3575);
			add_location(br1, file$2, 144, 4, 3894);
			attr_dev(h10, "class", "svelte-1thz8mg");
			add_location(h10, file$2, 146, 4, 3904);
			add_location(br2, file$2, 148, 4, 3933);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 150, 4, 3943);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 74, 0, 1608);
			add_location(br3, file$2, 155, 0, 4099);
			add_location(br4, file$2, 156, 0, 4104);
			attr_dev(h11, "class", "svelte-1thz8mg");
			add_location(h11, file$2, 208, 0, 4921);
			add_location(br5, file$2, 210, 0, 4989);
			add_location(br6, file$2, 211, 0, 4994);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 213, 0, 5000);
			add_location(br7, file$2, 215, 0, 5042);
			add_location(br8, file$2, 216, 0, 5047);
			add_location(p2, file$2, 218, 0, 5053);
			add_location(p3, file$2, 219, 0, 5089);
			add_location(p4, file$2, 220, 0, 5133);
			add_location(br9, file$2, 222, 0, 5179);
			add_location(br10, file$2, 223, 0, 5184);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 225, 0, 5190);
			add_location(span1, file$2, 229, 8, 5264);
			add_location(li5, file$2, 228, 4, 5251);
			add_location(span2, file$2, 236, 8, 5498);
			add_location(li6, file$2, 235, 4, 5485);
			add_location(span3, file$2, 243, 8, 5693);
			add_location(li7, file$2, 242, 4, 5680);
			add_location(ul1, file$2, 227, 0, 5242);
			add_location(br11, file$2, 251, 0, 5911);
			add_location(br12, file$2, 252, 0, 5916);
			add_location(br13, file$2, 256, 8, 6023);
			add_location(br14, file$2, 258, 8, 6052);
			add_location(br15, file$2, 259, 8, 6065);
			add_location(br16, file$2, 261, 8, 6141);
			add_location(br17, file$2, 262, 8, 6154);
			add_location(br18, file$2, 264, 8, 6243);
			add_location(br19, file$2, 265, 8, 6256);
			add_location(br20, file$2, 267, 8, 6362);
			add_location(br21, file$2, 268, 8, 6375);
			add_location(br22, file$2, 272, 8, 6502);
			add_location(br23, file$2, 273, 8, 6515);
			add_location(br24, file$2, 275, 8, 6622);
			add_location(br25, file$2, 276, 8, 6635);
			add_location(br26, file$2, 278, 8, 6741);
			add_location(br27, file$2, 279, 8, 6754);
			add_location(div2, file$2, 255, 4, 6009);
			add_location(br28, file$2, 283, 8, 6789);
			add_location(br29, file$2, 285, 8, 6827);
			add_location(br30, file$2, 286, 8, 6840);
			add_location(br31, file$2, 288, 8, 6925);
			add_location(br32, file$2, 289, 8, 6938);
			add_location(br33, file$2, 291, 8, 7036);
			add_location(br34, file$2, 292, 8, 7049);
			add_location(br35, file$2, 294, 8, 7147);
			add_location(br36, file$2, 295, 8, 7160);
			add_location(br37, file$2, 299, 8, 7296);
			add_location(br38, file$2, 300, 8, 7309);
			add_location(br39, file$2, 302, 8, 7425);
			add_location(br40, file$2, 303, 8, 7438);
			add_location(br41, file$2, 305, 8, 7553);
			add_location(br42, file$2, 306, 8, 7566);
			add_location(div3, file$2, 282, 4, 6775);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 254, 0, 5922);
			add_location(br43, file$2, 310, 0, 7594);
			add_location(br44, file$2, 311, 0, 7599);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 313, 0, 7605);
			add_location(br45, file$2, 315, 0, 7648);
			add_location(br46, file$2, 316, 0, 7653);
			add_location(br47, file$2, 321, 4, 7718);
			add_location(br48, file$2, 322, 4, 7727);
			add_location(br49, file$2, 326, 4, 7810);
			add_location(br50, file$2, 327, 4, 7819);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 332, 8, 7908);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 333, 8, 7935);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 334, 8, 7962);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 331, 4, 7880);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 337, 4, 8002);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 338, 4, 8060);
			add_location(br51, file$2, 340, 4, 8109);
			add_location(br52, file$2, 341, 4, 8118);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 343, 4, 8128);
			add_location(br53, file$2, 345, 4, 8180);
			add_location(br54, file$2, 346, 4, 8189);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 348, 4, 8199);
			add_location(section4, file$2, 318, 0, 7659);
			add_location(br55, file$2, 351, 0, 8275);
			add_location(br56, file$2, 352, 0, 8280);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 354, 0, 8286);
			add_location(br57, file$2, 360, 0, 8410);
			add_location(br58, file$2, 361, 0, 8415);
			add_location(br59, file$2, 365, 0, 8487);
			add_location(br60, file$2, 366, 0, 8492);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 368, 0, 8498);
			add_location(strong, file$2, 371, 4, 8543);
			add_location(p5, file$2, 370, 0, 8535);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 376, 0, 8652);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
