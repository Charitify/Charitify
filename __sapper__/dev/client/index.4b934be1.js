...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$8, 46, 8, 1399);
			attr_dev(div1, "class", "progress-inner-frame svelte-1kjumgy");
			add_location(div1, file$8, 45, 4, 1356);
			...
			add_location(div2, file$8, 34, 0, 1085);
		},
		m: function mount(target, anchor) {
...
function getBorderRadius(borders) {
	const brVar = "99999";
	const brDefault = new Array(4).fill(brVar);
	const bds = safeGet(() => borders.split(" "), [], true);
	const rule = "border-radius";
	const res = `${rule}:${brDefault.map((def, i) => `${bds[i] || def}`).join(" ")};`;
	console.log(res);
	return res;
}
