...
import { B as Button, I as Input, P as Progress, A as Avatar, R as Rate, D as Divider, F as Form, a as Icon, b as Picture } from './index.b332974a.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-hwohzt");
			add_location(div0, file$2, 77, 8, 1711);
			attr_dev(li0, "class", "svelte-hwohzt");
			add_location(li0, file$2, 98, 12, 2539);
			attr_dev(li1, "class", "svelte-hwohzt");
			add_location(li1, file$2, 101, 12, 2659);
			attr_dev(li2, "class", "svelte-hwohzt");
			...
			attr_dev(li3, "class", "svelte-hwohzt");
			add_location(li3, file$2, 107, 12, 2902);
			attr_dev(li4, "class", "svelte-hwohzt");
			add_location(li4, file$2, 124, 12, 3435);
			attr_dev(ul0, "class", "options svelte-hwohzt");
			add_location(ul0, file$2, 97, 8, 2506);
			attr_dev(section0, "class", "top svelte-hwohzt");
			add_location(section0, file$2, 76, 4, 1681);
			attr_dev(h3, "class", "svelte-hwohzt");
			add_location(h3, file$2, 137, 16, 3794);
			attr_dev(p0, "class", "svelte-hwohzt");
			add_location(p0, file$2, 138, 16, 3834);
			attr_dev(span0, "class", "svelte-hwohzt");
			add_location(span0, file$2, 136, 12, 3771);
			attr_dev(div1, "class", "ava-section svelte-hwohzt");
			add_location(div1, file$2, 133, 8, 3655);
			attr_dev(section1, "class", "rate-section svelte-hwohzt");
			add_location(section1, file$2, 132, 4, 3616);
			add_location(br1, file$2, 145, 4, 3935);
			attr_dev(h10, "class", "svelte-hwohzt");
			...
			attr_dev(h11, "class", "svelte-hwohzt");
