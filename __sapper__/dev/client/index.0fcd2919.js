...
function create_fragment$9(ctx) {
	...
	const block = {
		c: function create() {
			...
			t7 = space();
			pre = element("pre");
			t8 = text("A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			this.h();
		},
		l: function claim(nodes) {
			...
			t8 = claim_text(pre_nodes, "A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
		...
		h: function hydrate() {
			...
			add_location(br1, file$9, 18, 8, 371);
			attr_dev(br2, "class", "big");
			add_location(br2, file$9, 19, 8, 399);
			attr_dev(pre, "class", "svelte-h9qx8j");
			add_location(pre, file$9, 21, 8, 425);
