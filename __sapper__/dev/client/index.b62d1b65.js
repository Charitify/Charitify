...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 157, 4, 4146);
			add_location(br1, file$2, 158, 4, 4155);
			add_location(br2, file$2, 162, 4, 4229);
			add_location(br3, file$2, 163, 4, 4238);
			add_location(br4, file$2, 167, 4, 4310);
			add_location(br5, file$2, 168, 4, 4319);
			add_location(br6, file$2, 172, 4, 4392);
			add_location(br7, file$2, 173, 4, 4401);
			add_location(br8, file$2, 177, 4, 4472);
			add_location(br9, file$2, 178, 4, 4481);
			add_location(br10, file$2, 182, 4, 4555);
			add_location(br11, file$2, 183, 4, 4564);
			add_location(br12, file$2, 187, 4, 4636);
			add_location(br13, file$2, 188, 4, 4645);
			add_location(br14, file$2, 192, 4, 4721);
			add_location(br15, file$2, 193, 4, 4730);
			add_location(br16, file$2, 197, 4, 4801);
			add_location(br17, file$2, 198, 4, 4810);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br2, file$2, 144, 4, 3876);
			attr_dev(h10, "class", "svelte-1r1ab2y");
			add_location(h10, file$2, 146, 4, 3886);
			add_location(br3, file$2, 148, 4, 3915);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 150, 4, 3925);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 73, 0, 1569);
			attr_dev(h11, "class", "svelte-1r1ab2y");
			add_location(h11, file$2, 203, 0, 4880);
			add_location(br4, file$2, 205, 0, 4948);
			add_location(br5, file$2, 206, 0, 4953);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 208, 0, 4959);
			add_location(br6, file$2, 210, 0, 5001);
			add_location(br7, file$2, 211, 0, 5006);
			add_location(p2, file$2, 213, 0, 5012);
			add_location(p3, file$2, 214, 0, 5048);
			add_location(p4, file$2, 215, 0, 5092);
			add_location(br8, file$2, 217, 0, 5138);
			add_location(br9, file$2, 218, 0, 5143);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 220, 0, 5149);
			add_location(span1, file$2, 224, 8, 5223);
			add_location(li5, file$2, 223, 4, 5210);
			add_location(span2, file$2, 231, 8, 5457);
			add_location(li6, file$2, 230, 4, 5444);
			add_location(span3, file$2, 238, 8, 5652);
			add_location(li7, file$2, 237, 4, 5639);
			add_location(ul1, file$2, 222, 0, 5201);
			add_location(br10, file$2, 246, 0, 5870);
			add_location(br11, file$2, 247, 0, 5875);
			add_location(br12, file$2, 251, 8, 5982);
			add_location(br13, file$2, 253, 8, 6011);
			add_location(br14, file$2, 254, 8, 6024);
			add_location(br15, file$2, 256, 8, 6100);
			add_location(br16, file$2, 257, 8, 6113);
			add_location(br17, file$2, 259, 8, 6202);
			add_location(br18, file$2, 260, 8, 6215);
			add_location(br19, file$2, 262, 8, 6321);
			add_location(br20, file$2, 263, 8, 6334);
			add_location(br21, file$2, 267, 8, 6461);
			add_location(br22, file$2, 268, 8, 6474);
			add_location(br23, file$2, 270, 8, 6581);
			add_location(br24, file$2, 271, 8, 6594);
			add_location(br25, file$2, 273, 8, 6700);
			add_location(br26, file$2, 274, 8, 6713);
			add_location(div2, file$2, 250, 4, 5968);
			add_location(br27, file$2, 278, 8, 6748);
			add_location(br28, file$2, 280, 8, 6786);
			add_location(br29, file$2, 281, 8, 6799);
			add_location(br30, file$2, 283, 8, 6884);
			add_location(br31, file$2, 284, 8, 6897);
			add_location(br32, file$2, 286, 8, 6995);
			add_location(br33, file$2, 287, 8, 7008);
			add_location(br34, file$2, 289, 8, 7106);
			add_location(br35, file$2, 290, 8, 7119);
			add_location(br36, file$2, 294, 8, 7255);
			add_location(br37, file$2, 295, 8, 7268);
			add_location(br38, file$2, 297, 8, 7384);
			add_location(br39, file$2, 298, 8, 7397);
			add_location(br40, file$2, 300, 8, 7512);
			add_location(br41, file$2, 301, 8, 7525);
			add_location(div3, file$2, 277, 4, 6734);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 249, 0, 5881);
			add_location(br42, file$2, 305, 0, 7553);
			add_location(br43, file$2, 306, 0, 7558);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 308, 0, 7564);
			add_location(br44, file$2, 310, 0, 7607);
			add_location(br45, file$2, 311, 0, 7612);
			add_location(br46, file$2, 316, 4, 7677);
			add_location(br47, file$2, 317, 4, 7686);
			add_location(br48, file$2, 321, 4, 7769);
			add_location(br49, file$2, 322, 4, 7778);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 327, 8, 7867);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 328, 8, 7894);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 329, 8, 7921);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 326, 4, 7839);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 332, 4, 7961);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 333, 4, 8019);
			add_location(br50, file$2, 335, 4, 8068);
			add_location(br51, file$2, 336, 4, 8077);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 338, 4, 8087);
			add_location(br52, file$2, 340, 4, 8139);
			add_location(br53, file$2, 341, 4, 8148);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 343, 4, 8158);
			add_location(section4, file$2, 313, 0, 7618);
			add_location(br54, file$2, 346, 0, 8234);
			add_location(br55, file$2, 347, 0, 8239);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 349, 0, 8245);
			add_location(br56, file$2, 355, 0, 8369);
			add_location(br57, file$2, 356, 0, 8374);
			add_location(br58, file$2, 360, 0, 8446);
			add_location(br59, file$2, 361, 0, 8451);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 363, 0, 8457);
			add_location(strong, file$2, 366, 4, 8502);
			add_location(p5, file$2, 365, 0, 8494);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 371, 0, 8611);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
