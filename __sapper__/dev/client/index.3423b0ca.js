...
import { B as Button, I as Input, P as Progress, A as Avatar, R as Rate, F as Form, a as Icon, b as Picture } from './index.84819990.js';
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic main-shadow svelte-st009a");
			add_location(div0, file$2, 75, 8, 1631);
			attr_dev(li0, "class", "svelte-st009a");
			add_location(li0, file$2, 96, 12, 2471);
			attr_dev(li1, "class", "svelte-st009a");
			add_location(li1, file$2, 99, 12, 2591);
			attr_dev(li2, "class", "svelte-st009a");
			...
			attr_dev(li3, "class", "svelte-st009a");
			add_location(li3, file$2, 105, 12, 2834);
			attr_dev(li4, "class", "svelte-st009a");
			add_location(li4, file$2, 122, 12, 3367);
			attr_dev(ul0, "class", "options svelte-st009a");
			add_location(ul0, file$2, 95, 8, 2438);
			attr_dev(section0, "class", "top svelte-st009a");
			add_location(section0, file$2, 74, 4, 1601);
			attr_dev(h3, "class", "svelte-st009a");
			add_location(h3, file$2, 135, 16, 3726);
			attr_dev(p0, "class", "svelte-st009a");
			add_location(p0, file$2, 136, 16, 3766);
			attr_dev(span0, "class", "svelte-st009a");
			add_location(span0, file$2, 134, 12, 3703);
			attr_dev(div1, "class", "ava-section svelte-st009a");
			add_location(div1, file$2, 131, 8, 3587);
			attr_dev(section1, "class", "rate-section svelte-st009a");
			add_location(section1, file$2, 130, 4, 3548);
			add_location(br1, file$2, 143, 4, 3867);
			attr_dev(h10, "class", "svelte-st009a");
			...
			attr_dev(h11, "class", "svelte-st009a");
