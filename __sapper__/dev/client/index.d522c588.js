...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br2, file, 28, 1, 645);
			add_location(br3, file, 36, 1, 744);
			add_location(br4, file, 37, 1, 750);
			attr_dev(div1, "class", "list-wrap svelte-15uoncq");
			add_location(div1, file, 27, 0, 620);
		},
		m: function mount(target, anchor) {
