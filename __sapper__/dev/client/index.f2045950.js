...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 97, 4, 2182);
			add_location(br1, file, 98, 4, 2191);
			add_location(br2, file, 102, 4, 2252);
			add_location(br3, file, 103, 4, 2261);
			add_location(br4, file, 107, 4, 2320);
			add_location(br5, file, 108, 4, 2329);
			add_location(br6, file, 112, 4, 2389);
			add_location(br7, file, 113, 4, 2398);
			add_location(br8, file, 117, 4, 2456);
			add_location(br9, file, 118, 4, 2465);
			add_location(br10, file, 122, 4, 2526);
			add_location(br11, file, 123, 4, 2535);
			add_location(br12, file, 127, 4, 2594);
			add_location(br13, file, 128, 4, 2603);
			add_location(br14, file, 132, 4, 2666);
			add_location(br15, file, 133, 4, 2675);
			add_location(br16, file, 137, 4, 2733);
			add_location(br17, file, 138, 4, 2742);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 143, 10, 2822);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 143, 0, 2812);
			add_location(br0, file, 145, 0, 2871);
			add_location(br1, file, 146, 0, 2876);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 148, 0, 2882);
			add_location(br2, file, 150, 0, 2924);
			add_location(br3, file, 151, 0, 2929);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 153, 0, 2935);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 154, 0, 2971);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 155, 0, 3015);
			add_location(br4, file, 157, 0, 3061);
			add_location(br5, file, 158, 0, 3066);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 160, 0, 3072);
			add_location(br6, file, 162, 0, 3124);
			add_location(br7, file, 163, 0, 3129);
			add_location(br8, file, 167, 8, 3236);
			add_location(br9, file, 169, 8, 3265);
			add_location(br10, file, 170, 8, 3278);
			add_location(br11, file, 172, 8, 3354);
			add_location(br12, file, 173, 8, 3367);
			add_location(br13, file, 175, 8, 3456);
			add_location(br14, file, 176, 8, 3469);
			add_location(br15, file, 178, 8, 3575);
			add_location(br16, file, 179, 8, 3588);
			add_location(br17, file, 183, 8, 3715);
			add_location(br18, file, 184, 8, 3728);
			add_location(br19, file, 186, 8, 3835);
			add_location(br20, file, 187, 8, 3848);
			add_location(br21, file, 189, 8, 3954);
			add_location(br22, file, 190, 8, 3967);
			add_location(div1, file, 166, 4, 3222);
			add_location(br23, file, 194, 8, 4002);
			add_location(br24, file, 196, 8, 4040);
			add_location(br25, file, 197, 8, 4053);
			add_location(br26, file, 199, 8, 4138);
			add_location(br27, file, 200, 8, 4151);
			add_location(br28, file, 202, 8, 4249);
			add_location(br29, file, 203, 8, 4262);
			add_location(br30, file, 205, 8, 4360);
			add_location(br31, file, 206, 8, 4373);
			add_location(br32, file, 210, 8, 4509);
			add_location(br33, file, 211, 8, 4522);
			add_location(br34, file, 213, 8, 4638);
			add_location(br35, file, 214, 8, 4651);
			add_location(br36, file, 216, 8, 4766);
			add_location(br37, file, 217, 8, 4779);
			add_location(div2, file, 193, 4, 3988);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 165, 0, 3135);
			add_location(br38, file, 221, 0, 4807);
			add_location(br39, file, 222, 0, 4812);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 224, 0, 4818);
			add_location(br40, file, 226, 0, 4861);
			add_location(br41, file, 227, 0, 4866);
			add_location(br42, file, 232, 4, 4931);
			add_location(br43, file, 233, 4, 4940);
			add_location(br44, file, 237, 4, 5023);
			add_location(br45, file, 238, 4, 5032);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 243, 8, 5121);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 244, 8, 5148);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 245, 8, 5175);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 242, 4, 5093);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 248, 4, 5215);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 249, 4, 5273);
			add_location(br46, file, 251, 4, 5322);
			add_location(br47, file, 252, 4, 5331);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 254, 4, 5341);
			add_location(br48, file, 256, 4, 5393);
			add_location(br49, file, 257, 4, 5402);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 259, 4, 5412);
			add_location(section4, file, 229, 0, 4872);
			add_location(br50, file, 262, 0, 5488);
			add_location(br51, file, 263, 0, 5493);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 265, 0, 5499);
			add_location(br52, file, 271, 0, 5623);
			add_location(br53, file, 272, 0, 5628);
			add_location(br54, file, 276, 0, 5700);
			add_location(br55, file, 277, 0, 5705);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 279, 0, 5711);
			add_location(strong, file, 282, 4, 5756);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 281, 0, 5748);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 287, 0, 5865);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
