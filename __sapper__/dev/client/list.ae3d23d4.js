...
import { C as Carousel, D as DonatingGroup, P as Progress, A as AvatarAndName, R as Rate, T as TitleSubTitle, b as CharityCards } from './index.0d130c60.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 46, 12, 1090);
			attr_dev(section0, "class", "top svelte-9uj01k");
			add_location(section0, file, 44, 8, 1055);
		...
		i: function intro(local) {
			...
			add_render_callback(() => {
				...
				if (!div0_intro) div0_intro = create_in_transition(div0, receive, { key: "pictures" });
				div0_intro.start();
			});
		...
		o: function outro(local) {
			...
			div0_outro = create_out_transition(div0, send, { key: "pictures" });
