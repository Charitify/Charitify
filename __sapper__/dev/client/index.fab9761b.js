...
function create_fragment$i(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$i, 5, 0, 49);
			add_location(br1, file$i, 6, 0, 54);
			add_location(p0, file$i, 7, 0, 59);
			add_location(br2, file$i, 8, 0, 164);
			add_location(p1, file$i, 9, 0, 169);
		},
		m: function mount(target, anchor) {
