...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-77l4ga");
...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-77l4ga");
			add_location(ul, file$b, 57, 4, 1823);
			attr_dev(section, "class", "svelte-77l4ga");
