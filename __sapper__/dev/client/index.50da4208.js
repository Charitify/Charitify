...
function create_fragment$b(ctx) {
	...
	const progress = new Progress({ props: { value: "45" }, $$inline: true });
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t7 = claim_text(p_nodes, "ORG charity charitify");
		...
		h: function hydrate() {
			...
			add_location(br0, file$b, 33, 4, 1065);
			add_location(br1, file$b, 37, 4, 1103);
			attr_dev(h3, "class", "svelte-onscs3");
			add_location(h3, file$b, 44, 16, 1269);
			attr_dev(p, "class", "svelte-onscs3");
			add_location(p, file$b, 45, 16, 1309);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 43, 12, 1246);
			attr_dev(div1, "class", "ava-section svelte-onscs3");
			add_location(div1, file$b, 40, 8, 1130);
			add_location(footer, file$b, 39, 4, 1113);
