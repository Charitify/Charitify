...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-1196gp0");
			add_location(li, file$b, 58, 8, 1851);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(58:4) {#each imagesArr as img}",
		ctx
	});
...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-1196gp0");
			add_location(ul, file$b, 56, 0, 1809);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
