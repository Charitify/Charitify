...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(input, "svelte-1x5y6zt", true);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(textarea, "svelte-1x5y6zt", true);
