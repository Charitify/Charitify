...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br, file$b, 35, 4, 1093);
			attr_dev(h3, "class", "svelte-onscs3");
			add_location(h3, file$b, 42, 16, 1259);
			attr_dev(p, "class", "svelte-onscs3");
			add_location(p, file$b, 43, 16, 1299);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 41, 12, 1236);
			attr_dev(div1, "class", "ava-section svelte-onscs3");
			add_location(div1, file$b, 38, 8, 1120);
			add_location(footer, file$b, 37, 4, 1103);
