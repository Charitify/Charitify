...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 156, 4, 4139);
			add_location(br1, file$2, 157, 4, 4148);
			add_location(br2, file$2, 161, 4, 4222);
			add_location(br3, file$2, 162, 4, 4231);
			add_location(br4, file$2, 166, 4, 4303);
			add_location(br5, file$2, 167, 4, 4312);
			add_location(br6, file$2, 171, 4, 4385);
			add_location(br7, file$2, 172, 4, 4394);
			add_location(br8, file$2, 176, 4, 4465);
			add_location(br9, file$2, 177, 4, 4474);
			add_location(br10, file$2, 181, 4, 4548);
			add_location(br11, file$2, 182, 4, 4557);
			add_location(br12, file$2, 186, 4, 4629);
			add_location(br13, file$2, 187, 4, 4638);
			add_location(br14, file$2, 191, 4, 4714);
			add_location(br15, file$2, 192, 4, 4723);
			add_location(br16, file$2, 196, 4, 4794);
			add_location(br17, file$2, 197, 4, 4803);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic main-shadow svelte-z6xbrd");
			add_location(div0, file$2, 75, 8, 1633);
			attr_dev(li0, "class", "svelte-z6xbrd");
			add_location(li0, file$2, 96, 12, 2473);
			attr_dev(li1, "class", "svelte-z6xbrd");
			add_location(li1, file$2, 99, 12, 2593);
			attr_dev(li2, "class", "svelte-z6xbrd");
			add_location(li2, file$2, 102, 12, 2714);
			add_location(br0, file$2, 106, 16, 2857);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 117, 20, 3208);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 118, 20, 3248);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 119, 20, 3289);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 116, 16, 3156);
			attr_dev(li3, "class", "svelte-z6xbrd");
			add_location(li3, file$2, 105, 12, 2836);
			attr_dev(li4, "class", "svelte-z6xbrd");
			add_location(li4, file$2, 122, 12, 3369);
			attr_dev(ul0, "class", "options svelte-z6xbrd");
			add_location(ul0, file$2, 95, 8, 2440);
			attr_dev(section0, "class", "top svelte-z6xbrd");
			add_location(section0, file$2, 74, 4, 1603);
			attr_dev(h3, "class", "svelte-z6xbrd");
			add_location(h3, file$2, 135, 16, 3728);
			attr_dev(p0, "class", "svelte-z6xbrd");
			add_location(p0, file$2, 136, 16, 3768);
			attr_dev(span0, "class", "svelte-z6xbrd");
			add_location(span0, file$2, 134, 12, 3705);
			attr_dev(div1, "class", "ava-section svelte-z6xbrd");
			add_location(div1, file$2, 131, 8, 3589);
			attr_dev(section1, "class", "rate-section svelte-z6xbrd");
			add_location(section1, file$2, 130, 4, 3550);
			add_location(br1, file$2, 143, 4, 3869);
			attr_dev(h10, "class", "svelte-z6xbrd");
			add_location(h10, file$2, 145, 4, 3879);
			add_location(br2, file$2, 147, 4, 3908);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 149, 4, 3918);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 73, 0, 1571);
			attr_dev(h11, "class", "svelte-z6xbrd");
			add_location(h11, file$2, 202, 0, 4873);
			add_location(br3, file$2, 204, 0, 4941);
			add_location(br4, file$2, 205, 0, 4946);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 207, 0, 4952);
			add_location(br5, file$2, 209, 0, 4994);
			add_location(br6, file$2, 210, 0, 4999);
			add_location(p2, file$2, 212, 0, 5005);
			add_location(p3, file$2, 213, 0, 5041);
			add_location(p4, file$2, 214, 0, 5085);
			add_location(br7, file$2, 216, 0, 5131);
			add_location(br8, file$2, 217, 0, 5136);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 219, 0, 5142);
			add_location(span1, file$2, 223, 8, 5216);
			add_location(li5, file$2, 222, 4, 5203);
			add_location(span2, file$2, 230, 8, 5450);
			add_location(li6, file$2, 229, 4, 5437);
			add_location(span3, file$2, 237, 8, 5645);
			add_location(li7, file$2, 236, 4, 5632);
			add_location(ul1, file$2, 221, 0, 5194);
			add_location(br9, file$2, 245, 0, 5863);
			add_location(br10, file$2, 246, 0, 5868);
			add_location(br11, file$2, 250, 8, 5975);
			add_location(br12, file$2, 252, 8, 6004);
			add_location(br13, file$2, 253, 8, 6017);
			add_location(br14, file$2, 255, 8, 6093);
			add_location(br15, file$2, 256, 8, 6106);
			add_location(br16, file$2, 258, 8, 6195);
			add_location(br17, file$2, 259, 8, 6208);
			add_location(br18, file$2, 261, 8, 6314);
			add_location(br19, file$2, 262, 8, 6327);
			add_location(br20, file$2, 266, 8, 6454);
			add_location(br21, file$2, 267, 8, 6467);
			add_location(br22, file$2, 269, 8, 6574);
			add_location(br23, file$2, 270, 8, 6587);
			add_location(br24, file$2, 272, 8, 6693);
			add_location(br25, file$2, 273, 8, 6706);
			add_location(div2, file$2, 249, 4, 5961);
			add_location(br26, file$2, 277, 8, 6741);
			add_location(br27, file$2, 279, 8, 6779);
			add_location(br28, file$2, 280, 8, 6792);
			add_location(br29, file$2, 282, 8, 6877);
			add_location(br30, file$2, 283, 8, 6890);
			add_location(br31, file$2, 285, 8, 6988);
			add_location(br32, file$2, 286, 8, 7001);
			add_location(br33, file$2, 288, 8, 7099);
			add_location(br34, file$2, 289, 8, 7112);
			add_location(br35, file$2, 293, 8, 7248);
			add_location(br36, file$2, 294, 8, 7261);
			add_location(br37, file$2, 296, 8, 7377);
			add_location(br38, file$2, 297, 8, 7390);
			add_location(br39, file$2, 299, 8, 7505);
			add_location(br40, file$2, 300, 8, 7518);
			add_location(div3, file$2, 276, 4, 6727);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 248, 0, 5874);
			add_location(br41, file$2, 304, 0, 7546);
			add_location(br42, file$2, 305, 0, 7551);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 307, 0, 7557);
			add_location(br43, file$2, 309, 0, 7600);
			add_location(br44, file$2, 310, 0, 7605);
			add_location(br45, file$2, 315, 4, 7670);
			add_location(br46, file$2, 316, 4, 7679);
			add_location(br47, file$2, 320, 4, 7762);
			add_location(br48, file$2, 321, 4, 7771);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 326, 8, 7860);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 327, 8, 7887);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 328, 8, 7914);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 325, 4, 7832);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 331, 4, 7954);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 332, 4, 8012);
			add_location(br49, file$2, 334, 4, 8061);
			add_location(br50, file$2, 335, 4, 8070);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 337, 4, 8080);
			add_location(br51, file$2, 339, 4, 8132);
			add_location(br52, file$2, 340, 4, 8141);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 342, 4, 8151);
			add_location(section4, file$2, 312, 0, 7611);
			add_location(br53, file$2, 345, 0, 8227);
			add_location(br54, file$2, 346, 0, 8232);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 348, 0, 8238);
			add_location(br55, file$2, 354, 0, 8362);
			add_location(br56, file$2, 355, 0, 8367);
			add_location(br57, file$2, 359, 0, 8439);
			add_location(br58, file$2, 360, 0, 8444);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 362, 0, 8450);
			add_location(strong, file$2, 365, 4, 8495);
			add_location(p5, file$2, 364, 0, 8487);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 370, 0, 8604);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
