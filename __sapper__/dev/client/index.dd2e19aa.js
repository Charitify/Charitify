...
import { B as Button, I as Input, P as Progress, R as Rate, A as Avatar, F as Form, a as Icon, b as Picture } from './index.b866f473.js';
...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 125, 4, 3554);
			add_location(br1, file$2, 126, 4, 3563);
			add_location(br2, file$2, 130, 4, 3637);
			add_location(br3, file$2, 131, 4, 3646);
			add_location(br4, file$2, 135, 4, 3718);
			add_location(br5, file$2, 136, 4, 3727);
			add_location(br6, file$2, 140, 4, 3800);
			add_location(br7, file$2, 141, 4, 3809);
			add_location(br8, file$2, 145, 4, 3880);
			add_location(br9, file$2, 146, 4, 3889);
			add_location(br10, file$2, 150, 4, 3963);
			add_location(br11, file$2, 151, 4, 3972);
			add_location(br12, file$2, 155, 4, 4044);
			add_location(br13, file$2, 156, 4, 4053);
			add_location(br14, file$2, 160, 4, 4129);
			add_location(br15, file$2, 161, 4, 4138);
			add_location(br16, file$2, 165, 4, 4209);
			add_location(br17, file$2, 166, 4, 4218);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic main-shadow svelte-zdetv5");
			add_location(div0, file$2, 48, 8, 1055);
			attr_dev(li0, "class", "svelte-zdetv5");
			add_location(li0, file$2, 69, 12, 1895);
			attr_dev(li1, "class", "svelte-zdetv5");
			add_location(li1, file$2, 72, 12, 2015);
			attr_dev(li2, "class", "svelte-zdetv5");
			add_location(li2, file$2, 75, 12, 2136);
			add_location(br0, file$2, 79, 16, 2279);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 90, 20, 2630);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 91, 20, 2670);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 92, 20, 2711);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 89, 16, 2578);
			attr_dev(li3, "class", "svelte-zdetv5");
			add_location(li3, file$2, 78, 12, 2258);
			attr_dev(li4, "class", "svelte-zdetv5");
			add_location(li4, file$2, 95, 12, 2791);
			attr_dev(ul0, "class", "options svelte-zdetv5");
			add_location(ul0, file$2, 68, 8, 1862);
			attr_dev(section0, "class", "top svelte-zdetv5");
			add_location(section0, file$2, 47, 4, 1025);
			attr_dev(section1, "class", "rate svelte-zdetv5");
			add_location(section1, file$2, 103, 4, 2972);
			add_location(br1, file$2, 111, 4, 3275);
			add_location(br2, file$2, 112, 4, 3284);
			attr_dev(h10, "class", "svelte-zdetv5");
			add_location(h10, file$2, 114, 4, 3294);
			add_location(br3, file$2, 116, 4, 3323);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 118, 4, 3333);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 46, 0, 993);
			attr_dev(h11, "class", "svelte-zdetv5");
			add_location(h11, file$2, 171, 0, 4288);
			add_location(br4, file$2, 173, 0, 4356);
			add_location(br5, file$2, 174, 0, 4361);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 176, 0, 4367);
			add_location(br6, file$2, 178, 0, 4409);
			add_location(br7, file$2, 179, 0, 4414);
			add_location(p1, file$2, 181, 0, 4420);
			add_location(p2, file$2, 182, 0, 4456);
			add_location(p3, file$2, 183, 0, 4500);
			add_location(br8, file$2, 185, 0, 4546);
			add_location(br9, file$2, 186, 0, 4551);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 188, 0, 4557);
			add_location(span0, file$2, 192, 8, 4631);
			add_location(li5, file$2, 191, 4, 4618);
			add_location(span1, file$2, 199, 8, 4865);
			add_location(li6, file$2, 198, 4, 4852);
			add_location(span2, file$2, 206, 8, 5060);
			add_location(li7, file$2, 205, 4, 5047);
			add_location(ul1, file$2, 190, 0, 4609);
			add_location(br10, file$2, 214, 0, 5278);
			add_location(br11, file$2, 215, 0, 5283);
			add_location(br12, file$2, 219, 8, 5390);
			add_location(br13, file$2, 221, 8, 5419);
			add_location(br14, file$2, 222, 8, 5432);
			add_location(br15, file$2, 224, 8, 5508);
			add_location(br16, file$2, 225, 8, 5521);
			add_location(br17, file$2, 227, 8, 5610);
			add_location(br18, file$2, 228, 8, 5623);
			add_location(br19, file$2, 230, 8, 5729);
			add_location(br20, file$2, 231, 8, 5742);
			add_location(br21, file$2, 235, 8, 5869);
			add_location(br22, file$2, 236, 8, 5882);
			add_location(br23, file$2, 238, 8, 5989);
			add_location(br24, file$2, 239, 8, 6002);
			add_location(br25, file$2, 241, 8, 6108);
			add_location(br26, file$2, 242, 8, 6121);
			add_location(div1, file$2, 218, 4, 5376);
			add_location(br27, file$2, 246, 8, 6156);
			add_location(br28, file$2, 248, 8, 6194);
			add_location(br29, file$2, 249, 8, 6207);
			add_location(br30, file$2, 251, 8, 6292);
			add_location(br31, file$2, 252, 8, 6305);
			add_location(br32, file$2, 254, 8, 6403);
			add_location(br33, file$2, 255, 8, 6416);
			add_location(br34, file$2, 257, 8, 6514);
			add_location(br35, file$2, 258, 8, 6527);
			add_location(br36, file$2, 262, 8, 6663);
			add_location(br37, file$2, 263, 8, 6676);
			add_location(br38, file$2, 265, 8, 6792);
			add_location(br39, file$2, 266, 8, 6805);
			add_location(br40, file$2, 268, 8, 6920);
			add_location(br41, file$2, 269, 8, 6933);
			add_location(div2, file$2, 245, 4, 6142);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 217, 0, 5289);
			add_location(br42, file$2, 273, 0, 6961);
			add_location(br43, file$2, 274, 0, 6966);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 276, 0, 6972);
			add_location(br44, file$2, 278, 0, 7015);
			add_location(br45, file$2, 279, 0, 7020);
			add_location(br46, file$2, 284, 4, 7085);
			add_location(br47, file$2, 285, 4, 7094);
			add_location(br48, file$2, 289, 4, 7177);
			add_location(br49, file$2, 290, 4, 7186);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 295, 8, 7275);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 296, 8, 7302);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 297, 8, 7329);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 294, 4, 7247);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 300, 4, 7369);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 301, 4, 7427);
			add_location(br50, file$2, 303, 4, 7476);
			add_location(br51, file$2, 304, 4, 7485);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 306, 4, 7495);
			add_location(br52, file$2, 308, 4, 7547);
			add_location(br53, file$2, 309, 4, 7556);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 311, 4, 7566);
			add_location(section4, file$2, 281, 0, 7026);
			add_location(br54, file$2, 314, 0, 7642);
			add_location(br55, file$2, 315, 0, 7647);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 317, 0, 7653);
			add_location(br56, file$2, 323, 0, 7777);
			add_location(br57, file$2, 324, 0, 7782);
			add_location(br58, file$2, 328, 0, 7854);
			add_location(br59, file$2, 329, 0, 7859);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 331, 0, 7865);
			add_location(strong, file$2, 334, 4, 7910);
			add_location(p4, file$2, 333, 0, 7902);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 339, 0, 8019);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
