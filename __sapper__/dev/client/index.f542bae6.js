...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-1l1j0nq");
			add_location(li, file, 247, 12, 6305);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 262, 4, 6496);
			add_location(br1, file, 263, 4, 6505);
			add_location(br2, file, 267, 4, 6579);
			add_location(br3, file, 268, 4, 6588);
			add_location(br4, file, 272, 4, 6660);
			add_location(br5, file, 273, 4, 6669);
			add_location(br6, file, 277, 4, 6742);
			add_location(br7, file, 278, 4, 6751);
			add_location(br8, file, 282, 4, 6822);
			add_location(br9, file, 283, 4, 6831);
			add_location(br10, file, 287, 4, 6905);
			add_location(br11, file, 288, 4, 6914);
			add_location(br12, file, 292, 4, 6986);
			add_location(br13, file, 293, 4, 6995);
			add_location(br14, file, 297, 4, 7071);
			add_location(br15, file, 298, 4, 7080);
			add_location(br16, file, 302, 4, 7151);
			add_location(br17, file, 303, 4, 7160);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br9, file, 235, 0, 6087);
			add_location(br10, file, 236, 0, 6092);
			set_style(h21, "text-align", "right");
			add_location(h21, file, 240, 4, 6151);
			add_location(br11, file, 243, 4, 6234);
			attr_dev(ul2, "class", "cards svelte-1l1j0nq");
			add_location(ul2, file, 245, 4, 6244);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 238, 0, 6098);
			add_location(br12, file, 254, 0, 6403);
			add_location(br13, file, 255, 0, 6408);
			add_location(br14, file, 256, 0, 6413);
			attr_dev(h11, "class", "svelte-1l1j0nq");
			add_location(h11, file, 308, 0, 7230);
			add_location(br15, file, 310, 0, 7298);
			add_location(br16, file, 311, 0, 7303);
			attr_dev(h22, "class", "text-success");
			add_location(h22, file, 313, 0, 7309);
			add_location(br17, file, 315, 0, 7351);
			add_location(br18, file, 316, 0, 7356);
			add_location(p2, file, 318, 0, 7362);
			add_location(p3, file, 319, 0, 7398);
			add_location(p4, file, 320, 0, 7442);
			add_location(br19, file, 322, 0, 7488);
			add_location(br20, file, 323, 0, 7493);
			attr_dev(h23, "class", "text-warning");
			add_location(h23, file, 325, 0, 7499);
			add_location(span1, file, 329, 8, 7573);
			add_location(li5, file, 328, 4, 7560);
			add_location(span2, file, 336, 8, 7807);
			add_location(li6, file, 335, 4, 7794);
			add_location(span3, file, 343, 8, 8002);
			add_location(li7, file, 342, 4, 7989);
			add_location(ul3, file, 327, 0, 7551);
			add_location(br21, file, 351, 0, 8220);
			add_location(br22, file, 352, 0, 8225);
			add_location(br23, file, 356, 8, 8332);
			add_location(br24, file, 358, 8, 8361);
			add_location(br25, file, 359, 8, 8374);
			add_location(br26, file, 361, 8, 8450);
			add_location(br27, file, 362, 8, 8463);
			add_location(br28, file, 364, 8, 8552);
			add_location(br29, file, 365, 8, 8565);
			add_location(br30, file, 367, 8, 8671);
			add_location(br31, file, 368, 8, 8684);
			add_location(br32, file, 372, 8, 8811);
			add_location(br33, file, 373, 8, 8824);
			add_location(br34, file, 375, 8, 8931);
			add_location(br35, file, 376, 8, 8944);
			add_location(br36, file, 378, 8, 9050);
			add_location(br37, file, 379, 8, 9063);
			add_location(div4, file, 355, 4, 8318);
			add_location(br38, file, 383, 8, 9098);
			add_location(br39, file, 385, 8, 9136);
			add_location(br40, file, 386, 8, 9149);
			add_location(br41, file, 388, 8, 9234);
			add_location(br42, file, 389, 8, 9247);
			add_location(br43, file, 391, 8, 9345);
			add_location(br44, file, 392, 8, 9358);
			add_location(br45, file, 394, 8, 9456);
			add_location(br46, file, 395, 8, 9469);
			add_location(br47, file, 399, 8, 9605);
			add_location(br48, file, 400, 8, 9618);
			add_location(br49, file, 402, 8, 9734);
			add_location(br50, file, 403, 8, 9747);
			add_location(br51, file, 405, 8, 9862);
			add_location(br52, file, 406, 8, 9875);
			add_location(div5, file, 382, 4, 9084);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 354, 0, 8231);
			add_location(br53, file, 410, 0, 9903);
			add_location(br54, file, 411, 0, 9908);
			attr_dev(h24, "class", "text-danger");
			add_location(h24, file, 413, 0, 9914);
			add_location(br55, file, 415, 0, 9957);
			add_location(br56, file, 416, 0, 9962);
			add_location(br57, file, 421, 4, 10027);
			add_location(br58, file, 422, 4, 10036);
			add_location(br59, file, 426, 4, 10119);
			add_location(br60, file, 427, 4, 10128);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 432, 8, 10217);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 433, 8, 10244);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 434, 8, 10271);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 431, 4, 10189);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 437, 4, 10311);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 438, 4, 10369);
			add_location(br61, file, 440, 4, 10418);
			add_location(br62, file, 441, 4, 10427);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 443, 4, 10437);
			add_location(br63, file, 445, 4, 10489);
			add_location(br64, file, 446, 4, 10498);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 448, 4, 10508);
			add_location(section4, file, 418, 0, 9968);
			add_location(br65, file, 451, 0, 10584);
			add_location(br66, file, 452, 0, 10589);
			attr_dev(h25, "class", "text-info");
			add_location(h25, file, 454, 0, 10595);
			add_location(br67, file, 456, 0, 10630);
			add_location(br68, file, 457, 0, 10635);
			add_location(br69, file, 461, 0, 10707);
			add_location(br70, file, 462, 0, 10712);
			attr_dev(h26, "class", "text-success");
			add_location(h26, file, 464, 0, 10718);
			add_location(strong, file, 467, 4, 10763);
			add_location(p5, file, 466, 0, 10755);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 472, 0, 10872);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
