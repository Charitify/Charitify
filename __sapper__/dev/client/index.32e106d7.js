...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br57, file$2, 361, 0, 8469);
			add_location(br58, file$2, 362, 0, 8474);
			add_location(br59, file$2, 366, 0, 8546);
			add_location(br60, file$2, 367, 0, 8551);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 369, 0, 8557);
			add_location(strong, file$2, 372, 4, 8602);
			add_location(p5, file$2, 371, 0, 8594);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 377, 0, 8711);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
