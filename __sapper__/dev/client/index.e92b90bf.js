...
function create_fragment$6(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t1 = claim_text(p_nodes, /*currYear*/ ctx[0]);
			p_nodes.forEach(detach_dev);
			footer_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			add_location(p, file$6, 5, 4, 79);
			attr_dev(footer, "class", "svelte-17uqt94");
			add_location(footer, file$6, 4, 0, 66);
		},
		m: function mount(target, anchor) {
