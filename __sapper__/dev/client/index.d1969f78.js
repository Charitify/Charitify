...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div, file, 242, 8, 6254);
		},
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(242:4) {#if showIndicators}",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file, 244, 16, 6363);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(244:12) {#each indicators as x, i }",
		ctx
	});
