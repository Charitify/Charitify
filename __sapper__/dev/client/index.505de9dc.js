...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$8, 43, 8, 1341);
			attr_dev(div1, "class", "progress-inner-frame svelte-1kjumgy");
			add_location(div1, file$8, 42, 4, 1298);
			...
			add_location(div2, file$8, 31, 0, 1027);
		},
		m: function mount(target, anchor) {
...
function getBorderRadius(borders, defaults = "9999") {
