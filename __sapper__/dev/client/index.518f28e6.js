...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 106, 4, 2536);
			add_location(br1, file, 107, 4, 2545);
			add_location(br2, file, 111, 4, 2619);
			add_location(br3, file, 112, 4, 2628);
			add_location(br4, file, 116, 4, 2700);
			add_location(br5, file, 117, 4, 2709);
			add_location(br6, file, 121, 4, 2782);
			add_location(br7, file, 122, 4, 2791);
			add_location(br8, file, 126, 4, 2862);
			add_location(br9, file, 127, 4, 2871);
			add_location(br10, file, 131, 4, 2945);
			add_location(br11, file, 132, 4, 2954);
			add_location(br12, file, 136, 4, 3026);
			add_location(br13, file, 137, 4, 3035);
			add_location(br14, file, 141, 4, 3111);
			add_location(br15, file, 142, 4, 3120);
			add_location(br16, file, 146, 4, 3191);
			add_location(br17, file, 147, 4, 3200);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h11, file, 152, 0, 3270);
			add_location(br5, file, 154, 0, 3338);
			add_location(br6, file, 155, 0, 3343);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 157, 0, 3349);
			add_location(br7, file, 159, 0, 3391);
			add_location(br8, file, 160, 0, 3396);
			add_location(p1, file, 162, 0, 3402);
			add_location(p2, file, 163, 0, 3438);
			add_location(p3, file, 164, 0, 3482);
			add_location(br9, file, 166, 0, 3528);
			add_location(br10, file, 167, 0, 3533);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 169, 0, 3539);
			add_location(span1, file, 173, 8, 3613);
			add_location(li5, file, 172, 4, 3600);
			add_location(span2, file, 180, 8, 3847);
			add_location(li6, file, 179, 4, 3834);
			add_location(span3, file, 187, 8, 4042);
			add_location(li7, file, 186, 4, 4029);
			add_location(ul1, file, 171, 0, 3591);
			add_location(br11, file, 195, 0, 4260);
			add_location(br12, file, 196, 0, 4265);
			add_location(br13, file, 200, 8, 4372);
			add_location(br14, file, 202, 8, 4401);
			add_location(br15, file, 203, 8, 4414);
			add_location(br16, file, 205, 8, 4490);
			add_location(br17, file, 206, 8, 4503);
			add_location(br18, file, 208, 8, 4592);
			add_location(br19, file, 209, 8, 4605);
			add_location(br20, file, 211, 8, 4711);
			add_location(br21, file, 212, 8, 4724);
			add_location(br22, file, 216, 8, 4851);
			add_location(br23, file, 217, 8, 4864);
			add_location(br24, file, 219, 8, 4971);
			add_location(br25, file, 220, 8, 4984);
			add_location(br26, file, 222, 8, 5090);
			add_location(br27, file, 223, 8, 5103);
			add_location(div1, file, 199, 4, 4358);
			add_location(br28, file, 227, 8, 5138);
			add_location(br29, file, 229, 8, 5176);
			add_location(br30, file, 230, 8, 5189);
			add_location(br31, file, 232, 8, 5274);
			add_location(br32, file, 233, 8, 5287);
			add_location(br33, file, 235, 8, 5385);
			add_location(br34, file, 236, 8, 5398);
			add_location(br35, file, 238, 8, 5496);
			add_location(br36, file, 239, 8, 5509);
			add_location(br37, file, 243, 8, 5645);
			add_location(br38, file, 244, 8, 5658);
			add_location(br39, file, 246, 8, 5774);
			add_location(br40, file, 247, 8, 5787);
			add_location(br41, file, 249, 8, 5902);
			add_location(br42, file, 250, 8, 5915);
			add_location(div2, file, 226, 4, 5124);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 198, 0, 4271);
			add_location(br43, file, 254, 0, 5943);
			add_location(br44, file, 255, 0, 5948);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 257, 0, 5954);
			add_location(br45, file, 259, 0, 5997);
			add_location(br46, file, 260, 0, 6002);
			add_location(br47, file, 265, 4, 6067);
			add_location(br48, file, 266, 4, 6076);
			add_location(br49, file, 270, 4, 6159);
			add_location(br50, file, 271, 4, 6168);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 276, 8, 6257);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 277, 8, 6284);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 278, 8, 6311);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 275, 4, 6229);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 281, 4, 6351);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 282, 4, 6409);
			add_location(br51, file, 284, 4, 6458);
			add_location(br52, file, 285, 4, 6467);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 287, 4, 6477);
			add_location(br53, file, 289, 4, 6529);
			add_location(br54, file, 290, 4, 6538);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 292, 4, 6548);
			add_location(section4, file, 262, 0, 6008);
			add_location(br55, file, 295, 0, 6624);
			add_location(br56, file, 296, 0, 6629);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 298, 0, 6635);
			add_location(br57, file, 304, 0, 6759);
			add_location(br58, file, 305, 0, 6764);
			add_location(br59, file, 309, 0, 6836);
			add_location(br60, file, 310, 0, 6841);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 312, 0, 6847);
			add_location(strong, file, 315, 4, 6892);
			add_location(p4, file, 314, 0, 6884);
			set_style(p5, "text-align", "justify");
			add_location(p5, file, 320, 0, 7001);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
