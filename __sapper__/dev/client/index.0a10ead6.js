...
// (170:16) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_15(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(170:16) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (190:16) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_14(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(190:16) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-1ypkzhj");
			add_location(li, file, 233, 12, 6218);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 248, 4, 6405);
			add_location(br1, file, 249, 4, 6414);
			add_location(br2, file, 253, 4, 6488);
			add_location(br3, file, 254, 4, 6497);
			add_location(br4, file, 258, 4, 6569);
			add_location(br5, file, 259, 4, 6578);
			add_location(br6, file, 263, 4, 6651);
			add_location(br7, file, 264, 4, 6660);
			add_location(br8, file, 268, 4, 6731);
			add_location(br9, file, 269, 4, 6740);
			add_location(br10, file, 273, 4, 6814);
			add_location(br11, file, 274, 4, 6823);
			add_location(br12, file, 278, 4, 6895);
			add_location(br13, file, 279, 4, 6904);
			add_location(br14, file, 283, 4, 6980);
			add_location(br15, file, 284, 4, 6989);
			add_location(br16, file, 288, 4, 7060);
			add_location(br17, file, 289, 4, 7069);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-1ypkzhj");
			add_location(div0, file, 141, 8, 3526);
			attr_dev(li0, "class", "svelte-1ypkzhj");
			add_location(li0, file, 162, 12, 4354);
			attr_dev(li1, "class", "svelte-1ypkzhj");
			add_location(li1, file, 165, 12, 4474);
			attr_dev(li2, "class", "svelte-1ypkzhj");
			add_location(li2, file, 168, 12, 4595);
			add_location(br0, file, 172, 16, 4738);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 183, 20, 5089);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 184, 20, 5129);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 185, 20, 5170);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 182, 16, 5037);
			attr_dev(li3, "class", "svelte-1ypkzhj");
			add_location(li3, file, 171, 12, 4717);
			attr_dev(li4, "class", "svelte-1ypkzhj");
			add_location(li4, file, 188, 12, 5250);
			attr_dev(ul0, "class", "options svelte-1ypkzhj");
			add_location(ul0, file, 161, 8, 4321);
			attr_dev(section0, "class", "top svelte-1ypkzhj");
			add_location(section0, file, 140, 4, 3496);
			add_location(br1, file, 195, 4, 5430);
			attr_dev(h3, "class", "svelte-1ypkzhj");
			add_location(h3, file, 203, 16, 5663);
			attr_dev(p0, "class", "svelte-1ypkzhj");
			add_location(p0, file, 204, 16, 5703);
			attr_dev(span0, "class", "svelte-1ypkzhj");
			add_location(span0, file, 202, 12, 5640);
			attr_dev(div1, "class", "ava-section svelte-1ypkzhj");
			add_location(div1, file, 199, 8, 5524);
			attr_dev(section1, "class", "rate-section svelte-1ypkzhj");
			add_location(section1, file, 198, 4, 5485);
			add_location(br2, file, 211, 4, 5804);
			attr_dev(h10, "class", "svelte-1ypkzhj");
			add_location(h10, file, 213, 4, 5814);
			add_location(br3, file, 215, 4, 5843);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 217, 4, 5853);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 139, 0, 3464);
			add_location(br4, file, 222, 0, 6009);
			add_location(br5, file, 223, 0, 6014);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 228, 4, 6074);
			attr_dev(ul1, "class", "cards svelte-1ypkzhj");
			add_location(ul1, file, 231, 4, 6157);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 225, 0, 6020);
			add_location(br6, file, 241, 0, 6317);
			add_location(br7, file, 242, 0, 6322);
			attr_dev(h11, "class", "svelte-1ypkzhj");
			add_location(h11, file, 294, 0, 7139);
			add_location(br8, file, 296, 0, 7207);
			add_location(br9, file, 297, 0, 7212);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 299, 0, 7218);
			add_location(br10, file, 301, 0, 7260);
			add_location(br11, file, 302, 0, 7265);
			add_location(p2, file, 304, 0, 7271);
			add_location(p3, file, 305, 0, 7307);
			add_location(p4, file, 306, 0, 7351);
			add_location(br12, file, 308, 0, 7397);
			add_location(br13, file, 309, 0, 7402);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 311, 0, 7408);
			add_location(span1, file, 315, 8, 7482);
			add_location(li5, file, 314, 4, 7469);
			add_location(span2, file, 322, 8, 7716);
			add_location(li6, file, 321, 4, 7703);
			add_location(span3, file, 329, 8, 7911);
			add_location(li7, file, 328, 4, 7898);
			add_location(ul2, file, 313, 0, 7460);
			add_location(br14, file, 337, 0, 8129);
			add_location(br15, file, 338, 0, 8134);
			add_location(br16, file, 342, 8, 8241);
			add_location(br17, file, 344, 8, 8270);
			add_location(br18, file, 345, 8, 8283);
			add_location(br19, file, 347, 8, 8359);
			add_location(br20, file, 348, 8, 8372);
			add_location(br21, file, 350, 8, 8461);
			add_location(br22, file, 351, 8, 8474);
			add_location(br23, file, 353, 8, 8580);
			add_location(br24, file, 354, 8, 8593);
			add_location(br25, file, 358, 8, 8720);
			add_location(br26, file, 359, 8, 8733);
			add_location(br27, file, 361, 8, 8840);
			add_location(br28, file, 362, 8, 8853);
			add_location(br29, file, 364, 8, 8959);
			add_location(br30, file, 365, 8, 8972);
			add_location(div3, file, 341, 4, 8227);
			add_location(br31, file, 369, 8, 9007);
			add_location(br32, file, 371, 8, 9045);
			add_location(br33, file, 372, 8, 9058);
			add_location(br34, file, 374, 8, 9143);
			add_location(br35, file, 375, 8, 9156);
			add_location(br36, file, 377, 8, 9254);
			add_location(br37, file, 378, 8, 9267);
			add_location(br38, file, 380, 8, 9365);
			add_location(br39, file, 381, 8, 9378);
			add_location(br40, file, 385, 8, 9514);
			add_location(br41, file, 386, 8, 9527);
			add_location(br42, file, 388, 8, 9643);
			add_location(br43, file, 389, 8, 9656);
			add_location(br44, file, 391, 8, 9771);
			add_location(br45, file, 392, 8, 9784);
			add_location(div4, file, 368, 4, 8993);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 340, 0, 8140);
			add_location(br46, file, 396, 0, 9812);
			add_location(br47, file, 397, 0, 9817);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 399, 0, 9823);
			add_location(br48, file, 401, 0, 9866);
			add_location(br49, file, 402, 0, 9871);
			add_location(br50, file, 407, 4, 9936);
			add_location(br51, file, 408, 4, 9945);
			add_location(br52, file, 412, 4, 10028);
			add_location(br53, file, 413, 4, 10037);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 418, 8, 10126);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 419, 8, 10153);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 420, 8, 10180);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 417, 4, 10098);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 423, 4, 10220);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 424, 4, 10278);
			add_location(br54, file, 426, 4, 10327);
			add_location(br55, file, 427, 4, 10336);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 429, 4, 10346);
			add_location(br56, file, 431, 4, 10398);
			add_location(br57, file, 432, 4, 10407);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 434, 4, 10417);
			add_location(section4, file, 404, 0, 9877);
			add_location(br58, file, 437, 0, 10493);
			add_location(br59, file, 438, 0, 10498);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 440, 0, 10504);
			add_location(br60, file, 442, 0, 10539);
			add_location(br61, file, 443, 0, 10544);
			add_location(br62, file, 447, 0, 10616);
			add_location(br63, file, 448, 0, 10621);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 450, 0, 10627);
			add_location(strong, file, 453, 4, 10672);
			add_location(p5, file, 452, 0, 10664);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 458, 0, 10781);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
