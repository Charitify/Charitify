...
function create_fragment$b(ctx) {
	...
	const block = {
		c: function create() {
			...
			if (!default_slot) {
				pre = element("pre");
				t6 = text("A loooooooooooooong comment that has been\n                left by a very angry guy who complains upon\n                looooong comments.");
			}
		...
		l: function claim(nodes) {
			...
			if (!default_slot) {
				...
				t6 = claim_text(pre_nodes, "A loooooooooooooong comment that has been\n                left by a very angry guy who complains upon\n                looooong comments.");
