...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br, file$g, 53, 8, 1822);
		},
		m: function mount(target, anchor) {
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file$g, 57, 12, 1902);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
...
function create_fragment$g(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(ul, file$g, 55, 4, 1841);
