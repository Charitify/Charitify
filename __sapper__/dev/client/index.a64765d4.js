...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "images svelte-zfbadj");
			add_location(div0, file$b, 14, 4, 375);
			attr_dev(h5, "class", "svelte-zfbadj");
			add_location(h5, file$b, 36, 4, 967);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding-top", "var(--screen-padding)");
			add_location(p0, file$b, 38, 4, 989);
			attr_dev(h3, "class", "svelte-zfbadj");
			add_location(h3, file$b, 46, 12, 1204);
			attr_dev(p1, "class", "svelte-zfbadj");
			add_location(p1, file$b, 47, 12, 1235);
			attr_dev(span, "class", "svelte-zfbadj");
			add_location(span, file$b, 45, 8, 1185);
			attr_dev(footer, "class", "ava-section svelte-zfbadj");
			add_location(footer, file$b, 42, 4, 1099);
			attr_dev(div1, "class", "card svelte-zfbadj");
