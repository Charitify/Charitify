...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 128, 4, 3496);
			add_location(br1, file$2, 129, 4, 3505);
			add_location(br2, file$2, 133, 4, 3579);
			add_location(br3, file$2, 134, 4, 3588);
			add_location(br4, file$2, 138, 4, 3660);
			add_location(br5, file$2, 139, 4, 3669);
			add_location(br6, file$2, 143, 4, 3742);
			add_location(br7, file$2, 144, 4, 3751);
			add_location(br8, file$2, 148, 4, 3822);
			add_location(br9, file$2, 149, 4, 3831);
			add_location(br10, file$2, 153, 4, 3905);
			add_location(br11, file$2, 154, 4, 3914);
			add_location(br12, file$2, 158, 4, 3986);
			add_location(br13, file$2, 159, 4, 3995);
			add_location(br14, file$2, 163, 4, 4071);
			add_location(br15, file$2, 164, 4, 4080);
			add_location(br16, file$2, 168, 4, 4151);
			add_location(br17, file$2, 169, 4, 4160);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file$2, 106, 4, 2933);
			add_location(br2, file$2, 114, 4, 3217);
			add_location(br3, file$2, 115, 4, 3226);
			attr_dev(h10, "class", "svelte-12g2sr8");
			add_location(h10, file$2, 117, 4, 3236);
			add_location(br4, file$2, 119, 4, 3265);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 121, 4, 3275);
			attr_dev(section2, "class", "top-wrap svelte-12g2sr8");
			add_location(section2, file$2, 47, 0, 889);
			attr_dev(h11, "class", "svelte-12g2sr8");
			add_location(h11, file$2, 174, 0, 4230);
			add_location(br5, file$2, 176, 0, 4298);
			add_location(br6, file$2, 177, 0, 4303);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 179, 0, 4309);
			add_location(br7, file$2, 181, 0, 4351);
			add_location(br8, file$2, 182, 0, 4356);
			add_location(p1, file$2, 184, 0, 4362);
			add_location(p2, file$2, 185, 0, 4398);
			add_location(p3, file$2, 186, 0, 4442);
			add_location(br9, file$2, 188, 0, 4488);
			add_location(br10, file$2, 189, 0, 4493);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 191, 0, 4499);
			add_location(span1, file$2, 195, 8, 4573);
			add_location(li5, file$2, 194, 4, 4560);
			add_location(span2, file$2, 202, 8, 4807);
			add_location(li6, file$2, 201, 4, 4794);
			add_location(span3, file$2, 209, 8, 5002);
			add_location(li7, file$2, 208, 4, 4989);
			add_location(ul1, file$2, 193, 0, 4551);
			add_location(br11, file$2, 217, 0, 5220);
			add_location(br12, file$2, 218, 0, 5225);
			add_location(br13, file$2, 222, 8, 5332);
			add_location(br14, file$2, 224, 8, 5361);
			add_location(br15, file$2, 225, 8, 5374);
			add_location(br16, file$2, 227, 8, 5450);
			add_location(br17, file$2, 228, 8, 5463);
			add_location(br18, file$2, 230, 8, 5552);
			add_location(br19, file$2, 231, 8, 5565);
			add_location(br20, file$2, 233, 8, 5671);
			add_location(br21, file$2, 234, 8, 5684);
			add_location(br22, file$2, 238, 8, 5811);
			add_location(br23, file$2, 239, 8, 5824);
			add_location(br24, file$2, 241, 8, 5931);
			add_location(br25, file$2, 242, 8, 5944);
			add_location(br26, file$2, 244, 8, 6050);
			add_location(br27, file$2, 245, 8, 6063);
			add_location(div1, file$2, 221, 4, 5318);
			add_location(br28, file$2, 249, 8, 6098);
			add_location(br29, file$2, 251, 8, 6136);
			add_location(br30, file$2, 252, 8, 6149);
			add_location(br31, file$2, 254, 8, 6234);
			add_location(br32, file$2, 255, 8, 6247);
			add_location(br33, file$2, 257, 8, 6345);
			add_location(br34, file$2, 258, 8, 6358);
			add_location(br35, file$2, 260, 8, 6456);
			add_location(br36, file$2, 261, 8, 6469);
			add_location(br37, file$2, 265, 8, 6605);
			add_location(br38, file$2, 266, 8, 6618);
			add_location(br39, file$2, 268, 8, 6734);
			add_location(br40, file$2, 269, 8, 6747);
			add_location(br41, file$2, 271, 8, 6862);
			add_location(br42, file$2, 272, 8, 6875);
			add_location(div2, file$2, 248, 4, 6084);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 220, 0, 5231);
			add_location(br43, file$2, 276, 0, 6903);
			add_location(br44, file$2, 277, 0, 6908);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 279, 0, 6914);
			add_location(br45, file$2, 281, 0, 6957);
			add_location(br46, file$2, 282, 0, 6962);
			add_location(br47, file$2, 287, 4, 7027);
			add_location(br48, file$2, 288, 4, 7036);
			add_location(br49, file$2, 292, 4, 7119);
			add_location(br50, file$2, 293, 4, 7128);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 298, 8, 7217);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 299, 8, 7244);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 300, 8, 7271);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 297, 4, 7189);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 303, 4, 7311);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 304, 4, 7369);
			add_location(br51, file$2, 306, 4, 7418);
			add_location(br52, file$2, 307, 4, 7427);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 309, 4, 7437);
			add_location(br53, file$2, 311, 4, 7489);
			add_location(br54, file$2, 312, 4, 7498);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 314, 4, 7508);
			add_location(section4, file$2, 284, 0, 6968);
			add_location(br55, file$2, 317, 0, 7584);
			add_location(br56, file$2, 318, 0, 7589);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 320, 0, 7595);
			add_location(br57, file$2, 326, 0, 7719);
			add_location(br58, file$2, 327, 0, 7724);
			add_location(br59, file$2, 331, 0, 7796);
			add_location(br60, file$2, 332, 0, 7801);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 334, 0, 7807);
			add_location(strong, file$2, 337, 4, 7852);
			add_location(p4, file$2, 336, 0, 7844);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 342, 0, 7961);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
