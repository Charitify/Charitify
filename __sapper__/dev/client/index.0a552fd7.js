...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 108, 4, 2590);
			add_location(br1, file, 109, 4, 2599);
			add_location(br2, file, 113, 4, 2673);
			add_location(br3, file, 114, 4, 2682);
			add_location(br4, file, 118, 4, 2754);
			add_location(br5, file, 119, 4, 2763);
			add_location(br6, file, 123, 4, 2836);
			add_location(br7, file, 124, 4, 2845);
			add_location(br8, file, 128, 4, 2916);
			add_location(br9, file, 129, 4, 2925);
			add_location(br10, file, 133, 4, 2999);
			add_location(br11, file, 134, 4, 3008);
			add_location(br12, file, 138, 4, 3080);
			add_location(br13, file, 139, 4, 3089);
			add_location(br14, file, 143, 4, 3165);
			add_location(br15, file, 144, 4, 3174);
			add_location(br16, file, 148, 4, 3245);
			add_location(br17, file, 149, 4, 3254);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file, 86, 4, 2087);
			add_location(br2, file, 94, 4, 2311);
			add_location(br3, file, 95, 4, 2320);
			attr_dev(h10, "class", "svelte-omfi2y");
			add_location(h10, file, 97, 4, 2330);
			add_location(br4, file, 99, 4, 2359);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file, 101, 4, 2369);
			attr_dev(section2, "class", "top-wrap svelte-omfi2y");
			add_location(section2, file, 43, 0, 679);
			attr_dev(h11, "class", "svelte-omfi2y");
			add_location(h11, file, 154, 0, 3324);
			add_location(br5, file, 156, 0, 3392);
			add_location(br6, file, 157, 0, 3397);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 159, 0, 3403);
			add_location(br7, file, 161, 0, 3445);
			add_location(br8, file, 162, 0, 3450);
			add_location(p1, file, 164, 0, 3456);
			add_location(p2, file, 165, 0, 3492);
			add_location(p3, file, 166, 0, 3536);
			add_location(br9, file, 168, 0, 3582);
			add_location(br10, file, 169, 0, 3587);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 171, 0, 3593);
			add_location(span1, file, 175, 8, 3667);
			add_location(li5, file, 174, 4, 3654);
			add_location(span2, file, 182, 8, 3901);
			add_location(li6, file, 181, 4, 3888);
			add_location(span3, file, 189, 8, 4096);
			add_location(li7, file, 188, 4, 4083);
			add_location(ul1, file, 173, 0, 3645);
			add_location(br11, file, 197, 0, 4314);
			add_location(br12, file, 198, 0, 4319);
			add_location(br13, file, 202, 8, 4426);
			add_location(br14, file, 204, 8, 4455);
			add_location(br15, file, 205, 8, 4468);
			add_location(br16, file, 207, 8, 4544);
			add_location(br17, file, 208, 8, 4557);
			add_location(br18, file, 210, 8, 4646);
			add_location(br19, file, 211, 8, 4659);
			add_location(br20, file, 213, 8, 4765);
			add_location(br21, file, 214, 8, 4778);
			add_location(br22, file, 218, 8, 4905);
			add_location(br23, file, 219, 8, 4918);
			add_location(br24, file, 221, 8, 5025);
			add_location(br25, file, 222, 8, 5038);
			add_location(br26, file, 224, 8, 5144);
			add_location(br27, file, 225, 8, 5157);
			add_location(div1, file, 201, 4, 4412);
			add_location(br28, file, 229, 8, 5192);
			add_location(br29, file, 231, 8, 5230);
			add_location(br30, file, 232, 8, 5243);
			add_location(br31, file, 234, 8, 5328);
			add_location(br32, file, 235, 8, 5341);
			add_location(br33, file, 237, 8, 5439);
			add_location(br34, file, 238, 8, 5452);
			add_location(br35, file, 240, 8, 5550);
			add_location(br36, file, 241, 8, 5563);
			add_location(br37, file, 245, 8, 5699);
			add_location(br38, file, 246, 8, 5712);
			add_location(br39, file, 248, 8, 5828);
			add_location(br40, file, 249, 8, 5841);
			add_location(br41, file, 251, 8, 5956);
			add_location(br42, file, 252, 8, 5969);
			add_location(div2, file, 228, 4, 5178);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 200, 0, 4325);
			add_location(br43, file, 256, 0, 5997);
			add_location(br44, file, 257, 0, 6002);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 259, 0, 6008);
			add_location(br45, file, 261, 0, 6051);
			add_location(br46, file, 262, 0, 6056);
			add_location(br47, file, 267, 4, 6121);
			add_location(br48, file, 268, 4, 6130);
			add_location(br49, file, 272, 4, 6213);
			add_location(br50, file, 273, 4, 6222);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 278, 8, 6311);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 279, 8, 6338);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 280, 8, 6365);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 277, 4, 6283);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 283, 4, 6405);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 284, 4, 6463);
			add_location(br51, file, 286, 4, 6512);
			add_location(br52, file, 287, 4, 6521);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 289, 4, 6531);
			add_location(br53, file, 291, 4, 6583);
			add_location(br54, file, 292, 4, 6592);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 294, 4, 6602);
			add_location(section4, file, 264, 0, 6062);
			add_location(br55, file, 297, 0, 6678);
			add_location(br56, file, 298, 0, 6683);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 300, 0, 6689);
			add_location(br57, file, 306, 0, 6813);
			add_location(br58, file, 307, 0, 6818);
			add_location(br59, file, 311, 0, 6890);
			add_location(br60, file, 312, 0, 6895);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 314, 0, 6901);
			add_location(strong, file, 317, 4, 6946);
			add_location(p4, file, 316, 0, 6938);
			set_style(p5, "text-align", "justify");
			add_location(p5, file, 322, 0, 7055);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
