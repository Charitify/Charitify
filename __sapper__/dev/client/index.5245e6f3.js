...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(footer, "class", "ava-section svelte-onscs3");
			add_location(footer, file$b, 39, 4, 1199);
			attr_dev(div1, "class", "card svelte-onscs3");
