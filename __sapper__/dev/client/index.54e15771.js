...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file$b, 43, 16, 1334);
			attr_dev(p1, "class", "svelte-onscs3");
			add_location(p1, file$b, 44, 16, 1374);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 42, 12, 1311);
