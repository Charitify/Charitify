...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			p0 = claim_element(div2_nodes, "P", { class: true, style: true });
		...
		h: function hydrate() {
			...
			add_location(h3, file$b, 44, 16, 1355);
			attr_dev(p1, "class", "svelte-onscs3");
			add_location(p1, file$b, 45, 16, 1395);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 43, 12, 1332);
			attr_dev(div1, "class", "ava-section svelte-onscs3");
			add_location(div1, file$b, 40, 8, 1216);
