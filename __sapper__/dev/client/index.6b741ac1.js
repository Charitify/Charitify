...
function create_fragment$b(ctx) {
	...
	const block = {
		c: function create() {
			...
			span = element("span");
			h3 = element("h3");
			t5 = text("Tina Kandelaki");
			t6 = space();
			p1 = element("p");
			t7 = text("ORG charity charitify");
			this.h();
		},
		l: function claim(nodes) {
			...
			t5 = claim_text(h3_nodes, "Tina Kandelaki");
			h3_nodes.forEach(detach_dev);
			t6 = claim_space(span_nodes);
			p1 = claim_element(span_nodes, "P", { class: true });
			var p1_nodes = children(p1);
			t7 = claim_text(p1_nodes, "ORG charity charitify");
		...
		h: function hydrate() {
			...
			add_location(br, file$b, 35, 4, 1107);
			attr_dev(p0, "class", "text-center");
			add_location(p0, file$b, 37, 4, 1117);
			attr_dev(h3, "class", "svelte-onscs3");
			add_location(h3, file$b, 46, 16, 1340);
			attr_dev(p1, "class", "svelte-onscs3");
			add_location(p1, file$b, 47, 16, 1380);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 45, 12, 1317);
			attr_dev(div1, "class", "ava-section svelte-onscs3");
			add_location(div1, file$b, 42, 8, 1201);
			add_location(footer, file$b, 41, 4, 1184);
