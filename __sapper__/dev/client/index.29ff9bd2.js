...
// (313:4) <Button is="success" type="submit">
function create_default_slot_13(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(313:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (269:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 269, 4, 6799);
			add_location(br1, file, 270, 4, 6808);
			add_location(br2, file, 274, 4, 6882);
			add_location(br3, file, 275, 4, 6891);
			add_location(br4, file, 279, 4, 6963);
			add_location(br5, file, 280, 4, 6972);
			add_location(br6, file, 284, 4, 7045);
			add_location(br7, file, 285, 4, 7054);
			add_location(br8, file, 289, 4, 7125);
			add_location(br9, file, 290, 4, 7134);
			add_location(br10, file, 294, 4, 7208);
			add_location(br11, file, 295, 4, 7217);
			add_location(br12, file, 299, 4, 7289);
			add_location(br13, file, 300, 4, 7298);
			add_location(br14, file, 304, 4, 7374);
			add_location(br15, file, 305, 4, 7383);
			add_location(br16, file, 309, 4, 7454);
			add_location(br17, file, 310, 4, 7463);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(269:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (368:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(368:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (374:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(374:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (378:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(378:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (382:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(382:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (385:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(385:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (395:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(395:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (401:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(401:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (405:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(405:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (409:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(409:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (412:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(412:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t46 = space();
			h11 = element("h1");
			t47 = text("Charitify - is the application for helping those in need.");
			t48 = space();
			br16 = element("br");
			t49 = space();
			br17 = element("br");
			...
			t54 = space();
			p2 = element("p");
			t55 = text("Few paragraphs to text fonts");
			t56 = space();
			p3 = element("p");
			t57 = text("Декілька параграфів для тесту тексту");
			t58 = space();
			p4 = element("p");
			t59 = text("Несколько параграфов для теста текста");
			t60 = space();
			br20 = element("br");
			t61 = space();
			br21 = element("br");
			...
			t154 = text("Try editing this file (src/routes/index.svelte) to test live reloading.");
			t155 = space();
			p6 = element("p");
			t156 = text("A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.");
			this.h();
		},
		l: function claim(nodes) {
			t0 = claim_space(nodes);
			...
			t47 = claim_text(h11_nodes, "Charitify - is the application for helping those in need.");
			...
			t51 = claim_text(h22_nodes, "Typography");
			...
			t55 = claim_text(p2_nodes, "Few paragraphs to text fonts");
			p2_nodes.forEach(detach_dev);
			t56 = claim_space(nodes);
			p3 = claim_element(nodes, "P", {});
			var p3_nodes = children(p3);
			t57 = claim_text(p3_nodes, "Декілька параграфів для тесту тексту");
			p3_nodes.forEach(detach_dev);
			t58 = claim_space(nodes);
			p4 = claim_element(nodes, "P", {});
			var p4_nodes = children(p4);
			t59 = claim_text(p4_nodes, "Несколько параграфов для теста текста");
			...
			t63 = claim_text(h23_nodes, "Interactive elements");
			...
			t120 = claim_text(h24_nodes, "Input fields");
			...
			t132 = claim_text(label_nodes, "label");
			...
			t137 = claim_text(a_nodes, "Some link");
			...
			t141 = claim_text(button16_nodes, "Button example");
			...
			t145 = claim_text(h25_nodes, "Images");
			...
			t152 = claim_text(h26_nodes, "Other");
			...
			t154 = claim_text(strong_nodes, "Try editing this file (src/routes/index.svelte) to test live reloading.");
			strong_nodes.forEach(detach_dev);
			p5_nodes.forEach(detach_dev);
			t155 = claim_space(nodes);
			p6 = claim_element(nodes, "P", { style: true });
			var p6_nodes = children(p6);
			t156 = claim_text(p6_nodes, "A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.\n    A lot of English text. A lot of English text. A lot of English text. A lot of English text.");
		...
		h: function hydrate() {
			...
			add_location(h11, file, 315, 0, 7533);
			add_location(br16, file, 317, 0, 7601);
			add_location(br17, file, 318, 0, 7606);
			attr_dev(h22, "class", "text-success");
			add_location(h22, file, 320, 0, 7612);
			add_location(br18, file, 322, 0, 7654);
			add_location(br19, file, 323, 0, 7659);
			add_location(p2, file, 325, 0, 7665);
			add_location(p3, file, 326, 0, 7701);
			add_location(p4, file, 327, 0, 7745);
			add_location(br20, file, 329, 0, 7791);
			add_location(br21, file, 330, 0, 7796);
			attr_dev(h23, "class", "text-warning");
			add_location(h23, file, 332, 0, 7802);
			add_location(span1, file, 336, 8, 7876);
			add_location(li5, file, 335, 4, 7863);
			add_location(span2, file, 343, 8, 8110);
			add_location(li6, file, 342, 4, 8097);
			add_location(span3, file, 350, 8, 8305);
			add_location(li7, file, 349, 4, 8292);
			add_location(ul3, file, 334, 0, 7854);
			add_location(br22, file, 358, 0, 8523);
			add_location(br23, file, 359, 0, 8528);
			add_location(br24, file, 363, 8, 8635);
			add_location(br25, file, 365, 8, 8664);
			add_location(br26, file, 366, 8, 8677);
			add_location(br27, file, 368, 8, 8753);
			add_location(br28, file, 369, 8, 8766);
			add_location(br29, file, 371, 8, 8855);
			add_location(br30, file, 372, 8, 8868);
			add_location(br31, file, 374, 8, 8974);
			add_location(br32, file, 375, 8, 8987);
			add_location(br33, file, 379, 8, 9114);
			add_location(br34, file, 380, 8, 9127);
			add_location(br35, file, 382, 8, 9234);
			add_location(br36, file, 383, 8, 9247);
			add_location(br37, file, 385, 8, 9353);
			add_location(br38, file, 386, 8, 9366);
			add_location(div4, file, 362, 4, 8621);
			add_location(br39, file, 390, 8, 9401);
			add_location(br40, file, 392, 8, 9439);
			add_location(br41, file, 393, 8, 9452);
			add_location(br42, file, 395, 8, 9537);
			add_location(br43, file, 396, 8, 9550);
			add_location(br44, file, 398, 8, 9648);
			add_location(br45, file, 399, 8, 9661);
			add_location(br46, file, 401, 8, 9759);
			add_location(br47, file, 402, 8, 9772);
			add_location(br48, file, 406, 8, 9908);
			add_location(br49, file, 407, 8, 9921);
			add_location(br50, file, 409, 8, 10037);
			add_location(br51, file, 410, 8, 10050);
			add_location(br52, file, 412, 8, 10165);
			add_location(br53, file, 413, 8, 10178);
			add_location(div5, file, 389, 4, 9387);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 361, 0, 8534);
			add_location(br54, file, 417, 0, 10206);
			add_location(br55, file, 418, 0, 10211);
			attr_dev(h24, "class", "text-danger");
			add_location(h24, file, 420, 0, 10217);
			add_location(br56, file, 422, 0, 10260);
			add_location(br57, file, 423, 0, 10265);
			add_location(br58, file, 428, 4, 10330);
			add_location(br59, file, 429, 4, 10339);
			add_location(br60, file, 433, 4, 10422);
			add_location(br61, file, 434, 4, 10431);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 439, 8, 10520);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 440, 8, 10547);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 441, 8, 10574);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 438, 4, 10492);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 444, 4, 10614);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 445, 4, 10672);
			add_location(br62, file, 447, 4, 10721);
			add_location(br63, file, 448, 4, 10730);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 450, 4, 10740);
			add_location(br64, file, 452, 4, 10792);
			add_location(br65, file, 453, 4, 10801);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 455, 4, 10811);
			add_location(section4, file, 425, 0, 10271);
			add_location(br66, file, 458, 0, 10887);
			add_location(br67, file, 459, 0, 10892);
			attr_dev(h25, "class", "text-info");
			add_location(h25, file, 461, 0, 10898);
			add_location(br68, file, 463, 0, 10933);
			add_location(br69, file, 464, 0, 10938);
			add_location(br70, file, 468, 0, 11010);
			add_location(br71, file, 469, 0, 11015);
			attr_dev(h26, "class", "text-success");
			add_location(h26, file, 471, 0, 11021);
			add_location(strong, file, 474, 4, 11066);
			add_location(p5, file, 473, 0, 11058);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 479, 0, 11175);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
