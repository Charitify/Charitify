...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 126, 4, 3478);
			add_location(br1, file$2, 127, 4, 3487);
			add_location(br2, file$2, 131, 4, 3561);
			add_location(br3, file$2, 132, 4, 3570);
			add_location(br4, file$2, 136, 4, 3642);
			add_location(br5, file$2, 137, 4, 3651);
			add_location(br6, file$2, 141, 4, 3724);
			add_location(br7, file$2, 142, 4, 3733);
			add_location(br8, file$2, 146, 4, 3804);
			add_location(br9, file$2, 147, 4, 3813);
			add_location(br10, file$2, 151, 4, 3887);
			add_location(br11, file$2, 152, 4, 3896);
			add_location(br12, file$2, 156, 4, 3968);
			add_location(br13, file$2, 157, 4, 3977);
			add_location(br14, file$2, 161, 4, 4053);
			add_location(br15, file$2, 162, 4, 4062);
			add_location(br16, file$2, 166, 4, 4133);
			add_location(br17, file$2, 167, 4, 4142);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br1, file$2, 112, 4, 3199);
			add_location(br2, file$2, 113, 4, 3208);
			attr_dev(h10, "class", "svelte-dv7fz");
			add_location(h10, file$2, 115, 4, 3218);
			add_location(br3, file$2, 117, 4, 3247);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 119, 4, 3257);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 49, 0, 1087);
			attr_dev(h11, "class", "svelte-dv7fz");
			add_location(h11, file$2, 172, 0, 4212);
			add_location(br4, file$2, 174, 0, 4280);
			add_location(br5, file$2, 175, 0, 4285);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 177, 0, 4291);
			add_location(br6, file$2, 179, 0, 4333);
			add_location(br7, file$2, 180, 0, 4338);
			add_location(p1, file$2, 182, 0, 4344);
			add_location(p2, file$2, 183, 0, 4380);
			add_location(p3, file$2, 184, 0, 4424);
			add_location(br8, file$2, 186, 0, 4470);
			add_location(br9, file$2, 187, 0, 4475);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 189, 0, 4481);
			add_location(span0, file$2, 193, 8, 4555);
			add_location(li5, file$2, 192, 4, 4542);
			add_location(span1, file$2, 200, 8, 4789);
			add_location(li6, file$2, 199, 4, 4776);
			add_location(span2, file$2, 207, 8, 4984);
			add_location(li7, file$2, 206, 4, 4971);
			add_location(ul1, file$2, 191, 0, 4533);
			add_location(br10, file$2, 215, 0, 5202);
			add_location(br11, file$2, 216, 0, 5207);
			add_location(br12, file$2, 220, 8, 5314);
			add_location(br13, file$2, 222, 8, 5343);
			add_location(br14, file$2, 223, 8, 5356);
			add_location(br15, file$2, 225, 8, 5432);
			add_location(br16, file$2, 226, 8, 5445);
			add_location(br17, file$2, 228, 8, 5534);
			add_location(br18, file$2, 229, 8, 5547);
			add_location(br19, file$2, 231, 8, 5653);
			add_location(br20, file$2, 232, 8, 5666);
			add_location(br21, file$2, 236, 8, 5793);
			add_location(br22, file$2, 237, 8, 5806);
			add_location(br23, file$2, 239, 8, 5913);
			add_location(br24, file$2, 240, 8, 5926);
			add_location(br25, file$2, 242, 8, 6032);
			add_location(br26, file$2, 243, 8, 6045);
			add_location(div1, file$2, 219, 4, 5300);
			add_location(br27, file$2, 247, 8, 6080);
			add_location(br28, file$2, 249, 8, 6118);
			add_location(br29, file$2, 250, 8, 6131);
			add_location(br30, file$2, 252, 8, 6216);
			add_location(br31, file$2, 253, 8, 6229);
			add_location(br32, file$2, 255, 8, 6327);
			add_location(br33, file$2, 256, 8, 6340);
			add_location(br34, file$2, 258, 8, 6438);
			add_location(br35, file$2, 259, 8, 6451);
			add_location(br36, file$2, 263, 8, 6587);
			add_location(br37, file$2, 264, 8, 6600);
			add_location(br38, file$2, 266, 8, 6716);
			add_location(br39, file$2, 267, 8, 6729);
			add_location(br40, file$2, 269, 8, 6844);
			add_location(br41, file$2, 270, 8, 6857);
			add_location(div2, file$2, 246, 4, 6066);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 218, 0, 5213);
			add_location(br42, file$2, 274, 0, 6885);
			add_location(br43, file$2, 275, 0, 6890);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 277, 0, 6896);
			add_location(br44, file$2, 279, 0, 6939);
			add_location(br45, file$2, 280, 0, 6944);
			add_location(br46, file$2, 285, 4, 7009);
			add_location(br47, file$2, 286, 4, 7018);
			add_location(br48, file$2, 290, 4, 7101);
			add_location(br49, file$2, 291, 4, 7110);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 296, 8, 7199);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 297, 8, 7226);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 298, 8, 7253);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 295, 4, 7171);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 301, 4, 7293);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 302, 4, 7351);
			add_location(br50, file$2, 304, 4, 7400);
			add_location(br51, file$2, 305, 4, 7409);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 307, 4, 7419);
			add_location(br52, file$2, 309, 4, 7471);
			add_location(br53, file$2, 310, 4, 7480);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 312, 4, 7490);
			add_location(section4, file$2, 282, 0, 6950);
			add_location(br54, file$2, 315, 0, 7566);
			add_location(br55, file$2, 316, 0, 7571);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 318, 0, 7577);
			add_location(br56, file$2, 324, 0, 7701);
			add_location(br57, file$2, 325, 0, 7706);
			add_location(br58, file$2, 329, 0, 7778);
			add_location(br59, file$2, 330, 0, 7783);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 332, 0, 7789);
			add_location(strong, file$2, 335, 4, 7834);
			add_location(p4, file$2, 334, 0, 7826);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 340, 0, 7943);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
