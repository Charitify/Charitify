...
import { I as Icon, P as Picture, B as Button, a as Input, b as Progress, F as Form } from './index.cc6ea908.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 143, 10, 2820);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 143, 0, 2810);
			add_location(br0, file, 145, 0, 2869);
			add_location(br1, file, 146, 0, 2874);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 148, 0, 2880);
			add_location(br2, file, 150, 0, 2922);
			add_location(br3, file, 151, 0, 2927);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 153, 0, 2933);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 154, 0, 2969);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 155, 0, 3013);
			add_location(br4, file, 157, 0, 3059);
			add_location(br5, file, 158, 0, 3064);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 160, 0, 3070);
			add_location(br6, file, 162, 0, 3122);
			add_location(br7, file, 163, 0, 3127);
			add_location(br8, file, 167, 8, 3234);
			add_location(br9, file, 169, 8, 3263);
			add_location(br10, file, 170, 8, 3276);
			add_location(br11, file, 172, 8, 3352);
			add_location(br12, file, 173, 8, 3365);
			add_location(br13, file, 175, 8, 3454);
			add_location(br14, file, 176, 8, 3467);
			add_location(br15, file, 178, 8, 3573);
			add_location(br16, file, 179, 8, 3586);
			add_location(br17, file, 183, 8, 3713);
			add_location(br18, file, 184, 8, 3726);
			add_location(br19, file, 186, 8, 3833);
			add_location(br20, file, 187, 8, 3846);
			add_location(br21, file, 189, 8, 3952);
			add_location(br22, file, 190, 8, 3965);
			add_location(div1, file, 166, 4, 3220);
			add_location(br23, file, 194, 8, 4000);
			add_location(br24, file, 196, 8, 4038);
			add_location(br25, file, 197, 8, 4051);
			add_location(br26, file, 199, 8, 4136);
			add_location(br27, file, 200, 8, 4149);
			add_location(br28, file, 202, 8, 4247);
			add_location(br29, file, 203, 8, 4260);
			add_location(br30, file, 205, 8, 4358);
			add_location(br31, file, 206, 8, 4371);
			add_location(br32, file, 210, 8, 4507);
			add_location(br33, file, 211, 8, 4520);
			add_location(br34, file, 213, 8, 4636);
			add_location(br35, file, 214, 8, 4649);
			add_location(br36, file, 216, 8, 4764);
			add_location(br37, file, 217, 8, 4777);
			add_location(div2, file, 193, 4, 3986);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 165, 0, 3133);
			add_location(br38, file, 221, 0, 4805);
			add_location(br39, file, 222, 0, 4810);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 224, 0, 4816);
			add_location(br40, file, 226, 0, 4859);
			add_location(br41, file, 227, 0, 4864);
			add_location(br42, file, 232, 4, 4929);
			add_location(br43, file, 233, 4, 4938);
			add_location(br44, file, 237, 4, 5021);
			add_location(br45, file, 238, 4, 5030);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 243, 8, 5119);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 244, 8, 5146);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 245, 8, 5173);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 242, 4, 5091);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 248, 4, 5213);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 249, 4, 5271);
			add_location(br46, file, 251, 4, 5320);
			add_location(br47, file, 252, 4, 5329);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 254, 4, 5339);
			add_location(br48, file, 256, 4, 5391);
			add_location(br49, file, 257, 4, 5400);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 259, 4, 5410);
			add_location(section4, file, 229, 0, 4870);
			add_location(br50, file, 262, 0, 5486);
			add_location(br51, file, 263, 0, 5491);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 265, 0, 5497);
			add_location(br52, file, 271, 0, 5621);
			add_location(br53, file, 272, 0, 5626);
			add_location(br54, file, 276, 0, 5698);
			add_location(br55, file, 277, 0, 5703);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 279, 0, 5709);
			add_location(strong, file, 282, 4, 5754);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 281, 0, 5746);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 287, 0, 5863);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
