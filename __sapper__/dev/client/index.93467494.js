...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-18ko52n"));
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty & /*classProp*/ 16 && button_class_value !== (button_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-18ko52n"))) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-18ko52n"));
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty & /*classProp*/ 16 && a_class_value !== (a_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-18ko52n"))) {
...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-core svelte-1hahocr");
			attr_dev(div0, "style", div0_style_value = `width:${/*val*/ ctx[1]}%`);
			add_location(div0, file$5, 29, 8, 800);
			attr_dev(div1, "class", "progress-inner-frame svelte-1hahocr");
			add_location(div1, file$5, 28, 4, 757);
			attr_dev(div2, "id", /*id*/ ctx[0]);
			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1hahocr"));
			...
			add_location(div2, file$5, 18, 0, 537);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 16 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1hahocr"))) {
