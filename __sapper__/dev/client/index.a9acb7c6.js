...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			set_style(h31, "font-size", "1.175em");
			add_location(h31, file, 67, 0, 2203);
			add_location(span5, file, 67, 48, 2251);
			add_location(h4, file, 68, 0, 2274);
			add_location(span6, file, 68, 21, 2295);
			add_location(h5, file, 69, 0, 2318);
			add_location(span7, file, 69, 21, 2339);
			add_location(h6, file, 70, 0, 2362);
			add_location(span8, file, 70, 21, 2383);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 72, 0, 2407);
			attr_dev(section, "class", "container");
			add_location(section, file, 76, 0, 2462);
		},
