...
const file$d = "src/layouts/SearchLine.svelte";
...
function create_fragment$d(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(section, file$d, 4, 0, 62);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
class AvatarAndName extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$c, create_fragment$e, safe_not_equal, { src: 0, title: 1, subtitle: 2 });
...
const file$h = "src/layouts/NavigationBar.svelte";
...
class NavigationBar extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$f, create_fragment$h, safe_not_equal, { segment: 0 });
...
function create_fragment$i(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$i, 5, 4, 35);
			add_location(br, file$i, 6, 4, 89);
			add_location(p, file$i, 7, 4, 98);
			attr_dev(section, "class", "svelte-1qydgyt");
			add_location(section, file$i, 4, 0, 21);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function create_fragment$k(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$k, 5, 0, 69);
			add_location(br1, file$k, 6, 0, 74);
			add_location(p0, file$k, 7, 0, 79);
			add_location(br2, file$k, 8, 0, 184);
			add_location(p1, file$k, 9, 0, 189);
		},
		m: function mount(target, anchor) {
