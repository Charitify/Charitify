import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, L as Carousel, X as DonatingGroup, P as Progress, Y as AvatarAndName, Z as Rate, T as TitleSubTitle, R as CharityCards, Q as Footer, _ as onMount, p as space, e as element, o as create_component, r as claim_space, c as claim_element, b as children, q as claim_component, f as detach_dev, g as attr_dev, h as add_location, k as insert_dev, l as append_dev, t as mount_component, w as transition_in, x as transition_out, y as destroy_component } from './index.4afd8a71.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 48, 8, 1151);
			...
			add_location(section1, file, 57, 4, 1316);
			add_location(br0, file, 68, 8, 1565);
			add_location(br1, file, 73, 8, 1697);
			add_location(section2, file, 67, 4, 1547);
			attr_dev(section3, "class", "container");
			add_location(section3, file, 45, 0, 1088);
			add_location(br2, file, 78, 0, 1730);
			add_location(br3, file, 79, 0, 1735);
			add_location(br4, file, 80, 0, 1740);
			attr_dev(div1, "class", "container");
			add_location(div1, file, 82, 0, 1746);
			add_location(br5, file, 86, 0, 1798);
			add_location(br6, file, 87, 0, 1803);
			add_location(br7, file, 88, 0, 1808);
			add_location(br8, file, 89, 0, 1813);
			add_location(br9, file, 90, 0, 1818);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 92, 0, 1824);
			add_location(br10, file, 96, 0, 1876);
			add_location(br11, file, 97, 0, 1881);
			add_location(br12, file, 98, 0, 1886);
			add_location(br13, file, 99, 0, 1891);
			add_location(br14, file, 100, 0, 1896);
		},
