...
// (141:4) <Button is="success" type="submit">
function create_default_slot_14(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(141:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (97:0) <Form on:submit="{(e, v) => console.log(e, v)}">
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 97, 4, 2188);
			add_location(br1, file, 98, 4, 2197);
			add_location(br2, file, 102, 4, 2258);
			add_location(br3, file, 103, 4, 2267);
			add_location(br4, file, 107, 4, 2326);
			add_location(br5, file, 108, 4, 2335);
			add_location(br6, file, 112, 4, 2395);
			add_location(br7, file, 113, 4, 2404);
			add_location(br8, file, 117, 4, 2462);
			add_location(br9, file, 118, 4, 2471);
			add_location(br10, file, 122, 4, 2532);
			add_location(br11, file, 123, 4, 2541);
			add_location(br12, file, 127, 4, 2600);
			add_location(br13, file, 128, 4, 2609);
			add_location(br14, file, 132, 4, 2672);
			add_location(br15, file, 133, 4, 2681);
			add_location(br16, file, 137, 4, 2739);
			add_location(br17, file, 138, 4, 2748);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(97:0) <Form on:submit=\\\"{(e, v) => console.log(e, v)}\\\">",
		ctx
	});
...
// (172:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_12(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(172:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (175:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(175:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (178:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(178:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (182:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(182:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (186:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(186:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (189:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(189:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (199:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(199:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (202:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(202:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (209:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(209:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (213:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(213:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (216:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(216:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (268:0) <Picture alt="Borat" src="great-success.png" class="picture">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(268:0) <Picture alt=\\\"Borat\\\" src=\\\"great-success.png\\\" class=\\\"picture\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span1, file, 143, 10, 2828);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 143, 0, 2818);
			add_location(br0, file, 145, 0, 2877);
			add_location(br1, file, 146, 0, 2882);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 148, 0, 2888);
			add_location(br2, file, 150, 0, 2930);
			add_location(br3, file, 151, 0, 2935);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 153, 0, 2941);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 154, 0, 2977);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 155, 0, 3021);
			add_location(br4, file, 157, 0, 3067);
			add_location(br5, file, 158, 0, 3072);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 160, 0, 3078);
			add_location(br6, file, 162, 0, 3130);
			add_location(br7, file, 163, 0, 3135);
			add_location(br8, file, 167, 8, 3242);
			add_location(br9, file, 169, 8, 3271);
			add_location(br10, file, 170, 8, 3284);
			add_location(br11, file, 172, 8, 3360);
			add_location(br12, file, 173, 8, 3373);
			add_location(br13, file, 175, 8, 3462);
			add_location(br14, file, 176, 8, 3475);
			add_location(br15, file, 178, 8, 3581);
			add_location(br16, file, 179, 8, 3594);
			add_location(br17, file, 183, 8, 3721);
			add_location(br18, file, 184, 8, 3734);
			add_location(br19, file, 186, 8, 3841);
			add_location(br20, file, 187, 8, 3854);
			add_location(br21, file, 189, 8, 3960);
			add_location(br22, file, 190, 8, 3973);
			add_location(div1, file, 166, 4, 3228);
			add_location(br23, file, 194, 8, 4008);
			add_location(br24, file, 196, 8, 4046);
			add_location(br25, file, 197, 8, 4059);
			add_location(br26, file, 199, 8, 4144);
			add_location(br27, file, 200, 8, 4157);
			add_location(br28, file, 202, 8, 4255);
			add_location(br29, file, 203, 8, 4268);
			add_location(br30, file, 205, 8, 4366);
			add_location(br31, file, 206, 8, 4379);
			add_location(br32, file, 210, 8, 4515);
			add_location(br33, file, 211, 8, 4528);
			add_location(br34, file, 213, 8, 4644);
			add_location(br35, file, 214, 8, 4657);
			add_location(br36, file, 216, 8, 4772);
			add_location(br37, file, 217, 8, 4785);
			add_location(div2, file, 193, 4, 3994);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 165, 0, 3141);
			add_location(br38, file, 221, 0, 4813);
			add_location(br39, file, 222, 0, 4818);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 224, 0, 4824);
			add_location(br40, file, 226, 0, 4867);
			add_location(br41, file, 227, 0, 4872);
			add_location(br42, file, 232, 4, 4937);
			add_location(br43, file, 233, 4, 4946);
			add_location(br44, file, 237, 4, 5029);
			add_location(br45, file, 238, 4, 5038);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 243, 8, 5127);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 244, 8, 5154);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 245, 8, 5181);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 242, 4, 5099);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 248, 4, 5221);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 249, 4, 5279);
			add_location(br46, file, 251, 4, 5328);
			add_location(br47, file, 252, 4, 5337);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 254, 4, 5347);
			add_location(br48, file, 256, 4, 5399);
			add_location(br49, file, 257, 4, 5408);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 259, 4, 5418);
			add_location(section4, file, 229, 0, 4878);
			add_location(br50, file, 262, 0, 5494);
			add_location(br51, file, 263, 0, 5499);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 265, 0, 5505);
			add_location(br52, file, 271, 0, 5629);
			add_location(br53, file, 272, 0, 5634);
			add_location(br54, file, 276, 0, 5706);
			add_location(br55, file, 277, 0, 5711);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 279, 0, 5717);
			add_location(strong, file, 282, 4, 5762);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 281, 0, 5754);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 287, 0, 5871);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
function instance($$self) {
	...
	const submit_handler = (e, v) => console.log(e, v);
