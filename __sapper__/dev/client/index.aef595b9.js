...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "images svelte-lmf000");
			...
			attr_dev(div1, "class", "card svelte-lmf000");
