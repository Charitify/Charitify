...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 124, 4, 3419);
			add_location(br1, file$2, 125, 4, 3428);
			add_location(br2, file$2, 129, 4, 3502);
			add_location(br3, file$2, 130, 4, 3511);
			add_location(br4, file$2, 134, 4, 3583);
			add_location(br5, file$2, 135, 4, 3592);
			add_location(br6, file$2, 139, 4, 3665);
			add_location(br7, file$2, 140, 4, 3674);
			add_location(br8, file$2, 144, 4, 3745);
			add_location(br9, file$2, 145, 4, 3754);
			add_location(br10, file$2, 149, 4, 3828);
			add_location(br11, file$2, 150, 4, 3837);
			add_location(br12, file$2, 154, 4, 3909);
			add_location(br13, file$2, 155, 4, 3918);
			add_location(br14, file$2, 159, 4, 3994);
			add_location(br15, file$2, 160, 4, 4003);
			add_location(br16, file$2, 164, 4, 4074);
			add_location(br17, file$2, 165, 4, 4083);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 41, 0, 815);
			attr_dev(div0, "class", "top-pic main-shadow svelte-1x3zvbg");
			add_location(div0, file$2, 45, 8, 883);
			attr_dev(li0, "class", "svelte-1x3zvbg");
			add_location(li0, file$2, 66, 12, 1723);
			attr_dev(li1, "class", "svelte-1x3zvbg");
			add_location(li1, file$2, 69, 12, 1843);
			attr_dev(li2, "class", "svelte-1x3zvbg");
			add_location(li2, file$2, 72, 12, 1964);
			add_location(br1, file$2, 76, 16, 2107);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 87, 20, 2458);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 88, 20, 2498);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 89, 20, 2539);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 86, 16, 2406);
			attr_dev(li3, "class", "svelte-1x3zvbg");
			add_location(li3, file$2, 75, 12, 2086);
			attr_dev(li4, "class", "svelte-1x3zvbg");
			add_location(li4, file$2, 92, 12, 2619);
			attr_dev(ul0, "class", "options svelte-1x3zvbg");
			add_location(ul0, file$2, 65, 8, 1690);
			attr_dev(section0, "class", "top svelte-1x3zvbg");
			add_location(section0, file$2, 44, 4, 853);
			set_style(section1, "padding", "7px 0");
			add_location(section1, file$2, 98, 4, 2762);
			add_location(span0, file$2, 102, 4, 2856);
			add_location(br2, file$2, 110, 4, 3140);
			add_location(br3, file$2, 111, 4, 3149);
			attr_dev(h10, "class", "svelte-1x3zvbg");
			add_location(h10, file$2, 113, 4, 3159);
			add_location(br4, file$2, 115, 4, 3188);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 117, 4, 3198);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 43, 0, 821);
			attr_dev(h11, "class", "svelte-1x3zvbg");
			add_location(h11, file$2, 170, 0, 4153);
			add_location(br5, file$2, 172, 0, 4221);
			add_location(br6, file$2, 173, 0, 4226);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 175, 0, 4232);
			add_location(br7, file$2, 177, 0, 4274);
			add_location(br8, file$2, 178, 0, 4279);
			add_location(p1, file$2, 180, 0, 4285);
			add_location(p2, file$2, 181, 0, 4321);
			add_location(p3, file$2, 182, 0, 4365);
			add_location(br9, file$2, 184, 0, 4411);
			add_location(br10, file$2, 185, 0, 4416);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 187, 0, 4422);
			add_location(span1, file$2, 191, 8, 4496);
			add_location(li5, file$2, 190, 4, 4483);
			add_location(span2, file$2, 198, 8, 4730);
			add_location(li6, file$2, 197, 4, 4717);
			add_location(span3, file$2, 205, 8, 4925);
			add_location(li7, file$2, 204, 4, 4912);
			add_location(ul1, file$2, 189, 0, 4474);
			add_location(br11, file$2, 213, 0, 5143);
			add_location(br12, file$2, 214, 0, 5148);
			add_location(br13, file$2, 218, 8, 5255);
			add_location(br14, file$2, 220, 8, 5284);
			add_location(br15, file$2, 221, 8, 5297);
			add_location(br16, file$2, 223, 8, 5373);
			add_location(br17, file$2, 224, 8, 5386);
			add_location(br18, file$2, 226, 8, 5475);
			add_location(br19, file$2, 227, 8, 5488);
			add_location(br20, file$2, 229, 8, 5594);
			add_location(br21, file$2, 230, 8, 5607);
			add_location(br22, file$2, 234, 8, 5734);
			add_location(br23, file$2, 235, 8, 5747);
			add_location(br24, file$2, 237, 8, 5854);
			add_location(br25, file$2, 238, 8, 5867);
			add_location(br26, file$2, 240, 8, 5973);
			add_location(br27, file$2, 241, 8, 5986);
			add_location(div1, file$2, 217, 4, 5241);
			add_location(br28, file$2, 245, 8, 6021);
			add_location(br29, file$2, 247, 8, 6059);
			add_location(br30, file$2, 248, 8, 6072);
			add_location(br31, file$2, 250, 8, 6157);
			add_location(br32, file$2, 251, 8, 6170);
			add_location(br33, file$2, 253, 8, 6268);
			add_location(br34, file$2, 254, 8, 6281);
			add_location(br35, file$2, 256, 8, 6379);
			add_location(br36, file$2, 257, 8, 6392);
			add_location(br37, file$2, 261, 8, 6528);
			add_location(br38, file$2, 262, 8, 6541);
			add_location(br39, file$2, 264, 8, 6657);
			add_location(br40, file$2, 265, 8, 6670);
			add_location(br41, file$2, 267, 8, 6785);
			add_location(br42, file$2, 268, 8, 6798);
			add_location(div2, file$2, 244, 4, 6007);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 216, 0, 5154);
			add_location(br43, file$2, 272, 0, 6826);
			add_location(br44, file$2, 273, 0, 6831);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 275, 0, 6837);
			add_location(br45, file$2, 277, 0, 6880);
			add_location(br46, file$2, 278, 0, 6885);
			add_location(br47, file$2, 283, 4, 6950);
			add_location(br48, file$2, 284, 4, 6959);
			add_location(br49, file$2, 288, 4, 7042);
			add_location(br50, file$2, 289, 4, 7051);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 294, 8, 7140);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 295, 8, 7167);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 296, 8, 7194);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 293, 4, 7112);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 299, 4, 7234);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 300, 4, 7292);
			add_location(br51, file$2, 302, 4, 7341);
			add_location(br52, file$2, 303, 4, 7350);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 305, 4, 7360);
			add_location(br53, file$2, 307, 4, 7412);
			add_location(br54, file$2, 308, 4, 7421);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 310, 4, 7431);
			add_location(section4, file$2, 280, 0, 6891);
			add_location(br55, file$2, 313, 0, 7507);
			add_location(br56, file$2, 314, 0, 7512);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 316, 0, 7518);
			add_location(br57, file$2, 322, 0, 7642);
			add_location(br58, file$2, 323, 0, 7647);
			add_location(br59, file$2, 327, 0, 7719);
			add_location(br60, file$2, 328, 0, 7724);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 330, 0, 7730);
			add_location(strong, file$2, 333, 4, 7775);
			add_location(p4, file$2, 332, 0, 7767);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 338, 0, 7884);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
