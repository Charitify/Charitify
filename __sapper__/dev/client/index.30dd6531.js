...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-nxuv9s");
			add_location(h4, file$9, 12, 8, 230);
			attr_dev(p, "class", "svelte-nxuv9s");
			add_location(p, file$9, 13, 8, 255);
			attr_dev(span, "class", "svelte-nxuv9s");
			add_location(span, file$9, 11, 4, 215);
			attr_dev(section, "class", "svelte-nxuv9s");
