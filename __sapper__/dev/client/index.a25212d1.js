...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file, 234, 12, 6185);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(234:8) {#each cards as card}",
		ctx
	});
...
// (293:4) <Button is="success" type="submit">
function create_default_slot_13(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(293:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (249:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 249, 4, 6372);
			add_location(br1, file, 250, 4, 6381);
			add_location(br2, file, 254, 4, 6455);
			add_location(br3, file, 255, 4, 6464);
			add_location(br4, file, 259, 4, 6536);
			add_location(br5, file, 260, 4, 6545);
			add_location(br6, file, 264, 4, 6618);
			add_location(br7, file, 265, 4, 6627);
			add_location(br8, file, 269, 4, 6698);
			add_location(br9, file, 270, 4, 6707);
			add_location(br10, file, 274, 4, 6781);
			add_location(br11, file, 275, 4, 6790);
			add_location(br12, file, 279, 4, 6862);
			add_location(br13, file, 280, 4, 6871);
			add_location(br14, file, 284, 4, 6947);
			add_location(br15, file, 285, 4, 6956);
			add_location(br16, file, 289, 4, 7027);
			add_location(br17, file, 290, 4, 7036);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(249:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (348:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(348:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (351:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(351:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (354:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(354:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (358:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(358:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (362:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(362:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (365:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(365:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (375:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(375:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (385:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(385:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (389:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(389:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (392:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(392:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br6, file, 230, 4, 6114);
			attr_dev(ul1, "class", "cards svelte-mows4x");
			add_location(ul1, file, 232, 4, 6124);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 224, 0, 5977);
			add_location(br7, file, 242, 0, 6284);
			add_location(br8, file, 243, 0, 6289);
			attr_dev(h11, "class", "svelte-mows4x");
			add_location(h11, file, 295, 0, 7106);
			add_location(br9, file, 297, 0, 7174);
			add_location(br10, file, 298, 0, 7179);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 300, 0, 7185);
			add_location(br11, file, 302, 0, 7227);
			add_location(br12, file, 303, 0, 7232);
			add_location(p2, file, 305, 0, 7238);
			add_location(p3, file, 306, 0, 7274);
			add_location(p4, file, 307, 0, 7318);
			add_location(br13, file, 309, 0, 7364);
			add_location(br14, file, 310, 0, 7369);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 312, 0, 7375);
			add_location(span1, file, 316, 8, 7449);
			add_location(li5, file, 315, 4, 7436);
			add_location(span2, file, 323, 8, 7683);
			add_location(li6, file, 322, 4, 7670);
			add_location(span3, file, 330, 8, 7878);
			add_location(li7, file, 329, 4, 7865);
			add_location(ul2, file, 314, 0, 7427);
			add_location(br15, file, 338, 0, 8096);
			add_location(br16, file, 339, 0, 8101);
			add_location(br17, file, 343, 8, 8208);
			add_location(br18, file, 345, 8, 8237);
			add_location(br19, file, 346, 8, 8250);
			add_location(br20, file, 348, 8, 8326);
			add_location(br21, file, 349, 8, 8339);
			add_location(br22, file, 351, 8, 8428);
			add_location(br23, file, 352, 8, 8441);
			add_location(br24, file, 354, 8, 8547);
			add_location(br25, file, 355, 8, 8560);
			add_location(br26, file, 359, 8, 8687);
			add_location(br27, file, 360, 8, 8700);
			add_location(br28, file, 362, 8, 8807);
			add_location(br29, file, 363, 8, 8820);
			add_location(br30, file, 365, 8, 8926);
			add_location(br31, file, 366, 8, 8939);
			add_location(div3, file, 342, 4, 8194);
			add_location(br32, file, 370, 8, 8974);
			add_location(br33, file, 372, 8, 9012);
			add_location(br34, file, 373, 8, 9025);
			add_location(br35, file, 375, 8, 9110);
			add_location(br36, file, 376, 8, 9123);
			add_location(br37, file, 378, 8, 9221);
			add_location(br38, file, 379, 8, 9234);
			add_location(br39, file, 381, 8, 9332);
			add_location(br40, file, 382, 8, 9345);
			add_location(br41, file, 386, 8, 9481);
			add_location(br42, file, 387, 8, 9494);
			add_location(br43, file, 389, 8, 9610);
			add_location(br44, file, 390, 8, 9623);
			add_location(br45, file, 392, 8, 9738);
			add_location(br46, file, 393, 8, 9751);
			add_location(div4, file, 369, 4, 8960);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 341, 0, 8107);
			add_location(br47, file, 397, 0, 9779);
			add_location(br48, file, 398, 0, 9784);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 400, 0, 9790);
			add_location(br49, file, 402, 0, 9833);
			add_location(br50, file, 403, 0, 9838);
			add_location(br51, file, 408, 4, 9903);
			add_location(br52, file, 409, 4, 9912);
			add_location(br53, file, 413, 4, 9995);
			add_location(br54, file, 414, 4, 10004);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 419, 8, 10093);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 420, 8, 10120);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 421, 8, 10147);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 418, 4, 10065);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 424, 4, 10187);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 425, 4, 10245);
			add_location(br55, file, 427, 4, 10294);
			add_location(br56, file, 428, 4, 10303);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 430, 4, 10313);
			add_location(br57, file, 432, 4, 10365);
			add_location(br58, file, 433, 4, 10374);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 435, 4, 10384);
			add_location(section4, file, 405, 0, 9844);
			add_location(br59, file, 438, 0, 10460);
			add_location(br60, file, 439, 0, 10465);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 441, 0, 10471);
			add_location(br61, file, 443, 0, 10506);
			add_location(br62, file, 444, 0, 10511);
			add_location(br63, file, 448, 0, 10583);
			add_location(br64, file, 449, 0, 10588);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 451, 0, 10594);
			add_location(strong, file, 454, 4, 10639);
			add_location(p5, file, 453, 0, 10631);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 459, 0, 10748);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
