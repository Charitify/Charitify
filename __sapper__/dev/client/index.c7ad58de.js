...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1jzuvi6"));
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty & /*classProp*/ 16 && button_class_value !== (button_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1jzuvi6"))) {
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1jzuvi6"));
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty & /*classProp*/ 16 && a_class_value !== (a_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1jzuvi6"))) {
