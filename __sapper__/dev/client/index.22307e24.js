...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-core svelte-1p4h3tt");
			attr_dev(div0, "style", div0_style_value = `width:${/*val*/ ctx[1]}%`);
			add_location(div0, file$5, 34, 8, 942);
			attr_dev(div1, "class", "progress-inner-frame svelte-1p4h3tt");
			add_location(div1, file$5, 33, 4, 899);
			attr_dev(div2, "id", /*id*/ ctx[0]);
			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1p4h3tt"));
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 16 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1p4h3tt"))) {
