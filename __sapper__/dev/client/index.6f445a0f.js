...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-h2p9q4");
			add_location(li, file, 237, 12, 6364);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-h2p9q4");
			add_location(li, file, 259, 12, 6694);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-h2p9q4");
			add_location(div0, file, 145, 8, 3712);
			attr_dev(li0, "class", "svelte-h2p9q4");
			add_location(li0, file, 166, 12, 4540);
			attr_dev(li1, "class", "svelte-h2p9q4");
			add_location(li1, file, 169, 12, 4660);
			attr_dev(li2, "class", "svelte-h2p9q4");
			add_location(li2, file, 172, 12, 4781);
			add_location(br0, file, 176, 16, 4924);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 187, 20, 5275);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 188, 20, 5315);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 189, 20, 5356);
			attr_dev(datalist, "id", "sum-suggestions");
			add_location(datalist, file, 186, 16, 5223);
			attr_dev(li3, "class", "svelte-h2p9q4");
			add_location(li3, file, 175, 12, 4903);
			attr_dev(li4, "class", "svelte-h2p9q4");
			add_location(li4, file, 192, 12, 5436);
			attr_dev(ul0, "class", "options svelte-h2p9q4");
			add_location(ul0, file, 165, 8, 4507);
			attr_dev(section0, "class", "top svelte-h2p9q4");
			add_location(section0, file, 144, 4, 3682);
			attr_dev(h3, "class", "svelte-h2p9q4");
			add_location(h3, file, 205, 16, 5795);
			attr_dev(p0, "class", "svelte-h2p9q4");
			add_location(p0, file, 206, 16, 5835);
			attr_dev(span, "class", "svelte-h2p9q4");
			add_location(span, file, 204, 12, 5772);
			attr_dev(div1, "class", "ava-section svelte-h2p9q4");
			add_location(div1, file, 201, 8, 5656);
			attr_dev(section1, "class", "rate-section svelte-h2p9q4");
			add_location(section1, file, 200, 4, 5617);
			add_location(br1, file, 213, 4, 5936);
			attr_dev(h1, "class", "svelte-h2p9q4");
			add_location(h1, file, 215, 4, 5946);
			add_location(br2, file, 217, 4, 5975);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 219, 4, 5985);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 143, 0, 3650);
			add_location(br3, file, 224, 0, 6141);
			add_location(br4, file, 225, 0, 6146);
			add_location(br5, file, 226, 0, 6151);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 230, 4, 6210);
			add_location(br6, file, 233, 4, 6293);
			attr_dev(ul1, "class", "cards svelte-h2p9q4");
			add_location(ul1, file, 235, 4, 6303);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 228, 0, 6157);
			add_location(br7, file, 244, 0, 6462);
			add_location(br8, file, 245, 0, 6467);
			add_location(br9, file, 246, 0, 6472);
			add_location(br10, file, 247, 0, 6477);
			add_location(br11, file, 248, 0, 6482);
			set_style(h21, "text-align", "right");
			add_location(h21, file, 252, 4, 6541);
			add_location(br12, file, 255, 4, 6623);
			attr_dev(ul2, "class", "cards svelte-h2p9q4");
			add_location(ul2, file, 257, 4, 6633);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 250, 0, 6488);
			add_location(br13, file, 266, 0, 6792);
			add_location(br14, file, 267, 0, 6797);
			add_location(br15, file, 268, 0, 6802);
			add_location(br16, file, 269, 0, 6807);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
