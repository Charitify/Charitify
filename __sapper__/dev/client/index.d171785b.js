...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 162, 4, 4216);
			add_location(br1, file$2, 163, 4, 4225);
			add_location(br2, file$2, 167, 4, 4299);
			add_location(br3, file$2, 168, 4, 4308);
			add_location(br4, file$2, 172, 4, 4380);
			add_location(br5, file$2, 173, 4, 4389);
			add_location(br6, file$2, 177, 4, 4462);
			add_location(br7, file$2, 178, 4, 4471);
			add_location(br8, file$2, 182, 4, 4542);
			add_location(br9, file$2, 183, 4, 4551);
			add_location(br10, file$2, 187, 4, 4625);
			add_location(br11, file$2, 188, 4, 4634);
			add_location(br12, file$2, 192, 4, 4706);
			add_location(br13, file$2, 193, 4, 4715);
			add_location(br14, file$2, 197, 4, 4791);
			add_location(br15, file$2, 198, 4, 4800);
			add_location(br16, file$2, 202, 4, 4871);
			add_location(br17, file$2, 203, 4, 4880);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			claim_component(divider.$$.fragment, section2_nodes);
		...
		h: function hydrate() {
			...
			add_location(br3, file$2, 154, 4, 4105);
			add_location(br4, file$2, 155, 4, 4114);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 74, 0, 1621);
			attr_dev(h11, "class", "svelte-1acbdpe");
			add_location(h11, file$2, 208, 0, 4950);
			add_location(br5, file$2, 210, 0, 5018);
			add_location(br6, file$2, 211, 0, 5023);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 213, 0, 5029);
			add_location(br7, file$2, 215, 0, 5071);
			add_location(br8, file$2, 216, 0, 5076);
			add_location(p2, file$2, 218, 0, 5082);
			add_location(p3, file$2, 219, 0, 5118);
			add_location(p4, file$2, 220, 0, 5162);
			add_location(br9, file$2, 222, 0, 5208);
			add_location(br10, file$2, 223, 0, 5213);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 225, 0, 5219);
			add_location(span1, file$2, 229, 8, 5293);
			add_location(li5, file$2, 228, 4, 5280);
			add_location(span2, file$2, 236, 8, 5527);
			add_location(li6, file$2, 235, 4, 5514);
			add_location(span3, file$2, 243, 8, 5722);
			add_location(li7, file$2, 242, 4, 5709);
			add_location(ul1, file$2, 227, 0, 5271);
			add_location(br11, file$2, 251, 0, 5940);
			add_location(br12, file$2, 252, 0, 5945);
			add_location(br13, file$2, 256, 8, 6052);
			add_location(br14, file$2, 258, 8, 6081);
			add_location(br15, file$2, 259, 8, 6094);
			add_location(br16, file$2, 261, 8, 6170);
			add_location(br17, file$2, 262, 8, 6183);
			add_location(br18, file$2, 264, 8, 6272);
			add_location(br19, file$2, 265, 8, 6285);
			add_location(br20, file$2, 267, 8, 6391);
			add_location(br21, file$2, 268, 8, 6404);
			add_location(br22, file$2, 272, 8, 6531);
			add_location(br23, file$2, 273, 8, 6544);
			add_location(br24, file$2, 275, 8, 6651);
			add_location(br25, file$2, 276, 8, 6664);
			add_location(br26, file$2, 278, 8, 6770);
			add_location(br27, file$2, 279, 8, 6783);
			add_location(div2, file$2, 255, 4, 6038);
			add_location(br28, file$2, 283, 8, 6818);
			add_location(br29, file$2, 285, 8, 6856);
			add_location(br30, file$2, 286, 8, 6869);
			add_location(br31, file$2, 288, 8, 6954);
			add_location(br32, file$2, 289, 8, 6967);
			add_location(br33, file$2, 291, 8, 7065);
			add_location(br34, file$2, 292, 8, 7078);
			add_location(br35, file$2, 294, 8, 7176);
			add_location(br36, file$2, 295, 8, 7189);
			add_location(br37, file$2, 299, 8, 7325);
			add_location(br38, file$2, 300, 8, 7338);
			add_location(br39, file$2, 302, 8, 7454);
			add_location(br40, file$2, 303, 8, 7467);
			add_location(br41, file$2, 305, 8, 7582);
			add_location(br42, file$2, 306, 8, 7595);
			add_location(div3, file$2, 282, 4, 6804);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 254, 0, 5951);
			add_location(br43, file$2, 310, 0, 7623);
			add_location(br44, file$2, 311, 0, 7628);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 313, 0, 7634);
			add_location(br45, file$2, 315, 0, 7677);
			add_location(br46, file$2, 316, 0, 7682);
			add_location(br47, file$2, 321, 4, 7747);
			add_location(br48, file$2, 322, 4, 7756);
			add_location(br49, file$2, 326, 4, 7839);
			add_location(br50, file$2, 327, 4, 7848);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 332, 8, 7937);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 333, 8, 7964);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 334, 8, 7991);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 331, 4, 7909);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 337, 4, 8031);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 338, 4, 8089);
			add_location(br51, file$2, 340, 4, 8138);
			add_location(br52, file$2, 341, 4, 8147);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 343, 4, 8157);
			add_location(br53, file$2, 345, 4, 8209);
			add_location(br54, file$2, 346, 4, 8218);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 348, 4, 8228);
			add_location(section4, file$2, 318, 0, 7688);
			add_location(br55, file$2, 351, 0, 8304);
			add_location(br56, file$2, 352, 0, 8309);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 354, 0, 8315);
			add_location(br57, file$2, 360, 0, 8439);
			add_location(br58, file$2, 361, 0, 8444);
			add_location(br59, file$2, 365, 0, 8516);
			add_location(br60, file$2, 366, 0, 8521);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 368, 0, 8527);
			add_location(strong, file$2, 371, 4, 8572);
			add_location(p5, file$2, 370, 0, 8564);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 376, 0, 8681);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			...
			mount_component(divider, section2, null);
			insert_dev(target, t24, anchor);
