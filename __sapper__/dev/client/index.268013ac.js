...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 108, 4, 2605);
			add_location(br1, file, 109, 4, 2614);
			add_location(br2, file, 113, 4, 2688);
			add_location(br3, file, 114, 4, 2697);
			add_location(br4, file, 118, 4, 2769);
			add_location(br5, file, 119, 4, 2778);
			add_location(br6, file, 123, 4, 2851);
			add_location(br7, file, 124, 4, 2860);
			add_location(br8, file, 128, 4, 2931);
			add_location(br9, file, 129, 4, 2940);
			add_location(br10, file, 133, 4, 3014);
			add_location(br11, file, 134, 4, 3023);
			add_location(br12, file, 138, 4, 3095);
			add_location(br13, file, 139, 4, 3104);
			add_location(br14, file, 143, 4, 3180);
			add_location(br15, file, 144, 4, 3189);
			add_location(br16, file, 148, 4, 3260);
			add_location(br17, file, 149, 4, 3269);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br2, file, 94, 4, 2326);
			add_location(br3, file, 95, 4, 2335);
			attr_dev(h10, "class", "svelte-omfi2y");
			add_location(h10, file, 97, 4, 2345);
			add_location(br4, file, 99, 4, 2374);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file, 101, 4, 2384);
			attr_dev(section2, "class", "top-wrap svelte-omfi2y");
			add_location(section2, file, 43, 0, 679);
			attr_dev(h11, "class", "svelte-omfi2y");
			add_location(h11, file, 154, 0, 3339);
			add_location(br5, file, 156, 0, 3407);
			add_location(br6, file, 157, 0, 3412);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 159, 0, 3418);
			add_location(br7, file, 161, 0, 3460);
			add_location(br8, file, 162, 0, 3465);
			add_location(p1, file, 164, 0, 3471);
			add_location(p2, file, 165, 0, 3507);
			add_location(p3, file, 166, 0, 3551);
			add_location(br9, file, 168, 0, 3597);
			add_location(br10, file, 169, 0, 3602);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 171, 0, 3608);
			add_location(span1, file, 175, 8, 3682);
			add_location(li5, file, 174, 4, 3669);
			add_location(span2, file, 182, 8, 3916);
			add_location(li6, file, 181, 4, 3903);
			add_location(span3, file, 189, 8, 4111);
			add_location(li7, file, 188, 4, 4098);
			add_location(ul1, file, 173, 0, 3660);
			add_location(br11, file, 197, 0, 4329);
			add_location(br12, file, 198, 0, 4334);
			add_location(br13, file, 202, 8, 4441);
			add_location(br14, file, 204, 8, 4470);
			add_location(br15, file, 205, 8, 4483);
			add_location(br16, file, 207, 8, 4559);
			add_location(br17, file, 208, 8, 4572);
			add_location(br18, file, 210, 8, 4661);
			add_location(br19, file, 211, 8, 4674);
			add_location(br20, file, 213, 8, 4780);
			add_location(br21, file, 214, 8, 4793);
			add_location(br22, file, 218, 8, 4920);
			add_location(br23, file, 219, 8, 4933);
			add_location(br24, file, 221, 8, 5040);
			add_location(br25, file, 222, 8, 5053);
			add_location(br26, file, 224, 8, 5159);
			add_location(br27, file, 225, 8, 5172);
			add_location(div1, file, 201, 4, 4427);
			add_location(br28, file, 229, 8, 5207);
			add_location(br29, file, 231, 8, 5245);
			add_location(br30, file, 232, 8, 5258);
			add_location(br31, file, 234, 8, 5343);
			add_location(br32, file, 235, 8, 5356);
			add_location(br33, file, 237, 8, 5454);
			add_location(br34, file, 238, 8, 5467);
			add_location(br35, file, 240, 8, 5565);
			add_location(br36, file, 241, 8, 5578);
			add_location(br37, file, 245, 8, 5714);
			add_location(br38, file, 246, 8, 5727);
			add_location(br39, file, 248, 8, 5843);
			add_location(br40, file, 249, 8, 5856);
			add_location(br41, file, 251, 8, 5971);
			add_location(br42, file, 252, 8, 5984);
			add_location(div2, file, 228, 4, 5193);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 200, 0, 4340);
			add_location(br43, file, 256, 0, 6012);
			add_location(br44, file, 257, 0, 6017);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 259, 0, 6023);
			add_location(br45, file, 261, 0, 6066);
			add_location(br46, file, 262, 0, 6071);
			add_location(br47, file, 267, 4, 6136);
			add_location(br48, file, 268, 4, 6145);
			add_location(br49, file, 272, 4, 6228);
			add_location(br50, file, 273, 4, 6237);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 278, 8, 6326);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 279, 8, 6353);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 280, 8, 6380);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 277, 4, 6298);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 283, 4, 6420);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 284, 4, 6478);
			add_location(br51, file, 286, 4, 6527);
			add_location(br52, file, 287, 4, 6536);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 289, 4, 6546);
			add_location(br53, file, 291, 4, 6598);
			add_location(br54, file, 292, 4, 6607);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 294, 4, 6617);
			add_location(section4, file, 264, 0, 6077);
			add_location(br55, file, 297, 0, 6693);
			add_location(br56, file, 298, 0, 6698);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 300, 0, 6704);
			add_location(br57, file, 306, 0, 6828);
			add_location(br58, file, 307, 0, 6833);
			add_location(br59, file, 311, 0, 6905);
			add_location(br60, file, 312, 0, 6910);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 314, 0, 6916);
			add_location(strong, file, 317, 4, 6961);
			add_location(p4, file, 316, 0, 6953);
			set_style(p5, "text-align", "justify");
			add_location(p5, file, 322, 0, 7070);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
