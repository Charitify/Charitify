...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "images svelte-122tzfy");
			add_location(div0, file$b, 13, 4, 323);
			add_location(br0, file$b, 33, 4, 1041);
			add_location(br1, file$b, 34, 4, 1050);
			add_location(p, file$b, 36, 4, 1060);
			attr_dev(div1, "class", "card svelte-122tzfy");
			add_location(div1, file$b, 11, 0, 299);
		},
		m: function mount(target, anchor) {
