...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$8, 43, 8, 1357);
			attr_dev(div1, "class", "progress-inner-frame svelte-1kjumgy");
			add_location(div1, file$8, 42, 4, 1314);
			...
			add_location(div2, file$8, 31, 0, 1043);
		},
		m: function mount(target, anchor) {
...
function getBorderRadius(borders, defaults = "var(--border-radius)") {
...
function create_fragment$b(ctx) {
	...
	const progress = new Progress({
			props: { value: "45", borderRadius: "0 0" },
			$$inline: true
		});
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(p0, file$b, 35, 4, 1112);
			attr_dev(h3, "class", "svelte-xaarx7");
			add_location(h3, file$b, 43, 12, 1334);
			attr_dev(p1, "class", "svelte-xaarx7");
			add_location(p1, file$b, 44, 12, 1370);
			attr_dev(span, "class", "svelte-xaarx7");
			add_location(span, file$b, 42, 8, 1315);
			attr_dev(footer, "class", "ava-section svelte-xaarx7");
			add_location(footer, file$b, 39, 4, 1204);
