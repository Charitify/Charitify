...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-core svelte-pafjdi");
			attr_dev(div0, "style", div0_style_value = `width:${/*val*/ ctx[2]}%;`);
			add_location(div0, file$8, 44, 8, 1381);
			attr_dev(div1, "class", "progress-inner-frame svelte-pafjdi");
			add_location(div1, file$8, 43, 4, 1338);
			attr_dev(div2, "id", /*id*/ ctx[0]);
			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[5]) + " svelte-pafjdi"));
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 32 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[5]) + " svelte-pafjdi"))) {
