...
function create_fragment$9(ctx) {
	...
	const block = {
		c: function create() {
			...
			t8 = space();
			pre1 = element("pre");
			t9 = text("A loooooooooooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			t10 = space();
			br2 = element("br");
			t11 = space();
			pre2 = element("pre");
			t12 = text("A loooooooooooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			this.h();
		},
		l: function claim(nodes) {
			...
			br0 = claim_element(div_nodes, "BR", { class: true });
			t5 = claim_space(div_nodes);
			pre0 = claim_element(div_nodes, "PRE", { class: true });
			var pre0_nodes = children(pre0);
			t6 = claim_text(pre0_nodes, "A loooooooooooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			pre0_nodes.forEach(detach_dev);
			t7 = claim_space(div_nodes);
			br1 = claim_element(div_nodes, "BR", { class: true });
			t8 = claim_space(div_nodes);
			pre1 = claim_element(div_nodes, "PRE", { class: true });
			var pre1_nodes = children(pre1);
			t9 = claim_text(pre1_nodes, "A loooooooooooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			pre1_nodes.forEach(detach_dev);
			t10 = claim_space(div_nodes);
			br2 = claim_element(div_nodes, "BR", { class: true });
			t11 = claim_space(div_nodes);
			pre2 = claim_element(div_nodes, "PRE", { class: true });
			var pre2_nodes = children(pre2);
			t12 = claim_text(pre2_nodes, "A loooooooooooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-1duvwj4");
			add_location(h4, file$9, 13, 12, 268);
			attr_dev(sub, "class", "svelte-1duvwj4");
			add_location(sub, file$9, 14, 12, 297);
			attr_dev(span, "class", "svelte-1duvwj4");
			add_location(span, file$9, 12, 8, 249);
			attr_dev(br0, "class", "small");
			add_location(br0, file$9, 17, 8, 344);
			attr_dev(pre0, "class", "svelte-1duvwj4");
			add_location(pre0, file$9, 19, 8, 372);
			attr_dev(br1, "class", "medium");
			add_location(br1, file$9, 24, 8, 534);
			attr_dev(pre1, "class", "svelte-1duvwj4");
			add_location(pre1, file$9, 26, 8, 563);
			attr_dev(br2, "class", "big");
			add_location(br2, file$9, 31, 8, 725);
			attr_dev(pre2, "class", "svelte-1duvwj4");
			add_location(pre2, file$9, 33, 8, 751);
			attr_dev(div, "class", "svelte-1duvwj4");
			add_location(div, file$9, 11, 4, 235);
			attr_dev(section, "class", "svelte-1duvwj4");
