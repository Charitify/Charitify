...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 55, 8, 881);
			attr_dev(li0, "class", "svelte-1kmv00v");
			add_location(li0, file, 60, 12, 1040);
			attr_dev(li1, "class", "svelte-1kmv00v");
			add_location(li1, file, 63, 12, 1160);
			attr_dev(li2, "class", "svelte-1kmv00v");
			add_location(li2, file, 66, 12, 1281);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 80, 20, 1754);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 81, 20, 1794);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 82, 20, 1835);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 79, 16, 1702);
			attr_dev(li3, "class", "svelte-1kmv00v");
			add_location(li3, file, 69, 12, 1403);
			attr_dev(ul, "class", "options svelte-1kmv00v");
			add_location(ul, file, 59, 8, 1007);
			attr_dev(section0, "class", "top svelte-1kmv00v");
			add_location(section0, file, 54, 4, 851);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file, 88, 4, 1937);
			attr_dev(section2, "class", "top-wrap svelte-1kmv00v");
			add_location(section2, file, 48, 0, 697);
			add_location(br0, file, 96, 4, 2109);
			add_location(br1, file, 97, 4, 2118);
			add_location(br2, file, 101, 4, 2179);
			add_location(br3, file, 102, 4, 2188);
			add_location(br4, file, 106, 4, 2247);
			add_location(br5, file, 107, 4, 2256);
			add_location(br6, file, 111, 4, 2316);
			add_location(br7, file, 112, 4, 2325);
			add_location(br8, file, 116, 4, 2383);
			add_location(br9, file, 117, 4, 2392);
			add_location(br10, file, 121, 4, 2453);
			add_location(br11, file, 122, 4, 2462);
			add_location(br12, file, 126, 4, 2521);
			add_location(br13, file, 127, 4, 2530);
			add_location(br14, file, 131, 4, 2593);
			add_location(br15, file, 132, 4, 2602);
			add_location(section3, file, 94, 0, 2094);
			attr_dev(span, "class", "text-success");
			add_location(span, file, 137, 10, 2677);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 137, 0, 2667);
			add_location(br16, file, 139, 0, 2726);
			add_location(br17, file, 140, 0, 2731);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 142, 0, 2737);
			add_location(br18, file, 144, 0, 2779);
			add_location(br19, file, 145, 0, 2784);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 147, 0, 2790);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 148, 0, 2826);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 149, 0, 2870);
			add_location(br20, file, 151, 0, 2916);
			add_location(br21, file, 152, 0, 2921);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 154, 0, 2927);
			add_location(br22, file, 156, 0, 2979);
			add_location(br23, file, 157, 0, 2984);
			add_location(br24, file, 161, 8, 3091);
			add_location(br25, file, 163, 8, 3120);
			add_location(br26, file, 164, 8, 3133);
			add_location(br27, file, 166, 8, 3209);
			add_location(br28, file, 167, 8, 3222);
			add_location(br29, file, 169, 8, 3311);
			add_location(br30, file, 170, 8, 3324);
			add_location(br31, file, 172, 8, 3430);
			add_location(br32, file, 173, 8, 3443);
			add_location(br33, file, 177, 8, 3570);
			add_location(br34, file, 178, 8, 3583);
			add_location(br35, file, 180, 8, 3690);
			add_location(br36, file, 181, 8, 3703);
			add_location(br37, file, 183, 8, 3809);
			add_location(br38, file, 184, 8, 3822);
			add_location(div1, file, 160, 4, 3077);
			add_location(br39, file, 188, 8, 3857);
			add_location(br40, file, 190, 8, 3895);
			add_location(br41, file, 191, 8, 3908);
			add_location(br42, file, 193, 8, 3993);
			add_location(br43, file, 194, 8, 4006);
			add_location(br44, file, 196, 8, 4104);
			add_location(br45, file, 197, 8, 4117);
			add_location(br46, file, 199, 8, 4215);
			add_location(br47, file, 200, 8, 4228);
			add_location(br48, file, 204, 8, 4364);
			add_location(br49, file, 205, 8, 4377);
			add_location(br50, file, 207, 8, 4493);
			add_location(br51, file, 208, 8, 4506);
			add_location(br52, file, 210, 8, 4621);
			add_location(br53, file, 211, 8, 4634);
			add_location(div2, file, 187, 4, 3843);
			set_style(section4, "text-align", "center");
			set_style(section4, "display", "flex");
			set_style(section4, "justify-content", "space-around");
			add_location(section4, file, 159, 0, 2990);
			add_location(br54, file, 215, 0, 4662);
			add_location(br55, file, 216, 0, 4667);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 218, 0, 4673);
			add_location(br56, file, 220, 0, 4716);
			add_location(br57, file, 221, 0, 4721);
			add_location(br58, file, 226, 4, 4786);
			add_location(br59, file, 227, 4, 4795);
			add_location(br60, file, 231, 4, 4878);
			add_location(br61, file, 232, 4, 4887);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 237, 8, 4976);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 238, 8, 5003);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 239, 8, 5030);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 236, 4, 4948);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 242, 4, 5070);
			attr_dev(input12, "id", "input");
			attr_dev(input12, "type", "text");
			input12.value = "text";
			add_location(input12, file, 243, 4, 5128);
			add_location(br62, file, 245, 4, 5177);
			add_location(br63, file, 246, 4, 5186);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 248, 4, 5196);
			add_location(br64, file, 250, 4, 5248);
			add_location(br65, file, 251, 4, 5257);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 253, 4, 5267);
			add_location(section5, file, 223, 0, 4727);
			add_location(br66, file, 256, 0, 5343);
			add_location(br67, file, 257, 0, 5348);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 259, 0, 5354);
			add_location(br68, file, 265, 0, 5478);
			add_location(br69, file, 266, 0, 5483);
			add_location(br70, file, 270, 0, 5555);
			add_location(br71, file, 271, 0, 5560);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 273, 0, 5566);
			add_location(strong, file, 276, 4, 5611);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 275, 0, 5603);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 281, 0, 5720);
		},
		m: function mount(target, anchor) {
