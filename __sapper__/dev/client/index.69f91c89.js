...
function create_fragment$e(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			sub = claim_element(span_nodes, "SUB", { class: true });
			var sub_nodes = children(sub);
			t4 = claim_text(sub_nodes, /*subtitle*/ ctx[2]);
			sub_nodes.forEach(detach_dev);
			span_nodes.forEach(detach_dev);
			section_nodes.forEach(detach_dev);
			this.h();
		...
		h: function hydrate() {
			...
			attr_dev(br, "class", "small");
			add_location(br, file$d, 13, 8, 255);
			attr_dev(sub, "class", "svelte-1gxsw4y");
			add_location(sub, file$d, 14, 8, 282);
...
function create_each_block$1(ctx) {
	...
	const avatarandname = new AvatarAndName({
			props: {
				src: /*item*/ ctx[1].orgHead,
				title: /*item*/ ctx[1].orgHeadSrc,
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*items*/ 1) avatarandname_changes.src = /*item*/ ctx[1].orgHead;
			if (dirty & /*items*/ 1) avatarandname_changes.title = /*item*/ ctx[1].orgHeadSrc;
