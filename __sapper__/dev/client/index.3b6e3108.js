...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 124, 4, 3450);
			add_location(br1, file$2, 125, 4, 3459);
			add_location(br2, file$2, 129, 4, 3533);
			add_location(br3, file$2, 130, 4, 3542);
			add_location(br4, file$2, 134, 4, 3614);
			add_location(br5, file$2, 135, 4, 3623);
			add_location(br6, file$2, 139, 4, 3696);
			add_location(br7, file$2, 140, 4, 3705);
			add_location(br8, file$2, 144, 4, 3776);
			add_location(br9, file$2, 145, 4, 3785);
			add_location(br10, file$2, 149, 4, 3859);
			add_location(br11, file$2, 150, 4, 3868);
			add_location(br12, file$2, 154, 4, 3940);
			add_location(br13, file$2, 155, 4, 3949);
			add_location(br14, file$2, 159, 4, 4025);
			add_location(br15, file$2, 160, 4, 4034);
			add_location(br16, file$2, 164, 4, 4105);
			add_location(br17, file$2, 165, 4, 4114);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic main-shadow svelte-2iloh8");
			add_location(div0, file$2, 45, 8, 914);
			attr_dev(li0, "class", "svelte-2iloh8");
			add_location(li0, file$2, 66, 12, 1754);
			attr_dev(li1, "class", "svelte-2iloh8");
			add_location(li1, file$2, 69, 12, 1874);
			attr_dev(li2, "class", "svelte-2iloh8");
			...
			attr_dev(li3, "class", "svelte-2iloh8");
			add_location(li3, file$2, 75, 12, 2117);
			attr_dev(li4, "class", "svelte-2iloh8");
			add_location(li4, file$2, 92, 12, 2650);
			attr_dev(ul0, "class", "options svelte-2iloh8");
			add_location(ul0, file$2, 65, 8, 1721);
			attr_dev(section0, "class", "top svelte-2iloh8");
			add_location(section0, file$2, 44, 4, 884);
			set_style(section1, "padding", "7px 0");
			add_location(section1, file$2, 98, 4, 2793);
			add_location(span0, file$2, 102, 4, 2887);
			add_location(br2, file$2, 110, 4, 3171);
			add_location(br3, file$2, 111, 4, 3180);
			attr_dev(h10, "class", "svelte-2iloh8");
			add_location(h10, file$2, 113, 4, 3190);
			add_location(br4, file$2, 115, 4, 3219);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 117, 4, 3229);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 43, 0, 852);
			attr_dev(h11, "class", "svelte-2iloh8");
			add_location(h11, file$2, 170, 0, 4184);
			add_location(br5, file$2, 172, 0, 4252);
			add_location(br6, file$2, 173, 0, 4257);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 175, 0, 4263);
			add_location(br7, file$2, 177, 0, 4305);
			add_location(br8, file$2, 178, 0, 4310);
			add_location(p1, file$2, 180, 0, 4316);
			add_location(p2, file$2, 181, 0, 4352);
			add_location(p3, file$2, 182, 0, 4396);
			add_location(br9, file$2, 184, 0, 4442);
			add_location(br10, file$2, 185, 0, 4447);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 187, 0, 4453);
			add_location(span1, file$2, 191, 8, 4527);
			add_location(li5, file$2, 190, 4, 4514);
			add_location(span2, file$2, 198, 8, 4761);
			add_location(li6, file$2, 197, 4, 4748);
			add_location(span3, file$2, 205, 8, 4956);
			add_location(li7, file$2, 204, 4, 4943);
			add_location(ul1, file$2, 189, 0, 4505);
			add_location(br11, file$2, 213, 0, 5174);
			add_location(br12, file$2, 214, 0, 5179);
			add_location(br13, file$2, 218, 8, 5286);
			add_location(br14, file$2, 220, 8, 5315);
			add_location(br15, file$2, 221, 8, 5328);
			add_location(br16, file$2, 223, 8, 5404);
			add_location(br17, file$2, 224, 8, 5417);
			add_location(br18, file$2, 226, 8, 5506);
			add_location(br19, file$2, 227, 8, 5519);
			add_location(br20, file$2, 229, 8, 5625);
			add_location(br21, file$2, 230, 8, 5638);
			add_location(br22, file$2, 234, 8, 5765);
			add_location(br23, file$2, 235, 8, 5778);
			add_location(br24, file$2, 237, 8, 5885);
			add_location(br25, file$2, 238, 8, 5898);
			add_location(br26, file$2, 240, 8, 6004);
			add_location(br27, file$2, 241, 8, 6017);
			add_location(div1, file$2, 217, 4, 5272);
			add_location(br28, file$2, 245, 8, 6052);
			add_location(br29, file$2, 247, 8, 6090);
			add_location(br30, file$2, 248, 8, 6103);
			add_location(br31, file$2, 250, 8, 6188);
			add_location(br32, file$2, 251, 8, 6201);
			add_location(br33, file$2, 253, 8, 6299);
			add_location(br34, file$2, 254, 8, 6312);
			add_location(br35, file$2, 256, 8, 6410);
			add_location(br36, file$2, 257, 8, 6423);
			add_location(br37, file$2, 261, 8, 6559);
			add_location(br38, file$2, 262, 8, 6572);
			add_location(br39, file$2, 264, 8, 6688);
			add_location(br40, file$2, 265, 8, 6701);
			add_location(br41, file$2, 267, 8, 6816);
			add_location(br42, file$2, 268, 8, 6829);
			add_location(div2, file$2, 244, 4, 6038);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 216, 0, 5185);
			add_location(br43, file$2, 272, 0, 6857);
			add_location(br44, file$2, 273, 0, 6862);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 275, 0, 6868);
			add_location(br45, file$2, 277, 0, 6911);
			add_location(br46, file$2, 278, 0, 6916);
			add_location(br47, file$2, 283, 4, 6981);
			add_location(br48, file$2, 284, 4, 6990);
			add_location(br49, file$2, 288, 4, 7073);
			add_location(br50, file$2, 289, 4, 7082);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 294, 8, 7171);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 295, 8, 7198);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 296, 8, 7225);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 293, 4, 7143);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 299, 4, 7265);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 300, 4, 7323);
			add_location(br51, file$2, 302, 4, 7372);
			add_location(br52, file$2, 303, 4, 7381);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 305, 4, 7391);
			add_location(br53, file$2, 307, 4, 7443);
			add_location(br54, file$2, 308, 4, 7452);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 310, 4, 7462);
			add_location(section4, file$2, 280, 0, 6922);
			add_location(br55, file$2, 313, 0, 7538);
			add_location(br56, file$2, 314, 0, 7543);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 316, 0, 7549);
			add_location(br57, file$2, 322, 0, 7673);
			add_location(br58, file$2, 323, 0, 7678);
			add_location(br59, file$2, 327, 0, 7750);
			add_location(br60, file$2, 328, 0, 7755);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 330, 0, 7761);
			add_location(strong, file$2, 333, 4, 7806);
			add_location(p4, file$2, 332, 0, 7798);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 338, 0, 7915);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
