...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(button, file$6, 68, 4, 1670);
...
function create_if_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(label, file$6, 56, 4, 1409);
...
function create_if_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$6, 45, 4, 1180);
...
function instance$5($$self, $$props, $$invalidate) {
	...
	onMount(() => {
		audioClick = document.getElementById("button_click");
	...
	$$self.$inject_state = $$new_props => {
		...
		if ("audioClick" in $$props) audioClick = $$new_props.audioClick;
