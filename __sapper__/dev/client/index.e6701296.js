...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 128, 4, 3502);
			add_location(br1, file$2, 129, 4, 3511);
			add_location(br2, file$2, 133, 4, 3585);
			add_location(br3, file$2, 134, 4, 3594);
			add_location(br4, file$2, 138, 4, 3666);
			add_location(br5, file$2, 139, 4, 3675);
			add_location(br6, file$2, 143, 4, 3748);
			add_location(br7, file$2, 144, 4, 3757);
			add_location(br8, file$2, 148, 4, 3828);
			add_location(br9, file$2, 149, 4, 3837);
			add_location(br10, file$2, 153, 4, 3911);
			add_location(br11, file$2, 154, 4, 3920);
			add_location(br12, file$2, 158, 4, 3992);
			add_location(br13, file$2, 159, 4, 4001);
			add_location(br14, file$2, 163, 4, 4077);
			add_location(br15, file$2, 164, 4, 4086);
			add_location(br16, file$2, 168, 4, 4157);
			add_location(br17, file$2, 169, 4, 4166);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 45, 0, 889);
			attr_dev(div0, "class", "top-pic main-shadow svelte-cwxbfk");
			add_location(div0, file$2, 49, 8, 956);
			attr_dev(li0, "class", "svelte-cwxbfk");
			add_location(li0, file$2, 70, 12, 1796);
			attr_dev(li1, "class", "svelte-cwxbfk");
			add_location(li1, file$2, 73, 12, 1916);
			attr_dev(li2, "class", "svelte-cwxbfk");
			add_location(li2, file$2, 76, 12, 2037);
			add_location(br1, file$2, 80, 16, 2180);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 91, 20, 2531);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 92, 20, 2571);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 93, 20, 2612);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 90, 16, 2479);
			attr_dev(li3, "class", "svelte-cwxbfk");
			add_location(li3, file$2, 79, 12, 2159);
			attr_dev(li4, "class", "svelte-cwxbfk");
			add_location(li4, file$2, 96, 12, 2692);
			attr_dev(ul0, "class", "options svelte-cwxbfk");
			add_location(ul0, file$2, 69, 8, 1763);
			attr_dev(section0, "class", "top svelte-cwxbfk");
			add_location(section0, file$2, 48, 4, 926);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file$2, 102, 4, 2835);
			add_location(span0, file$2, 106, 4, 2939);
			add_location(br2, file$2, 114, 4, 3223);
			add_location(br3, file$2, 115, 4, 3232);
			attr_dev(h10, "class", "svelte-cwxbfk");
			add_location(h10, file$2, 117, 4, 3242);
			add_location(br4, file$2, 119, 4, 3271);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 121, 4, 3281);
			attr_dev(section2, "class", "top-wrap svelte-cwxbfk");
			add_location(section2, file$2, 47, 0, 895);
			attr_dev(h11, "class", "svelte-cwxbfk");
			add_location(h11, file$2, 174, 0, 4236);
			add_location(br5, file$2, 176, 0, 4304);
			add_location(br6, file$2, 177, 0, 4309);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 179, 0, 4315);
			add_location(br7, file$2, 181, 0, 4357);
			add_location(br8, file$2, 182, 0, 4362);
			add_location(p1, file$2, 184, 0, 4368);
			add_location(p2, file$2, 185, 0, 4404);
			add_location(p3, file$2, 186, 0, 4448);
			add_location(br9, file$2, 188, 0, 4494);
			add_location(br10, file$2, 189, 0, 4499);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 191, 0, 4505);
			add_location(span1, file$2, 195, 8, 4579);
			add_location(li5, file$2, 194, 4, 4566);
			add_location(span2, file$2, 202, 8, 4813);
			add_location(li6, file$2, 201, 4, 4800);
			add_location(span3, file$2, 209, 8, 5008);
			add_location(li7, file$2, 208, 4, 4995);
			add_location(ul1, file$2, 193, 0, 4557);
			add_location(br11, file$2, 217, 0, 5226);
			add_location(br12, file$2, 218, 0, 5231);
			add_location(br13, file$2, 222, 8, 5338);
			add_location(br14, file$2, 224, 8, 5367);
			add_location(br15, file$2, 225, 8, 5380);
			add_location(br16, file$2, 227, 8, 5456);
			add_location(br17, file$2, 228, 8, 5469);
			add_location(br18, file$2, 230, 8, 5558);
			add_location(br19, file$2, 231, 8, 5571);
			add_location(br20, file$2, 233, 8, 5677);
			add_location(br21, file$2, 234, 8, 5690);
			add_location(br22, file$2, 238, 8, 5817);
			add_location(br23, file$2, 239, 8, 5830);
			add_location(br24, file$2, 241, 8, 5937);
			add_location(br25, file$2, 242, 8, 5950);
			add_location(br26, file$2, 244, 8, 6056);
			add_location(br27, file$2, 245, 8, 6069);
			add_location(div1, file$2, 221, 4, 5324);
			add_location(br28, file$2, 249, 8, 6104);
			add_location(br29, file$2, 251, 8, 6142);
			add_location(br30, file$2, 252, 8, 6155);
			add_location(br31, file$2, 254, 8, 6240);
			add_location(br32, file$2, 255, 8, 6253);
			add_location(br33, file$2, 257, 8, 6351);
			add_location(br34, file$2, 258, 8, 6364);
			add_location(br35, file$2, 260, 8, 6462);
			add_location(br36, file$2, 261, 8, 6475);
			add_location(br37, file$2, 265, 8, 6611);
			add_location(br38, file$2, 266, 8, 6624);
			add_location(br39, file$2, 268, 8, 6740);
			add_location(br40, file$2, 269, 8, 6753);
			add_location(br41, file$2, 271, 8, 6868);
			add_location(br42, file$2, 272, 8, 6881);
			add_location(div2, file$2, 248, 4, 6090);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 220, 0, 5237);
			add_location(br43, file$2, 276, 0, 6909);
			add_location(br44, file$2, 277, 0, 6914);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 279, 0, 6920);
			add_location(br45, file$2, 281, 0, 6963);
			add_location(br46, file$2, 282, 0, 6968);
			add_location(br47, file$2, 287, 4, 7033);
			add_location(br48, file$2, 288, 4, 7042);
			add_location(br49, file$2, 292, 4, 7125);
			add_location(br50, file$2, 293, 4, 7134);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 298, 8, 7223);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 299, 8, 7250);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 300, 8, 7277);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 297, 4, 7195);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 303, 4, 7317);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 304, 4, 7375);
			add_location(br51, file$2, 306, 4, 7424);
			add_location(br52, file$2, 307, 4, 7433);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 309, 4, 7443);
			add_location(br53, file$2, 311, 4, 7495);
			add_location(br54, file$2, 312, 4, 7504);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 314, 4, 7514);
			add_location(section4, file$2, 284, 0, 6974);
			add_location(br55, file$2, 317, 0, 7590);
			add_location(br56, file$2, 318, 0, 7595);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 320, 0, 7601);
			add_location(br57, file$2, 326, 0, 7725);
			add_location(br58, file$2, 327, 0, 7730);
			add_location(br59, file$2, 331, 0, 7802);
			add_location(br60, file$2, 332, 0, 7807);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 334, 0, 7813);
			add_location(strong, file$2, 337, 4, 7858);
			add_location(p4, file$2, 336, 0, 7850);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 342, 0, 7967);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
