...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "images svelte-qk35gs");
			...
			attr_dev(div1, "class", "card svelte-qk35gs");
