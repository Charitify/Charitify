...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$a, 29, 16, 1082);
			option1.__value = "ru";
			option1.value = option1.__value;
			add_location(option1, file$a, 30, 16, 1129);
			option2.__value = "en";
			option2.value = option2.__value;
			add_location(option2, file$a, 31, 16, 1176);
			attr_dev(select, "name", "lang");
			attr_dev(select, "id", "lang");
			attr_dev(select, "class", "btn small lang-select svelte-iotsi1");
			add_location(select, file$a, 28, 12, 997);
			attr_dev(li5, "class", "svelte-iotsi1");
			add_location(li5, file$a, 27, 8, 980);
			attr_dev(li6, "class", "svelte-iotsi1");
			add_location(li6, file$a, 35, 8, 1252);
			attr_dev(li7, "class", "svelte-iotsi1");
			add_location(li7, file$a, 41, 8, 1423);
			attr_dev(ul1, "class", "nav-actions svelte-iotsi1");
			add_location(ul1, file$a, 26, 4, 947);
