...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t15 = space();
			h4 = element("h4");
			t16 = text("Main title 4");
			span5 = element("span");
			t17 = text("with text");
			t18 = space();
			h5 = element("h5");
			t19 = text("Main title 5");
			span6 = element("span");
			t20 = text("with text");
			t21 = space();
			h6 = element("h6");
			t22 = text("Main title 6");
			span7 = element("span");
			t23 = text("with text");
			t24 = space();
			div = element("div");
		...
		l: function claim(nodes) {
			...
			h20 = claim_element(nodes, "H2", { style: true });
			...
			t13 = claim_text(h3_nodes, "Main title 3");
			...
			t16 = claim_text(h4_nodes, "Main title 4");
			...
			t19 = claim_text(h5_nodes, "Main title 5");
			...
			t22 = claim_text(h6_nodes, "Main title 6");
		...
		h: function hydrate() {
			...
			set_style(h20, "font-size", "1.5em");
			add_location(h20, file, 64, 0, 2046);
			add_location(span2, file, 64, 46, 2092);
			add_location(h21, file, 65, 0, 2115);
			add_location(span3, file, 65, 21, 2136);
			add_location(h3, file, 66, 0, 2159);
			add_location(span4, file, 66, 21, 2180);
			add_location(h4, file, 67, 0, 2203);
			add_location(span5, file, 67, 21, 2224);
			add_location(h5, file, 68, 0, 2247);
			add_location(span6, file, 68, 21, 2268);
			add_location(h6, file, 69, 0, 2291);
			add_location(span7, file, 69, 21, 2312);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 71, 0, 2336);
			attr_dev(section, "class", "container");
			add_location(section, file, 75, 0, 2391);
		},
