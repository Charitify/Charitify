...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a1, file, 20, 7, 484);
			attr_dev(li1, "class", "svelte-1vo7cwi");
			add_location(li1, file, 20, 3, 480);
			...
			add_location(br1, file, 26, 1, 637);
			add_location(br2, file, 34, 1, 738);
			add_location(br3, file, 35, 1, 744);
			attr_dev(div1, "class", "list-wrap svelte-1vo7cwi");
			add_location(div1, file, 25, 0, 612);
		},
		m: function mount(target, anchor) {
