...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 163, 4, 4228);
			add_location(br1, file$2, 164, 4, 4237);
			add_location(br2, file$2, 168, 4, 4311);
			add_location(br3, file$2, 169, 4, 4320);
			add_location(br4, file$2, 173, 4, 4392);
			add_location(br5, file$2, 174, 4, 4401);
			add_location(br6, file$2, 178, 4, 4474);
			add_location(br7, file$2, 179, 4, 4483);
			add_location(br8, file$2, 183, 4, 4554);
			add_location(br9, file$2, 184, 4, 4563);
			add_location(br10, file$2, 188, 4, 4637);
			add_location(br11, file$2, 189, 4, 4646);
			add_location(br12, file$2, 193, 4, 4718);
			add_location(br13, file$2, 194, 4, 4727);
			add_location(br14, file$2, 198, 4, 4803);
			add_location(br15, file$2, 199, 4, 4812);
			add_location(br16, file$2, 203, 4, 4883);
			add_location(br17, file$2, 204, 4, 4892);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-1wnoihq");
			add_location(div0, file$2, 77, 8, 1711);
			attr_dev(li0, "class", "svelte-1wnoihq");
			add_location(li0, file$2, 98, 12, 2539);
			attr_dev(li1, "class", "svelte-1wnoihq");
			add_location(li1, file$2, 101, 12, 2659);
			attr_dev(li2, "class", "svelte-1wnoihq");
			add_location(li2, file$2, 104, 12, 2780);
			add_location(br0, file$2, 108, 16, 2923);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 119, 20, 3274);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 120, 20, 3314);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 121, 20, 3355);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 118, 16, 3222);
			attr_dev(li3, "class", "svelte-1wnoihq");
			add_location(li3, file$2, 107, 12, 2902);
			attr_dev(li4, "class", "svelte-1wnoihq");
			add_location(li4, file$2, 124, 12, 3435);
			attr_dev(ul0, "class", "options svelte-1wnoihq");
			add_location(ul0, file$2, 97, 8, 2506);
			attr_dev(section0, "class", "top svelte-1wnoihq");
			add_location(section0, file$2, 76, 4, 1681);
			attr_dev(h3, "class", "svelte-1wnoihq");
			add_location(h3, file$2, 137, 16, 3794);
			attr_dev(p0, "class", "svelte-1wnoihq");
			add_location(p0, file$2, 138, 16, 3834);
			attr_dev(span0, "class", "svelte-1wnoihq");
			add_location(span0, file$2, 136, 12, 3771);
			attr_dev(div1, "class", "ava-section svelte-1wnoihq");
			add_location(div1, file$2, 133, 8, 3655);
			attr_dev(section1, "class", "rate-section svelte-1wnoihq");
			add_location(section1, file$2, 132, 4, 3616);
			add_location(br1, file$2, 145, 4, 3935);
			attr_dev(h10, "class", "svelte-1wnoihq");
			add_location(h10, file$2, 147, 4, 3945);
			add_location(br2, file$2, 149, 4, 3974);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 151, 4, 3984);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 75, 0, 1649);
			add_location(br3, file$2, 156, 0, 4140);
			add_location(br4, file$2, 157, 0, 4145);
			attr_dev(h11, "class", "svelte-1wnoihq");
			add_location(h11, file$2, 209, 0, 4962);
			add_location(br5, file$2, 211, 0, 5030);
			add_location(br6, file$2, 212, 0, 5035);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 214, 0, 5041);
			add_location(br7, file$2, 216, 0, 5083);
			add_location(br8, file$2, 217, 0, 5088);
			add_location(p2, file$2, 219, 0, 5094);
			add_location(p3, file$2, 220, 0, 5130);
			add_location(p4, file$2, 221, 0, 5174);
			add_location(br9, file$2, 223, 0, 5220);
			add_location(br10, file$2, 224, 0, 5225);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 226, 0, 5231);
			add_location(span1, file$2, 230, 8, 5305);
			add_location(li5, file$2, 229, 4, 5292);
			add_location(span2, file$2, 237, 8, 5539);
			add_location(li6, file$2, 236, 4, 5526);
			add_location(span3, file$2, 244, 8, 5734);
			add_location(li7, file$2, 243, 4, 5721);
			add_location(ul1, file$2, 228, 0, 5283);
			add_location(br11, file$2, 252, 0, 5952);
			add_location(br12, file$2, 253, 0, 5957);
			add_location(br13, file$2, 257, 8, 6064);
			add_location(br14, file$2, 259, 8, 6093);
			add_location(br15, file$2, 260, 8, 6106);
			add_location(br16, file$2, 262, 8, 6182);
			add_location(br17, file$2, 263, 8, 6195);
			add_location(br18, file$2, 265, 8, 6284);
			add_location(br19, file$2, 266, 8, 6297);
			add_location(br20, file$2, 268, 8, 6403);
			add_location(br21, file$2, 269, 8, 6416);
			add_location(br22, file$2, 273, 8, 6543);
			add_location(br23, file$2, 274, 8, 6556);
			add_location(br24, file$2, 276, 8, 6663);
			add_location(br25, file$2, 277, 8, 6676);
			add_location(br26, file$2, 279, 8, 6782);
			add_location(br27, file$2, 280, 8, 6795);
			add_location(div2, file$2, 256, 4, 6050);
			add_location(br28, file$2, 284, 8, 6830);
			add_location(br29, file$2, 286, 8, 6868);
			add_location(br30, file$2, 287, 8, 6881);
			add_location(br31, file$2, 289, 8, 6966);
			add_location(br32, file$2, 290, 8, 6979);
			add_location(br33, file$2, 292, 8, 7077);
			add_location(br34, file$2, 293, 8, 7090);
			add_location(br35, file$2, 295, 8, 7188);
			add_location(br36, file$2, 296, 8, 7201);
			add_location(br37, file$2, 300, 8, 7337);
			add_location(br38, file$2, 301, 8, 7350);
			add_location(br39, file$2, 303, 8, 7466);
			add_location(br40, file$2, 304, 8, 7479);
			add_location(br41, file$2, 306, 8, 7594);
			add_location(br42, file$2, 307, 8, 7607);
			add_location(div3, file$2, 283, 4, 6816);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 255, 0, 5963);
			add_location(br43, file$2, 311, 0, 7635);
			add_location(br44, file$2, 312, 0, 7640);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 314, 0, 7646);
			add_location(br45, file$2, 316, 0, 7689);
			add_location(br46, file$2, 317, 0, 7694);
			add_location(br47, file$2, 322, 4, 7759);
			add_location(br48, file$2, 323, 4, 7768);
			add_location(br49, file$2, 327, 4, 7851);
			add_location(br50, file$2, 328, 4, 7860);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 333, 8, 7949);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 334, 8, 7976);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 335, 8, 8003);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 332, 4, 7921);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 338, 4, 8043);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 339, 4, 8101);
			add_location(br51, file$2, 341, 4, 8150);
			add_location(br52, file$2, 342, 4, 8159);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 344, 4, 8169);
			add_location(br53, file$2, 346, 4, 8221);
			add_location(br54, file$2, 347, 4, 8230);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 349, 4, 8240);
			add_location(section4, file$2, 319, 0, 7700);
			add_location(br55, file$2, 352, 0, 8316);
			add_location(br56, file$2, 353, 0, 8321);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 355, 0, 8327);
			add_location(br57, file$2, 361, 0, 8451);
			add_location(br58, file$2, 362, 0, 8456);
			add_location(br59, file$2, 366, 0, 8528);
			add_location(br60, file$2, 367, 0, 8533);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 369, 0, 8539);
			add_location(strong, file$2, 372, 4, 8584);
			add_location(p5, file$2, 371, 0, 8576);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 377, 0, 8693);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
