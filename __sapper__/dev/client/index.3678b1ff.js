...
import { S as Swipe, B as Button, I as Input, P as Progress, A as Avatar, R as Rate, D as Divider, F as Form, a as Icon, b as Picture, c as SwipeItem, C as CharityCard } from './index.20b93a4b.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-9urtg6");
			add_location(li, file, 253, 12, 6603);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(253:8) {#each cards as card}",
		ctx
	});
...
// (312:4) <Button is="success" type="submit">
function create_default_slot_13(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(312:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (268:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 268, 4, 6794);
			add_location(br1, file, 269, 4, 6803);
			add_location(br2, file, 273, 4, 6877);
			add_location(br3, file, 274, 4, 6886);
			add_location(br4, file, 278, 4, 6958);
			add_location(br5, file, 279, 4, 6967);
			add_location(br6, file, 283, 4, 7040);
			add_location(br7, file, 284, 4, 7049);
			add_location(br8, file, 288, 4, 7120);
			add_location(br9, file, 289, 4, 7129);
			add_location(br10, file, 293, 4, 7203);
			add_location(br11, file, 294, 4, 7212);
			add_location(br12, file, 298, 4, 7284);
			add_location(br13, file, 299, 4, 7293);
			add_location(br14, file, 303, 4, 7369);
			add_location(br15, file, 304, 4, 7378);
			add_location(br16, file, 308, 4, 7449);
			add_location(br17, file, 309, 4, 7458);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(268:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (367:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(367:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (370:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(370:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (373:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(373:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (377:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(377:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (381:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(381:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (384:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(384:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (394:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(394:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (397:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(397:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (400:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(400:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (404:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(404:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (408:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(408:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (411:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(411:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h21, file, 246, 4, 6450);
			add_location(br11, file, 249, 4, 6532);
			attr_dev(ul2, "class", "cards svelte-9urtg6");
			add_location(ul2, file, 251, 4, 6542);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 244, 0, 6397);
			add_location(br12, file, 260, 0, 6701);
			add_location(br13, file, 261, 0, 6706);
			add_location(br14, file, 262, 0, 6711);
			attr_dev(h11, "class", "svelte-9urtg6");
			add_location(h11, file, 314, 0, 7528);
			add_location(br15, file, 316, 0, 7596);
			add_location(br16, file, 317, 0, 7601);
			attr_dev(h22, "class", "text-success");
			add_location(h22, file, 319, 0, 7607);
			add_location(br17, file, 321, 0, 7649);
			add_location(br18, file, 322, 0, 7654);
			add_location(p2, file, 324, 0, 7660);
			add_location(p3, file, 325, 0, 7696);
			add_location(p4, file, 326, 0, 7740);
			add_location(br19, file, 328, 0, 7786);
			add_location(br20, file, 329, 0, 7791);
			attr_dev(h23, "class", "text-warning");
			add_location(h23, file, 331, 0, 7797);
			add_location(span1, file, 335, 8, 7871);
			add_location(li5, file, 334, 4, 7858);
			add_location(span2, file, 342, 8, 8105);
			add_location(li6, file, 341, 4, 8092);
			add_location(span3, file, 349, 8, 8300);
			add_location(li7, file, 348, 4, 8287);
			add_location(ul3, file, 333, 0, 7849);
			add_location(br21, file, 357, 0, 8518);
			add_location(br22, file, 358, 0, 8523);
			add_location(br23, file, 362, 8, 8630);
			add_location(br24, file, 364, 8, 8659);
			add_location(br25, file, 365, 8, 8672);
			add_location(br26, file, 367, 8, 8748);
			add_location(br27, file, 368, 8, 8761);
			add_location(br28, file, 370, 8, 8850);
			add_location(br29, file, 371, 8, 8863);
			add_location(br30, file, 373, 8, 8969);
			add_location(br31, file, 374, 8, 8982);
			add_location(br32, file, 378, 8, 9109);
			add_location(br33, file, 379, 8, 9122);
			add_location(br34, file, 381, 8, 9229);
			add_location(br35, file, 382, 8, 9242);
			add_location(br36, file, 384, 8, 9348);
			add_location(br37, file, 385, 8, 9361);
			add_location(div4, file, 361, 4, 8616);
			add_location(br38, file, 389, 8, 9396);
			add_location(br39, file, 391, 8, 9434);
			add_location(br40, file, 392, 8, 9447);
			add_location(br41, file, 394, 8, 9532);
			add_location(br42, file, 395, 8, 9545);
			add_location(br43, file, 397, 8, 9643);
			add_location(br44, file, 398, 8, 9656);
			add_location(br45, file, 400, 8, 9754);
			add_location(br46, file, 401, 8, 9767);
			add_location(br47, file, 405, 8, 9903);
			add_location(br48, file, 406, 8, 9916);
			add_location(br49, file, 408, 8, 10032);
			add_location(br50, file, 409, 8, 10045);
			add_location(br51, file, 411, 8, 10160);
			add_location(br52, file, 412, 8, 10173);
			add_location(div5, file, 388, 4, 9382);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 360, 0, 8529);
			add_location(br53, file, 416, 0, 10201);
			add_location(br54, file, 417, 0, 10206);
			attr_dev(h24, "class", "text-danger");
			add_location(h24, file, 419, 0, 10212);
			add_location(br55, file, 421, 0, 10255);
			add_location(br56, file, 422, 0, 10260);
			add_location(br57, file, 427, 4, 10325);
			add_location(br58, file, 428, 4, 10334);
			add_location(br59, file, 432, 4, 10417);
			add_location(br60, file, 433, 4, 10426);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 438, 8, 10515);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 439, 8, 10542);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 440, 8, 10569);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 437, 4, 10487);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 443, 4, 10609);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 444, 4, 10667);
			add_location(br61, file, 446, 4, 10716);
			add_location(br62, file, 447, 4, 10725);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 449, 4, 10735);
			add_location(br63, file, 451, 4, 10787);
			add_location(br64, file, 452, 4, 10796);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 454, 4, 10806);
			add_location(section4, file, 424, 0, 10266);
			add_location(br65, file, 457, 0, 10882);
			add_location(br66, file, 458, 0, 10887);
			attr_dev(h25, "class", "text-info");
			add_location(h25, file, 460, 0, 10893);
			add_location(br67, file, 462, 0, 10928);
			add_location(br68, file, 463, 0, 10933);
			add_location(br69, file, 467, 0, 11005);
			add_location(br70, file, 468, 0, 11010);
			attr_dev(h26, "class", "text-success");
			add_location(h26, file, 470, 0, 11016);
			add_location(strong, file, 473, 4, 11061);
			add_location(p5, file, 472, 0, 11053);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 478, 0, 11170);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
