...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file, 89, 8, 2035);
			add_location(li5, file, 88, 8, 2022);
			add_location(span1, file, 96, 8, 2277);
			add_location(li6, file, 95, 8, 2264);
			add_location(span2, file, 103, 8, 2480);
			add_location(li7, file, 102, 8, 2467);
			add_location(ul1, file, 87, 4, 2009);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file, 111, 4, 2710);
