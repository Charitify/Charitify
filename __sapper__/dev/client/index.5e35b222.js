...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t25 = claim_text(h5_nodes, "Main title 5");
			...
			t28 = claim_text(h6_nodes, "Main title 6");
		...
		h: function hydrate() {
			...
			add_location(h5, file, 70, 0, 2383);
			add_location(span8, file, 70, 21, 2404);
			add_location(h6, file, 71, 0, 2427);
			add_location(span9, file, 71, 21, 2448);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 73, 0, 2472);
			attr_dev(section, "class", "container");
			add_location(section, file, 77, 0, 2527);
		},
