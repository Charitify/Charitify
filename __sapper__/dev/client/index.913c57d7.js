...
import { P as Picture, B as Button, I as Input, a as Progress, b as Icon, F as Form } from './index.406a0e27.js';
...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 118, 4, 2935);
			add_location(br1, file, 119, 4, 2944);
			add_location(br2, file, 123, 4, 3018);
			add_location(br3, file, 124, 4, 3027);
			add_location(br4, file, 128, 4, 3099);
			add_location(br5, file, 129, 4, 3108);
			add_location(br6, file, 133, 4, 3181);
			add_location(br7, file, 134, 4, 3190);
			add_location(br8, file, 138, 4, 3261);
			add_location(br9, file, 139, 4, 3270);
			add_location(br10, file, 143, 4, 3344);
			add_location(br11, file, 144, 4, 3353);
			add_location(br12, file, 148, 4, 3425);
			add_location(br13, file, 149, 4, 3434);
			add_location(br14, file, 153, 4, 3510);
			add_location(br15, file, 154, 4, 3519);
			add_location(br16, file, 158, 4, 3590);
			add_location(br17, file, 159, 4, 3599);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file, 93, 8, 2188);
			add_location(li5, file, 92, 8, 2175);
			add_location(span1, file, 100, 8, 2430);
			add_location(li6, file, 99, 8, 2417);
			add_location(span2, file, 107, 8, 2633);
			add_location(li7, file, 106, 8, 2620);
			add_location(ul1, file, 91, 4, 2162);
			attr_dev(section2, "class", "top-wrap svelte-1kmv00v");
			add_location(section2, file, 48, 0, 750);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 164, 0, 3669);
			add_location(br1, file, 166, 0, 3737);
			add_location(br2, file, 167, 0, 3742);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 169, 0, 3748);
			add_location(br3, file, 171, 0, 3790);
			add_location(br4, file, 172, 0, 3795);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 174, 0, 3801);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 175, 0, 3837);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 176, 0, 3881);
			add_location(br5, file, 178, 0, 3927);
			add_location(br6, file, 179, 0, 3932);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 181, 0, 3938);
			add_location(br7, file, 183, 0, 3990);
			add_location(br8, file, 184, 0, 3995);
			add_location(br9, file, 188, 8, 4102);
			add_location(br10, file, 190, 8, 4131);
			add_location(br11, file, 191, 8, 4144);
			add_location(br12, file, 193, 8, 4220);
			add_location(br13, file, 194, 8, 4233);
			add_location(br14, file, 196, 8, 4322);
			add_location(br15, file, 197, 8, 4335);
			add_location(br16, file, 199, 8, 4441);
			add_location(br17, file, 200, 8, 4454);
			add_location(br18, file, 204, 8, 4581);
			add_location(br19, file, 205, 8, 4594);
			add_location(br20, file, 207, 8, 4701);
			add_location(br21, file, 208, 8, 4714);
			add_location(br22, file, 210, 8, 4820);
			add_location(br23, file, 211, 8, 4833);
			add_location(div1, file, 187, 4, 4088);
			add_location(br24, file, 215, 8, 4868);
			add_location(br25, file, 217, 8, 4906);
			add_location(br26, file, 218, 8, 4919);
			add_location(br27, file, 220, 8, 5004);
			add_location(br28, file, 221, 8, 5017);
			add_location(br29, file, 223, 8, 5115);
			add_location(br30, file, 224, 8, 5128);
			add_location(br31, file, 226, 8, 5226);
			add_location(br32, file, 227, 8, 5239);
			add_location(br33, file, 231, 8, 5375);
			add_location(br34, file, 232, 8, 5388);
			add_location(br35, file, 234, 8, 5504);
			add_location(br36, file, 235, 8, 5517);
			add_location(br37, file, 237, 8, 5632);
			add_location(br38, file, 238, 8, 5645);
			add_location(div2, file, 214, 4, 4854);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 186, 0, 4001);
			add_location(br39, file, 242, 0, 5673);
			add_location(br40, file, 243, 0, 5678);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 245, 0, 5684);
			add_location(br41, file, 247, 0, 5727);
			add_location(br42, file, 248, 0, 5732);
			add_location(br43, file, 253, 4, 5797);
			add_location(br44, file, 254, 4, 5806);
			add_location(br45, file, 258, 4, 5889);
			add_location(br46, file, 259, 4, 5898);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 264, 8, 5987);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 265, 8, 6014);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 266, 8, 6041);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 263, 4, 5959);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 269, 4, 6081);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 270, 4, 6139);
			add_location(br47, file, 272, 4, 6188);
			add_location(br48, file, 273, 4, 6197);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 275, 4, 6207);
			add_location(br49, file, 277, 4, 6259);
			add_location(br50, file, 278, 4, 6268);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 280, 4, 6278);
			add_location(section4, file, 250, 0, 5738);
			add_location(br51, file, 283, 0, 6354);
			add_location(br52, file, 284, 0, 6359);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 286, 0, 6365);
			add_location(br53, file, 292, 0, 6489);
			add_location(br54, file, 293, 0, 6494);
			add_location(br55, file, 297, 0, 6566);
			add_location(br56, file, 298, 0, 6571);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 300, 0, 6577);
			add_location(strong, file, 303, 4, 6622);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 302, 0, 6614);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 308, 0, 6731);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
