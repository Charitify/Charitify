...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-2oq8vl");
			add_location(li, file, 231, 12, 6252);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-2oq8vl");
			add_location(li, file, 252, 12, 6577);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 267, 4, 6768);
			add_location(br1, file, 268, 4, 6777);
			add_location(br2, file, 272, 4, 6851);
			add_location(br3, file, 273, 4, 6860);
			add_location(br4, file, 277, 4, 6932);
			add_location(br5, file, 278, 4, 6941);
			add_location(br6, file, 282, 4, 7014);
			add_location(br7, file, 283, 4, 7023);
			add_location(br8, file, 287, 4, 7094);
			add_location(br9, file, 288, 4, 7103);
			add_location(br10, file, 292, 4, 7177);
			add_location(br11, file, 293, 4, 7186);
			add_location(br12, file, 297, 4, 7258);
			add_location(br13, file, 298, 4, 7267);
			add_location(br14, file, 302, 4, 7343);
			add_location(br15, file, 303, 4, 7352);
			add_location(br16, file, 307, 4, 7423);
			add_location(br17, file, 308, 4, 7432);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-2oq8vl");
			add_location(div0, file, 139, 8, 3600);
			attr_dev(li0, "class", "svelte-2oq8vl");
			add_location(li0, file, 160, 12, 4428);
			attr_dev(li1, "class", "svelte-2oq8vl");
			add_location(li1, file, 163, 12, 4548);
			attr_dev(li2, "class", "svelte-2oq8vl");
			add_location(li2, file, 166, 12, 4669);
			add_location(br0, file, 170, 16, 4812);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 181, 20, 5163);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 182, 20, 5203);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 183, 20, 5244);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 180, 16, 5111);
			attr_dev(li3, "class", "svelte-2oq8vl");
			add_location(li3, file, 169, 12, 4791);
			attr_dev(li4, "class", "svelte-2oq8vl");
			add_location(li4, file, 186, 12, 5324);
			attr_dev(ul0, "class", "options svelte-2oq8vl");
			add_location(ul0, file, 159, 8, 4395);
			attr_dev(section0, "class", "top svelte-2oq8vl");
			add_location(section0, file, 138, 4, 3570);
			attr_dev(h3, "class", "svelte-2oq8vl");
			add_location(h3, file, 199, 16, 5683);
			attr_dev(p0, "class", "svelte-2oq8vl");
			add_location(p0, file, 200, 16, 5723);
			attr_dev(span0, "class", "svelte-2oq8vl");
			add_location(span0, file, 198, 12, 5660);
			attr_dev(div1, "class", "ava-section svelte-2oq8vl");
			add_location(div1, file, 195, 8, 5544);
			attr_dev(section1, "class", "rate-section svelte-2oq8vl");
			add_location(section1, file, 194, 4, 5505);
			add_location(br1, file, 207, 4, 5824);
			attr_dev(h10, "class", "svelte-2oq8vl");
			add_location(h10, file, 209, 4, 5834);
			add_location(br2, file, 211, 4, 5863);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 213, 4, 5873);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 137, 0, 3538);
			add_location(br3, file, 218, 0, 6029);
			add_location(br4, file, 219, 0, 6034);
			add_location(br5, file, 220, 0, 6039);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 224, 4, 6098);
			add_location(br6, file, 227, 4, 6181);
			attr_dev(ul1, "class", "cards svelte-2oq8vl");
			add_location(ul1, file, 229, 4, 6191);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 222, 0, 6045);
			add_location(br7, file, 238, 0, 6350);
			add_location(br8, file, 239, 0, 6355);
			add_location(br9, file, 240, 0, 6360);
			add_location(br10, file, 241, 0, 6365);
			set_style(h21, "text-align", "right");
			add_location(h21, file, 245, 4, 6424);
			add_location(br11, file, 248, 4, 6506);
			attr_dev(ul2, "class", "cards svelte-2oq8vl");
			add_location(ul2, file, 250, 4, 6516);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 243, 0, 6371);
			add_location(br12, file, 259, 0, 6675);
			add_location(br13, file, 260, 0, 6680);
			add_location(br14, file, 261, 0, 6685);
			attr_dev(h11, "class", "svelte-2oq8vl");
			add_location(h11, file, 313, 0, 7502);
			add_location(br15, file, 315, 0, 7570);
			add_location(br16, file, 316, 0, 7575);
			attr_dev(h22, "class", "text-success");
			add_location(h22, file, 318, 0, 7581);
			add_location(br17, file, 320, 0, 7623);
			add_location(br18, file, 321, 0, 7628);
			add_location(p2, file, 323, 0, 7634);
			add_location(p3, file, 324, 0, 7670);
			add_location(p4, file, 325, 0, 7714);
			add_location(br19, file, 327, 0, 7760);
			add_location(br20, file, 328, 0, 7765);
			attr_dev(h23, "class", "text-warning");
			add_location(h23, file, 330, 0, 7771);
			add_location(span1, file, 334, 8, 7845);
			add_location(li5, file, 333, 4, 7832);
			add_location(span2, file, 341, 8, 8079);
			add_location(li6, file, 340, 4, 8066);
			add_location(span3, file, 348, 8, 8274);
			add_location(li7, file, 347, 4, 8261);
			add_location(ul3, file, 332, 0, 7823);
			add_location(br21, file, 356, 0, 8492);
			add_location(br22, file, 357, 0, 8497);
			add_location(br23, file, 361, 8, 8604);
			add_location(br24, file, 363, 8, 8633);
			add_location(br25, file, 364, 8, 8646);
			add_location(br26, file, 366, 8, 8722);
			add_location(br27, file, 367, 8, 8735);
			add_location(br28, file, 369, 8, 8824);
			add_location(br29, file, 370, 8, 8837);
			add_location(br30, file, 372, 8, 8943);
			add_location(br31, file, 373, 8, 8956);
			add_location(br32, file, 377, 8, 9083);
			add_location(br33, file, 378, 8, 9096);
			add_location(br34, file, 380, 8, 9203);
			add_location(br35, file, 381, 8, 9216);
			add_location(br36, file, 383, 8, 9322);
			add_location(br37, file, 384, 8, 9335);
			add_location(div4, file, 360, 4, 8590);
			add_location(br38, file, 388, 8, 9370);
			add_location(br39, file, 390, 8, 9408);
			add_location(br40, file, 391, 8, 9421);
			add_location(br41, file, 393, 8, 9506);
			add_location(br42, file, 394, 8, 9519);
			add_location(br43, file, 396, 8, 9617);
			add_location(br44, file, 397, 8, 9630);
			add_location(br45, file, 399, 8, 9728);
			add_location(br46, file, 400, 8, 9741);
			add_location(br47, file, 404, 8, 9877);
			add_location(br48, file, 405, 8, 9890);
			add_location(br49, file, 407, 8, 10006);
			add_location(br50, file, 408, 8, 10019);
			add_location(br51, file, 410, 8, 10134);
			add_location(br52, file, 411, 8, 10147);
			add_location(div5, file, 387, 4, 9356);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 359, 0, 8503);
			add_location(br53, file, 415, 0, 10175);
			add_location(br54, file, 416, 0, 10180);
			attr_dev(h24, "class", "text-danger");
			add_location(h24, file, 418, 0, 10186);
			add_location(br55, file, 420, 0, 10229);
			add_location(br56, file, 421, 0, 10234);
			add_location(br57, file, 426, 4, 10299);
			add_location(br58, file, 427, 4, 10308);
			add_location(br59, file, 431, 4, 10391);
			add_location(br60, file, 432, 4, 10400);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 437, 8, 10489);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 438, 8, 10516);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 439, 8, 10543);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 436, 4, 10461);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 442, 4, 10583);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 443, 4, 10641);
			add_location(br61, file, 445, 4, 10690);
			add_location(br62, file, 446, 4, 10699);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 448, 4, 10709);
			add_location(br63, file, 450, 4, 10761);
			add_location(br64, file, 451, 4, 10770);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 453, 4, 10780);
			add_location(section4, file, 423, 0, 10240);
			add_location(br65, file, 456, 0, 10856);
			add_location(br66, file, 457, 0, 10861);
			attr_dev(h25, "class", "text-info");
			add_location(h25, file, 459, 0, 10867);
			add_location(br67, file, 461, 0, 10902);
			add_location(br68, file, 462, 0, 10907);
			add_location(br69, file, 466, 0, 10979);
			add_location(br70, file, 467, 0, 10984);
			attr_dev(h26, "class", "text-success");
			add_location(h26, file, 469, 0, 10990);
			add_location(strong, file, 472, 4, 11035);
			add_location(p5, file, 471, 0, 11027);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 477, 0, 11144);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
