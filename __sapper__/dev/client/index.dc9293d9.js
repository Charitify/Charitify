...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li0, file$2, 8, 4, 171);
			attr_dev(li1, "class", "svelte-o292s3");
			add_location(li1, file$2, 11, 4, 238);
			attr_dev(li2, "class", "svelte-o292s3");
			add_location(li2, file$2, 14, 4, 305);
			attr_dev(li3, "class", "svelte-o292s3");
			add_location(li3, file$2, 17, 4, 372);
			attr_dev(li4, "class", "svelte-o292s3");
			add_location(li4, file$2, 20, 4, 439);
			attr_dev(ul, "class", "rate svelte-o292s3");
			add_location(ul, file$2, 7, 0, 149);
		},
		m: function mount(target, anchor) {
