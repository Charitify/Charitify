...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 161, 4, 4203);
			add_location(br1, file$2, 162, 4, 4212);
			add_location(br2, file$2, 166, 4, 4286);
			add_location(br3, file$2, 167, 4, 4295);
			add_location(br4, file$2, 171, 4, 4367);
			add_location(br5, file$2, 172, 4, 4376);
			add_location(br6, file$2, 176, 4, 4449);
			add_location(br7, file$2, 177, 4, 4458);
			add_location(br8, file$2, 181, 4, 4529);
			add_location(br9, file$2, 182, 4, 4538);
			add_location(br10, file$2, 186, 4, 4612);
			add_location(br11, file$2, 187, 4, 4621);
			add_location(br12, file$2, 191, 4, 4693);
			add_location(br13, file$2, 192, 4, 4702);
			add_location(br14, file$2, 196, 4, 4778);
			add_location(br15, file$2, 197, 4, 4787);
			add_location(br16, file$2, 201, 4, 4858);
			add_location(br17, file$2, 202, 4, 4867);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h11, file$2, 207, 0, 4937);
			add_location(br4, file$2, 209, 0, 5005);
			add_location(br5, file$2, 210, 0, 5010);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 212, 0, 5016);
			add_location(br6, file$2, 214, 0, 5058);
			add_location(br7, file$2, 215, 0, 5063);
			add_location(p2, file$2, 217, 0, 5069);
			add_location(p3, file$2, 218, 0, 5105);
			add_location(p4, file$2, 219, 0, 5149);
			add_location(br8, file$2, 221, 0, 5195);
			add_location(br9, file$2, 222, 0, 5200);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 224, 0, 5206);
			add_location(span1, file$2, 228, 8, 5280);
			add_location(li5, file$2, 227, 4, 5267);
			add_location(span2, file$2, 235, 8, 5514);
			add_location(li6, file$2, 234, 4, 5501);
			add_location(span3, file$2, 242, 8, 5709);
			add_location(li7, file$2, 241, 4, 5696);
			add_location(ul1, file$2, 226, 0, 5258);
			add_location(br10, file$2, 250, 0, 5927);
			add_location(br11, file$2, 251, 0, 5932);
			add_location(br12, file$2, 255, 8, 6039);
			add_location(br13, file$2, 257, 8, 6068);
			add_location(br14, file$2, 258, 8, 6081);
			add_location(br15, file$2, 260, 8, 6157);
			add_location(br16, file$2, 261, 8, 6170);
			add_location(br17, file$2, 263, 8, 6259);
			add_location(br18, file$2, 264, 8, 6272);
			add_location(br19, file$2, 266, 8, 6378);
			add_location(br20, file$2, 267, 8, 6391);
			add_location(br21, file$2, 271, 8, 6518);
			add_location(br22, file$2, 272, 8, 6531);
			add_location(br23, file$2, 274, 8, 6638);
			add_location(br24, file$2, 275, 8, 6651);
			add_location(br25, file$2, 277, 8, 6757);
			add_location(br26, file$2, 278, 8, 6770);
			add_location(div2, file$2, 254, 4, 6025);
			add_location(br27, file$2, 282, 8, 6805);
			add_location(br28, file$2, 284, 8, 6843);
			add_location(br29, file$2, 285, 8, 6856);
			add_location(br30, file$2, 287, 8, 6941);
			add_location(br31, file$2, 288, 8, 6954);
			add_location(br32, file$2, 290, 8, 7052);
			add_location(br33, file$2, 291, 8, 7065);
			add_location(br34, file$2, 293, 8, 7163);
			add_location(br35, file$2, 294, 8, 7176);
			add_location(br36, file$2, 298, 8, 7312);
			add_location(br37, file$2, 299, 8, 7325);
			add_location(br38, file$2, 301, 8, 7441);
			add_location(br39, file$2, 302, 8, 7454);
			add_location(br40, file$2, 304, 8, 7569);
			add_location(br41, file$2, 305, 8, 7582);
			add_location(div3, file$2, 281, 4, 6791);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 253, 0, 5938);
			add_location(br42, file$2, 309, 0, 7610);
			add_location(br43, file$2, 310, 0, 7615);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 312, 0, 7621);
			add_location(br44, file$2, 314, 0, 7664);
			add_location(br45, file$2, 315, 0, 7669);
			add_location(br46, file$2, 320, 4, 7734);
			add_location(br47, file$2, 321, 4, 7743);
			add_location(br48, file$2, 325, 4, 7826);
			add_location(br49, file$2, 326, 4, 7835);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 331, 8, 7924);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 332, 8, 7951);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 333, 8, 7978);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 330, 4, 7896);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 336, 4, 8018);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 337, 4, 8076);
			add_location(br50, file$2, 339, 4, 8125);
			add_location(br51, file$2, 340, 4, 8134);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 342, 4, 8144);
			add_location(br52, file$2, 344, 4, 8196);
			add_location(br53, file$2, 345, 4, 8205);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 347, 4, 8215);
			add_location(section4, file$2, 317, 0, 7675);
			add_location(br54, file$2, 350, 0, 8291);
			add_location(br55, file$2, 351, 0, 8296);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 353, 0, 8302);
			add_location(br56, file$2, 359, 0, 8426);
			add_location(br57, file$2, 360, 0, 8431);
			add_location(br58, file$2, 364, 0, 8503);
			add_location(br59, file$2, 365, 0, 8508);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 367, 0, 8514);
			add_location(strong, file$2, 370, 4, 8559);
			add_location(p5, file$2, 369, 0, 8551);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 375, 0, 8668);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
