...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 100, 4, 2416);
			add_location(br1, file, 101, 4, 2425);
			add_location(br2, file, 105, 4, 2499);
			add_location(br3, file, 106, 4, 2508);
			add_location(br4, file, 110, 4, 2580);
			add_location(br5, file, 111, 4, 2589);
			add_location(br6, file, 115, 4, 2662);
			add_location(br7, file, 116, 4, 2671);
			add_location(br8, file, 120, 4, 2742);
			add_location(br9, file, 121, 4, 2751);
			add_location(br10, file, 125, 4, 2825);
			add_location(br11, file, 126, 4, 2834);
			add_location(br12, file, 130, 4, 2906);
			add_location(br13, file, 131, 4, 2915);
			add_location(br14, file, 135, 4, 2991);
			add_location(br15, file, 136, 4, 3000);
			add_location(br16, file, 140, 4, 3071);
			add_location(br17, file, 141, 4, 3080);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t16 = claim_text(h10_nodes, "The main text");
		...
		h: function hydrate() {
			...
			add_location(h11, file, 146, 0, 3150);
			add_location(br2, file, 148, 0, 3218);
			add_location(br3, file, 149, 0, 3223);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 151, 0, 3229);
			add_location(br4, file, 153, 0, 3271);
			add_location(br5, file, 154, 0, 3276);
			add_location(p0, file, 156, 0, 3282);
			add_location(p1, file, 157, 0, 3318);
			add_location(p2, file, 158, 0, 3362);
			add_location(br6, file, 160, 0, 3408);
			add_location(br7, file, 161, 0, 3413);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 163, 0, 3419);
			add_location(span1, file, 167, 8, 3493);
			add_location(li5, file, 166, 4, 3480);
			add_location(span2, file, 174, 8, 3727);
			add_location(li6, file, 173, 4, 3714);
			add_location(span3, file, 181, 8, 3922);
			add_location(li7, file, 180, 4, 3909);
			add_location(ul1, file, 165, 0, 3471);
			add_location(br8, file, 189, 0, 4140);
			add_location(br9, file, 190, 0, 4145);
			add_location(br10, file, 194, 8, 4252);
			add_location(br11, file, 196, 8, 4281);
			add_location(br12, file, 197, 8, 4294);
			add_location(br13, file, 199, 8, 4370);
			add_location(br14, file, 200, 8, 4383);
			add_location(br15, file, 202, 8, 4472);
			add_location(br16, file, 203, 8, 4485);
			add_location(br17, file, 205, 8, 4591);
			add_location(br18, file, 206, 8, 4604);
			add_location(br19, file, 210, 8, 4731);
			add_location(br20, file, 211, 8, 4744);
			add_location(br21, file, 213, 8, 4851);
			add_location(br22, file, 214, 8, 4864);
			add_location(br23, file, 216, 8, 4970);
			add_location(br24, file, 217, 8, 4983);
			add_location(div1, file, 193, 4, 4238);
			add_location(br25, file, 221, 8, 5018);
			add_location(br26, file, 223, 8, 5056);
			add_location(br27, file, 224, 8, 5069);
			add_location(br28, file, 226, 8, 5154);
			add_location(br29, file, 227, 8, 5167);
			add_location(br30, file, 229, 8, 5265);
			add_location(br31, file, 230, 8, 5278);
			add_location(br32, file, 232, 8, 5376);
			add_location(br33, file, 233, 8, 5389);
			add_location(br34, file, 237, 8, 5525);
			add_location(br35, file, 238, 8, 5538);
			add_location(br36, file, 240, 8, 5654);
			add_location(br37, file, 241, 8, 5667);
			add_location(br38, file, 243, 8, 5782);
			add_location(br39, file, 244, 8, 5795);
			add_location(div2, file, 220, 4, 5004);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 192, 0, 4151);
			add_location(br40, file, 248, 0, 5823);
			add_location(br41, file, 249, 0, 5828);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 251, 0, 5834);
			add_location(br42, file, 253, 0, 5877);
			add_location(br43, file, 254, 0, 5882);
			add_location(br44, file, 259, 4, 5947);
			add_location(br45, file, 260, 4, 5956);
			add_location(br46, file, 264, 4, 6039);
			add_location(br47, file, 265, 4, 6048);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 270, 8, 6137);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 271, 8, 6164);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 272, 8, 6191);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 269, 4, 6109);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 275, 4, 6231);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 276, 4, 6289);
			add_location(br48, file, 278, 4, 6338);
			add_location(br49, file, 279, 4, 6347);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 281, 4, 6357);
			add_location(br50, file, 283, 4, 6409);
			add_location(br51, file, 284, 4, 6418);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 286, 4, 6428);
			add_location(section4, file, 256, 0, 5888);
			add_location(br52, file, 289, 0, 6504);
			add_location(br53, file, 290, 0, 6509);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 292, 0, 6515);
			add_location(br54, file, 298, 0, 6639);
			add_location(br55, file, 299, 0, 6644);
			add_location(br56, file, 303, 0, 6716);
			add_location(br57, file, 304, 0, 6721);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 306, 0, 6727);
			add_location(strong, file, 309, 4, 6772);
			add_location(p3, file, 308, 0, 6764);
			set_style(p4, "text-align", "justify");
			add_location(p4, file, 314, 0, 6881);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
