...
function create_fragment$c(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a2, "class", "svelte-xs8syd");
			...
			attr_dev(select, "class", "btn small lang-select svelte-xs8syd");
			add_location(select, file$c, 29, 4, 884);
			attr_dev(span, "class", "nav-actions svelte-xs8syd");
			add_location(span, file$c, 28, 2, 853);
			attr_dev(nav, "class", "theme-bg container svelte-xs8syd");
