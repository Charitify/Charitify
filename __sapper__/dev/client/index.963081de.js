...
import { B as Button, I as Input, P as Progress, a as Icon, F as Form, b as Picture } from './index.b637f1f2.js';
...
// (90:16) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_15(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(90:16) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 120, 4, 3073);
			add_location(br1, file$2, 121, 4, 3082);
			add_location(br2, file$2, 125, 4, 3156);
			add_location(br3, file$2, 126, 4, 3165);
			add_location(br4, file$2, 130, 4, 3237);
			add_location(br5, file$2, 131, 4, 3246);
			add_location(br6, file$2, 135, 4, 3319);
			add_location(br7, file$2, 136, 4, 3328);
			add_location(br8, file$2, 140, 4, 3399);
			add_location(br9, file$2, 141, 4, 3408);
			add_location(br10, file$2, 145, 4, 3482);
			add_location(br11, file$2, 146, 4, 3491);
			add_location(br12, file$2, 150, 4, 3563);
			add_location(br13, file$2, 151, 4, 3572);
			add_location(br14, file$2, 155, 4, 3648);
			add_location(br15, file$2, 156, 4, 3657);
			add_location(br16, file$2, 160, 4, 3728);
			add_location(br17, file$2, 161, 4, 3737);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 43, 0, 749);
			attr_dev(div0, "class", "top-pic svelte-155sn6i");
			add_location(div0, file$2, 47, 8, 816);
			attr_dev(li0, "class", "svelte-155sn6i");
			add_location(li0, file$2, 62, 12, 1367);
			attr_dev(li1, "class", "svelte-155sn6i");
			add_location(li1, file$2, 65, 12, 1487);
			attr_dev(li2, "class", "svelte-155sn6i");
			add_location(li2, file$2, 68, 12, 1608);
			add_location(br1, file$2, 72, 16, 1751);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 83, 20, 2102);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 84, 20, 2142);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 85, 20, 2183);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 82, 16, 2050);
			attr_dev(li3, "class", "svelte-155sn6i");
			add_location(li3, file$2, 71, 12, 1730);
			attr_dev(li4, "class", "svelte-155sn6i");
			add_location(li4, file$2, 88, 12, 2263);
			attr_dev(ul0, "class", "options svelte-155sn6i");
			add_location(ul0, file$2, 61, 8, 1334);
			attr_dev(section0, "class", "top svelte-155sn6i");
			add_location(section0, file$2, 46, 4, 786);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file$2, 94, 4, 2406);
			add_location(span0, file$2, 98, 4, 2510);
			add_location(br2, file$2, 106, 4, 2794);
			add_location(br3, file$2, 107, 4, 2803);
			attr_dev(h10, "class", "svelte-155sn6i");
			add_location(h10, file$2, 109, 4, 2813);
			add_location(br4, file$2, 111, 4, 2842);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 113, 4, 2852);
			attr_dev(section2, "class", "top-wrap svelte-155sn6i");
			add_location(section2, file$2, 45, 0, 755);
			attr_dev(h11, "class", "svelte-155sn6i");
			add_location(h11, file$2, 166, 0, 3807);
			add_location(br5, file$2, 168, 0, 3875);
			add_location(br6, file$2, 169, 0, 3880);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 171, 0, 3886);
			add_location(br7, file$2, 173, 0, 3928);
			add_location(br8, file$2, 174, 0, 3933);
			add_location(p1, file$2, 176, 0, 3939);
			add_location(p2, file$2, 177, 0, 3975);
			add_location(p3, file$2, 178, 0, 4019);
			add_location(br9, file$2, 180, 0, 4065);
			add_location(br10, file$2, 181, 0, 4070);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 183, 0, 4076);
			add_location(span1, file$2, 187, 8, 4150);
			add_location(li5, file$2, 186, 4, 4137);
			add_location(span2, file$2, 194, 8, 4384);
			add_location(li6, file$2, 193, 4, 4371);
			add_location(span3, file$2, 201, 8, 4579);
			add_location(li7, file$2, 200, 4, 4566);
			add_location(ul1, file$2, 185, 0, 4128);
			add_location(br11, file$2, 209, 0, 4797);
			add_location(br12, file$2, 210, 0, 4802);
			add_location(br13, file$2, 214, 8, 4909);
			add_location(br14, file$2, 216, 8, 4938);
			add_location(br15, file$2, 217, 8, 4951);
			add_location(br16, file$2, 219, 8, 5027);
			add_location(br17, file$2, 220, 8, 5040);
			add_location(br18, file$2, 222, 8, 5129);
			add_location(br19, file$2, 223, 8, 5142);
			add_location(br20, file$2, 225, 8, 5248);
			add_location(br21, file$2, 226, 8, 5261);
			add_location(br22, file$2, 230, 8, 5388);
			add_location(br23, file$2, 231, 8, 5401);
			add_location(br24, file$2, 233, 8, 5508);
			add_location(br25, file$2, 234, 8, 5521);
			add_location(br26, file$2, 236, 8, 5627);
			add_location(br27, file$2, 237, 8, 5640);
			add_location(div1, file$2, 213, 4, 4895);
			add_location(br28, file$2, 241, 8, 5675);
			add_location(br29, file$2, 243, 8, 5713);
			add_location(br30, file$2, 244, 8, 5726);
			add_location(br31, file$2, 246, 8, 5811);
			add_location(br32, file$2, 247, 8, 5824);
			add_location(br33, file$2, 249, 8, 5922);
			add_location(br34, file$2, 250, 8, 5935);
			add_location(br35, file$2, 252, 8, 6033);
			add_location(br36, file$2, 253, 8, 6046);
			add_location(br37, file$2, 257, 8, 6182);
			add_location(br38, file$2, 258, 8, 6195);
			add_location(br39, file$2, 260, 8, 6311);
			add_location(br40, file$2, 261, 8, 6324);
			add_location(br41, file$2, 263, 8, 6439);
			add_location(br42, file$2, 264, 8, 6452);
			add_location(div2, file$2, 240, 4, 5661);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 212, 0, 4808);
			add_location(br43, file$2, 268, 0, 6480);
			add_location(br44, file$2, 269, 0, 6485);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 271, 0, 6491);
			add_location(br45, file$2, 273, 0, 6534);
			add_location(br46, file$2, 274, 0, 6539);
			add_location(br47, file$2, 279, 4, 6604);
			add_location(br48, file$2, 280, 4, 6613);
			add_location(br49, file$2, 284, 4, 6696);
			add_location(br50, file$2, 285, 4, 6705);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 290, 8, 6794);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 291, 8, 6821);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 292, 8, 6848);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 289, 4, 6766);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 295, 4, 6888);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 296, 4, 6946);
			add_location(br51, file$2, 298, 4, 6995);
			add_location(br52, file$2, 299, 4, 7004);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 301, 4, 7014);
			add_location(br53, file$2, 303, 4, 7066);
			add_location(br54, file$2, 304, 4, 7075);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 306, 4, 7085);
			add_location(section4, file$2, 276, 0, 6545);
			add_location(br55, file$2, 309, 0, 7161);
			add_location(br56, file$2, 310, 0, 7166);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 312, 0, 7172);
			add_location(br57, file$2, 318, 0, 7296);
			add_location(br58, file$2, 319, 0, 7301);
			add_location(br59, file$2, 323, 0, 7373);
			add_location(br60, file$2, 324, 0, 7378);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 326, 0, 7384);
			add_location(strong, file$2, 329, 4, 7429);
			add_location(p4, file$2, 328, 0, 7421);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 334, 0, 7538);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
