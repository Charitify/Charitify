...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "images svelte-1yacjgq");
			...
			attr_dev(div1, "class", "card svelte-1yacjgq");
