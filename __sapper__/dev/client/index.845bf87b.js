import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, p as space, e as element, o as create_component, A as text, r as claim_space, c as claim_element, b as children, q as claim_component, f as detach_dev, B as claim_text, g as attr_dev, h as add_location, j as set_style, k as insert_dev, t as mount_component, l as append_dev, w as transition_in, x as transition_out, y as destroy_component } from './index.272f3989.js';
...
function create_default_slot(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			template = claim_element(nodes, "TEMPLATE", {});
		...
		p: function update(ctx, dirty) {
			const charitycards_changes = {};
			if (dirty & /*item*/ 1) charitycards_changes.listNamw = /*item*/ ctx[0].title;
			charitycards.$set(charitycards_changes);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br10, file, 64, 0, 1097);
			add_location(br11, file, 65, 0, 1102);
			add_location(br12, file, 66, 0, 1107);
			add_location(br13, file, 67, 0, 1112);
			add_location(br14, file, 68, 0, 1117);
			add_location(br15, file, 78, 12, 1437);
			set_style(li0, "width", "50%");
			add_location(li0, file, 72, 8, 1207);
			add_location(br16, file, 86, 12, 1694);
			set_style(li1, "width", "50%");
			add_location(li1, file, 80, 8, 1464);
			add_location(br17, file, 94, 12, 1951);
			set_style(li2, "width", "50%");
			add_location(li2, file, 88, 8, 1721);
			add_location(br18, file, 102, 12, 2208);
			set_style(li3, "width", "50%");
			add_location(li3, file, 96, 8, 1978);
			set_style(ul, "display", "flex");
			set_style(ul, "flex-wrap", "wrap");
			add_location(ul, file, 71, 4, 1155);
			attr_dev(section1, "class", "container");
			add_location(section1, file, 70, 0, 1123);
			add_location(br19, file, 107, 0, 2249);
			add_location(br20, file, 108, 0, 2254);
			add_location(br21, file, 109, 0, 2259);
			add_location(br22, file, 110, 0, 2264);
			add_location(br23, file, 111, 0, 2269);
			add_location(br24, file, 115, 0, 2293);
			add_location(br25, file, 116, 0, 2298);
			add_location(br26, file, 117, 0, 2303);
			add_location(br27, file, 118, 0, 2308);
			add_location(br28, file, 119, 0, 2313);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 121, 0, 2319);
			add_location(br29, file, 125, 0, 2390);
			add_location(br30, file, 126, 0, 2395);
			add_location(br31, file, 127, 0, 2400);
			add_location(br32, file, 128, 0, 2405);
			add_location(br33, file, 129, 0, 2410);
		},
		m: function mount(target, anchor) {
