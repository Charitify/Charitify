...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 238, 4, 5966);
			add_location(br1, file$2, 239, 4, 5975);
			add_location(br2, file$2, 243, 4, 6049);
			add_location(br3, file$2, 244, 4, 6058);
			add_location(br4, file$2, 248, 4, 6130);
			add_location(br5, file$2, 249, 4, 6139);
			add_location(br6, file$2, 253, 4, 6212);
			add_location(br7, file$2, 254, 4, 6221);
			add_location(br8, file$2, 258, 4, 6292);
			add_location(br9, file$2, 259, 4, 6301);
			add_location(br10, file$2, 263, 4, 6375);
			add_location(br11, file$2, 264, 4, 6384);
			add_location(br12, file$2, 268, 4, 6456);
			add_location(br13, file$2, 269, 4, 6465);
			add_location(br14, file$2, 273, 4, 6541);
			add_location(br15, file$2, 274, 4, 6550);
			add_location(br16, file$2, 278, 4, 6621);
			add_location(br17, file$2, 279, 4, 6630);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br6, file$2, 222, 0, 5869);
			add_location(br7, file$2, 223, 0, 5874);
			attr_dev(h11, "class", "svelte-1fydlyp");
			add_location(h11, file$2, 284, 0, 6700);
			add_location(br8, file$2, 286, 0, 6768);
			add_location(br9, file$2, 287, 0, 6773);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file$2, 289, 0, 6779);
			add_location(br10, file$2, 291, 0, 6821);
			add_location(br11, file$2, 292, 0, 6826);
			add_location(p2, file$2, 294, 0, 6832);
			add_location(p3, file$2, 295, 0, 6868);
			add_location(p4, file$2, 296, 0, 6912);
			add_location(br12, file$2, 298, 0, 6958);
			add_location(br13, file$2, 299, 0, 6963);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file$2, 301, 0, 6969);
			add_location(span1, file$2, 305, 8, 7043);
			add_location(li5, file$2, 304, 4, 7030);
			add_location(span2, file$2, 312, 8, 7277);
			add_location(li6, file$2, 311, 4, 7264);
			add_location(span3, file$2, 319, 8, 7472);
			add_location(li7, file$2, 318, 4, 7459);
			add_location(ul1, file$2, 303, 0, 7021);
			add_location(br14, file$2, 327, 0, 7690);
			add_location(br15, file$2, 328, 0, 7695);
			add_location(br16, file$2, 332, 8, 7802);
			add_location(br17, file$2, 334, 8, 7831);
			add_location(br18, file$2, 335, 8, 7844);
			add_location(br19, file$2, 337, 8, 7920);
			add_location(br20, file$2, 338, 8, 7933);
			add_location(br21, file$2, 340, 8, 8022);
			add_location(br22, file$2, 341, 8, 8035);
			add_location(br23, file$2, 343, 8, 8141);
			add_location(br24, file$2, 344, 8, 8154);
			add_location(br25, file$2, 348, 8, 8281);
			add_location(br26, file$2, 349, 8, 8294);
			add_location(br27, file$2, 351, 8, 8401);
			add_location(br28, file$2, 352, 8, 8414);
			add_location(br29, file$2, 354, 8, 8520);
			add_location(br30, file$2, 355, 8, 8533);
			add_location(div3, file$2, 331, 4, 7788);
			add_location(br31, file$2, 359, 8, 8568);
			add_location(br32, file$2, 361, 8, 8606);
			add_location(br33, file$2, 362, 8, 8619);
			add_location(br34, file$2, 364, 8, 8704);
			add_location(br35, file$2, 365, 8, 8717);
			add_location(br36, file$2, 367, 8, 8815);
			add_location(br37, file$2, 368, 8, 8828);
			add_location(br38, file$2, 370, 8, 8926);
			add_location(br39, file$2, 371, 8, 8939);
			add_location(br40, file$2, 375, 8, 9075);
			add_location(br41, file$2, 376, 8, 9088);
			add_location(br42, file$2, 378, 8, 9204);
			add_location(br43, file$2, 379, 8, 9217);
			add_location(br44, file$2, 381, 8, 9332);
			add_location(br45, file$2, 382, 8, 9345);
			add_location(div4, file$2, 358, 4, 8554);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 330, 0, 7701);
			add_location(br46, file$2, 386, 0, 9373);
			add_location(br47, file$2, 387, 0, 9378);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file$2, 389, 0, 9384);
			add_location(br48, file$2, 391, 0, 9427);
			add_location(br49, file$2, 392, 0, 9432);
			add_location(br50, file$2, 397, 4, 9497);
			add_location(br51, file$2, 398, 4, 9506);
			add_location(br52, file$2, 402, 4, 9589);
			add_location(br53, file$2, 403, 4, 9598);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 408, 8, 9687);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 409, 8, 9714);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 410, 8, 9741);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 407, 4, 9659);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 413, 4, 9781);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 414, 4, 9839);
			add_location(br54, file$2, 416, 4, 9888);
			add_location(br55, file$2, 417, 4, 9897);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 419, 4, 9907);
			add_location(br56, file$2, 421, 4, 9959);
			add_location(br57, file$2, 422, 4, 9968);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 424, 4, 9978);
			add_location(section4, file$2, 394, 0, 9438);
			add_location(br58, file$2, 427, 0, 10054);
			add_location(br59, file$2, 428, 0, 10059);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file$2, 430, 0, 10065);
			add_location(br60, file$2, 432, 0, 10100);
			add_location(br61, file$2, 433, 0, 10105);
			add_location(br62, file$2, 437, 0, 10177);
			add_location(br63, file$2, 438, 0, 10182);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file$2, 440, 0, 10188);
			add_location(strong, file$2, 443, 4, 10233);
			add_location(p5, file$2, 442, 0, 10225);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 448, 0, 10342);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
