...
function create_fragment$9(ctx) {
	...
	const block = {
		c: function create() {
			...
			t8 = space();
			pre1 = element("pre");
			t9 = text("A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			t10 = space();
			br2 = element("br");
			t11 = space();
			pre2 = element("pre");
			t12 = text("A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			this.h();
		},
		l: function claim(nodes) {
			...
			t6 = claim_text(pre0_nodes, "A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			...
			t9 = claim_text(pre1_nodes, "A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
			...
			t12 = claim_text(pre2_nodes, "A loooooooooong comment that has been\n            left by a very angry guy who complains upon\n            looooong comments.");
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-h9qx8j");
			add_location(h4, file$9, 13, 12, 268);
			attr_dev(sub, "class", "svelte-h9qx8j");
			add_location(sub, file$9, 14, 12, 297);
			attr_dev(span, "class", "svelte-h9qx8j");
			add_location(span, file$9, 12, 8, 249);
			attr_dev(br0, "class", "small");
			add_location(br0, file$9, 17, 8, 344);
			attr_dev(pre0, "class", "svelte-h9qx8j");
			add_location(pre0, file$9, 19, 8, 372);
			attr_dev(br1, "class", "medium");
			add_location(br1, file$9, 24, 8, 526);
			attr_dev(pre1, "class", "svelte-h9qx8j");
			add_location(pre1, file$9, 26, 8, 555);
			attr_dev(br2, "class", "big");
			add_location(br2, file$9, 31, 8, 709);
			attr_dev(pre2, "class", "svelte-h9qx8j");
			add_location(pre2, file$9, 33, 8, 735);
			attr_dev(div, "class", "svelte-h9qx8j");
			add_location(div, file$9, 11, 4, 235);
			attr_dev(section, "class", "svelte-h9qx8j");
