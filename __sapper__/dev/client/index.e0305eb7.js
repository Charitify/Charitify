...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-core svelte-1m8tyz3");
			add_location(div0, file$5, 27, 4, 687);
			attr_dev(div1, "id", /*id*/ ctx[0]);
			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1m8tyz3"));
			...
			attr_dev(div1, "aria-valuenow", /*value*/ ctx[1]);
			add_location(div1, file$5, 17, 0, 465);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 16 && div1_class_value !== (div1_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-1m8tyz3"))) {
