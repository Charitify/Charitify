...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 157, 4, 4168);
			add_location(br1, file$2, 158, 4, 4177);
			add_location(br2, file$2, 162, 4, 4251);
			add_location(br3, file$2, 163, 4, 4260);
			add_location(br4, file$2, 167, 4, 4332);
			add_location(br5, file$2, 168, 4, 4341);
			add_location(br6, file$2, 172, 4, 4414);
			add_location(br7, file$2, 173, 4, 4423);
			add_location(br8, file$2, 177, 4, 4494);
			add_location(br9, file$2, 178, 4, 4503);
			add_location(br10, file$2, 182, 4, 4577);
			add_location(br11, file$2, 183, 4, 4586);
			add_location(br12, file$2, 187, 4, 4658);
			add_location(br13, file$2, 188, 4, 4667);
			add_location(br14, file$2, 192, 4, 4743);
			add_location(br15, file$2, 193, 4, 4752);
			add_location(br16, file$2, 197, 4, 4823);
			add_location(br17, file$2, 198, 4, 4832);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$2, 76, 8, 1674);
			attr_dev(li0, "class", "svelte-1acbdpe");
			add_location(li0, file$2, 97, 12, 2502);
			attr_dev(li1, "class", "svelte-1acbdpe");
			add_location(li1, file$2, 100, 12, 2622);
			attr_dev(li2, "class", "svelte-1acbdpe");
			add_location(li2, file$2, 103, 12, 2743);
			add_location(br0, file$2, 107, 16, 2886);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 118, 20, 3237);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 119, 20, 3277);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 120, 20, 3318);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 117, 16, 3185);
			attr_dev(li3, "class", "svelte-1acbdpe");
			add_location(li3, file$2, 106, 12, 2865);
			attr_dev(li4, "class", "svelte-1acbdpe");
			add_location(li4, file$2, 123, 12, 3398);
			attr_dev(ul0, "class", "options svelte-1acbdpe");
			add_location(ul0, file$2, 96, 8, 2469);
			attr_dev(section0, "class", "top svelte-1acbdpe");
			add_location(section0, file$2, 75, 4, 1644);
			attr_dev(h3, "class", "svelte-1acbdpe");
			add_location(h3, file$2, 136, 16, 3757);
			attr_dev(p0, "class", "svelte-1acbdpe");
			add_location(p0, file$2, 137, 16, 3797);
			attr_dev(span0, "class", "svelte-1acbdpe");
			add_location(span0, file$2, 135, 12, 3734);
			attr_dev(div1, "class", "ava-section svelte-1acbdpe");
			add_location(div1, file$2, 132, 8, 3618);
			attr_dev(section1, "class", "rate-section svelte-1acbdpe");
			add_location(section1, file$2, 131, 4, 3579);
			add_location(br1, file$2, 144, 4, 3898);
			attr_dev(h10, "class", "svelte-1acbdpe");
			add_location(h10, file$2, 146, 4, 3908);
			add_location(br2, file$2, 148, 4, 3937);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 150, 4, 3947);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 74, 0, 1612);
			attr_dev(h11, "class", "svelte-1acbdpe");
			add_location(h11, file$2, 203, 0, 4902);
			add_location(br3, file$2, 205, 0, 4970);
			add_location(br4, file$2, 206, 0, 4975);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 208, 0, 4981);
			add_location(br5, file$2, 210, 0, 5023);
			add_location(br6, file$2, 211, 0, 5028);
			add_location(p2, file$2, 213, 0, 5034);
			add_location(p3, file$2, 214, 0, 5070);
			add_location(p4, file$2, 215, 0, 5114);
			add_location(br7, file$2, 217, 0, 5160);
			add_location(br8, file$2, 218, 0, 5165);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 220, 0, 5171);
			add_location(span1, file$2, 224, 8, 5245);
			add_location(li5, file$2, 223, 4, 5232);
			add_location(span2, file$2, 231, 8, 5479);
			add_location(li6, file$2, 230, 4, 5466);
			add_location(span3, file$2, 238, 8, 5674);
			add_location(li7, file$2, 237, 4, 5661);
			add_location(ul1, file$2, 222, 0, 5223);
			add_location(br9, file$2, 246, 0, 5892);
			add_location(br10, file$2, 247, 0, 5897);
			add_location(br11, file$2, 251, 8, 6004);
			add_location(br12, file$2, 253, 8, 6033);
			add_location(br13, file$2, 254, 8, 6046);
			add_location(br14, file$2, 256, 8, 6122);
			add_location(br15, file$2, 257, 8, 6135);
			add_location(br16, file$2, 259, 8, 6224);
			add_location(br17, file$2, 260, 8, 6237);
			add_location(br18, file$2, 262, 8, 6343);
			add_location(br19, file$2, 263, 8, 6356);
			add_location(br20, file$2, 267, 8, 6483);
			add_location(br21, file$2, 268, 8, 6496);
			add_location(br22, file$2, 270, 8, 6603);
			add_location(br23, file$2, 271, 8, 6616);
			add_location(br24, file$2, 273, 8, 6722);
			add_location(br25, file$2, 274, 8, 6735);
			add_location(div2, file$2, 250, 4, 5990);
			add_location(br26, file$2, 278, 8, 6770);
			add_location(br27, file$2, 280, 8, 6808);
			add_location(br28, file$2, 281, 8, 6821);
			add_location(br29, file$2, 283, 8, 6906);
			add_location(br30, file$2, 284, 8, 6919);
			add_location(br31, file$2, 286, 8, 7017);
			add_location(br32, file$2, 287, 8, 7030);
			add_location(br33, file$2, 289, 8, 7128);
			add_location(br34, file$2, 290, 8, 7141);
			add_location(br35, file$2, 294, 8, 7277);
			add_location(br36, file$2, 295, 8, 7290);
			add_location(br37, file$2, 297, 8, 7406);
			add_location(br38, file$2, 298, 8, 7419);
			add_location(br39, file$2, 300, 8, 7534);
			add_location(br40, file$2, 301, 8, 7547);
			add_location(div3, file$2, 277, 4, 6756);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 249, 0, 5903);
			add_location(br41, file$2, 305, 0, 7575);
			add_location(br42, file$2, 306, 0, 7580);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 308, 0, 7586);
			add_location(br43, file$2, 310, 0, 7629);
			add_location(br44, file$2, 311, 0, 7634);
			add_location(br45, file$2, 316, 4, 7699);
			add_location(br46, file$2, 317, 4, 7708);
			add_location(br47, file$2, 321, 4, 7791);
			add_location(br48, file$2, 322, 4, 7800);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 327, 8, 7889);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 328, 8, 7916);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 329, 8, 7943);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 326, 4, 7861);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 332, 4, 7983);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 333, 4, 8041);
			add_location(br49, file$2, 335, 4, 8090);
			add_location(br50, file$2, 336, 4, 8099);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 338, 4, 8109);
			add_location(br51, file$2, 340, 4, 8161);
			add_location(br52, file$2, 341, 4, 8170);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 343, 4, 8180);
			add_location(section4, file$2, 313, 0, 7640);
			add_location(br53, file$2, 346, 0, 8256);
			add_location(br54, file$2, 347, 0, 8261);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 349, 0, 8267);
			add_location(br55, file$2, 355, 0, 8391);
			add_location(br56, file$2, 356, 0, 8396);
			add_location(br57, file$2, 360, 0, 8468);
			add_location(br58, file$2, 361, 0, 8473);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 363, 0, 8479);
			add_location(strong, file$2, 366, 4, 8524);
			add_location(p5, file$2, 365, 0, 8516);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 371, 0, 8633);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
