...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 239, 4, 6027);
			add_location(br1, file$2, 240, 4, 6036);
			add_location(br2, file$2, 244, 4, 6110);
			add_location(br3, file$2, 245, 4, 6119);
			add_location(br4, file$2, 249, 4, 6191);
			add_location(br5, file$2, 250, 4, 6200);
			add_location(br6, file$2, 254, 4, 6273);
			add_location(br7, file$2, 255, 4, 6282);
			add_location(br8, file$2, 259, 4, 6353);
			add_location(br9, file$2, 260, 4, 6362);
			add_location(br10, file$2, 264, 4, 6436);
			add_location(br11, file$2, 265, 4, 6445);
			add_location(br12, file$2, 269, 4, 6517);
			add_location(br13, file$2, 270, 4, 6526);
			add_location(br14, file$2, 274, 4, 6602);
			add_location(br15, file$2, 275, 4, 6611);
			add_location(br16, file$2, 279, 4, 6682);
			add_location(br17, file$2, 280, 4, 6691);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br6, file$2, 223, 0, 5930);
			add_location(br7, file$2, 224, 0, 5935);
			attr_dev(h11, "class", "svelte-1fydlyp");
			add_location(h11, file$2, 285, 0, 6761);
			add_location(br8, file$2, 287, 0, 6829);
			add_location(br9, file$2, 288, 0, 6834);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file$2, 290, 0, 6840);
			add_location(br10, file$2, 292, 0, 6882);
			add_location(br11, file$2, 293, 0, 6887);
			add_location(p2, file$2, 295, 0, 6893);
			add_location(p3, file$2, 296, 0, 6929);
			add_location(p4, file$2, 297, 0, 6973);
			add_location(br12, file$2, 299, 0, 7019);
			add_location(br13, file$2, 300, 0, 7024);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file$2, 302, 0, 7030);
			add_location(span1, file$2, 306, 8, 7104);
			add_location(li5, file$2, 305, 4, 7091);
			add_location(span2, file$2, 313, 8, 7338);
			add_location(li6, file$2, 312, 4, 7325);
			add_location(span3, file$2, 320, 8, 7533);
			add_location(li7, file$2, 319, 4, 7520);
			add_location(ul1, file$2, 304, 0, 7082);
			add_location(br14, file$2, 328, 0, 7751);
			add_location(br15, file$2, 329, 0, 7756);
			add_location(br16, file$2, 333, 8, 7863);
			add_location(br17, file$2, 335, 8, 7892);
			add_location(br18, file$2, 336, 8, 7905);
			add_location(br19, file$2, 338, 8, 7981);
			add_location(br20, file$2, 339, 8, 7994);
			add_location(br21, file$2, 341, 8, 8083);
			add_location(br22, file$2, 342, 8, 8096);
			add_location(br23, file$2, 344, 8, 8202);
			add_location(br24, file$2, 345, 8, 8215);
			add_location(br25, file$2, 349, 8, 8342);
			add_location(br26, file$2, 350, 8, 8355);
			add_location(br27, file$2, 352, 8, 8462);
			add_location(br28, file$2, 353, 8, 8475);
			add_location(br29, file$2, 355, 8, 8581);
			add_location(br30, file$2, 356, 8, 8594);
			add_location(div3, file$2, 332, 4, 7849);
			add_location(br31, file$2, 360, 8, 8629);
			add_location(br32, file$2, 362, 8, 8667);
			add_location(br33, file$2, 363, 8, 8680);
			add_location(br34, file$2, 365, 8, 8765);
			add_location(br35, file$2, 366, 8, 8778);
			add_location(br36, file$2, 368, 8, 8876);
			add_location(br37, file$2, 369, 8, 8889);
			add_location(br38, file$2, 371, 8, 8987);
			add_location(br39, file$2, 372, 8, 9000);
			add_location(br40, file$2, 376, 8, 9136);
			add_location(br41, file$2, 377, 8, 9149);
			add_location(br42, file$2, 379, 8, 9265);
			add_location(br43, file$2, 380, 8, 9278);
			add_location(br44, file$2, 382, 8, 9393);
			add_location(br45, file$2, 383, 8, 9406);
			add_location(div4, file$2, 359, 4, 8615);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 331, 0, 7762);
			add_location(br46, file$2, 387, 0, 9434);
			add_location(br47, file$2, 388, 0, 9439);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file$2, 390, 0, 9445);
			add_location(br48, file$2, 392, 0, 9488);
			add_location(br49, file$2, 393, 0, 9493);
			add_location(br50, file$2, 398, 4, 9558);
			add_location(br51, file$2, 399, 4, 9567);
			add_location(br52, file$2, 403, 4, 9650);
			add_location(br53, file$2, 404, 4, 9659);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 409, 8, 9748);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 410, 8, 9775);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 411, 8, 9802);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 408, 4, 9720);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 414, 4, 9842);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 415, 4, 9900);
			add_location(br54, file$2, 417, 4, 9949);
			add_location(br55, file$2, 418, 4, 9958);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 420, 4, 9968);
			add_location(br56, file$2, 422, 4, 10020);
			add_location(br57, file$2, 423, 4, 10029);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 425, 4, 10039);
			add_location(section4, file$2, 395, 0, 9499);
			add_location(br58, file$2, 428, 0, 10115);
			add_location(br59, file$2, 429, 0, 10120);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file$2, 431, 0, 10126);
			add_location(br60, file$2, 433, 0, 10161);
			add_location(br61, file$2, 434, 0, 10166);
			add_location(br62, file$2, 438, 0, 10238);
			add_location(br63, file$2, 439, 0, 10243);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file$2, 441, 0, 10249);
			add_location(strong, file$2, 444, 4, 10294);
			add_location(p5, file$2, 443, 0, 10286);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 449, 0, 10403);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
