...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 127, 4, 3374);
			add_location(br1, file$2, 128, 4, 3383);
			add_location(br2, file$2, 132, 4, 3457);
			add_location(br3, file$2, 133, 4, 3466);
			add_location(br4, file$2, 137, 4, 3538);
			add_location(br5, file$2, 138, 4, 3547);
			add_location(br6, file$2, 142, 4, 3620);
			add_location(br7, file$2, 143, 4, 3629);
			add_location(br8, file$2, 147, 4, 3700);
			add_location(br9, file$2, 148, 4, 3709);
			add_location(br10, file$2, 152, 4, 3783);
			add_location(br11, file$2, 153, 4, 3792);
			add_location(br12, file$2, 157, 4, 3864);
			add_location(br13, file$2, 158, 4, 3873);
			add_location(br14, file$2, 162, 4, 3949);
			add_location(br15, file$2, 163, 4, 3958);
			add_location(br16, file$2, 167, 4, 4029);
			add_location(br17, file$2, 168, 4, 4038);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 44, 0, 773);
			attr_dev(div0, "class", "top-pic svelte-1jnnvri");
			add_location(div0, file$2, 48, 8, 840);
			attr_dev(li0, "class", "svelte-1jnnvri");
			add_location(li0, file$2, 69, 12, 1668);
			attr_dev(li1, "class", "svelte-1jnnvri");
			add_location(li1, file$2, 72, 12, 1788);
			attr_dev(li2, "class", "svelte-1jnnvri");
			add_location(li2, file$2, 75, 12, 1909);
			add_location(br1, file$2, 79, 16, 2052);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 90, 20, 2403);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 91, 20, 2443);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 92, 20, 2484);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 89, 16, 2351);
			attr_dev(li3, "class", "svelte-1jnnvri");
			add_location(li3, file$2, 78, 12, 2031);
			attr_dev(li4, "class", "svelte-1jnnvri");
			add_location(li4, file$2, 95, 12, 2564);
			attr_dev(ul0, "class", "options svelte-1jnnvri");
			add_location(ul0, file$2, 68, 8, 1635);
			attr_dev(section0, "class", "top svelte-1jnnvri");
			add_location(section0, file$2, 47, 4, 810);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file$2, 101, 4, 2707);
			add_location(span0, file$2, 105, 4, 2811);
			add_location(br2, file$2, 113, 4, 3095);
			add_location(br3, file$2, 114, 4, 3104);
			attr_dev(h10, "class", "svelte-1jnnvri");
			add_location(h10, file$2, 116, 4, 3114);
			add_location(br4, file$2, 118, 4, 3143);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 120, 4, 3153);
			attr_dev(section2, "class", "top-wrap svelte-1jnnvri");
			add_location(section2, file$2, 46, 0, 779);
			attr_dev(h11, "class", "svelte-1jnnvri");
			add_location(h11, file$2, 173, 0, 4108);
			add_location(br5, file$2, 175, 0, 4176);
			add_location(br6, file$2, 176, 0, 4181);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 178, 0, 4187);
			add_location(br7, file$2, 180, 0, 4229);
			add_location(br8, file$2, 181, 0, 4234);
			add_location(p1, file$2, 183, 0, 4240);
			add_location(p2, file$2, 184, 0, 4276);
			add_location(p3, file$2, 185, 0, 4320);
			add_location(br9, file$2, 187, 0, 4366);
			add_location(br10, file$2, 188, 0, 4371);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 190, 0, 4377);
			add_location(span1, file$2, 194, 8, 4451);
			add_location(li5, file$2, 193, 4, 4438);
			add_location(span2, file$2, 201, 8, 4685);
			add_location(li6, file$2, 200, 4, 4672);
			add_location(span3, file$2, 208, 8, 4880);
			add_location(li7, file$2, 207, 4, 4867);
			add_location(ul1, file$2, 192, 0, 4429);
			add_location(br11, file$2, 216, 0, 5098);
			add_location(br12, file$2, 217, 0, 5103);
			add_location(br13, file$2, 221, 8, 5210);
			add_location(br14, file$2, 223, 8, 5239);
			add_location(br15, file$2, 224, 8, 5252);
			add_location(br16, file$2, 226, 8, 5328);
			add_location(br17, file$2, 227, 8, 5341);
			add_location(br18, file$2, 229, 8, 5430);
			add_location(br19, file$2, 230, 8, 5443);
			add_location(br20, file$2, 232, 8, 5549);
			add_location(br21, file$2, 233, 8, 5562);
			add_location(br22, file$2, 237, 8, 5689);
			add_location(br23, file$2, 238, 8, 5702);
			add_location(br24, file$2, 240, 8, 5809);
			add_location(br25, file$2, 241, 8, 5822);
			add_location(br26, file$2, 243, 8, 5928);
			add_location(br27, file$2, 244, 8, 5941);
			add_location(div1, file$2, 220, 4, 5196);
			add_location(br28, file$2, 248, 8, 5976);
			add_location(br29, file$2, 250, 8, 6014);
			add_location(br30, file$2, 251, 8, 6027);
			add_location(br31, file$2, 253, 8, 6112);
			add_location(br32, file$2, 254, 8, 6125);
			add_location(br33, file$2, 256, 8, 6223);
			add_location(br34, file$2, 257, 8, 6236);
			add_location(br35, file$2, 259, 8, 6334);
			add_location(br36, file$2, 260, 8, 6347);
			add_location(br37, file$2, 264, 8, 6483);
			add_location(br38, file$2, 265, 8, 6496);
			add_location(br39, file$2, 267, 8, 6612);
			add_location(br40, file$2, 268, 8, 6625);
			add_location(br41, file$2, 270, 8, 6740);
			add_location(br42, file$2, 271, 8, 6753);
			add_location(div2, file$2, 247, 4, 5962);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 219, 0, 5109);
			add_location(br43, file$2, 275, 0, 6781);
			add_location(br44, file$2, 276, 0, 6786);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 278, 0, 6792);
			add_location(br45, file$2, 280, 0, 6835);
			add_location(br46, file$2, 281, 0, 6840);
			add_location(br47, file$2, 286, 4, 6905);
			add_location(br48, file$2, 287, 4, 6914);
			add_location(br49, file$2, 291, 4, 6997);
			add_location(br50, file$2, 292, 4, 7006);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 297, 8, 7095);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 298, 8, 7122);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 299, 8, 7149);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 296, 4, 7067);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 302, 4, 7189);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 303, 4, 7247);
			add_location(br51, file$2, 305, 4, 7296);
			add_location(br52, file$2, 306, 4, 7305);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 308, 4, 7315);
			add_location(br53, file$2, 310, 4, 7367);
			add_location(br54, file$2, 311, 4, 7376);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 313, 4, 7386);
			add_location(section4, file$2, 283, 0, 6846);
			add_location(br55, file$2, 316, 0, 7462);
			add_location(br56, file$2, 317, 0, 7467);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 319, 0, 7473);
			add_location(br57, file$2, 325, 0, 7597);
			add_location(br58, file$2, 326, 0, 7602);
			add_location(br59, file$2, 330, 0, 7674);
			add_location(br60, file$2, 331, 0, 7679);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 333, 0, 7685);
			add_location(strong, file$2, 336, 4, 7730);
			add_location(p4, file$2, 335, 0, 7722);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 341, 0, 7839);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
