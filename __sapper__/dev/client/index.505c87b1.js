...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(use, "class", "ico_use svelte-18w1ohr");
			add_location(use, file, 22, 4, 580);
			set_svg_attributes(svg, svg_data);
			toggle_class(svg, "svelte-18w1ohr", true);
