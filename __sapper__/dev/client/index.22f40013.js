...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$8, 43, 8, 1337);
			attr_dev(div1, "class", "progress-inner-frame svelte-1kjumgy");
			add_location(div1, file$8, 42, 4, 1294);
			...
			add_location(div2, file$8, 31, 0, 1023);
		},
		m: function mount(target, anchor) {
...
function getBorderRadius(borders, defaults) {
	const brDefault = new Array(4).fill(defaults || 0);
