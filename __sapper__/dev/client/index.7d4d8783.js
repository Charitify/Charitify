...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 128, 4, 3507);
			add_location(br1, file$2, 129, 4, 3516);
			add_location(br2, file$2, 133, 4, 3590);
			add_location(br3, file$2, 134, 4, 3599);
			add_location(br4, file$2, 138, 4, 3671);
			add_location(br5, file$2, 139, 4, 3680);
			add_location(br6, file$2, 143, 4, 3753);
			add_location(br7, file$2, 144, 4, 3762);
			add_location(br8, file$2, 148, 4, 3833);
			add_location(br9, file$2, 149, 4, 3842);
			add_location(br10, file$2, 153, 4, 3916);
			add_location(br11, file$2, 154, 4, 3925);
			add_location(br12, file$2, 158, 4, 3997);
			add_location(br13, file$2, 159, 4, 4006);
			add_location(br14, file$2, 163, 4, 4082);
			add_location(br15, file$2, 164, 4, 4091);
			add_location(br16, file$2, 168, 4, 4162);
			add_location(br17, file$2, 169, 4, 4171);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 45, 0, 894);
			attr_dev(div0, "class", "top-pic main-shadow svelte-ovvjc8");
			add_location(div0, file$2, 49, 8, 961);
			attr_dev(li0, "class", "svelte-ovvjc8");
			add_location(li0, file$2, 70, 12, 1801);
			attr_dev(li1, "class", "svelte-ovvjc8");
			add_location(li1, file$2, 73, 12, 1921);
			attr_dev(li2, "class", "svelte-ovvjc8");
			add_location(li2, file$2, 76, 12, 2042);
			add_location(br1, file$2, 80, 16, 2185);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 91, 20, 2536);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 92, 20, 2576);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 93, 20, 2617);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 90, 16, 2484);
			attr_dev(li3, "class", "svelte-ovvjc8");
			add_location(li3, file$2, 79, 12, 2164);
			attr_dev(li4, "class", "svelte-ovvjc8");
			add_location(li4, file$2, 96, 12, 2697);
			attr_dev(ul0, "class", "options svelte-ovvjc8");
			add_location(ul0, file$2, 69, 8, 1768);
			attr_dev(section0, "class", "top svelte-ovvjc8");
			add_location(section0, file$2, 48, 4, 931);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file$2, 102, 4, 2840);
			add_location(span0, file$2, 106, 4, 2944);
			add_location(br2, file$2, 114, 4, 3228);
			add_location(br3, file$2, 115, 4, 3237);
			attr_dev(h10, "class", "svelte-ovvjc8");
			add_location(h10, file$2, 117, 4, 3247);
			add_location(br4, file$2, 119, 4, 3276);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 121, 4, 3286);
			attr_dev(section2, "class", "top-wrap svelte-ovvjc8");
			add_location(section2, file$2, 47, 0, 900);
			attr_dev(h11, "class", "svelte-ovvjc8");
			add_location(h11, file$2, 174, 0, 4241);
			add_location(br5, file$2, 176, 0, 4309);
			add_location(br6, file$2, 177, 0, 4314);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 179, 0, 4320);
			add_location(br7, file$2, 181, 0, 4362);
			add_location(br8, file$2, 182, 0, 4367);
			add_location(p1, file$2, 184, 0, 4373);
			add_location(p2, file$2, 185, 0, 4409);
			add_location(p3, file$2, 186, 0, 4453);
			add_location(br9, file$2, 188, 0, 4499);
			add_location(br10, file$2, 189, 0, 4504);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 191, 0, 4510);
			add_location(span1, file$2, 195, 8, 4584);
			add_location(li5, file$2, 194, 4, 4571);
			add_location(span2, file$2, 202, 8, 4818);
			add_location(li6, file$2, 201, 4, 4805);
			add_location(span3, file$2, 209, 8, 5013);
			add_location(li7, file$2, 208, 4, 5000);
			add_location(ul1, file$2, 193, 0, 4562);
			add_location(br11, file$2, 217, 0, 5231);
			add_location(br12, file$2, 218, 0, 5236);
			add_location(br13, file$2, 222, 8, 5343);
			add_location(br14, file$2, 224, 8, 5372);
			add_location(br15, file$2, 225, 8, 5385);
			add_location(br16, file$2, 227, 8, 5461);
			add_location(br17, file$2, 228, 8, 5474);
			add_location(br18, file$2, 230, 8, 5563);
			add_location(br19, file$2, 231, 8, 5576);
			add_location(br20, file$2, 233, 8, 5682);
			add_location(br21, file$2, 234, 8, 5695);
			add_location(br22, file$2, 238, 8, 5822);
			add_location(br23, file$2, 239, 8, 5835);
			add_location(br24, file$2, 241, 8, 5942);
			add_location(br25, file$2, 242, 8, 5955);
			add_location(br26, file$2, 244, 8, 6061);
			add_location(br27, file$2, 245, 8, 6074);
			add_location(div1, file$2, 221, 4, 5329);
			add_location(br28, file$2, 249, 8, 6109);
			add_location(br29, file$2, 251, 8, 6147);
			add_location(br30, file$2, 252, 8, 6160);
			add_location(br31, file$2, 254, 8, 6245);
			add_location(br32, file$2, 255, 8, 6258);
			add_location(br33, file$2, 257, 8, 6356);
			add_location(br34, file$2, 258, 8, 6369);
			add_location(br35, file$2, 260, 8, 6467);
			add_location(br36, file$2, 261, 8, 6480);
			add_location(br37, file$2, 265, 8, 6616);
			add_location(br38, file$2, 266, 8, 6629);
			add_location(br39, file$2, 268, 8, 6745);
			add_location(br40, file$2, 269, 8, 6758);
			add_location(br41, file$2, 271, 8, 6873);
			add_location(br42, file$2, 272, 8, 6886);
			add_location(div2, file$2, 248, 4, 6095);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 220, 0, 5242);
			add_location(br43, file$2, 276, 0, 6914);
			add_location(br44, file$2, 277, 0, 6919);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 279, 0, 6925);
			add_location(br45, file$2, 281, 0, 6968);
			add_location(br46, file$2, 282, 0, 6973);
			add_location(br47, file$2, 287, 4, 7038);
			add_location(br48, file$2, 288, 4, 7047);
			add_location(br49, file$2, 292, 4, 7130);
			add_location(br50, file$2, 293, 4, 7139);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 298, 8, 7228);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 299, 8, 7255);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 300, 8, 7282);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 297, 4, 7200);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 303, 4, 7322);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 304, 4, 7380);
			add_location(br51, file$2, 306, 4, 7429);
			add_location(br52, file$2, 307, 4, 7438);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 309, 4, 7448);
			add_location(br53, file$2, 311, 4, 7500);
			add_location(br54, file$2, 312, 4, 7509);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 314, 4, 7519);
			add_location(section4, file$2, 284, 0, 6979);
			add_location(br55, file$2, 317, 0, 7595);
			add_location(br56, file$2, 318, 0, 7600);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 320, 0, 7606);
			add_location(br57, file$2, 326, 0, 7730);
			add_location(br58, file$2, 327, 0, 7735);
			add_location(br59, file$2, 331, 0, 7807);
			add_location(br60, file$2, 332, 0, 7812);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 334, 0, 7818);
			add_location(strong, file$2, 337, 4, 7863);
			add_location(p4, file$2, 336, 0, 7855);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 342, 0, 7972);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
