...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t31 = claim_text(h60_nodes, "Main title 6");
			...
			h61 = claim_element(nodes, "H6", { style: true });
			var h61_nodes = children(h61);
			t34 = claim_text(h61_nodes, "Main title 6");
			h61_nodes.forEach(detach_dev);
			span11 = claim_element(nodes, "SPAN", {});
			var span11_nodes = children(span11);
			t35 = claim_text(span11_nodes, "with text");
		...
		h: function hydrate() {
			...
			set_style(h51, "font-size", ".825em");
			add_location(h51, file, 71, 0, 2427);
			add_location(span9, file, 71, 47, 2474);
			add_location(h60, file, 72, 0, 2497);
			add_location(span10, file, 72, 21, 2518);
			set_style(h61, "font-size", ".675em");
			add_location(h61, file, 73, 0, 2541);
			add_location(span11, file, 73, 47, 2588);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 75, 0, 2612);
			attr_dev(section, "class", "container");
			add_location(section, file, 79, 0, 2667);
		},
