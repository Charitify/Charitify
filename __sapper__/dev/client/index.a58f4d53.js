...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(option0, file$8, 28, 16, 976);
			option1.__value = "ru";
			option1.value = option1.__value;
			add_location(option1, file$8, 29, 16, 1023);
			option2.__value = "en";
			option2.value = option2.__value;
			add_location(option2, file$8, 30, 16, 1070);
			attr_dev(select, "name", "lang");
			attr_dev(select, "id", "lang");
			attr_dev(select, "class", "btn small lang-select svelte-iotsi1");
			add_location(select, file$8, 27, 12, 891);
			attr_dev(li4, "class", "svelte-iotsi1");
			add_location(li4, file$8, 26, 8, 874);
			attr_dev(li5, "class", "svelte-iotsi1");
			add_location(li5, file$8, 34, 8, 1146);
			attr_dev(li6, "class", "svelte-iotsi1");
			add_location(li6, file$8, 40, 8, 1317);
			attr_dev(ul1, "class", "nav-actions svelte-iotsi1");
			add_location(ul1, file$8, 25, 4, 841);
