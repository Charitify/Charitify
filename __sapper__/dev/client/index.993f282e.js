...
// (171:16) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_16(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(171:16) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (174:16) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_15(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(174:16) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (194:16) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_14(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(194:16) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-18j5852");
			add_location(li, file, 238, 12, 6297);
		},
		m: function mount(target, anchor) {
...
// (297:4) <Button is="success" type="submit">
function create_default_slot_13(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(297:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (253:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 253, 4, 6484);
			add_location(br1, file, 254, 4, 6493);
			add_location(br2, file, 258, 4, 6567);
			add_location(br3, file, 259, 4, 6576);
			add_location(br4, file, 263, 4, 6648);
			add_location(br5, file, 264, 4, 6657);
			add_location(br6, file, 268, 4, 6730);
			add_location(br7, file, 269, 4, 6739);
			add_location(br8, file, 273, 4, 6810);
			add_location(br9, file, 274, 4, 6819);
			add_location(br10, file, 278, 4, 6893);
			add_location(br11, file, 279, 4, 6902);
			add_location(br12, file, 283, 4, 6974);
			add_location(br13, file, 284, 4, 6983);
			add_location(br14, file, 288, 4, 7059);
			add_location(br15, file, 289, 4, 7068);
			add_location(br16, file, 293, 4, 7139);
			add_location(br17, file, 294, 4, 7148);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(253:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (352:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(352:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (358:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(358:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (366:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(366:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (369:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(369:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (379:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(379:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (393:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(393:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (396:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(396:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-18j5852");
			add_location(div0, file, 145, 8, 3596);
			attr_dev(li0, "class", "svelte-18j5852");
			add_location(li0, file, 166, 12, 4424);
			attr_dev(li1, "class", "svelte-18j5852");
			add_location(li1, file, 169, 12, 4544);
			attr_dev(li2, "class", "svelte-18j5852");
			add_location(li2, file, 172, 12, 4665);
			add_location(br0, file, 176, 16, 4808);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 187, 20, 5159);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 188, 20, 5199);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 189, 20, 5240);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 186, 16, 5107);
			attr_dev(li3, "class", "svelte-18j5852");
			add_location(li3, file, 175, 12, 4787);
			attr_dev(li4, "class", "svelte-18j5852");
			add_location(li4, file, 192, 12, 5320);
			attr_dev(ul0, "class", "options svelte-18j5852");
			add_location(ul0, file, 165, 8, 4391);
			attr_dev(section0, "class", "top svelte-18j5852");
			add_location(section0, file, 144, 4, 3566);
			add_location(br1, file, 199, 4, 5500);
			attr_dev(h3, "class", "svelte-18j5852");
			add_location(h3, file, 207, 16, 5733);
			attr_dev(p0, "class", "svelte-18j5852");
			add_location(p0, file, 208, 16, 5773);
			attr_dev(span0, "class", "svelte-18j5852");
			add_location(span0, file, 206, 12, 5710);
			attr_dev(div1, "class", "ava-section svelte-18j5852");
			add_location(div1, file, 203, 8, 5594);
			attr_dev(section1, "class", "rate-section svelte-18j5852");
			add_location(section1, file, 202, 4, 5555);
			add_location(br2, file, 215, 4, 5874);
			attr_dev(h10, "class", "svelte-18j5852");
			add_location(h10, file, 217, 4, 5884);
			add_location(br3, file, 219, 4, 5913);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 221, 4, 5923);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 143, 0, 3534);
			add_location(br4, file, 226, 0, 6079);
			add_location(br5, file, 227, 0, 6084);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 231, 4, 6143);
			add_location(br6, file, 234, 4, 6226);
			attr_dev(ul1, "class", "cards svelte-18j5852");
			add_location(ul1, file, 236, 4, 6236);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 229, 0, 6090);
			add_location(br7, file, 246, 0, 6396);
			add_location(br8, file, 247, 0, 6401);
			attr_dev(h11, "class", "svelte-18j5852");
			add_location(h11, file, 299, 0, 7218);
			add_location(br9, file, 301, 0, 7286);
			add_location(br10, file, 302, 0, 7291);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 304, 0, 7297);
			add_location(br11, file, 306, 0, 7339);
			add_location(br12, file, 307, 0, 7344);
			add_location(p2, file, 309, 0, 7350);
			add_location(p3, file, 310, 0, 7386);
			add_location(p4, file, 311, 0, 7430);
			add_location(br13, file, 313, 0, 7476);
			add_location(br14, file, 314, 0, 7481);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 316, 0, 7487);
			add_location(span1, file, 320, 8, 7561);
			add_location(li5, file, 319, 4, 7548);
			add_location(span2, file, 327, 8, 7795);
			add_location(li6, file, 326, 4, 7782);
			add_location(span3, file, 334, 8, 7990);
			add_location(li7, file, 333, 4, 7977);
			add_location(ul2, file, 318, 0, 7539);
			add_location(br15, file, 342, 0, 8208);
			add_location(br16, file, 343, 0, 8213);
			add_location(br17, file, 347, 8, 8320);
			add_location(br18, file, 349, 8, 8349);
			add_location(br19, file, 350, 8, 8362);
			add_location(br20, file, 352, 8, 8438);
			add_location(br21, file, 353, 8, 8451);
			add_location(br22, file, 355, 8, 8540);
			add_location(br23, file, 356, 8, 8553);
			add_location(br24, file, 358, 8, 8659);
			add_location(br25, file, 359, 8, 8672);
			add_location(br26, file, 363, 8, 8799);
			add_location(br27, file, 364, 8, 8812);
			add_location(br28, file, 366, 8, 8919);
			add_location(br29, file, 367, 8, 8932);
			add_location(br30, file, 369, 8, 9038);
			add_location(br31, file, 370, 8, 9051);
			add_location(div3, file, 346, 4, 8306);
			add_location(br32, file, 374, 8, 9086);
			add_location(br33, file, 376, 8, 9124);
			add_location(br34, file, 377, 8, 9137);
			add_location(br35, file, 379, 8, 9222);
			add_location(br36, file, 380, 8, 9235);
			add_location(br37, file, 382, 8, 9333);
			add_location(br38, file, 383, 8, 9346);
			add_location(br39, file, 385, 8, 9444);
			add_location(br40, file, 386, 8, 9457);
			add_location(br41, file, 390, 8, 9593);
			add_location(br42, file, 391, 8, 9606);
			add_location(br43, file, 393, 8, 9722);
			add_location(br44, file, 394, 8, 9735);
			add_location(br45, file, 396, 8, 9850);
			add_location(br46, file, 397, 8, 9863);
			add_location(div4, file, 373, 4, 9072);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 345, 0, 8219);
			add_location(br47, file, 401, 0, 9891);
			add_location(br48, file, 402, 0, 9896);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 404, 0, 9902);
			add_location(br49, file, 406, 0, 9945);
			add_location(br50, file, 407, 0, 9950);
			add_location(br51, file, 412, 4, 10015);
			add_location(br52, file, 413, 4, 10024);
			add_location(br53, file, 417, 4, 10107);
			add_location(br54, file, 418, 4, 10116);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 423, 8, 10205);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 424, 8, 10232);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 425, 8, 10259);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 422, 4, 10177);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 428, 4, 10299);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 429, 4, 10357);
			add_location(br55, file, 431, 4, 10406);
			add_location(br56, file, 432, 4, 10415);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 434, 4, 10425);
			add_location(br57, file, 436, 4, 10477);
			add_location(br58, file, 437, 4, 10486);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 439, 4, 10496);
			add_location(section4, file, 409, 0, 9956);
			add_location(br59, file, 442, 0, 10572);
			add_location(br60, file, 443, 0, 10577);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 445, 0, 10583);
			add_location(br61, file, 447, 0, 10618);
			add_location(br62, file, 448, 0, 10623);
			add_location(br63, file, 452, 0, 10695);
			add_location(br64, file, 453, 0, 10700);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 455, 0, 10706);
			add_location(strong, file, 458, 4, 10751);
			add_location(p5, file, 457, 0, 10743);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 463, 0, 10860);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
