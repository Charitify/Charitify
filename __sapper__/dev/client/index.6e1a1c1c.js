...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div, "class", "progress-core svelte-tnudzz");
...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-inner-frame svelte-tnudzz");
			add_location(div0, file$8, 33, 4, 916);
			attr_dev(div1, "id", /*id*/ ctx[0]);
			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-tnudzz"));
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 16 && div1_class_value !== (div1_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-tnudzz"))) {
