...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(section, "class", "carousel svelte-zim3vn");
...
function create_fragment$c(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h5, "class", "svelte-2mt2xv");
			add_location(h5, file$c, 12, 8, 252);
			attr_dev(h6, "class", "svelte-2mt2xv");
			add_location(h6, file$c, 13, 8, 277);
			attr_dev(span, "class", "svelte-2mt2xv");
			add_location(span, file$c, 11, 4, 237);
			attr_dev(section, "class", "ava-with-name svelte-2mt2xv");
...
function create_fragment$d(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$d, 14, 4, 415);
			attr_dev(h4, "class", "svelte-do16pj");
			add_location(h4, file$d, 20, 4, 542);
			attr_dev(div1, "class", "rate-wrap svelte-do16pj");
			add_location(div1, file$d, 22, 4, 564);
			add_location(footer, file$d, 26, 4, 633);
			attr_dev(div2, "class", "card svelte-do16pj");
			add_location(div2, file$d, 13, 0, 392);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div2, anchor);
...
function create_fragment$f(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			h4 = claim_element(section_nodes, "H4", {});
			var h4_nodes = children(h4);
			t3 = claim_text(h4_nodes, "A small description that describes the title above and just makes text longer.");
			h4_nodes.forEach(detach_dev);
			section_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			add_location(h1, file$f, 5, 4, 49);
			add_location(br, file$f, 7, 4, 104);
			add_location(h4, file$f, 9, 4, 114);
			attr_dev(section, "class", "title svelte-31vbg2");
...
function create_fragment$g(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li0, "class", "svelte-115iut2");
			add_location(li0, file$g, 5, 4, 95);
			attr_dev(li1, "class", "svelte-115iut2");
			add_location(li1, file$g, 8, 4, 191);
			attr_dev(li2, "class", "svelte-115iut2");
			add_location(li2, file$g, 11, 4, 288);
			add_location(br, file$g, 15, 8, 399);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$g, 26, 12, 670);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$g, 27, 12, 702);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$g, 28, 12, 735);
			attr_dev(datalist, "id", "sum-suggestions");
			add_location(datalist, file$g, 25, 8, 626);
			attr_dev(li3, "class", "svelte-115iut2");
			add_location(li3, file$g, 14, 4, 386);
			attr_dev(li4, "class", "svelte-115iut2");
			add_location(li4, file$g, 31, 4, 791);
			attr_dev(ul, "class", "options svelte-115iut2");
