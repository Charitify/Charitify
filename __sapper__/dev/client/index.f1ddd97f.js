...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 127, 4, 3389);
			add_location(br1, file$2, 128, 4, 3398);
			add_location(br2, file$2, 132, 4, 3472);
			add_location(br3, file$2, 133, 4, 3481);
			add_location(br4, file$2, 137, 4, 3553);
			add_location(br5, file$2, 138, 4, 3562);
			add_location(br6, file$2, 142, 4, 3635);
			add_location(br7, file$2, 143, 4, 3644);
			add_location(br8, file$2, 147, 4, 3715);
			add_location(br9, file$2, 148, 4, 3724);
			add_location(br10, file$2, 152, 4, 3798);
			add_location(br11, file$2, 153, 4, 3807);
			add_location(br12, file$2, 157, 4, 3879);
			add_location(br13, file$2, 158, 4, 3888);
			add_location(br14, file$2, 162, 4, 3964);
			add_location(br15, file$2, 163, 4, 3973);
			add_location(br16, file$2, 167, 4, 4044);
			add_location(br17, file$2, 168, 4, 4053);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 44, 0, 776);
			attr_dev(div0, "class", "top-pic main-shadow svelte-9rktio");
			add_location(div0, file$2, 48, 8, 843);
			attr_dev(li0, "class", "svelte-9rktio");
			add_location(li0, file$2, 69, 12, 1683);
			attr_dev(li1, "class", "svelte-9rktio");
			add_location(li1, file$2, 72, 12, 1803);
			attr_dev(li2, "class", "svelte-9rktio");
			add_location(li2, file$2, 75, 12, 1924);
			add_location(br1, file$2, 79, 16, 2067);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 90, 20, 2418);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 91, 20, 2458);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 92, 20, 2499);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 89, 16, 2366);
			attr_dev(li3, "class", "svelte-9rktio");
			add_location(li3, file$2, 78, 12, 2046);
			attr_dev(li4, "class", "svelte-9rktio");
			add_location(li4, file$2, 95, 12, 2579);
			attr_dev(ul0, "class", "options svelte-9rktio");
			add_location(ul0, file$2, 68, 8, 1650);
			attr_dev(section0, "class", "top svelte-9rktio");
			add_location(section0, file$2, 47, 4, 813);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file$2, 101, 4, 2722);
			add_location(span0, file$2, 105, 4, 2826);
			add_location(br2, file$2, 113, 4, 3110);
			add_location(br3, file$2, 114, 4, 3119);
			attr_dev(h10, "class", "svelte-9rktio");
			add_location(h10, file$2, 116, 4, 3129);
			add_location(br4, file$2, 118, 4, 3158);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 120, 4, 3168);
			attr_dev(section2, "class", "top-wrap svelte-9rktio");
			add_location(section2, file$2, 46, 0, 782);
			attr_dev(h11, "class", "svelte-9rktio");
			add_location(h11, file$2, 173, 0, 4123);
			add_location(br5, file$2, 175, 0, 4191);
			add_location(br6, file$2, 176, 0, 4196);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 178, 0, 4202);
			add_location(br7, file$2, 180, 0, 4244);
			add_location(br8, file$2, 181, 0, 4249);
			add_location(p1, file$2, 183, 0, 4255);
			add_location(p2, file$2, 184, 0, 4291);
			add_location(p3, file$2, 185, 0, 4335);
			add_location(br9, file$2, 187, 0, 4381);
			add_location(br10, file$2, 188, 0, 4386);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 190, 0, 4392);
			add_location(span1, file$2, 194, 8, 4466);
			add_location(li5, file$2, 193, 4, 4453);
			add_location(span2, file$2, 201, 8, 4700);
			add_location(li6, file$2, 200, 4, 4687);
			add_location(span3, file$2, 208, 8, 4895);
			add_location(li7, file$2, 207, 4, 4882);
			add_location(ul1, file$2, 192, 0, 4444);
			add_location(br11, file$2, 216, 0, 5113);
			add_location(br12, file$2, 217, 0, 5118);
			add_location(br13, file$2, 221, 8, 5225);
			add_location(br14, file$2, 223, 8, 5254);
			add_location(br15, file$2, 224, 8, 5267);
			add_location(br16, file$2, 226, 8, 5343);
			add_location(br17, file$2, 227, 8, 5356);
			add_location(br18, file$2, 229, 8, 5445);
			add_location(br19, file$2, 230, 8, 5458);
			add_location(br20, file$2, 232, 8, 5564);
			add_location(br21, file$2, 233, 8, 5577);
			add_location(br22, file$2, 237, 8, 5704);
			add_location(br23, file$2, 238, 8, 5717);
			add_location(br24, file$2, 240, 8, 5824);
			add_location(br25, file$2, 241, 8, 5837);
			add_location(br26, file$2, 243, 8, 5943);
			add_location(br27, file$2, 244, 8, 5956);
			add_location(div1, file$2, 220, 4, 5211);
			add_location(br28, file$2, 248, 8, 5991);
			add_location(br29, file$2, 250, 8, 6029);
			add_location(br30, file$2, 251, 8, 6042);
			add_location(br31, file$2, 253, 8, 6127);
			add_location(br32, file$2, 254, 8, 6140);
			add_location(br33, file$2, 256, 8, 6238);
			add_location(br34, file$2, 257, 8, 6251);
			add_location(br35, file$2, 259, 8, 6349);
			add_location(br36, file$2, 260, 8, 6362);
			add_location(br37, file$2, 264, 8, 6498);
			add_location(br38, file$2, 265, 8, 6511);
			add_location(br39, file$2, 267, 8, 6627);
			add_location(br40, file$2, 268, 8, 6640);
			add_location(br41, file$2, 270, 8, 6755);
			add_location(br42, file$2, 271, 8, 6768);
			add_location(div2, file$2, 247, 4, 5977);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 219, 0, 5124);
			add_location(br43, file$2, 275, 0, 6796);
			add_location(br44, file$2, 276, 0, 6801);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 278, 0, 6807);
			add_location(br45, file$2, 280, 0, 6850);
			add_location(br46, file$2, 281, 0, 6855);
			add_location(br47, file$2, 286, 4, 6920);
			add_location(br48, file$2, 287, 4, 6929);
			add_location(br49, file$2, 291, 4, 7012);
			add_location(br50, file$2, 292, 4, 7021);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 297, 8, 7110);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 298, 8, 7137);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 299, 8, 7164);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 296, 4, 7082);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 302, 4, 7204);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 303, 4, 7262);
			add_location(br51, file$2, 305, 4, 7311);
			add_location(br52, file$2, 306, 4, 7320);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 308, 4, 7330);
			add_location(br53, file$2, 310, 4, 7382);
			add_location(br54, file$2, 311, 4, 7391);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 313, 4, 7401);
			add_location(section4, file$2, 283, 0, 6861);
			add_location(br55, file$2, 316, 0, 7477);
			add_location(br56, file$2, 317, 0, 7482);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 319, 0, 7488);
			add_location(br57, file$2, 325, 0, 7612);
			add_location(br58, file$2, 326, 0, 7617);
			add_location(br59, file$2, 330, 0, 7689);
			add_location(br60, file$2, 331, 0, 7694);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 333, 0, 7700);
			add_location(strong, file$2, 336, 4, 7745);
			add_location(p4, file$2, 335, 0, 7737);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 341, 0, 7854);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
