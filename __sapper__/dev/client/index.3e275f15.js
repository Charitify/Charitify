...
// (150:4) <Button is="success" type="submit">
function create_default_slot_14(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(150:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (106:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 106, 4, 2556);
			add_location(br1, file, 107, 4, 2565);
			add_location(br2, file, 111, 4, 2639);
			add_location(br3, file, 112, 4, 2648);
			add_location(br4, file, 116, 4, 2720);
			add_location(br5, file, 117, 4, 2729);
			add_location(br6, file, 121, 4, 2802);
			add_location(br7, file, 122, 4, 2811);
			add_location(br8, file, 126, 4, 2882);
			add_location(br9, file, 127, 4, 2891);
			add_location(br10, file, 131, 4, 2965);
			add_location(br11, file, 132, 4, 2974);
			add_location(br12, file, 136, 4, 3046);
			add_location(br13, file, 137, 4, 3055);
			add_location(br14, file, 141, 4, 3131);
			add_location(br15, file, 142, 4, 3140);
			add_location(br16, file, 146, 4, 3211);
			add_location(br17, file, 147, 4, 3220);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(106:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (205:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_12(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(205:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (208:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(208:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (211:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(211:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (215:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(215:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (219:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(219:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (222:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(222:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (232:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(232:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (235:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(235:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (238:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(238:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (242:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(242:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (246:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(246:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (249:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(249:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (301:0) <Picture alt="Borat" src="great-success.png" class="picture">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(301:0) <Picture alt=\\\"Borat\\\" src=\\\"great-success.png\\\" class=\\\"picture\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br4, file, 99, 4, 2363);
			attr_dev(p0, "class", "text-center");
			add_location(p0, file, 101, 4, 2373);
			attr_dev(section2, "class", "top-wrap svelte-omfi2y");
			add_location(section2, file, 42, 0, 674);
			attr_dev(h11, "class", "svelte-omfi2y");
			add_location(h11, file, 152, 0, 3290);
			add_location(br5, file, 154, 0, 3358);
			add_location(br6, file, 155, 0, 3363);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 157, 0, 3369);
			add_location(br7, file, 159, 0, 3411);
			add_location(br8, file, 160, 0, 3416);
			add_location(p1, file, 162, 0, 3422);
			add_location(p2, file, 163, 0, 3458);
			add_location(p3, file, 164, 0, 3502);
			add_location(br9, file, 166, 0, 3548);
			add_location(br10, file, 167, 0, 3553);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 169, 0, 3559);
			add_location(span1, file, 173, 8, 3633);
			add_location(li5, file, 172, 4, 3620);
			add_location(span2, file, 180, 8, 3867);
			add_location(li6, file, 179, 4, 3854);
			add_location(span3, file, 187, 8, 4062);
			add_location(li7, file, 186, 4, 4049);
			add_location(ul1, file, 171, 0, 3611);
			add_location(br11, file, 195, 0, 4280);
			add_location(br12, file, 196, 0, 4285);
			add_location(br13, file, 200, 8, 4392);
			add_location(br14, file, 202, 8, 4421);
			add_location(br15, file, 203, 8, 4434);
			add_location(br16, file, 205, 8, 4510);
			add_location(br17, file, 206, 8, 4523);
			add_location(br18, file, 208, 8, 4612);
			add_location(br19, file, 209, 8, 4625);
			add_location(br20, file, 211, 8, 4731);
			add_location(br21, file, 212, 8, 4744);
			add_location(br22, file, 216, 8, 4871);
			add_location(br23, file, 217, 8, 4884);
			add_location(br24, file, 219, 8, 4991);
			add_location(br25, file, 220, 8, 5004);
			add_location(br26, file, 222, 8, 5110);
			add_location(br27, file, 223, 8, 5123);
			add_location(div1, file, 199, 4, 4378);
			add_location(br28, file, 227, 8, 5158);
			add_location(br29, file, 229, 8, 5196);
			add_location(br30, file, 230, 8, 5209);
			add_location(br31, file, 232, 8, 5294);
			add_location(br32, file, 233, 8, 5307);
			add_location(br33, file, 235, 8, 5405);
			add_location(br34, file, 236, 8, 5418);
			add_location(br35, file, 238, 8, 5516);
			add_location(br36, file, 239, 8, 5529);
			add_location(br37, file, 243, 8, 5665);
			add_location(br38, file, 244, 8, 5678);
			add_location(br39, file, 246, 8, 5794);
			add_location(br40, file, 247, 8, 5807);
			add_location(br41, file, 249, 8, 5922);
			add_location(br42, file, 250, 8, 5935);
			add_location(div2, file, 226, 4, 5144);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 198, 0, 4291);
			add_location(br43, file, 254, 0, 5963);
			add_location(br44, file, 255, 0, 5968);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 257, 0, 5974);
			add_location(br45, file, 259, 0, 6017);
			add_location(br46, file, 260, 0, 6022);
			add_location(br47, file, 265, 4, 6087);
			add_location(br48, file, 266, 4, 6096);
			add_location(br49, file, 270, 4, 6179);
			add_location(br50, file, 271, 4, 6188);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 276, 8, 6277);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 277, 8, 6304);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 278, 8, 6331);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 275, 4, 6249);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 281, 4, 6371);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 282, 4, 6429);
			add_location(br51, file, 284, 4, 6478);
			add_location(br52, file, 285, 4, 6487);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 287, 4, 6497);
			add_location(br53, file, 289, 4, 6549);
			add_location(br54, file, 290, 4, 6558);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 292, 4, 6568);
			add_location(section4, file, 262, 0, 6028);
			add_location(br55, file, 295, 0, 6644);
			add_location(br56, file, 296, 0, 6649);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 298, 0, 6655);
			add_location(br57, file, 304, 0, 6779);
			add_location(br58, file, 305, 0, 6784);
			add_location(br59, file, 309, 0, 6856);
			add_location(br60, file, 310, 0, 6861);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 312, 0, 6867);
			add_location(strong, file, 315, 4, 6912);
			add_location(p4, file, 314, 0, 6904);
			set_style(p5, "text-align", "justify");
			add_location(p5, file, 320, 0, 7021);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
