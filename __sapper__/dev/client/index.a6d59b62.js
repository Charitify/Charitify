...
function create_fragment$c(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-crb7w8");
			add_location(h4, file$c, 12, 8, 230);
			attr_dev(p, "class", "svelte-crb7w8");
			add_location(p, file$c, 13, 8, 255);
			attr_dev(span, "class", "svelte-crb7w8");
			add_location(span, file$c, 11, 4, 215);
			attr_dev(section, "class", "svelte-crb7w8");
