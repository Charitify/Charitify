...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 122, 4, 3390);
			add_location(br1, file$2, 123, 4, 3399);
			add_location(br2, file$2, 127, 4, 3473);
			add_location(br3, file$2, 128, 4, 3482);
			add_location(br4, file$2, 132, 4, 3554);
			add_location(br5, file$2, 133, 4, 3563);
			add_location(br6, file$2, 137, 4, 3636);
			add_location(br7, file$2, 138, 4, 3645);
			add_location(br8, file$2, 142, 4, 3716);
			add_location(br9, file$2, 143, 4, 3725);
			add_location(br10, file$2, 147, 4, 3799);
			add_location(br11, file$2, 148, 4, 3808);
			add_location(br12, file$2, 152, 4, 3880);
			add_location(br13, file$2, 153, 4, 3889);
			add_location(br14, file$2, 157, 4, 3965);
			add_location(br15, file$2, 158, 4, 3974);
			add_location(br16, file$2, 162, 4, 4045);
			add_location(br17, file$2, 163, 4, 4054);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br0, file$2, 41, 0, 842);
			attr_dev(div0, "class", "top-pic main-shadow svelte-g87fnk");
			add_location(div0, file$2, 45, 8, 910);
			attr_dev(li0, "class", "svelte-g87fnk");
			add_location(li0, file$2, 66, 12, 1750);
			attr_dev(li1, "class", "svelte-g87fnk");
			add_location(li1, file$2, 69, 12, 1870);
			attr_dev(li2, "class", "svelte-g87fnk");
			add_location(li2, file$2, 72, 12, 1991);
			add_location(br1, file$2, 76, 16, 2134);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 87, 20, 2485);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 88, 20, 2525);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 89, 20, 2566);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 86, 16, 2433);
			attr_dev(li3, "class", "svelte-g87fnk");
			add_location(li3, file$2, 75, 12, 2113);
			attr_dev(li4, "class", "svelte-g87fnk");
			add_location(li4, file$2, 92, 12, 2646);
			attr_dev(ul0, "class", "options svelte-g87fnk");
			add_location(ul0, file$2, 65, 8, 1717);
			attr_dev(section0, "class", "top svelte-g87fnk");
			add_location(section0, file$2, 44, 4, 880);
			add_location(span0, file$2, 100, 4, 2827);
			add_location(br2, file$2, 108, 4, 3111);
			add_location(br3, file$2, 109, 4, 3120);
			attr_dev(h10, "class", "svelte-g87fnk");
			add_location(h10, file$2, 111, 4, 3130);
			add_location(br4, file$2, 113, 4, 3159);
			attr_dev(p0, "class", "text-center");
			set_style(p0, "padding", "0 10vw");
			add_location(p0, file$2, 115, 4, 3169);
			attr_dev(section1, "class", "container");
			add_location(section1, file$2, 43, 0, 848);
			attr_dev(h11, "class", "svelte-g87fnk");
			add_location(h11, file$2, 168, 0, 4124);
			add_location(br5, file$2, 170, 0, 4192);
			add_location(br6, file$2, 171, 0, 4197);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 173, 0, 4203);
			add_location(br7, file$2, 175, 0, 4245);
			add_location(br8, file$2, 176, 0, 4250);
			add_location(p1, file$2, 178, 0, 4256);
			add_location(p2, file$2, 179, 0, 4292);
			add_location(p3, file$2, 180, 0, 4336);
			add_location(br9, file$2, 182, 0, 4382);
			add_location(br10, file$2, 183, 0, 4387);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 185, 0, 4393);
			add_location(span1, file$2, 189, 8, 4467);
			add_location(li5, file$2, 188, 4, 4454);
			add_location(span2, file$2, 196, 8, 4701);
			add_location(li6, file$2, 195, 4, 4688);
			add_location(span3, file$2, 203, 8, 4896);
			add_location(li7, file$2, 202, 4, 4883);
			add_location(ul1, file$2, 187, 0, 4445);
			add_location(br11, file$2, 211, 0, 5114);
			add_location(br12, file$2, 212, 0, 5119);
			add_location(br13, file$2, 216, 8, 5226);
			add_location(br14, file$2, 218, 8, 5255);
			add_location(br15, file$2, 219, 8, 5268);
			add_location(br16, file$2, 221, 8, 5344);
			add_location(br17, file$2, 222, 8, 5357);
			add_location(br18, file$2, 224, 8, 5446);
			add_location(br19, file$2, 225, 8, 5459);
			add_location(br20, file$2, 227, 8, 5565);
			add_location(br21, file$2, 228, 8, 5578);
			add_location(br22, file$2, 232, 8, 5705);
			add_location(br23, file$2, 233, 8, 5718);
			add_location(br24, file$2, 235, 8, 5825);
			add_location(br25, file$2, 236, 8, 5838);
			add_location(br26, file$2, 238, 8, 5944);
			add_location(br27, file$2, 239, 8, 5957);
			add_location(div1, file$2, 215, 4, 5212);
			add_location(br28, file$2, 243, 8, 5992);
			add_location(br29, file$2, 245, 8, 6030);
			add_location(br30, file$2, 246, 8, 6043);
			add_location(br31, file$2, 248, 8, 6128);
			add_location(br32, file$2, 249, 8, 6141);
			add_location(br33, file$2, 251, 8, 6239);
			add_location(br34, file$2, 252, 8, 6252);
			add_location(br35, file$2, 254, 8, 6350);
			add_location(br36, file$2, 255, 8, 6363);
			add_location(br37, file$2, 259, 8, 6499);
			add_location(br38, file$2, 260, 8, 6512);
			add_location(br39, file$2, 262, 8, 6628);
			add_location(br40, file$2, 263, 8, 6641);
			add_location(br41, file$2, 265, 8, 6756);
			add_location(br42, file$2, 266, 8, 6769);
			add_location(div2, file$2, 242, 4, 5978);
			set_style(section2, "text-align", "center");
			set_style(section2, "display", "flex");
			set_style(section2, "justify-content", "space-around");
			add_location(section2, file$2, 214, 0, 5125);
			add_location(br43, file$2, 270, 0, 6797);
			add_location(br44, file$2, 271, 0, 6802);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 273, 0, 6808);
			add_location(br45, file$2, 275, 0, 6851);
			add_location(br46, file$2, 276, 0, 6856);
			add_location(br47, file$2, 281, 4, 6921);
			add_location(br48, file$2, 282, 4, 6930);
			add_location(br49, file$2, 286, 4, 7013);
			add_location(br50, file$2, 287, 4, 7022);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 292, 8, 7111);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 293, 8, 7138);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 294, 8, 7165);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 291, 4, 7083);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 297, 4, 7205);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 298, 4, 7263);
			add_location(br51, file$2, 300, 4, 7312);
			add_location(br52, file$2, 301, 4, 7321);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 303, 4, 7331);
			add_location(br53, file$2, 305, 4, 7383);
			add_location(br54, file$2, 306, 4, 7392);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 308, 4, 7402);
			add_location(section3, file$2, 278, 0, 6862);
			add_location(br55, file$2, 311, 0, 7478);
			add_location(br56, file$2, 312, 0, 7483);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 314, 0, 7489);
			add_location(br57, file$2, 320, 0, 7613);
			add_location(br58, file$2, 321, 0, 7618);
			add_location(br59, file$2, 325, 0, 7690);
			add_location(br60, file$2, 326, 0, 7695);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 328, 0, 7701);
			add_location(strong, file$2, 331, 4, 7746);
			add_location(p4, file$2, 330, 0, 7738);
			set_style(p5, "text-align", "justify");
			add_location(p5, file$2, 336, 0, 7855);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
			insert_dev(target, br0, anchor);
