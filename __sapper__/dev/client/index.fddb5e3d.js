...
function create_fragment$f(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t3 = claim_text(h3_nodes, "A small description that describes the title above and just makes text longer.");
		...
		h: function hydrate() {
			...
			add_location(h3, file$f, 9, 4, 114);
