...
function create_each_block_1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-e1yb2e");
			add_location(li, file, 231, 12, 6254);
		},
		m: function mount(target, anchor) {
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-e1yb2e");
			add_location(li, file, 252, 12, 6579);
		},
		m: function mount(target, anchor) {
			insert_dev(target, li, anchor);
			mount_component(charitycard, li, null);
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 267, 4, 6770);
			add_location(br1, file, 268, 4, 6779);
			add_location(br2, file, 272, 4, 6853);
			add_location(br3, file, 273, 4, 6862);
			add_location(br4, file, 277, 4, 6934);
			add_location(br5, file, 278, 4, 6943);
			add_location(br6, file, 282, 4, 7016);
			add_location(br7, file, 283, 4, 7025);
			add_location(br8, file, 287, 4, 7096);
			add_location(br9, file, 288, 4, 7105);
			add_location(br10, file, 292, 4, 7179);
			add_location(br11, file, 293, 4, 7188);
			add_location(br12, file, 297, 4, 7260);
			add_location(br13, file, 298, 4, 7269);
			add_location(br14, file, 302, 4, 7345);
			add_location(br15, file, 303, 4, 7354);
			add_location(br16, file, 307, 4, 7425);
			add_location(br17, file, 308, 4, 7434);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-e1yb2e");
			add_location(div0, file, 139, 8, 3602);
			attr_dev(li0, "class", "svelte-e1yb2e");
			add_location(li0, file, 160, 12, 4430);
			attr_dev(li1, "class", "svelte-e1yb2e");
			add_location(li1, file, 163, 12, 4550);
			attr_dev(li2, "class", "svelte-e1yb2e");
			add_location(li2, file, 166, 12, 4671);
			add_location(br0, file, 170, 16, 4814);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 181, 20, 5165);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 182, 20, 5205);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 183, 20, 5246);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 180, 16, 5113);
			attr_dev(li3, "class", "svelte-e1yb2e");
			add_location(li3, file, 169, 12, 4793);
			attr_dev(li4, "class", "svelte-e1yb2e");
			add_location(li4, file, 186, 12, 5326);
			attr_dev(ul0, "class", "options svelte-e1yb2e");
			add_location(ul0, file, 159, 8, 4397);
			attr_dev(section0, "class", "top svelte-e1yb2e");
			add_location(section0, file, 138, 4, 3572);
			attr_dev(h3, "class", "svelte-e1yb2e");
			add_location(h3, file, 199, 16, 5685);
			attr_dev(p0, "class", "svelte-e1yb2e");
			add_location(p0, file, 200, 16, 5725);
			attr_dev(span0, "class", "svelte-e1yb2e");
			add_location(span0, file, 198, 12, 5662);
			attr_dev(div1, "class", "ava-section svelte-e1yb2e");
			add_location(div1, file, 195, 8, 5546);
			attr_dev(section1, "class", "rate-section svelte-e1yb2e");
			add_location(section1, file, 194, 4, 5507);
			add_location(br1, file, 207, 4, 5826);
			attr_dev(h10, "class", "svelte-e1yb2e");
			add_location(h10, file, 209, 4, 5836);
			add_location(br2, file, 211, 4, 5865);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 213, 4, 5875);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 137, 0, 3540);
			add_location(br3, file, 218, 0, 6031);
			add_location(br4, file, 219, 0, 6036);
			add_location(br5, file, 220, 0, 6041);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 224, 4, 6100);
			add_location(br6, file, 227, 4, 6183);
			attr_dev(ul1, "class", "cards svelte-e1yb2e");
			add_location(ul1, file, 229, 4, 6193);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 222, 0, 6047);
			add_location(br7, file, 238, 0, 6352);
			add_location(br8, file, 239, 0, 6357);
			add_location(br9, file, 240, 0, 6362);
			add_location(br10, file, 241, 0, 6367);
			set_style(h21, "text-align", "right");
			add_location(h21, file, 245, 4, 6426);
			add_location(br11, file, 248, 4, 6508);
			attr_dev(ul2, "class", "cards svelte-e1yb2e");
			add_location(ul2, file, 250, 4, 6518);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 243, 0, 6373);
			add_location(br12, file, 259, 0, 6677);
			add_location(br13, file, 260, 0, 6682);
			add_location(br14, file, 261, 0, 6687);
			attr_dev(h11, "class", "svelte-e1yb2e");
			add_location(h11, file, 313, 0, 7504);
			add_location(br15, file, 315, 0, 7572);
			add_location(br16, file, 316, 0, 7577);
			attr_dev(h22, "class", "text-success");
			add_location(h22, file, 318, 0, 7583);
			add_location(br17, file, 320, 0, 7625);
			add_location(br18, file, 321, 0, 7630);
			add_location(p2, file, 323, 0, 7636);
			add_location(p3, file, 324, 0, 7672);
			add_location(p4, file, 325, 0, 7716);
			add_location(br19, file, 327, 0, 7762);
			add_location(br20, file, 328, 0, 7767);
			attr_dev(h23, "class", "text-warning");
			add_location(h23, file, 330, 0, 7773);
			add_location(span1, file, 334, 8, 7847);
			add_location(li5, file, 333, 4, 7834);
			add_location(span2, file, 341, 8, 8081);
			add_location(li6, file, 340, 4, 8068);
			add_location(span3, file, 348, 8, 8276);
			add_location(li7, file, 347, 4, 8263);
			add_location(ul3, file, 332, 0, 7825);
			add_location(br21, file, 356, 0, 8494);
			add_location(br22, file, 357, 0, 8499);
			add_location(br23, file, 361, 8, 8606);
			add_location(br24, file, 363, 8, 8635);
			add_location(br25, file, 364, 8, 8648);
			add_location(br26, file, 366, 8, 8724);
			add_location(br27, file, 367, 8, 8737);
			add_location(br28, file, 369, 8, 8826);
			add_location(br29, file, 370, 8, 8839);
			add_location(br30, file, 372, 8, 8945);
			add_location(br31, file, 373, 8, 8958);
			add_location(br32, file, 377, 8, 9085);
			add_location(br33, file, 378, 8, 9098);
			add_location(br34, file, 380, 8, 9205);
			add_location(br35, file, 381, 8, 9218);
			add_location(br36, file, 383, 8, 9324);
			add_location(br37, file, 384, 8, 9337);
			add_location(div4, file, 360, 4, 8592);
			add_location(br38, file, 388, 8, 9372);
			add_location(br39, file, 390, 8, 9410);
			add_location(br40, file, 391, 8, 9423);
			add_location(br41, file, 393, 8, 9508);
			add_location(br42, file, 394, 8, 9521);
			add_location(br43, file, 396, 8, 9619);
			add_location(br44, file, 397, 8, 9632);
			add_location(br45, file, 399, 8, 9730);
			add_location(br46, file, 400, 8, 9743);
			add_location(br47, file, 404, 8, 9879);
			add_location(br48, file, 405, 8, 9892);
			add_location(br49, file, 407, 8, 10008);
			add_location(br50, file, 408, 8, 10021);
			add_location(br51, file, 410, 8, 10136);
			add_location(br52, file, 411, 8, 10149);
			add_location(div5, file, 387, 4, 9358);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 359, 0, 8505);
			add_location(br53, file, 415, 0, 10177);
			add_location(br54, file, 416, 0, 10182);
			attr_dev(h24, "class", "text-danger");
			add_location(h24, file, 418, 0, 10188);
			add_location(br55, file, 420, 0, 10231);
			add_location(br56, file, 421, 0, 10236);
			add_location(br57, file, 426, 4, 10301);
			add_location(br58, file, 427, 4, 10310);
			add_location(br59, file, 431, 4, 10393);
			add_location(br60, file, 432, 4, 10402);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 437, 8, 10491);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 438, 8, 10518);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 439, 8, 10545);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 436, 4, 10463);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 442, 4, 10585);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 443, 4, 10643);
			add_location(br61, file, 445, 4, 10692);
			add_location(br62, file, 446, 4, 10701);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 448, 4, 10711);
			add_location(br63, file, 450, 4, 10763);
			add_location(br64, file, 451, 4, 10772);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 453, 4, 10782);
			add_location(section4, file, 423, 0, 10242);
			add_location(br65, file, 456, 0, 10858);
			add_location(br66, file, 457, 0, 10863);
			attr_dev(h25, "class", "text-info");
			add_location(h25, file, 459, 0, 10869);
			add_location(br67, file, 461, 0, 10904);
			add_location(br68, file, 462, 0, 10909);
			add_location(br69, file, 466, 0, 10981);
			add_location(br70, file, 467, 0, 10986);
			attr_dev(h26, "class", "text-success");
			add_location(h26, file, 469, 0, 10992);
			add_location(strong, file, 472, 4, 11037);
			add_location(p5, file, 471, 0, 11029);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 477, 0, 11146);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
