...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h4, file, 68, 0, 2272);
			add_location(span6, file, 68, 21, 2293);
			add_location(h5, file, 69, 0, 2316);
			add_location(span7, file, 69, 21, 2337);
			add_location(h6, file, 70, 0, 2360);
			add_location(span8, file, 70, 21, 2381);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 72, 0, 2405);
			attr_dev(section, "class", "container");
			add_location(section, file, 76, 0, 2460);
		},
