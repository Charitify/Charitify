...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br2, file, 26, 1, 618);
			add_location(br3, file, 34, 1, 717);
			add_location(br4, file, 35, 1, 723);
			attr_dev(div1, "class", "list-wrap svelte-15uoncq");
			add_location(div1, file, 25, 0, 593);
		},
		m: function mount(target, anchor) {
