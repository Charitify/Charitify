...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t6 = claim_text(p_nodes, "ORG charity charitify");
			p_nodes.forEach(detach_dev);
			span_nodes.forEach(detach_dev);
			div1_nodes.forEach(detach_dev);
			t7 = claim_space(footer_nodes);
			claim_component(rate.$$.fragment, footer_nodes);
		...
		h: function hydrate() {
			...
			add_location(h3, file$b, 42, 16, 1273);
			attr_dev(p, "class", "svelte-onscs3");
			add_location(p, file$b, 43, 16, 1313);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 41, 12, 1250);
			attr_dev(div1, "class", "ava-section svelte-onscs3");
			add_location(div1, file$b, 38, 8, 1134);
			add_location(footer, file$b, 37, 4, 1117);
		...
		m: function mount(target, anchor) {
			...
			mount_component(rate, footer, null);
			current = true;
		},
		p: function update(ctx, [dirty]) {
			const swipe_changes = {};
