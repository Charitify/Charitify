...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li0, "class", "svelte-zj8rvm");
			add_location(li0, file$2, 8, 4, 160);
			attr_dev(li1, "class", "svelte-zj8rvm");
			add_location(li1, file$2, 11, 4, 227);
			attr_dev(li2, "class", "svelte-zj8rvm");
			add_location(li2, file$2, 14, 4, 294);
			attr_dev(li3, "class", "svelte-zj8rvm");
			add_location(li3, file$2, 17, 4, 361);
			attr_dev(li4, "class", "svelte-zj8rvm");
			add_location(li4, file$2, 20, 4, 428);
			attr_dev(ul, "class", "rate svelte-zj8rvm");
