...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "images svelte-t3hdao");
			add_location(div0, file$b, 14, 4, 375);
			attr_dev(h5, "class", "svelte-t3hdao");
			...
			attr_dev(h3, "class", "svelte-t3hdao");
			add_location(h3, file$b, 46, 12, 1204);
			attr_dev(p1, "class", "svelte-t3hdao");
			add_location(p1, file$b, 47, 12, 1235);
			attr_dev(span, "class", "svelte-t3hdao");
			add_location(span, file$b, 45, 8, 1185);
			attr_dev(footer, "class", "ava-section svelte-t3hdao");
			add_location(footer, file$b, 42, 4, 1099);
			attr_dev(div1, "class", "card svelte-t3hdao");
