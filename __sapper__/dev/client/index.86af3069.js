import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, I as text, F as space, r as element, K as create_component, J as claim_text, G as claim_space, c as claim_element, f as children, L as claim_component, g as detach_dev, h as attr_dev, j as add_location, H as set_style, m as append_dev, l as insert_dev, M as mount_component, B as transition_in, z as transition_out, N as destroy_component } from './index.f49bbbed.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t34 = claim_text(h1_nodes, "Great ");
			span = claim_element(h1_nodes, "SPAN", { class: true });
			var span_nodes = children(span);
			t35 = claim_text(span_nodes, "success");
			span_nodes.forEach(detach_dev);
			t36 = claim_text(h1_nodes, "!");
			...
			t40 = claim_text(h20_nodes, "Typography");
			...
			t44 = claim_text(p0_nodes, "Few paragraphs to text fonts");
			p0_nodes.forEach(detach_dev);
			t45 = claim_space(nodes);
			p1 = claim_element(nodes, "P", { class: true });
			var p1_nodes = children(p1);
			t46 = claim_text(p1_nodes, "Декілька параграфів для тесту тексту");
			p1_nodes.forEach(detach_dev);
			t47 = claim_space(nodes);
			p2 = claim_element(nodes, "P", { class: true });
			var p2_nodes = children(p2);
			t48 = claim_text(p2_nodes, "Несколько параграфов для теста текста");
			...
			t52 = claim_text(h21_nodes, "Interactive elements");
			...
			t121 = claim_text(button15_nodes, "Button example");
			...
			t133 = claim_text(h24_nodes, "Other");
			...
			t135 = claim_text(strong_nodes, "Try editing this file (src/routes/index.svelte) to test live reloading.");
			strong_nodes.forEach(detach_dev);
			p3_nodes.forEach(detach_dev);
			t136 = claim_space(nodes);
			p4 = claim_element(nodes, "P", { style: true, class: true });
			var p4_nodes = children(p4);
			t137 = claim_text(p4_nodes, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem doloribus id laborum minima. Adipisci aperiam atque\n    autem commodi consequuntur debitis distinctio dolorem eum expedita ipsam iure labore laudantium maiores mollitia\n    nesciunt\n    nostrum optio perferendis porro, possimus quas quasi quisquam sint sunt totam unde. A atque blanditiis consequatur,\n    dolore\n    ducimus et id ipsam iusto labore, laudantium libero minus nam nostrum, numquam praesentium quisquam sint?\n    Consectetur dolorum\n    enim ex ipsum nam necessitatibus nisi nostrum odio omnis, quia recusandae temporibus totam. A aliquam, assumenda aut\n    autem\n    commodi consectetur dignissimos ducimus eius eos error ipsa ipsam molestias mollitia numquam praesentium quod rem\n    sapiente\n    sed sint totam! Ab aspernatur at culpa debitis dolores ea eius, excepturi ipsa laborum, minus numquam, optio\n    reiciendis\n    repudiandae similique temporibus! Blanditiis consequatur, dignissimos dolores eaque excepturi hic inventore ipsa\n    iste\n    nemo obcaecati provident quia, quibusdam ratione reiciendis saepe sequi vel veritatis vitae voluptate voluptatem.\n    Debitis\n    illum quaerat velit voluptatibus. A accusamus ad adipisci animi, aperiam architecto aspernatur aut beatae corporis\n    culpa\n    debitis dicta distinctio dolorem ducimus ea eligendi eos eveniet excepturi harum ipsum magnam maxime nesciunt\n    numquam obcaecati\n    perferendis, provident quaerat qui ratione reiciendis repellendus reprehenderit saepe sequi vel voluptas voluptate\n    voluptates\n    voluptatibus? Amet aperiam corporis deleniti deserunt, dolorem est exercitationem fuga hic impedit inventore itaque\n    laboriosam\n    laudantium, magnam necessitatibus nemo odio officiis perferendis perspiciatis quae qui quibusdam quis quod saepe sit\n    suscipit\n    tenetur ut vel veritatis voluptate
\n    amet\n    corporis eaque enim explicabo fuga harum illo inventore itaque laudantium modi nemo nihil nulla possimus quae quas\n    quia quidem\n    quisquam recusandae repellendus sapiente sequi sit tempora, totam unde velit. Accusantium corporis cum dolor dolorum\n    iusto\n    laboriosam minus necessitatibus, nulla, omnis pariatur quae ullam voluptatem. Accusantium architecto, assumenda\n    commodi cumque\n    dignissimos doloribus eius et eum in iusto libero magnam, magni mollitia necessitatibus neque nesciunt perspiciatis\n    quidem\n    voluptas voluptatem voluptatibus? Aspernatur assumenda at consequatur deleniti eum expedita fuga in neque officia\n    pariatur,\n    provident quasi saepe sed sequi tempora tempore voluptates? Aliquam aperiam autem cum doloribus ducimus enim eum ex\n    expedita\n    explicabo id illo iste iure maiores modi nemo neque nisi nostrum officia officiis omnis perferendis perspiciatis\n    possimus\n    quae quas quibusdam quidem quis saepe sed sint sunt velit, vero vitae voluptatum? Amet debitis, dolore dolores eum\n    in ipsum\n    magnam mollitia nostrum quas quisquam quod rem sed sequi tenetur, voluptatibus. Ad adipisci aliquam animi aut autem\n    commodi\n    distinctio dolor eveniet impedit in iusto magni neque, odit optio pariatur placeat quaerat quo rem rerum sequi\n    suscipit\n    veniam vero voluptate voluptatem, voluptatum. Accusantium dicta dolores ea est libero rerum sapiente sit!\n    Accusantium cupiditate\n    eum ex molestiae praesentium provident saepe? Eveniet labore, rem. Aperiam, architecto at consectetur culpa cumque\n    debitis\n    dolorum eius eveniet fuga illo, in ipsum libero molestias necessitatibus nemo neque omnis perferendis perspiciatis\n    praesentium\n    quasi qui quia quod rerum saepe sed similique sunt suscipit tenetur totam ullam veritatis vitae voluptate\n    voluptatem. Assumenda\n    consequatur corporis dolorem doloremque ea inventore iusto sequi sit ut vitae! Adipisci alias aliquid aperiam\n    architecto asperiores\n    delectus dolore eaque eius eligendi fugiat incidunt ipsam iusto laborum magni maxime nam, necessitatibus nesciunt\n    omnis placeat\n    quaerat quibusdam rem, suscipit unde vel, veritatis vero voluptatum. Animi aut fuga impedit nostrum odit officia\n    quisquam,\n    repudiandae saepe suscipit voluptates! Ab autem beatae distinctio, dolorum eligendi est excepturi facere facilis\n    illo inventore\n    iure minus nemo nesciunt quaerat quibusdam repellendus sequi sint sit ullam voluptatem. Debitis ducimus excepturi\n    impedit\n    laudantium magnam nisi possimus, quae quod repellat sed sit tempora unde. Delectus eius laudantium quas quidem\n    similique sit\n    unde voluptas voluptate? Accusamus aut distinctio dolorum earum enim illo illum incidunt iure magni natus nulla\n    officiis\n    pariatur perspiciatis possimus quasi recusandae sint voluptas, voluptatibus. Ad aliquam amet, deleniti dignissimos,\n    eius enim\n    error excepturi hic magni quae qui quisquam repellendus rerum saepe similique suscipit temporibus vel voluptate. A\n    asperiores\n    at, dolores eligendi eum facere fuga impedit incidunt ipsam labore laborum magnam omnis placeat, quam quidem quos\n    similique\n    tenetur totam, vero voluptatibus. Ab asperiores autem cum delectus dicta dolor dolorum eos ex impedit libero nam\n    natus, necessitatibus");
		...
		h: function hydrate() {
			...
			add_location(div0, file, 53, 8, 793);
			attr_dev(li0, "class", "svelte-1kmv00v");
			add_location(li0, file, 58, 12, 952);
			attr_dev(li1, "class", "svelte-1kmv00v");
			add_location(li1, file, 61, 12, 1072);
			attr_dev(li2, "class", "svelte-1kmv00v");
			add_location(li2, file, 64, 12, 1193);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 78, 20, 1666);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 79, 20, 1706);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 80, 20, 1747);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 77, 16, 1614);
			attr_dev(li3, "class", "svelte-1kmv00v");
			add_location(li3, file, 67, 12, 1315);
			attr_dev(ul, "class", "options svelte-1kmv00v");
			add_location(ul, file, 57, 8, 919);
			attr_dev(section0, "class", "top svelte-1kmv00v");
			add_location(section0, file, 52, 4, 763);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file, 86, 4, 1849);
			attr_dev(section2, "class", "top-wrap svelte-1kmv00v");
			add_location(section2, file, 48, 0, 698);
			add_location(br0, file, 94, 4, 2021);
			add_location(br1, file, 95, 4, 2030);
			add_location(br2, file, 99, 4, 2091);
			add_location(br3, file, 100, 4, 2100);
			add_location(br4, file, 104, 4, 2159);
			add_location(br5, file, 105, 4, 2168);
			add_location(br6, file, 109, 4, 2228);
			add_location(br7, file, 110, 4, 2237);
			add_location(br8, file, 114, 4, 2295);
			add_location(br9, file, 115, 4, 2304);
			add_location(br10, file, 119, 4, 2365);
			add_location(br11, file, 120, 4, 2374);
			add_location(br12, file, 124, 4, 2433);
			add_location(br13, file, 125, 4, 2442);
			add_location(br14, file, 129, 4, 2505);
			add_location(br15, file, 130, 4, 2514);
			add_location(section3, file, 92, 0, 2006);
			attr_dev(span, "class", "text-success");
			add_location(span, file, 135, 10, 2589);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 135, 0, 2579);
			add_location(br16, file, 137, 0, 2638);
			add_location(br17, file, 138, 0, 2643);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 140, 0, 2649);
			add_location(br18, file, 142, 0, 2691);
			add_location(br19, file, 143, 0, 2696);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 145, 0, 2702);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 146, 0, 2738);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 147, 0, 2782);
			add_location(br20, file, 149, 0, 2828);
			add_location(br21, file, 150, 0, 2833);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 152, 0, 2839);
			add_location(br22, file, 154, 0, 2891);
			add_location(br23, file, 155, 0, 2896);
			add_location(br24, file, 159, 8, 3003);
			add_location(br25, file, 161, 8, 3032);
			add_location(br26, file, 162, 8, 3045);
			add_location(br27, file, 164, 8, 3121);
			add_location(br28, file, 165, 8, 3134);
			add_location(br29, file, 167, 8, 3223);
			add_location(br30, file, 168, 8, 3236);
			add_location(br31, file, 170, 8, 3342);
			add_location(br32, file, 171, 8, 3355);
			add_location(br33, file, 175, 8, 3482);
			add_location(br34, file, 176, 8, 3495);
			add_location(br35, file, 178, 8, 3602);
			add_location(br36, file, 179, 8, 3615);
			add_location(br37, file, 181, 8, 3721);
			add_location(br38, file, 182, 8, 3734);
			add_location(div1, file, 158, 4, 2989);
			add_location(br39, file, 186, 8, 3769);
			add_location(br40, file, 188, 8, 3807);
			add_location(br41, file, 189, 8, 3820);
			add_location(br42, file, 191, 8, 3905);
			add_location(br43, file, 192, 8, 3918);
			add_location(br44, file, 194, 8, 4016);
			add_location(br45, file, 195, 8, 4029);
			add_location(br46, file, 197, 8, 4127);
			add_location(br47, file, 198, 8, 4140);
			add_location(br48, file, 202, 8, 4276);
			add_location(br49, file, 203, 8, 4289);
			add_location(br50, file, 205, 8, 4405);
			add_location(br51, file, 206, 8, 4418);
			add_location(br52, file, 208, 8, 4533);
			add_location(br53, file, 209, 8, 4546);
			add_location(div2, file, 185, 4, 3755);
			set_style(section4, "text-align", "center");
			set_style(section4, "display", "flex");
			set_style(section4, "justify-content", "space-around");
			add_location(section4, file, 157, 0, 2902);
			add_location(br54, file, 213, 0, 4574);
			add_location(br55, file, 214, 0, 4579);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 216, 0, 4585);
			add_location(br56, file, 218, 0, 4628);
			add_location(br57, file, 219, 0, 4633);
			add_location(br58, file, 224, 4, 4698);
			add_location(br59, file, 225, 4, 4707);
			add_location(br60, file, 229, 4, 4790);
			add_location(br61, file, 230, 4, 4799);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 235, 8, 4888);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 236, 8, 4915);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 237, 8, 4942);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 234, 4, 4860);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 240, 4, 4982);
			attr_dev(input12, "id", "input");
			attr_dev(input12, "type", "text");
			input12.value = "text";
			add_location(input12, file, 241, 4, 5040);
			add_location(br62, file, 243, 4, 5089);
			add_location(br63, file, 244, 4, 5098);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 246, 4, 5108);
			add_location(br64, file, 248, 4, 5160);
			add_location(br65, file, 249, 4, 5169);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 251, 4, 5179);
			add_location(section5, file, 221, 0, 4639);
			add_location(br66, file, 254, 0, 5255);
			add_location(br67, file, 255, 0, 5260);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 257, 0, 5266);
			add_location(br68, file, 263, 0, 5390);
			add_location(br69, file, 264, 0, 5395);
			add_location(br70, file, 268, 0, 5467);
			add_location(br71, file, 269, 0, 5472);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 271, 0, 5478);
			add_location(strong, file, 274, 4, 5523);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 273, 0, 5515);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 279, 0, 5632);
		},
		m: function mount(target, anchor) {
