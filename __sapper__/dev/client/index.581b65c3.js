...
function create_fragment$h(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$h, 6, 4, 238);
			add_location(br, file$h, 7, 4, 259);
			add_location(p, file$h, 8, 4, 268);
			attr_dev(section, "class", "svelte-1qydgyt");
			add_location(section, file$h, 5, 0, 224);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function instance$f($$self, $$props, $$invalidate) {
	const title = "The main title that explains the charity";
