...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h3, "class", "h2 svelte-172nez7");
...
function create_each_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-172nez7");
...
function create_fragment$g(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "cards svelte-172nez7");
			add_location(ul, file$g, 55, 4, 1858);
			attr_dev(section, "class", "svelte-172nez7");
