...
import { B as Button, I as Input, P as Progress, A as Avatar, R as Rate, D as Divider, F as Form, a as Icon, b as Picture } from './index.b6ac7ff2.js';
...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 163, 4, 4229);
			add_location(br1, file$2, 164, 4, 4238);
			add_location(br2, file$2, 168, 4, 4312);
			add_location(br3, file$2, 169, 4, 4321);
			add_location(br4, file$2, 173, 4, 4393);
			add_location(br5, file$2, 174, 4, 4402);
			add_location(br6, file$2, 178, 4, 4475);
			add_location(br7, file$2, 179, 4, 4484);
			add_location(br8, file$2, 183, 4, 4555);
			add_location(br9, file$2, 184, 4, 4564);
			add_location(br10, file$2, 188, 4, 4638);
			add_location(br11, file$2, 189, 4, 4647);
			add_location(br12, file$2, 193, 4, 4719);
			add_location(br13, file$2, 194, 4, 4728);
			add_location(br14, file$2, 198, 4, 4804);
			add_location(br15, file$2, 199, 4, 4813);
			add_location(br16, file$2, 203, 4, 4884);
			add_location(br17, file$2, 204, 4, 4893);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-h9u6vt");
			add_location(div0, file$2, 77, 8, 1712);
			attr_dev(li0, "class", "svelte-h9u6vt");
			add_location(li0, file$2, 98, 12, 2540);
			attr_dev(li1, "class", "svelte-h9u6vt");
			add_location(li1, file$2, 101, 12, 2660);
			attr_dev(li2, "class", "svelte-h9u6vt");
			add_location(li2, file$2, 104, 12, 2781);
			add_location(br0, file$2, 108, 16, 2924);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 119, 20, 3275);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 120, 20, 3315);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 121, 20, 3356);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 118, 16, 3223);
			attr_dev(li3, "class", "svelte-h9u6vt");
			add_location(li3, file$2, 107, 12, 2903);
			attr_dev(li4, "class", "svelte-h9u6vt");
			add_location(li4, file$2, 124, 12, 3436);
			attr_dev(ul0, "class", "options svelte-h9u6vt");
			add_location(ul0, file$2, 97, 8, 2507);
			attr_dev(section0, "class", "top svelte-h9u6vt");
			add_location(section0, file$2, 76, 4, 1682);
			attr_dev(h3, "class", "svelte-h9u6vt");
			add_location(h3, file$2, 137, 16, 3795);
			attr_dev(p0, "class", "svelte-h9u6vt");
			add_location(p0, file$2, 138, 16, 3835);
			attr_dev(span0, "class", "svelte-h9u6vt");
			add_location(span0, file$2, 136, 12, 3772);
			attr_dev(div1, "class", "ava-section svelte-h9u6vt");
			add_location(div1, file$2, 133, 8, 3656);
			attr_dev(section1, "class", "rate-section svelte-h9u6vt");
			add_location(section1, file$2, 132, 4, 3617);
			add_location(br1, file$2, 145, 4, 3936);
			attr_dev(h10, "class", "svelte-h9u6vt");
			add_location(h10, file$2, 147, 4, 3946);
			add_location(br2, file$2, 149, 4, 3975);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 151, 4, 3985);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 75, 0, 1650);
			add_location(br3, file$2, 156, 0, 4141);
			add_location(br4, file$2, 157, 0, 4146);
			attr_dev(h11, "class", "svelte-h9u6vt");
			add_location(h11, file$2, 209, 0, 4963);
			add_location(br5, file$2, 211, 0, 5031);
			add_location(br6, file$2, 212, 0, 5036);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 214, 0, 5042);
			add_location(br7, file$2, 216, 0, 5084);
			add_location(br8, file$2, 217, 0, 5089);
			add_location(p2, file$2, 219, 0, 5095);
			add_location(p3, file$2, 220, 0, 5131);
			add_location(p4, file$2, 221, 0, 5175);
			add_location(br9, file$2, 223, 0, 5221);
			add_location(br10, file$2, 224, 0, 5226);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 226, 0, 5232);
			add_location(span1, file$2, 230, 8, 5306);
			add_location(li5, file$2, 229, 4, 5293);
			add_location(span2, file$2, 237, 8, 5540);
			add_location(li6, file$2, 236, 4, 5527);
			add_location(span3, file$2, 244, 8, 5735);
			add_location(li7, file$2, 243, 4, 5722);
			add_location(ul1, file$2, 228, 0, 5284);
			add_location(br11, file$2, 252, 0, 5953);
			add_location(br12, file$2, 253, 0, 5958);
			add_location(br13, file$2, 257, 8, 6065);
			add_location(br14, file$2, 259, 8, 6094);
			add_location(br15, file$2, 260, 8, 6107);
			add_location(br16, file$2, 262, 8, 6183);
			add_location(br17, file$2, 263, 8, 6196);
			add_location(br18, file$2, 265, 8, 6285);
			add_location(br19, file$2, 266, 8, 6298);
			add_location(br20, file$2, 268, 8, 6404);
			add_location(br21, file$2, 269, 8, 6417);
			add_location(br22, file$2, 273, 8, 6544);
			add_location(br23, file$2, 274, 8, 6557);
			add_location(br24, file$2, 276, 8, 6664);
			add_location(br25, file$2, 277, 8, 6677);
			add_location(br26, file$2, 279, 8, 6783);
			add_location(br27, file$2, 280, 8, 6796);
			add_location(div2, file$2, 256, 4, 6051);
			add_location(br28, file$2, 284, 8, 6831);
			add_location(br29, file$2, 286, 8, 6869);
			add_location(br30, file$2, 287, 8, 6882);
			add_location(br31, file$2, 289, 8, 6967);
			add_location(br32, file$2, 290, 8, 6980);
			add_location(br33, file$2, 292, 8, 7078);
			add_location(br34, file$2, 293, 8, 7091);
			add_location(br35, file$2, 295, 8, 7189);
			add_location(br36, file$2, 296, 8, 7202);
			add_location(br37, file$2, 300, 8, 7338);
			add_location(br38, file$2, 301, 8, 7351);
			add_location(br39, file$2, 303, 8, 7467);
			add_location(br40, file$2, 304, 8, 7480);
			add_location(br41, file$2, 306, 8, 7595);
			add_location(br42, file$2, 307, 8, 7608);
			add_location(div3, file$2, 283, 4, 6817);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 255, 0, 5964);
			add_location(br43, file$2, 311, 0, 7636);
			add_location(br44, file$2, 312, 0, 7641);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 314, 0, 7647);
			add_location(br45, file$2, 316, 0, 7690);
			add_location(br46, file$2, 317, 0, 7695);
			add_location(br47, file$2, 322, 4, 7760);
			add_location(br48, file$2, 323, 4, 7769);
			add_location(br49, file$2, 327, 4, 7852);
			add_location(br50, file$2, 328, 4, 7861);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 333, 8, 7950);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 334, 8, 7977);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 335, 8, 8004);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 332, 4, 7922);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 338, 4, 8044);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 339, 4, 8102);
			add_location(br51, file$2, 341, 4, 8151);
			add_location(br52, file$2, 342, 4, 8160);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 344, 4, 8170);
			add_location(br53, file$2, 346, 4, 8222);
			add_location(br54, file$2, 347, 4, 8231);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 349, 4, 8241);
			add_location(section4, file$2, 319, 0, 7701);
			add_location(br55, file$2, 352, 0, 8317);
			add_location(br56, file$2, 353, 0, 8322);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 355, 0, 8328);
			add_location(br57, file$2, 361, 0, 8452);
			add_location(br58, file$2, 362, 0, 8457);
			add_location(br59, file$2, 366, 0, 8529);
			add_location(br60, file$2, 367, 0, 8534);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 369, 0, 8540);
			add_location(strong, file$2, 372, 4, 8585);
			add_location(p5, file$2, 371, 0, 8577);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 377, 0, 8694);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
