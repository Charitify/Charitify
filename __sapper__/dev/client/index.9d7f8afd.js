import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, G as space, r as element, L as create_component, J as text, H as claim_space, c as claim_element, f as children, M as claim_component, g as detach_dev, K as claim_text, j as add_location, h as attr_dev, I as set_style, l as insert_dev, m as append_dev, N as mount_component, C as transition_in, A as transition_out, O as destroy_component } from './index.429efc97.js';
import { I as Icon, P as Picture, B as Button, a as Input, b as Progress } from './index.3b22e190.js';
...
// (168:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_12(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(168:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (174:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(174:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (178:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(178:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (182:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(182:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (185:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(185:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (195:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(195:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (205:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(205:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (209:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(209:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (212:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(212:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (264:0) <Picture alt="Borat" src="great-success.png" class="picture">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(264:0) <Picture alt=\\\"Borat\\\" src=\\\"great-success.png\\\" class=\\\"picture\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t35 = claim_text(h1_nodes, "Great ");
			span1 = claim_element(h1_nodes, "SPAN", { class: true });
			var span1_nodes = children(span1);
			t36 = claim_text(span1_nodes, "success");
			span1_nodes.forEach(detach_dev);
			t37 = claim_text(h1_nodes, "!");
			...
			t41 = claim_text(h20_nodes, "Typography");
			...
			t45 = claim_text(p0_nodes, "Few paragraphs to text fonts");
			p0_nodes.forEach(detach_dev);
			t46 = claim_space(nodes);
			p1 = claim_element(nodes, "P", { class: true });
			var p1_nodes = children(p1);
			t47 = claim_text(p1_nodes, "Декілька параграфів для тесту тексту");
			p1_nodes.forEach(detach_dev);
			t48 = claim_space(nodes);
			p2 = claim_element(nodes, "P", { class: true });
			var p2_nodes = children(p2);
			t49 = claim_text(p2_nodes, "Несколько параграфов для теста текста");
			...
			t53 = claim_text(h21_nodes, "Interactive elements");
			...
			t68 = claim_text(div1_nodes, "\n        With text\n        ");
			claim_component(button6.$$.fragment, div1_nodes);
			t69 = claim_text(div1_nodes, "\n        and behind.\n        ");
			...
			t75 = claim_space(div1_nodes);
			br37 = claim_element(div1_nodes, "BR", {});
			t76 = claim_space(div1_nodes);
			...
			t89 = claim_text(div2_nodes, "\n        With text\n        ");
			claim_component(button12.$$.fragment, div2_nodes);
			t90 = claim_text(div2_nodes, "\n        and behind.\n        ");
			...
			t101 = claim_text(h22_nodes, "Input fields");
			...
			t113 = claim_text(label_nodes, "label");
			...
			t118 = claim_text(a_nodes, "Some link");
			...
			t122 = claim_text(button15_nodes, "Button example");
			...
			t126 = claim_text(h23_nodes, "Images");
			...
			t134 = claim_text(h24_nodes, "Other");
			...
			t136 = claim_text(strong_nodes, "Try editing this file (src/routes/index.svelte) to test live reloading.");
			strong_nodes.forEach(detach_dev);
			p3_nodes.forEach(detach_dev);
			t137 = claim_space(nodes);
			p4 = claim_element(nodes, "P", { style: true, class: true });
			var p4_nodes = children(p4);
			t138 = claim_text(p4_nodes, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem doloribus id laborum minima. Adipisci aperiam atque\n    autem commodi consequuntur debitis distinctio dolorem eum expedita ipsam iure labore laudantium maiores mollitia\n    nesciunt\n    nostrum optio perferendis porro, possimus quas quasi quisquam sint sunt totam unde. A atque blanditiis consequatur,\n    dolore\n    ducimus et id ipsam iusto labore, laudantium libero minus nam nostrum, numquam praesentium quisquam sint?\n    Consectetur dolorum\n    enim ex ipsum nam necessitatibus nisi nostrum odio omnis, quia recusandae temporibus totam. A aliquam, assumenda aut\n    autem\n    commodi consectetur dignissimos ducimus eius eos error ipsa ipsam molestias mollitia numquam praesentium quod rem\n    sapiente\n    sed sint totam! Ab aspernatur at culpa debitis dolores ea eius, excepturi ipsa laborum, minus numquam, optio\n    reiciendis\n    repudiandae similique temporibus! Blanditiis consequatur, dignissimos dolores eaque excepturi hic inventore ipsa\n    iste\n    nemo obcaecati provident quia, quibusdam ratione reiciendis saepe sequi vel veritatis vitae voluptate voluptatem.\n    Debitis\n    illum quaerat velit voluptatibus. A accusamus ad adipisci animi, aperiam architecto aspernatur aut beatae corporis\n    culpa\n    debitis dicta distinctio dolorem ducimus ea eligendi eos eveniet excepturi harum ipsum magnam maxime nesciunt\n    numquam obcaecati\n    perferendis, provident quaerat qui ratione reiciendis repellendus reprehenderit saepe sequi vel voluptas voluptate\n    voluptates\n    voluptatibus? Amet aperiam corporis deleniti deserunt, dolorem est exercitationem fuga hic impedit inventore itaque\n    laboriosam\n    laudantium, magnam necessitatibus nemo odio officiis perferendis perspiciatis quae qui quibusdam quis quod saepe sit\n    suscipit\n    tenetur ut vel veritatis voluptate voluptatibus. Aliquid cum cumque eum iure laboriosam natus rem. Accusantium alias\n    amet\n    corporis eaque enim explicabo fuga harum illo inventore itaque laudantium modi nemo nihil nulla possimus quae quas\n    quia quidem\n    quisquam recusandae repellendus sapiente sequi sit tempora, totam unde velit. Accusantium corporis cum dolor dolorum\n    iusto\n    laboriosam minus necessitatibus, n
to, assumenda\n    commodi cumque\n    dignissimos doloribus eius et eum in iusto libero magnam, magni mollitia necessitatibus neque nesciunt perspiciatis\n    quidem\n    voluptas voluptatem voluptatibus? Aspernatur assumenda at consequatur deleniti eum expedita fuga in neque officia\n    pariatur,\n    provident quasi saepe sed sequi tempora tempore voluptates? Aliquam aperiam autem cum doloribus ducimus enim eum ex\n    expedita\n    explicabo id illo iste iure maiores modi nemo neque nisi nostrum officia officiis omnis perferendis perspiciatis\n    possimus\n    quae quas quibusdam quidem quis saepe sed sint sunt velit, vero vitae voluptatum? Amet debitis, dolore dolores eum\n    in ipsum\n    magnam mollitia nostrum quas quisquam quod rem sed sequi tenetur, voluptatibus. Ad adipisci aliquam animi aut autem\n    commodi\n    distinctio dolor eveniet impedit in iusto magni neque, odit optio pariatur placeat quaerat quo rem rerum sequi\n    suscipit\n    veniam vero voluptate voluptatem, voluptatum. Accusantium dicta dolores ea est libero rerum sapiente sit!\n    Accusantium cupiditate\n    eum ex molestiae praesentium provident saepe? Eveniet labore, rem. Aperiam, architecto at consectetur culpa cumque\n    debitis\n    dolorum eius eveniet fuga illo, in ipsum libero molestias necessitatibus nemo neque omnis perferendis perspiciatis\n    praesentium\n    quasi qui quia quod rerum saepe sed similique sunt suscipit tenetur totam ullam veritatis vitae voluptate\n    voluptatem. Assumenda\n    consequatur corporis dolorem doloremque ea inventore iusto sequi sit ut vitae! Adipisci alias aliquid aperiam\n    architecto asperiores\n    delectus dolore eaque eius eligendi fugiat incidunt ipsam iusto laborum magni maxime nam, necessitatibus nesciunt\n    omnis placeat\n    quaerat quibusdam rem, suscipit unde vel, veritatis vero voluptatum. Animi aut fuga impedit nostrum odit officia\n    quisquam,\n    repudiandae saepe suscipit voluptates! Ab autem beatae distinctio, dolorum eligendi est excepturi facere facilis\n    illo inventore\n    iure minus nemo nesciunt quaerat quibusdam repellendus sequi sint sit ullam voluptatem. Debitis ducimus excepturi\n    impedit\n    laudantium magnam nisi possimus, quae quod repellat sed sit tempora unde. Delectus eius laudantium quas quidem\n    similique sit\n    unde voluptas voluptate? Accusamus aut distinctio dolorum earum enim illo illum incidunt iure magni natus nulla\n    officiis\n    pariatur perspiciatis possimus quasi recusandae sint voluptas, voluptatibus. Ad aliquam amet, deleniti dignissimos,\n    eius enim\n    error excepturi hic magni quae qui quisquam repellendus rerum saepe similique suscipit temporibus vel voluptate. A\n    asperiores\n    at, dolores eligendi eum facere fuga impedit incidunt ipsam labore laborum magnam omnis placeat, quam quidem quos\n    similique\n    tenetur totam, vero voluptatibus. Ab asperiores autem cum delectus dicta dolor dolorum eos ex impedit libero nam\n    natus, necessitatibus");
			p4_nodes.forEach(detach_dev);
			this.h();
		},
		h: function hydrate() {
			document.title = "Test Title";
			add_location(span0, file, 50, 4, 729);
			attr_dev(div0, "class", "top-pic svelte-1kmv00v");
			add_location(div0, file, 57, 8, 916);
			attr_dev(li0, "class", "svelte-1kmv00v");
			add_location(li0, file, 62, 12, 1075);
			attr_dev(li1, "class", "svelte-1kmv00v");
			add_location(li1, file, 65, 12, 1195);
			attr_dev(li2, "class", "svelte-1kmv00v");
			add_location(li2, file, 68, 12, 1316);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 82, 20, 1789);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 83, 20, 1829);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 84, 20, 1870);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 81, 16, 1737);
			attr_dev(li3, "class", "svelte-1kmv00v");
			add_location(li3, file, 71, 12, 1438);
			attr_dev(ul, "class", "options svelte-1kmv00v");
			add_location(ul, file, 61, 8, 1042);
			attr_dev(section0, "class", "top svelte-1kmv00v");
			add_location(section0, file, 56, 4, 886);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file, 90, 4, 1972);
			attr_dev(section2, "class", "top-wrap svelte-1kmv00v");
			add_location(section2, file, 48, 0, 697);
			add_location(br0, file, 98, 4, 2144);
			add_location(br1, file, 99, 4, 2153);
			add_location(br2, file, 103, 4, 2214);
			add_location(br3, file, 104, 4, 2223);
			add_location(br4, file, 108, 4, 2282);
			add_location(br5, file, 109, 4, 2291);
			add_location(br6, file, 113, 4, 2351);
			add_location(br7, file, 114, 4, 2360);
			add_location(br8, file, 118, 4, 2418);
			add_location(br9, file, 119, 4, 2427);
			add_location(br10, file, 123, 4, 2488);
			add_location(br11, file, 124, 4, 2497);
			add_location(br12, file, 128, 4, 2556);
			add_location(br13, file, 129, 4, 2565);
			add_location(br14, file, 133, 4, 2628);
			add_location(br15, file, 134, 4, 2637);
			add_location(section3, file, 96, 0, 2129);
			attr_dev(span1, "class", "text-success");
			add_location(span1, file, 139, 10, 2712);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 139, 0, 2702);
			add_location(br16, file, 141, 0, 2761);
			add_location(br17, file, 142, 0, 2766);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 144, 0, 2772);
			add_location(br18, file, 146, 0, 2814);
			add_location(br19, file, 147, 0, 2819);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 149, 0, 2825);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 150, 0, 2861);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 151, 0, 2905);
			add_location(br20, file, 153, 0, 2951);
			add_location(br21, file, 154, 0, 2956);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 156, 0, 2962);
			add_location(br22, file, 158, 0, 3014);
			add_location(br23, file, 159, 0, 3019);
			add_location(br24, file, 163, 8, 3126);
			add_location(br25, file, 165, 8, 3155);
			add_location(br26, file, 166, 8, 3168);
			add_location(br27, file, 168, 8, 3244);
			add_location(br28, file, 169, 8, 3257);
			add_location(br29, file, 171, 8, 3346);
			add_location(br30, file, 172, 8, 3359);
			add_location(br31, file, 174, 8, 3465);
			add_location(br32, file, 175, 8, 3478);
			add_location(br33, file, 179, 8, 3605);
			add_location(br34, file, 180, 8, 3618);
			add_location(br35, file, 182, 8, 3725);
			add_location(br36, file, 183, 8, 3738);
			add_location(br37, file, 185, 8, 3844);
			add_location(br38, file, 186, 8, 3857);
			add_location(div1, file, 162, 4, 3112);
			add_location(br39, file, 190, 8, 3892);
			add_location(br40, file, 192, 8, 3930);
			add_location(br41, file, 193, 8, 3943);
			add_location(br42, file, 195, 8, 4028);
			add_location(br43, file, 196, 8, 4041);
			add_location(br44, file, 198, 8, 4139);
			add_location(br45, file, 199, 8, 4152);
			add_location(br46, file, 201, 8, 4250);
			add_location(br47, file, 202, 8, 4263);
			add_location(br48, file, 206, 8, 4399);
			add_location(br49, file, 207, 8, 4412);
			add_location(br50, file, 209, 8, 4528);
			add_location(br51, file, 210, 8, 4541);
			add_location(br52, file, 212, 8, 4656);
			add_location(br53, file, 213, 8, 4669);
			add_location(div2, file, 189, 4, 3878);
			set_style(section4, "text-align", "center");
			set_style(section4, "display", "flex");
			set_style(section4, "justify-content", "space-around");
			add_location(section4, file, 161, 0, 3025);
			add_location(br54, file, 217, 0, 4697);
			add_location(br55, file, 218, 0, 4702);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 220, 0, 4708);
			add_location(br56, file, 222, 0, 4751);
			add_location(br57, file, 223, 0, 4756);
			add_location(br58, file, 228, 4, 4821);
			add_location(br59, file, 229, 4, 4830);
			add_location(br60, file, 233, 4, 4913);
			add_location(br61, file, 234, 4, 4922);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 239, 8, 5011);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 240, 8, 5038);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 241, 8, 5065);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 238, 4, 4983);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 244, 4, 5105);
			attr_dev(input12, "id", "input");
			attr_dev(input12, "type", "text");
			input12.value = "text";
			add_location(input12, file, 245, 4, 5163);
			add_location(br62, file, 247, 4, 5212);
			add_location(br63, file, 248, 4, 5221);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 250, 4, 5231);
			add_location(br64, file, 252, 4, 5283);
			add_location(br65, file, 253, 4, 5292);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 255, 4, 5302);
			add_location(section5, file, 225, 0, 4762);
			add_location(br66, file, 258, 0, 5378);
			add_location(br67, file, 259, 0, 5383);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 261, 0, 5389);
			add_location(br68, file, 267, 0, 5513);
			add_location(br69, file, 268, 0, 5518);
			add_location(br70, file, 272, 0, 5590);
			add_location(br71, file, 273, 0, 5595);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 275, 0, 5601);
			add_location(strong, file, 278, 4, 5646);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 277, 0, 5638);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 283, 0, 5755);
		},
		m: function mount(target, anchor) {
			...
			append_dev(section5, t120);
			append_dev(section5, br65);
			append_dev(section5, t121);
			append_dev(section5, button15);
			append_dev(button15, t122);
