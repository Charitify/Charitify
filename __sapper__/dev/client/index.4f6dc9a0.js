...
import { B as Button, I as Input, P as ProgressNext, A as Avatar, R as Rate, D as Divider, F as Form, a as Icon, b as Picture } from './index.ed43e0fb.js';
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 165, 4, 4313);
			add_location(br1, file$2, 166, 4, 4322);
			add_location(br2, file$2, 170, 4, 4396);
			add_location(br3, file$2, 171, 4, 4405);
			add_location(br4, file$2, 175, 4, 4477);
			add_location(br5, file$2, 176, 4, 4486);
			add_location(br6, file$2, 180, 4, 4559);
			add_location(br7, file$2, 181, 4, 4568);
			add_location(br8, file$2, 185, 4, 4639);
			add_location(br9, file$2, 186, 4, 4648);
			add_location(br10, file$2, 190, 4, 4722);
			add_location(br11, file$2, 191, 4, 4731);
			add_location(br12, file$2, 195, 4, 4803);
			add_location(br13, file$2, 196, 4, 4812);
			add_location(br14, file$2, 200, 4, 4888);
			add_location(br15, file$2, 201, 4, 4897);
			add_location(br16, file$2, 205, 4, 4968);
			add_location(br17, file$2, 206, 4, 4977);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file$2, 139, 16, 3879);
			attr_dev(p0, "class", "svelte-1fydlyp");
			add_location(p0, file$2, 140, 16, 3919);
			attr_dev(span0, "class", "svelte-1fydlyp");
			add_location(span0, file$2, 138, 12, 3856);
			attr_dev(div1, "class", "ava-section svelte-1fydlyp");
			add_location(div1, file$2, 135, 8, 3740);
			attr_dev(section1, "class", "rate-section svelte-1fydlyp");
			add_location(section1, file$2, 134, 4, 3701);
			add_location(br1, file$2, 147, 4, 4020);
			attr_dev(h10, "class", "svelte-1fydlyp");
			add_location(h10, file$2, 149, 4, 4030);
			add_location(br2, file$2, 151, 4, 4059);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 153, 4, 4069);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 75, 0, 1681);
			add_location(br3, file$2, 158, 0, 4225);
			add_location(br4, file$2, 159, 0, 4230);
			attr_dev(h11, "class", "svelte-1fydlyp");
			add_location(h11, file$2, 211, 0, 5047);
			add_location(br5, file$2, 213, 0, 5115);
			add_location(br6, file$2, 214, 0, 5120);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 216, 0, 5126);
			add_location(br7, file$2, 218, 0, 5168);
			add_location(br8, file$2, 219, 0, 5173);
			add_location(p2, file$2, 221, 0, 5179);
			add_location(p3, file$2, 222, 0, 5215);
			add_location(p4, file$2, 223, 0, 5259);
			add_location(br9, file$2, 225, 0, 5305);
			add_location(br10, file$2, 226, 0, 5310);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 228, 0, 5316);
			add_location(span1, file$2, 232, 8, 5390);
			add_location(li5, file$2, 231, 4, 5377);
			add_location(span2, file$2, 239, 8, 5624);
			add_location(li6, file$2, 238, 4, 5611);
			add_location(span3, file$2, 246, 8, 5819);
			add_location(li7, file$2, 245, 4, 5806);
			add_location(ul1, file$2, 230, 0, 5368);
			add_location(br11, file$2, 254, 0, 6037);
			add_location(br12, file$2, 255, 0, 6042);
			add_location(br13, file$2, 259, 8, 6149);
			add_location(br14, file$2, 261, 8, 6178);
			add_location(br15, file$2, 262, 8, 6191);
			add_location(br16, file$2, 264, 8, 6267);
			add_location(br17, file$2, 265, 8, 6280);
			add_location(br18, file$2, 267, 8, 6369);
			add_location(br19, file$2, 268, 8, 6382);
			add_location(br20, file$2, 270, 8, 6488);
			add_location(br21, file$2, 271, 8, 6501);
			add_location(br22, file$2, 275, 8, 6628);
			add_location(br23, file$2, 276, 8, 6641);
			add_location(br24, file$2, 278, 8, 6748);
			add_location(br25, file$2, 279, 8, 6761);
			add_location(br26, file$2, 281, 8, 6867);
			add_location(br27, file$2, 282, 8, 6880);
			add_location(div2, file$2, 258, 4, 6135);
			add_location(br28, file$2, 286, 8, 6915);
			add_location(br29, file$2, 288, 8, 6953);
			add_location(br30, file$2, 289, 8, 6966);
			add_location(br31, file$2, 291, 8, 7051);
			add_location(br32, file$2, 292, 8, 7064);
			add_location(br33, file$2, 294, 8, 7162);
			add_location(br34, file$2, 295, 8, 7175);
			add_location(br35, file$2, 297, 8, 7273);
			add_location(br36, file$2, 298, 8, 7286);
			add_location(br37, file$2, 302, 8, 7422);
			add_location(br38, file$2, 303, 8, 7435);
			add_location(br39, file$2, 305, 8, 7551);
			add_location(br40, file$2, 306, 8, 7564);
			add_location(br41, file$2, 308, 8, 7679);
			add_location(br42, file$2, 309, 8, 7692);
			add_location(div3, file$2, 285, 4, 6901);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 257, 0, 6048);
			add_location(br43, file$2, 313, 0, 7720);
			add_location(br44, file$2, 314, 0, 7725);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 316, 0, 7731);
			add_location(br45, file$2, 318, 0, 7774);
			add_location(br46, file$2, 319, 0, 7779);
			add_location(br47, file$2, 324, 4, 7844);
			add_location(br48, file$2, 325, 4, 7853);
			add_location(br49, file$2, 329, 4, 7936);
			add_location(br50, file$2, 330, 4, 7945);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 335, 8, 8034);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 336, 8, 8061);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 337, 8, 8088);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 334, 4, 8006);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 340, 4, 8128);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 341, 4, 8186);
			add_location(br51, file$2, 343, 4, 8235);
			add_location(br52, file$2, 344, 4, 8244);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 346, 4, 8254);
			add_location(br53, file$2, 348, 4, 8306);
			add_location(br54, file$2, 349, 4, 8315);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 351, 4, 8325);
			add_location(section4, file$2, 321, 0, 7785);
			add_location(br55, file$2, 354, 0, 8401);
			add_location(br56, file$2, 355, 0, 8406);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 357, 0, 8412);
			add_location(br57, file$2, 359, 0, 8447);
			add_location(br58, file$2, 360, 0, 8452);
			add_location(br59, file$2, 364, 0, 8524);
			add_location(br60, file$2, 365, 0, 8529);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 367, 0, 8535);
			add_location(strong, file$2, 370, 4, 8580);
			add_location(p5, file$2, 369, 0, 8572);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 375, 0, 8689);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
