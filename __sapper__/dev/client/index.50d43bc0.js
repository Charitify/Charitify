...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			set_style(h61, "font-size", ".65em");
			add_location(h61, file, 73, 0, 2541);
			add_location(span11, file, 73, 46, 2587);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 75, 0, 2611);
			attr_dev(section, "class", "container");
			add_location(section, file, 79, 0, 2666);
		},
