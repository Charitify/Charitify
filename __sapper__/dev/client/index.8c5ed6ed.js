...
import { S as Swipe, B as Button, I as Input, P as Progress, a as ProgressNext, A as Avatar, R as Rate, D as Divider, F as Form, b as Icon, c as Picture, d as SwipeItem, C as CharityCard } from './index.54e15771.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-13boegw");
			add_location(li, file, 239, 12, 6330);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 254, 4, 6517);
			add_location(br1, file, 255, 4, 6526);
			add_location(br2, file, 259, 4, 6600);
			add_location(br3, file, 260, 4, 6609);
			add_location(br4, file, 264, 4, 6681);
			add_location(br5, file, 265, 4, 6690);
			add_location(br6, file, 269, 4, 6763);
			add_location(br7, file, 270, 4, 6772);
			add_location(br8, file, 274, 4, 6843);
			add_location(br9, file, 275, 4, 6852);
			add_location(br10, file, 279, 4, 6926);
			add_location(br11, file, 280, 4, 6935);
			add_location(br12, file, 284, 4, 7007);
			add_location(br13, file, 285, 4, 7016);
			add_location(br14, file, 289, 4, 7092);
			add_location(br15, file, 290, 4, 7101);
			add_location(br16, file, 294, 4, 7172);
			add_location(br17, file, 295, 4, 7181);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-13boegw");
			add_location(div0, file, 146, 8, 3629);
			attr_dev(li0, "class", "svelte-13boegw");
			add_location(li0, file, 167, 12, 4457);
			attr_dev(li1, "class", "svelte-13boegw");
			add_location(li1, file, 170, 12, 4577);
			attr_dev(li2, "class", "svelte-13boegw");
			add_location(li2, file, 173, 12, 4698);
			add_location(br0, file, 177, 16, 4841);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 188, 20, 5192);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 189, 20, 5232);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 190, 20, 5273);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 187, 16, 5140);
			attr_dev(li3, "class", "svelte-13boegw");
			add_location(li3, file, 176, 12, 4820);
			attr_dev(li4, "class", "svelte-13boegw");
			add_location(li4, file, 193, 12, 5353);
			attr_dev(ul0, "class", "options svelte-13boegw");
			add_location(ul0, file, 166, 8, 4424);
			attr_dev(section0, "class", "top svelte-13boegw");
			add_location(section0, file, 145, 4, 3599);
			add_location(br1, file, 200, 4, 5533);
			attr_dev(h3, "class", "svelte-13boegw");
			add_location(h3, file, 208, 16, 5766);
			attr_dev(p0, "class", "svelte-13boegw");
			add_location(p0, file, 209, 16, 5806);
			attr_dev(span0, "class", "svelte-13boegw");
			add_location(span0, file, 207, 12, 5743);
			attr_dev(div1, "class", "ava-section svelte-13boegw");
			add_location(div1, file, 204, 8, 5627);
			attr_dev(section1, "class", "rate-section svelte-13boegw");
			add_location(section1, file, 203, 4, 5588);
			add_location(br2, file, 216, 4, 5907);
			attr_dev(h10, "class", "svelte-13boegw");
			add_location(h10, file, 218, 4, 5917);
			add_location(br3, file, 220, 4, 5946);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 222, 4, 5956);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 144, 0, 3567);
			add_location(br4, file, 227, 0, 6112);
			add_location(br5, file, 228, 0, 6117);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 232, 4, 6176);
			add_location(br6, file, 235, 4, 6259);
			attr_dev(ul1, "class", "cards svelte-13boegw");
			add_location(ul1, file, 237, 4, 6269);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 230, 0, 6123);
			add_location(br7, file, 247, 0, 6429);
			add_location(br8, file, 248, 0, 6434);
			attr_dev(h11, "class", "svelte-13boegw");
			add_location(h11, file, 300, 0, 7251);
			add_location(br9, file, 302, 0, 7319);
			add_location(br10, file, 303, 0, 7324);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 305, 0, 7330);
			add_location(br11, file, 307, 0, 7372);
			add_location(br12, file, 308, 0, 7377);
			add_location(p2, file, 310, 0, 7383);
			add_location(p3, file, 311, 0, 7419);
			add_location(p4, file, 312, 0, 7463);
			add_location(br13, file, 314, 0, 7509);
			add_location(br14, file, 315, 0, 7514);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 317, 0, 7520);
			add_location(span1, file, 321, 8, 7594);
			add_location(li5, file, 320, 4, 7581);
			add_location(span2, file, 328, 8, 7828);
			add_location(li6, file, 327, 4, 7815);
			add_location(span3, file, 335, 8, 8023);
			add_location(li7, file, 334, 4, 8010);
			add_location(ul2, file, 319, 0, 7572);
			add_location(br15, file, 343, 0, 8241);
			add_location(br16, file, 344, 0, 8246);
			add_location(br17, file, 348, 8, 8353);
			add_location(br18, file, 350, 8, 8382);
			add_location(br19, file, 351, 8, 8395);
			add_location(br20, file, 353, 8, 8471);
			add_location(br21, file, 354, 8, 8484);
			add_location(br22, file, 356, 8, 8573);
			add_location(br23, file, 357, 8, 8586);
			add_location(br24, file, 359, 8, 8692);
			add_location(br25, file, 360, 8, 8705);
			add_location(br26, file, 364, 8, 8832);
			add_location(br27, file, 365, 8, 8845);
			add_location(br28, file, 367, 8, 8952);
			add_location(br29, file, 368, 8, 8965);
			add_location(br30, file, 370, 8, 9071);
			add_location(br31, file, 371, 8, 9084);
			add_location(div3, file, 347, 4, 8339);
			add_location(br32, file, 375, 8, 9119);
			add_location(br33, file, 377, 8, 9157);
			add_location(br34, file, 378, 8, 9170);
			add_location(br35, file, 380, 8, 9255);
			add_location(br36, file, 381, 8, 9268);
			add_location(br37, file, 383, 8, 9366);
			add_location(br38, file, 384, 8, 9379);
			add_location(br39, file, 386, 8, 9477);
			add_location(br40, file, 387, 8, 9490);
			add_location(br41, file, 391, 8, 9626);
			add_location(br42, file, 392, 8, 9639);
			add_location(br43, file, 394, 8, 9755);
			add_location(br44, file, 395, 8, 9768);
			add_location(br45, file, 397, 8, 9883);
			add_location(br46, file, 398, 8, 9896);
			add_location(div4, file, 374, 4, 9105);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 346, 0, 8252);
			add_location(br47, file, 402, 0, 9924);
			add_location(br48, file, 403, 0, 9929);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 405, 0, 9935);
			add_location(br49, file, 407, 0, 9978);
			add_location(br50, file, 408, 0, 9983);
			add_location(br51, file, 413, 4, 10048);
			add_location(br52, file, 414, 4, 10057);
			add_location(br53, file, 418, 4, 10140);
			add_location(br54, file, 419, 4, 10149);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 424, 8, 10238);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 425, 8, 10265);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 426, 8, 10292);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 423, 4, 10210);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 429, 4, 10332);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 430, 4, 10390);
			add_location(br55, file, 432, 4, 10439);
			add_location(br56, file, 433, 4, 10448);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 435, 4, 10458);
			add_location(br57, file, 437, 4, 10510);
			add_location(br58, file, 438, 4, 10519);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 440, 4, 10529);
			add_location(section4, file, 410, 0, 9989);
			add_location(br59, file, 443, 0, 10605);
			add_location(br60, file, 444, 0, 10610);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 446, 0, 10616);
			add_location(br61, file, 448, 0, 10651);
			add_location(br62, file, 449, 0, 10656);
			add_location(br63, file, 453, 0, 10728);
			add_location(br64, file, 454, 0, 10733);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 456, 0, 10739);
			add_location(strong, file, 459, 4, 10784);
			add_location(p5, file, 458, 0, 10776);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 464, 0, 10893);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
