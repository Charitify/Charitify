...
function create_else_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(input, "svelte-cljkuc", true);
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			toggle_class(textarea, "svelte-cljkuc", true);
