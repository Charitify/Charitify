...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h4, "class", "svelte-l880kn");
			add_location(h4, file$9, 13, 12, 268);
			attr_dev(sub, "class", "svelte-l880kn");
			add_location(sub, file$9, 14, 12, 297);
			attr_dev(span, "class", "svelte-l880kn");
			add_location(span, file$9, 12, 8, 249);
			attr_dev(br, "class", "svelte-l880kn");
			add_location(br, file$9, 17, 8, 344);
			attr_dev(pre, "class", "svelte-l880kn");
			add_location(pre, file$9, 19, 8, 358);
			attr_dev(div, "class", "svelte-l880kn");
			add_location(div, file$9, 11, 4, 235);
			attr_dev(section, "class", "svelte-l880kn");
