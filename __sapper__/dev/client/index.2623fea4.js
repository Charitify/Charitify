...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h3, file$b, 44, 16, 1330);
			attr_dev(p1, "class", "svelte-onscs3");
			add_location(p1, file$b, 45, 16, 1370);
			attr_dev(span, "class", "svelte-onscs3");
			add_location(span, file$b, 43, 12, 1307);
			attr_dev(div1, "class", "ava-section svelte-onscs3");
			add_location(div1, file$b, 40, 8, 1191);
			add_location(footer, file$b, 39, 4, 1174);
