...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$2, 163, 4, 4246);
			add_location(br1, file$2, 164, 4, 4255);
			add_location(br2, file$2, 168, 4, 4329);
			add_location(br3, file$2, 169, 4, 4338);
			add_location(br4, file$2, 173, 4, 4410);
			add_location(br5, file$2, 174, 4, 4419);
			add_location(br6, file$2, 178, 4, 4492);
			add_location(br7, file$2, 179, 4, 4501);
			add_location(br8, file$2, 183, 4, 4572);
			add_location(br9, file$2, 184, 4, 4581);
			add_location(br10, file$2, 188, 4, 4655);
			add_location(br11, file$2, 189, 4, 4664);
			add_location(br12, file$2, 193, 4, 4736);
			add_location(br13, file$2, 194, 4, 4745);
			add_location(br14, file$2, 198, 4, 4821);
			add_location(br15, file$2, 199, 4, 4830);
			add_location(br16, file$2, 203, 4, 4901);
			add_location(br17, file$2, 204, 4, 4910);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$2, 77, 8, 1729);
			attr_dev(li0, "class", "svelte-1fydlyp");
			add_location(li0, file$2, 98, 12, 2557);
			attr_dev(li1, "class", "svelte-1fydlyp");
			add_location(li1, file$2, 101, 12, 2677);
			attr_dev(li2, "class", "svelte-1fydlyp");
			add_location(li2, file$2, 104, 12, 2798);
			add_location(br0, file$2, 108, 16, 2941);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file$2, 119, 20, 3292);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file$2, 120, 20, 3332);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file$2, 121, 20, 3373);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file$2, 118, 16, 3240);
			attr_dev(li3, "class", "svelte-1fydlyp");
			add_location(li3, file$2, 107, 12, 2920);
			attr_dev(li4, "class", "svelte-1fydlyp");
			add_location(li4, file$2, 124, 12, 3453);
			attr_dev(ul0, "class", "options svelte-1fydlyp");
			add_location(ul0, file$2, 97, 8, 2524);
			attr_dev(section0, "class", "top svelte-1fydlyp");
			add_location(section0, file$2, 76, 4, 1699);
			attr_dev(h3, "class", "svelte-1fydlyp");
			add_location(h3, file$2, 137, 16, 3812);
			attr_dev(p0, "class", "svelte-1fydlyp");
			add_location(p0, file$2, 138, 16, 3852);
			attr_dev(span0, "class", "svelte-1fydlyp");
			add_location(span0, file$2, 136, 12, 3789);
			attr_dev(div1, "class", "ava-section svelte-1fydlyp");
			add_location(div1, file$2, 133, 8, 3673);
			attr_dev(section1, "class", "rate-section svelte-1fydlyp");
			add_location(section1, file$2, 132, 4, 3634);
			add_location(br1, file$2, 145, 4, 3953);
			attr_dev(h10, "class", "svelte-1fydlyp");
			add_location(h10, file$2, 147, 4, 3963);
			add_location(br2, file$2, 149, 4, 3992);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file$2, 151, 4, 4002);
			attr_dev(section2, "class", "container");
			add_location(section2, file$2, 75, 0, 1667);
			add_location(br3, file$2, 156, 0, 4158);
			add_location(br4, file$2, 157, 0, 4163);
			attr_dev(h11, "class", "svelte-1fydlyp");
			add_location(h11, file$2, 209, 0, 4980);
			add_location(br5, file$2, 211, 0, 5048);
			add_location(br6, file$2, 212, 0, 5053);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file$2, 214, 0, 5059);
			add_location(br7, file$2, 216, 0, 5101);
			add_location(br8, file$2, 217, 0, 5106);
			add_location(p2, file$2, 219, 0, 5112);
			add_location(p3, file$2, 220, 0, 5148);
			add_location(p4, file$2, 221, 0, 5192);
			add_location(br9, file$2, 223, 0, 5238);
			add_location(br10, file$2, 224, 0, 5243);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file$2, 226, 0, 5249);
			add_location(span1, file$2, 230, 8, 5323);
			add_location(li5, file$2, 229, 4, 5310);
			add_location(span2, file$2, 237, 8, 5557);
			add_location(li6, file$2, 236, 4, 5544);
			add_location(span3, file$2, 244, 8, 5752);
			add_location(li7, file$2, 243, 4, 5739);
			add_location(ul1, file$2, 228, 0, 5301);
			add_location(br11, file$2, 252, 0, 5970);
			add_location(br12, file$2, 253, 0, 5975);
			add_location(br13, file$2, 257, 8, 6082);
			add_location(br14, file$2, 259, 8, 6111);
			add_location(br15, file$2, 260, 8, 6124);
			add_location(br16, file$2, 262, 8, 6200);
			add_location(br17, file$2, 263, 8, 6213);
			add_location(br18, file$2, 265, 8, 6302);
			add_location(br19, file$2, 266, 8, 6315);
			add_location(br20, file$2, 268, 8, 6421);
			add_location(br21, file$2, 269, 8, 6434);
			add_location(br22, file$2, 273, 8, 6561);
			add_location(br23, file$2, 274, 8, 6574);
			add_location(br24, file$2, 276, 8, 6681);
			add_location(br25, file$2, 277, 8, 6694);
			add_location(br26, file$2, 279, 8, 6800);
			add_location(br27, file$2, 280, 8, 6813);
			add_location(div2, file$2, 256, 4, 6068);
			add_location(br28, file$2, 284, 8, 6848);
			add_location(br29, file$2, 286, 8, 6886);
			add_location(br30, file$2, 287, 8, 6899);
			add_location(br31, file$2, 289, 8, 6984);
			add_location(br32, file$2, 290, 8, 6997);
			add_location(br33, file$2, 292, 8, 7095);
			add_location(br34, file$2, 293, 8, 7108);
			add_location(br35, file$2, 295, 8, 7206);
			add_location(br36, file$2, 296, 8, 7219);
			add_location(br37, file$2, 300, 8, 7355);
			add_location(br38, file$2, 301, 8, 7368);
			add_location(br39, file$2, 303, 8, 7484);
			add_location(br40, file$2, 304, 8, 7497);
			add_location(br41, file$2, 306, 8, 7612);
			add_location(br42, file$2, 307, 8, 7625);
			add_location(div3, file$2, 283, 4, 6834);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file$2, 255, 0, 5981);
			add_location(br43, file$2, 311, 0, 7653);
			add_location(br44, file$2, 312, 0, 7658);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file$2, 314, 0, 7664);
			add_location(br45, file$2, 316, 0, 7707);
			add_location(br46, file$2, 317, 0, 7712);
			add_location(br47, file$2, 322, 4, 7777);
			add_location(br48, file$2, 323, 4, 7786);
			add_location(br49, file$2, 327, 4, 7869);
			add_location(br50, file$2, 328, 4, 7878);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file$2, 333, 8, 7967);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file$2, 334, 8, 7994);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file$2, 335, 8, 8021);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file$2, 332, 4, 7939);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file$2, 338, 4, 8061);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file$2, 339, 4, 8119);
			add_location(br51, file$2, 341, 4, 8168);
			add_location(br52, file$2, 342, 4, 8177);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file$2, 344, 4, 8187);
			add_location(br53, file$2, 346, 4, 8239);
			add_location(br54, file$2, 347, 4, 8248);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file$2, 349, 4, 8258);
			add_location(section4, file$2, 319, 0, 7718);
			add_location(br55, file$2, 352, 0, 8334);
			add_location(br56, file$2, 353, 0, 8339);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file$2, 355, 0, 8345);
			add_location(br57, file$2, 357, 0, 8380);
			add_location(br58, file$2, 358, 0, 8385);
			add_location(br59, file$2, 362, 0, 8457);
			add_location(br60, file$2, 363, 0, 8462);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file$2, 365, 0, 8468);
			add_location(strong, file$2, 368, 4, 8513);
			add_location(p5, file$2, 367, 0, 8505);
			set_style(p6, "text-align", "justify");
			add_location(p6, file$2, 373, 0, 8622);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
