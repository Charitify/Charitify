...
// (146:4) <Button is="success" type="submit">
function create_default_slot_14(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(146:4) <Button is=\\\"success\\\" type=\\\"submit\\\">",
		ctx
	});
...
// (102:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 102, 4, 2454);
			add_location(br1, file, 103, 4, 2463);
			add_location(br2, file, 107, 4, 2537);
			add_location(br3, file, 108, 4, 2546);
			add_location(br4, file, 112, 4, 2618);
			add_location(br5, file, 113, 4, 2627);
			add_location(br6, file, 117, 4, 2700);
			add_location(br7, file, 118, 4, 2709);
			add_location(br8, file, 122, 4, 2780);
			add_location(br9, file, 123, 4, 2789);
			add_location(br10, file, 127, 4, 2863);
			add_location(br11, file, 128, 4, 2872);
			add_location(br12, file, 132, 4, 2944);
			add_location(br13, file, 133, 4, 2953);
			add_location(br14, file, 137, 4, 3029);
			add_location(br15, file, 138, 4, 3038);
			add_location(br16, file, 142, 4, 3109);
			add_location(br17, file, 143, 4, 3118);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(102:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
// (201:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_12(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(201:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (204:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(204:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (207:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(207:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (211:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(211:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (215:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(215:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (218:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(218:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (228:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(228:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (231:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(231:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (242:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(242:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (245:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(245:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (297:0) <Picture alt="Borat" src="great-success.png" class="picture">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(297:0) <Picture alt=\\\"Borat\\\" src=\\\"great-success.png\\\" class=\\\"picture\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 148, 0, 3188);
			add_location(br1, file, 150, 0, 3256);
			add_location(br2, file, 151, 0, 3261);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 153, 0, 3267);
			add_location(br3, file, 155, 0, 3309);
			add_location(br4, file, 156, 0, 3314);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 158, 0, 3320);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 159, 0, 3356);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 160, 0, 3400);
			add_location(br5, file, 162, 0, 3446);
			add_location(br6, file, 163, 0, 3451);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 165, 0, 3457);
			add_location(span1, file, 169, 8, 3531);
			add_location(li5, file, 168, 4, 3518);
			add_location(span2, file, 176, 8, 3765);
			add_location(li6, file, 175, 4, 3752);
			add_location(span3, file, 183, 8, 3960);
			add_location(li7, file, 182, 4, 3947);
			add_location(ul1, file, 167, 0, 3509);
			add_location(br7, file, 191, 0, 4178);
			add_location(br8, file, 192, 0, 4183);
			add_location(br9, file, 196, 8, 4290);
			add_location(br10, file, 198, 8, 4319);
			add_location(br11, file, 199, 8, 4332);
			add_location(br12, file, 201, 8, 4408);
			add_location(br13, file, 202, 8, 4421);
			add_location(br14, file, 204, 8, 4510);
			add_location(br15, file, 205, 8, 4523);
			add_location(br16, file, 207, 8, 4629);
			add_location(br17, file, 208, 8, 4642);
			add_location(br18, file, 212, 8, 4769);
			add_location(br19, file, 213, 8, 4782);
			add_location(br20, file, 215, 8, 4889);
			add_location(br21, file, 216, 8, 4902);
			add_location(br22, file, 218, 8, 5008);
			add_location(br23, file, 219, 8, 5021);
			add_location(div1, file, 195, 4, 4276);
			add_location(br24, file, 223, 8, 5056);
			add_location(br25, file, 225, 8, 5094);
			add_location(br26, file, 226, 8, 5107);
			add_location(br27, file, 228, 8, 5192);
			add_location(br28, file, 229, 8, 5205);
			add_location(br29, file, 231, 8, 5303);
			add_location(br30, file, 232, 8, 5316);
			add_location(br31, file, 234, 8, 5414);
			add_location(br32, file, 235, 8, 5427);
			add_location(br33, file, 239, 8, 5563);
			add_location(br34, file, 240, 8, 5576);
			add_location(br35, file, 242, 8, 5692);
			add_location(br36, file, 243, 8, 5705);
			add_location(br37, file, 245, 8, 5820);
			add_location(br38, file, 246, 8, 5833);
			add_location(div2, file, 222, 4, 5042);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 194, 0, 4189);
			add_location(br39, file, 250, 0, 5861);
			add_location(br40, file, 251, 0, 5866);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 253, 0, 5872);
			add_location(br41, file, 255, 0, 5915);
			add_location(br42, file, 256, 0, 5920);
			add_location(br43, file, 261, 4, 5985);
			add_location(br44, file, 262, 4, 5994);
			add_location(br45, file, 266, 4, 6077);
			add_location(br46, file, 267, 4, 6086);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 272, 8, 6175);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 273, 8, 6202);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 274, 8, 6229);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 271, 4, 6147);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 277, 4, 6269);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 278, 4, 6327);
			add_location(br47, file, 280, 4, 6376);
			add_location(br48, file, 281, 4, 6385);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 283, 4, 6395);
			add_location(br49, file, 285, 4, 6447);
			add_location(br50, file, 286, 4, 6456);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 288, 4, 6466);
			add_location(section4, file, 258, 0, 5926);
			add_location(br51, file, 291, 0, 6542);
			add_location(br52, file, 292, 0, 6547);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 294, 0, 6553);
			add_location(br53, file, 300, 0, 6677);
			add_location(br54, file, 301, 0, 6682);
			add_location(br55, file, 305, 0, 6754);
			add_location(br56, file, 306, 0, 6759);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 308, 0, 6765);
			add_location(strong, file, 311, 4, 6810);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 310, 0, 6802);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 316, 0, 6919);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
