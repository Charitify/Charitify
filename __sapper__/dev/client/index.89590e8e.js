...
function create_fragment$9(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$9, 20, 6, 433);
			add_location(li0, file$9, 20, 2, 429);
			attr_dev(a1, "href", "about");
			attr_dev(a1, "class", "svelte-ij5g36");
			toggle_class(a1, "selected", /*segment*/ ctx[0] === "about");
			add_location(a1, file$9, 21, 6, 506);
			add_location(li1, file$9, 21, 2, 502);
			attr_dev(a2, "rel", "prefetch");
			attr_dev(a2, "href", "blog");
			attr_dev(a2, "class", "svelte-ij5g36");
			toggle_class(a2, "selected", /*segment*/ ctx[0] === "blog");
			add_location(a2, file$9, 25, 6, 740);
			add_location(li2, file$9, 25, 2, 736);
			add_location(ul, file$9, 19, 1, 422);
			option0.__value = "ua";
			option0.value = option0.__value;
			add_location(option0, file$9, 30, 6, 936);
			option1.__value = "ru";
			option1.value = option1.__value;
			add_location(option1, file$9, 31, 6, 973);
			option2.__value = "en";
			option2.value = option2.__value;
			add_location(option2, file$9, 32, 6, 1010);
			attr_dev(select, "name", "lang");
			attr_dev(select, "id", "lang");
			attr_dev(select, "class", "btn small lang-select svelte-ij5g36");
			add_location(select, file$9, 29, 4, 861);
			attr_dev(span, "class", "nav-actions svelte-ij5g36");
			add_location(span, file$9, 28, 2, 830);
			attr_dev(nav, "class", "theme-bg container svelte-ij5g36");
			add_location(nav, file$9, 18, 0, 388);
		},
		m: function mount(target, anchor) {
...
function instance$9($$self, $$props, $$invalidate) {
	...
	function changeTheme() {
		...
		document.body.classList.add(isDarkTheme ? "theme-2" : "theme-1");
	}
