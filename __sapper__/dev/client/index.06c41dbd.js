...
const get_default_slot_context = ctx => ({ item: "item" });
...
function create_fragment$f(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$f, 13, 4, 384);
			attr_dev(h4, "class", "svelte-do16pj");
			add_location(h4, file$f, 19, 4, 498);
			attr_dev(div1, "class", "rate-wrap svelte-do16pj");
			add_location(div1, file$f, 21, 4, 520);
			add_location(footer, file$f, 25, 4, 589);
			attr_dev(section, "class", "card svelte-do16pj");
			add_location(section, file$f, 12, 0, 357);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function instance$d($$self, $$props, $$invalidate) {
	...
	return [title, percent, orgHead, orgHeadSrc, organization, src];
}
