...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(li, "class", "svelte-nun1cl");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "class", "top-pic svelte-nun1cl");
			add_location(div0, file, 146, 8, 3694);
			attr_dev(li0, "class", "svelte-nun1cl");
			add_location(li0, file, 167, 12, 4522);
			attr_dev(li1, "class", "svelte-nun1cl");
			add_location(li1, file, 170, 12, 4642);
			attr_dev(li2, "class", "svelte-nun1cl");
			...
			attr_dev(li3, "class", "svelte-nun1cl");
			add_location(li3, file, 176, 12, 4885);
			attr_dev(li4, "class", "svelte-nun1cl");
			add_location(li4, file, 193, 12, 5418);
			attr_dev(ul0, "class", "options svelte-nun1cl");
			add_location(ul0, file, 166, 8, 4489);
			attr_dev(section0, "class", "top svelte-nun1cl");
			add_location(section0, file, 145, 4, 3664);
			add_location(br1, file, 200, 4, 5598);
			attr_dev(h3, "class", "svelte-nun1cl");
			add_location(h3, file, 208, 16, 5831);
			attr_dev(p0, "class", "svelte-nun1cl");
			add_location(p0, file, 209, 16, 5871);
			attr_dev(span0, "class", "svelte-nun1cl");
			add_location(span0, file, 207, 12, 5808);
			attr_dev(div1, "class", "ava-section svelte-nun1cl");
			add_location(div1, file, 204, 8, 5692);
			attr_dev(section1, "class", "rate-section svelte-nun1cl");
			add_location(section1, file, 203, 4, 5653);
			add_location(br2, file, 216, 4, 5972);
			attr_dev(h10, "class", "svelte-nun1cl");
			...
			attr_dev(ul1, "class", "cards svelte-nun1cl");
			...
			attr_dev(h11, "class", "svelte-nun1cl");
