...
function create_fragment$5(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(div0, "class", "progress-core svelte-db7hl6");
			attr_dev(div0, "style", div0_style_value = `width:${/*val*/ ctx[1]}%`);
			add_location(div0, file$5, 29, 8, 800);
			attr_dev(div1, "class", "progress-inner-frame svelte-db7hl6");
			add_location(div1, file$5, 28, 4, 757);
			attr_dev(div2, "id", /*id*/ ctx[0]);
			attr_dev(div2, "class", div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-db7hl6"));
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*classProp*/ 16 && div2_class_value !== (div2_class_value = "" + (null_to_empty(/*classProp*/ ctx[4]) + " svelte-db7hl6"))) {
