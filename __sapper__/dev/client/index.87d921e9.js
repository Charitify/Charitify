...
function create_fragment$h(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$h, 6, 4, 251);
			add_location(br, file$h, 7, 4, 272);
			add_location(p, file$h, 8, 4, 281);
			attr_dev(section, "class", "svelte-1qydgyt");
			add_location(section, file$h, 5, 0, 237);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
...
function instance$f($$self, $$props, $$invalidate) {
	const title = "The main title that explains everything the charity.";
	const subtitle = "And bigger description that describes in short keywords a charity, title above and just makes text longer.";
