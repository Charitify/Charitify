...
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(br2, file, 119, 4, 2855);
			add_location(br3, file, 120, 4, 2864);
			add_location(br4, file, 124, 4, 2936);
			add_location(br5, file, 125, 4, 2945);
			add_location(br6, file, 129, 4, 3018);
			add_location(br7, file, 130, 4, 3027);
			add_location(br8, file, 134, 4, 3098);
			add_location(br9, file, 135, 4, 3107);
			add_location(br10, file, 139, 4, 3181);
			add_location(br11, file, 140, 4, 3190);
			add_location(br12, file, 144, 4, 3262);
			add_location(br13, file, 145, 4, 3271);
			add_location(br14, file, 149, 4, 3347);
			add_location(br15, file, 150, 4, 3356);
			add_location(br16, file, 154, 4, 3427);
			add_location(br17, file, 155, 4, 3436);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 160, 0, 3506);
			add_location(br0, file, 162, 0, 3574);
			add_location(br1, file, 163, 0, 3579);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 165, 0, 3585);
			add_location(br2, file, 167, 0, 3627);
			add_location(br3, file, 168, 0, 3632);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 170, 0, 3638);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 171, 0, 3674);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 172, 0, 3718);
			add_location(br4, file, 174, 0, 3764);
			add_location(br5, file, 175, 0, 3769);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 177, 0, 3775);
			add_location(br6, file, 179, 0, 3827);
			add_location(br7, file, 180, 0, 3832);
			add_location(br8, file, 184, 8, 3939);
			add_location(br9, file, 186, 8, 3968);
			add_location(br10, file, 187, 8, 3981);
			add_location(br11, file, 189, 8, 4057);
			add_location(br12, file, 190, 8, 4070);
			add_location(br13, file, 192, 8, 4159);
			add_location(br14, file, 193, 8, 4172);
			add_location(br15, file, 195, 8, 4278);
			add_location(br16, file, 196, 8, 4291);
			add_location(br17, file, 200, 8, 4418);
			add_location(br18, file, 201, 8, 4431);
			add_location(br19, file, 203, 8, 4538);
			add_location(br20, file, 204, 8, 4551);
			add_location(br21, file, 206, 8, 4657);
			add_location(br22, file, 207, 8, 4670);
			add_location(div1, file, 183, 4, 3925);
			add_location(br23, file, 211, 8, 4705);
			add_location(br24, file, 213, 8, 4743);
			add_location(br25, file, 214, 8, 4756);
			add_location(br26, file, 216, 8, 4841);
			add_location(br27, file, 217, 8, 4854);
			add_location(br28, file, 219, 8, 4952);
			add_location(br29, file, 220, 8, 4965);
			add_location(br30, file, 222, 8, 5063);
			add_location(br31, file, 223, 8, 5076);
			add_location(br32, file, 227, 8, 5212);
			add_location(br33, file, 228, 8, 5225);
			add_location(br34, file, 230, 8, 5341);
			add_location(br35, file, 231, 8, 5354);
			add_location(br36, file, 233, 8, 5469);
			add_location(br37, file, 234, 8, 5482);
			add_location(div2, file, 210, 4, 4691);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 182, 0, 3838);
			add_location(br38, file, 238, 0, 5510);
			add_location(br39, file, 239, 0, 5515);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 241, 0, 5521);
			add_location(br40, file, 243, 0, 5564);
			add_location(br41, file, 244, 0, 5569);
			add_location(br42, file, 249, 4, 5634);
			add_location(br43, file, 250, 4, 5643);
			add_location(br44, file, 254, 4, 5726);
			add_location(br45, file, 255, 4, 5735);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 260, 8, 5824);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 261, 8, 5851);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 262, 8, 5878);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 259, 4, 5796);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 265, 4, 5918);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 266, 4, 5976);
			add_location(br46, file, 268, 4, 6025);
			add_location(br47, file, 269, 4, 6034);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 271, 4, 6044);
			add_location(br48, file, 273, 4, 6096);
			add_location(br49, file, 274, 4, 6105);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 276, 4, 6115);
			add_location(section4, file, 246, 0, 5575);
			add_location(br50, file, 279, 0, 6191);
			add_location(br51, file, 280, 0, 6196);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 282, 0, 6202);
			add_location(br52, file, 288, 0, 6326);
			add_location(br53, file, 289, 0, 6331);
			add_location(br54, file, 293, 0, 6403);
			add_location(br55, file, 294, 0, 6408);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 296, 0, 6414);
			add_location(strong, file, 299, 4, 6459);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 298, 0, 6451);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 304, 0, 6568);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
