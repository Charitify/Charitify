...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file$8, 43, 8, 1322);
			attr_dev(div1, "class", "progress-inner-frame svelte-1kjumgy");
			add_location(div1, file$8, 42, 4, 1279);
			...
			attr_dev(div2, "style", div2_style_value = `${getBorders(/*borders*/ ctx[1])}`);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*borders*/ 2 && div2_style_value !== (div2_style_value = `${getBorders(/*borders*/ ctx[1])}`)) {
