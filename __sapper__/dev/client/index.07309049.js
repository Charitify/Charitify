...
function create_each_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h3, "class", "svelte-skzzst");
			add_location(h3, file$k, 28, 12, 982);
			attr_dev(p, "class", "svelte-skzzst");
			add_location(p, file$k, 29, 12, 1016);
			add_location(br, file$k, 30, 12, 1047);
			attr_dev(li, "class", "svelte-skzzst");
...
function create_fragment$k(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-skzzst");
