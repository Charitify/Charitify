...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			t9 = space();
			h3 = element("h3");
			t10 = text("Main title 3");
			span3 = element("span");
			t11 = text("with text");
			t12 = space();
			h4 = element("h4");
			t13 = text("Main title 4");
			span4 = element("span");
			t14 = text("with text");
			t15 = space();
			h5 = element("h5");
			t16 = text("Main title 5");
			span5 = element("span");
			t17 = text("with text");
			t18 = space();
			h6 = element("h6");
			t19 = text("Main title 6");
			span6 = element("span");
			t20 = text("with text");
			t21 = space();
			div = element("div");
		...
		l: function claim(nodes) {
			...
			t7 = claim_text(h2_nodes, "Main title 2");
			...
			t10 = claim_text(h3_nodes, "Main title 3");
			...
			t13 = claim_text(h4_nodes, "Main title 4");
			...
			t16 = claim_text(h5_nodes, "Main title 5");
			...
			t19 = claim_text(h6_nodes, "Main title 6");
		...
		h: function hydrate() {
			...
			set_style(h11, "font-size", "4em");
			add_location(h11, file, 63, 0, 1979);
			add_location(span1, file, 63, 44, 2023);
			add_location(h2, file, 64, 0, 2046);
			add_location(span2, file, 64, 21, 2067);
			add_location(h3, file, 65, 0, 2090);
			add_location(span3, file, 65, 21, 2111);
			add_location(h4, file, 66, 0, 2134);
			add_location(span4, file, 66, 21, 2155);
			add_location(h5, file, 67, 0, 2178);
			add_location(span5, file, 67, 21, 2199);
			add_location(h6, file, 68, 0, 2222);
			add_location(span6, file, 68, 21, 2243);
			attr_dev(div, "class", "top-pic svelte-sujd4x");
			add_location(div, file, 70, 0, 2267);
			attr_dev(section, "class", "container");
			add_location(section, file, 74, 0, 2322);
		},
