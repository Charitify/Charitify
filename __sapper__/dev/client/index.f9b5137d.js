...
function create_fragment$h(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$h, 7, 4, 252);
			add_location(br, file$h, 8, 4, 273);
			add_location(p, file$h, 9, 4, 282);
			attr_dev(section, "class", "svelte-1qydgyt");
			add_location(section, file$h, 6, 0, 238);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
