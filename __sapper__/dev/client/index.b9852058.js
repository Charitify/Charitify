...
function create_fragment$8(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(div0, "style", div0_style_value = `width:${/*val*/ ctx[2]}%;${getBorderRadius(/*borderRadius*/ ctx[1])}`);
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*val, borderRadius*/ 6 && div0_style_value !== (div0_style_value = `width:${/*val*/ ctx[2]}%;${getBorderRadius(/*borderRadius*/ ctx[1])}`)) {
