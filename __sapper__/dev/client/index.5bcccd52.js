...
function create_fragment$e(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			h4_nodes.forEach(detach_dev);
			t2 = claim_space(span_nodes);
			br = claim_element(span_nodes, "BR", { size: true });
