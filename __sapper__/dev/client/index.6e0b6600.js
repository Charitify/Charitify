...
import { P as Picture, B as Button, I as Input, a as Icon, b as Progress, F as Form } from './index.85ddee6b.js';
...
// (114:0) <Form on:submit="{(e) => console.log(e)}" name="main-form">
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 114, 4, 2789);
			add_location(br1, file, 115, 4, 2798);
			add_location(br2, file, 119, 4, 2872);
			add_location(br3, file, 120, 4, 2881);
			add_location(br4, file, 124, 4, 2953);
			add_location(br5, file, 125, 4, 2962);
			add_location(br6, file, 129, 4, 3035);
			add_location(br7, file, 130, 4, 3044);
			add_location(br8, file, 134, 4, 3115);
			add_location(br9, file, 135, 4, 3124);
			add_location(br10, file, 139, 4, 3198);
			add_location(br11, file, 140, 4, 3207);
			add_location(br12, file, 144, 4, 3279);
			add_location(br13, file, 145, 4, 3288);
			add_location(br14, file, 149, 4, 3364);
			add_location(br15, file, 150, 4, 3373);
			add_location(br16, file, 154, 4, 3444);
			add_location(br17, file, 155, 4, 3453);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(114:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\" name=\\\"main-form\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h1, file, 160, 0, 3523);
			add_location(br0, file, 162, 0, 3591);
			add_location(br1, file, 163, 0, 3596);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 165, 0, 3602);
			add_location(br2, file, 167, 0, 3644);
			add_location(br3, file, 168, 0, 3649);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 170, 0, 3655);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 171, 0, 3691);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 172, 0, 3735);
			add_location(br4, file, 174, 0, 3781);
			add_location(br5, file, 175, 0, 3786);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 177, 0, 3792);
			add_location(br6, file, 179, 0, 3844);
			add_location(br7, file, 180, 0, 3849);
			add_location(br8, file, 184, 8, 3956);
			add_location(br9, file, 186, 8, 3985);
			add_location(br10, file, 187, 8, 3998);
			add_location(br11, file, 189, 8, 4074);
			add_location(br12, file, 190, 8, 4087);
			add_location(br13, file, 192, 8, 4176);
			add_location(br14, file, 193, 8, 4189);
			add_location(br15, file, 195, 8, 4295);
			add_location(br16, file, 196, 8, 4308);
			add_location(br17, file, 200, 8, 4435);
			add_location(br18, file, 201, 8, 4448);
			add_location(br19, file, 203, 8, 4555);
			add_location(br20, file, 204, 8, 4568);
			add_location(br21, file, 206, 8, 4674);
			add_location(br22, file, 207, 8, 4687);
			add_location(div1, file, 183, 4, 3942);
			add_location(br23, file, 211, 8, 4722);
			add_location(br24, file, 213, 8, 4760);
			add_location(br25, file, 214, 8, 4773);
			add_location(br26, file, 216, 8, 4858);
			add_location(br27, file, 217, 8, 4871);
			add_location(br28, file, 219, 8, 4969);
			add_location(br29, file, 220, 8, 4982);
			add_location(br30, file, 222, 8, 5080);
			add_location(br31, file, 223, 8, 5093);
			add_location(br32, file, 227, 8, 5229);
			add_location(br33, file, 228, 8, 5242);
			add_location(br34, file, 230, 8, 5358);
			add_location(br35, file, 231, 8, 5371);
			add_location(br36, file, 233, 8, 5486);
			add_location(br37, file, 234, 8, 5499);
			add_location(div2, file, 210, 4, 4708);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 182, 0, 3855);
			add_location(br38, file, 238, 0, 5527);
			add_location(br39, file, 239, 0, 5532);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 241, 0, 5538);
			add_location(br40, file, 243, 0, 5581);
			add_location(br41, file, 244, 0, 5586);
			add_location(br42, file, 249, 4, 5651);
			add_location(br43, file, 250, 4, 5660);
			add_location(br44, file, 254, 4, 5743);
			add_location(br45, file, 255, 4, 5752);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 260, 8, 5841);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 261, 8, 5868);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 262, 8, 5895);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 259, 4, 5813);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 265, 4, 5935);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 266, 4, 5993);
			add_location(br46, file, 268, 4, 6042);
			add_location(br47, file, 269, 4, 6051);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 271, 4, 6061);
			add_location(br48, file, 273, 4, 6113);
			add_location(br49, file, 274, 4, 6122);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 276, 4, 6132);
			add_location(section4, file, 246, 0, 5592);
			add_location(br50, file, 279, 0, 6208);
			add_location(br51, file, 280, 0, 6213);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 282, 0, 6219);
			add_location(br52, file, 288, 0, 6343);
			add_location(br53, file, 289, 0, 6348);
			add_location(br54, file, 293, 0, 6420);
			add_location(br55, file, 294, 0, 6425);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 296, 0, 6431);
			add_location(strong, file, 299, 4, 6476);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 298, 0, 6468);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 304, 0, 6585);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
