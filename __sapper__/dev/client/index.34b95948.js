...
function create_fragment$b(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file$b, 30, 4, 936);
			add_location(br1, file$b, 31, 4, 945);
			add_location(p, file$b, 33, 4, 955);
			attr_dev(div, "class", "card svelte-1c1t1r8");
			add_location(div, file$b, 11, 0, 299);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
