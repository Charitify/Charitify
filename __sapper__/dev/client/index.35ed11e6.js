...
function create_each_block$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h3, "class", "svelte-13f4wbi");
			add_location(h3, file$k, 24, 12, 806);
			attr_dev(p, "class", "svelte-13f4wbi");
			add_location(p, file$k, 25, 12, 840);
			add_location(br, file$k, 26, 12, 871);
			attr_dev(li, "class", "svelte-13f4wbi");
...
function create_fragment$k(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(ul, "class", "svelte-13f4wbi");
