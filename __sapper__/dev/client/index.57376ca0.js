...
function create_fragment$h(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(h1, file$h, 6, 4, 240);
			add_location(br, file$h, 7, 4, 261);
			add_location(p, file$h, 8, 4, 270);
			attr_dev(section, "class", "svelte-1qydgyt");
			add_location(section, file$h, 5, 0, 226);
		},
		m: function mount(target, anchor) {
			insert_dev(target, section, anchor);
