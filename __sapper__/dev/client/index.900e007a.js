import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, G as space, r as element, L as create_component, J as text, H as claim_space, c as claim_element, f as children, M as claim_component, g as detach_dev, K as claim_text, h as attr_dev, j as add_location, I as set_style, l as insert_dev, m as append_dev, N as mount_component, y as transition_in, z as transition_out, O as destroy_component } from './index.40eec3ee.js';
import { P as Picture, B as Button, I as Input, a as Icon, b as Progress, F as Form } from './index.5cc5a470.js';
...
// (120:0) <Form on:submit="{(e) => console.log(e)}">
function create_default_slot_13(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 120, 4, 2835);
			add_location(br1, file, 121, 4, 2844);
			add_location(br2, file, 125, 4, 2905);
			add_location(br3, file, 126, 4, 2914);
			add_location(br4, file, 130, 4, 2973);
			add_location(br5, file, 131, 4, 2982);
			add_location(br6, file, 135, 4, 3042);
			add_location(br7, file, 136, 4, 3051);
			add_location(br8, file, 140, 4, 3109);
			add_location(br9, file, 141, 4, 3118);
			add_location(br10, file, 145, 4, 3179);
			add_location(br11, file, 146, 4, 3188);
			add_location(br12, file, 150, 4, 3247);
			add_location(br13, file, 151, 4, 3256);
			add_location(br14, file, 155, 4, 3319);
			add_location(br15, file, 156, 4, 3328);
			add_location(br16, file, 160, 4, 3386);
			add_location(br17, file, 161, 4, 3395);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(120:0) <Form on:submit=\\\"{(e) => console.log(e)}\\\">",
		ctx
	});
...
// (195:8) <Button on:click="{e => console.log(e)}">
function create_default_slot_12(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(195:8) <Button on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (198:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_11(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(198:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (201:8) <Button is="success" on:click="{e => console.log(e)}" ariaLabel="text">
function create_default_slot_10(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(201:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" ariaLabel=\\\"text\\\">",
		ctx
	});
...
// (205:8) <Button is="success" on:click="{e => console.log(e)}">
function create_default_slot_9(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(205:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (209:8) <Button is="warning" on:click="{e => console.log(e)}">
function create_default_slot_8(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(209:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (212:8) <Button is="danger" on:click="{e => console.log(e)}">
function create_default_slot_7(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(212:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\">",
		ctx
	});
...
// (222:8) <Button on:click="{e => console.log(e)}" href="#">
function create_default_slot_6(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(222:8) <Button on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (228:8) <Button is="success" on:click="{e => console.log(e)}" href="#">
function create_default_slot_4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(228:8) <Button is=\\\"success\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (236:8) <Button is="warning" on:click="{e => console.log(e)}" href="#">
function create_default_slot_2(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(236:8) <Button is=\\\"warning\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (239:8) <Button is="danger" on:click="{e => console.log(e)}" href="#">
function create_default_slot_1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(239:8) <Button is=\\\"danger\\\" on:click=\\\"{e => console.log(e)}\\\" href=\\\"#\\\">",
		ctx
	});
...
// (291:0) <Picture alt="Borat" src="great-success.png" class="picture">
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(291:0) <Picture alt=\\\"Borat\\\" src=\\\"great-success.png\\\" class=\\\"picture\\\">",
		ctx
	});
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 56, 8, 874);
			attr_dev(li0, "class", "svelte-1kmv00v");
			add_location(li0, file, 61, 12, 1033);
			attr_dev(li1, "class", "svelte-1kmv00v");
			add_location(li1, file, 64, 12, 1153);
			attr_dev(li2, "class", "svelte-1kmv00v");
			add_location(li2, file, 67, 12, 1274);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 81, 20, 1747);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 82, 20, 1787);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 83, 20, 1828);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 80, 16, 1695);
			attr_dev(li3, "class", "svelte-1kmv00v");
			add_location(li3, file, 70, 12, 1396);
			attr_dev(ul0, "class", "options svelte-1kmv00v");
			add_location(ul0, file, 60, 8, 1000);
			attr_dev(section0, "class", "top svelte-1kmv00v");
			add_location(section0, file, 55, 4, 844);
			add_location(span0, file, 91, 8, 1956);
			add_location(li4, file, 90, 8, 1943);
			add_location(span1, file, 98, 8, 2198);
			add_location(li5, file, 97, 8, 2185);
			add_location(span2, file, 105, 8, 2401);
			add_location(li6, file, 104, 8, 2388);
			add_location(ul1, file, 89, 4, 1930);
			set_style(section1, "padding", "20px 5px 20px 0");
			add_location(section1, file, 113, 4, 2631);
			attr_dev(section2, "class", "top-wrap svelte-1kmv00v");
			add_location(section2, file, 54, 0, 813);
			attr_dev(span3, "class", "text-success");
			add_location(span3, file, 166, 10, 3475);
			attr_dev(h1, "class", "svelte-1kmv00v");
			add_location(h1, file, 166, 0, 3465);
			add_location(br0, file, 168, 0, 3524);
			add_location(br1, file, 169, 0, 3529);
			attr_dev(h20, "class", "text-success");
			add_location(h20, file, 171, 0, 3535);
			add_location(br2, file, 173, 0, 3577);
			add_location(br3, file, 174, 0, 3582);
			attr_dev(p0, "class", "svelte-1kmv00v");
			add_location(p0, file, 176, 0, 3588);
			attr_dev(p1, "class", "svelte-1kmv00v");
			add_location(p1, file, 177, 0, 3624);
			attr_dev(p2, "class", "svelte-1kmv00v");
			add_location(p2, file, 178, 0, 3668);
			add_location(br4, file, 180, 0, 3714);
			add_location(br5, file, 181, 0, 3719);
			attr_dev(h21, "class", "text-warning");
			add_location(h21, file, 183, 0, 3725);
			add_location(br6, file, 185, 0, 3777);
			add_location(br7, file, 186, 0, 3782);
			add_location(br8, file, 190, 8, 3889);
			add_location(br9, file, 192, 8, 3918);
			add_location(br10, file, 193, 8, 3931);
			add_location(br11, file, 195, 8, 4007);
			add_location(br12, file, 196, 8, 4020);
			add_location(br13, file, 198, 8, 4109);
			add_location(br14, file, 199, 8, 4122);
			add_location(br15, file, 201, 8, 4228);
			add_location(br16, file, 202, 8, 4241);
			add_location(br17, file, 206, 8, 4368);
			add_location(br18, file, 207, 8, 4381);
			add_location(br19, file, 209, 8, 4488);
			add_location(br20, file, 210, 8, 4501);
			add_location(br21, file, 212, 8, 4607);
			add_location(br22, file, 213, 8, 4620);
			add_location(div1, file, 189, 4, 3875);
			add_location(br23, file, 217, 8, 4655);
			add_location(br24, file, 219, 8, 4693);
			add_location(br25, file, 220, 8, 4706);
			add_location(br26, file, 222, 8, 4791);
			add_location(br27, file, 223, 8, 4804);
			add_location(br28, file, 225, 8, 4902);
			add_location(br29, file, 226, 8, 4915);
			add_location(br30, file, 228, 8, 5013);
			add_location(br31, file, 229, 8, 5026);
			add_location(br32, file, 233, 8, 5162);
			add_location(br33, file, 234, 8, 5175);
			add_location(br34, file, 236, 8, 5291);
			add_location(br35, file, 237, 8, 5304);
			add_location(br36, file, 239, 8, 5419);
			add_location(br37, file, 240, 8, 5432);
			add_location(div2, file, 216, 4, 4641);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 188, 0, 3788);
			add_location(br38, file, 244, 0, 5460);
			add_location(br39, file, 245, 0, 5465);
			attr_dev(h22, "class", "text-danger");
			add_location(h22, file, 247, 0, 5471);
			add_location(br40, file, 249, 0, 5514);
			add_location(br41, file, 250, 0, 5519);
			add_location(br42, file, 255, 4, 5584);
			add_location(br43, file, 256, 4, 5593);
			add_location(br44, file, 260, 4, 5676);
			add_location(br45, file, 261, 4, 5685);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 266, 8, 5774);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 267, 8, 5801);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 268, 8, 5828);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 265, 4, 5746);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 271, 4, 5868);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 272, 4, 5926);
			add_location(br46, file, 274, 4, 5975);
			add_location(br47, file, 275, 4, 5984);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 277, 4, 5994);
			add_location(br48, file, 279, 4, 6046);
			add_location(br49, file, 280, 4, 6055);
			attr_dev(button15, "type", "button");
			attr_dev(button15, "class", "text-info");
			add_location(button15, file, 282, 4, 6065);
			add_location(section4, file, 252, 0, 5525);
			add_location(br50, file, 285, 0, 6141);
			add_location(br51, file, 286, 0, 6146);
			attr_dev(h23, "class", "text-info");
			add_location(h23, file, 288, 0, 6152);
			add_location(br52, file, 294, 0, 6276);
			add_location(br53, file, 295, 0, 6281);
			add_location(br54, file, 299, 0, 6353);
			add_location(br55, file, 300, 0, 6358);
			attr_dev(h24, "class", "text-success");
			add_location(h24, file, 302, 0, 6364);
			add_location(strong, file, 305, 4, 6409);
			attr_dev(p3, "class", "svelte-1kmv00v");
			add_location(p3, file, 304, 0, 6401);
			set_style(p4, "text-align", "justify");
			attr_dev(p4, "class", "svelte-1kmv00v");
			add_location(p4, file, 310, 0, 6518);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
