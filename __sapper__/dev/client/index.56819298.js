...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(li, file$b, 58, 8, 1873);
		},
		m: function mount(target, anchor) {
...
function create_fragment$f(ctx) {
	...
	const carousel = new Carousel({
			props: {
				images: [/*src*/ ctx[0], /*src*/ ctx[0], /*src*/ ctx[0]]
			},
			$$inline: true
		});
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(h4, file$f, 20, 4, 558);
			attr_dev(div1, "class", "rate-wrap svelte-do16pj");
			add_location(div1, file$f, 22, 4, 580);
			add_location(footer, file$f, 26, 4, 649);
		...
		p: function update(ctx, [dirty]) {
			...
			if (dirty & /*src*/ 1) carousel_changes.images = [/*src*/ ctx[0], /*src*/ ctx[0], /*src*/ ctx[0]];
