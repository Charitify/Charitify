import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, a as assign, q as element, z as create_component, A as space, c as claim_element, f as children, B as claim_component, C as claim_space, g as detach_dev, j as add_location, k as insert_dev, D as mount_component, l as append_dev, J as get_spread_update, Z as get_spread_object, w as transition_in, y as transition_out, E as destroy_component, T as text, U as claim_text, h as attr_dev, V as set_style, M as check_outros, Q as destroy_each, L as group_outros, m as noop } from './index.50c5fe52.js';
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(li, file, 219, 12, 5901);
		},
		m: function mount(target, anchor) {
...
function create_default_slot_12(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(br0, file, 234, 4, 6088);
			add_location(br1, file, 235, 4, 6097);
			add_location(br2, file, 239, 4, 6171);
			add_location(br3, file, 240, 4, 6180);
			add_location(br4, file, 244, 4, 6252);
			add_location(br5, file, 245, 4, 6261);
			add_location(br6, file, 249, 4, 6334);
			add_location(br7, file, 250, 4, 6343);
			add_location(br8, file, 254, 4, 6414);
			add_location(br9, file, 255, 4, 6423);
			add_location(br10, file, 259, 4, 6497);
			add_location(br11, file, 260, 4, 6506);
			add_location(br12, file, 264, 4, 6578);
			add_location(br13, file, 265, 4, 6587);
			add_location(br14, file, 269, 4, 6663);
			add_location(br15, file, 270, 4, 6672);
			add_location(br16, file, 274, 4, 6743);
			add_location(br17, file, 275, 4, 6752);
		},
		m: function mount(target, anchor) {
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(div0, file, 127, 8, 3223);
			attr_dev(li0, "class", "svelte-1fydlyp");
			add_location(li0, file, 148, 12, 4051);
			attr_dev(li1, "class", "svelte-1fydlyp");
			add_location(li1, file, 151, 12, 4171);
			attr_dev(li2, "class", "svelte-1fydlyp");
			add_location(li2, file, 154, 12, 4292);
			add_location(br0, file, 158, 16, 4435);
			option0.__value = "20";
			option0.value = option0.__value;
			add_location(option0, file, 169, 20, 4786);
			option1.__value = "500";
			option1.value = option1.__value;
			add_location(option1, file, 170, 20, 4826);
			option2.__value = "1000";
			option2.value = option2.__value;
			add_location(option2, file, 171, 20, 4867);
			attr_dev(datalist0, "id", "sum-suggestions");
			add_location(datalist0, file, 168, 16, 4734);
			attr_dev(li3, "class", "svelte-1fydlyp");
			add_location(li3, file, 157, 12, 4414);
			attr_dev(li4, "class", "svelte-1fydlyp");
			add_location(li4, file, 174, 12, 4947);
			attr_dev(ul0, "class", "options svelte-1fydlyp");
			add_location(ul0, file, 147, 8, 4018);
			attr_dev(section0, "class", "top svelte-1fydlyp");
			add_location(section0, file, 126, 4, 3193);
			add_location(br1, file, 181, 4, 5127);
			attr_dev(h3, "class", "svelte-1fydlyp");
			add_location(h3, file, 189, 16, 5360);
			attr_dev(p0, "class", "svelte-1fydlyp");
			add_location(p0, file, 190, 16, 5400);
			attr_dev(span0, "class", "svelte-1fydlyp");
			add_location(span0, file, 188, 12, 5337);
			attr_dev(div1, "class", "ava-section svelte-1fydlyp");
			add_location(div1, file, 185, 8, 5221);
			attr_dev(section1, "class", "rate-section svelte-1fydlyp");
			add_location(section1, file, 184, 4, 5182);
			add_location(br2, file, 197, 4, 5501);
			attr_dev(h10, "class", "svelte-1fydlyp");
			add_location(h10, file, 199, 4, 5511);
			add_location(br3, file, 201, 4, 5540);
			attr_dev(p1, "class", "text-center");
			set_style(p1, "padding", "0 10vw");
			add_location(p1, file, 203, 4, 5550);
			attr_dev(section2, "class", "container");
			add_location(section2, file, 125, 0, 3161);
			add_location(br4, file, 208, 0, 5706);
			add_location(br5, file, 209, 0, 5711);
			set_style(h20, "text-align", "right");
			add_location(h20, file, 214, 4, 5771);
			add_location(ul1, file, 217, 4, 5854);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 211, 0, 5717);
			add_location(br6, file, 227, 0, 6000);
			add_location(br7, file, 228, 0, 6005);
			attr_dev(h11, "class", "svelte-1fydlyp");
			add_location(h11, file, 280, 0, 6822);
			add_location(br8, file, 282, 0, 6890);
			add_location(br9, file, 283, 0, 6895);
			attr_dev(h21, "class", "text-success");
			add_location(h21, file, 285, 0, 6901);
			add_location(br10, file, 287, 0, 6943);
			add_location(br11, file, 288, 0, 6948);
			add_location(p2, file, 290, 0, 6954);
			add_location(p3, file, 291, 0, 6990);
			add_location(p4, file, 292, 0, 7034);
			add_location(br12, file, 294, 0, 7080);
			add_location(br13, file, 295, 0, 7085);
			attr_dev(h22, "class", "text-warning");
			add_location(h22, file, 297, 0, 7091);
			add_location(span1, file, 301, 8, 7165);
			add_location(li5, file, 300, 4, 7152);
			add_location(span2, file, 308, 8, 7399);
			add_location(li6, file, 307, 4, 7386);
			add_location(span3, file, 315, 8, 7594);
			add_location(li7, file, 314, 4, 7581);
			add_location(ul2, file, 299, 0, 7143);
			add_location(br14, file, 323, 0, 7812);
			add_location(br15, file, 324, 0, 7817);
			add_location(br16, file, 328, 8, 7924);
			add_location(br17, file, 330, 8, 7953);
			add_location(br18, file, 331, 8, 7966);
			add_location(br19, file, 333, 8, 8042);
			add_location(br20, file, 334, 8, 8055);
			add_location(br21, file, 336, 8, 8144);
			add_location(br22, file, 337, 8, 8157);
			add_location(br23, file, 339, 8, 8263);
			add_location(br24, file, 340, 8, 8276);
			add_location(br25, file, 344, 8, 8403);
			add_location(br26, file, 345, 8, 8416);
			add_location(br27, file, 347, 8, 8523);
			add_location(br28, file, 348, 8, 8536);
			add_location(br29, file, 350, 8, 8642);
			add_location(br30, file, 351, 8, 8655);
			add_location(div3, file, 327, 4, 7910);
			add_location(br31, file, 355, 8, 8690);
			add_location(br32, file, 357, 8, 8728);
			add_location(br33, file, 358, 8, 8741);
			add_location(br34, file, 360, 8, 8826);
			add_location(br35, file, 361, 8, 8839);
			add_location(br36, file, 363, 8, 8937);
			add_location(br37, file, 364, 8, 8950);
			add_location(br38, file, 366, 8, 9048);
			add_location(br39, file, 367, 8, 9061);
			add_location(br40, file, 371, 8, 9197);
			add_location(br41, file, 372, 8, 9210);
			add_location(br42, file, 374, 8, 9326);
			add_location(br43, file, 375, 8, 9339);
			add_location(br44, file, 377, 8, 9454);
			add_location(br45, file, 378, 8, 9467);
			add_location(div4, file, 354, 4, 8676);
			set_style(section3, "text-align", "center");
			set_style(section3, "display", "flex");
			set_style(section3, "justify-content", "space-around");
			add_location(section3, file, 326, 0, 7823);
			add_location(br46, file, 382, 0, 9495);
			add_location(br47, file, 383, 0, 9500);
			attr_dev(h23, "class", "text-danger");
			add_location(h23, file, 385, 0, 9506);
			add_location(br48, file, 387, 0, 9549);
			add_location(br49, file, 388, 0, 9554);
			add_location(br50, file, 393, 4, 9619);
			add_location(br51, file, 394, 4, 9628);
			add_location(br52, file, 398, 4, 9711);
			add_location(br53, file, 399, 4, 9720);
			option3.__value = "1";
			option3.value = option3.__value;
			add_location(option3, file, 404, 8, 9809);
			option4.__value = "2";
			option4.value = option4.__value;
			add_location(option4, file, 405, 8, 9836);
			option5.__value = "3";
			option5.value = option5.__value;
			add_location(option5, file, 406, 8, 9863);
			attr_dev(datalist1, "id", "lis");
			add_location(datalist1, file, 403, 4, 9781);
			attr_dev(label, "for", "input");
			attr_dev(label, "class", "text-success");
			add_location(label, file, 409, 4, 9903);
			attr_dev(input4, "id", "input");
			attr_dev(input4, "type", "text");
			input4.value = "text";
			add_location(input4, file, 410, 4, 9961);
			add_location(br54, file, 412, 4, 10010);
			add_location(br55, file, 413, 4, 10019);
			attr_dev(a, "href", ".");
			attr_dev(a, "class", "text-warning");
			add_location(a, file, 415, 4, 10029);
			add_location(br56, file, 417, 4, 10081);
			add_location(br57, file, 418, 4, 10090);
			attr_dev(button16, "type", "button");
			attr_dev(button16, "class", "text-info");
			add_location(button16, file, 420, 4, 10100);
			add_location(section4, file, 390, 0, 9560);
			add_location(br58, file, 423, 0, 10176);
			add_location(br59, file, 424, 0, 10181);
			attr_dev(h24, "class", "text-info");
			add_location(h24, file, 426, 0, 10187);
			add_location(br60, file, 428, 0, 10222);
			add_location(br61, file, 429, 0, 10227);
			add_location(br62, file, 433, 0, 10299);
			add_location(br63, file, 434, 0, 10304);
			attr_dev(h25, "class", "text-success");
			add_location(h25, file, 436, 0, 10310);
			add_location(strong, file, 439, 4, 10355);
			add_location(p5, file, 438, 0, 10347);
			set_style(p6, "text-align", "justify");
			add_location(p6, file, 444, 0, 10464);
		},
		m: function mount(target, anchor) {
			insert_dev(target, t0, anchor);
