...
const Modal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	? `${validate_component(Portal, "Portal").$$render($$result, {}, {}, {
			default: () => `
        <div${add_attribute("id", `modal-${id}`, 0)} aria-hidden="${"true"}" class="${escape(null_to_empty(classProp)) + " svelte-1mknici"}" body-scroll-lock-ignore${add_attribute("this", ref, 1)}>
...
${validate_component(Modal, "Modal").$$render(
    ...
    <section class="${"container scroll-box scroll-y-center flex flex-column"}" style="${"flex: 1 1 auto; max-height: 100%"}">
        <div class="${"flex-1"}">
