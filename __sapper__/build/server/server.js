...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    <section class="${"top svelte-qhq3hs"}">
        ${validate_component(Carousel, "Carousel").$$render($$result, { items: carousel }, {}, {})}
    </section>
