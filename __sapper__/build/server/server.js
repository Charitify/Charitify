...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <ul class="${"carousel-inner scroll-x-center svelte-v2q7l8"}" body-scroll-lock-ignore>
