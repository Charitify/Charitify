...
const css$f = {
	code: ".inp.svelte-1g90qop.svelte-1g90qop{width:100%;-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.inp.svelte-1g90qop .inp-inner-wrap.svelte-1g90qop{position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-shadow:var(--shadow-field-inset);box-shadow:var(--shadow-field-inset);border-radius:var(--border-radius-small);background-color:rgba(var(--theme-bg-color))}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;color:inherit;overflow-y:auto;overflow-x:hidden;background-color:transparent;-webkit-overflow-scrolling:touch;min-width:var(--min-interactive-size);min-height:var(--min-interactive-size);border-radius:var(--border-radius-small)}.inp.postIcon.svelte-1g90qop .inp-inner.svelte-1g90qop{padding-right:var(--min-interactive-size)}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop:invalid,.inp.error.svelte-1g90qop .inp-inner.svelte-1g90qop{-webkit-box-shadow:0 0 0 1px rgb(var(--color-danger));box-shadow:0 0 0 1px rgb(var(--color-danger));color:rgb(var(--color-danger))}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop:focus{-webkit-box-shadow:0 0 0 1px rgb(var(--color-info));box-shadow:0 0 0 1px rgb(var(--color-info));color:rgb(var(--color-info))}.inp.svelte-1g90qop .inp-post-icon-inner.svelte-1g90qop{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;width:var(--min-interactive-size)}.inp.svelte-1g90qop .inp-post-icon.svelte-1g90qop{position:absolute;top:0;right:0;height:100%;width:var(--min-interactive-size);-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;overflow:hidden}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop::-webkit-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop::-moz-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop:-ms-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop::-ms-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-1g90qop .inp-inner.svelte-1g90qop::placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}",
	map: "{\"version\":3,\"file\":\"Input.svelte\",\"sources\":[\"Input.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames, toCSSString } from '@utils'\\n    import Br from '@components/Br.svelte'\\n    import Icon from '@components/Icon.svelte'\\n    import FieldErrors from '@components/FieldErrors.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let name\\n    export let value = ''\\n    export let style = {}\\n    export let type = 'text'\\n    export let id = undefined\\n    export let align = undefined\\n    export let minlength = undefined\\n    export let maxlength = 1000\\n    export let rows = undefined\\n    export let disabled = false\\n    export let label = undefined\\n    export let invalid = undefined\\n    export let min = undefined // Specifies a minimum value for an <input> element\\n    export let max = undefined // Specifies the maximum value for an <input> element\\n    export let list = undefined // Refers to a <datalist> element that contains pre-defined options for an <input> element\\n    export let form = undefined // Specifies the form the <input> element belongs to\\n    export let readonly = undefined // undefined|readonly\\n    export let required = undefined // undefined|required\\n    export let pattern = undefined // Specifies a regular expression that an <input> element's value is checked against (regexp)\\n    export let autocomplete = undefined// on|off\\n    export let ariaLabel = undefined\\n    export let placeholder = undefined\\n    export let postIcon = undefined\\n    export let errors = undefined\\n\\n    /**\\n     * autocomplete - https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete\\n     * names - https://developers.google.com/web/updates/2015/06/checkout-faster-with-autofill\\n     */\\n    const nameTypes = {\\n        'sex': { autocomplete: 'sex' },\\n        'bday': { autocomplete: 'bday' },\\n        'name': { autocomplete: 'name' },\\n        'fname': { autocomplete: 'name' },\\n        'lname': { autocomplete: 'name' },\\n        'email': { autocomplete: 'email' },\\n        'phone': { autocomplete: 'tel' },\\n        'password': { autocomplete: 'new-password' },\\n        'ship-address': { autocomplete: 'shipping street-address' },\\n        'ship-city': { autocomplete: 'shipping locality' },\\n        'ship-state': { autocomplete: 'shipping region' },\\n        'ship-zip': { autocomplete: 'shipping postal-code' },\\n        'ship-country': { autocomplete: 'shipping country' },\\n        'ccname': { autocomplete: 'cc-name' },\\n        'cardnumber': { autocomplete: 'cc-number' },\\n        'cvc': { autocomplete: 'cc-csc' },\\n        'cc-exp': { autocomplete: 'cc-exp' },\\n    }\\n\\n    const typePostIcons = {\\n      date: 'calendar',\\n      search: 'search',\\n    }\\n\\n    $: inputPredict = nameTypes[name] || {}\\n    $: iconType = postIcon || typePostIcons[type]\\n\\n    $: error = invalid !== undefined ? invalid : !!(errors || []).length\\n    $: idProp = id || inputPredict.id || name\\n    $: typeProp = type === 'number' ? 'text' : type\\n    $: titleProp = label || ariaLabel\\n    $: ariaLabelProp = ariaLabel || label || placeholder\\n    $: styleProp = toCSSString({ ...style, textAlign: align })\\n    $: patternProp = type === 'number' && !pattern ? '[0-9]*' : pattern\\n    $: classProp = classnames('inp', $$props.class, { disabled, readonly, required, error, postIcon: iconType })\\n    $: autocompleteProp = autocomplete || inputPredict.autocomplete\\n</script>\\n\\n<div class={classProp}>\\n    {#if titleProp}\\n        <label for={idProp} class=\\\"inp-label h2 font-secondary font-w-600 text-left\\\">\\n            { titleProp }\\n            <Br size=\\\"10\\\"/>\\n        </label>\\n    {/if}\\n\\n    <div class=\\\"inp-inner-wrap\\\">\\n        {#if rows || type === 'textarea'}\\n            <textarea\\n                    {min}\\n                    {max}\\n                    {rows}\\n                    {name}\\n                    {form}\\n                    {align}\\n                    {readonly}\\n                    {disabled}\\n                    {required}\\n                    {minlength}\\n                    {maxlength}\\n                    {placeholder}\\n                    id={idProp}\\n                    class=\\\"inp-inner\\\"\\n                    title={titleProp}\\n                    style={styleProp}\\n                    pattern={patternProp}\\n                    aria-label={ariaLabelProp}\\n                    autocomplete={autocompleteProp}\\n                    {...{ type: typeProp }}\\n                    bind:value\\n                    on:blur='{e => !disabled && dispatch(\\\"blur\\\", e)}'\\n                    on:focus='{e => !disabled && dispatch(\\\"focus\\\", e)}'\\n            ></textarea>\\n        {:else}\\n            <input\\n                    {min}\\n                    {max}\\n                    {name}\\n                    {list}\\n                    {form}\\n                    {align}\\n                    {readonly}\\n                    {disabled}\\n                    {required}\\n                    {minlength}\\n                    {maxlength}\\n                    {placeholder}\\n                    id={idProp}\\n                    class=\\\"inp-inner\\\"\\n                    title={titleProp}\\n                    style={styleProp}\\n                    pattern={patternProp}\\n                    aria-label={ariaLabelProp}\\n                    autocomplete={autocompleteProp}\\n                    {...{ type: typeProp }}\\n                    bind:value\\n                    on:blur='{e => !disabled && dispatch(\\\"blur\\\", e)}'\\n                    on:focus='{e => !disabled && dispatch(\\\"focus\\\", e)}'\\n            >\\n        {/if}\\n\\n        <label for={idProp} class=\\\"inp-post-icon\\\">\\n            <slot name=\\\"post-icon\\\">\\n                {#if iconType}\\n                    <span class=\\\"inp-post-icon-inner\\\">\\n                        <Icon type={iconType} is=\\\"info\\\" size=\\\"medium\\\"/>\\n                    </span>\\n                {/if}\\n            </slot>\\n        </label>\\n    </div>\\n\\n    <FieldErrors items={errors}>\\n        <div slot=\\\"before\\\">\\n            <Br size=\\\"5\\\"/>\\n        </div>\\n    </FieldErrors>\\n</div>\\n\\n<style>\\n    .inp {\\n        width: 100%;\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 auto;\\n                flex: 1 1 auto;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-orient: vertical;\\n        -webkit-box-direction: normal;\\n            -ms-flex-direction: column;\\n                flex-direction: column;\\n    }\\n\\n    .inp .inp-inner-wrap {\\n        position: relative;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-shadow: var(--shadow-field-inset);\\n                box-shadow: var(--shadow-field-inset);\\n        border-radius: var(--border-radius-small);\\n        background-color: rgba(var(--theme-bg-color));\\n    }\\n\\n    .inp .inp-inner {\\n        -webkit-box-flex: 1;\\n            -ms-flex-positive: 1;\\n                flex-grow: 1;\\n        color: inherit;\\n        overflow-y: auto;\\n        overflow-x: hidden;\\n        background-color: transparent;\\n        -webkit-overflow-scrolling: touch;\\n        min-width: var(--min-interactive-size);\\n        min-height: var(--min-interactive-size);\\n        border-radius: var(--border-radius-small);\\n    }\\n\\n    .inp.postIcon .inp-inner {\\n        padding-right: var(--min-interactive-size);\\n    }\\n\\n    .inp .inp-inner:invalid, .inp.error .inp-inner {\\n        -webkit-box-shadow: 0 0 0 1px rgb(var(--color-danger));\\n                box-shadow: 0 0 0 1px rgb(var(--color-danger));\\n        color: rgb(var(--color-danger));\\n    }\\n\\n    .inp .inp-inner:focus {\\n        -webkit-box-shadow: 0 0 0 1px rgb(var(--color-info));\\n                box-shadow: 0 0 0 1px rgb(var(--color-info));\\n        color: rgb(var(--color-info));\\n    }\\n\\n    .inp .inp-post-icon-inner {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        width: var(--min-interactive-size);\\n    }\\n\\n    .inp .inp-post-icon {\\n        position: absolute;\\n        top: 0;\\n        right: 0;\\n        height: 100%;\\n        width: var(--min-interactive-size);\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        overflow: hidden;\\n    }\\n\\n    .inp .inp-inner::-webkit-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner::-moz-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner:-ms-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner::-ms-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner::placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AA+JI,IAAI,8BAAC,CAAC,AACF,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACtB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,AAClC,CAAC,AAED,mBAAI,CAAC,eAAe,eAAC,CAAC,AAClB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,kBAAkB,CAAE,IAAI,oBAAoB,CAAC,CACrC,UAAU,CAAE,IAAI,oBAAoB,CAAC,CAC7C,aAAa,CAAE,IAAI,qBAAqB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,AACjD,CAAC,AAED,mBAAI,CAAC,UAAU,eAAC,CAAC,AACb,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,WAAW,CAC7B,0BAA0B,CAAE,KAAK,CACjC,SAAS,CAAE,IAAI,sBAAsB,CAAC,CACtC,UAAU,CAAE,IAAI,sBAAsB,CAAC,CACvC,aAAa,CAAE,IAAI,qBAAqB,CAAC,AAC7C,CAAC,AAED,IAAI,wBAAS,CAAC,UAAU,eAAC,CAAC,AACtB,aAAa,CAAE,IAAI,sBAAsB,CAAC,AAC9C,CAAC,AAED,mBAAI,CAAC,yBAAU,QAAQ,CAAE,IAAI,qBAAM,CAAC,UAAU,eAAC,CAAC,AAC5C,kBAAkB,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,cAAc,CAAC,CAAC,CAC9C,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,cAAc,CAAC,CAAC,CACtD,KAAK,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,AACnC,CAAC,AAED,mBAAI,CAAC,yBAAU,MAAM,AAAC,CAAC,AACnB,kBAAkB,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,YAAY,CAAC,CAAC,CAC5C,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,YAAY,CAAC,CAAC,CACpD,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,AACjC,CAAC,AAED,mBAAI,CAAC,oBAAoB,eAAC,CAAC,AACvB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,KAAK,CAAE,IAAI,sBAAsB,CAAC,AACtC,CAAC,AAED,mBAAI,CAAC,cAAc,eAAC,CAAC,AACjB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,sBAAsB,CAAC,CAClC,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,mBAAI,CAAC,yBAAU,2BAA2B,AAAC,CAAC,AACxC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,kBAAkB,AAAC,CAAC,AAC/B,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,sBAAsB,AAAC,CAAC,AACnC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,uBAAuB,AAAC,CAAC,AACpC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,aAAa,AAAC,CAAC,AAC1B,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC\"}"
};
 ...
 */
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-1g90qop"}">
    ${titleProp
    ...
    <div class="${"inp-inner-wrap svelte-1g90qop"}">
        ${rows || type === "textarea"
	? `<textarea${spread(
			[
				{ min: escape(min) },
	...
	: `<input${spread(
        ...
        <label${add_attribute("for", idProp, 0)} class="${"inp-post-icon svelte-1g90qop"}">
            ${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${iconType
		? `<span class="${"inp-post-icon-inner svelte-1g90qop"}">
