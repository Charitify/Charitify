...
const css$b = {
	code: "nav.svelte-vu93lv.svelte-vu93lv{position:sticky;top:0;z-index:10;display:flex;justify-content:space-between;box-shadow:var(--shadow-secondary);border-bottom:1px solid rgba(var(--color-danger), .1)}.selected.svelte-vu93lv.svelte-vu93lv{position:relative;display:inline-block}.selected.svelte-vu93lv.svelte-vu93lv::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(var(--color-danger));display:block;bottom:-1px}a.svelte-vu93lv.svelte-vu93lv{padding:0.8em 0.5em}.nav-actions.svelte-vu93lv.svelte-vu93lv{display:flex;align-items:center;margin:-3px}.nav-actions.svelte-vu93lv li.svelte-vu93lv{padding:3px}.lang-select.svelte-vu93lv.svelte-vu93lv{padding:5px;background-color:transparent}.lang-select.svelte-vu93lv.svelte-vu93lv:hover,.lang-select.svelte-vu93lv.svelte-vu93lv:focus{box-shadow:none;background-color:rgba(var(--color-black), 0.1)}",
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"theme-bg container svelte-vu93lv"}">
    <ul>
        <li><a rel="${"prefetch"}" href="${"."}" class="${["svelte-vu93lv", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
        <li><a rel="${"prefetch"}" href="${"lists/charities"}" class="${["svelte-vu93lv", segment === "lists" ? "selected" : ""].join(" ").trim()}">lists</a></li>
        <li><a href="${"map"}" class="${["svelte-vu93lv", segment === "map" ? "selected" : ""].join(" ").trim()}">map</a></li>
    </ul>

    <ul class="${"nav-actions svelte-vu93lv"}">
        <li class="${"svelte-vu93lv"}">
            <select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-vu93lv"}">
                <option value="${"ua"}">Ua</option>
                <option value="${"ru"}">Ru</option>
                <option value="${"en"}">En</option>
            </select>
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "map_$id", file: "map/[id].svelte", component: U5Bidu5D$2, params: match => ({ id: d(match[1]) }) }
			]
		}
	],
