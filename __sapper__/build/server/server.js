...
const css$1 = {
	code: "svg.svelte-1kwd051.svelte-1kwd051{display:inherit;flex-grow:1;align-self:stretch}svg.svelte-1kwd051.svelte-1kwd051,svg.svelte-1kwd051 .svelte-1kwd051{fill:rgba(var(--theme-svg-fill));stroke:rgba(var(--theme-svg-fill))}.small.svelte-1kwd051.svelte-1kwd051{width:18px;height:18px;flex:none;align-self:auto}.medium.svelte-1kwd051.svelte-1kwd051{width:24px;height:24px;flex:none;align-self:auto}.big.svelte-1kwd051.svelte-1kwd051{width:30px;height:30px;flex:none;align-self:auto}.primary.svelte-1kwd051.svelte-1kwd051,.primary.svelte-1kwd051 .svelte-1kwd051{fill:rgb(var(--color-success));stroke:rgb(var(--color-success))}.danger.svelte-1kwd051.svelte-1kwd051,.danger.svelte-1kwd051 .svelte-1kwd051{fill:rgb(var(--color-danger));stroke:rgb(var(--color-danger))}.info.svelte-1kwd051.svelte-1kwd051,.info.svelte-1kwd051 .svelte-1kwd051{fill:rgb(var(--color-info));stroke:rgb(var(--color-info))}.light.svelte-1kwd051.svelte-1kwd051,.light.svelte-1kwd051 .svelte-1kwd051{fill:rgb(var(--color-white));stroke:rgb(var(--color-white))}.dark.svelte-1kwd051.svelte-1kwd051,.dark.svelte-1kwd051 .svelte-1kwd051{fill:rgb(var(--color-black));stroke:rgb(var(--color-black))}",
...
const Icon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<svg${add_attribute("id", id, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1kwd051"}"${add_attribute("style", styleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}>
    <use${add_attribute("xlink:href", `#ico-${type}`, 0)} class="${"ico-use svelte-1kwd051"}"></use>
</svg>`;
});
...
const Picture = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<figure class="${escape(null_to_empty(wrapClassProp)) + " svelte-1ngjl06"}">
    <img${add_attribute("id", id, 0)}${add_attribute("alt", alt, 0)}${add_attribute("src", src, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)} class="${"pic pic-1x svelte-1ngjl06"}">
    ${srcBig && !loadingSrc
	? `<img${add_attribute("alt", alt, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)}${add_attribute("src", srcBig, 0)} class="${"pic pic-2x svelte-1ngjl06"}">`
	: ``}
    <figcaption>
        ${$$slots.default ? $$slots.default({}) : ``}
    </figcaption>
...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${add_attribute("id", id, 0)}${add_attribute("href", href, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1dc064t"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </a>`
	: `${htmlFor
		? `<label${add_attribute("id", id, 0)} ${disabled ? "disabled" : ""}${add_attribute("for", htmlFor, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1dc064t"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </label>`
		: `<button${add_attribute("id", id, 0)}${add_attribute("type", type, 0)} ${disabled ? "disabled" : ""}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1dc064t"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`}`}`;
});
...
const Comments = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"comments svelte-17fropl"}">
    <ul class="${"comments-wrap svelte-17fropl"}">
        ${each(comments, comment => `<li class="${"svelte-17fropl"}">
    ...
    ${withForm
	? `<br class="${"big"}">
        <div class="${"comments-form font-secondary h3 svelte-17fropl"}">
...
const css$m = {
	code: "ul.svelte-1hh5gkz{width:100%;display:flex;flex-direction:row-reverse;align-items:flex-start;max-width:100%;overflow-y:hidden;overflow-x:auto;padding:var(--screen-padding) 0}li.svelte-1hh5gkz{align-self:stretch;width:240px;padding:0 5px}li.svelte-1hh5gkz:last-child{padding-left:15px}li.svelte-1hh5gkz:first-child{padding-right:15px}",
...
const DonatorsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"scroll-x-center svelte-1hh5gkz"}">
    ${each(grouped, cards => `<li class="${"svelte-1hh5gkz"}">
...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    ${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
        ...
        <h2>Життя Волтера</h2>
        <br class="${"small"}">
        <table class="${"svelte-w6xn1q"}">
            <tbody>
            <tr>
                <td class="${"svelte-w6xn1q"}">01.02.2019</td>
                <td class="${"svelte-w6xn1q"}">—</td>
                <td class="${"svelte-w6xn1q"}">Його перший день народження</td>
            </tr>
            <tr>
                <td class="${"svelte-w6xn1q"}">05.02.2019</td>
                <td class="${"svelte-w6xn1q"}">—</td>
                <td class="${"svelte-w6xn1q"}">Ми приютили його з вулиці</td>
            </tr>
            <tr>
                <td class="${"svelte-w6xn1q"}">07.03.2019</td>
                <td class="${"svelte-w6xn1q"}">—</td>
                <td class="${"svelte-w6xn1q"}">Зробили вакцинацію проти бліх</td>
            </tr>
            <tr>
                <td class="${"svelte-w6xn1q"}">23.06.2019</td>
                <td class="${"svelte-w6xn1q"}">—</td>
                <td class="${"svelte-w6xn1q"}">Знайшов для себе улюблену іграшку</td>
            </tr>
            </tbody>
        </table>
