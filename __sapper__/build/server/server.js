...
const css$c = {
	code: "ul.svelte-jry08k{width:100%;display:flex;align-items:flex-start;max-width:100%;overflow-y:hidden;overflow-x:auto;padding:var(--screen-padding) 0}li.svelte-jry08k{flex:none;display:flex;align-self:stretch;height:180px;width:126px;padding:0 5px;box-sizing:content-box}li.svelte-jry08k:first-child{padding-left:15px}li.svelte-jry08k:last-child{padding-right:15px}",
	map: "{\"version\":3,\"file\":\"Documents.svelte\",\"sources\":[\"Documents.svelte\"],\"sourcesContent\":[\"<script>\\n    import Card from '../Card.svelte'\\n    import Picture from '../Picture.svelte'\\n\\n    const cardSample = {\\n        src: 'https://placeimg.com/300/300/people',\\n        alt: '10грн',\\n    }\\n\\n    const all = new Array(5).fill(cardSample)\\n</script>\\n\\n<ul class=\\\"scroll-x-center\\\">\\n    {#each all as img}\\n        <li>\\n            <Card class=\\\"flex\\\">\\n                <Picture {...img} size=\\\"contain\\\"/>\\n            </Card>\\n        </li>\\n    {/each}\\n</ul>\\n\\n<style>\\n    ul {\\n        width: 100%;\\n        display: flex;\\n        align-items: flex-start;\\n        max-width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: auto;\\n        padding: var(--screen-padding) 0;\\n    }\\n\\n    li {\\n        flex: none;\\n        display: flex;\\n        align-self: stretch;\\n        height: 180px;\\n        width: 126px;\\n        padding: 0 5px;\\n        box-sizing: content-box;\\n    }\\n\\n    li:first-child {\\n        padding-left: 15px;\\n    }\\n\\n    li:last-child {\\n        padding-right: 15px;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAuBI,EAAE,cAAC,CAAC,AACA,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,UAAU,CACvB,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAAC,CAAC,AACpC,CAAC,AAED,EAAE,cAAC,CAAC,AACA,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,CAAC,CAAC,GAAG,CACd,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,gBAAE,YAAY,AAAC,CAAC,AACZ,YAAY,CAAE,IAAI,AACtB,CAAC,AAED,gBAAE,WAAW,AAAC,CAAC,AACX,aAAa,CAAE,IAAI,AACvB,CAAC\"}"
};
...
const Documents = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"scroll-x-center svelte-jry08k"}">
    ${each(all, img => `<li class="${"svelte-jry08k"}">
...
const css$g = {
	code: ".trust-btn.svelte-15exogk.svelte-15exogk{position:relative;display:block;width:100%;height:0;padding-bottom:100%;border-radius:50%;overflow:hidden}div.svelte-15exogk.svelte-15exogk{display:flex;align-items:center;justify-content:center;border-radius:50%;border:4px solid rgba(var(--color-danger));background-color:rgba(var(--color-danger), .2)}.trust-btn.isActive.svelte-15exogk div.svelte-15exogk{background-color:rgba(var(--color-danger), 1)}.trust-btn.isActive.svelte-15exogk svg.svelte-15exogk{fill:rgba(var(--color-white));-webkit-animation:none;animation:none;transform:scale(1.1)\n    }svg.svelte-15exogk.svelte-15exogk{width:50%;height:50%;max-width:calc(100% - 10px);max-height:calc(100% - 10px);fill:rgba(var(--color-danger));-webkit-animation:svelte-15exogk-pulse 2s infinite;animation:svelte-15exogk-pulse 2s infinite}@-webkit-keyframes svelte-15exogk-pulse{10%{transform:scale(1.1)\n        }20%{transform:scale(1.05)\n        }30%{transform:scale(1.15)\n        }}@keyframes svelte-15exogk-pulse{10%{transform:scale(1.1)\n        }20%{transform:scale(1.05)\n        }30%{transform:scale(1.15)\n        }}",
	map: "{\"version\":3,\"file\":\"TrustButton.svelte\",\"sources\":[\"TrustButton.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames } from '../../utils'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let isActive = null\\n    export let onAsyncClick = null\\n\\n    let isActiveLocal = !!isActive\\n\\n    $: isActiveState = isActive === null ? isActiveLocal : isActive\\n    $: classProp = classnames('trust-btn', $$props.class, { isActive: isActiveState })\\n\\n    function onClickHandler(e) {\\n        onClickEvent(e)\\n        onClickPromise(e)\\n    }\\n\\n    function onClickEvent(e) {\\n        dispatch('click', e)\\n    }\\n\\n    const onClickPromise = async (e) => {\\n        if (typeof onAsyncClick === 'function') {\\n            try {\\n                isActiveLocal = !isActiveLocal\\n                await onAsyncClick(e)\\n            } catch (err) {\\n                isActiveLocal = !isActiveLocal\\n            }\\n        }\\n    }\\n</script>\\n\\n<button type=\\\"button\\\" title=\\\"I trust\\\" class={classProp} on:click={onClickHandler}>\\n    <div class=\\\"full-absolute\\\">\\n        <svg>\\n            <use xlink:href=\\\"#ico-heart-filled\\\" class=\\\"ico-use\\\"/>\\n        </svg>\\n    </div>\\n</button>\\n\\n<style>\\n    .trust-btn {\\n        position: relative;\\n        display: block;\\n        width: 100%;\\n        height: 0;\\n        padding-bottom: 100%;\\n        border-radius: 50%;\\n        overflow: hidden;\\n    }\\n\\n    div {\\n        display: flex;\\n        align-items: center;\\n        justify-content: center;\\n        border-radius: 50%;\\n        border: 4px solid rgba(var(--color-danger));\\n        background-color: rgba(var(--color-danger), .2);\\n    }\\n\\n    .trust-btn.isActive div {\\n        background-color: rgba(var(--color-danger), 1);\\n    }\\n\\n    .trust-btn.isActive svg {\\n        fill: rgba(var(--color-white));\\n        -webkit-animation: none;\\n                animation: none;\\n        transform: scale(1.1)\\n    }\\n\\n    svg {\\n        width: 50%;\\n        height: 50%;\\n        max-width: calc(100% - 10px);\\n        max-height: calc(100% - 10px);\\n        fill: rgba(var(--color-danger));\\n        -webkit-animation: pulse 2s infinite;\\n                animation: pulse 2s infinite;\\n    }\\n\\n    @-webkit-keyframes pulse {\\n        10% {\\n            transform: scale(1.1)\\n        }\\n        20% {\\n            transform: scale(1.05)\\n        }\\n        30% {\\n            transform: scale(1.15)\\n        }\\n    }\\n\\n    @keyframes pulse {\\n        10% {\\n            transform: scale(1.1)\\n        }\\n        20% {\\n            transform: scale(1.05)\\n        }\\n        30% {\\n            transform: scale(1.15)\\n        }\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AA4CI,UAAU,8BAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,CAAC,CACT,cAAc,CAAE,IAAI,CACpB,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,GAAG,8BAAC,CAAC,AACD,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,IAAI,cAAc,CAAC,CAAC,CAC3C,gBAAgB,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,EAAE,CAAC,AACnD,CAAC,AAED,UAAU,wBAAS,CAAC,GAAG,eAAC,CAAC,AACrB,gBAAgB,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,CAAC,CAAC,AAClD,CAAC,AAED,UAAU,wBAAS,CAAC,GAAG,eAAC,CAAC,AACrB,IAAI,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAC9B,iBAAiB,CAAE,IAAI,CACf,SAAS,CAAE,IAAI,CACvB,SAAS,CAAE,MAAM,GAAG,CAAC;IACzB,CAAC,AAED,GAAG,8BAAC,CAAC,AACD,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAC5B,UAAU,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAC7B,IAAI,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,CAC/B,iBAAiB,CAAE,oBAAK,CAAC,EAAE,CAAC,QAAQ,CAC5B,SAAS,CAAE,oBAAK,CAAC,EAAE,CAAC,QAAQ,AACxC,CAAC,AAED,mBAAmB,oBAAM,CAAC,AACtB,GAAG,AAAC,CAAC,AACD,SAAS,CAAE,MAAM,GAAG,CAAC;QACzB,CAAC,AACD,GAAG,AAAC,CAAC,AACD,SAAS,CAAE,MAAM,IAAI,CAAC;QAC1B,CAAC,AACD,GAAG,AAAC,CAAC,AACD,SAAS,CAAE,MAAM,IAAI,CAAC;QAC1B,CAAC,AACL,CAAC,AAED,WAAW,oBAAM,CAAC,AACd,GAAG,AAAC,CAAC,AACD,SAAS,CAAE,MAAM,GAAG,CAAC;QACzB,CAAC,AACD,GAAG,AAAC,CAAC,AACD,SAAS,CAAE,MAAM,IAAI,CAAC;QAC1B,CAAC,AACD,GAAG,AAAC,CAAC,AACD,SAAS,CAAE,MAAM,IAAI,CAAC;QAC1B,CAAC,AACL,CAAC\"}"
};
...
const TrustButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<button type="${"button"}" title="${"I trust"}" class="${escape(null_to_empty(classProp)) + " svelte-15exogk"}">
    <div class="${"full-absolute svelte-15exogk"}">
        <svg class="${"svelte-15exogk"}">
...
/* src/components/app/DonatingGroup.svelte generated by Svelte v3.18.1 */

const css$n = {
	code: "ul.svelte-1dxcl4a{position:fixed;top:50px;left:0;width:100%;flex:0;display:flex;z-index:9;padding:var(--screen-padding);transition:.3s ease-in-out;background-color:rgba(var(--theme-bg-color));box-shadow:var(--shadow-primary)}li.svelte-1dxcl4a{flex:1 1 0}",
	map: "{\"version\":3,\"file\":\"DonatingGroup.svelte\",\"sources\":[\"DonatingGroup.svelte\"],\"sourcesContent\":[\"<script>\\n    import Button from '../Button.svelte'\\n</script>\\n\\n<ul class=\\\"active font-secondary\\\">\\n    <li>\\n        <Button is=\\\"success\\\" size=\\\"medium\\\" on:click=\\\"{e => alert('Дякую! 🥰')}\\\">Допомогти</Button>\\n    </li>\\n    <li style=\\\"flex: none\\\">\\n        <s></s>\\n        <s></s>\\n        <s></s>\\n    </li>\\n    <li>\\n        <Button is=\\\"warning\\\" size=\\\"medium\\\" on:click=\\\"{e => alert('Дякую! 🥰')}\\\">Поділитись</Button>\\n    </li>\\n</ul>\\n\\n<style>\\n    ul {\\n        position: fixed;\\n        top: 50px;\\n        left: 0;\\n        width: 100%;\\n        flex: 0;\\n        display: flex;\\n        z-index: 9;\\n        padding: var(--screen-padding);\\n        transition: .3s ease-in-out;\\n        background-color: rgba(var(--theme-bg-color));\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    li {\\n        flex: 1 1 0;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAmBI,EAAE,eAAC,CAAC,AACA,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAC9B,UAAU,CAAE,GAAG,CAAC,WAAW,CAC3B,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAC7C,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAED,EAAE,eAAC,CAAC,AACA,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,AACf,CAAC\"}"
};

const DonatingGroup = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$n);

	return `<ul class="${"active font-secondary svelte-1dxcl4a"}">
    <li class="${"svelte-1dxcl4a"}">
        ${validate_component(Button, "Button").$$render($$result, { is: "success", size: "medium" }, {}, { default: () => `Допомогти` })}
    </li>
    <li style="${"flex: none"}" class="${"svelte-1dxcl4a"}">
        <s></s>
        <s></s>
        <s></s>
    </li>
