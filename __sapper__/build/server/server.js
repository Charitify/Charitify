...
const css$6 = {
	code: ".ava.svelte-1k301ob{flex:none;display:flex;border-radius:50%;overflow:hidden}.small.svelte-1k301ob{width:25px;height:25px}.medium.svelte-1k301ob{width:35px;height:35px}.big.svelte-1k301ob{width:130px;height:130px}",
...
const Avatar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-1k301ob"}">
