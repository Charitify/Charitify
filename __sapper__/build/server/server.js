...
const Documents = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"scroll-x-center svelte-1mh1key"}">
    ${each(all, img => `<li class="${"svelte-1mh1key"}">
...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    ${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
        ...
        <p class="${"h1"}">History of pet</p>
        <br class="${"tiny"}">
        <table class="${"svelte-14b4rxo"}">
            <tbody>
            <tr>
                <td class="${"svelte-14b4rxo"}">01.02.2019</td>
                <td class="${"svelte-14b4rxo"}">—</td>
                <td class="${"svelte-14b4rxo"}">His first Happy Birthday</td>
            </tr>
            <tr>
                <td class="${"svelte-14b4rxo"}">05.02.2019</td>
                <td class="${"svelte-14b4rxo"}">—</td>
                <td class="${"svelte-14b4rxo"}">We got him from the owners at the shelter</td>
            </tr>
            <tr>
                <td class="${"svelte-14b4rxo"}">07.03.2019</td>
                <td class="${"svelte-14b4rxo"}">—</td>
                <td class="${"svelte-14b4rxo"}">We do a vaccination for him from fleas</td>
            </tr>
            <tr>
                <td class="${"svelte-14b4rxo"}">23.06.2019</td>
                <td class="${"svelte-14b4rxo"}">—</td>
                <td class="${"svelte-14b4rxo"}">We do anouter vaccination</td>
            </tr>
            </tbody>
        </table>
