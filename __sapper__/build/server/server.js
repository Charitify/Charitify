...
function disableScroll(el) {
    ...
    bodyScrollLock.disableBodyScroll(el || defaltEl);
}

function enableScroll(el) {
    const defaltEl = document.getElementById('portal');
    bodyScrollLock.enableBodyScroll(el || defaltEl);
}
...
const Modal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	? `${validate_component(Portal, "Portal").$$render($$result, {}, {}, {
			default: () => `
        <div${add_attribute("id", `modal-${id}`, 0)} aria-hidden="${"true"}" class="${escape(null_to_empty(classProp)) + " svelte-jl8bb2"}"${add_attribute("style", `transition-duration: ${DURATION}ms`, 0)}${add_attribute("this", ref, 1)}>
...
${!slots.box
	? `${validate_component(Portal, "Portal").$$render($$result, {}, {}, {
			default: () => `
        <section class="${escape(null_to_empty(classProp)) + " svelte-1e3vswx"}"${add_attribute("style", `transition-duration: ${DURATION$1}ms`, 0)}${add_attribute("this", ref, 1)}>
