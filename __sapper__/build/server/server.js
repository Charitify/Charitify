 ...
 */
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-plonog"}">
    ${titleProp
    ...
    <div class="${"inp-inner-wrap svelte-plonog"}">
        ${rows || type === "textarea"
	? `<textarea${spread(
			[
				{ min: escape(min) },
	...
	: `<input${spread(
        ...
        <label${add_attribute("for", idProp, 0)} class="${"inp-post-icon svelte-plonog"}">
            ${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${iconType
		? `<span class="${"inp-post-icon-inner svelte-plonog"}">
...
const css$i = {
	code: ".select.svelte-o5i1je.svelte-o5i1je{width:100%;-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.select.null.svelte-o5i1je .inp-inner.svelte-o5i1je{color:rgba(var(--theme-color-primary-opposite), .2) !important}.select.svelte-o5i1je .inp-inner-wrap.svelte-o5i1je{position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-shadow:var(--shadow-field-inset);box-shadow:var(--shadow-field-inset);border-radius:var(--border-radius-small);background-color:rgba(var(--theme-bg-color))}.select.svelte-o5i1je .inp-inner.svelte-o5i1je{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;color:inherit;overflow-y:auto;overflow-x:hidden;background-color:transparent;-webkit-overflow-scrolling:touch;min-width:var(--min-interactive-size);min-height:var(--min-interactive-size);border-radius:var(--border-radius-small)}.select.svelte-o5i1je .inp-post-icon.svelte-o5i1je{position:absolute;top:0;right:0;height:100%;width:var(--min-interactive-size);-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;overflow:hidden}.select.svelte-o5i1je .inp-post-icon-inner.svelte-o5i1je{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;width:var(--min-interactive-size)}.select.svelte-o5i1je .inp-inner.svelte-o5i1je::-webkit-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.select.svelte-o5i1je .inp-inner.svelte-o5i1je::-moz-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.select.svelte-o5i1je .inp-inner.svelte-o5i1je:-ms-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.select.svelte-o5i1je .inp-inner.svelte-o5i1je::-ms-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.select.svelte-o5i1je .inp-inner.svelte-o5i1je::placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.select.postIcon.svelte-o5i1je .inp-inner.svelte-o5i1je{padding-right:var(--min-interactive-size)}.select.svelte-o5i1je .inp-inner.svelte-o5i1je:invalid,.select.error.svelte-o5i1je .inp-inner.svelte-o5i1je{-webkit-box-shadow:0 0 0 1px rgb(var(--color-danger));box-shadow:0 0 0 1px rgb(var(--color-danger));color:rgb(var(--color-danger))}.select .inp-inner:invalid+.inp-post-icon.svelte-o5i1je.svelte-o5i1je .ico,.select.error.svelte-o5i1je .inp-post-icon.svelte-o5i1je .ico{color:rgb(var(--color-danger)) !important}.select.svelte-o5i1je .inp-inner.svelte-o5i1je:focus{-webkit-box-shadow:0 0 0 1px rgb(var(--color-info));box-shadow:0 0 0 1px rgb(var(--color-info));color:rgb(var(--color-info))}.select .inp-inner:focus+.inp-post-icon.svelte-o5i1je.svelte-o5i1je .ico{color:rgb(var(--color-info)) !important}",
	map: "{\"version\":3,\"file\":\"Select.svelte\",\"sources\":[\"Select.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames, toCSSString } from '@utils'\\n    import Br from '@components/Br.svelte'\\n    import Icon from '@components/Icon.svelte'\\n    import FieldErrors from '@components/FieldErrors.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let name\\n    export let style = {}\\n    export let type = 'select'\\n    export let value = undefined\\n    export let id = undefined\\n    export let align = undefined\\n    export let disabled = false\\n    export let label = undefined\\n    export let invalid = undefined\\n    export let form = undefined // Specifies the form the <input> element belongs to\\n    export let readonly = undefined // undefined|readonly\\n    export let required = undefined // undefined|required\\n    export let ariaLabel = undefined\\n    export let placeholder = undefined\\n    export let autocomplete = 'on'\\n    export let postIcon = undefined\\n    export let errors = undefined\\n    /**\\n     *\\n     * @type {{\\n     *     value: string,\\n     *     label: string,\\n     * }[]}\\n     */\\n    export let options = []\\n\\n    $: iconType = postIcon || 'caret-down'\\n    $: error = invalid || !!(errors || []).length\\n    $: idProp = id || name\\n    $: titleProp = label || ariaLabel\\n    $: ariaLabelProp = ariaLabel || label || placeholder\\n    $: styleProp = toCSSString({ ...style, textAlign: align })\\n    $: classProp = classnames('select', $$props.class, { disabled, readonly, required, error, null: value === undefined })\\n\\n    function onChange(e) {\\n        const value = getValue(e)\\n        dispatch('change', { e, value, name })\\n    }\\n    \\n    function getValue(e) {\\n        return e.target.value\\n    }\\n</script>\\n\\n<div class={classProp}>\\n    {#if titleProp}\\n        <label for={idProp} class=\\\"block h2 font-w-500 full-width text-left\\\">\\n            { titleProp }\\n        </label>\\n        <Br size=\\\"10\\\"/>\\n    {/if}\\n\\n    <div class=\\\"inp-inner-wrap\\\">\\n        <select\\n                {name}\\n                {type}\\n                {form}\\n                {align}\\n                {readonly}\\n                {disabled}\\n                {required}\\n                {placeholder}\\n                {autocomplete}\\n                id={idProp}\\n                class=\\\"inp-inner\\\"\\n                title={titleProp}\\n                style={styleProp}\\n                aria-label={ariaLabelProp}\\n                bind:value\\n                on:change={onChange}\\n                on:blur='{e => !disabled && dispatch(\\\"blur\\\", e)}'\\n                on:focus='{e => !disabled && dispatch(\\\"focus\\\", e)}'\\n        >\\n            {#if !required}\\n                <option value={undefined}>{placeholder || ''}</option>\\n            {/if}\\n            {#each options as { label: text, ...option }}\\n                {#if option.value !== undefined && text !== undefined}\\n                    <option value={option.value}>\\n                        {text}\\n                    </option>\\n                {/if}\\n            {/each}\\n        </select>\\n\\n        <label for={idProp} class=\\\"inp-post-icon\\\">\\n            <slot name=\\\"post-icon\\\">\\n                {#if iconType}\\n                    <span class=\\\"inp-post-icon-inner\\\">\\n                        <Icon type={iconType} is=\\\"info\\\" size=\\\"medium\\\"/>\\n                    </span>\\n                {/if}\\n            </slot>\\n        </label>\\n    </div>\\n\\n    <FieldErrors items={errors}/>\\n</div>\\n\\n<style>\\n    .select {\\n        width: 100%;\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 auto;\\n                flex: 1 1 auto;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-orient: vertical;\\n        -webkit-box-direction: normal;\\n            -ms-flex-direction: column;\\n                flex-direction: column;\\n    }\\n\\n    .select.null .inp-inner {\\n        color: rgba(var(--theme-color-primary-opposite), .2) !important;\\n    }\\n\\n    .select .inp-inner-wrap {\\n        position: relative;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-shadow: var(--shadow-field-inset);\\n                box-shadow: var(--shadow-field-inset);\\n        border-radius: var(--border-radius-small);\\n        background-color: rgba(var(--theme-bg-color));\\n    }\\n\\n    .select .inp-inner {\\n        -webkit-box-flex: 1;\\n            -ms-flex-positive: 1;\\n                flex-grow: 1;\\n        color: inherit;\\n        overflow-y: auto;\\n        overflow-x: hidden;\\n        background-color: transparent;\\n        -webkit-overflow-scrolling: touch;\\n        min-width: var(--min-interactive-size);\\n        min-height: var(--min-interactive-size);\\n        border-radius: var(--border-radius-small);\\n    }\\n\\n    .select .inp-post-icon {\\n        position: absolute;\\n        top: 0;\\n        right: 0;\\n        height: 100%;\\n        width: var(--min-interactive-size);\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        overflow: hidden;\\n    }\\n\\n    .select .inp-post-icon-inner {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        width: var(--min-interactive-size);\\n    }\\n\\n    .select .inp-inner::-webkit-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .select .inp-inner::-moz-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .select .inp-inner:-ms-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .select .inp-inner::-ms-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .select .inp-inner option[default],\\n    .select .inp-inner::placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .select.postIcon .inp-inner {\\n        padding-right: var(--min-interactive-size);\\n    }\\n\\n    .select .inp-inner:invalid,\\n    .select.error .inp-inner {\\n        -webkit-box-shadow: 0 0 0 1px rgb(var(--color-danger));\\n                box-shadow: 0 0 0 1px rgb(var(--color-danger));\\n        color: rgb(var(--color-danger));\\n    }\\n\\n    .select .inp-inner:invalid + .inp-post-icon :global(.ico),\\n    .select.error .inp-post-icon :global(.ico) {\\n        color: rgb(var(--color-danger)) !important;\\n    }\\n\\n    .select .inp-inner:focus {\\n        -webkit-box-shadow: 0 0 0 1px rgb(var(--color-info));\\n                box-shadow: 0 0 0 1px rgb(var(--color-info));\\n        color: rgb(var(--color-info));\\n    }\\n\\n    .select .inp-inner:focus + .inp-post-icon :global(.ico) {\\n        color: rgb(var(--color-info)) !important;\\n    }\\n\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AA6GI,OAAO,4BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACtB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,AAClC,CAAC,AAED,OAAO,mBAAK,CAAC,UAAU,cAAC,CAAC,AACrB,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,UAAU,AACnE,CAAC,AAED,qBAAO,CAAC,eAAe,cAAC,CAAC,AACrB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,kBAAkB,CAAE,IAAI,oBAAoB,CAAC,CACrC,UAAU,CAAE,IAAI,oBAAoB,CAAC,CAC7C,aAAa,CAAE,IAAI,qBAAqB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,AACjD,CAAC,AAED,qBAAO,CAAC,UAAU,cAAC,CAAC,AAChB,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,WAAW,CAC7B,0BAA0B,CAAE,KAAK,CACjC,SAAS,CAAE,IAAI,sBAAsB,CAAC,CACtC,UAAU,CAAE,IAAI,sBAAsB,CAAC,CACvC,aAAa,CAAE,IAAI,qBAAqB,CAAC,AAC7C,CAAC,AAED,qBAAO,CAAC,cAAc,cAAC,CAAC,AACpB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,sBAAsB,CAAC,CAClC,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,qBAAO,CAAC,oBAAoB,cAAC,CAAC,AAC1B,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,KAAK,CAAE,IAAI,sBAAsB,CAAC,AACtC,CAAC,AAED,qBAAO,CAAC,wBAAU,2BAA2B,AAAC,CAAC,AAC3C,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,qBAAO,CAAC,wBAAU,kBAAkB,AAAC,CAAC,AAClC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,qBAAO,CAAC,wBAAU,sBAAsB,AAAC,CAAC,AACtC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,qBAAO,CAAC,wBAAU,uBAAuB,AAAC,CAAC,AACvC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAGD,qBAAO,CAAC,wBAAU,aAAa,AAAC,CAAC,AAC7B,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,OAAO,uBAAS,CAAC,UAAU,cAAC,CAAC,AACzB,aAAa,CAAE,IAAI,sBAAsB,CAAC,AAC9C,CAAC,AAED,qBAAO,CAAC,wBAAU,QAAQ,CAC1B,OAAO,oBAAM,CAAC,UAAU,cAAC,CAAC,AACtB,kBAAkB,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,cAAc,CAAC,CAAC,CAC9C,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,cAAc,CAAC,CAAC,CACtD,KAAK,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,AACnC,CAAC,AAED,OAAO,CAAC,UAAU,QAAQ,CAAG,0CAAc,CAAC,AAAQ,IAAI,AAAC,CACzD,OAAO,oBAAM,CAAC,4BAAc,CAAC,AAAQ,IAAI,AAAE,CAAC,AACxC,KAAK,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,CAAC,UAAU,AAC9C,CAAC,AAED,qBAAO,CAAC,wBAAU,MAAM,AAAC,CAAC,AACtB,kBAAkB,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,YAAY,CAAC,CAAC,CAC5C,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,YAAY,CAAC,CAAC,CACpD,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,AACjC,CAAC,AAED,OAAO,CAAC,UAAU,MAAM,CAAG,0CAAc,CAAC,AAAQ,IAAI,AAAE,CAAC,AACrD,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,CAAC,UAAU,AAC5C,CAAC\"}"
};
...
const Select = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-o5i1je"}">
    ${titleProp
    ...
    <div class="${"inp-inner-wrap svelte-o5i1je"}">
        <select${add_attribute("name", name, 0)}${add_attribute("type", type, 0)}${add_attribute("form", form, 0)}${add_attribute("align", align, 0)} ${readonly ? "readonly" : ""} ${disabled ? "disabled" : ""} ${required ? "required" : ""}${add_attribute("placeholder", placeholder, 0)}${add_attribute("autocomplete", autocomplete, 0)}${add_attribute("id", idProp, 0)} class="${"inp-inner svelte-o5i1je"}"${add_attribute("title", titleProp, 0)}${add_attribute("style", styleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}${add_attribute("value", value, 1)}>
            ${!required
	...
	: ``}`)}
        ...
        <label${add_attribute("for", idProp, 0)} class="${"inp-post-icon svelte-o5i1je"}">
            ${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${iconType
		? `<span class="${"inp-post-icon-inner svelte-o5i1je"}">
                        ${validate_component(Icon, "Icon").$$render(
				$$result,
				{
					type: iconType,
...
const css$k = {
	code: ".inp-upload.svelte-7pjp4x.svelte-7pjp4x{width:100%;-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-ms-flex-item-align:stretch;align-self:stretch;justify-self:stretch;overflow:hidden;border-radius:var(--border-radius-medium);color:rgba(var(--theme-color-primary-opposite), .5);background-color:rgba(var(--theme-color-primary-opposite), .07);-webkit-transform:translateZ(0);transform:translateZ(0)}.inp-upload.preview.svelte-7pjp4x .icon.svelte-7pjp4x{opacity:.5}.inp-upload.disabled.svelte-7pjp4x.svelte-7pjp4x{opacity:.5;pointer-events:none}.inp-upload.error.svelte-7pjp4x.svelte-7pjp4x,input:invalid+.inp-upload.svelte-7pjp4x.svelte-7pjp4x{color:rgba(var(--color-danger), .5);background-color:rgba(var(--color-danger), .07)}input:focus+.inp-upload.svelte-7pjp4x.svelte-7pjp4x{color:rgba(var(--color-info), .5);background-color:rgba(var(--color-info), .07)}",
	map: "{\"version\":3,\"file\":\"UploadBox.svelte\",\"sources\":[\"UploadBox.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames } from '@utils'\\n    import Br from '@components/Br.svelte'\\n    import Icon from '@components/Icon.svelte'\\n    import Square from '@components/Square.svelte'\\n    import Picture from '@components/Picture.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let id = undefined\\n    export let src = undefined\\n    export let name = undefined\\n    export let icon = undefined\\n    export let label = undefined\\n    export let value = undefined\\n    export let iconIs = undefined\\n    export let errors = undefined\\n    export let invalid = undefined\\n    export let multiple = undefined\\n    export let disabled = undefined\\n    export let accept = \\\"image/png, image/jpeg\\\"\\n\\n    $: error = invalid !== undefined ? invalid : !!(errors || []).length\\n    $: iconType = icon || 'upload'\\n    $: idProp = id || name\\n    $: classProp = classnames('inp-upload', { error, disabled, preview: src })\\n\\n    function onChange(e) {\\n        const value = Array.from(e.target.files)\\n        if (!value || !value.length) return\\n        dispatch('change', { value, name, e })\\n    }\\n</script>\\n\\n{#if label}\\n    <h2 class=\\\"text-left\\\">{label}</h2>\\n    <Br size=\\\"10\\\"/>\\n{/if}\\n<Square class={$$props.class}>\\n    <input\\n        {name}\\n        {accept}\\n        {multiple}\\n        hidden \\n        type=\\\"file\\\" \\n        id={idProp}\\n        bind:value\\n        on:change={onChange}\\n    >\\n    <label for={idProp} class={classProp}>\\n        <div class=\\\"flex full-absolute\\\">\\n            <Picture {src}/> \\n        </div>\\n        <div class=\\\"icon flex relative\\\" style=\\\"flex: 0 0 75px\\\">\\n            <Icon type={iconType} is={iconIs}/>\\n        </div>\\n    </label>\\n</Square>\\n\\n<style>\\n    .inp-upload {\\n        width: 100%;\\n        -webkit-box-flex: 1;\\n            -ms-flex-positive: 1;\\n                flex-grow: 1;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        justify-self: stretch;\\n        overflow: hidden;\\n        border-radius: var(--border-radius-medium);\\n        color: rgba(var(--theme-color-primary-opposite), .5);\\n        background-color: rgba(var(--theme-color-primary-opposite), .07);\\n        -webkit-transform: translateZ(0);\\n                transform: translateZ(0);\\n    }\\n\\n    .inp-upload.preview .icon {\\n        opacity: .5;\\n    }\\n\\n    .inp-upload.disabled {\\n        opacity: .5;\\n        pointer-events: none;\\n    }\\n\\n    .inp-upload.error,\\n    input:invalid + .inp-upload {\\n        color: rgba(var(--color-danger), .5);\\n        background-color: rgba(var(--color-danger), .07);\\n    }\\n\\n    input:focus + .inp-upload {\\n        color: rgba(var(--color-info), .5);\\n        background-color: rgba(var(--color-info), .07);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\"],\"names\":[],\"mappings\":\"AA6DI,WAAW,4BAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,YAAY,CAAE,OAAO,CACrB,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,IAAI,sBAAsB,CAAC,CAC1C,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAAC,EAAE,CAAC,CACpD,gBAAgB,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAAC,GAAG,CAAC,CAChE,iBAAiB,CAAE,WAAW,CAAC,CAAC,CACxB,SAAS,CAAE,WAAW,CAAC,CAAC,AACpC,CAAC,AAED,WAAW,sBAAQ,CAAC,KAAK,cAAC,CAAC,AACvB,OAAO,CAAE,EAAE,AACf,CAAC,AAED,WAAW,SAAS,4BAAC,CAAC,AAClB,OAAO,CAAE,EAAE,CACX,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,WAAW,kCAAM,CACjB,KAAK,QAAQ,CAAG,WAAW,4BAAC,CAAC,AACzB,KAAK,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,EAAE,CAAC,CACpC,gBAAgB,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,GAAG,CAAC,AACpD,CAAC,AAED,KAAK,MAAM,CAAG,WAAW,4BAAC,CAAC,AACvB,KAAK,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,EAAE,CAAC,CAClC,gBAAgB,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,GAAG,CAAC,AAClD,CAAC\"}"
};
...
${validate_component(Square, "Square").$$render($$result, { class: $$props.class }, {}, {
    ...
    <label${add_attribute("for", idProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-7pjp4x"}">
        <div class="${"flex full-absolute"}">
            ${validate_component(Picture, "Picture").$$render($$result, { src }, {}, {})} 
        </div>
        <div class="${"icon flex relative svelte-7pjp4x"}" style="${"flex: 0 0 75px"}">
...
const css$l = {
	code: "ul.svelte-5cy3jr{width:100%;display:grid;grid-template:auto / .5fr .5fr;grid-gap:20px}button.svelte-5cy3jr{position:absolute;top:0;right:0;font-size:24px;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;width:40px;height:40px}",
	map: "{\"version\":3,\"file\":\"UploadBoxGroup.svelte\",\"sources\":[\"UploadBoxGroup.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { _, classnames } from '@utils'\\n    import Br from '@components/Br.svelte'\\n    import Icon from '@components/Icon.svelte'\\n    import UploadBox from './UploadBox.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let name\\n    export let id = undefined\\n    export let label = undefined\\n    export let value = undefined\\n    export let accept = undefined\\n    export let errors = undefined\\n    export let invalid = undefined\\n    export let multiple = undefined\\n    export let disabled = undefined\\n    export let infoIndex = [0]\\n\\n    const BOX_AMOUNT = 4\\n\\n    let values = value || []\\n    let previews = []\\n\\n    $: error = invalid !== undefined ? invalid : !!(errors || []).length\\n    $: idProp = id || name\\n    $: itemsList = getCells(values)\\n    $: setPreviewSrc(values)\\n    $: classProp = classnames('inp-upload-group', $$props.class, { error, disabled })\\n\\n    function getCells(list) {\\n        const defaultList = new Array(BOX_AMOUNT - 1).fill(undefined)\\n        const listArr = [].concat(list || [])\\n        const biggerList = listArr.length > defaultList.length ? listArr : defaultList\\n        biggerList.push(undefined)\\n        return biggerList.map(((_, i) => listArr[i] || defaultList[i]))\\n    }\\n\\n    function setPreviewSrc(files) {\\n        try {\\n            if (files && files.length) {\\n                let loads = []\\n                files.forEach((file, i) => {\\n                    const reader = new FileReader();\\n                    reader.onload = function(e) {\\n                        const src = e.target.result\\n                        loads[i] = src\\n                        const filtered = loads.filter(Boolean)\\n                        previews = filtered\\n                    }\\n                    reader.readAsDataURL(file); // convert to base64 string\\n                })\\n            } else {\\n                previews = []\\n            }\\n        } catch(e) {\\n            console.log('UploadBoxGroup/getPreviewSrc error: ', e)\\n        }\\n    }\\n    \\n    function onChange(i, { detail: { e, value } }) {\\n        const val = [...values]\\n        val.splice(i, 0, ...value)\\n        values = val\\n        dispatch('change', { e, name, value: values })\\n    }\\n\\n    function onRemove(i, e) {\\n        values = [...values.filter((_, ind) => ind !== i)]\\n        dispatch('change', { e, name, value: values })\\n    }\\n</script>\\n\\n{#if label}\\n    <h2 class=\\\"text-left\\\">{label}</h2>\\n    <Br size=\\\"10\\\"/>\\n{/if}\\n<ul id={idProp} class={classProp}>\\n    {#each itemsList as item, i}\\n        <li class=\\\"relative\\\">\\n            <UploadBox\\n                key={i}\\n                {accept}\\n                {invalid}\\n                {disabled}\\n                {multiple}\\n                bind:value\\n                src={previews[i]}\\n                name={`${name || ''}[${i}]`}\\n                errors={_.get(errors, i)}\\n                iconIs={infoIndex.includes(i) ? 'info' : undefined}\\n                on:change={onChange.bind(null, i)}\\n            />\\n\\n            {#if previews[i]}\\n                <button type=\\\"button\\\" on:click={onRemove.bind(null, i)}>\\n                    <Icon size=\\\"big\\\" type=\\\"close\\\"/>    \\n                </button>\\n            {/if}\\n        </li>\\n    {/each}\\n</ul>\\n\\n<style>\\n    ul {\\n        width: 100%;\\n        display: grid;\\n        grid-template: auto / .5fr .5fr;\\n        grid-gap: 20px;\\n    }\\n    button {\\n        position: absolute;\\n        top: 0;\\n        right: 0;\\n        font-size: 24px;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        width: 40px;\\n        height: 40px;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\"],\"names\":[],\"mappings\":\"AAyGI,EAAE,cAAC,CAAC,AACA,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,IAAI,CAC/B,QAAQ,CAAE,IAAI,AAClB,CAAC,AACD,MAAM,cAAC,CAAC,AACJ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC\"}"
};
...
const UploadBoxGroup = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
		: ``}
<ul${add_attribute("id", idProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-5cy3jr"}">
    ${each(itemsList, (item, i) => `<li class="${"relative"}">
            ...
            ${previews[i]
		? `<button type="${"button"}" class="${"svelte-5cy3jr"}">
