...
const Layout$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <nav class="${"svelte-151vlup"}">
        <ul class="${"svelte-151vlup"}">
            <li class="${"svelte-151vlup"}"><a rel="${"prefetch"}" href="${"lists/funds"}" class="${["svelte-151vlup", segment === "charities" ? "selected" : ""].join(" ").trim()}">funds</a></li>
            <li class="${"svelte-151vlup"}"><a rel="${"prefetch"}" href="${"lists/organizations"}" class="${["svelte-151vlup", segment === "organizations" ? "selected" : ""].join(" ").trim()}">organizations</a></li>
        </ul>
    </nav>
