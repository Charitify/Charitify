...
const css$b = {
	code: ".carousel.rounded.svelte-v2q7l8.svelte-v2q7l8>.carousel-inner.svelte-v2q7l8.svelte-v2q7l8{border-radius:var(--border-radius-big)}.carousel.svelte-v2q7l8.svelte-v2q7l8.svelte-v2q7l8,.carousel-inner.svelte-v2q7l8.svelte-v2q7l8.svelte-v2q7l8,.carousel-inner.svelte-v2q7l8.svelte-v2q7l8>li.svelte-v2q7l8.svelte-v2q7l8{position:relative;-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;text-align:left;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}.carousel.dotsBelow.svelte-v2q7l8.svelte-v2q7l8.svelte-v2q7l8{padding-bottom:40px}.carousel.dotsBelow.svelte-v2q7l8.svelte-v2q7l8 .carousel-dots.svelte-v2q7l8.svelte-v2q7l8{bottom:0}.carousel.dotsBelow.svelte-v2q7l8.svelte-v2q7l8 .carousel-dots li.svelte-v2q7l8.svelte-v2q7l8{background-color:rgba(var(--theme-bg-color-opposite))}.carousel.stretch.svelte-v2q7l8>.carousel-inner.svelte-v2q7l8>.fluid.svelte-v2q7l8{-webkit-box-flex:0;-ms-flex:none;flex:none;width:100%}.carousel.auto.svelte-v2q7l8>.carousel-inner.svelte-v2q7l8>.fluid.svelte-v2q7l8{width:auto}.carousel.svelte-v2q7l8.svelte-v2q7l8.svelte-v2q7l8{width:100%}.carousel-inner.svelte-v2q7l8.svelte-v2q7l8.svelte-v2q7l8::-webkit-scrollbar{display:none}.carousel.svelte-v2q7l8.svelte-v2q7l8>.carousel-inner.svelte-v2q7l8.svelte-v2q7l8{width:100%;overflow-y:hidden;overflow-x:scroll}.carousel-dots.svelte-v2q7l8.svelte-v2q7l8.svelte-v2q7l8{position:absolute;left:0;bottom:10px;width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;justify-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-v2q7l8.svelte-v2q7l8 li.svelte-v2q7l8.svelte-v2q7l8{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;-webkit-box-shadow:var(--shadow-primary);box-shadow:var(--shadow-primary);background-color:rgba(var(--color-light))}.carousel-dots.svelte-v2q7l8.svelte-v2q7l8 li.svelte-v2q7l8.svelte-v2q7l8:not(.active){opacity:.5}.carousel-dots.svelte-v2q7l8.svelte-v2q7l8 li.active.svelte-v2q7l8.svelte-v2q7l8{-webkit-transform:scale(1.5);transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil, classnames } from '@utils'\\n    import Picture from '@components/Picture.svelte'\\n    import FancyBox from '@components/FancyBox.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let dotsBelow = true\\n    export let rounded = true\\n    export let size = 'stretch'\\n    export let initIndex = 0\\n    export let disableFancy = false\\n    export let stopPropagation = undefined\\n\\n    let parent = null\\n\\n    $: activeDot = initIndex\\n    $: classProp = classnames('carousel', size, $$props.class, { dotsBelow, rounded })\\n    $: setScrollPosition(parent, initIndex)\\n\\n    function carousel(node) {\\n        node.ontouchstart = e => stopPropagation && (e.stopPropagation())\\n        node.ontouchmove = e => stopPropagation && (e.stopPropagation())\\n        node.ontouchend = e => stopPropagation && (e.stopPropagation())\\n\\n        parent = node\\n        setScrollPosition(node, activeDot)\\n        node.addEventListener('scroll', onScroll)\\n        return { \\n            destroy: () => {\\n                node.removeEventListener('scroll', onScroll)\\n                node.ontouchstart= null\\n                node.ontouchmove= null\\n                node.ontouchend= null\\n            }\\n        }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft, scrollWidth, offsetWidth } = parent\\n        const dotAmount = Array.from(parent.children).length\\n        const scrollX = scrollLeft / (scrollWidth - offsetWidth)\\n        const newActiveDot = Math.round(scrollX * (dotAmount - 1))\\n        if (activeDot !== newActiveDot && !isNaN(newActiveDot)) activeDot = newActiveDot\\n    }\\n\\n    function setScrollPosition(parent, activeDot) {\\n        if (!parent) return\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = Math.round(width * activeDot)\\n            if (parent.scrollLeft !== Math.round(width * activeDot)) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class={classProp}>\\n    <ul \\n        use:carousel\\n        class=\\\"carousel-inner scroll-x-center\\\"\\n    >\\n        {#each items as item, index}\\n            <li class=\\\"fluid\\\" role=\\\"button\\\" on:click={onClick.bind(null, item, index)}>\\n                <slot {item} {index}>\\n                    <FancyBox disabled={disableFancy}>\\n                        <Picture key=\\\"picture\\\" {...item} alt={item.alt || 'Фото слайду'}/>\\n                        <section slot=\\\"box\\\" class=\\\"flex full-width\\\">\\n                            <Picture key=\\\"picture\\\" {...item} alt={item.alt || 'Фото слайду'}/>\\n                        </section>\\n                    </FancyBox>\\n                </slot>\\n            </li>\\n        {/each}\\n    </ul>\\n\\n\\n    {#if dots}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel.rounded > .carousel-inner {\\n       border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel, .carousel-inner, .carousel-inner > li {\\n        position: relative;\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        text-align: left;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    .carousel.dotsBelow {\\n        padding-bottom: 40px;\\n    }\\n\\n    .carousel.dotsBelow .carousel-dots {\\n        bottom: 0;\\n    }\\n\\n    .carousel.dotsBelow .carousel-dots li {\\n        background-color: rgba(var(--theme-bg-color-opposite));\\n    }\\n\\n    .carousel.stretch > .carousel-inner > .fluid {\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        width: 100%;\\n    }\\n\\n    .carousel.auto > .carousel-inner > .fluid {\\n        width: auto;\\n    }\\n\\n    .carousel {\\n        width: 100%;\\n    }\\n\\n    .carousel-inner::-webkit-scrollbar {\\n        display: none;\\n    }\\n\\n    .carousel > .carousel-inner {\\n        width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        left: 0;\\n        bottom: 10px;\\n        width: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        justify-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        -webkit-box-shadow: var(--shadow-primary);\\n                box-shadow: var(--shadow-primary);\\n        background-color: rgba(var(--color-light));\\n    }\\n\\n    .carousel-dots li:not(.active) {\\n        opacity: .5;\\n    }\\n\\n    .carousel-dots li.active {\\n        -webkit-transform: scale(1.5);\\n                transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAgHI,SAAS,oCAAQ,CAAG,eAAe,4BAAC,CAAC,AAClC,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC1C,CAAC,AAED,mDAAS,CAAE,yDAAe,CAAE,2CAAe,CAAG,EAAE,4BAAC,CAAC,AAC9C,QAAQ,CAAE,QAAQ,CAClB,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,IAAI,CAChB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,SAAS,UAAU,0CAAC,CAAC,AACjB,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,SAAS,sCAAU,CAAC,cAAc,4BAAC,CAAC,AAChC,MAAM,CAAE,CAAC,AACb,CAAC,AAED,SAAS,sCAAU,CAAC,cAAc,CAAC,EAAE,4BAAC,CAAC,AACnC,gBAAgB,CAAE,KAAK,IAAI,yBAAyB,CAAC,CAAC,AAC1D,CAAC,AAED,SAAS,sBAAQ,CAAG,6BAAe,CAAG,MAAM,cAAC,CAAC,AAC1C,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,mBAAK,CAAG,6BAAe,CAAG,MAAM,cAAC,CAAC,AACvC,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,0CAAC,CAAC,AACP,KAAK,CAAE,IAAI,AACf,CAAC,AAED,yDAAe,mBAAmB,AAAC,CAAC,AAChC,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,qCAAS,CAAG,eAAe,4BAAC,CAAC,AACzB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,cAAc,0CAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,aAAa,CAAE,MAAM,CACrB,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,0CAAc,CAAC,EAAE,4BAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,kBAAkB,CAAE,IAAI,gBAAgB,CAAC,CACjC,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC9C,CAAC,AAED,0CAAc,CAAC,8BAAE,KAAK,OAAO,CAAC,AAAC,CAAC,AAC5B,OAAO,CAAE,EAAE,AACf,CAAC,AAED,0CAAc,CAAC,EAAE,OAAO,4BAAC,CAAC,AACtB,iBAAiB,CAAE,MAAM,GAAG,CAAC,CACrB,SAAS,CAAE,MAAM,GAAG,CAAC,AACjC,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${escape(null_to_empty(classProp)) + " svelte-v2q7l8"}">
    <ul class="${"carousel-inner scroll-x-center svelte-v2q7l8"}">
        ${each(items, (item, index) => `<li class="${"fluid svelte-v2q7l8"}" role="${"button"}">
                ${$$slots.default
    ...
    ${dots
	? `<ul class="${"carousel-dots svelte-v2q7l8"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-v2q7l8"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
...
const Text = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<rect x="${"0"}" y="${"20%"}" rx="${"2"}" ry="${"2"}" width="${"100%"}" height="${"60%"}"></rect>`;
});

/* src/components/loader/Loader.svelte generated by Svelte v3.18.1 */

const css$o = {
	code: ".loader.svelte-1dt9s0q.svelte-1dt9s0q{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;-ms-flex-item-align:stretch;align-self:stretch}.loader.svelte-1dt9s0q svg.svelte-1dt9s0q{-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;-ms-flex-item-align:stretch;align-self:stretch}.loader.border.svelte-1dt9s0q.svelte-1dt9s0q{border-width:1px;border-style:solid}",
	map: "{\"version\":3,\"file\":\"Loader.svelte\",\"sources\":[\"Loader.svelte\"],\"sourcesContent\":[\"<script>\\n    // How to make a custom loader?\\n    // See here for generating: https://danilowoz.com/create-content-loader/\\n    \\n    import { onMount } from 'svelte'\\n    import { classnames } from '@utils'\\n    import Text from './Text.svelte'\\n\\n    export let width = '100%' \\n    export let height = '100%'\\n    export let light = '#636363';\\n    export let dark = '#000000';\\n    export let opacity = .1;\\n    export let border = false;\\n    export let type = 'p'; // h1, h2, h3, h4, h5, h6, p, pre\\n\\n    let hTypes = {\\n        p: 23,\\n        h1: 37,\\n        h2: 29,\\n        h3: 23,\\n        h4: 23,\\n        h5: 23,\\n        h6: 23,\\n        pre: 20,\\n    }\\n\\n    onMount(() => {\\n        const style = getComputedStyle(document.body);\\n        console.log(style.getPropertyValue('font-size'));\\n        console.log(style.getPropertyValue('line-height'));\\n    })\\n\\n    $: areaWidth = width.replace('%', '')\\n    $: areaHeight = hTypes[type] || height.replace('%', '')\\n    $: classProp = classnames('loader', { border })\\n</script>\\n\\n<section \\n    class={classProp}\\n    style={`opacity: ${opacity}; border-color: ${light};`}\\n>  \\n    <svg\\n        role=\\\"img\\\"\\n        width=\\\"100%\\\"\\n        height={areaHeight}\\n        aria-labelledby=\\\"loading-aria\\\"\\n        viewBox={`0 0 ${areaWidth} ${areaHeight}`}\\n        preserveAspectRatio=\\\"none\\\"\\n    >\\n        <title id=\\\"loading-aria\\\">Loading...</title>\\n        <rect\\n            x=\\\"0\\\"\\n            y=\\\"0\\\"\\n            width=\\\"100%\\\"\\n            height=\\\"100%\\\"\\n            clip-path=\\\"url(#clip-path)\\\"\\n            style='fill: url(\\\"#fill\\\");'\\n        ></rect>\\n        <defs>\\n            <clipPath id=\\\"clip-path\\\">\\n                <slot>\\n                    {#if type}\\n                        <Text/>\\n                    {/if}\\n                </slot>\\n            </clipPath>\\n            <linearGradient id=\\\"fill\\\">\\n            <stop\\n                offset=\\\"0.599964\\\"\\n                stop-color={light}\\n                stop-opacity=\\\"1\\\"\\n            >\\n                <animate\\n                attributeName=\\\"offset\\\"\\n                values=\\\"-2; -2; 1\\\"\\n                keyTimes=\\\"0; 0.25; 1\\\"\\n                dur=\\\"2s\\\"\\n                repeatCount=\\\"indefinite\\\"\\n                ></animate>\\n            </stop>\\n            <stop\\n                offset=\\\"1.59996\\\"\\n                stop-color={dark}\\n                stop-opacity=\\\"1\\\"\\n            >\\n                <animate\\n                attributeName=\\\"offset\\\"\\n                values=\\\"-1; -1; 2\\\"\\n                keyTimes=\\\"0; 0.25; 1\\\"\\n                dur=\\\"2s\\\"\\n                repeatCount=\\\"indefinite\\\"\\n                ></animate>\\n            </stop>\\n            <stop\\n                offset=\\\"2.59996\\\"\\n                stop-color={light}\\n                stop-opacity=\\\"1\\\"\\n            >\\n                <animate\\n                attributeName=\\\"offset\\\"\\n                values=\\\"0; 0; 3\\\"\\n                keyTimes=\\\"0; 0.25; 1\\\"\\n                dur=\\\"2s\\\"\\n                repeatCount=\\\"indefinite\\\"\\n                ></animate>\\n            </stop>\\n            </linearGradient>\\n        </defs>\\n    </svg>\\n</section>\\n\\n<style>\\n    .loader {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 auto;\\n                flex: 1 1 auto;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n    }\\n\\n    .loader svg {\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 auto;\\n                flex: 1 1 auto;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n    }\\n\\n    .loader.border {\\n        border-width: 1px;\\n        border-style: solid;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAiHI,OAAO,8BAAC,CAAC,AACL,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACtB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,AAC3B,CAAC,AAED,sBAAO,CAAC,GAAG,eAAC,CAAC,AACT,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACtB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,AAC3B,CAAC,AAED,OAAO,OAAO,8BAAC,CAAC,AACZ,YAAY,CAAE,GAAG,CACjB,YAAY,CAAE,KAAK,AACvB,CAAC\"}"
};

const Loader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { width = "100%" } = $$props;
	let { height = "100%" } = $$props;
	let { light = "#636363" } = $$props;
	let { dark = "#000000" } = $$props;
	let { opacity = 0.1 } = $$props;
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-1dt9s0q"}"${add_attribute("style", `opacity: ${opacity}; border-color: ${light};`, 0)}>  
    <svg role="${"img"}" width="${"100%"}"${add_attribute("height", areaHeight, 0)} aria-labelledby="${"loading-aria"}"${add_attribute("viewBox", `0 0 ${areaWidth} ${areaHeight}`, 0)} preserveAspectRatio="${"none"}" class="${"svelte-1dt9s0q"}">
        <title id="${"loading-aria"}">Loading...</title>
