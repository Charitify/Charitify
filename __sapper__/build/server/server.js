...
<audio src="${"./button_click.mp3"}"${add_attribute("this", audio, 1)}></audio>`;
});
...
const css$x = {
	...
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n\\timport { onMount } from 'svelte';\\n\\timport { Header } from '@components';\\n\\timport { Storages } from '@services'\\n\\timport { safeGet, disableDoubleTapZoom } from '@utils'\\n\\timport Icons from './_icons.svelte';\\n\\n\\texport let segment;\\n\\n\\tlet theme = safeGet(() => Storages.cookieStorage.get('theme') || Storages.localStorage.get('theme'))\\n\\n\\tonMount(() => {\\n\\t\\tdisableDoubleTapZoom([document])\\n\\t})\\n</script>\\n\\n<Icons/>\\n\\n<main id=\\\"main\\\" class={theme}>\\n\\t<Header {segment}/>\\n\\n\\t<br>\\n\\t<br>\\n\\t<br>\\n\\t<br>\\n\\n\\t<section id=\\\"offline-message\\\">\\n\\t\\tСторінка оффлайн\\n\\t</section>\\n\\n\\t<slot></slot>\\n</main>\\n\\n<style>\\n\\t:global(#offline-message) {\\n\\t\\tposition: fixed;\\n\\t\\tz-index: 11;\\n\\t\\tbottom: calc(env(safe-area-inset-bottom) + 100px);\\n\\t\\tleft: 50%;\\n\\t\\tpadding: 10px 20px;\\n\\t\\tbackground-color: rgba(var(--theme-bg-color));\\n\\t\\tborder-radius: var(--border-radius-small);\\n\\t\\toverflow: hidden;\\n\\t\\t-webkit-transition: .2s ease-out;\\n\\t\\ttransition: .2s ease-out;\\n\\t\\topacity: 0;\\n\\t\\tpointer-events: none;\\n\\t\\t-webkit-transform: translate3d(-50%, 20px, 0);\\n\\t\\t        transform: translate3d(-50%, 20px, 0);\\n\\t}\\n\\t:global(#offline-message.active) {\\n\\t\\topacity: 1;\\n\\t\\tpointer-events: auto;\\n\\t\\t-webkit-transform: translate3d(-50%, 0, 0);\\n\\t\\t        transform: translate3d(-50%, 0, 0);\\n\\t}\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\\n\"],\"names\":[],\"mappings\":\"AAkCS,gBAAgB,AAAE,CAAC,AAC1B,QAAQ,CAAE,KAAK,CACf,OAAO,CAAE,EAAE,CACX,MAAM,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CACjD,IAAI,CAAE,GAAG,CACT,OAAO,CAAE,IAAI,CAAC,IAAI,CAClB,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAC7C,aAAa,CAAE,IAAI,qBAAqB,CAAC,CACzC,QAAQ,CAAE,MAAM,CAChB,kBAAkB,CAAE,GAAG,CAAC,QAAQ,CAChC,UAAU,CAAE,GAAG,CAAC,QAAQ,CACxB,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IAAI,CACpB,iBAAiB,CAAE,YAAY,IAAI,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,CACrC,SAAS,CAAE,YAAY,IAAI,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAAC,AAC9C,CAAC,AACO,uBAAuB,AAAE,CAAC,AACjC,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IAAI,CACpB,iBAAiB,CAAE,YAAY,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAClC,SAAS,CAAE,YAAY,IAAI,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,AAC3C,CAAC\"}"
};
