...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    ${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
        ...
        <h2>Життя Волтера</h2>
        <br class="${"small"}">
        <table class="${"svelte-1y07cus"}">
            <tbody>
            <tr>
                <td class="${"svelte-1y07cus"}">01.02.2019</td>
                <td class="${"svelte-1y07cus"}">—</td>
                <td class="${"svelte-1y07cus"}">Його перший день народження</td>
            </tr>
            <tr>
                <td class="${"svelte-1y07cus"}">05.02.2019</td>
                <td class="${"svelte-1y07cus"}">—</td>
                <td class="${"svelte-1y07cus"}">Ми приютили його з вулиці</td>
            </tr>
            <tr>
                <td class="${"svelte-1y07cus"}">07.03.2019</td>
                <td class="${"svelte-1y07cus"}">—</td>
                <td class="${"svelte-1y07cus"}">Зробили вакцинацію проти бліх</td>
            </tr>
            <tr>
                <td class="${"svelte-1y07cus"}">23.06.2019</td>
                <td class="${"svelte-1y07cus"}">—</td>
                <td class="${"svelte-1y07cus"}">Знайшов для себе улюблену іграшку</td>
            </tr>
            </tbody>
        </table>
...
<button type="${"button"}" class="${escape(null_to_empty(classPropDonateBtn)) + " svelte-1y07cus"}">
