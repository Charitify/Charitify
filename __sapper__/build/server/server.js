...
const css$8 = {
	code: ".carousel.svelte-1hxvg00.svelte-1hxvg00,.carousel-inner.svelte-1hxvg00.svelte-1hxvg00,.carousel-inner.svelte-1hxvg00 li.svelte-1hxvg00,button.svelte-1hxvg00.svelte-1hxvg00{position:relative;flex:none;display:flex;overflow:hidden;align-self:stretch;align-items:stretch;justify-content:stretch}.carousel.stretch.svelte-1hxvg00 .fluid.svelte-1hxvg00{width:100%}.carousel.auto.svelte-1hxvg00 .fluid.svelte-1hxvg00{width:auto}.carousel.svelte-1hxvg00.svelte-1hxvg00{width:100%;border-radius:var(--border-radius-big)}.carousel-inner.svelte-1hxvg00.svelte-1hxvg00::-webkit-scrollbar{display:none}.carousel.svelte-1hxvg00 .carousel-inner.svelte-1hxvg00{width:100%;overflow-y:hidden;overflow-x:scroll}.carousel-dots.svelte-1hxvg00.svelte-1hxvg00{position:absolute;top:0;left:0;width:100%;display:flex;align-items:center;justify-items:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-1hxvg00 li.svelte-1hxvg00{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;background-color:rgba(var(--theme-bg-color));box-shadow:var(--shadow-primary)\n    }li.active.svelte-1hxvg00.svelte-1hxvg00{transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil, classnames } from '../utils'\\n    import Picture from './Picture.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let size = 'stretch'\\n    export let initIndex = 0\\n\\n    $: activeDot = initIndex\\n    $: classProp = classnames('carousel', size, $$props.class)\\n\\n    function carousel(node) {\\n        initScrollPosition(node)\\n        node.addEventListener('scroll', onScroll)\\n        return { destroy: () => node.removeEventListener('scroll', onScroll) }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft } = parent\\n        const { width } = parent.getBoundingClientRect()\\n        const newActiveDot = Math.round(scrollLeft / width)\\n        if (activeDot !== newActiveDot) activeDot = newActiveDot\\n    }\\n\\n    function initScrollPosition(parent) {\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = width * activeDot\\n            if (parent.scrollLeft !== width * activeDot) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class={classProp}>\\n    <ul use:carousel class=\\\"carousel-inner scroll-x-center\\\">\\n        {#each items as item, index}\\n            <li class=\\\"fluid\\\">\\n                <button type=\\\"button\\\" class=\\\"fluid\\\" on:click={onClick.bind(null, item, index)}>\\n                    <slot {item} {index}>\\n                        <Picture {...item}/>\\n                    </slot>\\n                </button>\\n            </li>\\n        {/each}\\n    </ul>\\n\\n\\n    {#if dots}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel, .carousel-inner, .carousel-inner li, button {\\n        position: relative;\\n        flex: none;\\n        display: flex;\\n        overflow: hidden;\\n        align-self: stretch;\\n        align-items: stretch;\\n        justify-content: stretch;\\n    }\\n\\n    .carousel.stretch .fluid {\\n        width: 100%;\\n    }\\n\\n    .carousel.auto .fluid {\\n        width: auto;\\n    }\\n\\n    .carousel {\\n        width: 100%;\\n        border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel-inner::-webkit-scrollbar {\\n        display: none;\\n    }\\n\\n    .carousel .carousel-inner {\\n        width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        display: flex;\\n        align-items: center;\\n        justify-items: center;\\n        justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        background-color: rgba(var(--theme-bg-color));\\n        box-shadow: var(--shadow-primary)\\n    }\\n\\n    li.active {\\n        transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAoFI,uCAAS,CAAE,6CAAe,CAAE,8BAAe,CAAC,iBAAE,CAAE,MAAM,8BAAC,CAAC,AACpD,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CACpB,eAAe,CAAE,OAAO,AAC5B,CAAC,AAED,SAAS,uBAAQ,CAAC,MAAM,eAAC,CAAC,AACtB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,oBAAK,CAAC,MAAM,eAAC,CAAC,AACnB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,8BAAC,CAAC,AACP,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC3C,CAAC,AAED,6CAAe,mBAAmB,AAAC,CAAC,AAChC,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,wBAAS,CAAC,eAAe,eAAC,CAAC,AACvB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,cAAc,8BAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,MAAM,CACrB,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,6BAAc,CAAC,EAAE,eAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAC7C,UAAU,CAAE,IAAI,gBAAgB,CAAC;IACrC,CAAC,AAED,EAAE,OAAO,8BAAC,CAAC,AACP,SAAS,CAAE,MAAM,GAAG,CAAC,AACzB,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${escape(null_to_empty(classProp)) + " svelte-1hxvg00"}">
    <ul class="${"carousel-inner scroll-x-center svelte-1hxvg00"}">
        ${each(items, (item, index) => `<li class="${"fluid svelte-1hxvg00"}">
                <button type="${"button"}" class="${"fluid svelte-1hxvg00"}">
                    ${$$slots.default
    ...
    ${dots
	? `<ul class="${"carousel-dots svelte-1hxvg00"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-1hxvg00"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
...
const css$c = {
	code: "div.svelte-1gfjwai{flex:none;display:flex;align-self:stretch;height:180px;width:126px;padding:0 5px;box-sizing:content-box}div.start.svelte-1gfjwai{padding-left:calc(var(--screen-padding) + 5px)}div.end.svelte-1gfjwai{padding-right:calc( var(--screen-padding) + 5px)}",
	map: "{\"version\":3,\"file\":\"Documents.svelte\",\"sources\":[\"Documents.svelte\"],\"sourcesContent\":[\"<script>\\n    import Card from '../Card.svelte'\\n    import Picture from '../Picture.svelte'\\n    import Carousel from '../Carousel.svelte'\\n\\n    const cardSample = {\\n        src: 'https://placeimg.com/300/300/people',\\n        alt: '10грн',\\n    }\\n\\n    const all = new Array(5).fill(cardSample)\\n</script>\\n\\n<Carousel items={all} size=\\\"auto\\\" dots={false} let:item={item} let:index={index}>\\n    <div class={!index ? 'start' : index === all.length - 1 ? 'end' : ''}>\\n        <Card class=\\\"flex\\\">\\n            <Picture {...item} size=\\\"contain\\\"/>\\n        </Card>\\n    </div>\\n</Carousel>\\n\\n<style>\\n    div {\\n        flex: none;\\n        display: flex;\\n        align-self: stretch;\\n        height: 180px;\\n        width: 126px;\\n        padding: 0 5px;\\n        box-sizing: content-box;\\n    }\\n\\n    div.start {\\n        padding-left: calc(var(--screen-padding) + 5px);\\n    }\\n\\n    div.end {\\n        padding-right:calc( var(--screen-padding) + 5px);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAsBI,GAAG,eAAC,CAAC,AACD,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,CAAC,CAAC,GAAG,CACd,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,GAAG,MAAM,eAAC,CAAC,AACP,YAAY,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAED,GAAG,IAAI,eAAC,CAAC,AACL,cAAc,MAAM,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACpD,CAAC\"}"
};
...
const Documents = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Carousel, "Carousel").$$render($$result, { items: all, size: "auto", dots: false }, {}, {
		default: ({ item, index }) => `
    <div class="${escape(null_to_empty(!index ? "start" : index === all.length - 1 ? "end" : "")) + " svelte-1gfjwai"}">
...
${ `<button type="${"button"}" class="${escape(null_to_empty(classPropDonateBtn)) + " svelte-1s6vodm"}">
...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    ${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
        ...
        <h2>Життя Волтера</h2>
        <br class="${"small"}">
        <table class="${"svelte-1s6vodm"}">
            <tbody>
            <tr>
                <td class="${"svelte-1s6vodm"}">01.02.2019</td>
                <td class="${"svelte-1s6vodm"}">—</td>
                <td class="${"svelte-1s6vodm"}">Його перший день народження</td>
            </tr>
            <tr>
                <td class="${"svelte-1s6vodm"}">05.02.2019</td>
                <td class="${"svelte-1s6vodm"}">—</td>
                <td class="${"svelte-1s6vodm"}">Ми приютили його з вулиці</td>
            </tr>
            <tr>
                <td class="${"svelte-1s6vodm"}">07.03.2019</td>
                <td class="${"svelte-1s6vodm"}">—</td>
                <td class="${"svelte-1s6vodm"}">Зробили вакцинацію проти бліх</td>
            </tr>
            <tr>
                <td class="${"svelte-1s6vodm"}">23.06.2019</td>
                <td class="${"svelte-1s6vodm"}">—</td>
                <td class="${"svelte-1s6vodm"}">Знайшов для себе улюблену іграшку</td>
            </tr>
            </tbody>
        </table>
