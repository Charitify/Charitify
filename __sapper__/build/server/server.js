...
const css$1 = {
	code: "svg.svelte-dpet1m.svelte-dpet1m{display:inherit}svg.svelte-dpet1m.svelte-dpet1m,svg.svelte-dpet1m .svelte-dpet1m{fill:rgba(var(--theme-svg-fill));stroke:rgba(var(--theme-svg-fill))}.small.svelte-dpet1m.svelte-dpet1m{width:15px;height:15px}.medium.svelte-dpet1m.svelte-dpet1m{width:22px;height:22px}.big.svelte-dpet1m.svelte-dpet1m{width:35px;height:35px}.primary.svelte-dpet1m.svelte-dpet1m,.primary.svelte-dpet1m .svelte-dpet1m{fill:rgb(var(--color-success));stroke:rgb(var(--color-success))}.danger.svelte-dpet1m.svelte-dpet1m,.danger.svelte-dpet1m .svelte-dpet1m{fill:rgb(var(--color-danger));stroke:rgb(var(--color-danger))}.info.svelte-dpet1m.svelte-dpet1m,.info.svelte-dpet1m .svelte-dpet1m{fill:rgb(var(--color-info));stroke:rgb(var(--color-info))}.light.svelte-dpet1m.svelte-dpet1m,.light.svelte-dpet1m .svelte-dpet1m{fill:rgb(var(--color-white));stroke:rgb(var(--color-white))}.dark.svelte-dpet1m.svelte-dpet1m,.dark.svelte-dpet1m .svelte-dpet1m{fill:rgb(var(--color-black));stroke:rgb(var(--color-black))}",
	map: "{\"version\":3,\"file\":\"Icon.svelte\",\"sources\":[\"Icon.svelte\"],\"sourcesContent\":[\"<script>\\n    import { classnames, toCSSString } from '../utils'\\n\\n    export let type\\n    export let is // primary|warning|danger|light|dark\\n    export let size = 'medium' // small|medium|big\\n    export let rotate = 0\\n    export let style = undefined\\n    export let id = undefined\\n    export let title = undefined\\n    export let ariaLabel = undefined\\n\\n    let titleProp = title || ariaLabel\\n    let ariaLabelProp = ariaLabel || title\\n    let styleProp = toCSSString({ transform: !!rotate ? `rotateZ(${rotate}deg)` : null, ...style })\\n\\n    $: classProp = classnames('ico', is, size, $$props.class)\\n</script>\\n\\n<svg\\n        {id}\\n        title={titleProp}\\n        class={classProp}\\n        style={styleProp}\\n        aria-label={ariaLabelProp}\\n>\\n    <use xlink:href={`#ico-${type}`} class=\\\"ico-use\\\"/>\\n</svg>\\n\\n<style>\\n    svg {\\n        display: inherit;\\n    }\\n\\n    svg, svg * {\\n        fill: rgba(var(--theme-svg-fill));\\n        stroke: rgba(var(--theme-svg-fill));\\n    }\\n\\n    /* ------------=========( Size )=========------------ */\\n    .small {\\n        width: 15px;\\n        height: 15px;\\n    }\\n\\n    .medium {\\n        width: 22px;\\n        height: 22px;\\n    }\\n\\n    .big {\\n        width: 35px;\\n        height: 35px;\\n    }\\n\\n    /* ------------=========( Color )=========------------ */\\n    .primary, .primary * {\\n        fill: rgb(var(--color-success));\\n        stroke: rgb(var(--color-success));\\n    }\\n\\n    .danger, .danger * {\\n        fill: rgb(var(--color-danger));\\n        stroke: rgb(var(--color-danger));\\n    }\\n\\n    .info, .info * {\\n        fill: rgb(var(--color-info));\\n        stroke: rgb(var(--color-info));\\n    }\\n\\n    .light, .light * {\\n        fill: rgb(var(--color-white));\\n        stroke: rgb(var(--color-white));\\n    }\\n\\n    .dark, .dark * {\\n        fill: rgb(var(--color-black));\\n        stroke: rgb(var(--color-black));\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AA8BI,GAAG,4BAAC,CAAC,AACD,OAAO,CAAE,OAAO,AACpB,CAAC,AAED,+BAAG,CAAE,iBAAG,CAAC,cAAE,CAAC,AACR,IAAI,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CACjC,MAAM,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,AACvC,CAAC,AAGD,MAAM,4BAAC,CAAC,AACJ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,OAAO,4BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,IAAI,4BAAC,CAAC,AACF,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAGD,oCAAQ,CAAE,sBAAQ,CAAC,cAAE,CAAC,AAClB,IAAI,CAAE,IAAI,IAAI,eAAe,CAAC,CAAC,CAC/B,MAAM,CAAE,IAAI,IAAI,eAAe,CAAC,CAAC,AACrC,CAAC,AAED,mCAAO,CAAE,qBAAO,CAAC,cAAE,CAAC,AAChB,IAAI,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,CAC9B,MAAM,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,AACpC,CAAC,AAED,iCAAK,CAAE,mBAAK,CAAC,cAAE,CAAC,AACZ,IAAI,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,CAC5B,MAAM,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,AAClC,CAAC,AAED,kCAAM,CAAE,oBAAM,CAAC,cAAE,CAAC,AACd,IAAI,CAAE,IAAI,IAAI,aAAa,CAAC,CAAC,CAC7B,MAAM,CAAE,IAAI,IAAI,aAAa,CAAC,CAAC,AACnC,CAAC,AAED,iCAAK,CAAE,mBAAK,CAAC,cAAE,CAAC,AACZ,IAAI,CAAE,IAAI,IAAI,aAAa,CAAC,CAAC,CAC7B,MAAM,CAAE,IAAI,IAAI,aAAa,CAAC,CAAC,AACnC,CAAC\"}"
};
...
const Icon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<svg${add_attribute("id", id, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-dpet1m"}"${add_attribute("style", styleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}>
    <use${add_attribute("xlink:href", `#ico-${type}`, 0)} class="${"ico-use svelte-dpet1m"}"></use>
</svg>`;
});
...
const css$3 = {
	code: ".card.svelte-1p7pli8{box-shadow:var(--shadow-secondary);border-radius:var(--border-radius-big);background-color:rgba(var(--color-white))}",
	map: "{\"version\":3,\"file\":\"Card.svelte\",\"sources\":[\"Card.svelte\"],\"sourcesContent\":[\"<script>\\n    import { classnames } from '../utils'\\n\\n    $: classProp = classnames('card', $$props.class)\\n</script>\\n\\n<section class={classProp}>\\n    <slot></slot>\\n</section>\\n\\n<style>\\n    .card {\\n        box-shadow: var(--shadow-secondary);\\n        border-radius: var(--border-radius-big);\\n        background-color: rgba(var(--color-white));\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAWI,KAAK,eAAC,CAAC,AACH,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,aAAa,CAAE,IAAI,mBAAmB,CAAC,CACvC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC9C,CAAC\"}"
};
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-1p7pli8"}">
    ${$$slots.default ? $$slots.default({}) : ``}
</section>`;
});
...
const css$5 = {
	code: ".picture.svelte-1uezii6.svelte-1uezii6{position:relative;flex-grow:1;align-self:stretch;display:inline-flex;flex-direction:column;align-items:stretch;justify-content:stretch}.picture.svelte-1uezii6 .pic.svelte-1uezii6{flex-grow:1;align-self:stretch;object-fit:cover;object-position:center;transition:opacity .3s ease-in}.picture.svelte-1uezii6 .pic-2x.svelte-1uezii6{position:absolute;top:0;left:0;width:100%;height:100%}",
...
const Picture = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<figure class="${escape(null_to_empty(wrapClassProp)) + " svelte-1uezii6"}">
    <img${add_attribute("id", id, 0)}${add_attribute("alt", alt, 0)}${add_attribute("src", src, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)} class="${"pic pic-1x svelte-1uezii6"}">
    ${srcBig && !loadingSrc
	? `<img${add_attribute("alt", alt, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)}${add_attribute("src", srcBig, 0)} class="${"pic pic-2x svelte-1uezii6"}">`
	: ``}
    <figcaption>
        ${$$slots.default ? $$slots.default({}) : ``}
    </figcaption>
...
const Avatar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-1d26gf3"}">
...
const Comment = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<a href="${"users/me"}" class="${"svelte-1vwqav7"}">
    ${validate_component(Avatar, "Avatar").$$render($$result, { src, alt: title, class: "comment-ava" }, {}, {})}

    <div class="${"svelte-1vwqav7"}">
        <span class="${"svelte-1vwqav7"}">
            <h4 class="${"svelte-1vwqav7"}">${escape(title)}</h4>
            <sub class="${"svelte-1vwqav7"}">${escape(subtitle)}</sub>
        </span>

        <br class="${"small"}">

        <pre class="${"svelte-1vwqav7"}">
            ${$$slots.default
	? $$slots.default({})
	: `
                 [No comment]
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul aria-label="${"carousel"}" class="${"svelte-969vss"}">
    ${each(items, item => `<li class="${"svelte-969vss"}">
            ${$$slots.default
	? $$slots.default({ item })
	: `
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <ul class="${"nav-pages svelte-teuio4"}">
...
const css$e = {
	code: ".comments.svelte-1louqvu{width:100%;flex-grow:1;display:flex;overflow-y:auto;overflow-x:hidden;align-self:stretch;flex-direction:column;box-shadow:inset var(--shadow-secondary-inset)}.comments-form.svelte-1louqvu{flex:none;padding:calc(var(--screen-padding) * 2) var(--screen-padding)}.comments-wrap.svelte-1louqvu{overflow:hidden;padding:var(--screen-padding)}span.svelte-1louqvu{padding:0 3em}",
	map: "{\"version\":3,\"file\":\"Comments.svelte\",\"sources\":[\"Comments.svelte\"],\"sourcesContent\":[\"<script>\\n    import { onMount } from 'svelte'\\n    import { api } from '../services'\\n    import { Comment, Carousel, Form, Input, Button } from '../components'\\n\\n    export let withForm = true\\n\\n    let commentsGroup = []\\n\\n    onMount(async () => {\\n        await new Promise(r => setTimeout(r, 1000))\\n        const comments = await api.getComments()\\n        commentsGroup = new Array(15).fill(comments).reduce((a, o) => a.concat([o]), [])\\n        console.log(commentsGroup)\\n    })\\n</script>\\n\\n<section class=\\\"comments\\\">\\n    <Carousel items={commentsGroup} let:item={comments}>\\n        <div class=\\\"comments-wrap\\\">\\n            {#each comments as comment}\\n                <Comment\\n                        src={comment.avatar}\\n                        title={comment.author}\\n                        subtitle={new Date(comment.created_at).toLocaleString()}\\n                >\\n                    {comment.comment}\\n                </Comment>\\n                <br>\\n            {/each}\\n        </div>\\n    </Carousel>\\n\\n    {#if withForm}\\n        <div class=\\\"comments-form\\\">\\n            <Form>\\n                <Input type=\\\"textarea\\\" rows=\\\"2\\\"/>\\n            </Form>\\n            <div class=\\\"text-right\\\">\\n                <Button type=\\\"submit\\\" is=\\\"success\\\" auto>\\n                    <span>Send</span>\\n                </Button>\\n            </div>\\n        </div>\\n    {/if}\\n</section>\\n\\n<style>\\n    .comments {\\n        width: 100%;\\n        flex-grow: 1;\\n        display: flex;\\n        overflow-y: auto;\\n        overflow-x: hidden;\\n        align-self: stretch;\\n        flex-direction: column;\\n        box-shadow: inset var(--shadow-secondary-inset);\\n    }\\n\\n    .comments-form {\\n        flex: none;\\n        padding: calc(var(--screen-padding) * 2) var(--screen-padding);\\n    }\\n\\n    .comments-wrap {\\n        overflow: hidden;\\n        padding: var(--screen-padding);\\n    }\\n\\n    span {\\n        padding: 0 3em;\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAgDI,SAAS,eAAC,CAAC,AACP,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,OAAO,CACnB,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,KAAK,CAAC,IAAI,wBAAwB,CAAC,AACnD,CAAC,AAED,cAAc,eAAC,CAAC,AACZ,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,gBAAgB,CAAC,AAClE,CAAC,AAED,cAAc,eAAC,CAAC,AACZ,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,IAAI,gBAAgB,CAAC,AAClC,CAAC,AAED,IAAI,eAAC,CAAC,AACF,OAAO,CAAE,CAAC,CAAC,GAAG,AAClB,CAAC\"}"
};
...
const Comments = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"comments svelte-1louqvu"}">
    ${validate_component(Carousel, "Carousel").$$render($$result, { items: commentsGroup }, {}, {
		default: ({ item: comments }) => `
        <div class="${"comments-wrap svelte-1louqvu"}">
            ${each(comments, comment => `${validate_component(Comment, "Comment").$$render(
			$$result,
			{
				src: comment.avatar,
				title: comment.author,
    ...
    ${withForm
	? `<div class="${"comments-form svelte-1louqvu"}">
            ${validate_component(Form, "Form").$$render($$result, {}, {}, {
			default: () => `
                ${validate_component(Input, "Input").$$render($$result, { type: "textarea", rows: "2" }, {}, {})}
            `
		})}
            <div class="${"text-right"}">
			...
			{
				default: () => `
                    <span class="${"svelte-1louqvu"}">Send</span>
                `
			}
		)}
            </div>
...
const TrustButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<button type="${"button"}" title="${"I trust"}" class="${escape(null_to_empty(classProp)) + " svelte-1ipesj0"}">
    <div class="${"full-absolute svelte-1ipesj0"}">
        <svg class="${"svelte-1ipesj0"}">
...
const Icons = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <svg style="${"display: none"}">
        ...
        <symbol id="${"ico-heart-filled"}" class="${"ico-heart-filled"}" viewBox="${"0 0 52 46"}">
        ...
        <symbol id="${"ico-eye"}" viewBox="${"0 0 29 17"}">
...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    <section class="${"top svelte-djnoyn"}">
        ${validate_component(Carousel, "Carousel").$$render($$result, { items: carousel }, {}, {})}
    </section>
    ...
    ${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
        ...
        <p class="${"h1"}">History of pet</p>
        <br class="${"tiny"}">
        <table class="${"svelte-djnoyn"}">
            <tbody>
            <tr>
                <td class="${"svelte-djnoyn"}">01.02.2019</td>
                <td class="${"svelte-djnoyn"}">—</td>
                <td class="${"svelte-djnoyn"}">His first Happy Birthday</td>
            </tr>
            <tr>
                <td class="${"svelte-djnoyn"}">05.02.2019</td>
                <td class="${"svelte-djnoyn"}">—</td>
                <td class="${"svelte-djnoyn"}">We got him from the owners at the shelter</td>
            </tr>
            <tr>
                <td class="${"svelte-djnoyn"}">07.03.2019</td>
                <td class="${"svelte-djnoyn"}">—</td>
                <td class="${"svelte-djnoyn"}">We do a vaccination for him from fleas</td>
            </tr>
            <tr>
                <td class="${"svelte-djnoyn"}">23.06.2019</td>
                <td class="${"svelte-djnoyn"}">—</td>
                <td class="${"svelte-djnoyn"}">We do anouter vaccination</td>
            </tr>
            </tbody>
        </table>
