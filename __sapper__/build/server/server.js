...
const css = {
	code: "br{display:block;height:0;content:\"\\00a0\";-webkit-box-sizing:content-box;box-sizing:content-box}br.tiny{margin-top:calc(1em * 0.29)}br.small{margin-top:calc(1em * 0.57)}br.medium,br{margin-top:calc(1em * 1.14)}br.big{margin-top:calc(1em * 2.28)}",
	map: "{\"version\":3,\"file\":\"Br.svelte\",\"sources\":[\"Br.svelte\"],\"sourcesContent\":[\"<script>\\n  export let size = '1em';\\n\\n  $: foramttedSize = Number.isFinite(+size) ? `${size}px` : typeof size === 'string' ? size : null\\n</script>\\n\\n<div class=\\\"overflow-hidden\\\">\\n  <br style={`margin-top: ${foramttedSize}`} class={$$props.class}/>\\n</div>\\n\\n<style>\\n:global(br) {\\n  display: block;\\n  height: 0;\\n  content: \\\"\\\\00a0\\\";\\n  -webkit-box-sizing: content-box;\\n          box-sizing: content-box;\\n}\\n\\n:global(br.tiny) {\\n  margin-top: calc(1em * 0.29); /* 4px */\\n}\\n\\n:global(br.small) {\\n  margin-top: calc(1em * 0.57); /* 8px */\\n}\\n\\n:global(br.medium),\\n:global(br) {\\n  margin-top: calc(1em * 1.14); /* 16px */\\n}\\n\\n:global(br.big) {\\n  margin-top: calc(1em * 2.28); /* 32px */\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAWQ,EAAE,AAAE,CAAC,AACX,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,OAAO,CAChB,kBAAkB,CAAE,WAAW,CACvB,UAAU,CAAE,WAAW,AACjC,CAAC,AAEO,OAAO,AAAE,CAAC,AAChB,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC,AAEO,QAAQ,AAAE,CAAC,AACjB,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC,AAEO,SAAS,AAAC,CACV,EAAE,AAAE,CAAC,AACX,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC,AAEO,MAAM,AAAE,CAAC,AACf,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC\"}"
};
...
const Br = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"overflow-hidden"}"><br${add_attribute("style", `margin-top: ${foramttedSize}`, 0)}${add_attribute("class", $$props.class, 0)}>
</div>`;
});
...
const css$1 = {
	code: "svg.svelte-vfq7n1{stroke:currentColor;fill:currentColor;stroke-width:0;width:100%;height:auto;max-height:100%}",
	map: "{\"version\":3,\"file\":\"IconBase.svelte\",\"sources\":[\"IconBase.svelte\"],\"sourcesContent\":[\"<script>\\n  export let title = null;\\n  export let viewBox;\\n</script>\\n\\n<style>\\nsvg {\\n  stroke: currentColor;\\n  fill: currentColor;\\n  stroke-width: 0;\\n  width: 100%;\\n  height: auto;\\n  max-height: 100%;\\n}</style>\\n\\n<svg xmlns=\\\"http://www.w3.org/2000/svg\\\" {viewBox}>\\n  {#if title}\\n    <title>{title}</title>\\n  {/if}\\n  <slot />\\n</svg>\\n\"],\"names\":[],\"mappings\":\"AAMA,GAAG,cAAC,CAAC,AACH,MAAM,CAAE,YAAY,CACpB,IAAI,CAAE,YAAY,CAClB,YAAY,CAAE,CAAC,CACf,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,IAAI,AAClB,CAAC\"}"
};
...
const IconBase = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<svg xmlns="${"http://www.w3.org/2000/svg"}"${add_attribute("viewBox", viewBox, 0)} class="${"svelte-vfq7n1"}">${title ? `<title>${escape(title)}</title>` : ``}${$$slots.default ? $$slots.default({}) : ``}</svg>`;
});
...
const MdLink = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"}"></path>`
	})}`;
});
...
const MdEdit = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"}"></path>`
	})}`;
});
...
const FaHeart = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 512 512" }, $$props), {}, {
		default: () => `<path d="${"M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z"}"></path>`
	})}`;
});
...
const FaShare = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 512 512" }, $$props), {}, {
		default: () => `<path d="${"M503.691 189.836L327.687 37.851C312.281 24.546 288 35.347 288 56.015v80.053C127.371 137.907 0 170.1 0 322.326c0 61.441 39.581 122.309 83.333 154.132 13.653 9.931 33.111-2.533 28.077-18.631C66.066 312.814 132.917 274.316 288 272.085V360c0 20.7 24.3 31.453 39.687 18.164l176.004-152c11.071-9.562 11.086-26.753 0-36.328z"}"></path>`
	})}`;
});
...
const MdCheck = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"}"></path>`
	})}`;
});
...
const IoMdSend = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 512 512" }, $$props), {}, {
		default: () => `<path d="${"M48 448l416-192L48 64v149.333L346 256 48 298.667z"}"></path>`
	})}`;
});
...
const GoSearch = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 16 16" }, $$props), {}, {
		default: () => `<path d="${"M15.7 13.3l-3.81-3.83A5.93 5.93 0 0 0 13 6c0-3.31-2.69-6-6-6S1 2.69 1 6s2.69 6 6 6c1.3 0 2.48-.41 3.47-1.11l3.83 3.81c.19.2.45.3.7.3.25 0 .52-.09.7-.3a.996.996 0 0 0 0-1.41v.01zM7 10.7c-2.59 0-4.7-2.11-4.7-4.7 0-2.59 2.11-4.7 4.7-4.7 2.59 0 4.7 2.11 4.7 4.7 0 2.59-2.11 4.7-4.7 4.7z"}"></path>`
	})}`;
});
...
const FaPhoneAlt = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 512 512" }, $$props), {}, {
		default: () => `<path d="${"M497.39 361.8l-112-48a24 24 0 0 0-28 6.9l-49.6 60.6A370.66 370.66 0 0 1 130.6 204.11l60.6-49.6a23.94 23.94 0 0 0 6.9-28l-48-112A24.16 24.16 0 0 0 122.6.61l-104 24A24 24 0 0 0 0 48c0 256.5 207.9 464 464 464a24 24 0 0 0 23.4-18.6l24-104a24.29 24.29 0 0 0-14.01-27.6z"}"></path>`
	})}`;
});
...
const FaFacebookF = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 320 512" }, $$props), {}, {
		default: () => `<path d="${"M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"}"></path>`
	})}`;
});
...
const FaRegSquare = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 448 512" }, $$props), {}, {
		default: () => `<path d="${"M400 32H48C21.5 32 0 53.5 0 80v352c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48V80c0-26.5-21.5-48-48-48zm-6 400H54c-3.3 0-6-2.7-6-6V86c0-3.3 2.7-6 6-6h340c3.3 0 6 2.7 6 6v340c0 3.3-2.7 6-6 6z"}"></path>`
	})}`;
});
...
const FaDollarSign = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 288 512" }, $$props), {}, {
		default: () => `<path d="${"M209.2 233.4l-108-31.6C88.7 198.2 80 186.5 80 173.5c0-16.3 13.2-29.5 29.5-29.5h66.3c12.2 0 24.2 3.7 34.2 10.5 6.1 4.1 14.3 3.1 19.5-2l34.8-34c7.1-6.9 6.1-18.4-1.8-24.5C238 74.8 207.4 64.1 176 64V16c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v48h-2.5C45.8 64-5.4 118.7.5 183.6c4.2 46.1 39.4 83.6 83.8 96.6l102.5 30c12.5 3.7 21.2 15.3 21.2 28.3 0 16.3-13.2 29.5-29.5 29.5h-66.3C100 368 88 364.3 78 357.5c-6.1-4.1-14.3-3.1-19.5 2l-34.8 34c-7.1 6.9-6.1 18.4 1.8 24.5 24.5 19.2 55.1 29.9 86.5 30v48c0 8.8 7.2 16 16 16h32c8.8 0 16-7.2 16-16v-48.2c46.6-.9 90.3-28.6 105.7-72.7 21.5-61.6-14.6-124.8-72.5-141.7z"}"></path>`
	})}`;
});
...
const FaCheckSquare = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 448 512" }, $$props), {}, {
		default: () => `<path d="${"M400 480H48c-26.51 0-48-21.49-48-48V80c0-26.51 21.49-48 48-48h352c26.51 0 48 21.49 48 48v352c0 26.51-21.49 48-48 48zm-204.686-98.059l184-184c6.248-6.248 6.248-16.379 0-22.627l-22.627-22.627c-6.248-6.248-16.379-6.249-22.628 0L184 302.745l-70.059-70.059c-6.248-6.248-16.379-6.248-22.628 0l-22.627 22.627c-6.248 6.248-6.248 16.379 0 22.627l104 104c6.249 6.25 16.379 6.25 22.628.001z"}"></path>`
	})}`;
});
...
const MdRemoveRedEye = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"}"></path>`
	})}`;
});
...
const FaMapMarkerAlt = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 384 512" }, $$props), {}, {
		default: () => `<path d="${"M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z"}"></path>`
	})}`;
});
...
const FaTelegramPlane = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 448 512" }, $$props), {}, {
		default: () => `<path d="${"M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"}"></path>`
	})}`;
});
...
const FaLongArrowAltUp = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 256 512" }, $$props), {}, {
		default: () => `<path d="${"M88 166.059V468c0 6.627 5.373 12 12 12h56c6.627 0 12-5.373 12-12V166.059h46.059c21.382 0 32.09-25.851 16.971-40.971l-86.059-86.059c-9.373-9.373-24.569-9.373-33.941 0l-86.059 86.059c-15.119 15.119-4.411 40.971 16.971 40.971H88z"}"></path>`
	})}`;
});
...
const FaLongArrowAltDown = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 256 512" }, $$props), {}, {
		default: () => `<path d="${"M168 345.941V44c0-6.627-5.373-12-12-12h-56c-6.627 0-12 5.373-12 12v301.941H41.941c-21.382 0-32.09 25.851-16.971 40.971l86.059 86.059c9.373 9.373 24.569 9.373 33.941 0l86.059-86.059c15.119-15.119 4.411-40.971-16.971-40.971H168z"}"></path>`
	})}`;
});
...
const FaLongArrowAltLeft = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 448 512" }, $$props), {}, {
		default: () => `<path d="${"M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z"}"></path>`
	})}`;
});
...
const FaLongArrowAltRight = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 448 512" }, $$props), {}, {
		default: () => `<path d="${"M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"}"></path>`
	})}`;
});
...
const MdKeyboardArrowUp = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"}"></path>`
	})}`;
});
...
const MdKeyboardArrowLeft = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"}"></path>`
	})}`;
});
...
const MdKeyboardArrowDown = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M7.41 7.84L12 12.42l4.59-4.58L18 9.25l-6 6-6-6z"}"></path>`
	})}`;
});
...
const MdKeyboardArrowRight = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
		default: () => `<path d="${"M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"}"></path>`
	})}`;
});
...
const Icon = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<i${add_attribute("id", id, 0)}${add_attribute("title", titleProp, 0)}${add_attribute("style", styleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1v3w8cp"}">${validate_component(icons[type] || missing_component, "svelte:component").$$render($$result, {}, {}, {})}
</i>`;
});
...
const Form = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<form${add_attribute("id", id, 0)}${add_attribute("name", name, 0)}${add_attribute("method", method, 0)}${add_attribute("autocomplete", autocomplete, 0)}${add_attribute("title", titleProp, 0)}${add_attribute("class", $$props.class, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}>${$$slots.default ? $$slots.default({}) : ``}
</form>`;
});
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-1ivni0f"}"${add_attribute("style", $$props.style, 0)}>${$$slots.default ? $$slots.default({}) : ``}
</section>`;
});
...
const Modal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	let active = safeGet(() => open !== null ? open : $modals[`modal-${id}`].open, null);
	...
	return `${active
	? `${validate_component(Portal, "Portal").$$render($$result, { id }, {}, {
			default: () => `<div${add_attribute("id", `modal-${id}`, 0)} aria-hidden="${"true"}" class="${escape(null_to_empty(classProp)) + " svelte-48jsm1"}"${add_attribute("this", ref, 1)}>${withHeader && size === "full"
			? `${validate_component(Portal, "Portal").$$render($$result, {}, {}, {
					default: () => `${$$slots.header
					? $$slots.header({})
					: `
                        <button type="${"button"}" class="${escape(null_to_empty(classnames("modal-header", { active }))) + " svelte-48jsm1"}"${add_attribute("this", refHeader, 1)}><h2 style="${"padding: 15px"}">${escape(title)}</h2>
                            <span class="${"close svelte-48jsm1"}">${validate_component(Icon, "Icon").$$render($$result, { type: "close", size: "big", is: "light" }, {}, {})}</span></button>
                    `}`
				})}   
                ${validate_component(Br, "Br").$$render($$result, { size: "60" }, {}, {})}`
			: ``}
            <div class="${"modal-inner svelte-48jsm1"}" tabindex="${"-1"}" role="${"dialog"}" aria-modal="${"true"}" aria-labelledby="${"модальне вікно"}">${withHeader && size !== "full"
			? `${$$slots.header
				? $$slots.header({
						props: safeGet(() => $modals[`modal-${id}`], {}, true)
					})
				: `
                        <button type="${"button"}" class="${escape(null_to_empty(classnames("modal-header-relative active"))) + " svelte-48jsm1"}"><h2 style="${"padding: 15px"}">${escape(title)}</h2>
                            <span class="${"close svelte-48jsm1"}">${validate_component(Icon, "Icon").$$render($$result, { type: "close", size: "big", is: "light" }, {}, {})}</span></button>
                    `}`
			: ``}
                ${$$slots.default
...
const Square = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section${add_attribute("style", style, 0)} class="${escape(null_to_empty(`square ${$$props.class || ""}`)) + " svelte-i76mlm"}"><div class="${"svelte-i76mlm"}">${$$slots.default ? $$slots.default({}) : ``}</div>
</section>`;
});
...
const Picture = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<figure class="${escape(null_to_empty(wrapClassProp)) + " svelte-e9w1rq"}">${src
	? `<img${add_attribute("id", id, 0)}${add_attribute("alt", alt, 0)}${add_attribute("src", src, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)} class="${"pic pic-1x svelte-e9w1rq"}">`
	: ``}

    ${srcBig && !loadingSrcSmall
	? `<img${add_attribute("alt", alt, 0)}${add_attribute("width", width, 0)}${add_attribute("height", height, 0)}${add_attribute("src", srcBig, 0)} class="${"pic pic-2x svelte-e9w1rq"}">`
	: ``}

    <figcaption>${$$slots.default ? $$slots.default({}) : ``}</figcaption>
</figure>`;
});
...
const css$8 = {
	code: ".ava.svelte-z7tvoj{position:relative;-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;display:-webkit-box;display:-ms-flexbox;display:flex;border-radius:50%;overflow:hidden;-webkit-transform:translateZ(0);transform:translateZ(0)}.ava.small.svelte-z7tvoj{-webkit-box-flex:0;-ms-flex:none;flex:none;width:30px;height:30px}.ava.medium.svelte-z7tvoj{-webkit-box-flex:0;-ms-flex:none;flex:none;width:60px;height:60px}.ava.big.svelte-z7tvoj{-webkit-box-flex:0;-ms-flex:none;flex:none;width:130px;height:130px}",
	map: "{\"version\":3,\"file\":\"Avatar.svelte\",\"sources\":[\"Avatar.svelte\"],\"sourcesContent\":[\"<script>\\n    import { classnames } from '@utils'\\n    import Picture from './Picture.svelte'\\n\\n    export let src\\n    export let alt\\n    export let size = null // small|medium|big\\n    export let srcBig = undefined\\n\\n    $: classProp = classnames('ava', size, $$props.class)\\n</script>\\n\\n<div class={classProp}>\\n    <Picture {src} {srcBig} {alt}/>\\n</div>\\n\\n<style>\\n.ava {\\n    position: relative;\\n    -webkit-box-flex: 1;\\n        -ms-flex-positive: 1;\\n            flex-grow: 1;\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    border-radius: 50%;\\n    overflow: hidden;\\n    -webkit-transform: translateZ(0);\\n            transform: translateZ(0);\\n}\\n\\n.ava.small {\\n    -webkit-box-flex: 0;\\n        -ms-flex: none;\\n            flex: none;\\n    width: 30px;\\n    height: 30px;\\n}\\n.ava.medium {\\n    -webkit-box-flex: 0;\\n        -ms-flex: none;\\n            flex: none;\\n    width: 60px;\\n    height: 60px;\\n}\\n.ava.big {\\n    -webkit-box-flex: 0;\\n        -ms-flex: none;\\n            flex: none;\\n    width: 130px;\\n    height: 130px;\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAiBA,IAAI,cAAC,CAAC,AACF,QAAQ,CAAE,QAAQ,CAClB,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,iBAAiB,CAAE,WAAW,CAAC,CAAC,CACxB,SAAS,CAAE,WAAW,CAAC,CAAC,AACpC,CAAC,AAED,IAAI,MAAM,cAAC,CAAC,AACR,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AACD,IAAI,OAAO,cAAC,CAAC,AACT,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AACD,IAAI,IAAI,cAAC,CAAC,AACN,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,AACjB,CAAC\"}"
};
...
const Avatar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-z7tvoj"}">${validate_component(Picture, "Picture").$$render($$result, { src, srcBig, alt }, {}, {})}
</div>`;
});
...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${add_attribute("id", id, 0)}${add_attribute("rel", rel, 0)}${add_attribute("href", href, 0)}${add_attribute("style", style, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1hd9njw"}"${add_attribute("aria-label", ariaLabelProp, 0)}>${$$slots.default ? $$slots.default({}) : ``}</a>`
	: `${htmlFor
		? `<label${add_attribute("id", id, 0)}${add_attribute("style", style, 0)} ${disabled ? "disabled" : ""}${add_attribute("for", htmlFor, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1hd9njw"}"${add_attribute("aria-label", ariaLabelProp, 0)}>${$$slots.default ? $$slots.default({}) : ``}</label>`
		: `<button${add_attribute("id", id, 0)}${add_attribute("form", form, 0)}${add_attribute("type", type, 0)}${add_attribute("style", style, 0)} ${disabled ? "disabled" : ""}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1hd9njw"}"${add_attribute("aria-label", ariaLabelProp, 0)}>${$$slots.default ? $$slots.default({}) : ``}</button>`}`}`;
});
...
const Progress = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)} class="${escape(null_to_empty(classProp)) + " svelte-wvyka1"}"${add_attribute("title", titleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)} role="${"progressbar"}" aria-valuemin="${"0"}" aria-valuemax="${"100"}"${add_attribute("aria-valuenow", val, 0)}${add_attribute("style", getBorderRadius(borderRadius), 0)}><div class="${"progress-inner-frame svelte-wvyka1"}"><div class="${"progress-core svelte-wvyka1"}"${add_attribute("style", `width:${val}%`, 0)}></div></div>
</div>`;
});
...
const FancyBox = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section role="${"button"}" class="${escape(null_to_empty(classPropWrap)) + " svelte-17mfy9g"}">${$$slots.default ? $$slots.default({ active }) : ``}</section>
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${escape(null_to_empty(classProp)) + " svelte-b7wi34"}"><ul class="${"carousel-inner scroll-x-center svelte-b7wi34"}">${items !== null
	? `${each(items, (item, index) => `<li class="${"fluid svelte-b7wi34"}" role="${"button"}">${$$slots.default
		? $$slots.default({ item, index })
		: `
                        ${validate_component(FancyBox, "FancyBox").$$render($$result, { disabled: disableFancy }, {}, {
				box: () => `<section slot="${"box"}" class="${"flex full-width"}">${validate_component(Picture, "Picture").$$render($$result, Object.assign({ key: "picture" }, item, { alt: item.alt || "Фото слайду" }), {}, {})}
                            </section>`,
				default: () => `${validate_component(Picture, "Picture").$$render($$result, Object.assign({ key: "picture" }, item, { alt: item.alt || "Фото слайду" }), {}, {})}
                            `
			})}
                    `}
                </li>`)}`
	...
	? `<ul class="${"carousel-dots svelte-b7wi34"}">${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-b7wi34"}"></li>`)}</ul>`
	: ``}
</section>`;
});
...
const EditArea = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section role="${"button"}" class="${escape(null_to_empty(classProp)) + " svelte-1tyi7td"}">${$$slots.default ? $$slots.default({}) : ``}
	...
	? `${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}
        ${validate_component(Button, "Button").$$render(
			...
			{},
			{
				default: () => `<span class="${"h3 font-secondary font-w-500 flex flex-align-center"}">Редагувати
                <s></s>
                <s></s>
                ${validate_component(Icon, "Icon").$$render($$result, { type: "edit", size: "small", is: "light" }, {}, {})}</span>`
			}
		)}
...
const EditCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Card, "Card").$$render($$result, { class: classProp }, {}, {
		default: () => `${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}

    ${$$slots.default ? $$slots.default({}) : ``}

    ${validate_component(Br, "Br").$$render($$result, { size: "40" }, {}, {})}

    <section class="${"flex flex-align-center"}"><div style="${"flex: 1 1 50%"}">${validate_component(Button, "Button").$$render($$result, { size: "small", is: "dark-border" }, {}, {
			default: () => `<span class="${"h3 font-secondary font-w-500 flex flex-align-center"}">Скасувати
                </span>`
		})}</div>
        <s></s>
        <s></s>
        <s></s>
        <div style="${"flex: 1 1 50%"}">${validate_component(Button, "Button").$$render(
			$$result,
			{
				form,
				size: "small",
			...
			{},
			{
				default: () => `<span class="${"h3 font-secondary font-w-500 flex flex-align-center"}">Зберегти
                </span>`
			}
		)}</div></section>
...
const LazyToggle = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-15bu51u"}">${isMounted
	? `${$$slots.default ? $$slots.default({}) : ``}`
	: ``}
</section>`;
});
...
const Loader = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-13ssox4"}"${add_attribute("style", `opacity: ${opacity}; outline-color: ${light};`, 0)}><svg role="${"img"}" width="${"100%"}"${add_attribute("height", areaHeight, 0)} aria-labelledby="${"loading-aria"}"${add_attribute("viewBox", `0 0 ${areaWidth} 100`, 0)} preserveAspectRatio="${"none"}" class="${"svelte-13ssox4"}"><title id="${"loading-aria"}">Loading...</title><rect x="${"0"}" y="${"0"}" width="${"100%"}" height="${"100%"}"${add_attribute("clip-path", `url(#clip-path-${uid})`, 0)} style="${"fill: url(&quot;#loader-fill&quot;);"}"></rect><defs><clipPath${add_attribute("id", `clip-path-${uid}`, 0)}>${$$slots.default
	? $$slots.default({})
	: `
		...
		: `${("h1,h2,h3,h4,h5,h6,p,pre").includes(type)
			...
			: `<rect x="${"0"}" y="${"0"}" rx="${"3"}" ry="${"3"}" width="${"100%"}" height="${"100%"}"></rect>`}`}
                `}</clipPath><linearGradient id="${"loader-fill"}"><stop offset="${"0.599964"}"${add_attribute("stop-color", light, 0)} stop-opacity="${"1"}"><animate attributeName="${"offset"}" values="${"-2; -2; 1"}" keyTimes="${"0; 0.25; 1"}" dur="${"2s"}" repeatCount="${"indefinite"}"></animate></stop><stop offset="${"1.59996"}"${add_attribute("stop-color", dark, 0)} stop-opacity="${"1"}"><animate attributeName="${"offset"}" values="${"-1; -1; 2"}" keyTimes="${"0; 0.25; 1"}" dur="${"2s"}" repeatCount="${"indefinite"}"></animate></stop><stop offset="${"2.59996"}"${add_attribute("stop-color", light, 0)} stop-opacity="${"1"}"><animate attributeName="${"offset"}" values="${"0; 0; 3"}" keyTimes="${"0; 0.25; 1"}" dur="${"2s"}" repeatCount="${"indefinite"}"></animate></stop></linearGradient></defs></svg>
</section>`;
});
...
const FieldErrors = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <ul${add_attribute("class", `font-primary font-w-500 h4 text-danger text-left ${$$props.class || ""}`, 0)}>${each(list, item => `<li>* ${escape(item)}</li>`)}</ul>
 ...
 */
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-1ckwvo6"}">${titleProp
	? `<label${add_attribute("for", idProp, 0)} class="${"inp-label h2 font-secondary font-w-600 text-left"}">${escape(titleProp)}
            ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}</label>`
	: ``}

    <div class="${"inp-inner-wrap svelte-1ckwvo6"}">${rows || type === "textarea"
	? `<textarea${spread(
			[
				{ min: escape(min) },
				{ max: escape(max) },
	...
	: `<input${spread(
        ...
        <label${add_attribute("for", idProp, 0)} class="${"inp-post-icon svelte-1ckwvo6"}">${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${iconType
		? `<span class="${"inp-post-icon-inner svelte-1ckwvo6"}">${validate_component(Icon, "Icon").$$render(
				$$result,
				{
					type: iconType,
					is: "info",
    ...
    ${validate_component(FieldErrors, "FieldErrors").$$render($$result, { items: errors }, {}, {
		before: () => `<div slot="${"before"}">${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}</div>`
	})}
</div>`;
});
...
const Select = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-6fajxs"}">${titleProp
	? `<label${add_attribute("for", idProp, 0)} class="${"block h2 font-w-500 full-width text-left"}">${escape(titleProp)}</label>
        ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
	: ``}

    <div class="${"inp-inner-wrap svelte-6fajxs"}"><select${add_attribute("name", name, 0)}${add_attribute("type", type, 0)}${add_attribute("form", form, 0)}${add_attribute("align", align, 0)} ${readonly ? "readonly" : ""} ${disabled ? "disabled" : ""} ${required ? "required" : ""}${add_attribute("placeholder", placeholder, 0)}${add_attribute("autocomplete", autocomplete, 0)}${add_attribute("id", idProp, 0)} class="${"inp-inner svelte-6fajxs"}"${add_attribute("title", titleProp, 0)}${add_attribute("style", styleProp, 0)}${add_attribute("aria-label", ariaLabelProp, 0)}${add_attribute("value", value, 1)}>${!required
	...
	? `<option${add_attribute("value", option.value, 0)}>${escape(text)}
                    </option>`
	: ``}`)}</select>

        <label${add_attribute("for", idProp, 0)} class="${"inp-post-icon svelte-6fajxs"}">${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${iconType
		? `<span class="${"inp-post-icon-inner svelte-6fajxs"}">${validate_component(Icon, "Icon").$$render(
				$$result,
				{
					type: iconType,
					is: "info",
...
const ReadField = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)}${add_attribute("class", classProp, 0)}${add_attribute("style", styleProp, 0)}>${label
	? `<h2 class="${"block full-width"}">${escape(label)}</h2>
        ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
	: ``}
    <p class="${"block full-width"}">${escape(value || "—")}</p></div>`;
});
...
const RadioRect = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", idProp, 0)}${add_attribute("class", classProp, 0)}${add_attribute("style", styleProp, 0)}>${label
	? `<h2 class="${"text-left"}">${escape(label)}
            ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}</h2>`
	: ``}

    <ul style="${"margin: -5px"}" class="${"flex flex-wrap"}">${each(options, (radio, i) => `<li style="${"padding: 5px"}">${validate_component(Button, "Button").$$render(
		$$result,
		{
			auto: true,
			htmlFor: `${idProp}_${i}`,
		...
		{},
		{
			default: () => `<input${add_attribute("form", form, 0)} hidden type="${"checkbox"}"${add_attribute("id", `${idProp}_${i}`, 0)}${add_attribute("value", radio.value, 0)}>
                    ${$$slots.default
			? $$slots.default({
					item: radio,
			...
			: `
                        <p class="${"flex flex-align-center"}" style="${"padding: 10px 20px"}">${radio.preIcon
				? `${validate_component(Icon, "Icon").$$render(
						...
						{}
                                ...
                                <s></s>`
				: ``}
                            <span class="${"font-w-500 h3 flex flex-align-center flex-justify-center"}">${escape(radio.label)}</span>
                            ${radio.postIcon
				? `<s></s>
                                ${validate_component(Icon, "Icon").$$render(
						$$result,
...
${validate_component(Square, "Square").$$render($$result, { class: $$props.class, style: styleProp }, {}, {
		default: () => `<input${add_attribute("name", name, 0)}${add_attribute("accept", accept, 0)} ${multiple ? "multiple" : ""} hidden type="${"file"}"${add_attribute("id", idProp, 0)}>
    <label${add_attribute("for", idProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-zm8c1o"}"><div class="${"flex full-absolute"}">${validate_component(Picture, "Picture").$$render($$result, { src: validSrc, alt: "Завантажене фото" }, {}, {})}</div>
        <div class="${"icon flex relative svelte-zm8c1o"}" style="${"flex: 0 0 75px"}">${validate_component(Icon, "Icon").$$render($$result, { type: iconType, is: iconIs }, {}, {})}</div></label>
`
	})}`;
});
...
const UploadBoxGroup = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
	: ``}
<ul${add_attribute("id", idProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1he43cw"}">${each(itemsList, (item, i) => `<li class="${"relative"}">${validate_component(UploadBox, "UploadBox").$$render(
		$$result,
		{
			key: i,
			accept,
		...
		{}
            ...
            ${values[i]
	? `<button type="${"button"}" class="${"svelte-1he43cw"}">${validate_component(Icon, "Icon").$$render($$result, { size: "big", type: "close" }, {}, {})}    
                </button>`
	: ``}
        </li>`)}
</ul>`;
...
const AvatarUpload = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)}${add_attribute("class", classProp, 0)}>${label
	? `<h2 class="${"text-left"}">${escape(label)}
            ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}</h2>`
	: ``}

    <section class="${"inline-flex flex-justify-center"}" style="${"padding: 10px 0"}">${validate_component(UploadBox, "UploadBox").$$render(
		$$result,
		{
			name,
			round,
    ...
    <div class="${"text-center"}">${validate_component(FieldErrors, "FieldErrors").$$render($$result, { items: errors }, {}, {})}</div></div>`;
});
...
const Checkbox = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-3bj243"}">${label
	? `<h2 class="${"text-left"}">${escape(label)}
            ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}</h2>`
	: ``}

    <input hidden type="${"checkbox"}"${add_attribute("id", idProp, 0)}${add_attribute("name", name, 0)}${add_attribute("form", form, 0)}${add_attribute("align", align, 0)}${add_attribute("value", value, 0)} ${checked ? "checked" : ""} ${disabled ? "disabled" : ""} ${required ? "required" : ""} class="${"inp-inner svelte-3bj243"}">

    <label${add_attribute("for", idProp, 0)} class="${"inp-label svelte-3bj243"}"><span class="${"inp-box-wrap svelte-3bj243"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			type: "box",
			size: "big",
...
const CheckboxGroup = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)}${add_attribute("class", classProp, 0)}${add_attribute("styleProp", styleProp, 0)}>${label
	? `<h2 class="${"text-left"}">${escape(label)}
            ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}</h2>`
	: ``}
...
const FormBuilder = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	function onChange({ detail: { e, name, value } }) {
		values = beforeChange(set(values, name, value));
		dispatch("change", { e, name, value, values });
	}
	...
	return `${validate_component(Form, "Form").$$render($$result, { id, class: classProp }, {}, {
		...
		? `${values[item.name] !== null
			...
			: `<div>${validate_component(Loader, "Loader").$$render($$result, { type: "h2" }, {}, {})}
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `
<nav class="${escape(null_to_empty(classProp)) + " svelte-1x3mqf2"}"><ul class="${"nav-pages flex svelte-1x3mqf2"}"><li class="${"svelte-1x3mqf2"}"><a rel="${"prefetch"}" href="${"."}" class="${["svelte-1x3mqf2", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
        <li class="${"svelte-1x3mqf2"}"><a rel="${"prefetch"}" href="${"lists/funds"}" class="${["svelte-1x3mqf2", segment === "lists" ? "selected" : ""].join(" ").trim()}">lists</a></li>
        <li class="${"svelte-1x3mqf2"}"><a href="${"map"}" class="${["svelte-1x3mqf2", segment === "map" ? "selected" : ""].join(" ").trim()}">map</a></li></ul>

    <ul class="${"nav-actions svelte-1x3mqf2"}"><li class="${"svelte-1x3mqf2"}"><select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-1x3mqf2"}"><option value="${"ua"}">Ua</option><option value="${"ru"}">Ru</option><option value="${"en"}">En</option></select></li>

        <li class="${"svelte-1x3mqf2"}">${validate_component(Button, "Button").$$render($$result, { auto: true, size: "small" }, {}, {
		default: () => `${validate_component(Icon, "Icon").$$render(
			$$result,
			{
				type: "moon",
				size: "medium",
        ...
        <li class="${"svelte-1x3mqf2"}"><a class="${"btn small svelte-1x3mqf2"}" href="${"users/me"}">${validate_component(Avatar, "Avatar").$$render(
		$$result,
		{
			size: "small",
...
const css$n = {
	code: "footer.svelte-e0hzot{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;padding:var(--screen-padding);-webkit-box-shadow:inset var(--shadow-primary);box-shadow:inset var(--shadow-primary);background-color:rgba(var(--theme-bg-color))}ul.svelte-e0hzot{display:-webkit-box;display:-ms-flexbox;display:flex;margin:-3px}li.svelte-e0hzot{padding:3px}",
	map: "{\"version\":3,\"file\":\"Footer.svelte\",\"sources\":[\"Footer.svelte\"],\"sourcesContent\":[\"<script>\\n    import Button from '@components/Button.svelte'\\n</script>\\n\\n<footer>\\n    <p>© {new Date().getFullYear()}</p>\\n    <ul>\\n        <li>\\n            <Button size=\\\"small\\\" is=\\\"success\\\">Action</Button>\\n        </li>\\n    </ul>\\n</footer>\\n\\n<style>\\nfooter {\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    -webkit-box-align: center;\\n        -ms-flex-align: center;\\n            align-items: center;\\n    -webkit-box-pack: justify;\\n        -ms-flex-pack: justify;\\n            justify-content: space-between;\\n    padding: var(--screen-padding);\\n    -webkit-box-shadow: inset var(--shadow-primary);\\n            box-shadow: inset var(--shadow-primary);\\n    background-color: rgba(var(--theme-bg-color));\\n}\\n\\nul {\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    margin: -3px;\\n}\\n\\nli {\\n    padding: 3px;\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAcA,MAAM,cAAC,CAAC,AACJ,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,aAAa,CACtC,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAC9B,kBAAkB,CAAE,KAAK,CAAC,IAAI,gBAAgB,CAAC,CACvC,UAAU,CAAE,KAAK,CAAC,IAAI,gBAAgB,CAAC,CAC/C,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,AACjD,CAAC,AAED,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,GAAG,AAChB,CAAC\"}"
};

const Footer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$n);

	return `<footer class="${"svelte-e0hzot"}"><p>© ${escape(new Date().getFullYear())}</p>
    <ul class="${"svelte-e0hzot"}"><li class="${"svelte-e0hzot"}">${validate_component(Button, "Button").$$render($$result, { size: "small", is: "success" }, {}, { default: () => `Action` })}</li></ul>
</footer>`;
});
...
const SocialsX = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"flex flex-justify-center social-icons svelte-x7o1bc"}">${each(list, item => `${item !== null
	? `<li class="${escape(null_to_empty(item.type)) + " svelte-x7o1bc"}">${$$slots.default
		? $$slots.default({ item })
		: `
                    ${item.href
			? `<a${add_attribute("href", item.href, 0)} target="${"_blank"}"${add_attribute("title", item.title, 0)}>${validate_component(Icon, "Icon").$$render(
					$$result,
					{
						type: item.type,
						is: "light",
	...
	: `<li style="${"padding: 0 10px; width: 60px; height: 45px; overflow: hidden"}" class="${"svelte-x7o1bc"}">${validate_component(Loader, "Loader").$$render($$result, { type: "avatar" }, {}, {})}
            </li>`}`)}
</ul>`;
});
...
const SocialsY = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"social-icons svelte-1qjherp"}">${each(list, item => `<li class="${"svelte-1qjherp"}">${item !== null
	? `${$$slots.default
		? $$slots.default({ item })
		: `
                    ${item.href
			? `<a${add_attribute("href", item.href, 0)} target="${"_blank"}" class="${"inner svelte-1qjherp"}"${add_attribute("title", item.title, 0)}><span class="${"icon-wrap svelte-1qjherp"}">${validate_component(Icon, "Icon").$$render(
					$$result,
					{
						type: item.type,
						is: "light",
			...
			: `<div class="${"inner svelte-1qjherp"}"${add_attribute("title", item.title, 0)}><span class="${"icon-wrap svelte-1qjherp"}">${validate_component(Icon, "Icon").$$render(
					$$result,
					{
						type: item.type,
						is: "light",
                ...
                `}`
	: `<span class="${"flex flex-align-center"}" style="${"padding: 7px 0"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}
                </span>`}
        </li>`)}
</ul>`;
});
...
const Documents = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Carousel, "Carousel").$$render(
		...
		{},
		{
			default: ({ item, index }) => `<div class="${escape(null_to_empty(!index
			? "start"
			: index === items.length - 1 ? "end" : "")) + " svelte-nrl6pf"}">${validate_component(FancyBox, "FancyBox").$$render($$result, {}, {}, {
				box: () => `<section slot="${"box"}" class="${"flex full-container svelte-nrl6pf"}">${validate_component(Card, "Card").$$render($$result, { class: "flex" }, {}, {
					default: () => `${validate_component(Picture, "Picture").$$render(
						$$result,
						{
							src: item.src,
							srcBig: item.src2x,
				...
				default: () => `${validate_component(Card, "Card").$$render($$result, { class: "flex" }, {}, {
					default: () => `${validate_component(Picture, "Picture").$$render(
						$$result,
						{
							src: item.src,
...
/* src/components/app/AvatarAndName.svelte generated by Svelte v3.24.0 */

const css$r = {
	code: "section.svelte-gex143.svelte-gex143{width:100%;-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:center;-ms-flex-align:center;align-items:center;overflow:hidden}span.svelte-gex143.svelte-gex143{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;overflow:hidden;padding:0 15px}span.svelte-gex143 h4.svelte-gex143,span.svelte-gex143 sub.svelte-gex143{max-width:100%;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}",
	map: "{\"version\":3,\"file\":\"AvatarAndName.svelte\",\"sources\":[\"AvatarAndName.svelte\"],\"sourcesContent\":[\"<script>\\n    import Avatar from '@components/Avatar.svelte'\\n\\n    export let src = undefined\\n    export let title = 'incognito'\\n    export let subtitle = ''\\n</script>\\n\\n<section>\\n    <Avatar src={src} size=\\\"medium\\\" alt={title}/>\\n\\n    <span>\\n        <h4>{title}</h4>\\n        <sub>{subtitle}</sub>\\n    </span>\\n</section>\\n\\n<style>\\nsection {\\n    width: 100%;\\n    -webkit-box-flex: 1;\\n        -ms-flex-positive: 1;\\n            flex-grow: 1;\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    -ms-flex-item-align: stretch;\\n        align-self: stretch;\\n    -webkit-box-align: center;\\n        -ms-flex-align: center;\\n            align-items: center;\\n    overflow: hidden;\\n}\\n\\nspan {\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    -webkit-box-orient: vertical;\\n    -webkit-box-direction: normal;\\n        -ms-flex-direction: column;\\n            flex-direction: column;\\n    -webkit-box-pack: center;\\n        -ms-flex-pack: center;\\n            justify-content: center;\\n    overflow: hidden;\\n    padding: 0 15px;\\n}\\n\\nspan h4,\\nspan sub {\\n    max-width: 100%;\\n    overflow: hidden;\\n    white-space: nowrap;\\n    text-overflow: ellipsis;\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAkBA,OAAO,4BAAC,CAAC,AACL,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,IAAI,4BAAC,CAAC,AACF,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,CAC9B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,CAAC,CAAC,IAAI,AACnB,CAAC,AAED,kBAAI,CAAC,gBAAE,CACP,kBAAI,CAAC,GAAG,cAAC,CAAC,AACN,SAAS,CAAE,IAAI,CACf,QAAQ,CAAE,MAAM,CAChB,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,QAAQ,AAC3B,CAAC\"}"
};
...
const AvatarAndName = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"svelte-gex143"}">${validate_component(Avatar, "Avatar").$$render($$result, { src, size: "medium", alt: title }, {}, {})}

    <span class="${"svelte-gex143"}"><h4 class="${"svelte-gex143"}">${escape(title)}</h4>
        <sub class="${"svelte-gex143"}">${escape(subtitle)}</sub></span>
</section>`;
});
...
const ListItems = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${items.length
	? each(items, item => `<a class="${"item container svelte-1020qdr"}"${add_attribute("href", `${basePath}/${item.id}`, 0)}><br>
        ...
        <br></a>
    <br>`)
	: `<section class="${"item container svelte-1020qdr"}"><p class="${"text-center"}">No organizations</p>
    </section>`}`;
});
...
const StoryList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section${add_attribute("class", classProp, 0)}${add_attribute("style", styleProp, 0)}>${label
	? `<h2 class="${"text-left"}">${escape(label)}</h2>
        ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
	: ``}

    <table class="${"svelte-1rv59vc"}"><tbody>${value !== null && Array.isArray(value) && value.length
	? `${each(value.filter(Boolean), (val, i) => `<tr><td class="${"svelte-1rv59vc"}">${escape(val.date)}</td>
                        <td class="${"svelte-1rv59vc"}">—</td>
                        <td class="${"svelte-1rv59vc"}">${escape(val.title)}</td>
                        ${!readonly
		? `<td class="${"svelte-1rv59vc"}">${validate_component(Button, "Button").$$render(
				$$result,
				{
					auto: true,
					style: "vertical-align: middle"
				...
				{},
				{
					default: () => `${validate_component(Icon, "Icon").$$render($$result, { type: "close", size: "medium" }, {}, {})}`
				}
			)}
                            </td>`
		: ``}
	...
	: `${value === null
		? `<tr><td class="${"svelte-1rv59vc"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</td>
                    <td class="${"svelte-1rv59vc"}">—</td>
                    <td class="${"svelte-1rv59vc"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}
                        ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</td></tr>
                <tr><td class="${"svelte-1rv59vc"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</td>
                    <td class="${"svelte-1rv59vc"}">—</td>
                    <td class="${"svelte-1rv59vc"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}
                        ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</td></tr>
	...
	? `${validate_component(Br, "Br").$$render($$result, { size: "25" }, {}, {})}
        ${validate_component(Button, "Button").$$render($$result, { auto: true, is: "info" }, {}, {
			default: () => `<h3 style="${"padding: 10px 25px"}" class="${"font-w-500"}">Додати подію
            </h3>`
		})}`
	: ``}</section>
...
${validate_component(Modal, "Modal").$$render(
		...
		{},
		{
			default: () => `<div class="${"container"}">${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
        ...
        ${validate_component(Button, "Button").$$render(
				...
				{},
				{ default: () => `<h3>Зберегти</h3>` }
			)}
        ${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}</div>`
		}
	)}`;
});
...
const SearchLine = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<section class="${"search svelte-16zbu6b"}">${validate_component(Input, "Input").$$render($$result, { type: "search" }, {}, {})}
</section>`;
});
...
const TrustButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<button type="${"button"}" title="${"I trust"}" class="${escape(null_to_empty(classProp)) + " svelte-1xs9p24"}"><div class="${"full-absolute svelte-1xs9p24"}"><span class="${"svelte-1xs9p24"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			type: "heart",
...
const TitleSubTitle = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"svelte-1cmj5fu"}"><h1>${escape(title)}</h1>
    <br>
    <h2 class="${"svelte-1cmj5fu"}">${escape(subtitle)}</h2>
</section>`;
});
...
<br>
<br>
<pre>This is the &quot;about&quot; section which explains people the main sense of our purpose.
    There&#39;s not much here.
    But this section is not the least!
</pre>
<br>
<pre>We try to make our society more kind and we do kind things for it.
...
const DonationButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<button type="${"button"}" class="${escape(null_to_empty(classPropDonateBtn)) + " svelte-1nsvb2j"}"><span class="${"svelte-1nsvb2j"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			type: "coin",
			size: "medium",
...
const css$x = {
	code: "ul.svelte-us8ild{list-style:disc outside none;padding:0 calc(var(--screen-padding) * 5)}li.svelte-us8ild{display:list-item}ul.svelte-us8ild,li.svelte-us8ild,h3.svelte-us8ild,p.svelte-us8ild{max-width:100%;vertical-align:middle}h3.svelte-us8ild,p.svelte-us8ild{overflow:hidden;display:inline-block;word-break:break-word;text-overflow:ellipsis}",
	map: "{\"version\":3,\"file\":\"ListOfFeatures.svelte\",\"sources\":[\"ListOfFeatures.svelte\"],\"sourcesContent\":[\"<script>\\n    const items = [\\n        {\\n            title: 'Comfort is the main feature',\\n            text: 'Just imaging, you do something simple and you can see the result of your short way.',\\n        },\\n        {\\n            title: 'Comfort is the main feature',\\n            text: 'Just imaging, you do something simple and you can see the result of your short way.',\\n        },\\n        {\\n            title: 'Comfort is the main feature',\\n            text: 'Just imaging, you do something simple and you can see the result of your short way.',\\n        },\\n        {\\n            title: 'Comfort is the main feature',\\n            text: 'Just imaging, you do something simple and you can see the result of your short way.',\\n        },\\n    ]\\n</script>\\n\\n<ul>\\n    {#each items as item}\\n        <li>\\n            <h3>{item.title}</h3>\\n            <p>{item.text}</p>\\n            <br>\\n        </li>\\n    {/each}\\n</ul>\\n\\n<style>\\nul {\\n    list-style: disc outside none;\\n    padding: 0 calc(var(--screen-padding) * 5);\\n    /*list-style-image: url(\\\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='10' height='10' viewBox='-1 -1 2 2'><circle r='1' /></svg>\\\");*/\\n}\\n\\nli {\\n    display: list-item;\\n}\\n\\nul, li, h3, p {\\n    max-width: 100%;\\n    vertical-align: middle;\\n}\\n\\nh3, p {\\n    overflow: hidden;\\n    display: inline-block;\\n    word-break: break-word;\\n    text-overflow: ellipsis;\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAgCA,EAAE,cAAC,CAAC,AACA,UAAU,CAAE,IAAI,CAAC,OAAO,CAAC,IAAI,CAC7B,OAAO,CAAE,CAAC,CAAC,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,AAE9C,CAAC,AAED,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,SAAS,AACtB,CAAC,AAED,gBAAE,CAAE,gBAAE,CAAE,gBAAE,CAAE,CAAC,cAAC,CAAC,AACX,SAAS,CAAE,IAAI,CACf,cAAc,CAAE,MAAM,AAC1B,CAAC,AAED,gBAAE,CAAE,CAAC,cAAC,CAAC,AACH,QAAQ,CAAE,MAAM,CAChB,OAAO,CAAE,YAAY,CACrB,UAAU,CAAE,UAAU,CACtB,aAAa,CAAE,QAAQ,AAC3B,CAAC\"}"
};
...
const ListOfFeatures = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"svelte-us8ild"}">${each(items, item => `<li class="${"svelte-us8ild"}"><h3 class="${"svelte-us8ild"}">${escape(item.title)}</h3>
            <p class="${"svelte-us8ild"}">${escape(item.text)}</p>
            <br>
        </li>`)}
</ul>`;
});
...
const Map$2 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"svelte-eljdnw"}"${add_attribute("this", container, 1)}>${map
	? `${$$slots.default ? $$slots.default({}) : ``}`
	: ``}</section>`;
});
...
const Comment = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Card, "Card").$$render($$result, { class: classProp }, {}, {
		default: () => `<section class="${"comment flex flex-align-start"}" style="${"padding: 20px"}"><div class="${"flex relative"}">${validate_component(FancyBox, "FancyBox").$$render($$result, {}, {}, {
			box: () => `<section slot="${"box"}" class="${"flex full-width full-height"}" style="${"height: 100vw"}"><div class="${"flex flex-self-stretch flex-1 overflow-hidden flex-justify-stretch"}" style="${"padding: var(--screen-padding) 0"}">${validate_component(Avatar, "Avatar").$$render($$result, { src, alt: title }, {}, {})}</div></section>`,
			default: () => `${validate_component(Avatar, "Avatar").$$render($$result, { src, alt: title, size: "medium" }, {}, {})}
                `
		})}

            ${checked
		? `<div class="${"absolute flex"}" style="${"top: -1px; right: -1px; width: 20px; height: 20px; overflow: hidden"}">${validate_component(Icon, "Icon").$$render($$result, { type: "polygon", is: "info" }, {}, {})}
                <div class="${"absolute-center flex"}" style="${"width: 10px; height: 10px;"}">${validate_component(Icon, "Icon").$$render($$result, { type: "check-flag", is: "light" }, {}, {})}</div></div>`
		: ``}</div>
        ...
        <div class="${"flex flex-column flex-1"}" style="${"overflow: hidden"}">${title !== null
		...
		: `<div style="${"width: 60%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}</div>`}
            ...
            <pre class="${"h4 font-w-300"}" style="${"line-height: 1.46;"}">${$$slots.default
		? $$slots.default({})
		: `
                     [No comment]
                `}</pre>
            ...
            <div class="${"flex flex-align-center flex-justify-between"}"><p class="${"flex flex-align-center flex-justify-between"}">${date !== null
		? `<span class="${"h4"}" style="${"opacity: .3"}">${escape(date)}</span>
                        ...
                        <s></s>
                        <s></s>`
		: `<div style="${"width: 80%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h4" }, {}, {})}</div>`}</p>
                <span class="${"h5 flex flex-align-center font-secondary"}" style="${"min-width: 4em"}"><span${add_attribute("style", `opacity: ${amount > 2 ? 1 : 0.5}`, 0)}>${validate_component(Icon, "Icon").$$render(
			$$result,
			{
				type: "heart",
				is: "danger",
			...
			{}
                    ...
                    ${amount !== null
		? `<h4>${escape(amount)}</h4>`
		: `<span class="${"h4 relative flex-self-start"}"><span style="${"visibility: hidden"}">199</span>
                            ${validate_component(Loader, "Loader").$$render($$result, { type: "h4", absolute: true }, {}, {})}</span>`}</span></div></div></section>
`
	})}`;
});
...
const Comments = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"comments svelte-gsvbhk"}"><ul class="${"comments-wrap svelte-gsvbhk"}">${each(items, comment => `<li class="${"svelte-gsvbhk"}">${validate_component(Comment, "Comment").$$render(
		$$result,
		{
			src: comment.avatar,
			title: comment.author,
    ...
    <p class="${"h3 font-w-500 font-secondary underline text-center"}"><span>Всі коментарі</span>
        ${validate_component(Icon, "Icon").$$render($$result, { type: "caret-down", size: "small" }, {}, {})}</p>

    ${withForm
	? `${validate_component(Br, "Br").$$render($$result, { size: "40" }, {}, {})}  
        <div class="${"comments-form font-secondary h3 svelte-gsvbhk"}">${validate_component(Form, "Form").$$render($$result, { class: "flex", name: "comment-form" }, {}, {
			default: () => `${validate_component(Input, "Input").$$render(
				$$result,
				{
					type: "textarea",
					name: "comment",
            ...
            <div class="${"flex absolute"}" style="${"top: 0; right: 0; height: 100%; width: 50px"}">${validate_component(Button, "Button").$$render(
			$$result,
			{
				type: "submit",
			...
			{},
			{
				default: () => `${validate_component(Icon, "Icon").$$render($$result, { type: "send", is: "info", size: "medium" }, {}, {})}`
			}
		)}</div></div>`
	: ``}
</section>`;
...
const DonatorsCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	? `${validate_component(Card, "Card").$$render($$result, {}, {}, {
			default: () => `<ul class="${"full-width"}">${each(items, item => `<li${add_attribute("key", item.id, 0)} class="${"svelte-3bffko"}"><div class="${"relative"}">${validate_component(Avatar, "Avatar").$$render(
				$$result,
				{
					src: item.src,
					size: "medium",
				...
				{}
                        ...
                        ${item.checked
			? `<div class="${"absolute flex"}" style="${"top: -1px; right: -1px; width: 20px; height: 20px; overflow: hidden"}">${validate_component(Icon, "Icon").$$render($$result, { type: "polygon", is: "info" }, {}, {})}
                                <div class="${"absolute-center flex"}" style="${"width: 10px; height: 10px;"}">${validate_component(Icon, "Icon").$$render($$result, { type: "check-flag", is: "light" }, {}, {})}</div>
                            </div>`
			: ``}</div>
                    <s></s>
                    <s></s>
                    <s></s>
                    <s></s>
                    <div style="${"overflow: hidden;"}" class="${"flex flex-column flex-justify-center"}">${item.title !== null
			? `<h2 class="${"text-ellipsis"}">${escape(item.title)}</h2>`
			: `<span class="${"h2 relative flex-self-start"}"><span style="${"visibility: hidden"}">₴ 1000</span>
			...
			: `${validate_component(Loader, "Loader").$$render($$result, { type: "h4" }, {}, {})}`}</div>
                </li>`)}</ul>`
		})}`
	: ``}`;
});
...
const DonatorsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"donators scroll-x-center svelte-1pn9uv2"}"${add_attribute("this", container, 1)}>${each(grouped, cards => `<li class="${"svelte-1pn9uv2"}">${validate_component(DonatorsCard, "DonatorsCard").$$render($$result, { items: cards }, {}, {})}
        </li>`)}
</ul>`;
});
...
const NewsItem = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Card, "Card").$$render($$result, { class: classProp }, {}, {
		default: () => `<section class="${"news-item flex"}"><div class="${"flex flex-none relative"}" style="${"width: 110px"}">${validate_component(Picture, "Picture").$$render($$result, { src, alt: title }, {}, {})}</div>

        <div class="${"flex flex-column flex-1 container overflow-hidden"}" style="${"padding-top: 20px; padding-bottom: 5px"}">${title !== null
		...
		: `<div style="${"width: 100%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</div>
            ...
            <div class="${"flex flex-align-center flex-justify-between"}"><p>${date !== null
		? `<span class="${"h4"}" style="${"opacity: .3"}">${escape(date)}</span>`
		: `<div style="${"width: 60%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h4" }, {}, {})}</div>`}</p>
                <s></s>
                <s></s>
                <span class="${"h5 flex flex-align-center font-secondary"}" style="${"min-width: 4em"}">${validate_component(Button, "Button").$$render($$result, { size: "medium" }, {}, {
			default: () => `<span${add_attribute("style", `opacity: ${isLiked ? 1 : 0.5}`, 0)}>${validate_component(Icon, "Icon").$$render(
				$$result,
				{
					type: "heart",
					is: "danger",
				...
				{}
                        ...
                        ${likes !== null
			? `<h4>${escape(likes)}</h4>`
			: `<span class="${"h4 relative"}"><span style="${"visibility: hidden"}">199</span>
                                ${validate_component(Loader, "Loader").$$render($$result, { type: "h4", absolute: true }, {}, {})}</span>`}`
...
const NewsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"news-list svelte-11jv2m5"}"><ul class="${"news-list-wrap svelte-11jv2m5"}">${each(items, (item, index) => `<li role="${"button"}"${add_attribute("key", item.id, 0)} class="${"svelte-11jv2m5"}">${validate_component(NewsItem, "NewsItem").$$render(
		$$result,
		{
			src: item.src,
			title: item.title,
		...
		{}
                ...
                <span class="${"arrow svelte-11jv2m5"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			type: "arrow-right",
			size: "small",
    ...
    <p class="${"h3 font-w-500 font-secondary underline text-center"}"><span>Всі новини</span>
        ${validate_component(Icon, "Icon").$$render($$result, { type: "caret-down", size: "small" }, {}, {})}</p>
</section>`;
});
...
const FundCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Card, "Card").$$render($$result, { class: "flex flex-column" }, {}, {
		default: () => `<div style="${"height: 160px"}" class="${"flex flex-none"}">${validate_component(Carousel, "Carousel").$$render(
			$$result,
			{
    ...
    <section class="${"container flex flex-column flex-justify-between flex-1"}"><div class="${"flex-none overflow-hidden"}" style="${"height: calc(2 * var(--font-line-height-h2) + var(--font-line-height) + 20px + 5px + 10px)"}">${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}     

            ${title !== null
		? `<h2 class="${"text-ellipsis-multiline"}" style="${"--max-lines: 2"}">${escape(title)}</h2>`
		: `${validate_component(Loader, "Loader").$$render($$result, { type: "h2" }, {}, {})}
            ...
            ${city !== null
		? `<p class="${"flex flex-align-center font-secondary font-w-500"}" style="${"opacity: .7; margin-left: -2px"}">${validate_component(Icon, "Icon").$$render($$result, { type: "location", size: "small" }, {}, {})}
                    <s></s>
                    <span>${escape(city)}</span></p>
                ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
		: `<div style="${"width: 40%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</div>`}</div>

        <div><p class="${"font-secondary flex flex-wrap flex-align-end"}" style="${"letter-spacing: -0.5px"}">${current !== null && total !== null
		? `<span class="${"h1 font-w-500"}">${escape(currency)} ${escape(current)}</span>
                    <s></s>
                    <span class="${"h4"}">/ ${escape(currency)} ${escape(total)}</span>`
		: `<div style="${"width: 80%; flex: none"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h1" }, {}, {})}</div>`}</p>
            ...
            ${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}</div></section>
`
	})}`;
});
...
const FundCards = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Carousel, "Carousel").$$render($$result, { items, size: "auto", class: "charities" }, {}, {
		default: ({ index, item }) => `<div class="${escape(null_to_empty(!index
		? "start"
		: index === items.length - 1 ? "end" : "")) + " svelte-yc0ge7"}"${add_attribute("key", item.id, 0)}>${validate_component(FundCard, "FundCard").$$render(
			$$result,
			{
				src: item.src,
				total: item.total,
			...
			{},
			{
				button: ({ id }) => `<span slot="${"button"}">${$$slots.button
				? $$slots.button({})
				: `
                    ${validate_component(Button, "Button").$$render($$result, { size: "big", is: "success", href: id }, {}, {
						default: () => `<span class="${"h2 font-secondary font-w-600"}">Допомогти
                        </span>`
					})}
                `}</span>`
			}
...
const Trust = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"flex flex-column flex-align-center flex-justify-center"}"><div style="${"width: 100px; max-width: 100%"}">${validate_component(TrustButton, "TrustButton").$$render($$result, { isActive: active }, {}, {})}</div>
    ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}
    <h2>Я довіряю</h2></section>`;
});
...
const Share = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<p class="${"flex"}">${validate_component(Button, "Button").$$render(
		$$result,
		{
...
${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
<section class="${"flex"}" style="${"height: 240px"}">${validate_component(Carousel, "Carousel").$$render($$result, { items }, {}, {})}</section>`;
});

/* src/routes/organizations/components/_WeOnMap.svelte generated by Svelte v3.24.0 */

const css$F = {
	code: "div.svelte-1mfnpq7{background-color:rgba(var(--theme-bg-color-opposite), .04)}",
	map: "{\"version\":3,\"file\":\"_WeOnMap.svelte\",\"sources\":[\"_WeOnMap.svelte\"],\"sourcesContent\":[\"<script>\\n  import { Br } from \\\"@components\\\";\\n  \\n  export let src\\n</script>\\n\\n<h1>Ми на карті</h1>\\n<Br size=\\\"20\\\" />\\n<div class=\\\"full-container\\\">\\n  <iframe\\n    {src}\\n    title=\\\"Карта\\\"\\n    width=\\\"100%\\\"\\n    height=\\\"450\\\"\\n    frameborder=\\\"0\\\"\\n    style=\\\"border:0;\\\"\\n    allowfullscreen=\\\"\\\"\\n    aria-hidden=\\\"false\\\"\\n    tabindex=\\\"0\\\" ></iframe>\\n</div>\\n\\n<style>\\ndiv {\\n    background-color: rgba(var(--theme-bg-color-opposite), .04);\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAsBA,GAAG,eAAC,CAAC,AACD,gBAAgB,CAAE,KAAK,IAAI,yBAAyB,CAAC,CAAC,CAAC,GAAG,CAAC,AAC/D,CAAC\"}"
};
...
${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
<div class="${"full-container svelte-1mfnpq7"}"><iframe${add_attribute("src", src, 0)} title="${"Карта"}" width="${"100%"}" height="${"450"}" frameborder="${"0"}" style="${"border:0;"}" allowfullscreen="${""}" aria-hidden="${"false"}" tabindex="${"0"}"></iframe>
</div>`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}
<div class="${"full-container"}">${validate_component(Comments, "Comments").$$render($$result, { items }, {}, {})}</div>`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
<div class="${"full-container"}">${validate_component(DonatorsList, "DonatorsList").$$render($$result, { items }, {}, {})}</div>`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}
<div class="${"full-container"}">${validate_component(FundCards, "FundCards").$$render($$result, { items }, {}, {})}</div>`;
});
...
const TopCarousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { items = [] } = $$props;
	if ($$props.items === void 0 && $$bindings.items && items !== void 0) $$bindings.items(items);
	return `<section class="${"flex"}" style="${"height: 240px"}">${validate_component(Carousel, "Carousel").$$render($$result, { items, dotsBelow: false }, {}, {})}</section>`;
});
...
${text
	? `<pre class="${"font-w-300"}">${escape(text)}</pre>`
...
const InteractionIndicators = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<p class="${"container flex flex-justify-between flex-align-center"}">${validate_component(Button, "Button").$$render(
		$$result,
		{
			class: "flex flex-align-center",
			auto: true,
    ...
    ${likes !== null
			...
			: `<span class="${"font-secondary font-w-600 h3 relative"}"><span style="${"visibility: hidden"}">199</span>
        ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span>`}`
		}
	)}

  <span class="${"flex"}">${validate_component(Button, "Button").$$render(
		$$result,
		{
			class: "flex flex-align-center",
			auto: true,
  ...
  <span class="${"flex flex-align-center"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			type: "eye",
			size: "medium",
	...
	: `<span class="${"font-secondary font-w-600 h3 relative"}"><span style="${"visibility: hidden"}">199</span>
        ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span>`}</span></p>`;
});
...
${validate_component(Modal, "Modal").$$render(
		...
		{},
		{
			default: () => `<section class="${"container flex flex-column relative"}">${validate_component(Br, "Br").$$render($$result, {}, {}, {})}
        ...
        <section class="${"flex"}" style="${"height: 240px"}">${validate_component(Carousel, "Carousel").$$render($$result, { items: carousel, stopPropagation: true }, {}, {})}</section>
        ...
        ${validate_component(Br, "Br").$$render($$result, {}, {}, {})}</section>
`
		}
	)}`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
<div class="${"full-container svelte-1mfnpq7"}"><iframe${add_attribute("src", src, 0)} title="${"360 тур"}" width="${"100%"}" height="${"450"}" frameborder="${"0"}" style="${"border:0;"}" allowfullscreen="${""}" aria-hidden="${"false"}" tabindex="${"0"}"></iframe>
</div>`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}
<div class="${"full-container"}">${validate_component(Documents, "Documents").$$render($$result, { items }, {}, {})}</div>`;
});
...
const ContactsCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Card, "Card").$$render($$result, {}, {}, {
		default: () => `<section style="${"padding: 0 20px"}">${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}

        <div class="${"flex flex-column flex-align-center"}"><span>${validate_component(FancyBox, "FancyBox").$$render($$result, { class: "flex-justify-center" }, {}, {
			box: () => `<section slot="${"box"}" class="${"flex full-width full-height"}" style="${"height: 100vw"}"><div class="${"flex flex-self-stretch flex-1 overflow-hidden flex-justify-stretch"}" style="${"padding: var(--screen-padding) 0"}">${validate_component(Avatar, "Avatar").$$render(
				$$result,
				{
					src: avatar,
					srcBig: avatarBig,
			...
			default: () => `${validate_component(Avatar, "Avatar").$$render(
				$$result,
				{
					size: "big",
					src: avatar,
            ...
            ${orgName !== null
		? `<p class="${"h3 font-secondary font-w-500"}" style="${"opacity: .7"}">${escape(orgName)}</p>`
		: `<p style="${"width: 60%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}</p>`}</div>
        ...
        ${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}</section>
`
	})}`;
});
...
const OrganizationButton = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Button, "Button").$$render(
		...
		{},
		{
			default: () => `<div class="${"flex flex-align-center flex-justify-between full-width"}"><div class="${"flex flex-align-center"}"><s></s>
      <div class="${"flex"}" style="${"max-width: 45px; height: 40px; overflow: hidden"}">${validate_component(Picture, "Picture").$$render(
				$$result,
				{
					src,
					size: "contain",
      ...
      ${title !== null
        ...
        <s></s>
        <h3>${escape(title)}</h3>`
			: `<span>${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}</span>`}</div></div>`
		}
	)}`;
});
...
const Map$3 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(EditCard, "EditCard").$$render($$result, { form: "map-form" }, {}, {
		default: () => `${validate_component(FormBuilder, "FormBuilder").$$render(
			$$result,
			{
				id: "map-form",
				items: formFields,
...
const Contacts = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(EditCard, "EditCard").$$render($$result, { form: "contacts-form" }, {}, {
		default: () => `${validate_component(FormBuilder, "FormBuilder").$$render(
			$$result,
			{
				id: "contacts-form",
			...
			{},
			{
				default: ({ item, value, onChange }) => `${item.type === "custom-socials" ? `Socials` : ``}`
			}
		)}`
	})}`;
});
...
const Map$4 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classnames({ preview }))) + " svelte-190a4wu"}">${validate_component(VirtualTour, "VirtualTour").$$render($$result, { src: location.virtual_tour }, {}, {})}
    ${validate_component(Br, "Br").$$render($$result, { size: preview ? 20 : 60 }, {}, {})}
    ${validate_component(WeOnMap, "WeOnMap").$$render($$result, { src: location.map }, {}, {})}</section>`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
<section class="${"flex"}" style="${"height: 280px"}">${validate_component(Carousel, "Carousel").$$render($$result, { items }, {}, {})}</section>`;
});
...
${validate_component(Br, "Br").$$render($$result, { size: "15" }, {}, {})}
<ul style="${"list-style: disc outside none; padding-left: var(--screen-padding)"}" class="${"h3 font-w-500 font-secondary"}">${data.how_to_help !== null
	? `${typeof data.how_to_help === "string"
		? `${each(data.how_to_help.split(/\n?• /).filter(Boolean), line => `<li style="${"padding-bottom: 5px"}">${escape(line)}</li>`)}`
		: ``}`
	: `<li style="${"padding-bottom: 5px"}"><span class="${"font-secondary font-w-500 p relative"}"><span style="${"visibility: hidden"}">Допомогти любим способом</span>
                ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span></li>
       <li style="${"padding-bottom: 5px"}"><span class="${"font-secondary font-w-500 p relative"}"><span style="${"visibility: hidden"}">Допомогти любим способом</span>
                ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span></li>
       <li style="${"padding-bottom: 5px"}"><span class="${"font-secondary font-w-500 p relative"}"><span style="${"visibility: hidden"}">Допомогти любим способом</span>
                ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span></li>
       <li style="${"padding-bottom: 5px"}"><span class="${"font-secondary font-w-500 p relative"}"><span style="${"visibility: hidden"}">Допомогти любим способом</span>
                ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span></li>`}</ul>
${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}
<div class="${"flex"}"><div class="${"flex flex-align-center font-secondary"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			size: "medium",
			type: "phone",
	...
	: `<span style="${"width: 240px"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h2" }, {}, {})}</span>`}</div></div>
${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}
...
const AnimalCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"flex flex-column flex-align-center"}"><span>${validate_component(FancyBox, "FancyBox").$$render($$result, {}, {}, {
			box: () => `<section slot="${"box"}" class="${"flex full-width full-height"}" style="${"height: 100vw"}"><div class="${"flex flex-self-stretch flex-1 overflow-hidden flex-justify-stretch"}" style="${"padding: var(--screen-padding) 0"}">${validate_component(Avatar, "Avatar").$$render(
				$$result,
				{
					src: animal.avatar,
		...
		: `<span style="${"width: 60%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}</span>`}</div>
    ${validate_component(Br, "Br").$$render($$result, { size: "35" }, {}, {})}

    <section class="${"flex flex-justify-center"}"><div class="${"flex flex-center relative"}" style="${"width: 120px; height: 120px"}">${validate_component(Icon, "Icon").$$render($$result, { type: "polygon", is: "primary" }, {}, {})}

            ${animal.age !== null
		? `<div class="${"text-white text-center absolute"}"><h4 class="${"h1"}">${escape(animal.age)}</h4>
                    <h4 style="${"margin-top: -8px"}">Роки</h4></div>`
		: ``}</div>

        <div class="${"flex flex-center relative"}" style="${"width: 120px; height: 120px"}">${validate_component(Icon, "Icon").$$render($$result, { type: "polygon", is: "info" }, {}, {})}

            ${animal.sex !== null
		? `<div class="${"absolute flex"}" style="${"width: 44px; height: 44px"}">${animal.sex === "male"
        ...
        <div class="${"flex flex-center relative"}" style="${"width: 120px; height: 120px"}">${validate_component(Icon, "Icon").$$render($$result, { type: "polygon", is: "primary" }, {}, {})}

            ${animal.sterilization !== null
		? `<div class="${"absolute flex flex-column flex-center"}">${animal.sterilization
			? `${validate_component(Icon, "Icon").$$render(
					$$result,
					{
						type: "checked-circle",
			...
			: `${validate_component(Icon, "Icon").$$render(
                    ...
                    <span class="${"text-white text-center h5"}">Cтерилізація</span></div>`
		: ``}</div></section>
    ${validate_component(Br, "Br").$$render($$result, { size: "40" }, {}, {})}
    ...
    ${animal.character !== null
		? `<p class="${"font-w-300"}">${escape(animal.character)}</p>`
		: `${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}
        ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}
        ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}
        ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}`}
    ...
    <h2>Вакцинації</h2>
    ${validate_component(Br, "Br").$$render($$result, { size: "15" }, {}, {})}
    <ul class="${"flex flex-column text-left"}">${animal.vaccination !== null
		? `${each(getVactinations(animal.vaccination), (item, i) => `<li>${i
			? `${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
			: ``}
                    <span class="${"flex flex-align-center font-w-300"}">${item.done
			? `${validate_component(Icon, "Icon").$$render(
					$$result,
					{
						is: "primary",
			...
			: `${validate_component(Icon, "Icon").$$render(
					...
					{}
                        ...
                        <s></s>
                        <s></s>
                        ${escape(item.title)}</span>
                </li>`)}`
		: `<li style="${"width: 40%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</li>
            <li style="${"width: 40%"}">${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}
                ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</li>
            <li style="${"width: 40%"}">${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}
                ${validate_component(Loader, "Loader").$$render($$result, { type: "p" }, {}, {})}</li>`}</ul>
...
const QuickInfoCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
		default: () => `${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "25" }, {}, {})}
    <p class="${"font-secondary flex flex-align-end"}">${cardTop.current_sum !== null
		...
		: `<div style="${"width: 30%; padding-bottom: 2px"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}</div>`}</p>
    ${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
...
const OrganizationButton$2 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Button, "Button").$$render(
      ...
      ${title !== null
        ...
        <s></s>
        <h3>${escape(title)}</h3>`
			: `<span style="${"width: 80%"}">${validate_component(Loader, "Loader").$$render($$result, { type: "h3" }, {}, {})}</span>`}</div>
...
const InteractionIndicators$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<p class="${"container flex flex-justify-between flex-align-center"}"><span class="${"flex flex-align-center"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			is: "danger",
			type: "heart",
	...
	? `<span class="${"font-secondary font-w-600 h3"}">${escape(likes)}</span>`
	: `<span class="${"font-secondary font-w-600 h3 relative"}"><span style="${"visibility: hidden"}">199</span>
                ${validate_component(Loader, "Loader").$$render($$result, { type: "h3", absolute: true }, {}, {})}</span>`}</span>
    <span class="${"flex flex-align-center"}">${validate_component(Icon, "Icon").$$render(
		$$result,
		{
			type: "eye",
...
const AnimalCard$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(EditCard, "EditCard").$$render($$result, { form: "animal-form" }, {}, {
		default: () => `${validate_component(FormBuilder, "FormBuilder").$$render(
			...
			{},
			{
				default: ({ item, value, onChange }) => `${item.type === "custom-character"
				? `<section><h2 class="${"text-left"}">${escape(item.label)}
                    ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}</h2>
                <div class="${"flex flex-justify-center"}">${validate_component(RadioRect, "RadioRect").$$render($$result, Object.assign(item.meta, { value }, { name: item.name }), {}, {
						default: ({ item: radio }) => `${validate_component(Square, "Square").$$render(
							$$result,
							{
							...
							{},
							{
								default: () => `<span class="${"max-full-height h1 flex-1 flex flex-align-center flex-justify-center"}">${escape(radio.label)}</span>`
							}
						)}`
					})}</div></section>`
				: `${item.type === "custom-lifestory"
					? `<section>${validate_component(StoryList, "StoryList").$$render($$result, Object.assign(item.meta, { value }, { name: item.name }, { label: item.label }), {}, {})}</section>`
					: ``}`}`
			}
		)}`
	})}`;
...
const css$I = {
	code: "section.svelte-i8p8ps.svelte-i8p8ps{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:100%;overflow:hidden;border:3px solid transparent;background-color:rgba(var(--theme-input-bg-color))}section.active.svelte-i8p8ps.svelte-i8p8ps{border-color:rgba(var(--color-white))}section.active.svelte-i8p8ps>div.svelte-i8p8ps{visibility:visible}div.svelte-i8p8ps.svelte-i8p8ps{visibility:hidden;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}div.svelte-i8p8ps span.svelte-i8p8ps{display:-webkit-box;display:-ms-flexbox;display:flex;width:50px;height:50px}h3.svelte-i8p8ps.svelte-i8p8ps{-webkit-box-flex:0;-ms-flex:none;flex:none;width:100%;padding:8px 5px 16px;text-align:center;font-weight:normal;color:rgba(var(--color-white));background-color:rgba(var(--color-black), .5)}",
	map: "{\"version\":3,\"file\":\"_ListNavigationItem.svelte\",\"sources\":[\"_ListNavigationItem.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Icon } from '@components'\\n    \\n    export let value = ''\\n    export let active = false\\n</script>\\n\\n<section class:active={active} class=\\\"radius-big\\\">\\n    <div>\\n        <span>\\n            <Icon type=\\\"check-flag\\\" is=\\\"primary\\\"/>    \\n        </span>\\n    </div>\\n    <h3>{value}</h3>\\n</section>\\n\\n<style>\\nsection {\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    -webkit-box-orient: vertical;\\n    -webkit-box-direction: normal;\\n        -ms-flex-direction: column;\\n            flex-direction: column;\\n    width: 100%;\\n    overflow: hidden;\\n    border: 3px solid transparent;\\n    background-color: rgba(var(--theme-input-bg-color));\\n}\\n\\nsection.active {\\n    border-color: rgba(var(--color-white));\\n}\\n\\nsection.active > div {\\n    visibility: visible;\\n}\\n\\ndiv {\\n    visibility: hidden;\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    -webkit-box-flex: 1;\\n        -ms-flex: 1 1 auto;\\n            flex: 1 1 auto;\\n    -webkit-box-align: center;\\n        -ms-flex-align: center;\\n            align-items: center;\\n    -webkit-box-pack: center;\\n        -ms-flex-pack: center;\\n            justify-content: center;\\n}\\n\\ndiv span {\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    width: 50px;\\n    height: 50px;\\n}\\n\\nh3 {\\n    -webkit-box-flex: 0;\\n        -ms-flex: none;\\n            flex: none;\\n    width: 100%;\\n    padding: 8px 5px 16px;\\n    text-align: center;\\n    font-weight: normal;\\n    color: rgba(var(--color-white));\\n    background-color: rgba(var(--color-black), .5);\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAiBA,OAAO,4BAAC,CAAC,AACL,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,CAC9B,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,CAChB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,WAAW,CAC7B,gBAAgB,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,AACvD,CAAC,AAED,OAAO,OAAO,4BAAC,CAAC,AACZ,YAAY,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC1C,CAAC,AAED,OAAO,qBAAO,CAAG,GAAG,cAAC,CAAC,AAClB,UAAU,CAAE,OAAO,AACvB,CAAC,AAED,GAAG,4BAAC,CAAC,AACD,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACtB,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,AACnC,CAAC,AAED,iBAAG,CAAC,IAAI,cAAC,CAAC,AACN,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,EAAE,4BAAC,CAAC,AACA,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,CAAC,GAAG,CAAC,IAAI,CACrB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAC/B,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,EAAE,CAAC,AAClD,CAAC\"}"
};

const ListNavigationItem = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { value = "" } = $$props;
	let { active = false } = $$props;
	if ($$props.value === void 0 && $$bindings.value && value !== void 0) $$bindings.value(value);
	if ($$props.active === void 0 && $$bindings.active && active !== void 0) $$bindings.active(active);
	...
	return `<section class="${["radius-big svelte-i8p8ps", active ? "active" : ""].join(" ").trim()}"><div class="${"svelte-i8p8ps"}"><span class="${"svelte-i8p8ps"}">${validate_component(Icon, "Icon").$$render($$result, { type: "check-flag", is: "primary" }, {}, {})}</span></div>
    <h3 class="${"svelte-i8p8ps"}">${escape(value)}</h3>
</section>`;
});
...
const css$J = {
	code: "nav.svelte-wcqcr1 ul.svelte-wcqcr1{display:grid;grid-auto-flow:column;grid-auto-columns:1fr;grid-template-rows:155px;grid-gap:10px;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}nav.svelte-wcqcr1 li.svelte-wcqcr1,nav.svelte-wcqcr1 li a.svelte-wcqcr1{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch;overflow:hidden}li.svelte-wcqcr1 a.svelte-wcqcr1:hover{background-color:rgba(var(--color-black), .1)}",
	map: "{\"version\":3,\"file\":\"_ListNavigation.svelte\",\"sources\":[\"_ListNavigation.svelte\"],\"sourcesContent\":[\"<script>\\n    import ListNavigationItem from './_ListNavigationItem.svelte'\\n\\n    export let segment\\n\\n    const nav = [\\n        {\\n            segment: 'funds',\\n            href: 'lists/funds',\\n            label: 'Фонди',\\n        },\\n        {\\n            segment: 'organizations',\\n            href: 'lists/organizations',\\n            label: 'Оргранізації',\\n        }\\n    ]\\n</script>\\n\\n<nav>\\n    <ul>\\n        {#each nav as navItem}\\n            <li class=\\\"radius-big overflow-hidden\\\">\\n                <a rel=prefetch href={navItem.href}>\\n                    <ListNavigationItem\\n                        active='{segment === navItem.segment}'\\n                        value={navItem.label}\\n                    />\\n                </a>\\n            </li>\\n        {/each}\\n    </ul>\\n</nav>\\n\\n<style>\\nnav ul {\\n    display: grid;\\n    grid-auto-flow: column;\\n    grid-auto-columns: 1fr;\\n    grid-template-rows: 155px;\\n    grid-gap: 10px;\\n    -webkit-box-align: stretch;\\n        -ms-flex-align: stretch;\\n            align-items: stretch;\\n    -webkit-box-pack: stretch;\\n        -ms-flex-pack: stretch;\\n            justify-content: stretch;\\n}\\n\\nnav li, nav li a {\\n    -webkit-box-flex: 1;\\n        -ms-flex-positive: 1;\\n            flex-grow: 1;\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    -ms-flex-item-align: stretch;\\n        align-self: stretch;\\n    -webkit-box-align: stretch;\\n        -ms-flex-align: stretch;\\n            align-items: stretch;\\n    -webkit-box-pack: stretch;\\n        -ms-flex-pack: stretch;\\n            justify-content: stretch;\\n    overflow: hidden;\\n}\\n\\nli a:hover {\\n    background-color: rgba(var(--color-black), .1);\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAmCA,iBAAG,CAAC,EAAE,cAAC,CAAC,AACJ,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,iBAAiB,CAAE,GAAG,CACtB,kBAAkB,CAAE,KAAK,CACzB,QAAQ,CAAE,IAAI,CACd,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,iBAAG,CAAC,gBAAE,CAAE,iBAAG,CAAC,EAAE,CAAC,CAAC,cAAC,CAAC,AACd,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,CAChC,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,gBAAE,CAAC,eAAC,MAAM,AAAC,CAAC,AACR,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,EAAE,CAAC,AAClD,CAAC\"}"
};

const ListNavigation = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { segment } = $$props;
	...
	return `<nav class="${"svelte-wcqcr1"}"><ul class="${"svelte-wcqcr1"}">${each(nav, navItem => `<li class="${"radius-big overflow-hidden svelte-wcqcr1"}"><a rel="${"prefetch"}"${add_attribute("href", navItem.href, 0)} class="${"svelte-wcqcr1"}">${validate_component(ListNavigationItem, "ListNavigationItem").$$render(
		$$result,
		{
			active: segment === navItem.segment,
			value: navItem.label
...
var route_6 = /*#__PURE__*/Object.freeze({
    ...
    ListNavigationItem: ListNavigationItem
});

/* src/routes/index.svelte generated by Svelte v3.24.0 */

const css$K = {
	code: ".top-pic.svelte-sih8e{-webkit-box-flex:0;-ms-flex:none;flex:none;z-index:0;width:100%;height:200px;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;border-radius:0}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script>\\n    import {\\n        Br,\\n        Footer,\\n        Divider,\\n        Comments,\\n        Progress,\\n        Carousel,\\n        ContentHolder,\\n        TitleSubTitle,\\n        ListOfFeatures,\\n    } from '@components'\\n</script>\\n\\n<style>\\n.top-pic {\\n    -webkit-box-flex: 0;\\n        -ms-flex: none;\\n            flex: none;\\n    z-index: 0;\\n    width: 100%;\\n    height: 200px;\\n    display: -webkit-box;\\n    display: -ms-flexbox;\\n    display: flex;\\n    overflow: hidden;\\n    border-radius: 0;\\n}</style>\\n\\n<svelte:head>\\n    <title>Charitify - list of charities you can donate.</title>\\n</svelte:head>\\n\\n<section>\\n    <Br size=\\\"var(--header-height)\\\"/>\\n\\n    <div class=\\\"top-pic\\\">\\n        <Carousel/>\\n    </div>\\n\\n    <Progress borderRadius=\\\"0 0 8px 8px\\\" value=\\\"30\\\"/>\\n\\n    <p>These guys rise a pound of vegetables. They like vegetables and long text under photos.</p>\\n\\n    <br>\\n    <br>\\n    <br>\\n    <br>\\n    <br>\\n    <section class=\\\"container\\\">\\n\\n        <TitleSubTitle\\n                title=\\\"Charitify\\\"\\n                subtitle=\\\"Charity application for helping those in need\\\"\\n        />\\n\\n        <br>\\n        <br>\\n        <br>\\n        <br>\\n        <br>\\n\\n        <ContentHolder/>\\n\\n        <br>\\n        <br>\\n        <br>\\n        <br>\\n        <br>\\n\\n        <Divider size=\\\"16\\\"/>\\n        <h3 class=\\\"h2 text-right\\\">Comments:</h3>\\n        <Divider size=\\\"20\\\"/>\\n\\n        <Comments withForm={false}/>\\n\\n            <br>\\n            <br>\\n            <br>\\n            <br>\\n            <br>\\n\\n            <ContentHolder/>\\n\\n            <br>\\n            <br>\\n            <br>\\n            <br>\\n            <br>\\n\\n            <ListOfFeatures/>\\n    </section>\\n\\n    <br>\\n    <br>\\n    <br>\\n    <br>\\n    <br>\\n\\n    <Footer/>\\n\\n</section>\\n\"],\"names\":[],\"mappings\":\"AAeA,QAAQ,aAAC,CAAC,AACN,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,CAAC,CACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,CAAC,AACpB,CAAC\"}"
};
...
<section>${validate_component(Br, "Br").$$render($$result, { size: "var(--header-height)" }, {}, {})}

    <div class="${"top-pic svelte-sih8e"}">${validate_component(Carousel, "Carousel").$$render($$result, {}, {}, {})}</div>
    ...
    <br>
    <br>
    <section class="${"container"}">${validate_component(TitleSubTitle, "TitleSubTitle").$$render(
		$$result,
		{
			title: "Charitify",
			subtitle: "Charity application for helping those in need"
        ...
        ${validate_component(Comments, "Comments").$$render($$result, { withForm: false }, {}, {})}
            ...
            ${validate_component(ListOfFeatures, "ListOfFeatures").$$render($$result, {}, {}, {})}</section>
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main id="${"main"}"${add_attribute("class", classProp, 0)}>${validate_component(Header, "Header").$$render($$result, { segment }, {}, {})}

	<section class="${"pages"}">${$$slots.default ? $$slots.default({}) : ``}</section>

	${validate_component(OfflineMessage, "OfflineMessage").$$render($$result, {}, {}, {})}</main>`;
});
...
<br>
<br>
<div class="${"text-center"}"><h1>ой 🙃</h1></div>
<div hidden class="${"text-center"}"><h1>Error: ${escape(status)}</h1>
	<br>
	<p>Reason: ${escape(error.message)}</p></div>
<br>
<br>`;
});
...
const components = [
	...
	{
		js: () => Promise.resolve().then(function () { return _id_; }),
		css: "__SAPPER_CSS_PLACEHOLDER:organizations/[id].svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return _id_$1; }),
		css: "__SAPPER_CSS_PLACEHOLDER:funds/[id].svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return _layout; }),
		css: "__SAPPER_CSS_PLACEHOLDER:lists/_layout.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return index$1; }),
		css: "__SAPPER_CSS_PLACEHOLDER:lists/index.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return organizations$1; }),
		css: "__SAPPER_CSS_PLACEHOLDER:lists/organizations.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return funds; }),
		css: "__SAPPER_CSS_PLACEHOLDER:lists/funds.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return index$2; }),
		css: "__SAPPER_CSS_PLACEHOLDER:users/index.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return me; }),
		css: "__SAPPER_CSS_PLACEHOLDER:users/me.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return _id_$2; }),
		css: "__SAPPER_CSS_PLACEHOLDER:users/[id].svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return index$3; }),
		css: "__SAPPER_CSS_PLACEHOLDER:map/index.svelte__"
	},
	{
		js: () => Promise.resolve().then(function () { return _id_$3; }),
		css: "__SAPPER_CSS_PLACEHOLDER:map/[id].svelte__"
	}
];
...
<section class="${"container theme-bg-color-secondary"}">${validate_component(Br, "Br").$$render($$result, { size: "var(--header-height)" }, {}, {})}

    <div class="${"overflow-hidden"}">${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}
        ${validate_component(Button, "Button").$$render($$result, { size: "small", is: "info" }, {}, {
		default: () => `<span class="${"h3 font-secondary font-w-500 flex flex-align-center"}">${escape( "Редагувати")}
                <s></s>
                <s></s>
                ${ `${validate_component(Icon, "Icon").$$render($$result, { type: "edit", size: "small", is: "light" }, {}, {})}`
		}</span>`
	})}
        ${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}</div>

    
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.topInfo }, {}, {
		default: () => `${validate_component(OrganizationButton$1, "OrganizationButtonEdit").$$render(
			$$result,
			{
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render(
		...
		{},
		{
			default: () => `${validate_component(EditArea, "EditArea").$$render($$result, { off: !isEditMode }, {}, {
				default: () => `${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.description }, {}, {
		default: () => `${validate_component(Description$1, "DescriptionEdit").$$render(
			$$result,
			{
				data: {
					...descriptionShort,
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(InteractionIndicators, "InteractionIndicators").$$render(
			$$result,
			{
				likes: iconsLine.likes,
				views: iconsLine.views,
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.about }, {}, {
		default: () => `${validate_component(About, "AboutEdit").$$render(
			$$result,
			{
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(Share, "Share").$$render($$result, {}, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "50" }, {}, {})}
        ${validate_component(Trust, "Trust").$$render($$result, { active: organization.isLiked }, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "50" }, {}, {})}
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.documents }, {}, {
		default: () => `${validate_component(Documents$1, "DocumentsEdit").$$render(
			$$result,
			{
				data: { documents },
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.videos }, {}, {
		default: () => `${validate_component(Videos$1, "VideosEdit").$$render(
			$$result,
			{
				data: { videos: media },
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render(
		...
		{
			default: () => `${validate_component(EditArea, "EditArea").$$render($$result, { off: !isEditMode }, {}, {
				default: () => `${validate_component(Br, "Br").$$render($$result, { size: "15" }, {}, {})}
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.contacts }, {}, {
		default: () => `${validate_component(Contacts, "ContactsEdit").$$render(
			$$result,
			{
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.map }, {}, {
		default: () => `${validate_component(Map$3, "MapEdit").$$render(
			$$result,
			{
				data: { location },
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(Comments_1, "Comments").$$render($$result, { items: commentsData.comments }, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "40" }, {}, {})}`
	})}

    <div class="${"full-container"}">${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</div></section>`;
});
...
<section class="${"container theme-bg-color-secondary"}">${validate_component(Br, "Br").$$render($$result, { size: "var(--header-height)" }, {}, {})}
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(InteractionIndicators$1, "InteractionIndicators").$$render(
			$$result,
			{
				likes: iconsLine.likes,
				views: iconsLine.views
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.description }, {}, {
		default: () => `${validate_component(Description$4, "DescriptionEdit").$$render(
			$$result,
			{
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(Share$1, "Share").$$render($$result, {}, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "45" }, {}, {})}
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.animalCard }, {}, {
		default: () => `${validate_component(AnimalCard$1, "AnimalCardEdit").$$render(
			$$result,
			{
				data: animal,
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "60" }, {}, {})}
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(Donators$1, "Donators").$$render($$result, { items: donators }, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "60" }, {}, {})}`
	})}

    
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.documents }, {}, {
		default: () => `${validate_component(Documents$3, "DocumentsEdit").$$render(
			$$result,
			{
				data: { documents },
				submit: onSubmit.bind(null, "documents")
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.videos }, {}, {
		default: () => `${validate_component(Videos$2, "VideosEdit").$$render(
			$$result,
			{
				data: { videos: media },
				submit: onSubmit.bind(null, "videos")
    ...
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: isEdit.howToHelp }, {}, {
		default: () => `${validate_component(HowToHelp$1, "HowToHelpEdit").$$render(
			$$result,
			{
				data: howToHelp,
    ...
    ${validate_component(Br, "Br").$$render($$result, { size: "60" }, {}, {})}
    ${validate_component(LazyToggle, "LazyToggle").$$render($$result, { active: !isEditMode, mounted: true }, {}, {
		default: () => `${validate_component(Comments_1$1, "Comments").$$render($$result, { items: commentsData.comments }, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "60" }, {}, {})}`
	})}

    <div class="${"full-container"}">${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</div>
    ${validate_component(Br, "Br").$$render($$result, { size: "70" }, {}, {})}</section>`;
});
...
const css$L = {
	code: ".list-wrap.svelte-oqg9wz{-webkit-box-flex:1;-ms-flex:1 1 0px;flex:1 1 0;overflow-x:hidden;overflow-y:auto;padding:0 var(--screen-padding)}",
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Br, Footer, SearchLine } from '@components'\\n    import { ListNavigation } from './components'\\n\\n    export let segment\\n</script>\\n\\n<main class=\\\"layout list-layout theme-bg-color-secondary\\\">\\n    <section class=\\\"theme-bg container shadow-secondary\\\">\\n        <Br size=\\\"var(--header-height)\\\"/>\\n\\n        <Br size=\\\"20\\\"/>\\n        <SearchLine/>\\n        <Br size=\\\"20\\\"/>\\n    </section>\\n\\n    <section class=\\\"container\\\">\\n        <Br size=\\\"30\\\"/>\\n        <ListNavigation {segment}/>\\n\\n        <section>\\n            <Br size=\\\"30\\\"/>\\n\\n        </section>\\n    </section>\\n\\n    <Br size=\\\"60\\\"/>\\n    <h2>Мої фонди</h2>\\n\\n    <div class=\\\"list-wrap\\\">\\n        <br>\\n\\n        <slot></slot>\\n\\n        <br>\\n        <br>\\n    </div>\\n\\n    <Footer/>\\n</main>\\n\\n<style>\\n.list-wrap {\\n    -webkit-box-flex: 1;\\n        -ms-flex: 1 1 0px;\\n            flex: 1 1 0;\\n    overflow-x: hidden;\\n    overflow-y: auto;\\n    padding: 0 var(--screen-padding);\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AA0CA,UAAU,cAAC,CAAC,AACR,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CACb,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CACnB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CAAC,CAAC,IAAI,gBAAgB,CAAC,AACpC,CAAC\"}"
};
...
const Layout$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main class="${"layout list-layout theme-bg-color-secondary"}"><section class="${"theme-bg container shadow-secondary"}">${validate_component(Br, "Br").$$render($$result, { size: "var(--header-height)" }, {}, {})}

        ${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}
        ${validate_component(SearchLine, "SearchLine").$$render($$result, {}, {}, {})}
        ${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}</section>

    <section class="${"container"}">${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}
        ${validate_component(ListNavigation, "ListNavigation").$$render($$result, { segment }, {}, {})}

        <section>${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}</section></section>

    ${validate_component(Br, "Br").$$render($$result, { size: "60" }, {}, {})}
    <h2>Мої фонди</h2>

    <div class="${"list-wrap svelte-oqg9wz"}"><br>
...
var organizations$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
...
var funds = /*#__PURE__*/Object.freeze({
    __proto__: null,
    'default': Funds
});
...
const UserCardView = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"text-center flex flex-column flex-align-center"}"><span>${validate_component(FancyBox, "FancyBox").$$render($$result, { class: "flex-justify-center" }, {}, {
		box: () => `<section slot="${"box"}" class="${"flex full-width full-height"}" style="${"height: 100vw"}"><div class="${"flex flex-self-stretch flex-1 overflow-hidden flex-justify-stretch"}" style="${"padding: var(--screen-padding) 0"}">${validate_component(Avatar, "Avatar").$$render($$result, { src, srcBig, alt: "ava" }, {}, {})}</div></section>`,
		default: () => `${validate_component(Avatar, "Avatar").$$render($$result, { size: "big", src, alt: "Організація" }, {}, {})}
            `
	})}</span>
...
const Me = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"container theme-bg-color-secondary"}">${validate_component(Br, "Br").$$render($$result, { size: "var(--header-height)" }, {}, {})}
    ${validate_component(Br, "Br").$$render($$result, { size: "35" }, {}, {})}
    ...
    <div class="${"full-container"}">${validate_component(EditArea, "EditArea").$$render($$result, {}, {}, {
		default: () => `${validate_component(Br, "Br").$$render($$result, { size: "40" }, {}, {})}
            <h1>Мої організації</h1>
            ${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}
            <div class="${"full-container"}">${validate_component(FundCards, "FundCards").$$render($$result, { items: animalFunds }, {}, {
			button: ({ id }) => `<div slot="${"button"}">${validate_component(Button, "Button").$$render($$result, { size: "small", is: "info", href: id }, {}, {
				default: () => `<span class="${"h3 font-secondary font-w-500 flex flex-align-center"}">Редагувати
                                <s></s>
                                <s></s>
                                ${validate_component(Icon, "Icon").$$render($$result, { type: "edit", size: "small", is: "light" }, {}, {})}</span>`
			...
			default: () => `<span class="${"h2 font-secondary font-w-600"}">Додати
                </span>`
		})}
            ${validate_component(Br, "Br").$$render($$result, { size: "40" }, {}, {})}`
	})}</div>
    ...
    <h1>Мої фонди</h1>
    ${validate_component(Br, "Br").$$render($$result, { size: "5" }, {}, {})}
    <div class="${"full-container"}">${validate_component(FundCards, "FundCards").$$render($$result, { items: othersFunds }, {}, {
		button: ({ id }) => `<div slot="${"button"}">${validate_component(Button, "Button").$$render($$result, { size: "small", is: "info", href: id }, {}, {
			default: () => `<span class="${"h3 font-secondary font-w-500 flex flex-align-center"}">Редагувати
                        <s></s>
                        <s></s>
...
/* src/routes/users/[id].svelte generated by Svelte v3.24.0 */
...
${validate_component(Map$2, "Map").$$render($$result, {}, {}, {
		default: () => `${each(organizations, o => `${validate_component(MapMarker, "MapMarker").$$render($$result, { lat: o.location.lat, lng: o.location.lng }, {}, {})}`)}`
	})}`;
});
...
const manifest = {
	server_routes: [
		...
		{
			// lists/components/index.js
			pattern: /^\/lists\/components\/?$/,
			handlers: route_6,
			params: () => ({})
		}
	],
	...
	pages: [
...

		{
			...
			pattern: /^\/lists\/?$/,
			parts: [
				{ name: "lists__layout", file: "lists/_layout.svelte", component: Layout$1 },
