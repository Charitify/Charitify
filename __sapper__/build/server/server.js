...
const ListNavigation = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-1ogfjcb"}"><ul class="${"svelte-1ogfjcb"}">${each(nav, navItem => `<li class="${"svelte-1ogfjcb"}"><a rel="${"prefetch"}"${add_attribute("href", navItem.href, 0)} class="${["svelte-1ogfjcb", segment === navItem.segment ? "selected" : ""].join(" ").trim()}">${validate_component(ListNavigationItem, "ListNavigationItem").$$render(
		$$result,
		{
			active: segment === navItem.segment,
			value: navItem.label
...
const css$K = {
	...
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Br, Footer, SearchLine } from '@components'\\n    import { ListNavigation } from './components'\\n\\n    export let segment\\n</script>\\n\\n<main class=\\\"layout list-layout theme-bg-color-secondary\\\">\\n    <section class=\\\"theme-bg container shadow-secondary\\\">\\n        <Br size=\\\"var(--header-height)\\\"/>\\n\\n        <Br size=\\\"20\\\"/>\\n        <SearchLine/>\\n        <Br size=\\\"20\\\"/>\\n    </section>\\n\\n    <section class=\\\"container\\\">\\n        <Br size=\\\"30\\\"/>\\n        <ListNavigation {segment}/>\\n    </section>\\n\\n    <div class=\\\"list-wrap\\\">\\n        <br>\\n\\n        <slot></slot>\\n\\n        <br>\\n        <br>\\n    </div>\\n\\n    <Footer/>\\n</main>\\n\\n<style>\\n.list-wrap {\\n    -webkit-box-flex: 1;\\n        -ms-flex: 1 1 0px;\\n            flex: 1 1 0;\\n    overflow-x: hidden;\\n    overflow-y: auto;\\n    padding: 0 var(--screen-padding);\\n}</style>\\n\"],\"names\":[],\"mappings\":\"AAkCA,UAAU,cAAC,CAAC,AACR,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CACb,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CACnB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CAAC,CAAC,IAAI,gBAAgB,CAAC,AACpC,CAAC\"}"
};
...
const Layout$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <section class="${"container"}">${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}
        ${validate_component(ListNavigation, "ListNavigation").$$render($$result, { segment }, {}, {})}</section>
