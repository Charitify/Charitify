...
const css$8 = {
	code: "section.svelte-1xrj7ff.svelte-1xrj7ff{width:100%;flex-grow:1;display:flex;align-self:stretch;align-items:flex-start}div.svelte-1xrj7ff.svelte-1xrj7ff{display:flex;flex-direction:column;overflow:hidden}span.svelte-1xrj7ff.svelte-1xrj7ff{flex:none;display:flex;flex-direction:column;justify-content:center;overflow:hidden;padding:0 8px}span.svelte-1xrj7ff h4.svelte-1xrj7ff,span.svelte-1xrj7ff sub.svelte-1xrj7ff{line-height:1.4;max-width:100%;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}pre.svelte-1xrj7ff.svelte-1xrj7ff{padding:0 8px;font-size:.825em;line-height:1.2}",
...
const Comment = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${"svelte-1xrj7ff"}">
    ${validate_component(Avatar, "Avatar").$$render($$result, { src, alt: title, class: "comment-ava" }, {}, {})}

    <div class="${"svelte-1xrj7ff"}">
        <span class="${"svelte-1xrj7ff"}">
            <h4 class="${"svelte-1xrj7ff"}">${escape(title)}</h4>
            <sub class="${"svelte-1xrj7ff"}">${escape(subtitle)}</sub>
        </span>

        <br class="${"small"}">

        <pre class="${"svelte-1xrj7ff"}">
            ${$$slots.default
	? $$slots.default({})
	: `
                 [No comment]
