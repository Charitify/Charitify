...
<section class="${"container theme-bg-color-secondary"}">
    ...
    <p class="${"container flex flex-justify-between flex-align-center"}">
		...
		{}
            ...
            <s></s>
            <s></s>
            <span class="${"font-secondary font-w-600 h3"}">${escape(iconsLine.likes)}</span>
        </span>
        <span class="${"flex flex-align-center"}">
            ${validate_component(Icon, "Icon").$$render(
		$$result,
		...
		{}
            ...
            <s></s>
            <s></s>
            <span class="${"font-secondary font-w-600 h3"}">${escape(iconsLine.views)}</span>
        </span>
    </p>
    ${validate_component(Br, "Br").$$render($$result, { size: "50" }, {}, {})}
