 ...
 */
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-1q8pry0"}">
    ${titleProp
    ...
    <div class="${"inp-inner-wrap svelte-1q8pry0"}">
        ${rows || type === "textarea"
	? `<textarea${spread(
			[
				{ min: escape(min) },
	...
	: `<input${spread(
        ...
        <div class="${"inp-post-icon svelte-1q8pry0"}">
            ${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${validate_component(Icon, "Icon").$$render($$result, { type: "" }, {}, {})}
            `}
        </div>
    </div>
