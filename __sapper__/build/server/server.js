...
const Input = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	if ($$props.autocorrect === void 0 && $$bindings.autocorrect && autocorrect !== void 0) $$bindings.autocorrect(autocorrect);
	...
	let autocompleteProp = autocomplete || inputPredict.autocomplete || "on";

	return `<section class="${escape(null_to_empty(classProp)) + " svelte-1q8pry0"}">
    ${titleProp
	? `<label${add_attribute("for", idProp, 0)} class="${"inp-label h2 font-secondary font-w-500 text-left"}">
            ${escape(titleProp)}
	...
	? `<textarea${spread(
			[
				...
				{ autocorrect: escape(autocorrect) },
				{ id: escape(idProp) },
				{ class: "inp-inner" },
...
const css$j = {
	code: ".social-icons.svelte-1pajzhd li.svelte-1pajzhd{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;border-radius:50%;overflow:hidden;margin:7px 0}.social-icons.svelte-1pajzhd .inner.svelte-1pajzhd{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:26px;height:26px}",
	map: "{\"version\":3,\"file\":\"SocialsY.svelte\",\"sources\":[\"SocialsY.svelte\"],\"sourcesContent\":[\"\\n<script>\\n    import Icon from '../Icon.svelte'\\n    import Loader from '../Loader/Loader.svelte'\\n\\n    /**\\n     * @type {{\\n     *  href: string,\\n     *  title: string,\\n     *  type: Config.Icons,\\n     * }[]}\\n     */\\n    export let items\\n\\n    $: list = items === null ? [null, null, null] : items || []\\n</script>\\n\\n<ul class=\\\"social-icons\\\">\\n    {#each list as item}\\n        <li>\\n            {#if item !== null}\\n                <slot {item}>\\n                    {#if item.href}\\n                        <a href={item.href} target=\\\"_blank\\\" class=\\\"inner\\\" title={item.title}>\\n                            <Icon type={item.type} size=\\\"tiny\\\"/>\\n                            <s></s>\\n                            <s></s>\\n                            <s></s>\\n                            <p class=\\\"h3\\\">{item.title}</p>\\n                        </a>\\n                    {:else}\\n                        <div on:click class=\\\"inner\\\" title={item.title}>\\n                            <Icon type={item.type} size=\\\"tiny\\\"/>\\n                            <s></s>\\n                            <s></s>\\n                            <s></s>\\n                            <p class=\\\"h3\\\">{item.title}</p>\\n                        </div>\\n                    {/if}\\n                </slot>\\n            {:else}\\n                <span class=\\\"flex flex-align-center\\\" style=\\\"padding: 7px 0\\\">\\n                    <Loader type=\\\"h3\\\"/>\\n                </span>\\n            {/if}\\n        </li>\\n    {/each}\\n</ul>\\n\\n<style>\\n    .social-icons li {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        margin: 7px 0;\\n    }\\n\\n    .social-icons .inner {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        width: 26px;\\n        height: 26px;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAkDI,4BAAa,CAAC,EAAE,eAAC,CAAC,AACd,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,MAAM,CAAE,GAAG,CAAC,CAAC,AACjB,CAAC,AAED,4BAAa,CAAC,MAAM,eAAC,CAAC,AAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC\"}"
};
...
const SocialsY = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"social-icons svelte-1pajzhd"}">
    ${each(list, item => `<li class="${"svelte-1pajzhd"}">
            ${item !== null
	? `${$$slots.default
		? $$slots.default({ item })
		: `
                    ${item.href
			? `<a${add_attribute("href", item.href, 0)} target="${"_blank"}" class="${"inner svelte-1pajzhd"}"${add_attribute("title", item.title, 0)}>
			...
			: `<div class="${"inner svelte-1pajzhd"}"${add_attribute("title", item.title, 0)}>
                            ${validate_component(Icon, "Icon").$$render($$result, { type: item.type, size: "tiny" }, {}, {})}
                            <s></s>
                            <s></s>
                            <s></s>
