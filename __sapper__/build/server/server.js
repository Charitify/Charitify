...
const css$3 = {
	code: ".card.svelte-1t5yign{width:100%;box-shadow:var(--shadow-secondary);border-radius:var(--border-radius-big);background-color:rgba(var(--color-white))}",
	map: "{\"version\":3,\"file\":\"Card.svelte\",\"sources\":[\"Card.svelte\"],\"sourcesContent\":[\"<script>\\n    import { classnames } from '../utils'\\n\\n    $: classProp = classnames('card', $$props.class)\\n</script>\\n\\n<section class={classProp}>\\n    <slot></slot>\\n</section>\\n\\n<style>\\n    .card {\\n        width: 100%;\\n        box-shadow: var(--shadow-secondary);\\n        border-radius: var(--border-radius-big);\\n        background-color: rgba(var(--color-white));\\n    }\\n</style>\\n\"],\"names\":[],\"mappings\":\"AAWI,KAAK,eAAC,CAAC,AACH,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,aAAa,CAAE,IAAI,mBAAmB,CAAC,CACvC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC9C,CAAC\"}"
};
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-1t5yign"}">
    ${$$slots.default ? $$slots.default({}) : ``}
</section>`;
});
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul aria-label="${"carousel"}" class="${"scroll-center svelte-1jfh9aa"}">
	...
	? `${validate_component(Card, "Card").$$render($$result, {}, {}, {
        ...
        <ul class="${"svelte-17ncppz"}">
			...
			? `<li class="${"svelte-17ncppz"}">
                        ${validate_component(Avatar, "Avatar").$$render($$result, { src: item.src, size: "medium" }, {}, {})}
                        <s></s>
                        <s></s>
                        <s></s>
                        <s></s>
...
const DonatorsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"scroll-center svelte-1nvgbbo"}">
