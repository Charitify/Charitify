...
const css$b = {
	code: ".carousel.rounded.svelte-1lj17mg.svelte-1lj17mg>.carousel-inner.svelte-1lj17mg.svelte-1lj17mg{border-radius:var(--border-radius-big)}.carousel.svelte-1lj17mg.svelte-1lj17mg.svelte-1lj17mg,.carousel-inner.svelte-1lj17mg.svelte-1lj17mg.svelte-1lj17mg,.carousel-inner.svelte-1lj17mg.svelte-1lj17mg>li.svelte-1lj17mg.svelte-1lj17mg{position:relative;-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;text-align:left;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}.carousel.dotsBelow.svelte-1lj17mg.svelte-1lj17mg.svelte-1lj17mg{padding-bottom:40px}.carousel.dotsBelow.svelte-1lj17mg.svelte-1lj17mg .carousel-dots.svelte-1lj17mg.svelte-1lj17mg{bottom:0}.carousel.dotsBelow.svelte-1lj17mg.svelte-1lj17mg .carousel-dots li.svelte-1lj17mg.svelte-1lj17mg{background-color:rgba(var(--theme-bg-color-opposite))}.carousel.stretch.svelte-1lj17mg>.carousel-inner.svelte-1lj17mg>.fluid.svelte-1lj17mg{-webkit-box-flex:0;-ms-flex:none;flex:none;width:100%}.carousel.auto.svelte-1lj17mg>.carousel-inner.svelte-1lj17mg>.fluid.svelte-1lj17mg{width:auto}.carousel.svelte-1lj17mg.svelte-1lj17mg.svelte-1lj17mg{width:100%}.carousel-inner.svelte-1lj17mg.svelte-1lj17mg.svelte-1lj17mg::-webkit-scrollbar{display:none}.carousel.svelte-1lj17mg.svelte-1lj17mg>.carousel-inner.svelte-1lj17mg.svelte-1lj17mg{width:100%;overflow-y:hidden;overflow-x:scroll;background-color:rgba(var(--color-black), .04)}.carousel-dots.svelte-1lj17mg.svelte-1lj17mg.svelte-1lj17mg{position:absolute;left:0;bottom:10px;width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;justify-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-1lj17mg.svelte-1lj17mg li.svelte-1lj17mg.svelte-1lj17mg{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;-webkit-box-shadow:var(--shadow-primary);box-shadow:var(--shadow-primary);background-color:rgba(var(--color-light))}.carousel-dots.svelte-1lj17mg.svelte-1lj17mg li.svelte-1lj17mg.svelte-1lj17mg:not(.active){opacity:.5}.carousel-dots.svelte-1lj17mg.svelte-1lj17mg li.active.svelte-1lj17mg.svelte-1lj17mg{-webkit-transform:scale(1.5);transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil, classnames } from '@utils'\\n    import Picture from '@components/Picture.svelte'\\n    import FancyBox from '@components/FancyBox.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let dotsBelow = true\\n    export let rounded = true\\n    export let size = 'stretch'\\n    export let initIndex = 0\\n    export let disableFancy = false\\n    export let stopPropagation = undefined\\n\\n    let parent = null\\n\\n    $: activeDot = initIndex\\n    $: classProp = classnames('carousel', size, $$props.class, { dotsBelow, rounded })\\n    $: setScrollPosition(parent, initIndex)\\n\\n    function carousel(node) {\\n        node.ontouchstart = e => stopPropagation && (e.stopPropagation())\\n        node.ontouchmove = e => stopPropagation && (e.stopPropagation())\\n        node.ontouchend = e => stopPropagation && (e.stopPropagation())\\n\\n        parent = node\\n        setScrollPosition(node, activeDot)\\n        node.addEventListener('scroll', onScroll)\\n        return { \\n            destroy: () => {\\n                node.removeEventListener('scroll', onScroll)\\n                node.ontouchstart= null\\n                node.ontouchmove= null\\n                node.ontouchend= null\\n            }\\n        }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft, scrollWidth, offsetWidth } = parent\\n        const dotAmount = Array.from(parent.children).length\\n        const scrollX = scrollLeft / (scrollWidth - offsetWidth)\\n        const newActiveDot = Math.round(scrollX * (dotAmount - 1))\\n        if (activeDot !== newActiveDot && !isNaN(newActiveDot)) activeDot = newActiveDot\\n    }\\n\\n    function setScrollPosition(parent, activeDot) {\\n        if (!parent) return\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = Math.round(width * activeDot)\\n            if (parent.scrollLeft !== Math.round(width * activeDot)) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class={classProp}>\\n    <ul \\n        use:carousel\\n        class=\\\"carousel-inner scroll-x-center\\\"\\n    >\\n        {#each items as item, index}\\n            <li class=\\\"fluid\\\" role=\\\"button\\\" on:click={onClick.bind(null, item, index)}>\\n                <slot {item} {index}>\\n                    <FancyBox disabled={disableFancy}>\\n                        <Picture key=\\\"picture\\\" {...item} alt={item.alt || 'Фото слайду'}/>\\n                        <section slot=\\\"box\\\" class=\\\"flex full-width\\\">\\n                            <Picture key=\\\"picture\\\" {...item} alt={item.alt || 'Фото слайду'}/>\\n                        </section>\\n                    </FancyBox>\\n                </slot>\\n            </li>\\n        {/each}\\n    </ul>\\n\\n\\n    {#if dots}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel.rounded > .carousel-inner {\\n       border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel, .carousel-inner, .carousel-inner > li {\\n        position: relative;\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        text-align: left;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    .carousel.dotsBelow {\\n        padding-bottom: 40px;\\n    }\\n\\n    .carousel.dotsBelow .carousel-dots {\\n        bottom: 0;\\n    }\\n\\n    .carousel.dotsBelow .carousel-dots li {\\n        background-color: rgba(var(--theme-bg-color-opposite));\\n    }\\n\\n    .carousel.stretch > .carousel-inner > .fluid {\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        width: 100%;\\n    }\\n\\n    .carousel.auto > .carousel-inner > .fluid {\\n        width: auto;\\n    }\\n\\n    .carousel {\\n        width: 100%;\\n    }\\n\\n    .carousel-inner::-webkit-scrollbar {\\n        display: none;\\n    }\\n\\n    .carousel > .carousel-inner {\\n        width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n        background-color: rgba(var(--color-black), .04);\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        left: 0;\\n        bottom: 10px;\\n        width: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        justify-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        -webkit-box-shadow: var(--shadow-primary);\\n                box-shadow: var(--shadow-primary);\\n        background-color: rgba(var(--color-light));\\n    }\\n\\n    .carousel-dots li:not(.active) {\\n        opacity: .5;\\n    }\\n\\n    .carousel-dots li.active {\\n        -webkit-transform: scale(1.5);\\n                transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAgHI,SAAS,sCAAQ,CAAG,eAAe,8BAAC,CAAC,AAClC,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC1C,CAAC,AAED,sDAAS,CAAE,4DAAe,CAAE,6CAAe,CAAG,EAAE,8BAAC,CAAC,AAC9C,QAAQ,CAAE,QAAQ,CAClB,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,IAAI,CAChB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,SAAS,UAAU,6CAAC,CAAC,AACjB,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,SAAS,wCAAU,CAAC,cAAc,8BAAC,CAAC,AAChC,MAAM,CAAE,CAAC,AACb,CAAC,AAED,SAAS,wCAAU,CAAC,cAAc,CAAC,EAAE,8BAAC,CAAC,AACnC,gBAAgB,CAAE,KAAK,IAAI,yBAAyB,CAAC,CAAC,AAC1D,CAAC,AAED,SAAS,uBAAQ,CAAG,8BAAe,CAAG,MAAM,eAAC,CAAC,AAC1C,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,oBAAK,CAAG,8BAAe,CAAG,MAAM,eAAC,CAAC,AACvC,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,6CAAC,CAAC,AACP,KAAK,CAAE,IAAI,AACf,CAAC,AAED,4DAAe,mBAAmB,AAAC,CAAC,AAChC,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,uCAAS,CAAG,eAAe,8BAAC,CAAC,AACzB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAED,cAAc,6CAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,aAAa,CAAE,MAAM,CACrB,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,4CAAc,CAAC,EAAE,8BAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,kBAAkB,CAAE,IAAI,gBAAgB,CAAC,CACjC,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC9C,CAAC,AAED,4CAAc,CAAC,gCAAE,KAAK,OAAO,CAAC,AAAC,CAAC,AAC5B,OAAO,CAAE,EAAE,AACf,CAAC,AAED,4CAAc,CAAC,EAAE,OAAO,8BAAC,CAAC,AACtB,iBAAiB,CAAE,MAAM,GAAG,CAAC,CACrB,SAAS,CAAE,MAAM,GAAG,CAAC,AACjC,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${escape(null_to_empty(classProp)) + " svelte-1lj17mg"}">
    <ul class="${"carousel-inner scroll-x-center svelte-1lj17mg"}">
        ${each(items, (item, index) => `<li class="${"fluid svelte-1lj17mg"}" role="${"button"}">
                ${$$slots.default
    ...
    ${dots
	? `<ul class="${"carousel-dots svelte-1lj17mg"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-1lj17mg"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
