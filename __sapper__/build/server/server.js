...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"theme-bg container svelte-cfuz0d"}">
    <ul>
        <li><a rel="${"prefetch"}" href="${"."}" class="${["svelte-cfuz0d", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
        <li><a href="${"map"}" class="${["svelte-cfuz0d", segment === "map" ? "selected" : ""].join(" ").trim()}">map</a></li>
        <li><a rel="${"prefetch"}" href="${"lists/charities"}" class="${["svelte-cfuz0d", segment === "lists" ? "selected" : ""].join(" ").trim()}">lists</a></li>
        <li><a rel="${"prefetch"}" href="${"charity"}" class="${["svelte-cfuz0d", segment === "charity" ? "selected" : ""].join(" ").trim()}">charity</a></li>
        <li><a rel="${"prefetch"}" href="${"organization"}" class="${["svelte-cfuz0d", segment === "organization" ? "selected" : ""].join(" ").trim()}">org</a></li>
    </ul>

    <ul class="${"nav-actions svelte-cfuz0d"}">
        <li class="${"svelte-cfuz0d"}">
            <select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-cfuz0d"}">
                <option value="${"ua"}">Ua</option>
                <option value="${"ru"}">Ru</option>
                <option value="${"en"}">En</option>
            </select>
...
${validate_component(ListsLayout, "ListsLayout").$$render($$result, {}, {}, {
		default: () => `
    ${validate_component(ListItems, "ListItems").$$render($$result, { items: chariries }, {}, {})}
`
	})}`;
});
