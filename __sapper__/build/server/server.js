...
const css$a = {
	code: ".carousel.svelte-1ejioxj.svelte-1ejioxj{position:relative;overflow:hidden;border-radius:var(--border-radius-big)}.carousel.svelte-1ejioxj.svelte-1ejioxj,.carousel-inner.svelte-1ejioxj.svelte-1ejioxj,.carousel-inner.svelte-1ejioxj li.svelte-1ejioxj,button.svelte-1ejioxj.svelte-1ejioxj{position:relative;width:100%;flex:none;display:flex;overflow:hidden;align-self:stretch;align-items:stretch;justify-content:stretch}.carousel-inner.svelte-1ejioxj.svelte-1ejioxj::-webkit-scrollbar{display:none}.carousel.svelte-1ejioxj .carousel-inner.svelte-1ejioxj{overflow-y:hidden;overflow-x:scroll;white-space:nowrap}.carousel-dots.svelte-1ejioxj.svelte-1ejioxj{position:absolute;top:0;left:0;width:100%;display:flex;align-items:center;justify-items:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-1ejioxj li.svelte-1ejioxj{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;background-color:rgba(var(--color-white));box-shadow:var(--shadow-primary)\n    }li.active.svelte-1ejioxj.svelte-1ejioxj{transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil } from '../utils'\\n    import Picture from './Picture.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let initIndex = 0\\n\\n    $: activeDot = initIndex\\n\\n    function carousel(node) {\\n        initScrollPosition(node)\\n        node.addEventListener('scroll', onScroll)\\n        return { destroy: () => node.removeEventListener('scroll', onScroll) }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft } = parent\\n        const { width } = parent.getBoundingClientRect()\\n        const newActiveDot = Math.round(scrollLeft / width)\\n        if (activeDot !== newActiveDot) activeDot = newActiveDot\\n    }\\n\\n    function initScrollPosition(parent) {\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = width * activeDot\\n            if (parent.scrollLeft !== width * activeDot) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class=\\\"carousel\\\">\\n    <ul use:carousel class=\\\"carousel-inner scroll-x-center\\\">\\n        {#each items as item, i}\\n            <li>\\n                <button type=\\\"button\\\" on:click={onClick.bind(null, item, i)}>\\n                    <slot {item}>\\n                        <Picture {...item}/>\\n                    </slot>\\n                </button>\\n            </li>\\n        {/each}\\n    </ul>\\n\\n\\n    {#if dots}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel {\\n        position: relative;\\n        overflow: hidden;\\n        border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel, .carousel-inner, .carousel-inner li, button {\\n        position: relative;\\n        width: 100%;\\n        flex: none;\\n        display: flex;\\n        overflow: hidden;\\n        align-self: stretch;\\n        align-items: stretch;\\n        justify-content: stretch;\\n    }\\n\\n    .carousel-inner::-webkit-scrollbar {\\n        display: none;\\n    }\\n\\n    .carousel .carousel-inner {\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n        white-space: nowrap;\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        display: flex;\\n        align-items: center;\\n        justify-items: center;\\n        justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        background-color: rgba(var(--color-white));\\n        box-shadow: var(--shadow-primary)\\n    }\\n\\n    li.active {\\n        transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAkFI,SAAS,8BAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC3C,CAAC,AAED,uCAAS,CAAE,6CAAe,CAAE,8BAAe,CAAC,iBAAE,CAAE,MAAM,8BAAC,CAAC,AACpD,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CACpB,eAAe,CAAE,OAAO,AAC5B,CAAC,AAED,6CAAe,mBAAmB,AAAC,CAAC,AAChC,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,wBAAS,CAAC,eAAe,eAAC,CAAC,AACvB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,AACvB,CAAC,AAED,cAAc,8BAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,MAAM,CACrB,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,6BAAc,CAAC,EAAE,eAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAC1C,UAAU,CAAE,IAAI,gBAAgB,CAAC;IACrC,CAAC,AAED,EAAE,OAAO,8BAAC,CAAC,AACP,SAAS,CAAE,MAAM,GAAG,CAAC,AACzB,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${"carousel svelte-1ejioxj"}">
    <ul class="${"carousel-inner scroll-x-center svelte-1ejioxj"}">
        ${each(items, (item, i) => `<li class="${"svelte-1ejioxj"}">
                <button type="${"button"}" class="${"svelte-1ejioxj"}">
                    ${$$slots.default
	? $$slots.default({ item })
	: `
    ...
    ${dots
	? `<ul class="${"carousel-dots svelte-1ejioxj"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-1ejioxj"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
...
const css$b = {
	code: ".fancy-box.svelte-14dvdvf{width:100%;flex:none;display:flex;overflow:hidden;align-self:stretch;align-items:stretch;justify-content:stretch}.fancy-box-ghost.svelte-14dvdvf{z-index:10;position:fixed;top:0;left:0;width:100%;height:100%;display:flex;overflow:hidden;align-items:center;justify-content:center;padding:var(--screen-padding);background-color:rgba(var(--color-black), 0);-webkit-animation:svelte-14dvdvf-fadeInBox .2s ease-in-out forwards;animation:svelte-14dvdvf-fadeInBox .2s ease-in-out forwards}@-webkit-keyframes svelte-14dvdvf-fadeInBox{to{background-color:rgba(var(--color-black), .75)}}@keyframes svelte-14dvdvf-fadeInBox{to{background-color:rgba(var(--color-black), .75)}}",
	map: "{\"version\":3,\"file\":\"FancyBox.svelte\",\"sources\":[\"FancyBox.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    let active = false\\n    function onClick(e) {\\n        active = !active\\n\\n        if (!active)\\n          dispatch('close', e)\\n        else\\n          dispatch('open', e)\\n    }\\n</script>\\n\\n<section role=\\\"button\\\" class=\\\"fancy-box\\\" on:click={onClick}>\\n    <slot></slot>\\n</section>\\n\\n{#if active}\\n    <button type=\\\"button\\\" class=\\\"fancy-box-ghost\\\" on:click={onClick}>\\n        <slot name=\\\"box\\\"></slot>\\n    </button>\\n{/if}\\n\\n<style>\\n    .fancy-box {\\n        width: 100%;\\n        flex: none;\\n        display: flex;\\n        overflow: hidden;\\n        align-self: stretch;\\n        align-items: stretch;\\n        justify-content: stretch;\\n    }\\n\\n    .fancy-box-ghost {\\n        z-index: 10;\\n        position: fixed;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        height: 100%;\\n        display: flex;\\n        overflow: hidden;\\n        align-items: center;\\n        justify-content: center;\\n        padding: var(--screen-padding);\\n        background-color: rgba(var(--color-black), 0);\\n        -webkit-animation: fadeInBox .2s ease-in-out forwards;\\n                animation: fadeInBox .2s ease-in-out forwards;\\n    }\\n\\n    @-webkit-keyframes fadeInBox {\\n        to {\\n            background-color: rgba(var(--color-black), .75);\\n        }\\n    }\\n\\n    @keyframes fadeInBox {\\n        to {\\n            background-color: rgba(var(--color-black), .75);\\n        }\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AA2BI,UAAU,eAAC,CAAC,AACR,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CACpB,eAAe,CAAE,OAAO,AAC5B,CAAC,AAED,gBAAgB,eAAC,CAAC,AACd,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAC9B,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,CAAC,CAC7C,iBAAiB,CAAE,wBAAS,CAAC,GAAG,CAAC,WAAW,CAAC,QAAQ,CAC7C,SAAS,CAAE,wBAAS,CAAC,GAAG,CAAC,WAAW,CAAC,QAAQ,AACzD,CAAC,AAED,mBAAmB,wBAAU,CAAC,AAC1B,EAAE,AAAC,CAAC,AACA,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AACL,CAAC,AAED,WAAW,wBAAU,CAAC,AAClB,EAAE,AAAC,CAAC,AACA,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AACL,CAAC\"}"
};
...
const FancyBox = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section role="${"button"}" class="${"fancy-box svelte-14dvdvf"}">
    ${$$slots.default ? $$slots.default({}) : ``}
</section>
...
const css$c = {
	code: "nav.svelte-1j2jmu0.svelte-1j2jmu0{position:-webkit-sticky;position:sticky;top:0;height:50px;z-index:10;display:flex;align-items:center;color:rgba(var(--color-font-light));justify-content:space-between;box-shadow:var(--shadow-secondary);border-bottom:1px solid rgba(var(--color-danger), .1);background-color:rgba(var(--color-dark-second))}.selected.svelte-1j2jmu0.svelte-1j2jmu0{position:relative;display:inline-block}.selected.svelte-1j2jmu0.svelte-1j2jmu0::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(var(--color-danger));display:block;bottom:-1px}.nav-pages.svelte-1j2jmu0 a.svelte-1j2jmu0{padding:0.8em 0.5em}.nav-actions.svelte-1j2jmu0.svelte-1j2jmu0{display:flex;align-items:center;margin:-3px}.nav-actions.svelte-1j2jmu0 li.svelte-1j2jmu0{padding:3px}.nav-actions.svelte-1j2jmu0 a.svelte-1j2jmu0{display:block}.lang-select.svelte-1j2jmu0.svelte-1j2jmu0{padding:5px;background-color:transparent;color:rgba(var(--color-font-light))}.lang-select.svelte-1j2jmu0.svelte-1j2jmu0:hover,.lang-select.svelte-1j2jmu0.svelte-1j2jmu0:focus{box-shadow:none;background-color:rgba(var(--color-black), 0.1)}",
	map: "{\"version\":3,\"file\":\"Header.svelte\",\"sources\":[\"Header.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Icon, Button, Avatar } from '../components'\\n\\n    export let segment\\n\\n    let isDarkTheme = false\\n\\n    let value = 'ua'\\n\\n    function changeTheme() {\\n        isDarkTheme = !isDarkTheme\\n        document.body.classList.remove('theme-dark')\\n        document.body.classList.remove('theme-light')\\n        document.body.classList.add(isDarkTheme ? 'theme-dark' : 'theme-light')\\n    }\\n</script>\\n\\n<nav class=\\\"container\\\">\\n    <ul class=\\\"nav-pages flex\\\">\\n        <li><a rel=prefetch href='.' class:selected='{segment === undefined}'>home</a></li>\\n        <li><a rel=prefetch href='lists/funds' class:selected='{segment === \\\"lists\\\"}'>lists</a></li>\\n        <li><a href='map' class:selected='{segment === \\\"map\\\"}'>map</a></li>\\n    </ul>\\n\\n    <ul class=\\\"nav-actions\\\">\\n        <li>\\n            <select {value} name=\\\"lang\\\" id=\\\"lang\\\" class=\\\"btn small lang-select\\\">\\n                <option value=\\\"ua\\\">Ua</option>\\n                <option value=\\\"ru\\\">Ru</option>\\n                <option value=\\\"en\\\">En</option>\\n            </select>\\n        </li>\\n\\n        <li>\\n            <Button on:click={changeTheme} auto size=\\\"small\\\">\\n                <Icon type=\\\"moon\\\" size=\\\"medium\\\" class=\\\"theme-svg-fill-opposite\\\" is=\\\"light\\\"/>\\n            </Button>\\n        </li>\\n\\n        <li>\\n            <a class=\\\"btn small\\\" href=\\\"users/me\\\">\\n                <Avatar size=\\\"small\\\" src=\\\"https://placeimg.com/30/30/people\\\" alt=\\\"avatar\\\"/>\\n            </a>\\n        </li>\\n    </ul>\\n</nav>\\n\\n<style>\\n    nav {\\n        position: -webkit-sticky;\\n        position: sticky;\\n        top: 0;\\n        height: 50px;\\n        z-index: 10;\\n        display: flex;\\n        align-items: center;\\n        color: rgba(var(--color-font-light));\\n        justify-content: space-between;\\n        box-shadow: var(--shadow-secondary);\\n        border-bottom: 1px solid rgba(var(--color-danger), .1);\\n        background-color: rgba(var(--color-dark-second));\\n    }\\n\\n    .selected {\\n        position: relative;\\n        display: inline-block;\\n    }\\n\\n    .selected::after {\\n        position: absolute;\\n        content: \\\"\\\";\\n        width: calc(100% - 1em);\\n        height: 2px;\\n        background-color: rgb(var(--color-danger));\\n        display: block;\\n        bottom: -1px;\\n    }\\n\\n    .nav-pages a {\\n        padding: 0.8em 0.5em;\\n    }\\n\\n    .nav-actions {\\n        display: flex;\\n        align-items: center;\\n        margin: -3px;\\n    }\\n\\n    .nav-actions li {\\n        padding: 3px;\\n    }\\n\\n    .nav-actions a {\\n        display: block;\\n    }\\n\\n    .lang-select {\\n        padding: 5px;\\n        background-color: transparent;\\n        color: rgba(var(--color-font-light));\\n    }\\n\\n    .lang-select:hover,\\n    .lang-select:focus {\\n        box-shadow: none;\\n        background-color: rgba(var(--color-black), 0.1);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAgDI,GAAG,8BAAC,CAAC,AACD,QAAQ,CAAE,cAAc,CACxB,QAAQ,CAAE,MAAM,CAChB,GAAG,CAAE,CAAC,CACN,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,KAAK,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,CACpC,eAAe,CAAE,aAAa,CAC9B,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,EAAE,CAAC,CACtD,gBAAgB,CAAE,KAAK,IAAI,mBAAmB,CAAC,CAAC,AACpD,CAAC,AAED,SAAS,8BAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,YAAY,AACzB,CAAC,AAED,uCAAS,OAAO,AAAC,CAAC,AACd,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,EAAE,CACX,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,GAAG,CAAC,CACvB,MAAM,CAAE,GAAG,CACX,gBAAgB,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,CAC1C,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,yBAAU,CAAC,CAAC,eAAC,CAAC,AACV,OAAO,CAAE,KAAK,CAAC,KAAK,AACxB,CAAC,AAED,YAAY,8BAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,2BAAY,CAAC,EAAE,eAAC,CAAC,AACb,OAAO,CAAE,GAAG,AAChB,CAAC,AAED,2BAAY,CAAC,CAAC,eAAC,CAAC,AACZ,OAAO,CAAE,KAAK,AAClB,CAAC,AAED,YAAY,8BAAC,CAAC,AACV,OAAO,CAAE,GAAG,CACZ,gBAAgB,CAAE,WAAW,CAC7B,KAAK,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,AACxC,CAAC,AAED,0CAAY,MAAM,CAClB,0CAAY,MAAM,AAAC,CAAC,AAChB,UAAU,CAAE,IAAI,CAChB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC\"}"
};
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"container svelte-1j2jmu0"}">
    <ul class="${"nav-pages flex svelte-1j2jmu0"}">
        <li><a rel="${"prefetch"}" href="${"."}" class="${["svelte-1j2jmu0", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
        <li><a rel="${"prefetch"}" href="${"lists/funds"}" class="${["svelte-1j2jmu0", segment === "lists" ? "selected" : ""].join(" ").trim()}">lists</a></li>
        <li><a href="${"map"}" class="${["svelte-1j2jmu0", segment === "map" ? "selected" : ""].join(" ").trim()}">map</a></li>
    </ul>

    <ul class="${"nav-actions svelte-1j2jmu0"}">
        <li class="${"svelte-1j2jmu0"}">
            <select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-1j2jmu0"}">
                <option value="${"ua"}">Ua</option>
                <option value="${"ru"}">Ru</option>
                <option value="${"en"}">En</option>
            </select>
        ...
        <li class="${"svelte-1j2jmu0"}">
            <a class="${"btn small svelte-1j2jmu0"}" href="${"users/me"}">
...
const css$h = {
	code: ".item.svelte-39irg8{display:block;flex:1 1 auto;box-shadow:var(--shadow-primary);border-radius:var(--border-radius-small);background-color:rgba(var(--theme-bg-color))}",
	map: "{\"version\":3,\"file\":\"ListItems.svelte\",\"sources\":[\"ListItems.svelte\"],\"sourcesContent\":[\"<script>\\n    import AvatarAndName from './AvatarAndName.svelte'\\n\\n    export let items = []\\n    export let basePath = ''\\n</script>\\n\\n{#each items as item}\\n    <a class=\\\"item container\\\" href={`${basePath}/${item.id}`}>\\n        <br>\\n        <AvatarAndName\\n                src={item.org_head_avatar}\\n                title={item.org_head}\\n                subtitle={item.organization}\\n        />\\n        <br>\\n    </a>\\n    <br>\\n{:else}\\n    <section class=\\\"item container\\\">\\n        <p class=\\\"text-center\\\">No organizations</p>\\n    </section>\\n{/each}\\n\\n<style>\\n    .item {\\n        display: block;\\n        flex: 1 1 auto;\\n        box-shadow: var(--shadow-primary);\\n        border-radius: var(--border-radius-small);\\n        background-color: rgba(var(--theme-bg-color));\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAyBI,KAAK,cAAC,CAAC,AACH,OAAO,CAAE,KAAK,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACjC,aAAa,CAAE,IAAI,qBAAqB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,AACjD,CAAC\"}"
};
...
const ListItems = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${items.length
	? each(items, item => `<a class="${"item container svelte-39irg8"}"${add_attribute("href", `${basePath}/${item.id}`, 0)}>
        <br>
    ...
    <br>`)
	: `<section class="${"item container svelte-39irg8"}">
        <p class="${"text-center"}">No organizations</p>
    </section>`}`;
});
...
const css$p = {
	code: "ul.svelte-1ieio3n{position:fixed;top:50px;left:0;width:100%;flex:0;display:flex;z-index:9;padding:var(--screen-padding);transition:.3s ease-in-out;background-color:rgba(var(--theme-bg-color));box-shadow:var(--shadow-primary)}li.svelte-1ieio3n{flex:1 1 0}",
	map: "{\"version\":3,\"file\":\"DonatingGroup.svelte\",\"sources\":[\"DonatingGroup.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Button } from '../components'\\n</script>\\n\\n<ul class=\\\"active font-secondary\\\">\\n    <li>\\n        <Button is=\\\"success\\\" size=\\\"medium\\\" on:click=\\\"{e => alert('Дякую! 🥰')}\\\">Допомогти</Button>\\n    </li>\\n    <li style=\\\"flex: none\\\">\\n        <s></s>\\n        <s></s>\\n        <s></s>\\n    </li>\\n    <li>\\n        <Button is=\\\"warning\\\" size=\\\"medium\\\" on:click=\\\"{e => alert('Дякую! 🥰')}\\\">Поділитись</Button>\\n    </li>\\n</ul>\\n\\n<style>\\n    ul {\\n        position: fixed;\\n        top: 50px;\\n        left: 0;\\n        width: 100%;\\n        flex: 0;\\n        display: flex;\\n        z-index: 9;\\n        padding: var(--screen-padding);\\n        transition: .3s ease-in-out;\\n        background-color: rgba(var(--theme-bg-color));\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    li {\\n        flex: 1 1 0;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAmBI,EAAE,eAAC,CAAC,AACA,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAC9B,UAAU,CAAE,GAAG,CAAC,WAAW,CAC3B,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAC7C,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAED,EAAE,eAAC,CAAC,AACA,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,AACf,CAAC\"}"
};

const DonatingGroup = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$p);

	return `<ul class="${"active font-secondary svelte-1ieio3n"}">
    <li class="${"svelte-1ieio3n"}">
        ${validate_component(Button, "Button").$$render($$result, { is: "success", size: "medium" }, {}, { default: () => `Допомогти` })}
    </li>
    <li style="${"flex: none"}" class="${"svelte-1ieio3n"}">
        <s></s>
        <s></s>
        <s></s>
    </li>
    <li class="${"svelte-1ieio3n"}">
        ${validate_component(Button, "Button").$$render($$result, { is: "warning", size: "medium" }, {}, { default: () => `Поділитись` })}
    </li>
</ul>`;
});
...
${ `<button type="${"button"}" class="${escape(null_to_empty(classPropDonateBtn)) + " svelte-8rueh3"}">
...
<section class="${"container scroll-box theme-bg-color-secondary"}">
    ...
    ${validate_component(Card, "Card").$$render($$result, { class: "container" }, {}, {
        ...
        <h2>Життя Волтера</h2>
        <br class="${"small"}">
        <table class="${"svelte-8rueh3"}">
            <tbody>
            <tr>
                <td class="${"svelte-8rueh3"}">01.02.2019</td>
                <td class="${"svelte-8rueh3"}">—</td>
                <td class="${"svelte-8rueh3"}">Його перший день народження</td>
            </tr>
            <tr>
                <td class="${"svelte-8rueh3"}">05.02.2019</td>
                <td class="${"svelte-8rueh3"}">—</td>
                <td class="${"svelte-8rueh3"}">Ми приютили його з вулиці</td>
            </tr>
            <tr>
                <td class="${"svelte-8rueh3"}">07.03.2019</td>
                <td class="${"svelte-8rueh3"}">—</td>
                <td class="${"svelte-8rueh3"}">Зробили вакцинацію проти бліх</td>
            </tr>
            <tr>
                <td class="${"svelte-8rueh3"}">23.06.2019</td>
                <td class="${"svelte-8rueh3"}">—</td>
                <td class="${"svelte-8rueh3"}">Знайшов для себе улюблену іграшку</td>
            </tr>
            </tbody>
        </table>
