...
const css$9 = {
	code: ".fancy-box.svelte-kr9okr{position:relative;width:100%;-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}.fancy-box-ghost.svelte-kr9okr{z-index:10;position:fixed;top:0;left:0;width:100%;height:100%;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch;background-color:rgba(var(--color-black), .75);outline:20px solid rgba(var(--color-black), .75);-webkit-transition:.3s ease-out;transition:.3s ease-out;opacity:0;-webkit-transform:translate3d(0,20px,0);transform:translate3d(0,20px,0);pointer-events:none;overflow:scroll;-webkit-overflow-scrolling:touch}.fancy-box-ghost.active.svelte-kr9okr{opacity:1;-webkit-transform:translate3d(0,0,0);transform:translate3d(0,0,0);pointer-events:auto}",
	map: "{\"version\":3,\"file\":\"FancyBox.svelte\",\"sources\":[\"FancyBox.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { fly } from 'svelte/transition'\\n    import { classnames, Swipe, delay } from '@utils'\\n    import { disableBodyScroll, enableBodyScroll } from 'body-scroll-lock';\\n\\n    const START_POSITION = 20\\n    const THRESHOLD = 100\\n\\n    const dispatch = createEventDispatcher()\\n\\n    let active = null\\n    let fancyBox = null\\n    let slots = $$props.$$slots || {}\\n\\n    function onClick(e) {\\n        const newActive = !active\\n\\n        setActive(newActive)\\n\\n        if (newActive) {\\n            drawTransform(fancyBox, 0)\\n            dispatch('open', e)\\n        } else {\\n            drawTransform(fancyBox, START_POSITION)\\n            dispatch('close', e)\\n        }\\n    }\\n     \\n    function setActive(isActive) {\\n        active = isActive\\n\\n        setTimeout(() => {\\n            if (active) {\\n                disableBodyScroll(fancyBox);\\n            } else {\\n                enableBodyScroll(fancyBox);\\n            }\\n        })\\n    }\\n\\n    $: classProp = classnames('fancy-box-ghost', { active })\\n\\n    let ySwipe = START_POSITION\\n    function swipe(el) {\\n        new Swipe(el)\\n                .run()\\n                .onUp(handleVerticalSwipe)\\n                .onDown(handleVerticalSwipe)\\n                .onTouchEnd(async () => {\\n                    if (ySwipe > THRESHOLD) {\\n                        setActive(false)\\n                        drawTransform(el, ySwipe + 50)\\n                        await delay(300)\\n                    } else if (ySwipe < -THRESHOLD) {\\n                        setActive(false)\\n                        drawTransform(el, ySwipe - 50)\\n                        await delay(300)\\n                    }\\n\\n                    ySwipe = START_POSITION\\n                    drawTransform(el, ySwipe)\\n                })\\n    }\\n\\n    function handleVerticalSwipe(yDown, yUp, evt, el) {\\n        ySwipe = yUp - yDown\\n        drawTransform(el, ySwipe)\\n    }\\n\\n    function drawTransform(el, y) {\\n        el && (el.style.transform = `translate3d(0, ${y}px, 0)`)\\n    }\\n</script>\\n\\n<section role=\\\"button\\\" class=\\\"fancy-box\\\" on:click={onClick}>\\n    <slot {active}></slot>\\n</section>\\n\\n{#if !slots.box}\\n    <button\\n            bind:this={fancyBox}\\n            use:swipe\\n            in:fly=\\\"{{ y: 20, duration: 200 }}\\\"\\n            type=\\\"button\\\"\\n            class={classProp}\\n            on:click={onClick}\\n    >\\n        <slot></slot>\\n    </button>\\n{/if}\\n\\n{#if active !== null && slots.box}\\n    <button\\n            bind:this={fancyBox}\\n            use:swipe\\n            in:fly=\\\"{{ y: 20, duration: 200 }}\\\"\\n            type=\\\"button\\\"\\n            class={classProp}\\n            on:click={onClick}\\n    >\\n        <slot name=\\\"box\\\"></slot>\\n    </button>\\n{/if}\\n\\n<style>\\n    .fancy-box {\\n        position: relative;\\n        width: 100%;\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    .fancy-box-ghost {\\n        z-index: 10;\\n        position: fixed;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        height: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n        background-color: rgba(var(--color-black), .75);\\n        outline: 20px solid rgba(var(--color-black), .75);\\n        -webkit-transition: .3s ease-out;\\n        transition: .3s ease-out;\\n        opacity: 0;\\n        -webkit-transform: translate3d(0,20px,0);\\n                transform: translate3d(0,20px,0);\\n        pointer-events: none;\\n        overflow: scroll;\\n        -webkit-overflow-scrolling: touch;\\n    }\\n\\n    .fancy-box-ghost.active {\\n        opacity: 1;\\n        -webkit-transform: translate3d(0,0,0);\\n                transform: translate3d(0,0,0);\\n        pointer-events: auto;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AA0GI,UAAU,cAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,gBAAgB,cAAC,CAAC,AACd,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,CAChC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,OAAO,CAAE,IAAI,CAAC,KAAK,CAAC,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CACjD,kBAAkB,CAAE,GAAG,CAAC,QAAQ,CAChC,UAAU,CAAE,GAAG,CAAC,QAAQ,CACxB,OAAO,CAAE,CAAC,CACV,iBAAiB,CAAE,YAAY,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CAChC,SAAS,CAAE,YAAY,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,CACxC,cAAc,CAAE,IAAI,CACpB,QAAQ,CAAE,MAAM,CAChB,0BAA0B,CAAE,KAAK,AACrC,CAAC,AAED,gBAAgB,OAAO,cAAC,CAAC,AACrB,OAAO,CAAE,CAAC,CACV,iBAAiB,CAAE,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAC7B,SAAS,CAAE,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACrC,cAAc,CAAE,IAAI,AACxB,CAAC\"}"
};
...
const FancyBox = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section role="${"button"}" class="${"fancy-box svelte-kr9okr"}">
    ${$$slots.default ? $$slots.default({ active }) : ``}
</section>

${!slots.box
	? `<button type="${"button"}" class="${escape(null_to_empty(classProp)) + " svelte-kr9okr"}"${add_attribute("this", fancyBox, 1)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`
	: ``}
