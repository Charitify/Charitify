...
const css$a = {
	code: "nav.svelte-zt15f6.svelte-zt15f6{position:sticky;top:0;z-index:10;display:flex;justify-content:space-between;box-shadow:var(--shadow-secondary);border-bottom:1px solid rgba(var(--color-danger), .1)}.selected.svelte-zt15f6.svelte-zt15f6{position:relative;display:inline-block}.selected.svelte-zt15f6.svelte-zt15f6::after{position:absolute;content:\"\";width:calc(100% - 1em);height:2px;background-color:rgb(var(--color-danger));display:block;bottom:-1px}a.svelte-zt15f6.svelte-zt15f6{padding:.8em 0.2em}.nav-actions.svelte-zt15f6.svelte-zt15f6{display:flex;align-items:center;margin:-3px}.nav-actions.svelte-zt15f6 li.svelte-zt15f6{padding:3px}.lang-select.svelte-zt15f6.svelte-zt15f6{padding:5px;background-color:transparent}.lang-select.svelte-zt15f6.svelte-zt15f6:hover,.lang-select.svelte-zt15f6.svelte-zt15f6:focus{box-shadow:none;background-color:rgba(var(--color-black), 0.1)}",
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"theme-bg container svelte-zt15f6"}">
    <ul>
        <li><a rel="${"prefetch"}" href="${"."}" class="${["svelte-zt15f6", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
        <li><a href="${"map"}" class="${["svelte-zt15f6", segment === "map" ? "selected" : ""].join(" ").trim()}">map</a></li>
        <li><a rel="${"prefetch"}" href="${"lists/charities"}" class="${["svelte-zt15f6", segment === "lists" ? "selected" : ""].join(" ").trim()}">lists</a></li>
        <li><a rel="${"prefetch"}" href="${"charity"}" class="${["svelte-zt15f6", segment === "charity" ? "selected" : ""].join(" ").trim()}">charity</a></li>
        <li><a rel="${"prefetch"}" href="${"organization"}" class="${["svelte-zt15f6", segment === "organization" ? "selected" : ""].join(" ").trim()}">org</a></li>
    </ul>

    <ul class="${"nav-actions svelte-zt15f6"}">
        <li class="${"svelte-zt15f6"}">
            <select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-zt15f6"}">
                <option value="${"ua"}">Ua</option>
                <option value="${"ru"}">Ru</option>
                <option value="${"en"}">En</option>
            </select>
