...
const Modal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	function blockScroll(modal) {
		if (active) {
			blockBody && bodyScrollLock.disableBodyScroll(modal);
		} else {
			blockBody && bodyScrollLock.enableBodyScroll(modal);
		}
	}
