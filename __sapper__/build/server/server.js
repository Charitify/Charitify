...
const css = {
	code: "br{display:block;height:0;content:\"\\00a0\";box-sizing:content-box}br.tiny{padding-bottom:calc(1em * 0.29) 0}br.small{padding-bottom:calc(1em * 0.57) 0}br.medium,br{padding-bottom:calc(1em * 1.14) 0}br.big{padding-bottom:calc(1em * 2.28) 0}",
	map: "{\"version\":3,\"file\":\"Br.svelte\",\"sources\":[\"Br.svelte\"],\"sourcesContent\":[\"<script>\\n  export let size = '1em';\\n\\n  $: foramttedSize = Number.isFinite(+size) ? `${size}px` : typeof size === 'string' ? size : null\\n</script>\\n\\n<br style={`padding-bottom: ${foramttedSize}`} class={$$props.class}/>\\n\\n<style>\\n  :global(br) {\\n    display: block;\\n    height: 0;\\n    content: \\\"\\\\00a0\\\";\\n    box-sizing: content-box;\\n  }\\n\\n  :global(br.tiny) {\\n    padding-bottom: calc(1em * 0.29) 0; /* 4px */\\n  }\\n\\n  :global(br.small) {\\n    padding-bottom: calc(1em * 0.57) 0; /* 8px */\\n  }\\n\\n  :global(br.medium),\\n  :global(br) {\\n    padding-bottom: calc(1em * 1.14) 0; /* 16px */\\n  }\\n\\n  :global(br.big) {\\n    padding-bottom: calc(1em * 2.28) 0; /* 32px */\\n  }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AASU,EAAE,AAAE,CAAC,AACX,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,OAAO,CAChB,UAAU,CAAE,WAAW,AACzB,CAAC,AAEO,OAAO,AAAE,CAAC,AAChB,cAAc,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,AACpC,CAAC,AAEO,QAAQ,AAAE,CAAC,AACjB,cAAc,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,AACpC,CAAC,AAEO,SAAS,AAAC,CACV,EAAE,AAAE,CAAC,AACX,cAAc,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,AACpC,CAAC,AAEO,MAAM,AAAE,CAAC,AACf,cAAc,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,AACpC,CAAC\"}"
};
...
const css$2 = {
	code: ".card.svelte-1pjhpfs{width:100%;overflow:hidden;position:relative;box-shadow:var(--shadow-secondary);border-radius:var(--border-radius-big);background-color:rgba(var(--theme-color-primary))}",
	map: "{\"version\":3,\"file\":\"Card.svelte\",\"sources\":[\"Card.svelte\"],\"sourcesContent\":[\"<script>\\n    import { classnames } from '@utils'\\n\\n    $: classProp = classnames('card', $$props.class)\\n</script>\\n\\n<section class={classProp} style={$$props.style}>\\n    <slot></slot>\\n</section>\\n\\n<style>\\n    .card {\\n        width: 100%;\\n        overflow: hidden;\\n        position: relative;\\n        box-shadow: var(--shadow-secondary);\\n        border-radius: var(--border-radius-big);\\n        background-color: rgba(var(--theme-color-primary));\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAWI,KAAK,eAAC,CAAC,AACH,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,CAChB,QAAQ,CAAE,QAAQ,CAClB,UAAU,CAAE,IAAI,kBAAkB,CAAC,CACnC,aAAa,CAAE,IAAI,mBAAmB,CAAC,CACvC,gBAAgB,CAAE,KAAK,IAAI,qBAAqB,CAAC,CAAC,AACtD,CAAC\"}"
};
...
const Card = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section class="${escape(null_to_empty(classProp)) + " svelte-1pjhpfs"}"${add_attribute("style", $$props.style, 0)}>
    ${$$slots.default ? $$slots.default({}) : ``}
</section>`;
});
...
const css$5 = {
	code: ".btn.svelte-1bc1p16:not(.auto){width:100%;padding:5px 15px}.btn{flex:none;cursor:pointer;max-width:100%;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-weight:bold;text-align:center;align-items:center;display:inline-flex;justify-content:center;color:rgba(var(--theme-font-color));border-radius:var(--border-radius-medium)}.btn.small{padding:5px;min-width:calc(var(--min-interactive-size) / 1.3);min-height:calc(var(--min-interactive-size) / 1.3)}.btn.medium{padding:5px 10px;min-width:var(--min-interactive-size);min-height:var(--min-interactive-size)}.btn.big{padding:5px 15px;min-width:calc(var(--min-interactive-size) * 1.3);min-height:calc(var(--min-interactive-size) * 1.3)}.btn:focus{background-color:rgba(var(--color-black), 0.1)}.btn:hover{background-color:rgba(var(--color-black), 0.1)}.btn:active{background-color:rgba(var(--color-black), 0.1)}.btn.white{color:rgba(var(--color-font-dark));background-color:rgba(var(--color-white))}.btn.white:focus{background-color:rgba(var(--color-white), .85)}.btn.white:hover{box-shadow:var(--shadow-primary)}.btn.white:active{box-shadow:var(--shadow-primary)}.btn.success{color:rgba(var(--color-font-light));background-color:rgba(var(--color-success))}.btn.success:focus{background-color:rgba(var(--color-success), .85)}.btn.success:hover{box-shadow:var(--shadow-primary)}.btn.success:active{box-shadow:var(--shadow-primary)}.btn.warning{color:rgba(var(--color-font-light));background-color:rgba(var(--color-warning))}.btn.warning:focus{background-color:rgba(var(--color-warning), .85)}.btn.warning:hover{box-shadow:var(--shadow-primary)}.btn.warning:active{box-shadow:var(--shadow-primary)}.btn.danger{color:rgba(var(--color-font-light));background-color:rgba(var(--color-danger))}.btn.danger:focus{background-color:rgba(var(--color-danger), .85)}.btn.danger:hover{box-shadow:var(--shadow-primary)}.btn.danger:active{box-shadow:var(--shadow-primary)}",
	map: "{\"version\":3,\"file\":\"Button.svelte\",\"sources\":[\"Button.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames } from '@utils'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let is = undefined\\n    export let id = undefined\\n    export let href = undefined\\n    export let auto = false\\n    export let type = 'button'\\n    export let size = undefined\\n    export let title = undefined\\n    export let htmlFor = undefined\\n    export let disabled = false\\n    export let ariaLabel = undefined\\n\\n    let titleProp = title || ariaLabel\\n    let ariaLabelProp = ariaLabel || title\\n\\n    $: classProp = classnames('btn', is, size, $$props.class, { auto, disabled })\\n\\n    function onLabelClick(e) {\\n        document.getElementById(htmlFor).click()\\n        !disabled && dispatch('click', e)\\n    }\\n\\n    function onClick(e) {\\n        !disabled && dispatch('click', e)\\n    }\\n</script>\\n\\n{#if href}\\n    <a\\n            {id}\\n            {href}\\n            title={titleProp}\\n            class={classProp}\\n            aria-label={ariaLabelProp}\\n            on:click={onClick}\\n    >\\n        <slot></slot>\\n    </a>\\n{:else if htmlFor}\\n    <label\\n            {id}\\n            {disabled}\\n            for={htmlFor}\\n            title={titleProp}\\n            class={classProp}\\n            aria-label={ariaLabelProp}\\n            on:click={onLabelClick}\\n    >\\n        <slot></slot>\\n    </label>\\n{:else}\\n    <button\\n            {id}\\n            {type}\\n            {disabled}\\n            title={titleProp}\\n            class={classProp}\\n            aria-label={ariaLabelProp}\\n            on:click={onClick}\\n    >\\n        <slot></slot>\\n    </button>\\n{/if}\\n\\n<style>\\n    .btn:not(.auto) {\\n        width: 100%;\\n        padding: 5px 15px;\\n    }\\n\\n    :global(.btn) {\\n        flex: none;\\n        cursor: pointer;\\n        max-width: 100%;\\n        -webkit-user-select: none;\\n           -moz-user-select: none;\\n            -ms-user-select: none;\\n                user-select: none;\\n        font-weight: bold;\\n        text-align: center;\\n        align-items: center;\\n        display: inline-flex;\\n        justify-content: center;\\n        color: rgba(var(--theme-font-color));\\n        border-radius: var(--border-radius-medium);\\n    }\\n\\n    :global(.btn.small) {\\n        padding: 5px;\\n        min-width: calc(var(--min-interactive-size) / 1.3);\\n        min-height: calc(var(--min-interactive-size) / 1.3);\\n    }\\n\\n    :global(.btn.medium) {\\n        padding: 5px 10px;\\n        min-width: var(--min-interactive-size);\\n        min-height: var(--min-interactive-size);\\n    }\\n\\n    :global(.btn.big) {\\n        padding: 5px 15px;\\n        min-width: calc(var(--min-interactive-size) * 1.3);\\n        min-height: calc(var(--min-interactive-size) * 1.3);\\n    }\\n\\n    :global(.btn:focus) {\\n        background-color: rgba(var(--color-black), 0.1);\\n    }\\n\\n    :global(.btn:hover) {\\n        background-color: rgba(var(--color-black), 0.1);\\n    }\\n\\n    :global(.btn:active) {\\n        background-color: rgba(var(--color-black), 0.1);\\n    }\\n\\n    /* White */\\n\\n    :global(.btn).white {\\n        color: rgba(var(--color-font-dark));\\n        background-color: rgba(var(--color-white));\\n    }\\n\\n    :global(.btn).white:focus {\\n        background-color: rgba(var(--color-white), .85);\\n    }\\n\\n    :global(.btn).white:hover {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    :global(.btn).white:active {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    /* Success */\\n\\n    :global(.btn).success {\\n        color: rgba(var(--color-font-light));\\n        background-color: rgba(var(--color-success));\\n    }\\n\\n    :global(.btn).success:focus {\\n        background-color: rgba(var(--color-success), .85);\\n    }\\n\\n    :global(.btn).success:hover {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    :global(.btn).success:active {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    /* Warning */\\n\\n    :global(.btn).warning {\\n        color: rgba(var(--color-font-light));\\n        background-color: rgba(var(--color-warning));\\n    }\\n\\n    :global(.btn).warning:focus {\\n        background-color: rgba(var(--color-warning), .85);\\n    }\\n\\n    :global(.btn).warning:hover {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    :global(.btn).warning:active {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    /* Danger */\\n\\n    :global(.btn).danger {\\n        color: rgba(var(--color-font-light));\\n        background-color: rgba(var(--color-danger));\\n    }\\n\\n    :global(.btn).danger:focus {\\n        background-color: rgba(var(--color-danger), .85);\\n    }\\n\\n    :global(.btn).danger:hover {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n    :global(.btn).danger:active {\\n        box-shadow: var(--shadow-primary);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAsEI,mBAAI,KAAK,KAAK,CAAC,AAAC,CAAC,AACb,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,CAAC,IAAI,AACrB,CAAC,AAEO,IAAI,AAAE,CAAC,AACX,IAAI,CAAE,IAAI,CACV,MAAM,CAAE,OAAO,CACf,SAAS,CAAE,IAAI,CACf,mBAAmB,CAAE,IAAI,CACtB,gBAAgB,CAAE,IAAI,CACrB,eAAe,CAAE,IAAI,CACjB,WAAW,CAAE,IAAI,CACzB,WAAW,CAAE,IAAI,CACjB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,WAAW,CACpB,eAAe,CAAE,MAAM,CACvB,KAAK,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,CACpC,aAAa,CAAE,IAAI,sBAAsB,CAAC,AAC9C,CAAC,AAEO,UAAU,AAAE,CAAC,AACjB,OAAO,CAAE,GAAG,CACZ,SAAS,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAClD,UAAU,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACvD,CAAC,AAEO,WAAW,AAAE,CAAC,AAClB,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,SAAS,CAAE,IAAI,sBAAsB,CAAC,CACtC,UAAU,CAAE,IAAI,sBAAsB,CAAC,AAC3C,CAAC,AAEO,QAAQ,AAAE,CAAC,AACf,OAAO,CAAE,GAAG,CAAC,IAAI,CACjB,SAAS,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAClD,UAAU,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AACvD,CAAC,AAEO,UAAU,AAAE,CAAC,AACjB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAEO,UAAU,AAAE,CAAC,AACjB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAEO,WAAW,AAAE,CAAC,AAClB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAIO,IAAI,AAAC,MAAM,AAAC,CAAC,AACjB,KAAK,CAAE,KAAK,IAAI,iBAAiB,CAAC,CAAC,CACnC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC9C,CAAC,AAEO,IAAI,AAAC,MAAM,MAAM,AAAC,CAAC,AACvB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,AACnD,CAAC,AAEO,IAAI,AAAC,MAAM,MAAM,AAAC,CAAC,AACvB,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAEO,IAAI,AAAC,MAAM,OAAO,AAAC,CAAC,AACxB,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAIO,IAAI,AAAC,QAAQ,AAAC,CAAC,AACnB,KAAK,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,CACpC,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,AAChD,CAAC,AAEO,IAAI,AAAC,QAAQ,MAAM,AAAC,CAAC,AACzB,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,AACrD,CAAC,AAEO,IAAI,AAAC,QAAQ,MAAM,AAAC,CAAC,AACzB,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAEO,IAAI,AAAC,QAAQ,OAAO,AAAC,CAAC,AAC1B,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAIO,IAAI,AAAC,QAAQ,AAAC,CAAC,AACnB,KAAK,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,CACpC,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,AAChD,CAAC,AAEO,IAAI,AAAC,QAAQ,MAAM,AAAC,CAAC,AACzB,gBAAgB,CAAE,KAAK,IAAI,eAAe,CAAC,CAAC,CAAC,GAAG,CAAC,AACrD,CAAC,AAEO,IAAI,AAAC,QAAQ,MAAM,AAAC,CAAC,AACzB,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAEO,IAAI,AAAC,QAAQ,OAAO,AAAC,CAAC,AAC1B,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAIO,IAAI,AAAC,OAAO,AAAC,CAAC,AAClB,KAAK,CAAE,KAAK,IAAI,kBAAkB,CAAC,CAAC,CACpC,gBAAgB,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,AAC/C,CAAC,AAEO,IAAI,AAAC,OAAO,MAAM,AAAC,CAAC,AACxB,gBAAgB,CAAE,KAAK,IAAI,cAAc,CAAC,CAAC,CAAC,GAAG,CAAC,AACpD,CAAC,AAEO,IAAI,AAAC,OAAO,MAAM,AAAC,CAAC,AACxB,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC,AAEO,IAAI,AAAC,OAAO,OAAO,AAAC,CAAC,AACzB,UAAU,CAAE,IAAI,gBAAgB,CAAC,AACrC,CAAC\"}"
};
...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${add_attribute("id", id, 0)}${add_attribute("href", href, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1bc1p16"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </a>`
	: `${htmlFor
		? `<label${add_attribute("id", id, 0)} ${disabled ? "disabled" : ""}${add_attribute("for", htmlFor, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1bc1p16"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </label>`
		: `<button${add_attribute("id", id, 0)}${add_attribute("type", type, 0)} ${disabled ? "disabled" : ""}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-1bc1p16"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`}`}`;
});
...
const css$8 = {
	code: ".carousel.svelte-10zi3mj.svelte-10zi3mj,.carousel-inner.svelte-10zi3mj.svelte-10zi3mj,.carousel-inner.svelte-10zi3mj li.svelte-10zi3mj{position:relative;flex:none;display:flex;overflow:hidden;text-align:left;align-self:stretch;align-items:stretch;justify-content:stretch}.carousel.stretch.svelte-10zi3mj .fluid.svelte-10zi3mj{width:100%}.carousel.auto.svelte-10zi3mj .fluid.svelte-10zi3mj{width:auto}.carousel.svelte-10zi3mj.svelte-10zi3mj{width:100%;border-radius:var(--border-radius-big)}.carousel-inner.svelte-10zi3mj.svelte-10zi3mj::-webkit-scrollbar{display:none}.carousel.svelte-10zi3mj .carousel-inner.svelte-10zi3mj{width:100%;overflow-y:hidden;overflow-x:scroll}.carousel-dots.svelte-10zi3mj.svelte-10zi3mj{position:absolute;left:0;bottom:10px;width:100%;display:flex;align-items:center;justify-items:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-10zi3mj li.svelte-10zi3mj{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;background-color:rgba(var(--theme-bg-color));box-shadow:var(--shadow-primary)\n    }li.active.svelte-10zi3mj.svelte-10zi3mj{transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil, classnames } from '@utils'\\n    import Picture from './Picture.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let size = 'stretch'\\n    export let initIndex = 0\\n\\n    $: activeDot = initIndex\\n    $: classProp = classnames('carousel', size, $$props.class)\\n\\n    function carousel(node) {\\n        initScrollPosition(node)\\n        node.addEventListener('scroll', onScroll)\\n        return { destroy: () => node.removeEventListener('scroll', onScroll) }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft } = parent\\n        const { width } = parent.getBoundingClientRect()\\n        const newActiveDot = Math.round(scrollLeft / width)\\n        if (activeDot !== newActiveDot) activeDot = newActiveDot\\n    }\\n\\n    function initScrollPosition(parent) {\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = width * activeDot\\n            if (parent.scrollLeft !== width * activeDot) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class={classProp}>\\n    <ul use:carousel class=\\\"carousel-inner scroll-x-center\\\">\\n        {#each items as item, index}\\n            <li class=\\\"fluid\\\" role=\\\"button\\\" on:click={onClick.bind(null, item, index)}>\\n                <slot {item} {index}>\\n                    <Picture {...item}/>\\n                </slot>\\n            </li>\\n        {/each}\\n    </ul>\\n\\n\\n    {#if dots}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel, .carousel-inner, .carousel-inner li {\\n        position: relative;\\n        flex: none;\\n        display: flex;\\n        overflow: hidden;\\n        text-align: left;\\n        align-self: stretch;\\n        align-items: stretch;\\n        justify-content: stretch;\\n    }\\n\\n    .carousel.stretch .fluid {\\n        width: 100%;\\n    }\\n\\n    .carousel.auto .fluid {\\n        width: auto;\\n    }\\n\\n    .carousel {\\n        width: 100%;\\n        border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel-inner::-webkit-scrollbar {\\n        display: none;\\n    }\\n\\n    .carousel .carousel-inner {\\n        width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        left: 0;\\n        bottom: 10px;\\n        width: 100%;\\n        display: flex;\\n        align-items: center;\\n        justify-items: center;\\n        justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        background-color: rgba(var(--theme-bg-color));\\n        box-shadow: var(--shadow-primary)\\n    }\\n\\n    li.active {\\n        transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAkFI,uCAAS,CAAE,6CAAe,CAAE,8BAAe,CAAC,EAAE,eAAC,CAAC,AAC5C,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CACpB,eAAe,CAAE,OAAO,AAC5B,CAAC,AAED,SAAS,uBAAQ,CAAC,MAAM,eAAC,CAAC,AACtB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,oBAAK,CAAC,MAAM,eAAC,CAAC,AACnB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,8BAAC,CAAC,AACP,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC3C,CAAC,AAED,6CAAe,mBAAmB,AAAC,CAAC,AAChC,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,wBAAS,CAAC,eAAe,eAAC,CAAC,AACvB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,AACtB,CAAC,AAED,cAAc,8BAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,MAAM,CACrB,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,6BAAc,CAAC,EAAE,eAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,KAAK,IAAI,gBAAgB,CAAC,CAAC,CAC7C,UAAU,CAAE,IAAI,gBAAgB,CAAC;IACrC,CAAC,AAED,EAAE,OAAO,8BAAC,CAAC,AACP,SAAS,CAAE,MAAM,GAAG,CAAC,AACzB,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${escape(null_to_empty(classProp)) + " svelte-10zi3mj"}">
    <ul class="${"carousel-inner scroll-x-center svelte-10zi3mj"}">
        ${each(items, (item, index) => `<li class="${"fluid svelte-10zi3mj"}" role="${"button"}">
                ${$$slots.default
    ...
    ${dots
	? `<ul class="${"carousel-dots svelte-10zi3mj"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-10zi3mj"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
...
const css$c = {
	code: "div.svelte-o53zpt{flex:none;display:flex;align-self:stretch;height:180px;width:126px;padding:15px 5px;box-sizing:content-box}div.start.svelte-o53zpt{padding-left:var(--screen-padding)}div.end.svelte-o53zpt{padding-right:var(--screen-padding)}",
	map: "{\"version\":3,\"file\":\"Documents.svelte\",\"sources\":[\"Documents.svelte\"],\"sourcesContent\":[\"<script>\\n    import Card from '@components/Card.svelte'\\n    import Picture from '@components/Picture.svelte'\\n    import Carousel from '@components/Carousel.svelte'\\n\\n    const cardSample = {\\n        src: 'https://placeimg.com/300/300/people',\\n        alt: '10грн',\\n    }\\n\\n    const all = new Array(5).fill(cardSample)\\n</script>\\n\\n<Carousel items={all} size=\\\"auto\\\" dots={false} let:item={item} let:index={index}>\\n    <div class={!index ? 'start' : index === all.length - 1 ? 'end' : ''}>\\n        <Card class=\\\"flex\\\">\\n            <Picture {...item} size=\\\"contain\\\"/>\\n        </Card>\\n    </div>\\n</Carousel>\\n\\n<style>\\n    div {\\n        flex: none;\\n        display: flex;\\n        align-self: stretch;\\n        height: 180px;\\n        width: 126px;\\n        padding: 15px 5px;\\n        box-sizing: content-box;\\n    }\\n\\n    div.start {\\n        padding-left: var(--screen-padding);\\n    }\\n\\n    div.end {\\n        padding-right: var(--screen-padding);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAsBI,GAAG,cAAC,CAAC,AACD,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,IAAI,CAAC,GAAG,CACjB,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,GAAG,MAAM,cAAC,CAAC,AACP,YAAY,CAAE,IAAI,gBAAgB,CAAC,AACvC,CAAC,AAED,GAAG,IAAI,cAAC,CAAC,AACL,aAAa,CAAE,IAAI,gBAAgB,CAAC,AACxC,CAAC\"}"
};
...
const Documents = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${validate_component(Carousel, "Carousel").$$render($$result, { items: all, size: "auto", dots: false }, {}, {
		default: ({ item, index }) => `
    <div class="${escape(null_to_empty(!index ? "start" : index === all.length - 1 ? "end" : "")) + " svelte-o53zpt"}">
...
const css$n = {
	code: "li.svelte-vlat95{display:flex;align-items:center;padding:20px;width:100%}li.svelte-vlat95:not(:last-child){background-image:linear-gradient(to right, rgba(var(--color-black), 0.1) 50%, rgba(var(--color-black), 0) 0%);background-position:bottom;background-size:20px 1px;background-repeat:repeat-x}",
	map: "{\"version\":3,\"file\":\"DonatorsCard.svelte\",\"sources\":[\"DonatorsCard.svelte\"],\"sourcesContent\":[\"<script>\\n    import Icon from '@components/Icon.svelte'\\n    import Card from '@components/Card.svelte'\\n    import Avatar from '@components/Avatar.svelte'\\n\\n    export let items\\n</script>\\n\\n{#if Array.isArray(items) && items.length}\\n    <Card>\\n        <ul class=\\\"full-width\\\">\\n            {#each items as item}\\n                {#if item.title && item.src}\\n                    <li>\\n                        <div class=\\\"relative\\\">\\n                            <Avatar src={item.src} size=\\\"medium\\\" alt={item.subtitle}/>\\n                            {#if item.checked}\\n                                <div class=\\\"absolute flex\\\" style=\\\"top: -1px; right: -1px; width: 20px; height: 20px; overflow: hidden\\\">\\n                                    <Icon type=\\\"polygon\\\" is=\\\"info\\\"/>\\n                                    <div class=\\\"absolute-center flex\\\" style=\\\"width: 10px; height: 10px;\\\">\\n                                        <Icon type=\\\"check-flag\\\" is=\\\"light\\\"/>\\n                                    </div>\\n                                </div>\\n                            {/if}\\n                        </div>\\n                        <s></s>\\n                        <s></s>\\n                        <s></s>\\n                        <s></s>\\n                        <div style=\\\"overflow: hidden;\\\" class=\\\"flex flex-column flex-justify-center\\\">\\n                            <h2 class=\\\"text-ellipsis\\\">{ item.title }</h2>\\n                            <span class=\\\"h4 font-w-300 text-ellipsis\\\">{ item.subtitle }<span/>\\n                        </div>\\n                    </li>\\n                {/if}\\n            {/each}\\n        </ul>\\n    </Card>\\n{/if}\\n\\n<style>\\n    li {\\n        display: flex;\\n        align-items: center;\\n        padding: 20px;\\n        width: 100%;\\n    }\\n\\n    li:not(:last-child) {\\n        background-image: linear-gradient(to right, rgba(var(--color-black), 0.1) 50%, rgba(var(--color-black), 0) 0%);\\n        background-position: bottom;\\n        background-size: 20px 1px;\\n        background-repeat: repeat-x;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAyCI,EAAE,cAAC,CAAC,AACA,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,AACf,CAAC,AAED,gBAAE,KAAK,WAAW,CAAC,AAAC,CAAC,AACjB,gBAAgB,CAAE,gBAAgB,EAAE,CAAC,KAAK,CAAC,CAAC,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAC9G,mBAAmB,CAAE,MAAM,CAC3B,eAAe,CAAE,IAAI,CAAC,GAAG,CACzB,iBAAiB,CAAE,QAAQ,AAC/B,CAAC\"}"
};
...
const css$o = {
	code: "ul.svelte-fsxn9v{width:100%;display:flex;align-items:flex-start;max-width:100%;overflow-y:hidden;overflow-x:auto;padding:var(--screen-padding) 0}li.svelte-fsxn9v{flex:none;align-self:stretch;width:260px;padding:0 5px}li.svelte-fsxn9v:first-child{padding-left:15px}li.svelte-fsxn9v:last-child{padding-right:15px}",
	map: "{\"version\":3,\"file\":\"DonatorsList.svelte\",\"sources\":[\"DonatorsList.svelte\"],\"sourcesContent\":[\"<script>\\n    import DonatorsCard from './DonatorsCard.svelte'\\n\\n    const all = [\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '₴ 10',\\n            subtitle: 'Тіна Канделакі',\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '₴ 250',\\n            subtitle: 'Bruce Lee',\\n            checked: true,\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '₴ 1140',\\n            subtitle: 'Leonardo DiCaprio junior',\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '₴ 50',\\n            subtitle: 'Добра людина',\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '₴ 5',\\n            subtitle: 'Добра людина',\\n        },\\n    ]\\n\\n    const grouped = all.map(one => new Array(3).fill(one))\\n\\n    function scrollEnd(node) {\\n        try {\\n          node.scrollTo(node.scrollWidth, 0)\\n        } catch (e) {}\\n    }\\n</script>\\n\\n<ul class=\\\"scroll-x-center\\\" use:scrollEnd>\\n    {#each grouped as cards}\\n        <li>\\n            <DonatorsCard items={cards}/>\\n        </li>\\n    {/each}\\n</ul>\\n\\n<style>\\n    ul {\\n        width: 100%;\\n        display: flex;\\n        align-items: flex-start;\\n        max-width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: auto;\\n        padding: var(--screen-padding) 0;\\n    }\\n\\n    li {\\n        flex: none;\\n        align-self: stretch;\\n        width: 260px;\\n        padding: 0 5px;\\n    }\\n\\n    li:first-child {\\n        padding-left: 15px;\\n    }\\n\\n    li:last-child {\\n        padding-right: 15px;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAkDI,EAAE,cAAC,CAAC,AACA,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,UAAU,CACvB,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAAC,CAAC,AACpC,CAAC,AAED,EAAE,cAAC,CAAC,AACA,IAAI,CAAE,IAAI,CACV,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,CAAC,CAAC,GAAG,AAClB,CAAC,AAED,gBAAE,YAAY,AAAC,CAAC,AACZ,YAAY,CAAE,IAAI,AACtB,CAAC,AAED,gBAAE,WAAW,AAAC,CAAC,AACX,aAAa,CAAE,IAAI,AACvB,CAAC\"}"
};
...
const DonatorsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"scroll-x-center svelte-fsxn9v"}">
    ${each(grouped, cards => `<li class="${"svelte-fsxn9v"}">
...
const css$p = {
	code: "div.svelte-1dhuyyf{flex:none;display:flex;align-self:stretch;height:470px;width:77vw;max-width:350px;padding:15px 5px;box-sizing:content-box}div.start.svelte-1dhuyyf{padding-left:var(--screen-padding)}div.end.svelte-1dhuyyf{padding-right:var(--screen-padding)}",
	map: "{\"version\":3,\"file\":\"CharityCards.svelte\",\"sources\":[\"CharityCards.svelte\"],\"sourcesContent\":[\"<script>\\n    import Carousel from '@components/Carousel.svelte'\\n    import CharityCard from './CharityCard.svelte'\\n\\n    export let amount = 5\\n\\n    let carousel = new Array(amount).fill(0)\\n</script>\\n\\n<Carousel items={carousel} size=\\\"auto\\\" let:index={index}>\\n    <div class={!index ? 'start' : index === carousel.length - 1 ? 'end' : ''}>\\n       <CharityCard\\n            src=\\\"https://placeimg.com/300/300/people\\\"\\n            total={20000}\\n            current={3500}\\n            city=\\\"Львів\\\"\\n            title=\\\"Допоможи Сірку\\\"\\n       />\\n    </div>\\n</Carousel>\\n\\n<style>\\n    div {\\n        flex: none;\\n        display: flex;\\n        align-self: stretch;\\n        height: 470px;\\n        width: 77vw;\\n        max-width: 350px;\\n        padding: 15px 5px;\\n        box-sizing: content-box;\\n    }\\n\\n    div.start {\\n        padding-left: var(--screen-padding);\\n    }\\n\\n    div.end {\\n        padding-right: var(--screen-padding);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAsBI,GAAG,eAAC,CAAC,AACD,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,IAAI,CAAC,GAAG,CACjB,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,GAAG,MAAM,eAAC,CAAC,AACP,YAAY,CAAE,IAAI,gBAAgB,CAAC,AACvC,CAAC,AAED,GAAG,IAAI,eAAC,CAAC,AACL,aAAa,CAAE,IAAI,gBAAgB,CAAC,AACxC,CAAC\"}"
};
...
const CharityCards = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${escape(null_to_empty(!index
		? "start"
		: index === carousel.length - 1 ? "end" : "")) + " svelte-1dhuyyf"}">
