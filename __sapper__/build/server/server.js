...
const css = {
	...
	map: "{\"version\":3,\"file\":\"Br.svelte\",\"sources\":[\"Br.svelte\"],\"sourcesContent\":[\"<script>\\n  export let size = '1em';\\n\\n  $: foramttedSize = Number.isFinite(+size) ? `${size}px` : typeof size === 'string' ? size : null\\n</script>\\n\\n<br style={`margin-top: ${foramttedSize}`} class={$$props.class}/>\\n\\n<style>\\n  :global(br) {\\n    display: block;\\n    height: 0;\\n    content: \\\"\\\\00a0\\\";\\n    -webkit-box-sizing: content-box;\\n            box-sizing: content-box;\\n  }\\n\\n  :global(br.tiny) {\\n    margin-top: calc(1em * 0.29); /* 4px */\\n  }\\n\\n  :global(br.small) {\\n    margin-top: calc(1em * 0.57); /* 8px */\\n  }\\n\\n  :global(br.medium),\\n  :global(br) {\\n    margin-top: calc(1em * 1.14); /* 16px */\\n  }\\n\\n  :global(br.big) {\\n    margin-top: calc(1em * 2.28); /* 32px */\\n  }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AASU,EAAE,AAAE,CAAC,AACX,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,OAAO,CAChB,kBAAkB,CAAE,WAAW,CACvB,UAAU,CAAE,WAAW,AACjC,CAAC,AAEO,OAAO,AAAE,CAAC,AAChB,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC,AAEO,QAAQ,AAAE,CAAC,AACjB,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC,AAEO,SAAS,AAAC,CACV,EAAE,AAAE,CAAC,AACX,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC,AAEO,MAAM,AAAE,CAAC,AACf,UAAU,CAAE,KAAK,GAAG,CAAC,CAAC,CAAC,IAAI,CAAC,AAC9B,CAAC\"}"
};
...
const Br = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<br${add_attribute("style", `margin-top: ${foramttedSize}`, 0)}${add_attribute("class", $$props.class, 0)}>`;
});
...
const css$5 = {
	code: ".modal.svelte-1x0eyqh.svelte-1x0eyqh{z-index:8;position:fixed;top:0;left:0;width:100%;height:100%;display:-webkit-box;display:-ms-flexbox;display:flex;overflow-x:hidden;overflow-y:auto;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-ms-touch-action:manipulation;touch-action:manipulation;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;background-color:rgba(var(--color-black), .75);outline:150px solid rgba(var(--color-black), .75);-webkit-transition-timing-function:ease-out;transition-timing-function:ease-out;opacity:0;pointer-events:none}.modal.active.svelte-1x0eyqh.svelte-1x0eyqh,.modal-header.active.svelte-1x0eyqh.svelte-1x0eyqh{opacity:1;pointer-events:auto}.modal-inner.svelte-1x0eyqh.svelte-1x0eyqh{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch;overflow:hidden;-webkit-transform:translateZ(0);transform:translateZ(0);background-color:rgba(var(--theme-color-primary))}.small.svelte-1x0eyqh .modal-inner.svelte-1x0eyqh{width:200px;border-radius:var(--border-radius-big);max-width:var(--full-container)}.medium.svelte-1x0eyqh .modal-inner.svelte-1x0eyqh{width:calc(100vw - var(--screen-padding) * 2);border-radius:var(--border-radius-big);max-width:var(--full-container)}.big.svelte-1x0eyqh .modal-inner.svelte-1x0eyqh{width:calc(100% - var(--screen-padding) * 2);height:calc(100% - var(--screen-padding) * 2);border-radius:var(--border-radius-big);max-width:var(--full-container)}.full.svelte-1x0eyqh.svelte-1x0eyqh{-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}.full.svelte-1x0eyqh .modal-inner.svelte-1x0eyqh{-webkit-box-flex:0;-ms-flex:none;flex:none;width:100%;min-height:100%;border-radius:0}.modal-header.svelte-1x0eyqh.svelte-1x0eyqh{-webkit-transform:translateZ(0);transform:translateZ(0);z-index:9;position:fixed;top:0;left:0;width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;color:rgb(var(--color-white));background-color:rgb(var(--color-info));opacity:0;pointer-events:none;-webkit-transform-origin:50% 50vh;transform-origin:50% 50vh}.modal-header-relative.svelte-1x0eyqh.svelte-1x0eyqh{-webkit-transform:translateZ(0);transform:translateZ(0);z-index:9;position:relative;width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;color:rgb(var(--color-white));background-color:rgb(var(--color-info))}.modal-header.svelte-1x0eyqh .close.svelte-1x0eyqh,.modal-header-relative.svelte-1x0eyqh .close.svelte-1x0eyqh{font-size:24px;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;width:50px;height:60px}",
	map: "{\"version\":3,\"file\":\"Modal.svelte\",\"sources\":[\"Modal.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher, tick } from 'svelte'\\n    import { fly } from \\\"svelte/transition\\\";\\n    import { Swipe } from '@services'\\n    import { safeGet, classnames, delay, bodyScroll, stopPropagationInRanges } from \\\"@utils\\\";\\n    import { modals } from \\\"@store\\\";\\n    import Portal from \\\"./Portal.svelte\\\";\\n    import Br from \\\"./Br.svelte\\\";\\n    import Icon from \\\"./Icon.svelte\\\";\\n\\n    const dispatch = createEventDispatcher()\\n    \\n    const DURATION = 250\\n    const THRESHOLD = 50\\n    const SWIPE_SPEED = .5\\n    const THRESHOLD_RANGES = { x: [0, 100], y: [1, 99] }\\n    const START_POSITION = {\\n        x: 50,\\n        y: 0\\n    }\\n\\n    export let id\\n    export let ref = null\\n    export let size = 'full'    // small/medium/big/full\\n    export let swipe = []       // up down left right all\\n    export let title = 'Закрити'\\n    export let open = null\\n    export let startPosition = START_POSITION\\n    export let blockBody = true\\n    export let withHeader = true\\n\\n    let refHeader\\n    let isBodyBlocked = false\\n    let isAllowed = {\\n        up: true,\\n        down: false,\\n        left: true,\\n        right: true,\\n    }\\n\\n    $: isSwipe = {\\n        up: safeGet(() => swipe.includes('up') || swipe.includes('all')),\\n        down: safeGet(() => swipe.includes('down') || swipe.includes('all')),\\n        left: safeGet(() => swipe.includes('left') || swipe.includes('all')),\\n        right: safeGet(() => swipe.includes('right') || swipe.includes('all')),\\n    }\\n    $: scrollY = ref && ref.scrollTop\\n    $: active = safeGet(() => open !== null ? open : $modals[`modal-${id}`].open, null)\\n    $: classProp = classnames('modal', size, { active })\\n    $: onActiveChange(active)\\n    $: blockScroll(ref)\\n\\n    function blockScroll(modal) {\\n        if (blockBody && active && !isBodyBlocked) {\\n            bodyScroll.disableScroll(modal, { extraLock: size === 'full' });\\n            isBodyBlocked = true\\n            modal && (modal.scrollTop = 0)\\n            isAllowed = {\\n                up: true,\\n                down: false,\\n                left: true,\\n                right: true,\\n            }\\n        } else if (blockBody && !active && isBodyBlocked) {\\n            bodyScroll.enableScroll(modal, { extraLock: size === 'full' });\\n            isBodyBlocked = false\\n        }\\n    }\\n\\n    async function onActiveChange(active) {\\n        if (active) {\\n            setDuration(ref, DURATION)\\n            setDuration(refHeader, DURATION)\\n            setTimeout(() => setDuration(ref, 0), DURATION)\\n            setTimeout(() => setDuration(refHeader, 0), DURATION)\\n            drawTransform(ref, 0, 0)\\n            drawTransform(refHeader, 0, 0)\\n            drawOpacity(ref, 0, 0)\\n            drawOpacity(refHeader, 0, 0)\\n            blockScroll(ref)\\n            await tick()\\n            dispatch('open')\\n        } else {\\n            blockScroll(ref)\\n            await tick()\\n            dispatch('close')\\n        }\\n    }\\n\\n    function setActive(isActive) {\\n        if (open !== null) open = isActive\\n        modals.update(s => ({ ...s, [`modal-${id}`]: { open: isActive } }))\\n    }\\n\\n    let xSwipe = 0\\n    let ySwipe = 0\\n\\n    function addSwipe(el) {\\n        stopPropagationInRanges(el, THRESHOLD_RANGES, ({ x, y }) => {\\n            isAllowed = {\\n                up: y <= THRESHOLD_RANGES.y[0],\\n                down: y >= THRESHOLD_RANGES.y[1],\\n                left: x <= THRESHOLD_RANGES.x[0] || x >= THRESHOLD_RANGES.x[1],\\n                right: x <= THRESHOLD_RANGES.x[0] || x >= THRESHOLD_RANGES.x[1],\\n            } \\n        })\\n\\n        new Swipe(el)\\n                .run()\\n                .onUp(isSwipe.up ? handleVerticalSwipe : null)\\n                .onDown(isSwipe.down ? handleVerticalSwipe : null)\\n                .onLeft(isSwipe.left ? handleHorizontalSwipe : null)\\n                .onRight(isSwipe.right ? handleHorizontalSwipe : null)\\n                .onTouchEnd(async () => {\\n                    const shift = 50\\n\\n                    if (xSwipe > THRESHOLD) {\\n                        setDuration(el, DURATION)\\n                        setDuration(refHeader, DURATION)\\n                        setTimeout(() => setDuration(el, 0), DURATION)\\n                        setTimeout(() => setDuration(refHeader, 0), DURATION)\\n                        setActive(false)\\n                        drawOpacity(el, xSwipe + shift, ySwipe)\\n                        drawOpacity(refHeader, xSwipe + shift, ySwipe)\\n                        drawTransform(el, xSwipe + shift, ySwipe)\\n                        drawTransform(refHeader, xSwipe + shift, ySwipe)\\n                        await delay(DURATION)\\n                    } else if (xSwipe < -THRESHOLD) {\\n                        setDuration(el, DURATION)\\n                        setDuration(refHeader, DURATION)\\n                        setTimeout(() => setDuration(el, 0), DURATION)\\n                        setTimeout(() => setDuration(refHeader, 0), DURATION)\\n                        setActive(false)\\n                        drawOpacity(el, xSwipe - shift, ySwipe)\\n                        drawOpacity(refHeader, xSwipe - shift, ySwipe)\\n                        drawTransform(el, xSwipe - shift, ySwipe)\\n                        drawTransform(refHeader, xSwipe - shift, ySwipe)\\n                        await delay(DURATION)\\n                    }\\n                    \\n                    if (ySwipe > THRESHOLD) {\\n                        setDuration(el, DURATION)\\n                        setDuration(refHeader, DURATION)\\n                        setTimeout(() => setDuration(el, 0), DURATION)\\n                        setTimeout(() => setDuration(refHeader, 0), DURATION)\\n                        setActive(false)\\n                        drawOpacity(el, xSwipe, ySwipe + shift)\\n                        drawOpacity(refHeader, xSwipe, ySwipe + shift)\\n                        drawTransform(el, xSwipe, ySwipe + shift)\\n                        drawTransform(refHeader, xSwipe, ySwipe + shift)\\n                        await delay(DURATION)\\n                    } else if (ySwipe < -THRESHOLD) {\\n                        setDuration(el, DURATION)\\n                        setDuration(refHeader, DURATION)\\n                        setTimeout(() => setDuration(el, 0), DURATION)\\n                        setTimeout(() => setDuration(refHeader, 0), DURATION)\\n                        setActive(false)\\n                        drawOpacity(el, xSwipe, ySwipe - shift)\\n                        drawOpacity(refHeader, xSwipe, ySwipe - shift)\\n                        drawTransform(el, xSwipe, ySwipe - shift)\\n                        drawTransform(refHeader, xSwipe, ySwipe - shift)\\n                        await delay(DURATION)\\n                    }\\n\\n                    if (xSwipe <= THRESHOLD && xSwipe >= -THRESHOLD && ySwipe <= THRESHOLD && ySwipe >= -THRESHOLD) {\\n                        setDuration(el, DURATION)\\n                        setDuration(refHeader, DURATION)\\n                        setTimeout(() => setDuration(el, 0), DURATION)\\n                        setTimeout(() => setDuration(refHeader, 0), DURATION)\\n                        drawTransform(el, 0, 0)\\n                        drawTransform(refHeader, 0, 0)\\n                    } else {\\n                        setStartPosition()\\n                    }\\n\\n                    xSwipe = 0\\n                    ySwipe = 0\\n                    el && (el.style.opacity = null)\\n                    refHeader && (refHeader.style.opacity = null)\\n                })\\n    }\\n\\n    function handleVerticalSwipe(yDown, yUp, evt, el) {\\n        const dir = yUp - yDown\\n        if (!isAllowed.up && dir > 0 || !isAllowed.down && dir < 0) return\\n        ySwipe = dir * SWIPE_SPEED\\n        drawTransform(el, xSwipe, ySwipe)\\n        drawTransform(refHeader, xSwipe, ySwipe)\\n        drawOpacity(el, xSwipe, ySwipe)\\n        drawOpacity(refHeader, xSwipe, ySwipe)\\n    }\\n    function handleHorizontalSwipe(xDown, xUp, evt, el) {\\n        const dir = xUp - xDown\\n        if (!isAllowed.left && dir > 0 || !isAllowed.right && dir < 0) return\\n        xSwipe = dir * SWIPE_SPEED\\n        drawTransform(el, xSwipe, ySwipe)\\n        drawTransform(refHeader, xSwipe, ySwipe)\\n        drawOpacity(el, xSwipe, ySwipe)\\n        drawOpacity(refHeader, xSwipe, ySwipe)\\n    }\\n\\n    function setStartPosition() {\\n        drawTransform(ref, startPosition.x, startPosition.y)\\n        drawTransform(refHeader, startPosition.x, startPosition.y)\\n    }\\n\\n    function drawTransform(el, x, y) {\\n        const delta = Math.abs(x) > Math.abs(y) ? x : y\\n        let scale = 1 - Math.abs(delta / window.innerHeight)\\n        el && (el.style.transform = `matrix(${scale}, 0, 0, ${scale}, ${x}, ${y})`)\\n    }\\n     function setDuration(el, ms) {\\n        el && (el.style.transitionDuration = `${ms}ms`)\\n    }\\n    function drawOpacity(el, x, y) {\\n        const delta = Math.abs(x) > Math.abs(y) ? x : y\\n        el && (el.style.opacity = 1 - Math.min(Math.abs(delta / (THRESHOLD * 1.5)), 1))\\n    }\\n\\n    function appear(node, params) {\\n        if (!active) return\\n\\t\\tconst existingTransform = getComputedStyle(node).transform.replace('none', '');\\n        const getScale = t => .9 + .1 * t\\n        const getX = t => startPosition.x - startPosition.x * t\\n\\t\\treturn {\\n\\t\\t\\tduration: DURATION,\\n\\t\\t\\tcss: (t) => `opacity: ${t}; transform: matrix(${getScale(t)}, 0, 0, ${getScale(t)}, ${getX(t)}, 0)`\\n\\t\\t};\\n    }\\n\\n    function onCloseModal() {\\n        setDuration(ref, DURATION)\\n        setDuration(refHeader, DURATION)\\n        setTimeout(() => setDuration(ref, 0), DURATION)\\n        setTimeout(() => setDuration(refHeader, 0), DURATION)\\n        setStartPosition()\\n        drawOpacity(ref, startPosition.x * 2, startPosition.y)\\n        drawOpacity(refHeader, startPosition.x * 2, startPosition.y)\\n        setTimeout(() => setActive(false), DURATION)\\n    }\\n</script>\\n\\n{#if active}\\n    <Portal {id}>\\n        <div\\n            id={`modal-${id}`}\\n            bind:this={ref}\\n            aria-hidden=\\\"true\\\" \\n            class={classProp}\\n            use:addSwipe\\n            in:appear\\n            on:click={setActive.bind(null, false)}\\n        >\\n            {#if withHeader && size === 'full'}\\n                <Portal>\\n                    <slot name=\\\"header\\\">\\n                        <button \\n                            type=\\\"button\\\"\\n                            class={classnames('modal-header', { active })}\\n                            in:appear\\n                            bind:this={refHeader}\\n                            on:click={onCloseModal}\\n                        >\\n                            <h2 style=\\\"padding: 15px\\\">{ title }</h2>\\n                            <span class=\\\"close\\\">\\n                                 <Icon type=\\\"close\\\" size=\\\"big\\\" is=\\\"light\\\"/>\\n                            </span>\\n                        </button>\\n                    </slot>\\n                </Portal>   \\n                <Br size=\\\"60\\\"/>\\n            {/if}\\n            <div\\n                class=\\\"modal-inner\\\"\\n                tabindex=\\\"-1\\\"\\n                role=\\\"dialog\\\"\\n                aria-modal=\\\"true\\\"\\n                aria-labelledby=\\\"модальне вікно\\\"\\n                on:click={e => e.stopPropagation()}\\n            >\\n                {#if withHeader && size !== 'full'}\\n                    <slot name=\\\"header\\\">\\n                        <button\\n                                type=\\\"button\\\"\\n                                class={classnames('modal-header-relative active')}\\n                                in:appear\\n                                on:click={onCloseModal}\\n                        >\\n                            <h2 style=\\\"padding: 15px\\\">{ title }</h2>\\n                            <span class=\\\"close\\\">\\n                                 <Icon type=\\\"close\\\" size=\\\"big\\\" is=\\\"light\\\"/>\\n                            </span>\\n                        </button>\\n                    </slot>\\n                {/if}\\n                <slot props={safeGet(() => $modals[`modal-${id}`], {}, true)}/>\\n            </div>\\n        </div>\\n    </Portal>\\n{/if}\\n\\n<style>\\n    .modal {\\n        z-index: 8;\\n        position: fixed;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        height: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow-x: hidden;\\n        overflow-y: auto;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        -webkit-box-orient: vertical;\\n        -webkit-box-direction: normal;\\n            -ms-flex-direction: column;\\n                flex-direction: column;\\n        -ms-touch-action: manipulation;\\n            touch-action: manipulation;\\n        -webkit-user-select: none;\\n           -moz-user-select: none;\\n            -ms-user-select: none;\\n                user-select: none;\\n        background-color: rgba(var(--color-black), .75);\\n        outline: 150px solid rgba(var(--color-black), .75);\\n        -webkit-transition-timing-function: ease-out;\\n                transition-timing-function: ease-out;\\n        opacity: 0;\\n        pointer-events: none;\\n    }\\n\\n    .modal.active, .modal-header.active {\\n        opacity: 1;\\n        pointer-events: auto;\\n    }\\n\\n    .modal-inner {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-orient: vertical;\\n        -webkit-box-direction: normal;\\n            -ms-flex-direction: column;\\n                flex-direction: column;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n        overflow: hidden;\\n        -webkit-transform: translateZ(0);\\n                transform: translateZ(0);\\n        background-color: rgba(var(--theme-color-primary));\\n    }\\n    .small .modal-inner {\\n        width: 200px;\\n        border-radius: var(--border-radius-big);\\n        max-width: var(--full-container);\\n    }\\n\\n    .medium .modal-inner {\\n        width: calc(100vw - var(--screen-padding) * 2);\\n        border-radius: var(--border-radius-big);\\n        max-width: var(--full-container);\\n    }\\n    .big .modal-inner {\\n        width: calc(100% - var(--screen-padding) * 2);\\n        height: calc(100% - var(--screen-padding) * 2);\\n        border-radius: var(--border-radius-big);\\n        max-width: var(--full-container);\\n    }\\n\\n    .full {\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    .full .modal-inner {\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        width: 100%;\\n        min-height: 100%;\\n        border-radius: 0;\\n    }\\n\\n    .modal-header {\\n        -webkit-transform: translateZ(0);\\n                transform: translateZ(0);\\n        z-index: 9;\\n        position: fixed;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: justify;\\n            -ms-flex-pack: justify;\\n                justify-content: space-between;\\n        color: rgb(var(--color-white));\\n        background-color: rgb(var(--color-info));\\n        opacity: 0;\\n        pointer-events: none;\\n        -webkit-transform-origin: 50% 50vh;\\n                transform-origin: 50% 50vh;\\n    }\\n\\n    .modal-header-relative {\\n        -webkit-transform: translateZ(0);\\n                transform: translateZ(0);\\n        z-index: 9;\\n        position: relative;\\n        width: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: justify;\\n            -ms-flex-pack: justify;\\n                justify-content: space-between;\\n        color: rgb(var(--color-white));\\n        background-color: rgb(var(--color-info));\\n    }\\n\\n    .modal-header .close,\\n    .modal-header-relative .close {\\n        font-size: 24px;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        width: 50px;\\n        height: 60px;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>   \\n\"],\"names\":[],\"mappings\":\"AA8SI,MAAM,8BAAC,CAAC,AACJ,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,CAC9B,gBAAgB,CAAE,YAAY,CAC1B,YAAY,CAAE,YAAY,CAC9B,mBAAmB,CAAE,IAAI,CACtB,gBAAgB,CAAE,IAAI,CACrB,eAAe,CAAE,IAAI,CACjB,WAAW,CAAE,IAAI,CACzB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,OAAO,CAAE,KAAK,CAAC,KAAK,CAAC,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CAClD,kCAAkC,CAAE,QAAQ,CACpC,0BAA0B,CAAE,QAAQ,CAC5C,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,MAAM,qCAAO,CAAE,aAAa,OAAO,8BAAC,CAAC,AACjC,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,YAAY,8BAAC,CAAC,AACV,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,CAC9B,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,CAChC,QAAQ,CAAE,MAAM,CAChB,iBAAiB,CAAE,WAAW,CAAC,CAAC,CACxB,SAAS,CAAE,WAAW,CAAC,CAAC,CAChC,gBAAgB,CAAE,KAAK,IAAI,qBAAqB,CAAC,CAAC,AACtD,CAAC,AACD,qBAAM,CAAC,YAAY,eAAC,CAAC,AACjB,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,IAAI,mBAAmB,CAAC,CACvC,SAAS,CAAE,IAAI,gBAAgB,CAAC,AACpC,CAAC,AAED,sBAAO,CAAC,YAAY,eAAC,CAAC,AAClB,KAAK,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAC9C,aAAa,CAAE,IAAI,mBAAmB,CAAC,CACvC,SAAS,CAAE,IAAI,gBAAgB,CAAC,AACpC,CAAC,AACD,mBAAI,CAAC,YAAY,eAAC,CAAC,AACf,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAC7C,MAAM,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,gBAAgB,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAC9C,aAAa,CAAE,IAAI,mBAAmB,CAAC,CACvC,SAAS,CAAE,IAAI,gBAAgB,CAAC,AACpC,CAAC,AAED,KAAK,8BAAC,CAAC,AACH,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,oBAAK,CAAC,YAAY,eAAC,CAAC,AAChB,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,aAAa,CAAE,CAAC,AACpB,CAAC,AAED,aAAa,8BAAC,CAAC,AACX,iBAAiB,CAAE,WAAW,CAAC,CAAC,CACxB,SAAS,CAAE,WAAW,CAAC,CAAC,CAChC,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,aAAa,CACtC,KAAK,CAAE,IAAI,IAAI,aAAa,CAAC,CAAC,CAC9B,gBAAgB,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,CACxC,OAAO,CAAE,CAAC,CACV,cAAc,CAAE,IAAI,CACpB,wBAAwB,CAAE,GAAG,CAAC,IAAI,CAC1B,gBAAgB,CAAE,GAAG,CAAC,IAAI,AACtC,CAAC,AAED,sBAAsB,8BAAC,CAAC,AACpB,iBAAiB,CAAE,WAAW,CAAC,CAAC,CACxB,SAAS,CAAE,WAAW,CAAC,CAAC,CAChC,OAAO,CAAE,CAAC,CACV,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,aAAa,CACtC,KAAK,CAAE,IAAI,IAAI,aAAa,CAAC,CAAC,CAC9B,gBAAgB,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,AAC5C,CAAC,AAED,4BAAa,CAAC,qBAAM,CACpB,qCAAsB,CAAC,MAAM,eAAC,CAAC,AAC3B,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC\"}"
};
...
const Modal = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	? `${validate_component(Portal, "Portal").$$render($$result, { id }, {}, {
			default: () => `
        <div${add_attribute("id", `modal-${id}`, 0)} aria-hidden="${"true"}" class="${escape(null_to_empty(classProp)) + " svelte-1x0eyqh"}"${add_attribute("this", ref, 1)}>
			...
			? `${validate_component(Portal, "Portal").$$render($$result, {}, {}, {
					...
					? $$slots.header({})
					: `
                        <button type="${"button"}" class="${escape(null_to_empty(classnames("modal-header", { active }))) + " svelte-1x0eyqh"}"${add_attribute("this", refHeader, 1)}>
                            <h2 style="${"padding: 15px"}">${escape(title)}</h2>
                            <span class="${"close svelte-1x0eyqh"}">
			...
			: ``}
            <div class="${"modal-inner svelte-1x0eyqh"}" tabindex="${"-1"}" role="${"dialog"}" aria-modal="${"true"}" aria-labelledby="${"модальне вікно"}">
                ${withHeader && size !== "full"
			? `${$$slots.header
				? $$slots.header({
				...
				: `
                        <button type="${"button"}" class="${escape(null_to_empty(classnames("modal-header-relative active"))) + " svelte-1x0eyqh"}">
                            <h2 style="${"padding: 15px"}">${escape(title)}</h2>
                            <span class="${"close svelte-1x0eyqh"}">
                                 ${validate_component(Icon, "Icon").$$render($$result, { type: "close", size: "big", is: "light" }, {}, {})}
                            </span>
...
const css$6 = {
	code: "section.svelte-16c88fv{position:relative;width:100%;overflow:hidden;-webkit-transform:translateZ(0);transform:translateZ(0)}section.svelte-16c88fv:after{content:\"\";display:block;padding-top:100%}div.svelte-16c88fv{position:absolute;top:0;left:0;right:0;bottom:0;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}",
	map: "{\"version\":3,\"file\":\"Square.svelte\",\"sources\":[\"Square.svelte\"],\"sourcesContent\":[\"<script>\\n    export let style = undefined\\n</script>  \\n\\n<section {style} class={`square ${$$props.class || ''}`}>\\n    <div>\\n        <slot></slot>\\n    </div>\\n</section>\\n\\n<style>\\n    section {\\n        position: relative;\\n        width: 100%;\\n        overflow: hidden;\\n        -webkit-transform: translateZ(0);\\n                transform: translateZ(0);\\n    }\\n\\n    section:after {\\n        content: \\\"\\\";\\n        display: block;\\n        padding-top: 100%;\\n    }\\n\\n    div {\\n        position: absolute;\\n        top: 0;\\n        left: 0;\\n        right: 0;\\n        bottom: 0;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-orient: vertical;\\n        -webkit-box-direction: normal;\\n            -ms-flex-direction: column;\\n                flex-direction: column;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAWI,OAAO,eAAC,CAAC,AACL,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,QAAQ,CAAE,MAAM,CAChB,iBAAiB,CAAE,WAAW,CAAC,CAAC,CACxB,SAAS,CAAE,WAAW,CAAC,CAAC,AACpC,CAAC,AAED,sBAAO,MAAM,AAAC,CAAC,AACX,OAAO,CAAE,EAAE,CACX,OAAO,CAAE,KAAK,CACd,WAAW,CAAE,IAAI,AACrB,CAAC,AAED,GAAG,eAAC,CAAC,AACD,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,AAClC,CAAC\"}"
};
...
const Square = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section${add_attribute("style", style, 0)} class="${escape(null_to_empty(`square ${$$props.class || ""}`)) + " svelte-16c88fv"}">
    <div class="${"svelte-16c88fv"}">
        ${$$slots.default ? $$slots.default({}) : ``}
    </div>
</section>`;
});
...
const css$d = {
	code: ".carousel.rounded.svelte-1mgw1u7.svelte-1mgw1u7>.carousel-inner.svelte-1mgw1u7.svelte-1mgw1u7{border-radius:var(--border-radius-big)}.carousel.svelte-1mgw1u7.svelte-1mgw1u7.svelte-1mgw1u7,.carousel-inner.svelte-1mgw1u7.svelte-1mgw1u7.svelte-1mgw1u7,.carousel-inner.svelte-1mgw1u7.svelte-1mgw1u7>li.svelte-1mgw1u7.svelte-1mgw1u7{position:relative;-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;text-align:left;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}.carousel.dots.dotsBelow.filled.svelte-1mgw1u7.svelte-1mgw1u7.svelte-1mgw1u7{padding-bottom:40px}.carousel.filled.svelte-1mgw1u7.svelte-1mgw1u7>.carousel-inner.svelte-1mgw1u7.svelte-1mgw1u7{background-color:transparent}.carousel.dotsBelow.svelte-1mgw1u7.svelte-1mgw1u7 .carousel-dots.svelte-1mgw1u7.svelte-1mgw1u7{bottom:0}.carousel.dotsBelow.svelte-1mgw1u7.svelte-1mgw1u7 .carousel-dots li.svelte-1mgw1u7.svelte-1mgw1u7{background-color:rgba(var(--theme-bg-color-opposite))}.carousel.stretch.svelte-1mgw1u7>.carousel-inner.svelte-1mgw1u7>.fluid.svelte-1mgw1u7{-webkit-box-flex:0;-ms-flex:none;flex:none;width:100%}.carousel.auto.svelte-1mgw1u7>.carousel-inner.svelte-1mgw1u7>.fluid.svelte-1mgw1u7{width:auto}.carousel.svelte-1mgw1u7.svelte-1mgw1u7.svelte-1mgw1u7{width:100%}.carousel.svelte-1mgw1u7.svelte-1mgw1u7>.carousel-inner.svelte-1mgw1u7.svelte-1mgw1u7{width:100%;overflow-y:hidden;overflow-x:scroll;background-color:rgba(var(--theme-bg-color-opposite), .04)}.carousel-dots.svelte-1mgw1u7.svelte-1mgw1u7.svelte-1mgw1u7{position:absolute;left:0;bottom:10px;width:100%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;justify-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-1mgw1u7.svelte-1mgw1u7 li.svelte-1mgw1u7.svelte-1mgw1u7{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;-webkit-box-shadow:var(--shadow-primary);box-shadow:var(--shadow-primary);background-color:rgba(var(--color-light))}.carousel-dots.svelte-1mgw1u7.svelte-1mgw1u7 li.svelte-1mgw1u7.svelte-1mgw1u7:not(.active){opacity:.5}.carousel-dots.svelte-1mgw1u7.svelte-1mgw1u7 li.active.svelte-1mgw1u7.svelte-1mgw1u7{-webkit-transform:scale(1.5);transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil, classnames } from '@utils'\\n    import Picture from '@components/Picture.svelte'\\n    import FancyBox from '@components/FancyBox.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let dotsBelow = true\\n    export let rounded = true\\n    export let size = 'stretch'\\n    export let initIndex = 0\\n    export let disableFancy = false\\n    export let stopPropagation = undefined\\n\\n    let parent = null\\n\\n    $: activeDot = initIndex\\n    $: classProp = classnames('carousel', size, $$props.class, { dots, dotsBelow, rounded, filled: items && items.length })\\n    $: setScrollPosition(parent, initIndex)\\n\\n    function carousel(node) {\\n        node.ontouchstart = e => stopPropagation && (e.stopPropagation())\\n        node.ontouchmove = e => stopPropagation && (e.stopPropagation())\\n        node.ontouchend = e => stopPropagation && (e.stopPropagation())\\n\\n        parent = node\\n        setScrollPosition(node, activeDot)\\n        node.addEventListener('scroll', onScroll)\\n        return { \\n            destroy: () => {\\n                node.removeEventListener('scroll', onScroll)\\n                node.ontouchstart= null\\n                node.ontouchmove= null\\n                node.ontouchend= null\\n            }\\n        }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft, scrollWidth, offsetWidth } = parent\\n        const dotAmount = Array.from(parent.children).length\\n        const scrollX = scrollLeft / (scrollWidth - offsetWidth)\\n        const newActiveDot = Math.round(scrollX * (dotAmount - 1))\\n        if (activeDot !== newActiveDot && !isNaN(newActiveDot)) activeDot = newActiveDot\\n    }\\n\\n    function setScrollPosition(parent, activeDot) {\\n        if (!parent) return\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = Math.round(width * activeDot)\\n            if (parent.scrollLeft !== Math.round(width * activeDot)) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class={classProp}>\\n    <ul \\n        use:carousel\\n        class=\\\"carousel-inner scroll-x-center\\\"\\n    >\\n        {#if items !== null}\\n            {#each items as item, index}\\n                <li class=\\\"fluid\\\" role=\\\"button\\\" on:click={onClick.bind(null, item, index)}>\\n                    <slot {item} {index}>\\n                        <FancyBox disabled={disableFancy}>\\n                            <Picture key=\\\"picture\\\" {...item} alt={item.alt || 'Фото слайду'}/>\\n                            <section slot=\\\"box\\\" class=\\\"flex full-width\\\">\\n                                <Picture key=\\\"picture\\\" {...item} alt={item.alt || 'Фото слайду'}/>\\n                            </section>\\n                        </FancyBox>\\n                    </slot>\\n                </li>\\n            {/each}\\n        {/if}\\n    </ul>\\n\\n\\n    {#if dots && Array.isArray(items)}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel.rounded > .carousel-inner {\\n       border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel, .carousel-inner, .carousel-inner > li {\\n        position: relative;\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        text-align: left;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    .carousel.dots.dotsBelow.filled {\\n        padding-bottom: 40px;\\n    }\\n\\n    .carousel.filled > .carousel-inner {\\n        background-color: transparent;\\n    }\\n\\n    .carousel.dotsBelow .carousel-dots {\\n        bottom: 0;\\n    }\\n\\n    .carousel.dotsBelow .carousel-dots li {\\n        background-color: rgba(var(--theme-bg-color-opposite));\\n    }\\n\\n    .carousel.stretch > .carousel-inner > .fluid {\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        width: 100%;\\n    }\\n\\n    .carousel.auto > .carousel-inner > .fluid {\\n        width: auto;\\n    }\\n\\n    .carousel {\\n        width: 100%;\\n    }\\n\\n    /* 3d out for good accessibility of desktop brows of desktop browsers */\\n    /*.carousel-inner::-webkit-scrollbar {*/\\n    /*    display: none;*/\\n    /*}*/\\n\\n    .carousel > .carousel-inner {\\n        width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n        background-color: rgba(var(--theme-bg-color-opposite), .04);\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        left: 0;\\n        bottom: 10px;\\n        width: 100%;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        justify-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        -webkit-box-shadow: var(--shadow-primary);\\n                box-shadow: var(--shadow-primary);\\n        background-color: rgba(var(--color-light));\\n    }\\n\\n    .carousel-dots li:not(.active) {\\n        opacity: .5;\\n    }\\n\\n    .carousel-dots li.active {\\n        -webkit-transform: scale(1.5);\\n                transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAkHI,SAAS,sCAAQ,CAAG,eAAe,8BAAC,CAAC,AAClC,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC1C,CAAC,AAED,sDAAS,CAAE,4DAAe,CAAE,6CAAe,CAAG,EAAE,8BAAC,CAAC,AAC9C,QAAQ,CAAE,QAAQ,CAClB,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,IAAI,CAChB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,SAAS,KAAK,UAAU,OAAO,6CAAC,CAAC,AAC7B,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,SAAS,qCAAO,CAAG,eAAe,8BAAC,CAAC,AAChC,gBAAgB,CAAE,WAAW,AACjC,CAAC,AAED,SAAS,wCAAU,CAAC,cAAc,8BAAC,CAAC,AAChC,MAAM,CAAE,CAAC,AACb,CAAC,AAED,SAAS,wCAAU,CAAC,cAAc,CAAC,EAAE,8BAAC,CAAC,AACnC,gBAAgB,CAAE,KAAK,IAAI,yBAAyB,CAAC,CAAC,AAC1D,CAAC,AAED,SAAS,uBAAQ,CAAG,8BAAe,CAAG,MAAM,eAAC,CAAC,AAC1C,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,oBAAK,CAAG,8BAAe,CAAG,MAAM,eAAC,CAAC,AACvC,KAAK,CAAE,IAAI,AACf,CAAC,AAED,SAAS,6CAAC,CAAC,AACP,KAAK,CAAE,IAAI,AACf,CAAC,AAOD,uCAAS,CAAG,eAAe,8BAAC,CAAC,AACzB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,KAAK,IAAI,yBAAyB,CAAC,CAAC,CAAC,GAAG,CAAC,AAC/D,CAAC,AAED,cAAc,6CAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,IAAI,CAAE,CAAC,CACP,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,aAAa,CAAE,MAAM,CACrB,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,4CAAc,CAAC,EAAE,8BAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,kBAAkB,CAAE,IAAI,gBAAgB,CAAC,CACjC,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,AAC9C,CAAC,AAED,4CAAc,CAAC,gCAAE,KAAK,OAAO,CAAC,AAAC,CAAC,AAC5B,OAAO,CAAE,EAAE,AACf,CAAC,AAED,4CAAc,CAAC,EAAE,OAAO,8BAAC,CAAC,AACtB,iBAAiB,CAAE,MAAM,GAAG,CAAC,CACrB,SAAS,CAAE,MAAM,GAAG,CAAC,AACjC,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${escape(null_to_empty(classProp)) + " svelte-1mgw1u7"}">
    <ul class="${"carousel-inner scroll-x-center svelte-1mgw1u7"}">
        ${items !== null
	? `${each(items, (item, index) => `<li class="${"fluid svelte-1mgw1u7"}" role="${"button"}">
                    ${$$slots.default
	...
	? `<ul class="${"carousel-dots svelte-1mgw1u7"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-1mgw1u7"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
...
const EditArea = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section role="${"button"}" class="${escape(null_to_empty(classProp)) + " svelte-1o6yo6m"}">
    ${$$slots.default ? $$slots.default({}) : ``}
...
const css$h = {
	code: ".inp.svelte-10lwbbl.svelte-10lwbbl{width:100%;-webkit-box-flex:1;-ms-flex:1 1 auto;flex:1 1 auto;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.inp.svelte-10lwbbl .inp-inner-wrap.svelte-10lwbbl{position:relative;display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-shadow:var(--shadow-field-inset);box-shadow:var(--shadow-field-inset);border-radius:var(--border-radius-small);background-color:rgba(var(--theme-input-bg-color))}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl{-webkit-box-flex:1;-ms-flex-positive:1;flex-grow:1;color:inherit;overflow-y:auto;overflow-x:hidden;background-color:transparent;-webkit-overflow-scrolling:touch;min-width:var(--min-interactive-size);min-height:var(--min-interactive-size);border-radius:var(--border-radius-small)}.inp.disabled.svelte-10lwbbl.svelte-10lwbbl{opacity:.5;pointer-events:none}.inp.postIcon.svelte-10lwbbl .inp-inner.svelte-10lwbbl{padding-right:var(--min-interactive-size)}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl:invalid,.inp.error.svelte-10lwbbl .inp-inner.svelte-10lwbbl{-webkit-box-shadow:0 0 0 1px rgb(var(--color-danger));box-shadow:0 0 0 1px rgb(var(--color-danger));color:rgb(var(--color-danger))}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl:focus{-webkit-box-shadow:0 0 0 1px rgb(var(--color-info));box-shadow:0 0 0 1px rgb(var(--color-info));color:rgb(var(--color-info))}.inp .inp-inner:invalid+.inp-post-icon.svelte-10lwbbl.svelte-10lwbbl .ico,.inp.error.svelte-10lwbbl .inp-post-icon.svelte-10lwbbl .ico{color:rgb(var(--color-danger)) !important}.inp .inp-inner:focus+.inp-post-icon.svelte-10lwbbl.svelte-10lwbbl .ico{color:rgb(var(--color-info)) !important}.inp.svelte-10lwbbl .inp-post-icon-inner.svelte-10lwbbl{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;width:var(--min-interactive-size)}.inp.svelte-10lwbbl .inp-post-icon.svelte-10lwbbl{position:absolute;top:0;right:0;height:100%;width:var(--min-interactive-size);-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;overflow:hidden}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl::-webkit-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl::-moz-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl:-ms-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl::-ms-input-placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}.inp.svelte-10lwbbl .inp-inner.svelte-10lwbbl::placeholder{color:rgba(var(--theme-color-primary-opposite));opacity:.2}",
	map: "{\"version\":3,\"file\":\"Input.svelte\",\"sources\":[\"Input.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { classnames, toCSSString } from '@utils'\\n    import Br from '@components/Br.svelte'\\n    import Icon from '@components/Icon.svelte'\\n    import FieldErrors from '@components/FieldErrors.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    export let name\\n    export let value = ''\\n    export let style = {}\\n    export let type = 'text'\\n    export let id = undefined\\n    export let min = undefined // Specifies a minimum value for an <input> element\\n    export let max = undefined // Specifies the maximum value for an <input> element\\n    export let list = undefined // Refers to a <datalist> element that contains pre-defined options for an <input> element\\n    export let form = undefined // Specifies the form the <input> element belongs to\\n    export let maxlength = 1000\\n    export let disabled = false\\n    export let rows = undefined\\n    export let align = undefined\\n    export let label = undefined\\n    export let errors = undefined\\n    export let invalid = undefined\\n    export let pattern = undefined // Specifies a regular expression that an <input> element's value is checked against (regexp)\\n    export let readonly = undefined // undefined|readonly\\n    export let required = undefined // undefined|required\\n    export let postIcon = undefined\\n    export let ariaLabel = undefined\\n    export let minlength = undefined\\n    export let placeholder = undefined\\n    export let autocomplete = undefined// on|off\\n\\n    /**\\n     * autocomplete - https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete\\n     * names - https://developers.google.com/web/updates/2015/06/checkout-faster-with-autofill\\n     */\\n    const nameTypes = {\\n        'sex': { autocomplete: 'sex' },\\n        'bday': { autocomplete: 'bday' },\\n        'name': { autocomplete: 'name' },\\n        'phone': { autocomplete: 'tel' },\\n        'fname': { autocomplete: 'name' },\\n        'lname': { autocomplete: 'name' },\\n        'email': { autocomplete: 'email' },\\n        'password': { autocomplete: 'new-password' },\\n        \\n        'cvc': { autocomplete: 'cc-csc' },\\n        'cc-exp': { autocomplete: 'cc-exp' },\\n        'ccname': { autocomplete: 'cc-name' },\\n        'cardnumber': { autocomplete: 'cc-number' },\\n\\n        'ship-state': { autocomplete: 'shipping region' },\\n        'ship-city': { autocomplete: 'shipping locality' },\\n        'ship-zip': { autocomplete: 'shipping postal-code' },\\n        'ship-country': { autocomplete: 'shipping country' },\\n        'ship-address': { autocomplete: 'shipping street-address' },\\n    }\\n\\n    const typePostIcons = {\\n      date: 'calendar',\\n      search: 'search',\\n    }\\n\\n    $: inputPredict = nameTypes[name] || {}\\n    $: iconType = postIcon || typePostIcons[type]\\n\\n    $: error = invalid !== undefined ? invalid : !!(errors || []).length\\n    $: idProp = id || inputPredict.id || name\\n    $: typeProp = type\\n    $: titleProp = label || ariaLabel\\n    $: ariaLabelProp = ariaLabel || label || placeholder\\n    $: styleProp = toCSSString({ ...style, textAlign: align })\\n    $: patternProp = type === 'number' && !pattern ? '[0-9]*' : pattern\\n    $: classProp = classnames('inp', $$props.class, { disabled, readonly, required, error, postIcon: iconType })\\n    $: autocompleteProp = autocomplete || inputPredict.autocomplete\\n\\n    function onInput(e) {\\n        const value = getValue(e)\\n        dispatch('input', { e, value, name })\\n    }\\n\\n    function onChange(e) {\\n        const value = getValue(e)\\n        dispatch('change', { e, value, name })\\n    }\\n\\n    function getValue(e) {\\n        return e.target.value\\n    }\\n</script>\\n\\n<div class={classProp}>\\n    {#if titleProp}\\n        <label for={idProp} class=\\\"inp-label h2 font-secondary font-w-600 text-left\\\">\\n            { titleProp }\\n            <Br size=\\\"10\\\"/>\\n        </label>\\n    {/if}\\n\\n    <div class=\\\"inp-inner-wrap\\\">\\n        {#if rows || type === 'textarea'}\\n            <textarea\\n                    {min}\\n                    {max}\\n                    {rows}\\n                    {name}\\n                    {form}\\n                    {align}\\n                    {readonly}\\n                    {disabled}\\n                    {required}\\n                    {minlength}\\n                    {maxlength}\\n                    {placeholder}\\n                    id={idProp}\\n                    class=\\\"inp-inner\\\"\\n                    title={titleProp}\\n                    style={styleProp}\\n                    pattern={patternProp}\\n                    aria-label={ariaLabelProp}\\n                    autocomplete={autocompleteProp}\\n                    {...{ type: typeProp }}\\n                    bind:value={value}\\n                    on:input={onInput}\\n                    on:change={onChange}\\n                    on:blur='{e => !disabled && dispatch(\\\"blur\\\", e)}'\\n                    on:focus='{e => !disabled && dispatch(\\\"focus\\\", e)}'\\n            ></textarea>\\n        {:else}\\n            <input\\n                    {min}\\n                    {max}\\n                    {name}\\n                    {list}\\n                    {form}\\n                    {align}\\n                    {readonly}\\n                    {disabled}\\n                    {required}\\n                    {minlength}\\n                    {maxlength}\\n                    {placeholder}\\n                    id={idProp}\\n                    class=\\\"inp-inner\\\"\\n                    title={titleProp}\\n                    style={styleProp}\\n                    pattern={patternProp}\\n                    aria-label={ariaLabelProp}\\n                    autocomplete={autocompleteProp}\\n                    {...{ type: typeProp }}\\n                    bind:value={value}\\n                    on:input={onInput}\\n                    on:change={onChange}\\n                    on:blur='{e => !disabled && dispatch(\\\"blur\\\", e)}'\\n                    on:focus='{e => !disabled && dispatch(\\\"focus\\\", e)}'\\n            >\\n        {/if}\\n\\n        <label for={idProp} class=\\\"inp-post-icon\\\">\\n            <slot name=\\\"post-icon\\\">\\n                {#if iconType}\\n                    <span class=\\\"inp-post-icon-inner\\\">\\n                        <Icon type={iconType} is=\\\"info\\\" size=\\\"medium\\\"/>\\n                    </span>\\n                {/if}\\n            </slot>\\n        </label>\\n    </div>\\n\\n    <FieldErrors items={errors}>\\n        <div slot=\\\"before\\\">\\n            <Br size=\\\"5\\\"/>\\n        </div>\\n    </FieldErrors>\\n</div>\\n\\n<style>\\n    .inp {\\n        width: 100%;\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 auto;\\n                flex: 1 1 auto;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-orient: vertical;\\n        -webkit-box-direction: normal;\\n            -ms-flex-direction: column;\\n                flex-direction: column;\\n    }\\n\\n    .inp .inp-inner-wrap {\\n        position: relative;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-shadow: var(--shadow-field-inset);\\n                box-shadow: var(--shadow-field-inset);\\n        border-radius: var(--border-radius-small);\\n        background-color: rgba(var(--theme-input-bg-color));\\n    }\\n\\n    .inp .inp-inner {\\n        -webkit-box-flex: 1;\\n            -ms-flex-positive: 1;\\n                flex-grow: 1;\\n        color: inherit;\\n        overflow-y: auto;\\n        overflow-x: hidden;\\n        background-color: transparent;\\n        -webkit-overflow-scrolling: touch;\\n        min-width: var(--min-interactive-size);\\n        min-height: var(--min-interactive-size);\\n        border-radius: var(--border-radius-small);\\n    }\\n\\n    .inp.disabled {\\n        opacity: .5;\\n        pointer-events: none;\\n    }\\n\\n    .inp.postIcon .inp-inner {\\n        padding-right: var(--min-interactive-size);\\n    }\\n\\n    .inp .inp-inner:invalid, .inp.error .inp-inner {\\n        -webkit-box-shadow: 0 0 0 1px rgb(var(--color-danger));\\n                box-shadow: 0 0 0 1px rgb(var(--color-danger));\\n        color: rgb(var(--color-danger));\\n    }\\n\\n    .inp .inp-inner:focus {\\n        -webkit-box-shadow: 0 0 0 1px rgb(var(--color-info));\\n                box-shadow: 0 0 0 1px rgb(var(--color-info));\\n        color: rgb(var(--color-info));\\n    }\\n\\n\\n    .inp .inp-inner:invalid + .inp-post-icon :global(.ico),\\n    .inp.error .inp-post-icon :global(.ico) {\\n        color: rgb(var(--color-danger)) !important;\\n    }\\n\\n    .inp .inp-inner:focus + .inp-post-icon :global(.ico) {\\n        color: rgb(var(--color-info)) !important;\\n    }\\n\\n    .inp .inp-post-icon-inner {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        width: var(--min-interactive-size);\\n    }\\n\\n    .inp .inp-post-icon {\\n        position: absolute;\\n        top: 0;\\n        right: 0;\\n        height: 100%;\\n        width: var(--min-interactive-size);\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        overflow: hidden;\\n    }\\n\\n    .inp .inp-inner::-webkit-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner::-moz-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner:-ms-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner::-ms-input-placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n    .inp .inp-inner::placeholder {\\n        color: rgba(var(--theme-color-primary-opposite));\\n        opacity: .2;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAmLI,IAAI,8BAAC,CAAC,AACF,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACtB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,kBAAkB,CAAE,QAAQ,CAC5B,qBAAqB,CAAE,MAAM,CACzB,kBAAkB,CAAE,MAAM,CACtB,cAAc,CAAE,MAAM,AAClC,CAAC,AAED,mBAAI,CAAC,eAAe,eAAC,CAAC,AAClB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,kBAAkB,CAAE,IAAI,oBAAoB,CAAC,CACrC,UAAU,CAAE,IAAI,oBAAoB,CAAC,CAC7C,aAAa,CAAE,IAAI,qBAAqB,CAAC,CACzC,gBAAgB,CAAE,KAAK,IAAI,sBAAsB,CAAC,CAAC,AACvD,CAAC,AAED,mBAAI,CAAC,UAAU,eAAC,CAAC,AACb,gBAAgB,CAAE,CAAC,CACf,iBAAiB,CAAE,CAAC,CAChB,SAAS,CAAE,CAAC,CACpB,KAAK,CAAE,OAAO,CACd,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,WAAW,CAC7B,0BAA0B,CAAE,KAAK,CACjC,SAAS,CAAE,IAAI,sBAAsB,CAAC,CACtC,UAAU,CAAE,IAAI,sBAAsB,CAAC,CACvC,aAAa,CAAE,IAAI,qBAAqB,CAAC,AAC7C,CAAC,AAED,IAAI,SAAS,8BAAC,CAAC,AACX,OAAO,CAAE,EAAE,CACX,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,IAAI,wBAAS,CAAC,UAAU,eAAC,CAAC,AACtB,aAAa,CAAE,IAAI,sBAAsB,CAAC,AAC9C,CAAC,AAED,mBAAI,CAAC,yBAAU,QAAQ,CAAE,IAAI,qBAAM,CAAC,UAAU,eAAC,CAAC,AAC5C,kBAAkB,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,cAAc,CAAC,CAAC,CAC9C,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,cAAc,CAAC,CAAC,CACtD,KAAK,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,AACnC,CAAC,AAED,mBAAI,CAAC,yBAAU,MAAM,AAAC,CAAC,AACnB,kBAAkB,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,YAAY,CAAC,CAAC,CAC5C,UAAU,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,IAAI,IAAI,YAAY,CAAC,CAAC,CACpD,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,AACjC,CAAC,AAGD,IAAI,CAAC,UAAU,QAAQ,CAAG,4CAAc,CAAC,AAAQ,IAAI,AAAC,CACtD,IAAI,qBAAM,CAAC,6BAAc,CAAC,AAAQ,IAAI,AAAE,CAAC,AACrC,KAAK,CAAE,IAAI,IAAI,cAAc,CAAC,CAAC,CAAC,UAAU,AAC9C,CAAC,AAED,IAAI,CAAC,UAAU,MAAM,CAAG,4CAAc,CAAC,AAAQ,IAAI,AAAE,CAAC,AAClD,KAAK,CAAE,IAAI,IAAI,YAAY,CAAC,CAAC,CAAC,UAAU,AAC5C,CAAC,AAED,mBAAI,CAAC,oBAAoB,eAAC,CAAC,AACvB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,KAAK,CAAE,IAAI,sBAAsB,CAAC,AACtC,CAAC,AAED,mBAAI,CAAC,cAAc,eAAC,CAAC,AACjB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,sBAAsB,CAAC,CAClC,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,QAAQ,CAAE,MAAM,AACpB,CAAC,AAED,mBAAI,CAAC,yBAAU,2BAA2B,AAAC,CAAC,AACxC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,kBAAkB,AAAC,CAAC,AAC/B,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,sBAAsB,AAAC,CAAC,AACnC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,uBAAuB,AAAC,CAAC,AACpC,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC,AAED,mBAAI,CAAC,yBAAU,aAAa,AAAC,CAAC,AAC1B,KAAK,CAAE,KAAK,IAAI,8BAA8B,CAAC,CAAC,CAChD,OAAO,CAAE,EAAE,AACf,CAAC\"}"
};
 ...
 */
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-10lwbbl"}">
    ${titleProp
    ...
    <div class="${"inp-inner-wrap svelte-10lwbbl"}">
        ${rows || type === "textarea"
	? `<textarea${spread(
			[
				{ min: escape(min) },
	...
	: `<input${spread(
        ...
        <label${add_attribute("for", idProp, 0)} class="${"inp-post-icon svelte-10lwbbl"}">
            ${$$slots["post-icon"]
	? $$slots["post-icon"]({})
	: `
                ${iconType
		? `<span class="${"inp-post-icon-inner svelte-10lwbbl"}">
...
const AvatarUpload = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div${add_attribute("id", id, 0)}${add_attribute("class", classProp, 0)}>
    ${label
	? `<h2 class="${"text-left"}">
            ${escape(label)}
            ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}
...
const StoryList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section${add_attribute("class", classProp, 0)}${add_attribute("style", styleProp, 0)}>
    ${label
	? `<h2 class="${"text-left"}">${escape(label)}</h2>
        ${validate_component(Br, "Br").$$render($$result, { size: "10" }, {}, {})}`
	: ``}
...
const SearchLine = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    ${validate_component(Input, "Input").$$render($$result, { type: "search" }, {}, {})}
</section>`;
});
...
const FundCards = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${escape(null_to_empty(!index
		? "start"
		: index === items.length - 1 ? "end" : "")) + " svelte-1lylfp9"}"${add_attribute("key", item.id, 0)}>
...
const ignore = [/^\/organizations\/components\/?$/, /^\/organizations\/edit\/?$/, /^\/organizations\/view\/?$/, /^\/funds\/components\/?$/, /^\/funds\/edit\/?$/, /^\/funds\/view\/?$/];
...
const css$J = {
	code: ".list-wrap.svelte-151vlup.svelte-151vlup{-webkit-box-flex:1;-ms-flex:1 1 0px;flex:1 1 0;overflow-x:hidden;overflow-y:auto;padding:0 var(--screen-padding)}nav.svelte-151vlup ul.svelte-151vlup,nav.svelte-151vlup li.svelte-151vlup{display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}li.svelte-151vlup.svelte-151vlup{-webkit-box-flex:1;-ms-flex:1 1 0px;flex:1 1 0}li.svelte-151vlup a.svelte-151vlup{-webkit-box-flex:1;-ms-flex:1 1 0px;flex:1 1 0;-ms-flex-item-align:stretch;align-self:stretch;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;text-align:center;padding:20px 10px}li.svelte-151vlup a.svelte-151vlup:hover,li.svelte-151vlup a.selected.svelte-151vlup{background-color:rgba(var(--color-black), .1)}",
	map: "{\"version\":3,\"file\":\"_layout.svelte\",\"sources\":[\"_layout.svelte\"],\"sourcesContent\":[\"<script>\\n    import { Br, Footer, SearchLine } from '@components'\\n\\n    export let segment\\n</script>\\n\\n<main class=\\\"layout list-layout theme-bg-color-secondary\\\">\\n    <section class=\\\"theme-bg container shadow-secondary\\\">\\n        <Br size=\\\"var(--header-height)\\\"/>\\n\\n        <div class=\\\"overflow-hidden\\\"><Br size=\\\"20\\\"/></div>\\n        <SearchLine/>\\n        <div class=\\\"overflow-hidden\\\"><Br size=\\\"20\\\"/></div>\\n    </section>\\n\\n    <section class=\\\"container\\\">\\n        <div class=\\\"overflow-hidden\\\"><Br size=\\\"30\\\"/></div>\\n        <nav>\\n            <ul>\\n                <li><a rel=prefetch href='lists/funds' class:selected='{segment === \\\"charities\\\"}'>Фонди</a></li>\\n                <li><a rel=prefetch href='lists/organizations' class:selected='{segment === \\\"organizations\\\"}'>Оргранізації</a></li>\\n            </ul>\\n        </nav>\\n    </section>\\n\\n    <div class=\\\"list-wrap\\\">\\n        <br>\\n\\n        <slot></slot>\\n\\n        <br>\\n        <br>\\n    </div>\\n\\n    <Footer/>\\n</main>\\n\\n<style>\\n    .list-wrap {\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 0px;\\n                flex: 1 1 0;\\n        overflow-x: hidden;\\n        overflow-y: auto;\\n        padding: 0 var(--screen-padding);\\n    }\\n\\n    nav ul, nav li {\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    li {\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 0px;\\n                flex: 1 1 0;\\n    }\\n\\n    li a {\\n        -webkit-box-flex: 1;\\n            -ms-flex: 1 1 0px;\\n                flex: 1 1 0;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        -webkit-box-align: center;\\n            -ms-flex-align: center;\\n                align-items: center;\\n        -webkit-box-pack: center;\\n            -ms-flex-pack: center;\\n                justify-content: center;\\n        text-align: center;\\n        padding: 20px 10px;\\n    }\\n\\n    li a:hover, li a.selected {\\n        background-color: rgba(var(--color-black), .1);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAsCI,UAAU,8BAAC,CAAC,AACR,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CACb,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CACnB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,CAAC,CAAC,IAAI,gBAAgB,CAAC,AACpC,CAAC,AAED,kBAAG,CAAC,iBAAE,CAAE,kBAAG,CAAC,EAAE,eAAC,CAAC,AACZ,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,EAAE,8BAAC,CAAC,AACA,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CACb,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,AACvB,CAAC,AAED,iBAAE,CAAC,CAAC,eAAC,CAAC,AACF,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CACb,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,CAAC,CACnB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,iBAAiB,CAAE,MAAM,CACrB,cAAc,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,CAC3B,gBAAgB,CAAE,MAAM,CACpB,aAAa,CAAE,MAAM,CACjB,eAAe,CAAE,MAAM,CAC/B,UAAU,CAAE,MAAM,CAClB,OAAO,CAAE,IAAI,CAAC,IAAI,AACtB,CAAC,AAED,iBAAE,CAAC,gBAAC,MAAM,CAAE,iBAAE,CAAC,CAAC,SAAS,eAAC,CAAC,AACvB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,EAAE,CAAC,AAClD,CAAC\"}"
};
...
const Layout$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main class="${"layout list-layout theme-bg-color-secondary"}">
    <section class="${"theme-bg container shadow-secondary"}">
        ${validate_component(Br, "Br").$$render($$result, { size: "var(--header-height)" }, {}, {})}

        <div class="${"overflow-hidden"}">${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}</div>
        ${validate_component(SearchLine, "SearchLine").$$render($$result, {}, {}, {})}
        <div class="${"overflow-hidden"}">${validate_component(Br, "Br").$$render($$result, { size: "20" }, {}, {})}</div>
    </section>

    <section class="${"container"}">
        <div class="${"overflow-hidden"}">${validate_component(Br, "Br").$$render($$result, { size: "30" }, {}, {})}</div>
        <nav class="${"svelte-151vlup"}">
            <ul class="${"svelte-151vlup"}">
                <li class="${"svelte-151vlup"}"><a rel="${"prefetch"}" href="${"lists/funds"}" class="${["svelte-151vlup", segment === "charities" ? "selected" : ""].join(" ").trim()}">Фонди</a></li>
                <li class="${"svelte-151vlup"}"><a rel="${"prefetch"}" href="${"lists/organizations"}" class="${["svelte-151vlup", segment === "organizations" ? "selected" : ""].join(" ").trim()}">Оргранізації</a></li>
            </ul>
        </nav>
    </section>

    <div class="${"list-wrap svelte-151vlup"}">
        <br>
