...
const css$9 = {
	code: ".fancy-box.svelte-vcv7h9{position:relative;width:100%;-webkit-box-flex:0;-ms-flex:none;flex:none;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;-ms-flex-item-align:stretch;align-self:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch}.fancy-box-ghost.svelte-vcv7h9{z-index:10;position:fixed;top:0;left:0;width:100%;height:100vh;display:-webkit-box;display:-ms-flexbox;display:flex;overflow:hidden;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;-webkit-box-pack:stretch;-ms-flex-pack:stretch;justify-content:stretch;background-color:rgba(var(--color-black), .75);outline:20px solid rgba(var(--color-black), .75);-webkit-transition:.2s ease-out;transition:.2s ease-out;opacity:0;-webkit-transform:translateY(20px);transform:translateY(20px);pointer-events:none}.fancy-box-ghost.active.svelte-vcv7h9{opacity:1;-webkit-transform:none;transform:none;pointer-events:auto}",
	map: "{\"version\":3,\"file\":\"FancyBox.svelte\",\"sources\":[\"FancyBox.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { fly } from 'svelte/transition'\\n    import { classnames, Swipe, delay } from '@utils'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    let active = null\\n\\n    function onClick(e) {\\n        const newActive = !active\\n\\n        setActive(newActive)\\n\\n        if (!newActive) {\\n            dispatch('close', e)\\n        } else {\\n            dispatch('open', e)\\n        }\\n    }\\n\\n    function setActive(isActive) {\\n        active = isActive\\n        if (!active) {\\n            document.documentElement.classList.remove('no-scroll-container')\\n        } else {\\n            const currScroll = document.documentElement.scrollTop\\n            document.documentElement.classList.add('no-scroll-container')\\n            document.documentElement.scrollTo(0, currScroll)\\n        }\\n    }\\n\\n    $: classProp = classnames('fancy-box-ghost', { active })\\n\\n    let ySwipe = 0\\n    const THRESHOLD = 100\\n\\n    function swipe(el) {\\n        new Swipe(el)\\n                .run()\\n                .onUp(handleVerticalSwipe)\\n                .onDown(handleVerticalSwipe)\\n                .onTouchEnd(async () => {\\n                    if (ySwipe > THRESHOLD) {\\n                        ySwipe = window.innerHeight\\n                        setActive(false)\\n                        drawTransform(el, ySwipe)\\n                        await delay(200)\\n                    } else if (ySwipe < -THRESHOLD) {\\n                        ySwipe = -window.innerHeight\\n                        setActive(false)\\n                        drawTransform(el, ySwipe)\\n                        await delay(200)\\n                    }\\n                    ySwipe = 0\\n                    drawTransform(el, ySwipe)\\n                })\\n    }\\n\\n    function handleVerticalSwipe(yDown, yUp, _evt, el) {\\n        ySwipe = yUp - yDown\\n        drawTransform(el, ySwipe)\\n    }\\n\\n    function drawTransform(el, y) {\\n        el.style.transform = `translate3d(0, ${y}px, 0)`\\n    }\\n\\n    document.addEventListener('scroll', () => {\\n        console.log(document.documentElement.scrollTop)\\n    })\\n\\n    let slots\\n    $: slots = $$props.$$slots || {}\\n</script>\\n\\n<section role=\\\"button\\\" class=\\\"fancy-box\\\" on:click={onClick}>\\n    <slot {active}></slot>\\n</section>\\n\\n{#if !slots.box}\\n    <button\\n            use:swipe\\n            in:fly=\\\"{{ y: 20, duration: 200 }}\\\"\\n            type=\\\"button\\\"\\n            class={classProp}\\n            on:click={onClick}\\n    >\\n        <slot></slot>\\n    </button>\\n{/if}\\n\\n{#if active !== null && slots.box}\\n    <button\\n            use:swipe\\n            in:fly=\\\"{{ y: 20, duration: 200 }}\\\"\\n            type=\\\"button\\\"\\n            class={classProp}\\n            on:click={onClick}\\n    >\\n        <slot name=\\\"box\\\"></slot>\\n    </button>\\n{/if}\\n\\n<style>\\n    .fancy-box {\\n        position: relative;\\n        width: 100%;\\n        -webkit-box-flex: 0;\\n            -ms-flex: none;\\n                flex: none;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        -ms-flex-item-align: stretch;\\n            align-self: stretch;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n    }\\n\\n    .fancy-box-ghost {\\n        z-index: 10;\\n        position: fixed;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        height: 100vh;\\n        display: -webkit-box;\\n        display: -ms-flexbox;\\n        display: flex;\\n        overflow: hidden;\\n        -webkit-box-align: stretch;\\n            -ms-flex-align: stretch;\\n                align-items: stretch;\\n        -webkit-box-pack: stretch;\\n            -ms-flex-pack: stretch;\\n                justify-content: stretch;\\n        background-color: rgba(var(--color-black), .75);\\n        outline: 20px solid rgba(var(--color-black), .75);\\n        -webkit-transition: .2s ease-out;\\n        transition: .2s ease-out;\\n        opacity: 0;\\n        -webkit-transform: translateY(20px);\\n                transform: translateY(20px);\\n        pointer-events: none;\\n    }\\n\\n    .fancy-box-ghost.active {\\n        opacity: 1;\\n        -webkit-transform: none;\\n                transform: none;\\n        pointer-events: auto;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAyGI,UAAU,cAAC,CAAC,AACR,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,gBAAgB,CAAE,CAAC,CACf,QAAQ,CAAE,IAAI,CACV,IAAI,CAAE,IAAI,CAClB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,mBAAmB,CAAE,OAAO,CACxB,UAAU,CAAE,OAAO,CACvB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,AACpC,CAAC,AAED,gBAAgB,cAAC,CAAC,AACd,OAAO,CAAE,EAAE,CACX,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,KAAK,CACb,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,WAAW,CACpB,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,iBAAiB,CAAE,OAAO,CACtB,cAAc,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CAC5B,gBAAgB,CAAE,OAAO,CACrB,aAAa,CAAE,OAAO,CAClB,eAAe,CAAE,OAAO,CAChC,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CAC/C,OAAO,CAAE,IAAI,CAAC,KAAK,CAAC,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,GAAG,CAAC,CACjD,kBAAkB,CAAE,GAAG,CAAC,QAAQ,CAChC,UAAU,CAAE,GAAG,CAAC,QAAQ,CACxB,OAAO,CAAE,CAAC,CACV,iBAAiB,CAAE,WAAW,IAAI,CAAC,CAC3B,SAAS,CAAE,WAAW,IAAI,CAAC,CACnC,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,gBAAgB,OAAO,cAAC,CAAC,AACrB,OAAO,CAAE,CAAC,CACV,iBAAiB,CAAE,IAAI,CACf,SAAS,CAAE,IAAI,CACvB,cAAc,CAAE,IAAI,AACxB,CAAC\"}"
};
...
const FancyBox = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section role="${"button"}" class="${"fancy-box svelte-vcv7h9"}">
    ${$$slots.default ? $$slots.default({ active }) : ``}
</section>

${!slots.box
	? `<button type="${"button"}" class="${escape(null_to_empty(classProp)) + " svelte-vcv7h9"}">
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`
	: ``}
