...
const css$a = {
	code: ".carousel.svelte-1mzjc9k.svelte-1mzjc9k{border-radius:var(--border-radius-big)}.carousel.svelte-1mzjc9k.svelte-1mzjc9k,.carousel-inner.svelte-1mzjc9k.svelte-1mzjc9k,.carousel-inner.svelte-1mzjc9k li.svelte-1mzjc9k,button.svelte-1mzjc9k.svelte-1mzjc9k{position:relative;width:100%;flex:none;display:flex;overflow:hidden;align-self:stretch;align-items:stretch;justify-content:stretch}.carousel-inner.svelte-1mzjc9k.svelte-1mzjc9k::-webkit-scrollbar{display:none}.carousel.svelte-1mzjc9k .carousel-inner.svelte-1mzjc9k{overflow-y:hidden;overflow-x:scroll;white-space:nowrap}.carousel-dots.svelte-1mzjc9k.svelte-1mzjc9k{position:absolute;top:0;left:0;width:100%;display:flex;align-items:center;justify-items:center;justify-content:center;pointer-events:none}.carousel-dots.svelte-1mzjc9k li.svelte-1mzjc9k{position:relative;width:8px;height:8px;margin:5px;border-radius:50%;overflow:hidden;background-color:rgba(var(--color-white));box-shadow:var(--shadow-primary)\n    }li.active.svelte-1mzjc9k.svelte-1mzjc9k{transform:scale(1.5)}",
	map: "{\"version\":3,\"file\":\"Carousel.svelte\",\"sources\":[\"Carousel.svelte\"],\"sourcesContent\":[\"<script>\\n    import { createEventDispatcher } from 'svelte'\\n    import { waitUntil } from '../utils'\\n    import Picture from './Picture.svelte'\\n\\n    const dispatch = createEventDispatcher()\\n\\n    /**\\n     *\\n     * @type {number | {\\n     *     src: string,\\n     *     srcBig: string,\\n     *     alt: string,\\n     *     onClick?: function,\\n     * }[]}\\n     */\\n    export let items = []\\n    export let dots = true\\n    export let initIndex = 0\\n\\n    $: activeDot = initIndex\\n\\n    function carousel(node) {\\n        initScrollPosition(node)\\n        node.addEventListener('scroll', onScroll)\\n        return { destroy: () => node.removeEventListener('scroll', onScroll) }\\n    }\\n\\n    function onScroll(e) {\\n        try {\\n            getActiveDot(e.target)\\n        } catch (err) { console.warn('Carousel does not work.', err) }\\n    }\\n\\n    function getActiveDot(parent) {\\n        const { scrollLeft } = parent\\n        const { width } = parent.getBoundingClientRect()\\n        const newActiveDot = Math.round(scrollLeft / width)\\n        if (activeDot !== newActiveDot) activeDot = newActiveDot\\n    }\\n\\n    function initScrollPosition(parent) {\\n        const { width } = parent.getBoundingClientRect()\\n        waitUntil(() => {\\n            parent.scrollLeft = width * activeDot\\n            if (parent.scrollLeft !== width * activeDot) {\\n              throw new Error('Not set.')\\n            }\\n        }, { interval: 50 })\\n    }\\n\\n    function onClick(item, index, e) {\\n        dispatch('click', { item, index, e })\\n        if (typeof item.onClick === 'function') item.onClick(item, index, e)\\n    }\\n\\n</script>\\n\\n<section aria-label=\\\"carousel\\\" class=\\\"carousel\\\">\\n    <ul use:carousel class=\\\"carousel-inner scroll-x-center\\\">\\n        {#each items as item, i}\\n            <li>\\n                <button type=\\\"button\\\" on:click={onClick.bind(null, item, i)}>\\n                    <slot {item}>\\n                        <Picture {...item}/>\\n                    </slot>\\n                </button>\\n            </li>\\n        {/each}\\n    </ul>\\n\\n\\n    {#if dots}\\n        <ul class=\\\"carousel-dots\\\">\\n            {#each items as _item, i}\\n                <li class={i === activeDot ? 'active' : ''}></li>\\n            {/each}\\n        </ul>\\n    {/if}\\n</section>\\n\\n<style>\\n    .carousel {\\n        border-radius: var(--border-radius-big);\\n    }\\n\\n    .carousel, .carousel-inner, .carousel-inner li, button {\\n        position: relative;\\n        width: 100%;\\n        flex: none;\\n        display: flex;\\n        overflow: hidden;\\n        align-self: stretch;\\n        align-items: stretch;\\n        justify-content: stretch;\\n    }\\n\\n    .carousel-inner::-webkit-scrollbar {\\n        display: none;\\n    }\\n\\n    .carousel .carousel-inner {\\n        overflow-y: hidden;\\n        overflow-x: scroll;\\n        white-space: nowrap;\\n    }\\n\\n    .carousel-dots {\\n        position: absolute;\\n        top: 0;\\n        left: 0;\\n        width: 100%;\\n        display: flex;\\n        align-items: center;\\n        justify-items: center;\\n        justify-content: center;\\n        pointer-events: none;\\n    }\\n\\n    .carousel-dots li {\\n        position: relative;\\n        width: 8px;\\n        height: 8px;\\n        margin: 5px;\\n        border-radius: 50%;\\n        overflow: hidden;\\n        background-color: rgba(var(--color-white));\\n        box-shadow: var(--shadow-primary)\\n    }\\n\\n    li.active {\\n        transform: scale(1.5);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAkFI,SAAS,8BAAC,CAAC,AACP,aAAa,CAAE,IAAI,mBAAmB,CAAC,AAC3C,CAAC,AAED,uCAAS,CAAE,6CAAe,CAAE,8BAAe,CAAC,iBAAE,CAAE,MAAM,8BAAC,CAAC,AACpD,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,QAAQ,CAAE,MAAM,CAChB,UAAU,CAAE,OAAO,CACnB,WAAW,CAAE,OAAO,CACpB,eAAe,CAAE,OAAO,AAC5B,CAAC,AAED,6CAAe,mBAAmB,AAAC,CAAC,AAChC,OAAO,CAAE,IAAI,AACjB,CAAC,AAED,wBAAS,CAAC,eAAe,eAAC,CAAC,AACvB,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,MAAM,CAClB,WAAW,CAAE,MAAM,AACvB,CAAC,AAED,cAAc,8BAAC,CAAC,AACZ,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,MAAM,CACrB,eAAe,CAAE,MAAM,CACvB,cAAc,CAAE,IAAI,AACxB,CAAC,AAED,6BAAc,CAAC,EAAE,eAAC,CAAC,AACf,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,GAAG,CACV,MAAM,CAAE,GAAG,CACX,MAAM,CAAE,GAAG,CACX,aAAa,CAAE,GAAG,CAClB,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAC1C,UAAU,CAAE,IAAI,gBAAgB,CAAC;IACrC,CAAC,AAED,EAAE,OAAO,8BAAC,CAAC,AACP,SAAS,CAAE,MAAM,GAAG,CAAC,AACzB,CAAC\"}"
};
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<section aria-label="${"carousel"}" class="${"carousel svelte-1mzjc9k"}">
    <ul class="${"carousel-inner scroll-x-center svelte-1mzjc9k"}">
        ${each(items, (item, i) => `<li class="${"svelte-1mzjc9k"}">
                <button type="${"button"}" class="${"svelte-1mzjc9k"}">
                    ${$$slots.default
	? $$slots.default({ item })
	: `
    ...
    ${dots
	? `<ul class="${"carousel-dots svelte-1mzjc9k"}">
            ${each(items, (_item, i) => `<li class="${escape(null_to_empty(i === activeDot ? "active" : "")) + " svelte-1mzjc9k"}"></li>`)}
        </ul>`
	: ``}
</section>`;
});
