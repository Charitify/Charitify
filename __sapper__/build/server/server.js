...
const css$o = {
	code: "div.svelte-13swpu0{flex:none;display:flex;align-self:stretch;height:470px;width:77vw;max-width:350px;padding:0 5px;box-sizing:content-box}div.start.svelte-13swpu0{padding-left:var(--screen-padding)}div.end.svelte-13swpu0{padding-right:var(--screen-padding)}",
	map: "{\"version\":3,\"file\":\"CharityCards.svelte\",\"sources\":[\"CharityCards.svelte\"],\"sourcesContent\":[\"<script>\\n    import Carousel from '../Carousel.svelte'\\n    import CharityCard from './CharityCard.svelte'\\n\\n    export let amount = 5\\n\\n    let carousel = new Array(amount).fill(0)\\n</script>\\n\\n<Carousel items={carousel} size=\\\"auto\\\" let:index={index}>\\n    <div class={!index ? 'start' : index === carousel.length - 1 ? 'end' : ''}>\\n       <CharityCard\\n            src=\\\"https://placeimg.com/300/300/people\\\"\\n            total={20000}\\n            current={3500}\\n            city=\\\"Львів\\\"\\n            title=\\\"Допоможи Сірку\\\"\\n       />\\n    </div>\\n</Carousel>\\n\\n<style>\\n    div {\\n        flex: none;\\n        display: flex;\\n        align-self: stretch;\\n        height: 470px;\\n        width: 77vw;\\n        max-width: 350px;\\n        padding: 0 5px;\\n        box-sizing: content-box;\\n    }\\n\\n    div.start {\\n        padding-left: var(--screen-padding);\\n    }\\n\\n    div.end {\\n        padding-right: var(--screen-padding);\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AAsBI,GAAG,eAAC,CAAC,AACD,IAAI,CAAE,IAAI,CACV,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,OAAO,CACnB,MAAM,CAAE,KAAK,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,CAAC,CAAC,GAAG,CACd,UAAU,CAAE,WAAW,AAC3B,CAAC,AAED,GAAG,MAAM,eAAC,CAAC,AACP,YAAY,CAAE,IAAI,gBAAgB,CAAC,AACvC,CAAC,AAED,GAAG,IAAI,eAAC,CAAC,AACL,aAAa,CAAE,IAAI,gBAAgB,CAAC,AACxC,CAAC\"}"
};
...
const CharityCards = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${escape(null_to_empty(!index
		? "start"
		: index === carousel.length - 1 ? "end" : "")) + " svelte-13swpu0"}">
