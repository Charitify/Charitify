...
<div class="${"search theme-bg container svelte-1ycg4f6"}">
    <br>

    ${validate_component(SearchLine, "SearchLine").$$render($$result, {}, {}, {})}

    <nav class="${"svelte-1ycg4f6"}">
        <ul class="${"svelte-1ycg4f6"}">
            <li class="${"svelte-1ycg4f6"}"><a rel="${"prefetch"}" href="${"lists/charities"}" class="${["svelte-1ycg4f6", segment === "charities" ? "selected" : ""].join(" ").trim()}">charities</a></li>
            <li class="${"svelte-1ycg4f6"}"><a rel="${"prefetch"}" href="${"lists/organizations"}" class="${["svelte-1ycg4f6", segment === "organizations" ? "selected" : ""].join(" ").trim()}">organizations</a></li>
        </ul>
    </nav>
</div>

<div class="${"list-wrap svelte-1ycg4f6"}">
    <br>
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${validate_component(ListsLayout, "ListsLayout").$$render($$result, {}, {}, {
		default: () => `
	${$$slots.default ? $$slots.default({}) : ``}
`
	})}`;
