...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${add_attribute("id", id, 0)}${add_attribute("href", href, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-5mxtl5"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </a>`
	: `${htmlFor
		? `<label${add_attribute("id", id, 0)} ${disabled ? "disabled" : ""}${add_attribute("for", htmlFor, 0)}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-5mxtl5"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </label>`
		: `<button${add_attribute("id", id, 0)}${add_attribute("type", type, 0)} ${disabled ? "disabled" : ""}${add_attribute("title", titleProp, 0)} class="${escape(null_to_empty(classProp)) + " svelte-5mxtl5"}"${add_attribute("aria-label", ariaLabelProp, 0)}>
        ${$$slots.default ? $$slots.default({}) : ``}
    </button>`}`}`;
});
...
const Carousel = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul aria-label="${"carousel"}" class="${"svelte-1lktaax"}">
    ${each(items, item => `<li class="${"svelte-1lktaax"}">
            ${$$slots.default
	? $$slots.default({ item })
	: `
...
const Header = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"theme-bg container svelte-de9q2v"}">
    <ul class="${"nav-pages svelte-de9q2v"}">
        <li><a rel="${"prefetch"}" href="${"."}" class="${["svelte-de9q2v", segment === undefined ? "selected" : ""].join(" ").trim()}">home</a></li>
        <li><a rel="${"prefetch"}" href="${"lists/charities"}" class="${["svelte-de9q2v", segment === "lists" ? "selected" : ""].join(" ").trim()}">lists</a></li>
        <li><a href="${"map"}" class="${["svelte-de9q2v", segment === "map" ? "selected" : ""].join(" ").trim()}">map</a></li>
    </ul>

    <ul class="${"nav-actions svelte-de9q2v"}">
        <li class="${"svelte-de9q2v"}">
            <select${add_attribute("value", value, 0)} name="${"lang"}" id="${"lang"}" class="${"btn small lang-select svelte-de9q2v"}">
                <option value="${"ua"}">Ua</option>
                <option value="${"ru"}">Ru</option>
                <option value="${"en"}">En</option>
            </select>
        ...
        <li class="${"svelte-de9q2v"}">
            <a class="${"btn small svelte-de9q2v"}" href="${"users/me"}">
...
<div class="${"search theme-bg container svelte-4yrc5j"}">
    ...
    <nav class="${"svelte-4yrc5j"}">
        <ul class="${"svelte-4yrc5j"}">
            <li class="${"svelte-4yrc5j"}"><a rel="${"prefetch"}" href="${"lists/charities"}" class="${["svelte-4yrc5j", segment === "charities" ? "selected" : ""].join(" ").trim()}">charities</a></li>
...
const CharityCard = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<a class="${"card svelte-do16pj"}" href="${"charities/id"}">
...
const U5Bidu5D$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	$page = get_store_value(page);
	let carousel = (charity.avarars || []).map(src => ({ src }));
...
<section class="${"container scroll-box"}">
    ...
    <a class="${"rate-section svelte-uz5elz"}"${add_attribute("href", `organizations/${charity.org_id}`, 0)}>
        ${validate_component(AvatarAndName, "AvatarAndName").$$render(
		$$result,
		{
			src: charity.org_head_avatar,
...
const Me = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <br>
    <div class="${"user-avatar svelte-16ij8e1"}">+</div>
    <br>
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "charities_$id", file: "charities/[id].svelte", component: U5Bidu5D$1, params: match => ({ id: d(match[1]) }) }
			]
		},
