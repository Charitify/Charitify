...
const Avatar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${escape(null_to_empty(classProp)) + " svelte-yqfqiz"}">
...
const css$m = {
	code: "ul.svelte-1y2ht4w{width:100%;display:flex;flex-direction:row-reverse;align-items:flex-start;max-width:100%;overflow-y:hidden;overflow-x:auto;padding:var(--screen-padding) 0}li.svelte-1y2ht4w{flex:none;align-self:stretch;width:260px;padding:0 5px}li.svelte-1y2ht4w:last-child{padding-left:15px}li.svelte-1y2ht4w:first-child{padding-right:15px}",
	map: "{\"version\":3,\"file\":\"DonatorsList.svelte\",\"sources\":[\"DonatorsList.svelte\"],\"sourcesContent\":[\"<script>\\n    import DonatorsCard from './DonatorsCard.svelte'\\n\\n    const all = [\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '10грн',\\n            subtitle: 'Тіна Канделакі',\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '250грн',\\n            subtitle: 'Bruce Lee',\\n            checked: true,\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '1140грн',\\n            subtitle: 'Leonardo DiCaprio junior',\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '50$',\\n            subtitle: 'Добра людина',\\n        },\\n        {\\n            src: 'https://placeimg.com/300/300/people',\\n            title: '5$',\\n            subtitle: 'Добра людина',\\n        },\\n    ]\\n\\n    const grouped = all.map(one => new Array(3).fill(one))\\n</script>\\n\\n<ul class=\\\"scroll-x-center\\\">\\n    {#each grouped as cards}\\n        <li>\\n            <DonatorsCard items={cards}/>\\n        </li>\\n    {/each}\\n</ul>\\n\\n<style>\\n    ul {\\n        width: 100%;\\n        display: flex;\\n        flex-direction: row-reverse;\\n        align-items: flex-start;\\n        max-width: 100%;\\n        overflow-y: hidden;\\n        overflow-x: auto;\\n        padding: var(--screen-padding) 0;\\n    }\\n\\n    li {\\n        flex: none;\\n        align-self: stretch;\\n        width: 260px;\\n        padding: 0 5px;\\n    }\\n\\n    li:last-child {\\n        padding-left: 15px;\\n    }\\n\\n    li:first-child {\\n        padding-right: 15px;\\n    }\\n\\n/*# sourceMappingURL=data:application/json;base64, */</style>\\n\"],\"names\":[],\"mappings\":\"AA4CI,EAAE,eAAC,CAAC,AACA,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,WAAW,CAC3B,WAAW,CAAE,UAAU,CACvB,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,MAAM,CAClB,UAAU,CAAE,IAAI,CAChB,OAAO,CAAE,IAAI,gBAAgB,CAAC,CAAC,CAAC,AACpC,CAAC,AAED,EAAE,eAAC,CAAC,AACA,IAAI,CAAE,IAAI,CACV,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,KAAK,CACZ,OAAO,CAAE,CAAC,CAAC,GAAG,AAClB,CAAC,AAED,iBAAE,WAAW,AAAC,CAAC,AACX,YAAY,CAAE,IAAI,AACtB,CAAC,AAED,iBAAE,YAAY,AAAC,CAAC,AACZ,aAAa,CAAE,IAAI,AACvB,CAAC\"}"
};
...
const DonatorsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<ul class="${"scroll-x-center svelte-1y2ht4w"}">
    ${each(grouped, cards => `<li class="${"svelte-1y2ht4w"}">
